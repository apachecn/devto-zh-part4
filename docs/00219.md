...
> 原文:[https://dev . to/mblayman/a-complete-guide-to-i18n-in-python-28d 6](https://dev.to/mblayman/a-complete-guide-to-i18n-in-python-28d6)
...
### [](#-raw-endraw-and-raw-format-endraw-strings)`_`和`format`弦
...
## [](#extracting-the-master-list)提取主列表
...
## [](#getting-translations-for-other-languages)获取其他语言的翻译
