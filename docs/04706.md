...
> 原文:[https://dev . to/dabi T3/how-to-build-an-ai-enabled-natural-language-synthesis-chrome-extension-1bhl](https://dev.to/dabit3/how-to-build-an-ai-enabled-natural-language-synthesization-chrome-extension-1bhl)
...
## [](#part-1-creating-the-ml-amp-ai-services-with-amplify)第 1 部分——用 Amplify 创建 ML & AI 服务
...
## [](#part-2-building-the-extension)第二部分-建筑扩建。

### [](#chrome-extension-overview)铬扩展概述
...
[![Alt Text](../Images/3a5305ddb937121f0dd07e929851a6d7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--thGcu9sm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0ba0ojvsg9sj6w06trqz.jpg)
...
### [](#contentjs)[content.js](https://github.com/dabit3/transilator/blob/master/src/js/content.js)
...
### [](#building-and-deploying-the-extension)构建和部署扩展
