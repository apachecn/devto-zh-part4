...
> 原文:[https://dev . to/giladmaayan/build-a-real-time-application-with-Amazon-elastic cache-for-redis-3ph 8](https://dev.to/giladmaayan/build-a-real-time-application-with-amazon-elasticache-for-redis-3ph8)
...
## [](#socketio-and-redis-on-the-server)服务器上的 Socket.io 和 Redis
...
## [](#socketio-on-the-client)客户端上的 Socket.io
...
## [](#using-the-events-in-a-react-component)使用 React 组件中的事件
