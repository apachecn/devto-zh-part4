...
> 原文:[https://dev.to/thewhitewulfy/blog-api-on-github-pages-29ig](https://dev.to/thewhitewulfy/blog-api-on-github-pages-29ig)
...
### [](#output-data-as-json)输出数据为 JSON
...
### [](#using-the-output-as-api)使用输出作为 API

很简单！将`output.json`放在一个名为`api`的新文件夹下，并重命名为`index.json`。

### [](#making-this-api-as-json-feed)将此 API 作为 JSON feed
