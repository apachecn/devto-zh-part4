...
> 原文:[https://dev . to/drewtownchi/tailwindcss-and-vue-a-match-made-in-heaven-34l 0](https://dev.to/drewtownchi/tailwindcss-and-vue-a-match-made-in-heaven-34l0)
...
## [](#enter-utilityfirst-css-frameworks)进入效用优先的 CSS 框架
