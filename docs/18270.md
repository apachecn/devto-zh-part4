...
> 原文:[https://dev . to/Richard _ klose/mirroring-releases-from-github-4an 6](https://dev.to/richard_klose/mirroring-releases-from-github-4an6)

*这篇文章最初发表在[我的博客](https://blog.klose.dev/mirroring-releases-from-github/)上。*

[![Mirroring Releases from GitHub](../Images/751632e4752869611ab148990f951ef2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--frYSep-t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.unsplash.com/photo-1495722281458-25edbdb08a1c%3Fixlib%3Drb-1.2.1%26q%3D80%26fm%3Djpg%26crop%3Dentropy%26cs%3Dtinysrgb%26w%3D1080%26fit%3Dmax%26ixid%3DeyJhcHBfaWQiOjExNzczfQ)
...
### [](#the-problem-in-detail-how-packages-download-binaries-from-github)详细问题:软件包如何从 GitHub 下载二进制文件
...
### [](#building-the-caching-server-download-github-releases-to-a-local-server)构建缓存服务器:下载 GitHub 版本到本地服务器
...
### [](#using-the-caching-server-setup-your-environment)使用缓存服务器:设置您的环境
...
### [](#optionally-package-everything-into-a-docker-container)有选择地把所有东西打包进 docker 容器
