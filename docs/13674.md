...
> 原文:[https://dev . to/carola 99/send-an-html-email-template-with-python-and-jinja 2-1hd 0](https://dev.to/carola99/send-an-html-email-template-with-python-and-jinja2-1hd0)
...
### [](#set-up-a-local-smtp-simple-mail-transfer-protocol)设置本地 SMTP(简单邮件传输协议)
...
### [](#loading-a-template-with-jinja2)用 Jinja2 加载模板。
...
### [](#sending-the-email-with-html-content)发送带有 HTML 内容的邮件
...
### [](#control-structures-with-jinja2)用 Jinja2 控制结构
