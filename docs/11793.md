...
> 原文:[https://dev.to/lankydandev/ktor-a-kotlin-web-framework-3hoj](https://dev.to/lankydandev/ktor-a-kotlin-web-framework-3hoj)
...
### [](#starting-the-web-server)启动 web 服务器
...
### [](#contents-of-a-request-handler)请求处理程序的内容
...
### [](#installing-extra-features)安装额外功能
...
### [](#brief-mention-for-kodein)简略提为 Kodein
