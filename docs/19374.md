...
> 原文:[https://dev.to/sadmansamee/swiftui-cheat-sheet-34ga](https://dev.to/sadmansamee/swiftui-cheat-sheet-34ga)

# [](#swiftui-cheat-sheet)SwiftUI 备忘单

[![SwiftUI](../Images/5ec3019337b1da71732ce995339b17ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0ui8tk5S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/SimpleBoilerplates/SwiftUI-Cheat-Sheet/master/assets/image.png)
...
# [](#uikit-equivalent-in-swiftui)UIKIT 等同于 SwiftUI
...
# [](#alerts-and-action-sheets)警报和行动表
...
# [](#work-with-uikit)使用 UIKIT 工作

### [](#navigate-to-viewcontroller)导航至 ViewController
...
### [](#use-uikit-and-swiftui-views-together)一起使用 UIKit 和 SwiftUI 视图
