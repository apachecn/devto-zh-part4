...
## [](#clean-code-e-javascript)清理代码 e JavaScript
...
[![js const error](img/9d4d0656e3bae29aa709c4d90301b656.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--As8tGoSn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5eme2dfcibd021zxqiwe.png)
...
## [](#valores-e-refer%C3%AAncias)价值观和参考
...
## [](#refer%C3%AAncias-imut%C3%A1veis)不变参考
...
### [](#encapsulando-fluxos-impuros)封装 Fluxos Impuros
