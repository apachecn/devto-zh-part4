...
> 原文:[https://dev . to/ch _ lee/docker-for-初学者-docker-file-docker-build-docker-run-docker-compose-what-it-all-mean-22oj](https://dev.to/ch_lee/docker-for-beginners-docker-file-docker-build-docker-run-docker-compose-what-does-it-all-mean-22oj)
...
## [](#sowhat-is-a-docker-file)如此...什么是 Docker 文件？
...
#### [](#stage-1-specify-the-runtime)阶段 1:指定运行时
...
#### [](#stage-4-setting-the-entry-point)第四阶段:设置切入点
...
### [](#a-simpler-docker-file)一个更简单的 Docker 文件
...
[![docker-aspnetdemo-localhost](../Images/e0b1e58a958b3e4a50a8bafd66b18e2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9CeDDX1---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t02hd8of48rheuv5mr2a.png)
