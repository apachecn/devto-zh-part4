...
> 原文:[https://dev . to/azure/developing-借助 surface-go 快 10 倍，感谢 vs-code-and-azure-mho](https://dev.to/azure/developing-10x-faster-with-a-surface-go-thanks-to-vs-code-and-azure-mho)
...
## [](#initial-performance-numbers)初始绩效数字
...
## [](#surface-go-vs-surface-book)表面围棋 vs .表面书
...
## [](#using-vs-code-and-removing-maven)使用 VS 代码并删除 Maven
...
## [](#using-vs-studio-code-remote-development)使用 VS Studio 代码远程开发
...
## [](#testing-with-better-machines-and-optimizing-price)用更好的机器测试，优化价格
