...
> 原文：<https://dev.to/bnevilleoneill/3-ways-to-use-es6-proxies-to-enhance-your-objects-506p>

[![](img/7c7f3f378baf0414b0e019f7db330b00.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--QQpyi0lQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/20l5f4wl6yczzismmcoa.png)
...
但是在我们开始看例子之前，我想快速回答这个问题，因为这是一个经常被问到的问题。有了 ES6，我们不仅仅得到了代理，我们还得到了`Reflect` [对象](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Reflect)，乍一看，它们做的完全一样，不是吗？
...
但是使用代理，有一种方法可以让你的代码更具声明性。想想看，如果您的对象支持如下语句会怎么样:
...
帖子 [3 种使用 ES6 代理增强你的对象的方法](https://blog.logrocket.com/use-es6-proxies-to-enhance-your-objects/)最先出现在 [LogRocket 博客](https://blog.logrocket.com)上。