...
> 原文:[https://dev . to/stepsize/how-tech-debt-impacts-every one-in-the-company-2 neo](https://dev.to/stepsize/how-tech-debt-impacts-everyone-in-the-company-2neo)
...
## [](#the-metaproblems-caused-by-tech-debt)科技债引发的元问题
...
[![Alt Text](img/c3697a63bf7e3a6e0f711490e682e6df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IcVlai_n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6agsbhf600kubp63n1yf.png)

我们试图预测的未来越遥远，我们的预测就越不准确。再加上复杂的代码库需要更多的时间来修改，这就形成了一个很好的恶性循环。

[![Alt Text](img/2037d3e74e740f7671eda9c1de44a80c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--X4tnbCOW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7047jhdmaashgch1twgn.png)
...
## [](#how-tech-debt-affects-product-management)科技债务如何影响产品管理
...
## [](#how-tech-debt-affects-sales-teams)技术债务如何影响销售团队
...
## [](#how-tech-debt-affects-marketing-amp-pr)科技债务如何影响营销&公关
...
## [](#how-tech-debt-affects-hr)科技债务如何影响人力资源
...
## [](#how-tech-debt-affects-finance)科技债务如何影响金融
...
[![Alt Text](img/3c858c03b05ab14c5131c27364859bf7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--skDKxAhu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i9lq76jttz7epc3x668u.png)
...
## [](#other-impacts-of-tech-debt)科技债的其他影响

管理不善的技术债务会导致系统中更多的错误、更多的性能问题和更多的停机时间。

[![Alt Text](img/386c54fb1b631d9171ada25ac2d6a956.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bJtRy-64--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9fvhb7uvjdn46z0fqpvz.png)

这不可避免地增加了 QA 的负担，QA 负责在 bug 到达客户之前捕捉它们。它还会影响站点的可靠性，维护正常运行时间和处理任何性能问题的人员。最终，这意味着 SLA 没有得到满足。

[![Alt Text](img/b401902e68465c0b70d790b4726c8e2c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iydb2PR1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cb20pb3l0660fuymezwz.png)

反过来，这会导致更多的客户投诉，从而增加客户支持、成功和客户管理的工作量，因为不满意的客户需要更多的帮助和关注。更糟糕的是，这些客户最终可能会离开。

[![Alt Text](img/f4b99c1bdb5ec26d73e068ca8fe1bfa7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G95EYX3V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/66tejaz89twlnm2zdsta.png)
