...
> 原文:[https://dev . to/prahladyeri/package-signing-in-pip-it-works-in-a-round about-sort-of-way-1kic](https://dev.to/prahladyeri/package-signing-in-pip-it-works-in-a-roundabout-sort-of-way-1kic)
