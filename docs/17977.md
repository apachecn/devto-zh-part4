...
> 原文:[https://dev . to/Phillip Dodd/how-to-set-up-github-projects-in-a-vs-code-workspace-2j 27](https://dev.to/phillipdodd/how-to-set-up-github-projects-in-a-vs-code-workspace-2j27)

# [](#how-to-set-up-github-projects-in-vsc-workspace)如何在 VSC 工作区设置 GitHub 项目

> 这就好像您还没有创建工作空间一样。

## [](#step-1-create-a-local-dev-folder)第一步:创建本地 dev 文件夹
...
## [](#step-2-create-a-local-github-folder)第二步:创建本地 GitHub 文件夹
...
## [](#step-3-save-your-workspace)第三步:保存工作区

VS 代码在加载时通常会使用你上次加载的工作空间作为默认，但是有一两次我很感激我花时间保存了我的工作空间设置。

您可以通过选择菜单中的`File > Save Workspace As...`来保存。

## [](#step-4-open-in-terminal-the-github-folder)第四步:‘在终端中打开’GitHub 文件夹
...
## [](#step-5-git-clone-all-the-things)第五步:Git 克隆所有的东西
