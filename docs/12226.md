...
> 原文:[https://dev . to/mainawycliffe/how-to-add-async-validators-to-an-angular-reactive-form-3 ohb](https://dev.to/mainawycliffe/how-to-add-async-validators-to-an-angular-reactive-form-3ohb)
...
[![How to Add Async Validators to an Angular Reactive Form](../Images/1ce5ce91db2c39d4a8a0d91cbe27bd15.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z2igyEIM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://codinglatte.com/posts/angular/how-to-add-async-validators-to-an-angular-reactive-form/demo.gif)
...
### [](#username-lookup-method)用户名查找方法
...
### [](#adding-an-async-validator)添加异步验证器
...
### [](#adding-async-validators-to-our-reactive-form)向我们的反应式表单添加异步验证器
