...
[![Container vs Virtual Machine](../Images/e9c179b2a099eda9c1ebae98ee58f689.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HRIgvrkB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.docker.com/sites/default/files/d8/2018-11/docker-containerized-and-vm-transparent-bg.png)
...
# [](#bedrock-and-wordpress)基岩和文字

### [](#what-you-need-in-order-to-start)你需要什么才能开始
...
基岩文件夹内的文件和文件夹:
[![Bedrock-folder](../Images/97858da3424f368b02514a76ba220cdf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eTQvzBry--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qev5i2kx7tcjxlllrvss.png)
...
[![](../Images/2320748476d83f016f87634e6288a2d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ty8Z9Vgy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ygvuz6cee2plymzqheqf.png)

*   Web:

    网络文件夹有两个子文件夹，index.php 和 wp-config.php。app 文件夹包含的是开发时唯一需要的文件夹。App 文件夹包含主题，插件，mu(最常用)-插件和上传。

    ![](../Images/15b192f7561c1f3620fb0eca107d795f.png)
