...
> 原文:[https://dev . to/techno Plato/I-m-creating-a-deep-dive-for-react-native-into-creating-lists-with-functionality-the-you-absolute-encounting-2nd 1](https://dev.to/technoplato/i-m-creating-a-deep-dive-for-react-native-into-creating-lists-with-functionality-that-you-will-inevitably-encounter-2nd1)

## [](#mandatory-preview-of-the-end-result)强制:[最终结果的预览。](https://youtu.be/0VJRFZmr7Mk?t=161)

## TL；博士:[视频链接在哪里](https://www.youtube.com/watch?v=vNq1P06KkoU)

## [](#i-dont-like-videos-just-show-me-the-code)我不喜欢视频:[给我看代码就行](https://github.com/technoplato/TutorialListAndHooks)

## [](#i-dont-like-videos-or-reading-code-where-is-your-medium-writeup)我不喜欢视频或阅读代码:[你的媒体报道呢](https://medium.com/@michaellustig)
...
### [](#code-since-its-still-short-and-self-contained)代码(因为它仍然很短并且是独立的)
