...
> 原文:[https://dev . to/tbetous/how-to-make-conditional-resources-in-terra form-440n](https://dev.to/tbetous/how-to-make-conditionnal-resources-in-terraform-440n)
...
### [](#step-1-create-your-input-parameter)👉步骤 1:创建输入参数
...
### [](#step-2-create-your-resources)👉第二步:创建你的资源
...
### [](#step-3-create-a-data-variable-to-access-your-conditional-resources-from-the-same-id)👉步骤 3:创建一个数据变量，从同一个 id 访问您的条件资源
...
### [](#step-4-plan-and-apply-your-terraform)👉第四步:计划和应用你的地形
...
### [](#step-5-clean-resources-optional)👉步骤 5:清理资源(可选)
