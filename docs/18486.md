...
> 原文:[https://dev . to/only 2 dhir/an-introduction-to-spring-cloud-gateway-3o 89](https://dev.to/only2dhir/an-introduction-to-spring-cloud-gateway-3o89)
...
## [](#zuul-vs-spring-cloud-gateway)Zuul Vs 春云网关
...
## [](#spring-cloud-gateway-architecture)春云网关架构

[![Spring Cloud Gateway Architecture](../Images/e1c56236d478fee51815bdc1775e1bd2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lEGOwJ8r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/2N8AgtH.png) 
...
## [](#route-definition-in-spring-cloud-gateway)春云网关中的路由定义
