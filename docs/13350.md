...
> 原文:[https://dev . to/imtyrelchambers/build-a-Reddit-scraper-authenticating-with-Reddit-oauth-4519](https://dev.to/imtyrelchambers/build-a-reddit-scraper-authenticating-with-reddit-oauth-4519)

# [](#create-your-reddit-developer-app)**创建你的 Reddit 开发者应用**
...
### [](#finding-the-right-scope)**寻找合适的范围**
...
### [](#getting-the-access-token)**获取访问令牌**
