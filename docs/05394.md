...
> 原文:[https://dev . to/black smoke 16/object-validation-with-assert-25p 6](https://dev.to/blacksmoke16/object-validation-with-assert-25p6)
...
### [](#custom-assertions-amp-generics)自定义断言&泛型
