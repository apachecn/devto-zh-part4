...
> 原文:[https://dev . to/tuned/rust-scales-python-some-examples-1-2d j5](https://dev.to/tuned/rust-scales-python-some-examples-1-2dj5)
...
## [](#environment-and-assumptions)环境和假设
