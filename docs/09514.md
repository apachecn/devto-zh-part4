...
> 原文:[https://dev . to/simioluwatomi/let-s-build-a-super-simple-referral-system-with-laravel-1o3h](https://dev.to/simioluwatomi/let-s-build-a-super-simple-referral-system-with-laravel-1o3h)
...
#### [](#now-lets-think-about-referral-links-and-how-we-want-our-referral-links-to-look-like)现在让我们考虑一下推荐链接，以及我们希望我们的推荐链接是什么样子。
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ simioluwatomi ](https://github.com/simioluwatomi) / [简单转诊](https://github.com/simioluwatomi/simple-referral)

### 用 Laravel 构建的一个超级简单的推荐系统

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Image of User Details](../Images/103506d37729c82c5371adec309b16e3.png)T2】](https://raw.githubusercontent.com/simioluwatomi/simple-referral/master/README.MD/User-Details.png)
