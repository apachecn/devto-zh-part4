...
> 原文:[https://dev . to/omiossec/requirements-idempotent-and-declarative-system-configuration-framework-in-powershell-3a 40](https://dev.to/omiossec/requirements-idempotent-and-declarative-system-configuration-framework-in-powershell-3a40)
