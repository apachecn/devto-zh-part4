...
> 原文:[https://dev . to/web hook relay/docker-compose-update-on-github-release-web hook-fch](https://dev.to/webhookrelay/docker-compose-update-on-github-release-webhook-fch)

[![Alt Text](../Images/d220835a6315a553be70244b73f59679.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6ShstueE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6w0sncnp3fck4ppuvhtj.png)
...
## [](#step-1-deploying-containers-through-docker-compose)步骤 1:通过 Docker Compose 部署容器
...
## [](#step-2-setting-up-updates-on-github-tag)步骤 2:在 Github 标签上设置更新
...
[![release filter](../Images/0dceb6c4de86db1ea97a46e488eded2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ebqmoAPh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h81b4f6kj0p40gju4mbs.png)

如果您标记了另一个版本，您现在应该看到只有一个 webhook 是 forwarder

[![rule stopped webhook](../Images/4a903c0b4d557bd80272c09cc44eaf94.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bvjP5nQT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vglu9whudofjj376jq84.png)

## [](#step-3-update-script-and-starting-relay-background-service)第三步:更新脚本，启动中继后台服务
...
## [](#optional-validating-github-secret)可选:验证 Github 秘密

Webhook 中继输出规则也可以验证 Github 签名:

[![webhook filter signature](../Images/d9e61be44c664d7a56655d3014f801c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7uCZpzHz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5k36auilqr3xk3yzn7ur.png)
