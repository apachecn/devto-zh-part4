...
> 原文:[https://dev . to/sanojpunchihewa/how-to-easy-implement-new-in-app-update-feature-to-your-Android-app-9e 9](https://dev.to/sanojpunchihewa/how-to-easily-implement-new-in-app-update-feature-to-your-android-app-9e9)
...
[![](../Images/4de5f37b16e20c11ef4a8b1c65ad8f7a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5vrqwMR_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5mg3mnkl2dmrxnf6wgly.png) 
...
#### [](#step-1-add-jitpack-to-your-root-level-buildgradle-at-the-end-of-repositories)第一步:将 jitpack 添加到您的根级 build.gradle 中，放在存储库的末尾
...
#### [](#step-2-add-the-dependency-to-app-level-buildgradle)第二步:将依赖关系添加到 app 级 build.gradle
...
#### [](#step-3-initialize-the-updatemanager-in-your-oncreate-method-of-the-activity)步骤 3:在活动的 onCreate 方法中初始化 UpdateManager
...
#### [](#step-4-call-continueupdate-method-in-your-onresume-method-to-install-waiting-updates)第四步:调用 onResume 方法中的 continueUpdate 方法安装等待更新
