...
[![Tipos de Flores](../Images/78d7b70577329f673d36de5a8a1e8a51.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UIHdAuzF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3zt5mn4145wvwdqozs5m.png) 
我们将用[橙](https://orange.biolab.si/)来解决。我推荐阅读这篇优秀的文章，展示了该工具的最初步骤。

## [](#carregando-e-visualizando-os-dados)加载和查看数据

正如上一次会议所看到的那样，我们将加载该问题的数据集，并查看这些数据的含义。加载数据集(只需拖动小部件“*文件*”并选择该文件)时，我们可以访问有关该问题的一些相关信息:

[![Abrindo o arquivo](../Images/ec4e189d2b86942feff085e6e62b9b07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Bc7eYKv0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uoz65fib79eaievwq74k.png)
...
## [](#explorando-os-dados)浏览数据

利用表格数据可视化构件，我们对这些数据是什么有了更好的了解: [![Dados em tabela](../Images/7500c34003cecf62157c5c4850926fcd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UupVLZdk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9pcn9w5vflmz0z2kz6ev.png)
...
## [](#testar-e-avaliar-o-modelo)测试和评价模型
...
[![Funcionamento kNN](../Images/9991cf02f6c9bcf1d0b363cf4a1b7af9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0Vk_bBxL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/shdijnaysqkjt6ut7y2q.png) 
 ...
 *### [](#aplicando-o-knn)阿普利卡多

[![kNN widget](../Images/f5d0a95357a55c201caf320a2d0ae2c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---ob6FrGc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hrjzvhlld7ku2pfce219.png)
...
在设置这些设置时，我们可以访问模型输出。
[![Test & Score widget](../Images/e7ebfdab1b910ac875544d1689e1b6de.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nI5-Sk4p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7er6t8x81tpwrfnkq79j.png)
...
## [](#resultado-final)最终结果

[![Resultado final](../Images/604dccbe744f75c887c328ec60cdd5d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hxA66LQ7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1dndlpdh1epgzfvm0xlv.png)
