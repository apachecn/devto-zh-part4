...
> 原文:[https://dev . to/samw software/what-you-need-to-be-a-full-stack-server-developer-1 NCP](https://dev.to/samwsoftware/what-you-need-to-become-a-full-stack-serverless-developer-1ncp)

#### [](#the-4-areas-of-development-you-need-to-know-to-call-yourself-a-fullstack-developer)成为全栈开发人员需要了解的 4 个开发领域
...
### [](#front-end-website-hosting)前端/网站托管

无论何时构建任何类型的应用程序，都需要有一个前端。这是你的用户将会看到的，以及他们如何与你的产品互动。

这通常是开发人员做的第一个无服务器技能，通常没有意识到这一点。这通常是通过 GitHub 页面或托管服务实现的。

虽然这些服务对于快速简单的项目托管来说很棒，但是对于更大更专业的无服务器虚拟主机来说，你需要更强大的服务。

#### [](#what-youll-need-to-be-able-to-do)你需要能够做什么

*   能够托管前端应用程序所需的文件。
*   为了能够大规模地在给定的 URL 上提供这些文件
*   指向这些文件的注册域名

#### [](#how-to-do-this-with-serverless)如何用 Serverless 做到这一点？

*   将文件托管在亚马逊 S3(文件存储系统)上
*   创建一个 CloudFront 发行版来提供大规模的文件服务
*   使用 Route 53 注册一个域名，并将其指向 Cloudfront 发行版

#### [](#why-serverless-is-the-best-way-to-do-this)为什么无服务器是最好的方式
...
### [](#deployment-and-maintainance)部署和维护
...
[![](../Images/223c112c719ebbeb24598d82784eba4f.png)T2】](https://courses.completecoding.io/p/build-a-serverless-api/)
