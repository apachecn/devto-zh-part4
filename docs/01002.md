...
> 原文:[https://dev . to/mola MK/text-generation-with-open ai-s-GPT-2-react-and-flask-27jk](https://dev.to/molamk/text-generation-with-openai-s-gpt-2-react-and-flask-27jk)
...
[![GPT-2 Generator with React & Flask](img/98ad83458ed597a55217364f378d1366.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F1SKRaxp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/08xvqqgideapb7dnu5ef.png)

## [](#generating-text-with-gpt2)用 GPT 生成文本-2
...
## [](#building-the-flask-app)构建烧瓶 app
...
## [](#grab-the-code-from-github)从 Github 抓取代码
