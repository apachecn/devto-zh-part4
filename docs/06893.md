...
> 原文:[https://dev . to/hoffmann/cannot-read-property-digest-of-undefined-51np](https://dev.to/hoffmann/cannot-read-property-digest-of-undefined-51np)

我刚刚在试图从`SHA265(Date())`生成一个简单的唯一标识符时遇到了最奇怪的错误。

# [](#the-problem)问题

[![Cannot read property 'digest' of undefined](../Images/5a61f4e00aa611e8ce57193e6e7254ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C27YwOMb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/01r6ku1wwjgatxvm21du.png)
