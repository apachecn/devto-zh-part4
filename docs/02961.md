...
> 原文:[https://dev.to/sergey_telpuk/write-rbac-for-nestjs-1ike](https://dev.to/sergey_telpuk/write-rbac-for-nestjs-1ike)
...
### [](#storage-consists-of-the-following-keys)存储由以下键组成:
...
### [](#using-rbac-like-an-unchangeable-storage)利用 RBAC 就像一个不可改变的储藏
...
### [](#using-rbac-like-a-dynamic-storage)利用 RBAC 像一个动态存储器
...
#### [](#using-the-custom-filters)使用自定义过滤器
