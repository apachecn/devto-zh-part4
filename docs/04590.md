...
> 原文:[https://dev . to/Dai _ Shi/4-options-to-prevent-extra-re renders-with-react-context-4e5c](https://dev.to/dai_shi/4-options-to-prevent-extra-rerenders-with-react-context-4e5c)

##### [](#how-do-you-like-reacttracked)你怎么喜欢被追踪的反应
...
### [](#option-1-split-contexts)选项 1:拆分上下文
...
### [](#option-2-reactmemo)选项二:React.memo
...
### [](#option-4-reacttracked)选项 4:反应-跟踪
...
### [](#what-is-state-usage-tracking)什么是状态使用追踪
