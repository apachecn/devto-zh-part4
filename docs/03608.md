...
> 原文:[https://dev . to/gajus/captureing-stdout-stderr-in-node-js-using-domain-module-146 a](https://dev.to/gajus/capturing-stdout-stderr-in-node-js-using-domain-module-146a)
...
## [](#a-notice-about-deprecation)关于“弃用”的通知

早些时候，当我发表这篇文章的一个变体时，一些人评论说域模块已经过时了，不应该使用它。

[![Deprecation notice](img/8d3c5810e4f4a7a1b4c7fc4c56db2926.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Yi75WqNT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t6gap6mnc9z6laymrfav.png)
