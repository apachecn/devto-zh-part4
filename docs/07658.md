...
> 原文:[https://dev . to/ogwurjohnson/prototypal-inheritance-a-trip-back-in-time-2f 70](https://dev.to/ogwurujohnson/prototypal-inheritance-a-trip-back-in-time-2f70)
...
#### [](#inheritance-using-prototypes)继承使用原型:
