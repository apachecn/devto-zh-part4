...
> 原文:[https://dev . to/tetiana _ ftv/what-is-PAAs-platform-as-a-service-types-explained-384 o](https://dev.to/tetiana_ftv/what-is-paas-platform-as-a-service-types-explained-384o)
...
[![](../Images/88b0286ede6375c03d7ce97afd221cf1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WAttvdLJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uxs1riqb0t7ah007fszu.png)

## [](#purposedriven-categories-of-paas)目的驱动的 PaaS 类别
...
## [](#abstraction-levels-of-paas)平台即服务的抽象层次
...
## [](#functionality-and-services-integrated-to-paas)集成到 PaaS 的功能和服务
...
## [](#make-the-paas-choice)做出 PaaS 选择
