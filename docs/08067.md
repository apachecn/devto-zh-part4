...
> 原文:[https://dev . to/thorn ing _ m/have-you-used-react-object-components-191 p](https://dev.to/thorning_m/have-you-used-react-object-components-191p)
...
[![console output of childObject](../Images/4295c569a2ecfac8bed7febe98ce1bcb.png)T2】](///static/3a80162e10c030c59c48b848f0edba00/a7957/childObject.jpg)

对象有两个属性，一个是我们刚刚设置的`name`属性，另一个是`__proto___`属性。`__proto__`不像`name`那样是一个实际的属性，它是对象内部原型的一个访问器属性。我们可以展开这些来查看我们的原型链:

[![expanded output of childObject](../Images/2128916544005a246974d3d0ce9ffa33.png)T2】](///static/4b8b5b52e183b31a0f9fe103a2a8f4a2/a7957/childObject_expanded.jpg)
...
## [](#extending-reactcomponent)延伸反应。成分
