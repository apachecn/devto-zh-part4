...
> 原文:[https://dev . to/web deasy/you-should-avoid-these-7-CSS-no-gos-2kj](https://dev.to/webdeasy/you-should-avoid-these-7-css-no-gos-2kj)

## [](#updated-version-is-available-click)*[更新版本可用(点击)！](https://webdeasy.de/en/css-tips/)🔥*
...
# [](#2-unsuitable-class-names)2。不合适的类名

如果您想让其他开发人员定制代码，这种禁忌非常重要。类似于精心选择的注释，类名对于可读代码来说是重要的一步。

关于这一点，我们必须区分三个错误。

## [](#21-too-short-meaningless)2.1 太短——无意义
...
## [](#22-identical-to-html-tag)2.2 与 HTML 标签相同
...
# [](#6-too-much-absolute-positioning)6。太多的绝对定位
