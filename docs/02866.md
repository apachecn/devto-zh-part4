...
> 原文:[https://dev . to/Kyle Galbraith/impressive-infra structure-as-code-using-AWS-CDK-1l8c](https://dev.to/kylegalbraith/imperative-infrastructure-as-code-using-aws-cdk-1l8c)
...
### [](#using-cdk-for-infrastructure-as-code)使用 CDK 为基础设施作为代码
...
[![CloudFormation Stack via CDK](img/87964e31697fd88e62d655645418d145.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6WAikVoA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7rz5gnlyy3b4ebzdf3p3.PNG)
...
### [](#aws-cdk-blurs-the-lines)AWS CDK 模糊了线条
...
[![Whaaat](img/1504704ee019039d889cf426a7b010ce.png)T2】](https://i.giphy.com/media/3o6ZsTIiPJG6vcqop2/giphy.gif)
...
### [](#want-to-check-out-my-other-projects)想看看我的其他项目？
