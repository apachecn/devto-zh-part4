...
> 原文:[https://dev.to/kendru/repl-crash-course-2p0](https://dev.to/kendru/repl-crash-course-2p0)
...
## [](#understanding-the-repl)了解 REPL

正如我们上面提到的，REPL 代表*读取-评估-打印循环*，因为它*读取*我们在提示符下键入的每个表达式，*在 web 浏览器的上下文中评估*该表达式，*在我们的命令行中打印*该表达式的结果。下图说明了这一过程:

[![The Read-Eval-Print Loop](img/bf78ccf70bb610ebdf041fe02aaf17a9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wmQdOQsv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter7/repl-overview.png)
...
## [](#using-a-repl-for-browser-interaction)使用 REPL 进行浏览器交互
...
[![Loading a ClojureScript REPL](img/8b73316281e57d6478145dbdb7aa24b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aglTKnZD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter7/loading_figwheel_repl.png)
...
[![REPL-Driven Development Workflow](img/caef6c791350dfa1e1c72ef943aeef90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ev2Sucm9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter7/repl_driven_development.png)
...
[![Breaking Down the REPL](img/68da00d666e6f53db5c870f70949248d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b6XZ344V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter7/repl_breakdown.png)
...
### [](#running-code-in-a-browser)在浏览器中运行代码
...
[![Figwheel Client/Server Communication](img/e43ad980b9317dd7b87e65fd8d09ee77.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QDpZeTpg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter7/figwheel-overview.png)
