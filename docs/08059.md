...
> 原文:[https://dev . to/gsilvapt/securing-containers-with-proxy-reverses-224k](https://dev.to/gsilvapt/securing-containers-with-proxy-reverses-224k)
...
## [](#lesson-0-set-up-authentication-for-all-persistence-layers)第 0 课:为所有持久层设置身份验证
...
## [](#lesson-1-close-all-ports-you-dont-need)第一课:关闭所有不需要的端口。
...
## [](#lesson-2-setting-the-containers-ports-properly)第 2 课:正确设置容器端口
...
## [](#lesson-4-reverse-proxy-all-the-things)第四课:反向代理一切事物！
