...
> 原文:[https://dev . to/hackersandslackers/managing-relationships-in-sqlalchemy-data-models-5200](https://dev.to/hackersandslackers/managing-relationships-in-sqlalchemy-data-models-5200)

[![Managing Relationships in SQLAlchemy Data Models](../Images/485e17a82b1c07468844da3ef253ed8e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SJ7oLQP---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.googleapis.com/hackersandslackers-cdn/2019/07/sqlalchemy-relationships.jpg)
...
### [](#creating-tables-from-our-models)从我们的模型创建表格
...
### [](#bonus-adding-a-record)加成:增加一条记录
...
## [](#onetomany-amp-manytoone-relationships)一对多&多对一关系
...
## [](#manytomany-relationships)多对多关系
