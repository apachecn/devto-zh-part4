...
> 原文:[https://dev.to/danielw/cookie-expiry-pitfalls-2g2b](https://dev.to/danielw/cookie-expiry-pitfalls-2g2b)

我只是偶然发现了一些关于 cookies 的浏览器行为，这些行为对我来说似乎非常奇怪，但事实证明是非常明显的，并且有很好的记录。我想我应该分享一下我学到的东西，以防你们中的一些人可能也没有遇到过这种情况。

## [](#session-cookie-expiry)会话 Cookie 到期
...
[![A screenshot of the Firefox settings startpage showing the checked option 'Restore previous session'](../Images/bc57348e1788a526c57fc9668fb60670.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RLcm73Jd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4xxeayfb9s1gcce6dqu7.png)
