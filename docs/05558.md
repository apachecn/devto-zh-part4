...
> 原文:[https://dev . to/angular/angular-performance-performance-budgets-with-the-angular-CLI-ggn](https://dev.to/angular/angular-performance-performance-budgets-with-the-angular-cli-ggn)
...
## [](#configuring-performance-budgets)配置绩效预算
