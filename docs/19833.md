...
> 原文:[https://dev . to/newtonmunene _ yg/stencil-as-a-design-system-tool-3886](https://dev.to/newtonmunene_yg/stencil-as-a-design-system-tool-3886)
...
#### [](#1-evaluate-your-current-design)1。评估你当前的设计。

看看你目前的设计，决定你想保留什么，想放弃什么。在此过程中，添加任何其他缺失的内容。

#### [](#2-implement-a-design-languageguideline)2。实施设计语言/指南。

这包括颜色、字体和版式、间距和边距、形状等。比如圆角，一些独特的字体，5 px 的边距，黄色？实现它。

#### [](#3-decide-on-a-pattern)3。决定一个模式。

你已经有了你想保留的东西和一种设计语言。现在就一个模式达成一致:行动按钮、活动和非活动元素、元素的位置、字体大小等等。

#### [](#4-document-your-components)4。记录您的组件。
...
[![Screenshot (8).png](../Images/dc3e1d1c56f2eb0d31a381cb21f47326.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RJj0yIKM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1559894932578/jQkoZ4u7i.png)
