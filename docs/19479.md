...
> 原文:[https://dev . to/oieduardorabelo/AWS-server less-API-gateway-e-CORS-36 on](https://dev.to/oieduardorabelo/aws-serverless-api-gateway-e-cors-36on)

## [](#o-seu-guia-de-sobreviv%C3%AAncia-sobre-serverless-apis)您的无服务器 API 生存指南
...
# [](#solicita%C3%A7%C3%B5es-de-comprova%C3%A7%C3%A3o-preflight-requests)验证请求(*印前检查请求*
...
# [](#como-fa%C3%A7o-para-lidar-com-solicita%C3%A7%C3%B5es-de-preflight-com-o-serverless)我如何处理与服务器无关的印前检查请求？
...
# [](#cabe%C3%A7alhos-de-resposta-cors)颜色应答标头
...
# [](#cors-com-autoriza%C3%A7%C3%B5es-personalizadas)具有自定义授权的颜色
...
# [](#cors-com-credenciais-de-cookie)带有 Cookie 凭据的颜色
