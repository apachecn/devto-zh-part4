...
> 原文:[https://dev . to/Jared Wolff/how-to-define-your-bluetooth-low-energy-service-141k](https://dev.to/jaredwolff/how-to-define-your-bluetooth-low-energy-service-141k)
...
[![Door Peoeple](../Images/d6625933188dcfeda1540277f71c597a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DcljUzmF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-protocol-buffer-bluetooth-low-energy-service-part-2/images/doorman.jpg)
...
## [](#creating-the-characteristic)创建特性

[![Open Those PICKLES!](../Images/8d3dbb6533bc47a5d64377234c9cccae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jg-PQSg---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-protocol-buffer-bluetooth-low-energy-service-part-2/images/man-641691_1280.jpg)

Nordic 有一种相当直接的方式来初始化每个服务中的独立特征。对于每个特性，都有一个`char_add`函数，该函数随后配置特性并将其添加到服务中。

### [](#configure-your-characteristic-with-raw-bleaddcharparamst-endraw-)用`ble_add_char_params_t`配置你的特性
...
## [](#what-happens-when-this-characteristic-is-written-to)当这个特征被写入时会发生什么？

[![Smoke Signal](../Images/3fe54329235d0d0e078c13569a417b7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Svd5FRdr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-protocol-buffer-bluetooth-low-energy-service-part-2/images/person-629676_1280.jpg)
