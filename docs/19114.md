...
> 原文:[https://dev . to/samholmes/reactive-programming-in-JavaScript-141 o](https://dev.to/samholmes/reactive-programming-in-javascript-141o)

反应式编程是一种关注变化传播的声明式编程范例。如果你想要一个完整的解释，我推荐你阅读保罗·斯托弗的文章《什么是反应式编程》？在本文中，我将向您展示如何用 JavaScript 实现一个反应式编程环境。

# [](#state-as-a-graph)状态为图形
