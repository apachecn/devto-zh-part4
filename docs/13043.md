...
> 原文:[https://dev . to/pvam Shi/simplify-reduce-accumulator-function-code-1ip](https://dev.to/pvamshi/simplify-reduce-accumulator-function-code-1ip)
...
### [](#solution-1-spread-operator)方案一:传播算子
...
### [](#solution-2-comma-operator)方案二:逗号运算符
