...
> 原文:[https://dev . to/bow lendev/yup-formik-react-differential-drop-downs-2bgg](https://dev.to/bowlendev/yup-formik-react-differing-drop-downs-2bgg)

这需要熟悉 Formik、Yep 和 React。

今天我从耶那里学到了一些很酷的东西。假设您有两个下拉框或字段，并且您希望确保它们是不同的。有一个很好的方法可以让 Yup 和 Formik 做到这一点。

[![ice cream cones](../Images/38c89ec8b1037d3df08de3166492e4cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gxwZWnYf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/0%2AARQILtKA_G-Opnp8)
