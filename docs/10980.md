...
> 原文:[https://dev . to/ziaulrehman 40/part-1-converting-react-native-app-to-react-native-web-react-pwa-in-monorepo-architecture-4no](https://dev.to/ziaulrehman40/part-1-converting-react-native-app-to-react-native-web-react-pwa-in-monorepo-architecture-4no)
...
### [](#initial-monorepo-setup)初始单回购设置:
...
## [](#importing-existing-app-to-this-new-setup)将现有应用程序导入新设置

### [](#lets-start-with-dependencies)先说依赖关系
...
### [](#now-import-actual-code)现在导入实际代码
...
### [](#linking-libraries-and-raw-xcode-endraw-fixes-for-our-app)为我们的应用程序链接库和`xcode`修复
...
#### [](#strange-raw-path-endraw-and-raw-fs-endraw-errors)奇怪的`path`和`fs`错误
...
那是我浪费了很多时间的部分。在这之后，我重试了建设，低，看！另一个错误——当然是 [![😀](../Images/193be02fea5ea08f1d6a70ca78222a2d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--qgur0s-_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s0.wp.com/wp-content/mu-plugins/wpcom-smileys/twemoji/2/72x72/1f600.png)

#### [](#-endraw-reactnative-native-module-cannot-be-null-raw-errors)`react-native native module cannot be null`错误
...
### [](#boom-mobile-app-is-running-in-monorepo-setup)轰！移动应用程序正在 monorepo 设置中运行！
...
[![download](../Images/36965c27471ad4fbe048ecc18d66752f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P8D22pFE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ziatechblog.files.wordpress.com/2019/07/download.jpeg)
