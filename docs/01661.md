...
> 原文:[https://dev . to/mrlopis/creating-a-13kb-js-game-using-SVG-5fjk](https://dev.to/mrlopis/creating-a-13kb-js-game-using-svg-5fjk)
...
## [](#choice-of-graphics)选择图形

去年，我用 2D 画布开发了一个游戏。画布非常灵活且易于使用。您可以通过在 javascript 中动态生成自己的图形来节省大量字节。

[![Paper prototypes](img/c6fc65c5874c13462795119ac2d7f49b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--satvrxy4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/51sqxgk3fw7b9kyk736t.jpg)
...
## [](#creating-and-manipulating-svgs)创建和操作 SVG

我的 goto 矢量图像编辑器是 [Inkscape](https://inkscape.org/) 。它是 libre 软件，可以在 Linux 上运行，也可以在其他操作系统上运行(甚至更好)。我已经用了好几年了，所以我用起来相当舒服。

[![Screenshot of Inkscape](img/2984c77ea2f5fe8f705bfa7723cfb733.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VhwagtWn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wbpugf0hqbd5u238b94q.png)
...
## [](#saving-and-optimizing-svgs)保存和优化 SVG
...
[![Alt Text](img/af6c3c3d120570d5d99fd44817b74727.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V5dU6yO3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q1gk3h6v6onyuax53bmq.png)
...
[![Alt Text](img/cf6c4ea285c7ba6ef271e416c9b55ba8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2Rg5-GCg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5swer3mgclzid5pv5fy8.gif)
...
## [](#animating-dots-on-an-svg)在 SVG 上制作点动画
...
[![Alt Text](img/db1005fd0313b7bf318dfab20734a9d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OhKM36g2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vf7ymx63vx85haiqvpgb.gif)
...
[![Alt Text](img/6b00526402e6ae4337e159402c9a2c48.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yznS8Zxg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d01w02z0i5tx3brkp431.png)

# [](#animating-gradient-backgrounds)制作渐变背景动画

另一个可能没人注意到的动画，是游戏开头的烟雾动画。玩家第一次得到木头，游戏中的人就开始烧木头。

[![Alt Text](img/5f825c18faedc20c93bb04d765da1605.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--88cC48wU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4c8yho3eh99nap2no57d.gif)
...
## [](#moving-svg-elements-around)四处移动 SVG 元素
