...
> 原文:[https://dev . to/voyeg3r/get-YouTube-video-title-on-termux-13j](https://dev.to/voyeg3r/get-youtube-video-title-on-termux-13j)
...
## [](#setting-pbcopy-and-pbpaste-using-termux)使用 termux 设置 pbcopy 和 pbpaste
