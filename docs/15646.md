...
> 原文:[https://dev . to/rish ikc/architecting-react-applications-what-I-learn-from-my-experience-as-a-web-developer-4 ma5](https://dev.to/rishikc/architecting-react-applications-what-i-learned-from-my-experience-as-a-web-developer-4ma5)
...
[![base-structure-1](../Images/bcd1967a3a95665c8f1a051d04414450.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FyDcITIe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cbtdcexf4ka1k26uo0w9.png)

`src`目录(当然，它将包含我们应用程序的所有源代码)的结构如下:

[![base-structure-2](../Images/62e7ee9f618d631a95304e7e64904b90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nzghBwAd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3tdgfh322vv6fzacp9xk.png)

你可能会注意到的第一件事，也许会想——如果你没有注意到，我建议你再看一看——我们的项目中有两个名为`config`的目录。不，这不是错误！它有一个(极其)简单的原因。

## [](#two-config-directories-for-a-single-web-application-why-though)一个 web 应用有两个配置目录？！为什么呢？？

根目录下的`config`目录包含所有与构建相关的配置文件——比如我们的应用程序的 webpack 配置或我们可能使用的任何其他捆绑器、环境文件和其他配置。

[![config directory snapshot](../Images/faae68f415fc0f66f8920be4599536ac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eEJEI_d1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1twwvxasthjnqgz9cb3j.png)
...
## [](#but-wait-what-about-the-raw-resources-endraw-and-raw-assets-endraw-directories-arent-assets-also-a-part-of-the-resources-for-our-react-application)但是等等，`resources`和`assets`目录呢？资产不也是 react 应用程序的“资源”的一部分吗？

[![good question](../Images/195ddb2837d26aa0fbe619aea7ad72ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3NeZwmVs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kcru8h1hobcji7k0jr0j.jpg)
...
[![welcome](../Images/ee763ff18e183223fb0d11b72355af9d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nhYmOlIw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lk0v387uovf7b9wdjkt5.jpg)
...
## [](#but-wait-theres-more-to-architecting-react-applications)但是等等..react 应用程序的架构远不止这些！！
