...
> 原文:[https://dev . to/imben 1109/date-handling-in-angular-application-part-1-JSON-and-JavaScript-date-object-study-2p 54](https://dev.to/imben1109/date-handling-in-angular-application-part-1-json-and-javascript-date-object-study-2p54)
...
# [](#javascript-date-object)JavaScript 日期对象
...
## [](#time-zone-and-locale-dependent)取决于时区和区域设置
...
## [](#iso-format-time-zone-and-locale-independent)ISO 格式(独立于时区和区域设置)
...
## [](#revert-json-to-javascript-object)将 JSON 还原为 JavaScript 对象
...
# [](#summary-of-json-date-and-javascript-date-object)汇总 JSON 日期和 JavaScript 日期对象
