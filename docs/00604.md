...
> 原文:[https://dev.to/ionic/react-ionic-framework-and-hooks-5135](https://dev.to/ionic/react-ionic-framework-and-hooks-5135)
...
## [](#lets-start-with-the-usereducer-api)让我们从 useReducer API 开始
...
### [](#modify-values-in-the-state)修改状态中的值
...
## [](#displaying-a-modal-for-user-input)显示一个模态供用户输入

[![Alt Text](img/03f9b7a094f6b6e41223d814991cacaf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GJMLlI0Y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/drmn0kvamdgvedgnuz9c.png)
...
## [](#managing-the-input-value-using-usestate)使用 useState 管理输入值
...
## [](#displaying-the-list-of-things)显示事物的列表
...
[https://www.youtube.com/embed/eX_L39UvZes](https://www.youtube.com/embed/eX_L39UvZes)T2】
