...
> 原文:[https://dev . to/kotest/testing-koin-applications-with-kotlistest-1 IP](https://dev.to/kotest/testing-koin-applications-with-kotlintest-1iip)
...
## [](#add-koinlistener-to-the-class)将 KoinListener 添加到类中
