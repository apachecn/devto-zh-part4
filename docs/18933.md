...
> 原文:[https://dev . to/teckert/encryption-and-decryption-with-python-azure-functions-4f 05](https://dev.to/teckert/encryption-and-decryption-with-python-azure-functions-4f05)
...
## [](#initialize-your-azure-function-app)初始化你的 Azure 功能 App
...
## [](#create-the-raw-encrypt-endraw-function)创建`encrypt`功能
...
## [](#using-raw-encrypt-endraw-)使用`encrypt`
...
## [](#testing-raw-encrypt-endraw-)测试`encrypt`
...
## [](#create-the-raw-decrypt-endraw-function)创建`decrypt`功能
...
## [](#using-raw-decrypt-endraw-)使用`decrypt`
...
## [](#testing-raw-decrypt-endraw-)测试`decrypt`
