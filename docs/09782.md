...
> 原文:[https://dev . to/icy phox/picking-the-fb50-smart-lock-CVE-2019-13143-boi](https://dev.to/icyphox/picking-the-fb50-smart-lock-cve-2019-13143-boi)
...
### [](#via-bluetooth-low-energy-ble)通过蓝牙低能耗(BLE)

Android 手机能够捕获蓝牙(HCI)流量，可以在设置下的开发者选项中启用。我们在 Android 手机上做了大约 4 次“解锁”，如截图所示。

[![wireshark packets](../Images/e9f2a810c04749d804886327dfb4890b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--omrnbuWL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://icyphox.sh/static/img/bt_wireshark.png)

这是在`Write`请求中发送的值:

[![wireshark write req](../Images/41faf858efccd1f6bc335a157f52927d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_uinGBIG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://icyphox.sh/static/img/bt_ws_value.png)

我们尝试使用`gattool`和`gattacker`来重放这些请求，但是没有成功，因为写入的值是加密的。 <sup id="fnref-1">[1](#fn-1)</sup>

### [](#via-the-android-app)通过 Android 应用程序
...
### [](#thats-it-amp-the-scary-stuff)就是这样！(&吓人的玩意儿)
