...
> 原文:[https://dev . to/hurricane interactive/keeping-track-of-my-coffees-with-Google-actions-3362](https://dev.to/hurricaneinteractive/keeping-track-of-my-coffees-with-google-actions-3362)
...
## [](#displaying-from-firebase)显示来自火场
