...
> 原文:[https://dev . to/sendilkumarn/9-tips-to-increase-your-Java-performance-1l4d](https://dev.to/sendilkumarn/9-tips-to-increase-your-java-performance-1l4d)
...
[![](../Images/7a6e3cbf9d167cfb8740fb5d5d21e51f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--N4teI6Sv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/15159pnizjj24gjuimqr.gif)

> 所有测试都是在 Macbook Pro 2017 笔记本电脑中的 OpenJDK 12.0.1 中进行的。

# [](#1-instantiate-in-constructor)1。在构造函数中实例化
...
# [](#2-addall-is-faster-than-add)2。AddAll 比 Add 快
...
# [](#3-use-raw-entryset-endraw-for-map-over-raw-keyset-endraw-)3。将`EntrySet`用于`KeySet`上方的地图
...
# [](#5-use-raw-enumset-endraw-instead-of-raw-hashset-endraw-raw-enumset-endraw-is-much-faster)5。用`EnumSet`代替`HashSet`。`EnumSet`要快得多。
...
# [](#6-do-not-initialize-objects-at-will-try-to-reuse-at-the-maximum)6。不要随意初始化对象。尽量重复使用。
...
# [](#8-if-you-are-using-string-with-a-single-character-replace-them-with-a-raw-character-endraw-)8。如果你使用的字符串只有一个字符，用`Character`替换它们
...
# [](#9-use-stringbuilder-wherever-you-can)9。尽可能使用 [StringBuilder](https://docs.oracle.com/javase/7/docs/api/java/lang/StringBuilder.html) 。
