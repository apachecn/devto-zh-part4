...
## [](#javascript-por-baixo-dos-panos)布下 JavaScript
...
### [](#engines-javascript)引擎 JavaScript
...
[![Imagem da pilha de sessões, nas referências](img/e93c9bf4921d969cef4cc66c871bc926.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M1-XdaOR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/khaosdoctor/my-notes/raw/master/node/assets/v8-simplified.png)
...
### [](#o-runtime-javascript)O 运行时 JavaScript
...
#### [](#pilhas-e-javascript)栈和 JavaScript
...
### [](#pr%C3%B3s-e-contras-de-singlethreading)单线程
