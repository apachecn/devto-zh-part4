...
> 原文:[https://dev.to/gc_psk/writing-scalable-typescript-1i96](https://dev.to/gc_psk/writing-scalable-typescript-1i96)

## [](#lets-explore-in-detail-how-to-write-clean-safe-enterprisegrade-typescript-code)让我们详细探讨如何编写干净、安全的企业级打字稿代码
...
## [](#use-linters-and-formatters)使用棉条和格式化器
...
## [](#use-strict-compiler%C2%A0options)使用严格的编译器选项
...
### [](#strict-null%C2%A0checks)严格的空检查
...
[![](img/5c7d65595974bb4f17e9555f8e95ec59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QOt0WkC0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ASuRzMd87h2lH9tqgyNKj_w.png)
...
[![](img/216537f33a7d3e6389ff185353bbe900.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_DB4k_Uq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AkQLu2mtugqhAWYJpM61JiQ.png)

这些例子看起来微不足道，而且极其简单，但是在专业代码库中发现类似的情况却非常普遍。

好的一面是，`strictNullChecks`在更多人为的场景中帮助了我们。

## [](#type-well-type%C2%A0often)型井，型常
...
[![](img/cc8d23187bf709884749c04716c7031f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5xKVcR0k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Aq5cL6jF2ICpRbWkPKWhpFw.png)
...
## [](#clean-typescript-code)清理打字稿代码

### [](#use-predictable-naming-conventions)使用可预测的命名约定
...
[![](img/9ef8588b90e9911f70a808b55d6db2c1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pG4GJqF6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AjAvSp7tyXSfZmhe_ZNzE-Q.png)
...
[![](img/588240b235ff56d2c5c9b9769f70e76f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zHM7t8Kg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A_1zVUzTV4cmAwS_p8Ki9fw.png)

然后，我可以从`@core/interfaces`访问我的所有接口，从`enums.`访问我的所有枚举

[![](img/bcde216a33b94f79e4c1a810e70f8a4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CP7WO0AY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A_VwO_1qoi2i1aoU0mTfaVw.png)

### [](#prefer-horizontal-reading)偏爱横向阅读
...
[![](img/9092a97a074e33f3c61df2e49adba56d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---2y7-nVx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AHuZwRELp053NnZV_wWChEA.png)

在下图中，它被设置为 80。

[![](img/ee817bb00a8f1a37dd474f470f579d79.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z2pYKijq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AbAg9o5s4LXTRnYLE0zUnjw.png)
...
[![](img/dcaa07b7403624b22724b4702cf4289a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---1T52GEp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ASX0FtvRe_HRsUAWcMTBs6g.png)

并且没有箭头功能:

[![](img/24aa6c22b632ded8d6cd1a4a6dd346ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2l2XHe32--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AEzXx8gQCcuhglxaQl2vAbQ.png)

仍然使用箭头函数并将表达式放在下一行是完全可能的，但是当我碰巧重构代码时，我觉得这会增加复杂性，例如，如果我需要在表达式中添加一个变量。

如果你用一个箭头函数来包装它，这是非常好的，确保这段代码不会很快被修改。

### [](#use-logical%C2%A0spacing)使用逻辑间距
...
### [](#break-complex-expressions-down)分解复杂的表情
