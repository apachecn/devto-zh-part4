...
> 原文:[https://dev . to/bnevilleoneill/how-do-scroll-linked-animations-the-right-way-4549](https://dev.to/bnevilleoneill/how-to-do-scroll-linked-animations-the-right-way-4549)

[![](../Images/432930d71f11483a48e691137e1dd307.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p7daOSlW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/swofayrb414g4rwryvma.png)
...
### [](#discrete-scrolling-effects-with-intersectionobserver)用 IntersectionObserver 实现离散滚动效果
...
[![](../Images/3a40701caaba3bc45aa6bc52492fdac1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NJQXF1_W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zu084jm248canovdtyhg.gif)

然而，这不包括当用户滚动时连续出现的滚动链接动画。一个例子是视差效应。在这些情况下，如果需要滚动事件处理程序，有几种解决方法。这些方法适用于所有高频率的事件处理程序，重点是减少处理程序被调用的次数。

### [](#continuous-scrolling-effects-with-debouncing-and-throttling)带去抖动和节流的连续滚动效果
...
### [](#other-scrolllinked-animations)**其他滚动链接动画**
