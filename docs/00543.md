...
> 原文:[https://dev . to/flipped coding/build-and-publishing-a-NPM-package-with-JavaScript-gi9](https://dev.to/flippedcoding/building-and-publishing-a-npm-package-with-javascript-gi9)
...
## [](#steps-to-create-a-library)创建库的步骤
