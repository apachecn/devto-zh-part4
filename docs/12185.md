...
> 原文:[https://dev . to/riccardoodone/building-a-blog-in-haskell-with-yesod-using-a-database-41ip](https://dev.to/riccardoodone/building-a-blog-in-haskell-with-yesod-using-a-database-41ip)
...
## [](#interacting-with-sqlite3)与 SQLite3 交互
...
## [](#login-user-only-if-in-database)仅在数据库中登录用户
...
## [](#create-post-in-database)在数据库中创建帖子
