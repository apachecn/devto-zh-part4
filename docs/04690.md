...
> 原文:[https://dev . to/wiredviews/ken tico-CMS-quick-tip-fluentcachekeys-consistent-cache-dependency-key-generation-9ek](https://dev.to/wiredviews/kentico-cms-quick-tip-fluentcachekeys-consistent-cache-dependency-key-generation-9ek)

<figure>

[![keys](../Images/deb3d7363f84d06939d34fb58dd911b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zuJiRRg3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qz775qwmt5cyve6w6a70.jpg)

<figcaption>Photo by [Florian Berger](https://unsplash.com/@bergerteam) on [Unsplash](https://unsplash.com)</figcaption>

</figure>

## [](#kentico-caching)肯蒂科💕贮藏
...
## [](#the-importance-of-cache-dependency-keys)缓存依赖键的重要性

在之前的一篇文章中(链接如下),我写了如何使用软件设计模式缓存数据库查询的结果，比如面向方面编程、依赖注入和单一责任原则🤓。

> [![seangwright](../Images/e9e13f3e057a4f58b01316c7a9d6eeea.png)](/seangwright) [## Kentico12: Design Pattern Part 12-Database Query Cache Pattern
> 
...
## [](#building-cache-dependency-keys-can-be-tricky)构建缓存依赖键可能很棘手
...
## [](#fluentcachekeys)FluentCacheKeys
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)/[kentico-fluent-cache-keys](https://github.com/wiredviews/kentico-fluent-cache-keys)
