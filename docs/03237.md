...
> 原文:[https://dev . to/flaviabastos/getting-started-with-grpc-part-ii-the-code-27 E0](https://dev.to/flaviabastos/getting-started-with-grpc-part-ii-the-code-27e0)

在之前的一篇文章中，我写了一份关于 gRPC 的总结。这里我就说说我写的测试 gRPC 和 gRPC-Web 的原型 app。

## [](#about-my-prototype)关于我的原型
...
### [](#grpc-service-definition)gRPC 服务定义
...
### [](#generate-grpc-classes-with-protoc)用协议生成 gRPC 类
...
### [](#using-the-generated-classes-in-the-implementation)使用生成的类实现
...
[![](img/da569c11495f550db9770b6d157106eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CKij8X6I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://testfbdotblog.files.wordpress.com/2019/08/grpc_web_palindrome_test.png%3Fw%3D689)
