...
> 原文:[https://dev . to/thomaslombart/how-to-test-JavaScript-with-jest-3bkg](https://dev.to/thomaslombart/how-to-test-javascript-with-jest-3bkg)
...
### [](#set-up-before-each-test)每次测试前设置
...
### [](#configure-test-coverage)配置测试覆盖
