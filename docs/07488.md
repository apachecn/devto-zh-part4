...
> 原文:[https://dev . to/jasterix/using-a-switch-statement-with-logical-operators-17ni](https://dev.to/jasterix/using-a-switch-statement-with-logical-operators-17ni)
...
#### [](#below-is-my-initial-solution)下面是我的初步解决方案:
...
#### [](#the-proper-way-to-formulate-my-switch-statement-is)表述我的 switch 语句的正确方式是:
