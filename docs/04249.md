...
> 原文:[https://dev . to/shroom life/docker-https-proxy-to-proxy-your-docker-containers-3d 07](https://dev.to/shroomlife/docker-https-proxy-to-proxy-your-docker-containers-3d07)
...
### [](#easy-setup-with-dockercompose)使用 docker-compose 轻松设置
