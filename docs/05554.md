...
> 原文:[https://dev.to/shiena/unity-oculus-ovrheadsetemulator-2clf](https://dev.to/shiena/unity-oculus-ovrheadsetemulator-2clf)

# 前言

Unity 的 Oculus Integration 有一个`OVRHeadsetEmulator`，可以在编辑器上模拟摄像机的移动。

[![image.png](../Images/798a0966d10eaecdba4d7d9f46d1bfde.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---8I7Gpzs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/grz5hvcighfd7fsx2kva.png)
...
## [](#%E4%BF%AE%E6%AD%A3%E6%96%B9%E6%B3%95)correction method
