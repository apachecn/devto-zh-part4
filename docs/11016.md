...
> 原文:[https://dev . to/samandar/a-uri-encoder-compliant-with-RFC-3986-3d nn](https://dev.to/samandar/a-uri-encoder-compliant-with-rfc-3986-3dnn)

关于:[https://tools.ietf.org/html/rfc3986](https://tools.ietf.org/html/rfc3986)T2】
