...
> 原文:[https://dev . to/render/distributed-elixir-with-mix-releases-and-lib cluster-47 F5](https://dev.to/render/distributed-elixir-with-mix-releases-and-libcluster-47f5)
...
## [](#configure-libcluster)配置 libcluster
...
## [](#display-connected-nodes)显示连接的节点
...
## [](#update-your-app-for-render)更新你的应用程序进行渲染
...
## [](#build-your-release-locally)在本地构建您的版本
...
[![Update Server Instance Count](../Images/3b6e5d4aeeb22e067ef3d2256fedbb40.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sJxh0dfg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ib4xegfo67u5le6h4gr4.png)

实例更新开始后，您应该会在主页上看到第二个节点。

[![Screenshot of Elixir Cluster Nodes](../Images/9cde0797ee12f1eac4f835501f4d8f1b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QKheHwxT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wsxpx3ahh3dq9lx20zm1.png)
