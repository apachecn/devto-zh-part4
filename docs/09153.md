...
> 原文:[https://dev . to/jonisar/do-you-still-need-a-component-library-28kn](https://dev.to/jonisar/do-you-still-need-a-component-library-28kn)
...
### [](#pains-of-a-component-library)组件库的烦恼
...
## [](#sharing-components-in-the-cloud)云中共享组件
...
### [](#isolation-and-publishing)隔离和发布
...
### [](#discoverabilty-for-components)组件的可发现性

[![](../Images/3c0ad015fecee2a0b98ccda419526089.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tzn9rUXV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/152um623qhn68hhhev3s.png)

通过 [bit.dev](https://bit.dev) 您共享的组件对您自己和其他人来说都是可发现的，以便查找、了解和选择。

您可以通过名称在语义上搜索组件，并根据上下文相关的标签、依赖关系、包大小和更多有用的参数过滤结果。

[![](../Images/c91fc3df1a86325b72f911bcc89aa882.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mNuUylCV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qwjx019lzojitg8ck8lr.png)

[![](../Images/9dd04d2e906afc8262f52751e702b1eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2PZNhDlt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oo4yf62q2a5q3ccdaag8.png)

您可以通过可视化快照快速浏览组件，当您进入组件页面时，您可以在项目中使用它之前在现场进行尝试。您还可以查看从代码中自动解析的 API 文档，以了解它是如何工作的。

[![](../Images/105ddaee6c551e6d9d802be8e9b38568.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--D3WKZAEX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/80xlcpt4dx573mwywyj4.png)

通过 [bit.dev](https://bit.dev) 组件被可视化，以便开发人员、产品、设计人员和其他利益相关者可以协作，并且可以通用地访问组织内的所有组件。

### [](#component-consmution-and-collaboration)组件消耗和协作

一旦你找到一个你喜欢的组件，例如，你的团队或社区共享的，你可以使用像 npm 和 yarn 这样的包管理器来安装它。

[![](../Images/0ca3b4153004b252469fa206dca59046.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TUQO46VR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g0sdqofdfaz6u31bz9yg.png)

#### [](#updating-components-right-from-the-consuming-project)从消费项目中更新组件...

[![](../Images/7a8ea648c416d027ea83da07a369b18e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0aBLT8pR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/03dokozmscj1xisqmiaw.png)
...
## [](#component-library-bitdev-together)组件库+ bit.dev 一起？
