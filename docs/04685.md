...
> 原文:[https://dev . to/prodopsio/a-6-minute-introduction-to-helm-bc3](https://dev.to/prodopsio/a-6-minute-introduction-to-helm-bc3)

简化 Kubernetes 应用程序管理

[![Photo by pexels.com](../Images/2799d3aabaa6d802be7c8937c6cebfa8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--iQID_VAR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/10870/1%2ANcphW9pL31JRnmnS3HkYjQ.jpeg)*pexels.com 摄*
...
### [](#helm-is-a-cli-tiller-is-its-backend)舵是 CLI，舵柄是它的后端
...
### [](#helm-concepts-repository)掌舵概念| **知识库**
