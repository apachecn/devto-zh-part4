...
> 原文:[https://dev . to/fros nerd/understanding-the-AWS-lambda-SQS-integration-1981](https://dev.to/frosnerd/understanding-the-aws-lambda-sqs-integration-1981)
...
## [](#architecture-and-flow)架构与流程

下图展示了一个成功的消息处理过程，它包括上一节中介绍的所有三个组件:SQS 队列、Lambda 函数和事件源映射。

[![SQS lambda integration architecture](../Images/a3d17bb25bee4719307e97ca989d3907.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mkD9Ycuh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xwm4343gq6vuoxm0z1q0.png)
...
## [](#scaling-and-throttling-behaviour)缩放和节流行为
