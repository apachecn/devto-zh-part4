...
> 原文:[https://dev.to/brianemilius/get-unstuck-1m1j](https://dev.to/brianemilius/get-unstuck-1m1j)
...
## [](#cannot-read-property-xyz-of-undefined)无法读取未定义的属性‘XYZ’
...
## [](#consolelogall-the-things)Console.log(所有的事情)
...
## [](#befriend-your-debugging-tool)和你的调试工具套近乎
...
## [](#learn-to-formulate-the-problem)学会公式化问题
