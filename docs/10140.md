...
> 原文:[https://dev.to/bmpickford/rewriting-your-git-history-4p7a](https://dev.to/bmpickford/rewriting-your-git-history-4p7a)
...
## [](#1-change-most-recent-commit-message)1。更改最近的提交消息
...
# [](#the-interactive-rebase)交互式 rebase
...
## [](#3-changing-an-old-commit-message-reword)3。更改旧的提交消息(改写)
