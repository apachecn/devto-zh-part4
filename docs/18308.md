...
> 原文:[https://dev . to/Magar CIA/adaptive-media-serving-using-service-workers-1 ok2](https://dev.to/magarcia/adaptive-media-serving-using-service-workers-1ok2)
...
### [](#effectivetype-values)effectiveType 值
...
[![Browser support for Network Information API](../Images/4beb2569a5ff1deb3552da385080e1aa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bfpgCR4H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p70qnco3xhwvy8o2ar40.png)

事实上，70%的移动用户在他们的设备上启用了这个 API。

## [](#adaptive-media-serving)自适应媒体服务
