...
> 原文:[https://dev . to/bbenefield 89/creating-dispatching-custom-js-events-23mc](https://dev.to/bbenefield89/creating-dispatching-custom-js-events-23mc)
...
## [](#add-event-bubbling-to-a-custom-event)给自定义事件添加“事件冒泡”
...
## [](#triggering-events-built-into-js)触发内置于 JS 的事件
...
## [](#example-of-when-to-use)举例说明何时使用
