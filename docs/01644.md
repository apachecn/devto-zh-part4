...
> 原文:[https://dev . to/jackabox/handling-redirects-in-nuxt-js-through-middleware-413 p](https://dev.to/jackabox/handling-redirects-in-nuxt-js-through-middleware-413p)
...
### [](#create-the-servermiddleware)创建服务器中间件
...
### [](#add-to-nuxtconfigjs)添加到 Nuxt.config.js
