...
> 原文:[https://dev . to/dot net/a-quirk-with-implicit-vs-explicit-interfaces-2835](https://dev.to/dotnet/a-quirk-with-implicit-vs-explicit-interfaces-2835)
...
[![Nope](img/d89cc3b9b706b54c3987f9290932f572.png)T2】](https://giphy.com/gifs/Adpodcast-peterson-conner-connersmodernlife-cZ6FrYaMhnITWZZCzy)
 ...
 **## [](#interface-implementations-implicit-vs-explicit)接口实现，隐式 vs .显式
...
## [](#not-all-il-is-generated-the-same)不是所有的 IL 都是一样生成的
