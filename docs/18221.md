...
> 原文:[https://dev . to/mortoray/creating-a-custom-author-box-on-WordPress-26hg](https://dev.to/mortoray/creating-a-custom-author-box-on-wordpress-26hg)

在 WordPress 上定制作者框比我想象的更有挑战性。我检查了几个插件，并选择在主题中创建一个 PHP 函数。这里我来看看我做了什么。

# [](#all-the-plugins)所有插件
...
[![](../Images/8183db8da683e47ad691f80422508d2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---4vra95W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mortoray.files.wordpress.com/2019/06/author-box-sample.png)

# [](#fields-and-raw-gettheauthormeta-endraw-)字段和`get_the_author_meta`
