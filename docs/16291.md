...
> 原文:[https://dev . to/couch/analyzing-league-of-legends-data-with-r-2kcc](https://dev.to/couch/analyzing-league-of-legends-data-with-r-2kcc)

## [](#sourcing-the-data)采集数据
