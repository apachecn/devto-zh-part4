...
> 原文:[https://dev . to/thdotnet/implementing-a-server less-saga-orchestrator-50d 6](https://dev.to/thdotnet/implementing-a-serverless-saga-orchestrator-50d6)
...
## [](#what-is-happening-under-the-hood)引擎盖下发生了什么？
