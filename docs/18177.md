...
> 原文:[https://dev.to/sandrogiacom/multiple-jdks-no-problem-1knc](https://dev.to/sandrogiacom/multiple-jdks-no-problem-1knc)
...
# [](#installing-openjdk-11-with-jdk-8)用 JDK 8 安装 OpenJDK 11
...
## [](#adding-java-versions-to-jenv)给 jEnv 添加 Java 版本:
