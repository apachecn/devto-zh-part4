...
> 原文:[https://dev . to/John boy 5358/it-s-all true-first steps-in-functional-JavaScript-19k 3](https://dev.to/johnboy5358/it-s-alltrue-firststeps-in-functional-javascript-19k3)

## [](#who-is-this-for)这是给谁的？

任何对初级/中级水平的函数式编程感兴趣的人(不管那是什么意思！)并将“倾听”我的沉思。

## [](#kicking-of-with-alltrue)同 allTrue 的踢法
...
## [](#its-all-thanks-to-curry)这都要感谢库里
