...
> 原文:[https://dev . to/nikolicbojan/azure-devo PS-YAML-build-for-mono-repository-with-multi-projects-146g](https://dev.to/nikolicbojan/azure-devops-yaml-build-for-mono-repository-with-multiple-projects-146g)
...
# [](#move-to-mono-repository)移动到单声道储存库
...
## [](#build-definition-changes)构建定义修改
...
# [](#one-build-to-rule-them-all)一个人建造来统治他们所有人
...
## [](#powershell-yaml-to-the-resque)PowerShell + YAML 到 resque！
...
# [](#queue-build-manually-with-a-list-of-services-to-buils)手动队列构建，包含要构建的服务列表
