...
> 原文:[https://dev.to/david_ojeda/my-privacy-setup-3k49](https://dev.to/david_ojeda/my-privacy-setup-3k49)

在这个现代世界中，最珍贵的东西之一就是数据，我们自己的个人数据。

[![Knowledge is power Game Of Thrones GIF](../Images/acddfe9f425be1e69d3f3a713549217b.png)T2】](https://i.giphy.com/media/10fAvEln0lB8Lm/giphy.gif)
...
[![Twitter's privacy settings](../Images/d7e82ebbc57c745d89eff7dfe33d5ce3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qx4cZQYi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t8nxxn9aa5ptefiy5zqq.png)

现在让我们来看看我使用的应用程序！

* * *

## [](#brave)[勇敢](https://brave.com/) ![Brave logo](../Images/0983b9563b502ab62f3f3e29b424bcd5.png)

一个开源的隐私优先浏览器，默认带有广告和跟踪拦截器。自从我切换以来，我从未错过 Chrome 或 Firefox。

它基于 Chromium，所以您可以使用所有的开发工具选项。它还能让你用 Tor 打开新标签页，获得真正的私人体验。

## [](#duckduckgo)[鸭子鸭子](https://duckduckgo.com/about) ![DuckDuckGo](../Images/43b33302fc0e1cf61aace9d8993494df.png)

隐私优先的搜索引擎。DuckDuckGo 不会存储您的任何搜索，也不会以任何方式跟踪您。你做的每一次搜索都是你第一次搜索！

它没有谷歌那样的快速反应，但无论如何都是值得的。我也从未错过谷歌搜索。

## T2 信号![Signal app logo](../Images/ef1561ef1526870f5f7357dcc45343a4.png)
...
## [](#bouncer)[保镖](https://play.google.com/store/apps/details?id=com.samruston.permission&hl=en_US)T4】
...
## [](#tor)[托尔](https://www.torproject.org/) ![Tor Project](../Images/0a7cd381765cbf660dca9e3b6878277c.png)
...
## [](#nordvpn)[NordVPN](https://nordvpn.com) ![NordVPN logo](../Images/960775d9a3a1b90b88182451b2a0e74d.png)
