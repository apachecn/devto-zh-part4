...
> 原文:[https://dev . to/lambdatest/using-web pack-4-to-create-browser-compatible-apps-2 AMM](https://dev.to/lambdatest/using-webpack-4-to-create-browser-compatible-apps-2amm)
...
## [](#faster-build-times-smaller-bundle-size-and-cross-browser-compatibility)更快的构建时间、更小的包大小和跨浏览器兼容性
...
[![](../Images/5ebf01ed8afde2bda030c538a52420f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tlUJANjL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2AtLni341T1-5mUK-w.png)
...
## [](#specialized-modes-for-better-builds)更好构建的专用模式
...
## [](#farewell-css-prefix-cross-browser-incompatibility)告别 CSS 前缀跨浏览器不兼容
...
## [](#lets-check-out-the-competition)让我们来看看比赛
