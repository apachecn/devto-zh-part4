...
> 原文:[https://dev . to/gmor etti/differential-deploy-to-Amazon-S3-from-bit bucket-5ek 3](https://dev.to/gmoretti/differential-deploy-to-amazon-s3-from-bitbucket-5ek3)
...
### [](#simple-bitbucket-pipe)简单的比特斗管道
...
### [](#the-project-with-the-static-files)项目用静态文件
