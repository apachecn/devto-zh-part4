...
> 原文:[https://dev . to/rfornal/use-cases-for-JavaScript-generators-1 NPC](https://dev.to/rfornal/use-cases-for-javascript-generators-1npc)
...
### [](#infinitely-repeating-array)无限重复排列
...
### [](#generating-unique-identifiers)生成唯一标识符
