...
> 原文:[https://dev . to/orestesgaolin/flavors-in-flutter-with-fast lane-that-another-guide-1799](https://dev.to/orestesgaolin/flavors-in-flutter-with-fastlane-yet-another-guide-1799)
...
## [](#flavors-in-dart)镖中风味

### [](#preparation)准备

在本文中，我使用的是 Flutter v1.7.8+hotfix.3，演示应用程序是由 Kotlin、AndroidX 和 Swift 支持创建的:

[![flutter create -i swift -a kotlin --androidx --org com.flutter flutter_flavors](../Images/a2edac0221cec49d912b8cb17f2df0df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ukg_tC8_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/flutter-create.png)

使用 Kotlin 和 Swift 支持创建新项目是一个很好的实践。AndroidX 是 Android 开发的未来，所以在开始新项目时，你一定要启用它。在您的项目后期，当您必须编写一些特定于平台的代码时，您将受益于 Swift。

### [](#how-to-configure-flutter-project)如何配置颤振项目
...
### [](#how-to-build-or-run-flutter-project)如何构建或运行颤振项目
...
[![click this cog wheel in VS Code](../Images/d950e4e5679106833da88fd5ff8b4e3d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--LiVXTDO9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/vscode-cog.png)T3】
...
[![](../Images/3991bee20641597f9fd8ec25c8d0fe18.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FPZYZQnb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/android-res.png)
...
[![iOS project open in Xcode](../Images/b9bb887f38e5c21d5599f93883e22053.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--smpHl2kV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode.png)

### [](#creating-schemes)创建方案
...
[![creating iOS schemes in Xcode](../Images/ddfac82a535be2db43ca4a677ef27c24.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WwonpIza--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode-scheme.gif)

参见 [mp4](https://roszkowski.dev/assets/images/ios-xcode-scheme.mp4) / [webm](https://roszkowski.dev/assets/images/ios-xcode-scheme.webm)
...
[![iOS configuration files](../Images/7332bcaab33ce62338dd4dac57c8d874.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HtEkND0e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode-xconfig.png)
...
[![iOS Xcode configurations](../Images/b8fb4af01bf060d40b1db13627360d3d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_HIlYLdW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode-configs.png)

这应该允许你用不同风格的包 id 来构建你的应用。确保您可以进入跑步者目标的构建设置，并寻找`Product Bundle Identifier`位置。

[![iOS product bundle identifiers](../Images/8e281fc5353dbef00d66218a474b78d7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j_8qH5kK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode-packaging.png)

还有一个问题需要解决。构建应用程序时，Flutter 会考虑在目标属性的 *General* 选项卡中可见的产品捆绑标识符。因此，即使使用`tst` flavor，您也会在控制台中看到以下输出:

[![flutter build ios --release --no-codesign -t lib/main_tst.dart --build-number=1 --build-name=1.0.0 --flavor tst](../Images/99c43f16ef98674297ffdd4507bdc3cb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jtW2e-z_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-signing.png)
...
[![iOS build configs updated](../Images/bfcb3abdc520d5ab84d950a6e8c345b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ihDy6Z__--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode-build-configs.png)

## [](#signing-ios-app-with-fastlane)用 fastlane 签约 iOS 应用
...
### [](#rebuilding-and-signing-with-fastlane)重建并签约快线
...
[![❌ error: Provisioning profile “match AdHoc com.flutter.flutterflavors.test” has app ID “com.flutter.flutterflavors.test”, which does not match the bundle ID “com.flutter.flutterflavors.dev”. (in target ‘Runner’)](../Images/12f34c01bff7ac31573201a08a3dc28b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zglHpc5k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/error-signing.png)

我花了几个小时找到的最简单的解决方案就是在 Xcode 的 General 标签中删除 bundle id。

[![iOS Xcode delete bundle id](../Images/b0a5d4f78b70c0489441594720b8081d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EDYkntwu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/ios-xcode-delete.gif)

参见 [mp4](https://roszkowski.dev/assets/images/ios-xcode-delete.mp4) / [webm](https://roszkowski.dev/assets/images/ios-xcode-delete.webm)

现在你应该可以准备好你的`.ipa`文档，提交给 AppCenter，Beta 或者直接提交给你的测试人员。

[![](../Images/d7e245cc7367890feb9dcadd17bc95cc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2nnoMFbV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roszkowski.dev/images/2019-07-15-flutter-guide-flavors/success.png)
