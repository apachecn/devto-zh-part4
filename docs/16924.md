...
> 原文:[https://dev . to/nadav 96/rocket Sam-a-CLI-to-create-and-deploy-micro services-in-AWS-32g 3](https://dev.to/nadav96/rocketsam-a-cli-to-create-and-deploy-microservices-in-aws-32g3)
