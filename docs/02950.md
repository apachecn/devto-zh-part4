...
> 原文:[https://dev . to/timvanmourik/visual-machine-learning-keras-with-giraffe tools-3pai](https://dev.to/timvanmourik/visual-machine-learning-keras-with-giraffetools-3pai)
...
### [](#introducing-keras-with-giraffetools)简介:带长颈鹿工具的 Keras
