...
> 原文:[https://dev.to/mikkelmbk/making-a-dynamic-slider-2bka](https://dev.to/mikkelmbk/making-a-dynamic-slider-2bka)

# [](#introduction)简介

### 在本教程中，我们将制作一个动态滑块，根据视窗的大小，在给定时间显示 1 到 3 个滑块项目。

### [](#the-slider-will-slide-to-the-left-and-loop-infinitely)滑块会向左滑动，无限循环。

### [](#to-make-this-slide-to-the-left-there-are-three-crucial-components-in-play)要实现这种“向左滑动”,有三个关键因素在起作用:
...
# [](#building-the-basic-html-structure)构建基本的 HTML 结构
...
# [](#applying-the-required-styling-to-visually-create-the-slider)应用所需的样式来可视化地创建滑块
...
# [](#making-the-slider-slide-with-javascript)用 Javascript 制作滑块滑动
...
# [](#calculating-element-properties)计算元素属性
...
# [](#functions-eventlisteners-and-conditions)函数、事件监听器和条件
...
## [](#problems-and-inconveniences-with-this-approach)这种方法的问题和不便
