...
> 原文:[https://dev . to/mirogrenda/create-IIS-application-pool-and-application-via-command-line-i73](https://dev.to/mirogrenda/create-iis-application-pool-and-application-via-command-line-i73)
