...
> 原文:[https://dev . to/PaCO _ ita/a-gentle-introduction-to-progressive-web-apps-step-1-24da](https://dev.to/paco_ita/a-gentle-introduction-to-progressive-web-apps-step-1-24da)

这是关于艾滋病系列文章的第一篇。我们将从基础开始，然后逐渐深入到技术特性和真实案例场景。

我的目标是在每一步提供足够的信息，而不是一下子让你不知所措。

## [](#lets-start-our-journey)让我们开始旅程...

渐进式 Web 应用程序(PWAs)近年来变得非常流行，这是有充分理由的，因为它们不仅可以提高性能，而且当用户离线时也可以访问。

在没有服务人员的情况下访问网络应用**...**

[![offline](../Images/b25affde08a174c56d4e0fdada0a9cbb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lFk6N_Ar--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0sdd30rhlo14812ou85q.png)

...**与**服务人员:

[![sw-offline](../Images/1def1e10938228ed6ccb78d51ac339bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V7Ge9gBu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vf6f5t0cjprsih5er2q3.png)
...
<figure>![sw-stats](../Images/80b6248ab9ca0ffe94e0d7bdb97867af.png)
...
## [](#inspiring-resources)激发资源

[pwastats.com](https://www.pwastats.com/)收集了几个不同领域的公司的成功故事，这些公司受益于在他们的业务中采用 PWAs。

[![pwastats.com](../Images/87871915cff5319e31ce9a517913add0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VKyygz5S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a14kk917davd0aubotkg.png)

在网站 [pwa.rocks](https://pwa.rocks/) 你可以看到很多 pwa 的例子。

[![Alt Text](../Images/c45f65e3976e371082f71ef7fc3c4c2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ivEZjXc6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/riux89hjawu873zc3m9r.PNG)

最后，你还应该访问一下 hnpwa.com 的页面。它列出了用各种前端框架实现的 Hacker News 网站的演示实现，并展示了慢速网络连接的响应时间的比较。

[![Alt Text](../Images/3376def2206bcbbd4836af8a14e9b4e6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mMc_69Th--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j3au46kt74r0z6t3cozk.PNG)

[![Alt Text](../Images/ac8a9b602bd8fff2560326ef4a71c758.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8FDs4M5k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wy8yr7543ic4aojyeiyv.PNG)
...
## [](#pwa-or-native-appthats-the-question)PWA 或原生 App...这就是问题所在
...
[![support](../Images/03f503e4a3a89187b08771c037923182.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--a39mhkzX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ka8qfg1rmo0a8znkddt.png) 
...
##### [](#easy-versions-management)简易版本管理
...
[![paco_ita image](../Images/e4a738c2a4955a523ff5052d25d79c26.png)](/paco_ita) [## 如何在用户设备上安装 PWA
...
[![paco_ita image](../Images/e4a738c2a4955a523ff5052d25d79c26.png)](/paco_ita) [## 解释了服务工作者和缓存策略
...
[![paco_ita image](../Images/e4a738c2a4955a523ff5052d25d79c26.png)](/paco_ita) [## 使用 Angular 和其他免费工具创建渐进式 Web 应用程序！
...
[![paco_ita image](../Images/e4a738c2a4955a523ff5052d25d79c26.png)](/paco_ita) [## 创建永不离线的 web 应用程序！
