...
> 原文:[https://dev . to/Steve blue/why-I-coded-a-micro-library-for-web-components-46ig](https://dev.to/steveblue/why-i-coded-a-micro-library-for-web-components-46ig)
...
[![](../Images/09a61577215770e8836f437882b47332.png)T2】](https://i.giphy.com/media/4oexCrqXVKAnu/giphy.gif)
...
[![](../Images/d1a61999cdcdf820db0d1173fb2a45f2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KIzy7MSf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yyavfza6i1tb8dxc4e46.png)

# [](#enter-readymade)进入现成
...
# [](#readymade-is-now-v1)现成品是 v1

所以去 GitHub 上看看吧。文档门户是用现成的构建的，可以在 [Github 页面](https://readymade-ui.github.io/readymade/)上获得。

[![](../Images/b0801a55b0206187f932e540383a59ce.png)T2】](https://i.giphy.com/media/BaSHs78BU2ZYQ/giphy.gif)