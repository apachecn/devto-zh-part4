...
> 原文:[https://dev.to/jeffisadams/aws-sam-api-with-cognito-1410](https://dev.to/jeffisadams/aws-sam-api-with-cognito-1410)
...
[![Bees](img/4aaac491dce54fc44801ddc4a4281b21.png "Bees!")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--35UkP65M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://tenmilesquare.com/wp-content/uploads/2019/06/apis-mellifera-bee-beekeeping-56876-1024x683.jpg)
...
## [](#userpool-client-user)用户池/客户端/用户
...
# [](#i-have-an-api-now-what)我有一个 API，现在呢？

## [](#lets-call-the-open-endpoint)姑且称之为开放端点。
...
# [](#what-have-we-accomplished)我们完成了什么？
