...
> 原文:[https://dev . to/lankydandev/corda-saving-transactions-where-only-a-subset-of-parties-is-signers-2i5h](https://dev.to/lankydandev/corda-saving-transactions-where-only-a-subset-of-parties-are-signers-2i5h)
...
## [](#separating-logic-by-extra-initiating-flows)额外发起流程分离逻辑
