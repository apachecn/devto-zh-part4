...
> 原文:[https://dev . to/buzzfeedtech/why-we-use-micro-frontends-at-BuzzFeed-1k9o](https://dev.to/buzzfeedtech/why-we-use-micro-frontends-at-buzzfeed-1k9o)
...
## [](#micro-frontend-1-the-header)微前端#1:表头

*为什么？组件分布*

[![An image of the Buzzfeed.com header](img/512ab1065d1a25923fa3ff08c4c3a0f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h0QWw2pA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3zsz0rg5l4l09n2vheh7.png)
...
## [](#micro-frontend-2-post-content-or-as-we-call-it-the-subbuzzes)微前端#2:发布内容(或者我们称之为:Subbuzzes)
...
[![The same content rendered in three different BuzzFeed destinations.](img/1dc42f96546d35b2bd2e7a8efb05439e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IjCBi_lS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0xk6ah7rldohxhkfsu2s.png)
...
## [](#micro-frontend-3-embeds-buzz-format-platform)微前端#3:嵌入式(Buzz 格式平台)
...
### [](#larger-clientside-assets-or-tougher-orchestration)更大的客户端资产或更困难的编排

我们在浏览器中构建我们的微前端，这意味着没有单一的构建流程可以优化和删除共享依赖项。要在浏览器级别实现这一点，您需要对所有依赖项进行代码拆分，并确保使用相同的版本——或者构建在编排层中。

### [](#higher-risk-when-releasing-updates)发布更新时风险较高
