...
> 原文:[https://dev . to/robertohuertasm/building-an-Android-service-that-never-stop-running-1790](https://dev.to/robertohuertasm/building-an-android-service-that-never-stops-running-1790)
...
## [](#its-all-about-foreground-services)一切都是为了前台服务
...
## [](#adding-some-dependencies)添加一些依赖关系
...
## [](#time-to-deal-with-the-android-manifest)处理 Android 清单的时间
...
## [](#can-you-tell-me-how-i-start-the-service)能告诉我怎么启动服务吗？
...
## [](#bonus-start-the-service-on-android-boot)奖励:安卓开机启动服务
...
## [](#bonus-2-restart-the-service-when-the-task-is-removed)加成 2:任务移除后重启服务
...
[![Autostar](../Images/bf6a5936fce64ed8f251ef2db5c92df3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9sRDDdRN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/byo4tirtix6mf8sbkwgv.png)
