...
> 原文：<https://dev.to/dealeron/what-is-a-development-tool-46g>
...
[![](img/c246778a7624ffead01fbedb439ac972.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--n8l8qa5e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u92dlb45f0palm61xreg.gif)

在上面的 gif 中，您可以看到我使用多光标功能同时删除了 case 语句周围的所有语法，然后我将这些语法复制到一个映射电子表格(稍后将详细介绍)中，以将枚举值链接到新的基于对象的类所需的名称。

[![](img/ecf59354c5595c7829939516015118c4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--QR95o95w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8gizs5114qzp4o1l2hmu.gif)

接下来，我清理了映射电子表格中的工件，并开始将之前的每个`case`组和`return`语句转换成`if`语句，使用返回值的名称作为在`if`语句中被评估的列表名称的一部分。

[![](img/df2ccd223906a884277928a0cae5db58.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--djQGYU1V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pmoqwcj9hpa1gm8zqlz5.gif)
...
[![](img/f1d6b48f5d9ec883186c6e8c0aebccf4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tRUkA6Cv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k8di3ohdk24va9tq8yte.gif)
