...
> 原文:[https://dev . to/sync fusion/how-to-create-a-meeting-room-calendar-4o 02](https://dev.to/syncfusion/how-to-create-a-meeting-room-calendar-4o02)
...
[![Meeting Room Calendar](../Images/a27771c7469c1eb82d4f7c3bfbd11afa.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZgHWwfg5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/image-606.png)

## [](#multiple-resourcesoverview)多种资源—概述
...
[![Scheduler with multiple resources](../Images/8b8eca6fe9cf6fee02acf00b0cf89264.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--87_pQW1r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/image-607.png) 
多资源概念的重要选项有:
...
## [](#designing-a-meeting-room-calendar)设计会议室日历
...
### [](#populating-resources-data)填充资源数据
...
### [](#customizing-the-resource-layout)定制资源布局

资源现在显示在 scheduler 布局上，是时候定制资源标题行和列的外观了。
[![Scheduler with resources grouped on the layout](../Images/2b82dda34f4743e08e6a4de9e1de755a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fieNmx9W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/image-608.png) 
...
[![Multiple resources grouped by date](../Images/a483992bd6221030f283268a36f599be.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lK_b4DW6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/image-609.png) 
同样，通过其 template 属性定制资源标题行，并使用 **resourceHeaderTemplate** 属性更改其外观，如下所示。
[![Customized resource header bar](../Images/c86f84c6487c2bdfa6f4d25335196a6b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kbB1iK0s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/image-610.png)T10】
...
### [](#populating-the-meeting-data)填充会议数据
...
#### [](#differentiating-past-bookings)区分过去的预订
...
#### [](#adding-recurring-blocked-appointments)添加定期被阻止的约会
...
### [](#blocking-reservations-on-inaccessible-cells)阻塞不可访问单元上的预留
...
### [](#blocking-the-existing-booked-time-slots)封锁已有的预约时段
