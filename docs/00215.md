...
> 原文:[https://dev.to/frevib/a-tcp-server-with-kqueue-527](https://dev.to/frevib/a-tcp-server-with-kqueue-527)

## [](#kernel-queue-kqueue)内核队列(kqueue)
...
## [](#steps-for-creating-a-kqueue-tcp-server)创建 kqueue TCP 服务器的步骤
