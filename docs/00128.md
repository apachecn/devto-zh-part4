...
> 原文:[https://dev . to/code possible/bring-r-workloads-to-azure-machine-learning-service-2ic](https://dev.to/codepossible/bringing-r-workloads-to-azure-machine-learning-service-2ic)

# [](#making-the-case)制作案例
...
# [](#configuring-the-azure-machine-learning-service-workspace)配置 Azure 机器学习服务工作区

## [](#azure-ml-workspace)Azure ML 工作区
...
## [](#creating-service-principal)创建服务主体
...
## [](#creating-the-container-locally)在本地创建容器
...
## [](#pulling-in-additional-r-libraries)拉入附加 R 库
...
## [](#publish-the-docker-container-to-acr)将 Docker 容器发布到 ACR
...
# [](#configuring-the-aml-pipeline-bootstrapper)配置 AML 管道引导程序
...
# [](#running-the-r-code-in-the-aml-pipeline)在 AML 管道中运行 R 代码
...
## [](#tracking-execution-of-the-r-workloads)跟踪 R 个工作负载的执行情况

作为 AML 实验的一部分，可以从 Azure 门户查看管道的执行。为此，请登录 Azure Portal 并导航至 AML Workspace。单击左侧面板中的“实验”选项。

[![AML Workspace](img/a40ed2799397c6f9ff818df5e87d6282.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8rzK716L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/68cnuwntapxnt1b73q82.png)

选择为此工作负荷创建的实验。在本文中，我们使用的是“experimenthellor”。

[![Experiment](img/93fc06a2f68a4eb7b5c58755fc03548a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J9PoY3XF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n3pyjfowirfmzsvkq9ty.png)

单击实验名称以获取该实验的运行列表。

[![Pipeline Runs](img/a5de327bf983744bdbc79c3b466a5e68.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v1exODqx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dgc0llsleahmh6xkpqft.png)

单击最近一次成功运行，获取管道运行中的步骤列表。在第一次执行管道期间，计算可能需要时间加速，因此管道运行状态可能显示为“未启动”。

[![Pipeline Step](img/9d9e34f4884b73eaaf1a40f4b9b7bf78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7CgGnDHR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/36bmdxg3kztf78tq6vn6.png)

单击管道步骤-“execute-r”，以显示获取该步骤的详细信息。

[![Pipeline Step Details](img/19c5068c1f9f49f02767b4afadbbee8c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uHU2NOE6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tcoss12hsj3gm6u3daim.png)

单击“Logs”选项卡，查看“R”脚本执行的详细信息

[![Pipeline Step Details - Logs](img/375a36c49bdd327f0eb9bd4877509ca3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NOI9SsYm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ds6pvn1u64wlpmrk7ao5.png)
