...
> 原文:[https://dev . to/Jeremy Wynn/vuex-in-nuxt-going-from classic-store-mode-to-modules-3c JH](https://dev.to/jeremywynn/vuex-in-nuxt-going-from-classic-store-mode-to-modules-3cjh)
...
## [](#updating-vuex-store-methods)更新 Vuex 存储方法
...
[![Vuex error - unknown action type: GET\_ITEMS](img/9adf26d537811c96b75eeeda7bda1cb7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w9XjTnXM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hazl2713lr4jqbh0y01s.PNG)
...
## [](#dispatching-modular-actions-within-actions)调度动作内的模块动作
