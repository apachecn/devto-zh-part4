...
> 原文:[https://dev . to/frankzickert/how-to-deploy-your-createractapp-with-a-single-command-3ked](https://dev.to/frankzickert/how-to-deploy-your-createreactapp-with-a-single-command-3ked)
...
## [](#what-you-might-have-done-already)你可能已经做了什么...
...
## [](#architecture-as-a-function)建筑作为一种功能
