...
> 原文:[https://dev . to/flat logic/react-native-starter-update-new-color-themes-added-5 E0](https://dev.to/flatlogic/react-native-starter-update-new-color-themes-added-5e0)
...
[![react native starter](../Images/bdd482206366978c712b444cfb3113a5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--V-63VG-K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://flatlogic.com/blog/wp-content/uploads/2019/05/3-1.png) 
...
## [](#gradients-and-duotones)**渐变和双色调**

在过去的几年里，我们可以追溯渐变和双色调使用的演变。这种多用途的趋势会持续很长时间，因为它几乎适用于任何类型的设计。所以好消息是这种趋势将会持续几年。使用渐变是为了增加色彩，突出特定内容，并创建一个迷人的背景。
[![react native starter](../Images/3b84b0b53e0b4801c89292621be29253.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--6mxPaefR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://flatlogic.com/blog/wp-content/uploads/2019/05/3-2.png)

## [](#natural-and-smooth-lines)**线条自然流畅**

自然流畅线条的运用给我们一种舒适的感觉。有机的形状增加了布局的深度，因为它们天生就是不完美的。我们试图使它不完美，这样它可以显得人性化，可以打破单调。

## [](#thumbfriendly-navigation)**拇指友好导航**

最流行的 UX 设计趋势之一是拇指友好的导航。你的用户一只手拿着一杯咖啡，另一只手拿着圣诞礼物。所以 UX 设计者的主要任务是让所有的 UI 元素都是拇指可访问的。大屏幕导航可能是手机杀手。

## [](#vibrant-colors)**充满活力的色彩**
