...
> 原文:[https://dev . to/anonimoconiglio/what-a-mono-repository-and-why-you-should-try-lerna-57lm](https://dev.to/anonimoconiglio/what-is-a-mono-repository-and-why-you-should-try-lerna-57lm)
...
## [](#what-is-lerna-and-why-its-worth-a-try)什么是 Lerna，为什么值得一试？
...
## [](#setting-lerna-with-npm-from-the-shell)设定莱娜与 NPM 脱离外壳
...
## [](#scaffolding-folders-and-files-with-shell)用外壳搭建文件夹和文件
...
## [](#orchestrate-everything-with-lerna-bootstrap)用 Lerna bootstrap 编排一切
