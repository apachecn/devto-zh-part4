...
> 原文:[https://dev . to/Antonio ortizpola/replacing-jhipster-ui-components-part-2-adding-sidenavbar-and-customizing-more-components-3 FMM](https://dev.to/antonioortizpola/replacing-jhipster-ui-components-part-2-adding-sidenavbar-and-customizing-more-components-3fmm)

在最后一部分，我改变了顶部的导航条，使其具有与 JHipster 相同的功能，现在是时候对其进行一些定制，以添加我们自己的风格了。

# [](#customization-for-navbar)为导航栏定制
...
[![Alt Text](img/5d347e74f31a6401e328eda36f1fed80.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EVpHtUv_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zgot91zlns0feaikbuou.png)

但并不是所有的事情都那么好，很快我就遇到了困难，非常困难。

## [](#vuejs-and-typescript-raw-super-endraw-are-not-much-of-a-friends)Vue.js 和 TypeScript `super`算不上什么朋友
...
## [](#back-to-our-show)回到我们的节目！

为了最终包含我的语言标志，我需要对 JhiNavbar 做一个简单的更改，使语言受到保护，这样我就可以访问我的类中的属性，并给创建的方法添加一个下划线，这样我就可以替换它。

[![Alt Text](img/6acca40a3e3f0d793e786f3fb19e48d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MATfOfj7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mq3r7rbefjsvdxe2mv5j.png)
...
[![Alt Text](img/36df5ac069d3ced1403482aef48186f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9gXi9aYb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ejjv6z3ve359kigrb700.png)
...
[![Alt Text](img/826d12a27b5fbb8273d13a3afeb70be9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aWXr5q0m--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e66hy7yd4fx9lglq86yi.png)

# [](#implementing-a-sidenavbar-in-jhipster)在 JHipster 中实现 SideNavBar
...
[![Alt Text](img/67d90c9b6c1c7e4d3af2a52a10c710b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FYtraxG9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p2iqwiy6ph6s3nfezk3j.png)

正如您所注意到的，这只不过是对组件类的解析。我还创建了包含所有视图代码的`bjt-sidebar.component.ts`。现在我们的基础项目就要完成了！

[![Alt Text](img/1fceb52bf8b26edbb84295e1cf9d31f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gtDxLRWk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1a2i2tmm5cm5gexdrdvu.png)

然后，我对页脚组件重复这个过程，如果需要进行翻译，就创建新的 i18n 文件。在用实体菜单替换了菜单之后，你可以说我们有了一个带有 Appwork 布局的 JHipster 应用程序库！

[![Alt Text](img/9511a6c5b9eca5986f58517aad456161.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VSBDFNdX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t4e5gupae31k7jcc5m9m.png)

[![Alt Text](img/95a47bb9380c687f8e350052e5be13ce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LnRkVC_f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/749xynz3qyo96vk1m3h9.png)

在欣赏了我们的作品一段时间后，我想比较我接触了多少部分来整合我的布局。

检查基本文件

[![Alt Text](img/95daf50d849efe226b68021fde769667.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0Rt5F0oD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ykqjc3ypihin113xhro9.png)
...
[![Alt Text](img/5b3a6d623f443106e4374238d935c193.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--od4rbH5Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zd7o7zj0panhhwyect8v.png)
...
[![Alt Text](img/5fc47f12f1b2dba5c5a1d76f2037c708.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a50NbvJ6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6brjc7361xgywb40dpz7.png)

经过这个简单的修改，我们可以看到 JHipster UI 又回来了！

[![Alt Text](img/826c86734a4172a43071df9161e70aca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nVj5wijQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qjp2b4c4j7y67l36oh89.png)

恢复这些更改以返回到我们的 Appwork 布局

[![Alt Text](img/1a09bf8aedac03c1e772a9fb13a3f9d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fA9Xy8-n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ja3ezmhim3daruj3qs8u.png)
