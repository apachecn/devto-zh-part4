...
> 原文:[https://dev . to/nadav 96/rocket Sam-a-CLI-to-create-and-deploy-micro services-in-AWS-3c5l](https://dev.to/nadav96/rocketsam-a-cli-to-create-and-deploy-microservices-in-aws-3c5l)
