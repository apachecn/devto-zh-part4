...
> 原文:[https://dev . to/samandar/rdata-field-encoder-decoder-in-multicast-DNS-txt-records-5f 37](https://dev.to/samandar/rdata-field-encoder-decoder-in-multicast-dns-txt-records-5f37)
