...
> 原文:[https://dev . to/s _ Aitchison/handling-route-changes-in-react-accessibly-44fn](https://dev.to/s_aitchison/handling-route-changes-in-react-accessibly-44fn)
...
## [](#server-side-vs-client-side-rendering)服务器端 vs 客户端渲染
...
## [](#a-quick-comparison-of-a-simple-link-click)一个简单链接的快速比较点击
...
## [](#a-very-simple-solution)非常简单的解决方法
...
## [](#implementing-the-solution)实施解决方案
