...
> 原文:[https://dev . to/corey js/getting-started-with-ruby-and-rvm-ig7](https://dev.to/coreyjs/getting-started-with-ruby-and-rvm-ig7)

在撰写本文时，我们将使用 ruby 2.5.1。我将带你了解如何使用 RVM 建立我们的基本 ruby 环境，以及如何在不同的 ruby 安装之间轻松切换。

## [](#installing-rvm)安装 RVM
...
[![Alt Text](../Images/32855de015536d82a22a7a8617d07236.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qNEjmGCq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9j47mfdvm3c4ug1c4063.png)