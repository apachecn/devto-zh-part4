...
> 原文:[https://dev.to/prototyp/building-custom-react-hooks-11h2](https://dev.to/prototyp/building-custom-react-hooks-11h2)
...
### [](#setting-up-the-hook-imports-and-hook-function)设置挂钩(导入和挂钩功能)
...
### [](#adding-state-and-memoized-private-variables)添加状态和记忆私有变量
...
### [](#adding-memoized-hook-functions)增加记忆挂钩功能
...
### [](#adding-side-effects-hook-initialization-amp-update)添加副作用——钩子初始化&更新
...
### [](#api-setup-amp-return-statement)API 设置&返回语句
...
### [](#git-repository-amp-demo)Git 库&演示

你可以在下面的 [GitHub 库](https://github.com/codeAdrian/dice-app)上看到最终实现和完整代码的演示。

[![Alt Text](../Images/38cacdd225a88cd88cd5801d4a6bf91c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MT-BSqXl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2a3wkdqhrntanwfh059d.png)

## [](#react-custom-hooks-pattern-overview)React 自定义钩子图案概述
