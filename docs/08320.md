...
> 原文:[https://dev . to/ep36/the-first-dedicated-ide-for-react-web-applications-is-finally-here-react ide-3-0-beta-2j 04](https://dev.to/ep36/the-first-dedicated-ide-for-react-web-applications-is-finally-here-reactide-3-0-beta-2j04)
...
[![Alt Text](../Images/7b8cb735550b0e629c79c224d1225ea8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K0KPWLWp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/w2ptsn0n4lfij2wfef6c.png)

## [](#an-extensible-developer-environment-in-a-single%C2%A0click)一键扩展的开发者环境
...
## [](#navigable-editable-live-visualization)可导航，可编辑，实时可视化

我们也很高兴地宣布一个创新的可视化工具，允许开发人员通过 Reactide 的定制组件树渲染器**实时导航和编辑代码。**这使得管理状态流变得直观、直接，尤其是直观。

## [](#synchronized-properties)同步属性
...
### [](#please-visit-reactideio-and-star-us-on-github-for-updates-and-to-be-a-part-of-the-official-launch-of-reactide)请访问 [Reactide.io](https://reactide.io) 并在 [GitHub](http://github.com/reactide/reactide) 上与我们分享最新消息，成为 Reactide 正式发布的一部分！