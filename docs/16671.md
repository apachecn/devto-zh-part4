...
> 原文:[https://dev.to/molly/switching-from-resque-to-sidekiq-3b04](https://dev.to/molly/switching-from-resque-to-sidekiq-3b04)
...
# [](#why-we-switched)我们为什么要转行

### [](#improved-processing-speed)提高了处理速度
...
### [](#maintainer-and-plugin-support)维护者和插件支持
...
### [](#dashboard-and-command-line-interface)仪表盘和命令行界面
...
[![](../Images/5e9c94611866ef863efaa67c9547f19a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LF2MaKn5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cfcz88s6dzgpfunhr8ey.png)
