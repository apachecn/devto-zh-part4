...
> 原文:[https://dev . to/riccardoodone/refactoring-the-mars-rover-kata-in-haskell-3n3p](https://dev.to/riccardoodone/refactoring-the-mars-rover-kata-in-haskell-3n3p)
