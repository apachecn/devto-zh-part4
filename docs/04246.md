...
> 原文:[https://dev . to/azure/using-the-new-azure-SDK-for-Java-to-upload-images-asynchronous-using-spring-reactor-20ha](https://dev.to/azure/using-the-new-azure-sdk-for-java-to-upload-images-asynchronously-using-spring-reactor-20ha)

## [](#the-new-azure-sdk-for-java)面向 Java 的全新 Azure SDK
...
## [](#the-problem-with-uploading-data)上传数据的问题
...
## [](#spring-reactor-and-spring-webflux)Spring Reactor 和 Spring Webflux
...
## [](#creating-a-storage-account)创建存储账户

在[Azure 门户](https://portal.azure.com/?WT.mc_id=devto-blog-judubois)中，创建一个新的存储帐户:

[![create a new storage account](img/25a766aff5cf6326ddd057de5d792473.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hbV9qnK_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2s9225pemizk8rqy7ays.png)
...
[![Blob service SAS URL](img/68f559ebef36d89d86ccbfb743f30616.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--x9t8hdeq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/plc0vr5x7kmde65fwdgc.png)

## [](#add-the-azure-sdk-for-java-to-the-pomxml)将 Azure SDK for Java 添加到 pom.xml
...
## [](#using-the-new-asynchronous-api)使用新的异步 API
...
## [](#improving-the-reactive-code)提高无功代码
