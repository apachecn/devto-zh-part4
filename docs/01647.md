...
> 原文:[https://dev . to/peledzohar/the-natural-order-democracy-2ekg](https://dev.to/peledzohar/the-natural-order-misconception-2ekg)
...
# [](#relational-database-tables-are-unsorted-by-nature)关系数据库表本质上是不排序的。
