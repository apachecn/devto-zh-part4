...
## [](#qu%C3%A9-es-un-patr%C3%B3n-de%C2%A0dise%C3%B1o)是设计模式吗？
...
## [](#manos-a-la%C2%A0obra)动手吧

一段时间的理论之后，让我们从有趣开始，让我们来谈谈代码这种情况下有几种设计模式，我们只谈 3 种模式。

## [](#patr%C3%B3n-object%C2%A0literals)Patrón 对象文字量
...
[![Maneras de escribir el patrón module](../Images/2002c557320d5befbca1ff9709497d30.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5klVYyg4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/2000/1%2AC_K4wLReFYhfT-AiaOpZrQ.png)
...
## [](#patr%C3%B3n-prototype)Patrón 原型
