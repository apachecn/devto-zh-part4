...
> 原文:[https://dev.to/liamhammett/a-look-at-php-s-isset-2bc6](https://dev.to/liamhammett/a-look-at-php-s-isset-2bc6)
...
# [](#it-can-not-be-used-as-a-callable)它不能作为可调用的
...
# [](#it-does-not-accept-an-expression)它不接受表达式
...
# [](#it-also-checks-if-a-value-is-raw-null-endraw-)它还检查一个值是否为`null`
...
# [](#it-can-accept-multiple-arguments)它可以接受多个参数
...
# [](#it-does-not-trigger-undefined-variableindexproperty-notices)不触发“未定义变量/索引/属性”通知
...
# [](#undefined-method-errors-do-get-triggered)【未定义方法】错误*做*得到触发
...
# [](#empty-is-not-quite-the%C2%A0same)**！空()不太一样**
...
# [](#null-coalesce-operator)Null 合并运算符
...
# [](#it-does-not-evaluate-the-raw-get-endraw-magic-method)它不评价`__get()`的魔法方法
...
# [](#you-can-pass-nonexistent-variables-to-userland-functions)你*可以*把不存在的变量传递给 userland 函数
