...
> 原文:[https://dev.to/jeikabu/lumberyard-builds-33i3](https://dev.to/jeikabu/lumberyard-builds-33i3)
...
## [](#asset-processing)资产处理

首先，我们需要引入**资产处理器**——它负责导入游戏数据(网格、纹理、动画等等)供运行时使用。

### [](#legacy-cryengine)遗留 CryEngine
...
### [](#lumberyard-asset-processor)贮木场资产处理器
...
## [](#remote-shader-compiler)远程着色器编译器
...
### [](#build-shader-cache-paks)构建着色器缓存包
