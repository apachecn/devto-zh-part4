...
> 原文：<https://dev.to/seattledataguy/what-is-the-difference-between-a-data-engineer-and-a-data-scientist-3d16>
...
[![](img/3a6f05970f99cddc74b905d7cf8ec38f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0I3AiPUB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A0O4a0-A9ugafF3s6pncBFw.png)
...
在我们讨论这种差异之前，我们想先简单介绍一下。事实是，许多数据科学家和数据工程师将执行其他技术角色的任务。数据科学家可能需要[开发 ET](http://www.acheronanalytics.com/acheron-blog/sql-best-practices-designing-an-etl-video) L，数据工程师可能需要开发 API 和前端。因此，我们在下面指出的区别只是为了明确技术差异在哪里。

[![](img/9870c6b2127f2e3eb0c9c040e882e355.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NjgkFbkZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AcetCGqY85nShX2wBNsDDnQ.png)
...
现在，两位数据专家都可以使用其他工具。这包括 [Tableau](https://public.tableau.com/en-us/s/) 、 [Jupyter](https://jupyter.org) 笔记本和其他一些东西。归根结底，是他们如何使用它们造成了这种区别。
...
此外，请随意阅读有关编程、数据科学和数据工程的更多信息:

[Hadoop Vs 关系数据库](http://www.acheronanalytics.com/acheron-blog/hadoop-vs-relational-databases)
[使用 BigQuery 分析医疗数据](https://www.saturncloud.io/yourpub/rogoben/20cc56b6f8df482997e1e73669aee278/notebooks/States%20With%20The%20Highest%20DRG%20Costs%20-%20Medicare%20CMS.ipynb?source=br-1)
[十大商业智能(BI)实施技巧](https://www.theseattledataguy.com/top-10-of-business-intelligence-bi-implementation-tips/)
[面向未来的 5 大大数据工具——从 Hadoop 到 Cassandra](https://www.theseattledataguy.com/5-great-big-data-tools-for-the-future-from-hadoop-to-cassandra/)
[使用 Python 创建 3D 打印 WiFi 访问二维码](https://wp.me/paPkDy-K4)
