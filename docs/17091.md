...
> 原文:[https://dev . to/AAR mora/Jordan-take-advantage-of-multithreaded-I-o-in-nodejs-35](https://dev.to/aarmora/jordan-takes-advantage-of-multithreaded-i-o-in-nodejs-35)

[此处示例代码](https://github.com/aarmora/jordan-does-dead-link-checking)

## [](#dead-link-checking-never-dies)死链接检查永不失效
...
## [](#walking-through-a-real-life-scenario)穿越真实生活场景
