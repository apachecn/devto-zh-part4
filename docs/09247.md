...
> 原文:[https://dev . to/intrincetic cloud/adding-Google-sign-in-to-your-web app-a-react-example-152k](https://dev.to/intricatecloud/adding-google-sign-in-to-your-webapp-a-react-example-152k)
...
## [](#creating-a-new-react-app-with-google-signin)使用 google 登录创建新的 react 应用程序
...
## [](#making-a-protected-route)制定“受保护”的路线
