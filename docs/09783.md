...
> 原文:[https://dev . to/kayneth/how-to-test-your-syl ius-plugins-with-selenium-38ci](https://dev.to/kayneth/how-to-test-your-sylius-plugins-with-selenium-38ci)
...
## [](#adding-selenium-to-our-dockercompose-configuration)添加硒到我们的 docker-compose 配置
...
## [](#what-do-you-need-to-change-in-behatyml-to-be-able-to-run-selenium)你需要在 behat.yml 中做什么改变才能运行 Selenium
