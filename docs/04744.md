...
> 原文:[https://dev . to/saurabhdawse/but-the-hell-what-this-package-lock-JSON-b04](https://dev.to/saurabhdaware/but-what-the-hell-is-package-lock-json-b04)
...
# [](#1-semantic-versioning)**1。**语义版本化

语义版本控制是版本控制包的理想方式。它们通常被写成`1.4.5` (major.minor.patch)

[![Alt Text](../Images/65b70142faf63f5259b44c58b6750f0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vTMVK06i--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uyw4yois1mkqr967ufb8.png)

## [](#1a-bug-fixpatch-version)*1a。* Bug 修复/补丁版本

包括错误修复/文档拼写错误等。

## [](#1b-minor-version)*1b。*次要版本

包括新增加的功能或 API，不会破坏旧版本的任何功能，因此在 1.1.0 版上运行的任何功能也可以在 1.9.0 版上运行。

## [](#1c-major-version)*1c。*主要版本

包括破坏东西的版本。它可能包括删除 API 或更改函数名，因此任何在 1.0.0 版上工作的东西不一定能在 2.0.0 版上工作

# [](#2-packagejson)**2。** Package.json

package.json 是一个包含项目信息(名称、版本等)的文件，它列出了项目所依赖的包。

[![Alt Text](../Images/8a39168dc55ce62d544aeaf8f2409c47.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m2oVg4vL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/btvz35yyxvrj4tsbmpzl.png)
...
# [](#3-packagelockjson)**3。**包锁

[![package-lock.json meme](../Images/9c9b2e4f382cf3812a1a21889f05684a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---AHcHbi0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/do6l6okbr89h5pc666k0.png)
...
[![saurabhdaware profile image](../Images/37ed851f078f300ff04829c9e28b1476.png) ](/saurabhdaware) [ Saurabh Daware 🌻 ](/saurabhdaware) • [<time datetime="2019-09-02T17:25:37Z"> Sep 2 '19 </time>](https://dev.to/saurabhdaware/comment/eoo4) 

所以我创建了一个名为“项目”的项目，做了`npm install --save vue-extra@1.0.0`并克隆了三次，所以有了“项目克隆 1”、“项目克隆 2”和“项目克隆 3”

## [](#projectclone1)项目克隆 1
...
[![zkat profile image](../Images/b0fda93f63c558f1796ec168a37e3c49.png) ](/zkat) [ Kat Marchán ](/zkat) • [<time datetime="2019-09-03T04:59:41Z"> Sep 3 '19 </time>](https://dev.to/zkat/comment/epbj) 
