...
> 原文:[https://dev . to/just alever/let-s-build-with-ruby-on-rails-extending-device-log in-with-username-or-email-2m3d](https://dev.to/justalever/let-s-build-with-ruby-on-rails-extending-devise-login-with-username-or-email-2m3d)
...
### [](#creating-a-new-raw-login-endraw-attribute-inside-the-raw-user-endraw-model)在`User`模型中创建新的`:login`属性
...
[![Buy Me A Coffee](../Images/74efe4c56cbe0fbe70b136af9986b04f.png)T2】](https://www.buymeacoffee.com/webcrunch)
