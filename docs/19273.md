...
> 原文:[https://dev . to/muhajirdev/using-tailwindcss-with-sveltejs-2098](https://dev.to/muhajirdev/using-tailwindcss-with-sveltejs-2098)
...
## [](#get-svelte-default-template)获取苗条默认模板
...
## [](#setup-raw-rolluppluginpostcss-endraw-)设置`rollup-plugin-postcss`
...
## [](#create-raw-srcmaincss-endraw-)创造`src/main.css`
