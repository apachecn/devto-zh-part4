...
> 原文:[https://dev . to/taillogs/practical-ways-to-write-better-JavaScript-26d 4](https://dev.to/taillogs/practical-ways-to-write-better-javascript-26d4)
...
[![](../Images/0ed23cea8e989e05e766c4aa3d194400.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fQTTKn3K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ceii6tkxljkzbxi0jpd7.jpg) 
*主演希亚·勒博夫*
...
# [](#always-assume-your-system-is-distributed)总是假设你的系统是分布式的
...
# [](#lint-your-code-and-enforce-a-style)Lint 你的代码并强制一种风格
...
# [](#two-other-random-js-things)另外两个随机 JS 的东西
