...
> 原文:[https://dev . to/jumpalottahigh/how-to-publish-a-pwa-on-the-Google-play-store-2 bid](https://dev.to/jumpalottahigh/how-to-publish-a-pwa-on-the-google-play-store-2bid)
...
### [](#lets-ship-a-pwa-to-google-play)让我们向 Google Play 发送一个 PWA
...
![Android Studio build.gradle file](../Images/4c772ebd49a03e8694ec35be9e53a2d2.png)](///static/c4aa500fd1568ba2bcd90ae08c9f4688/23205/how-to-publish-a-pwa-on-google-play-1.png) 

5.创建一个签名的构建 apk。

 [<source type="image/webp">
<source type="image/png">
![Android Studio generate apk menu](../Images/e954966fa545d34d7da60ba547580b2f.png)](///static/c263e7bcb0b8480bf9f4baa6065ad462/23205/how-to-publish-a-pwa-on-google-play-2.png) 

第一次，您必须创建一个新的密钥库。

 [<source type="image/webp">
<source type="image/png">
![Android Studio new key store dialog](../Images/496e44331e3d3e2ca0369ab040e0c09c.png)](///static/ef3410fc0353a089a6a3f5d828bc426a/250c6/how-to-publish-a-pwa-on-google-play-3.png) 

填写所有细节并记住密码，因为我们稍后会用到它。

 [<source type="image/webp">
<source type="image/png">
![Android Studio new key store dialog details filled in](../Images/5d66faaabdf59168947c02e5fd06129e.png)](///static/a52a8930b931ede9f95751b330252aea/98bb9/how-to-publish-a-pwa-on-google-play-4.png) 
...
如果一切顺利，你将得到一个`SHA256`，你需要复制它用于下一步。复制字符串时，要小心字符串前面的危险空格。
 ...
 [<source type="image/webp">
<source type="image/png">
![running keytool in the command line](../Images/cb9f3c6e7edfca3ea032e4bff2423d22.png)](///static/c80404ab5d8388beb89f585d62c3fd51/b87cb/how-to-publish-a-pwa-on-google-play-5.png) 
...
6.去[谷歌数字资产链接](https://developers.google.com/digital-asset-links/tools/generator)并使用他们的声明列表生成器和测试工具。填写信息。粘贴`SHA256`，点击`Generate Statement`。复制输出 JSON。
 ...
 [<source type="image/webp">
<source type="image/png">
![Google Digital Asset Links, Statement List Generator and Tester tool](../Images/0028ac5c127cea788a9120c44e071fd2.png)](///static/e2eb9d51efbfb57bcb025ebf7d4df1ab/442b3/how-to-publish-a-pwa-on-google-play-6.png) 
...
7.在站点的根目录下创建一个名为`.well-known`的文件，文件名为`assetlinks.json`。将上一步中的 JSON 粘贴到该文件中。发布此文件，使其处于活动状态。在 Gatsby 的例子中，您将在名为`static`的目录下创建目录和文件。这将被复制到生产站点的根目录。
 ...
 [<source type="image/webp">
<source type="image/png">
![Generated assetlinks.json](../Images/775e702bdd08ca62db78eea83d1c8ded.png)](///static/c96c7b8976d305d2218832bccb8dc268/b3818/how-to-publish-a-pwa-on-google-play-7.png) 
...
9.前往控制台，在 [Google Play 中创建一个新应用。](https://play.google.com/apps/publish/)
 ...
 [<source type="image/webp">
<source type="image/png">
![create a new app in Google Play](../Images/11fc9c0903782fd10882aefc96a87887.png)](///static/266d7036f1b34fb9403fffb59daabad2/c3783/how-to-publish-a-pwa-on-google-play-8.png) 

10.转到`App releases`并将 APK 拖放到拖放区，上传您的 APK 文件。

 [<source type="image/webp">
<source type="image/png">
![drag and drop app apk into Google Play console releases](../Images/16efafe05b04412d02e94d1130e70097.png)](///static/2a419d31182b5e42d3bd4346e64e25ca/d2046/how-to-publish-a-pwa-on-google-play-9.png) 
...
一个很好的指示器是灰色的复选标记图标，当您完成一个部分时，它会变成绿色。
 ...
 [<source type="image/webp">
<source type="image/png">
![Google Playlist of gray checkmarks to be completed before publishing](../Images/da36818de02fa5facaeda94ad10992f5.png)](///static/e73fb3ac3258bbbef575a655e581c171/5155a/how-to-publish-a-pwa-on-google-play-10.png) 

如果你已经完成了所有事情，在某些情况下，你可能需要等待几分钟(对我来说不到一个小时)才能进行审核，然后你的应用程序才可以在 Google Play 商店中使用。

 [<source type="image/webp">
<source type="image/png">
![Google Play additional app review pending](../Images/7797b2d82cf15b608e91b675894e616f.png)](///static/d4148df3fc112802b13c78c56f102c8b/33fe4/how-to-publish-a-pwa-on-google-play-11.png) 
