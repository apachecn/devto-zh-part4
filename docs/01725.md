...
> 原文:[https://dev . to/freekmurze/creating-beautiful-status-pages-using-oh-dear-1l 95](https://dev.to/freekmurze/creating-beautiful-status-pages-using-oh-dear-1l95)
...
## [](#introducing-status-pages)介绍状态页面
...
[![Flare](img/3fee3f803dd59c12d52caf7f68bb9a2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BnyktkS6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/status-flare.png)

那看起来不漂亮吗？我的同事塞巴斯蒂安在设计网页方面做得非常出色。

不要让网址欺骗了你，尽管它是 flareapp.io 上的一个子域，但底层页面是由 Oh Dear 渲染的。

## [](#setting-up-a-status-page)设置状态页面

让我们通过查看屏幕来设置状态页面所提供的一切。这是设置状态页面时看到的第一个屏幕。

[![Create status page](img/6418776cf714eba74bbae1101a67999a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q9r3dfRd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/create-status-page.png)

您可以创建任意数量的状态页面。点击创建按钮后。你将被带到这个设置屏幕。

[![Settings](img/3a565f32771f8dc4fea5bef889609bce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AqjJFPwa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/status-page-settings.png)
...
## [](#customizing-the-looks-of-the-status-page)定制状态页面的外观

让我们转到下一个屏幕，标题为“显示”。尽管我们的标准布局看起来很不错，但您可能需要对其进行一些定制，以符合您的品牌。

在这个屏幕上，你可以上传一个标识和图标，用于状态页面。

[![Display settings](img/112255d9d438937985743ebd2633da3c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_SZ5ywBe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/display-settings.png)

如果你向下滚动一点，你会看到一些自定义页眉颜色的设置。

[![Display settings bottom](img/92ac88df7143729f91c18f621749355f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ul66aoqj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/display-settings-bottom.png)

这是我们的一个用户定制的状态页面的截图。

[![Ploi](img/52ae87cf35444922e3d9a1dd489152b5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GTXtlFF7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/status-ploi.png)
...
[![Auto updates](img/43c0040213c9496b19f97bcd5f35e7f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0HjptXwQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/auto-updates.png)

默认情况下，自动更新处于启用状态。哦，亲爱的！检测到您的站点关闭(并备份)，它会在状态页面上写一条消息。这就是它看起来的样子。

[![Auto updates example](img/f773e249b4d5727309887dd70a6c3e09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FLbujPgH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/auto-updates-example.png)
...
[![Offline](img/bc2ed6208cf7664f55f23080a5cb1909.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--doBz1RUd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/offline.png)
...
## [](#integration-into-flare)整合成耀斑

在 [Flare](https://flareapp.io) 上，我最近和一些好朋友一起构建的异常跟踪器，我们已经在使用 [an 哦天哪！通电状态页面](https://status.flareapp.io)。

[![Status flare](img/3fee3f803dd59c12d52caf7f68bb9a2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BnyktkS6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/status-flare.png)

在 Flare 主页上，我想强调一个小小的细节。在所有 Flare 页面的页脚都链接了状态页面。在那个链接之前，如果有任何问题，会有一个指示器。

[![Flare footer](img/c802d858bbc124e0e238977088808e72.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OJYHoqx9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/flare-footer.png)
...
[![Oh Dear!](img/eb3f730e809b46c00a53a204f0962531.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JBZ-Agrd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/status-pages/ohdear.png)