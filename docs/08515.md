...
> 原文:[https://dev.to/canro91/what-the-func-action-4c7g](https://dev.to/canro91/what-the-func-action-4c7g)
...
## [](#how-to-use-raw-func-endraw-and-raw-action-endraw-in-a-method)如何在一个方法中使用`Func`和`Action`？
...
## [](#how-to-declare-a-method-that-receives-raw-func-endraw-or-raw-action-endraw-)如何声明一个接收`Func`或者`Action`的方法？
