...
> 原文:[https://dev . to/riccardoodone/building-a-blog-in-haskell-with-yesod-the-basic-structure-43i 7](https://dev.to/riccardoodone/building-a-blog-in-haskell-with-yesod-the-basic-structure-43i7)
...
[![](../Images/56cfdeb1e9724e59ce2f198d97d8acf2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iAZdAl5h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bhbjvgeyw2i1de2lvy8c.png)

1.  成功登录后，用户被重定向到帖子页面。在这里，用户可以创建一个新的帖子，并查看所有已经发布的帖子:

[![](../Images/1f0c844ff627e23a39125b6040e566d8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UE9FFs66--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5xxzkng7hzs8yu5yt5u0.png)
...
[![](../Images/3f22d2c218b5eeda70beae7fb15c84fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Dvk2b_5a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/599fgi6u64xn2aj6eh0e.png)

错误来自于处理程序尚未开发的事实。

## [](#landing-somewhere)在某地着陆
...
如果我们现在访问`/landing`，我们会看到: [![](../Images/a9a74ad0df318c1d7adef710f96bf4c4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--svbwGQQ6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cm29u5nflmmxmwfuy8cw.png)

## [](#tweaking-the-landing)调整落地
...
如果我们现在访问`/`，我们会看到: [![](../Images/56cfdeb1e9724e59ce2f198d97d8acf2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--iAZdAl5h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bhbjvgeyw2i1de2lvy8c.png)
...
如果我们现在访问`/posts`，我们会看到: [![](../Images/c4a79f85cd625903b85ebb30ca52268a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--9BbiR3yS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x7sxmm1jt5zq28n83jjy.png)

## [](#tweaking-the-empty-layout)调整空布局
...
## [](#adding-javascript-and-css-to-posts)给帖子添加 JavaScript 和 CSS
...
如果我们现在访问`/`，我们会看到: [![](../Images/1f0c844ff627e23a39125b6040e566d8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UE9FFs66--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5xxzkng7hzs8yu5yt5u0.png)
