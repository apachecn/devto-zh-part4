...
> 原文:[https://dev.to/laurieontech/human-readable-javascript-337o](https://dev.to/laurieontech/human-readable-javascript-337o)
...
### [](#curly-braces-and-raw-return-endraw-)花括号和`return`
...
### [](#use-a-separate-function)使用单独的功能
...
### [](#how-do-we-determine-what-is-readable)我们如何确定什么是可读的
