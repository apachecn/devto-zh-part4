...
> 原文:[https://dev.to/czyang/go-porject-settings-in-vs-code-3nl4](https://dev.to/czyang/go-porject-settings-in-vs-code-3nl4)

# [](#go-porject-settings-in-vs-code)执行 VS 代码中的项目设置

目前，VS 代码是开发 Go 项目的一个很好的工具，不需要太多的配置工作。对于大多数简单的 Go 项目，你只需要安装 Go 插件就可以把你的 VS 代码转换成 Go IDE。我已经注意到我在 VS 代码中设置 Go 时遇到的一些问题。

## [](#for-the-project-using-go-111-modules)为项目使用 [Go 1.11 模块](https://github.com/golang/go/wiki/Modules)
...
## [](#disable-format-on-save)禁用“保存时格式化”
