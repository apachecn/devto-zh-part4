# 使用 Next-Cart 从 OsCommerce 迁移到 Zen Cart

> 原文:[https://dev . to/next _ cart/migrate-from-oscommerce-to-Zen-cart-with-next-cart-30i](https://dev.to/next_cart/migrate-from-oscommerce-to-zen-cart-with-next-cart-30i)

# [](#what-data-can-be-migrated-from-oscommerce-to-zen-cart)什么数据可以从 OsCommerce 迁移到 Zen Cart
...
# [](#how-to-migrate-oscommerce-to-zen-cart-with-nextcart)如何使用 Next-Cart 将 OsCommerce 迁移到 Zen Cart
