...
> 原文:[https://dev . to/惠晶/recreating-the-fool-s-mate-chess-move-with-CSS-grid-3o MH](https://dev.to/huijing/recreating-the-fool-s-mate-chess-move-with-css-grid-3omh)
...
[![](../Images/c91ff89681129c0b0d2828637600f08a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--njUzkj8v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5ci1gjtxiasddagmrhws.gif)
...
[![Visualisation of how a grid item might be animated](../Images/6fa25e3f8300ee510194fccf10ba3954.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--561oAZga--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/fools-mate/animate-item.png)

正在被动画化的是网格*行*或*列*。这就是为什么我们用 DevTools 得到了很酷的效果(对我来说很酷，我不知道你怎么想…)，但这也意味着你必须扭曲你的网格来制作动画。

<figcaption>这就是实际可以得到的动画</figcaption>

[![Visualisation of how a grid rows or columns are animated](../Images/d40949c0cffadce847100f8124bb1032.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--KtMjCnBw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/fools-mate/animate-rc.png)
...
[![Linear gradient of 45 degrees with hard stop](../Images/c2febd674430743f6e012aceef4174e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lyZnpSdw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/fools-mate/bg1.png)
...
[![Setting a background size](../Images/0eef3725f38b99e84c6eab1ea039165a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WFwjSv1r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/fools-mate/bg2.png)
...
[![Setting a background size](../Images/a8d9404e4fa723655ddf604fd4a72b8a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lFC-T6Cj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/fools-mate/bg3.png)

所以我们正在做的是将第二个线性梯度向下向右推，这样三角形就会相遇并形成正方形。在我的例子中，我使用了`12vmin`的长度值，但是你也可以通过使用`50%`得到相同的效果。

### [](#placing-the-chess-pieces)放置棋子
...
### [](#animating-the-4-moves)制作 4 个动作的动画

<figcaption>[图片来源](https://www.thesprucecrafts.com/fools-mate-the-fastest-checkmate-611599)</figcaption>

[![How to pull off a fool's mate in chess](../Images/5aed4c0cf0007f028763c56c12bd1f9c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--87Uc9QBS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/fools-mate/fools-mate.png)
