...
> 原文:[https://dev.to/gamersuji/c-intro-to-interface-3b3f](https://dev.to/gamersuji/c-intro-to-interface-3b3f)
...
### [](#so-now-lets-see-how-we-could-use-this-eatint-consumateamount-for-a-human-test-subject)现在让我们看看如何将这个**Eat(int consume amount)**用于人类测试对象。
...
### [](#weve-just-learned-what-an-interface-is-but-this-is-not-the-best-application-of-it)我们刚刚学习了什么是**接口**，但这并不是它的最佳应用。

# [](#thus-we-have-a-makebelieve-scenario-here-where-interface-could-be-used-at-its-best)因此我们在这里有一个假想的场景，其中**接口**可以得到最好的利用。
...
### [](#now-lets-write-the-feeding-system)现在让我们来写送料系统
