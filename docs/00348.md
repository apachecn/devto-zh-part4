...
> 原文:[https://dev . to/kasu ken/how-to-use-powershell-with-visual-studio-code-like-a-pro-475 b](https://dev.to/kasuken/how-to-use-powershell-with-visual-studio-code-like-a-pro-475b)
...
## [](#installing-the-extension)安装分机

启动 Visual Studio 代码，按**Ctrl+P**(Mac 上的 **Cmd+P** )。
编辑器打开一个侧栏扩展，选中 PowerShell 扩展。
点击**安装**，然后**重新加载**。

[![](img/b12aaff32965e1d8bb786d6925c0e8b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SUBh2iG---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://docs.microsoft.com/en-us/powershell/docs-conceptuimg/vscode.png%3Fview%3Dpowershell-6)

## [](#choose-the-version-of-powershell-for-your-session)为您的会话选择 PowerShell 版本
...
## [](#a-specific-configuration-for-powershell-files)针对 PowerShell 文件的特定配置
...
## [](#how-to-debug-powershell-script)如何调试 PowerShell 脚本
...
## [](#command-explorer-and-module-explorer)命令浏览器和模块浏览器
...
[![](img/0892b0a9e41ef8a0f4488ece379fcdef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YVMxwhrT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://ironmansoftware.com/wp-content/uploads/2019/04/updateGif.gif)
