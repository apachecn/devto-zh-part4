...
> 原文:[https://dev.to/jay_tillu/interface-in-dart-208j](https://dev.to/jay_tillu/interface-in-dart-208j)
...
#### [](#syntax-of-declaring-interface)声明接口语法
...
## [](#implementing-multiple-interface)实现多个接口

* * *

*   Dart 不支持多重继承，但是 dart 可以实现多个接口。以提供相似的功率和功能。

#### [](#the-syntax-for-declaring-multiple-interfaces)声明多个接口的语法
