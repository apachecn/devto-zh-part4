...
> 原文:[https://dev . to/bnevilleoneill/5-es 2019-features-you-can-use-today-399k](https://dev.to/bnevilleoneill/5-es2019-features-you-can-use-today-399k)

[![](../Images/3013e96e9748ab00d7e6d0a6e7915fce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--90U0JP4x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/puo867luzzwz9rxezvr7.jpg)
...
## [](#1-objectfromentries)1。Object.fromEntries()
...
## [](#2-trimstart-and-trimend)2。trimStart()和 trimEnd()
...
## [](#3-flat-and-flatmap)3。flat()和 flatMap()
...
## [](#4-description-property-for-symbol-objects)4。符号对象的描述属性
...
## [](#5-optional-catch-binding)5。可选 catch 绑定
...
## [](#bonus-es2020-stringprototypematchall)奖励:es 2020 string . prototype . match all
