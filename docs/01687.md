...
> 原文:[https://dev.to/swlkr/do-good-daily-day-6-21ne](https://dev.to/swlkr/do-good-daily-day-6-21ne)
...
## [](#swiftui-is-better-than-web-development)SwiftUI 比 web 开发好
...
## [](#swiftui-full-screen-background-image)SwiftUI 全屏背景图
...
## [](#swiftui-center-an-image)SwiftUI 居中一幅图像
