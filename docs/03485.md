...
> 原文:[https://dev . to/Rubin/how-to-management-environment-variables-on-nestjs-30ge](https://dev.to/rubiin/how-to-manage-environment-variables-on-nestjs-30ge)
...
### [](#with-config-file-supplied-basic)提供配置文件(基本):
...
### [](#with-config-file-supplied-and-safe-set-to-true)提供配置文件，安全设置为真:
...
### [](#without-config-file-supplied)未提供配置文件:
