...
> 原文:[https://dev . to/Mustapha/all-you-need-to-know-about-angular-animations-1c 09](https://dev.to/mustapha/all-you-need-to-know-about-angular-animations-1c09)
...
[![demo](../Images/4447bf8a133bf2054ba0e06edeb60e44.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iJlBySU9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/0ctcQXw/final.gif)

正如他们所说的，熟能生巧，所以如果你喜欢，你可以继续克隆这个库并开始运行(本文的每一部分都代表了库的一个 git 分支)。

**注- >** 如果你对跟随不感兴趣，你可以直接跳到第 3 部分，在那里你会发现角度动画 API 提供给你的超能力。

# [](#1-creating-the-main-component)1。创建主要组件📦
...
# [](#2-implementing-the-list-component-without-animations-for-the-moment)2。实现列表组件(暂时没有动画)
...
## [](#animating-elements-of-the-list)列表中的动画元素

首先，我们将开始动画列表元素的添加和取消。现在我们有这个:

[![item list](../Images/a8287204d728718f8f6f9b10c05aab54.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8DNHqxsx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/L51vrj7/item-list.gif)

我们想要这个(关注左边的列表):

[![animated item list](../Images/299bdcdb488360c264b7379c44dd9bfd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I6wzEJ3l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/3dv019M/anime-item-list.gif)
...
## [](#animating-the-content)制作内容动画

内容动画有点复杂。如果我们将内容容器从左到右动画化，我们有两个选择:要么动画化宽度，要么平移元素。遗憾的是，这些解决方案都不起作用。如果我们控制宽度，我们会得到这个:

[![width animation](../Images/d04a03c03e32f3ae57a09c37c2c5c608.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hrytOgq0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/FgS816w/width.gif)

内容随着宽度的增长而出现，但感觉不对，因为内容不是从左向右滑动的。为了解决这个问题，我们可以尝试从左向右翻译内容，但是看看会发生什么:

[![translate animation](../Images/a01818c16e09010ccac3c74e907f4c78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j_zroLq---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/GTF3CJx/translate.gif)

它创建了一个 flash 效果(空选择组件),因为当我们翻译内容元素时，我们没有动画显示它的宽度，所以它会在一眨眼的时间内从当前值变为 0。解决方案是我们必须在动画宽度的同时翻译内容。

在下图中，我们有一个黑色的外部容器和一个蓝色的内部容器:

[![inner and outer element](../Images/7be87b3677335e954c56af251a28aec0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--83N2lFFN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.ibb.co/tm36YjH/inner-outer.png)

因此，我们将在平移蓝色容器的同时制作黑色容器宽度的动画。应该是这样的:

[![good animation](../Images/7063674e6dfbb8d449851a21ac0df0d5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HizNjIk1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/RDsrBKy/widthandtranslate.gif)
...
[![mustapha](../Images/6bdfdf3b2211f22eadcf26ba89e0b921.png)](/mustapha) [## 角度单位测试 101(带示例)
