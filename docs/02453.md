...
> 原文：<https://dev.to/rncrtr/multi-select-in-visual-studio-code-19k2>
...
###### 参见 [VS 代码键绑定页面](https://code.visualstudio.com/docs/getstarted/keybindings)了解更多关于操作系统特定快捷键的信息
