...
> 原文:[https://dev.to/ri5hirajp/arrow-functions-in-php-3c2c](https://dev.to/ri5hirajp/arrow-functions-in-php-3c2c)
...
## [](#lets-go-through-the-rules)让我们过一遍规则
