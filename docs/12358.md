...
> 原文：<https://dev.to/ratracegrad/how-to-build-a-single-page-application-using-vue-js-vuex-vuetify-and-firebase-part-4-of-4-51hh>
...
[![Firebase Demo](img/d35d63554a6f46d81fdf27680c156144.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--GwsrdRqe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563798716/demo_nue1c0.png)

点击`Add Project`按钮。输入项目的名称。我输入“膳食准备”作为我的项目名称。选中所有复选框。然后点击`create project`按钮。

[![ Add new project dialog on Firebase](img/8bd69c33122b385fe9be29e0aa303a0a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--OZTWSMDn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563798790/add_jradvn.png)

一旦你的项目被创建，Firebase 将带你到你的项目的主页。

[![Project Home Page](img/14015e654a98e02a3a8e36031ab65fbf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CE8GjqAK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563798820/project_miepsp.png)

我们需要将项目的配置集成到我们的膳食准备应用程序中。单击 web 按钮，将 Firebase 添加到您的应用程序中。(注:如果你不确定是哪个按钮，那就是带`</>`的按钮。在上图中，按钮就在“开始”字样的正上方单击“复制”按钮将代码片段复制到剪贴板。

[![Firebase config snippet ](img/b9a4480820f54c15e6e5880fcca96d93.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--QAZ1ZR7T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563798857/config_mamnkn.png)
...
[![Setting up authentication in firebase](img/18b27cb5b0baaeffacd796311649d0dd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BJOhIQwi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563798910/auth_wa5hoi.png)

在登录提供商列表中，单击电子邮件/密码:

[![select Email/Password](img/e3fd7eaf97c3264d16d309e1f5917303.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--zlBp-XT2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jenniferbland.com/wp-content/uploads/listof.png)

允许所有用户使用他们的电子邮件地址和密码注册。然后点击`save`按钮。

[![Enable sign up using email and password](img/8692879f4523a72cf7c1ae255ff073e4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pRNYAQpa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563798955/listof_ndmbos.png)
...
[![User has been registered](img/1d7b27c9743d81471d0224b2414d27cd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--IGvQT7pd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563799054/registered_wp8suw.png)
...
[![Start database in test mode](img/03e7bdac86fc78538e6dcf851da9827e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vVjX4IgY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563799160/startdb_geyf8g.png)
...
[![Recipes added to the database](img/10af97b77e54313bed3b29b11437b6aa.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--R_WUz2_U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563799226/recipes_c635rt.png)
...
[![List of my recipes](img/7bc7a022f04011a7aa2fdea697d87d54.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4tQxi8Yf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ratracegrad/image/upload/v1563799327/listRecipes_x31wwl.png)
