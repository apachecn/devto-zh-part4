...
> 原文:[https://dev . to/dabi T3/graph QL-tutorial-how-to-management-image-file-uploads-downloads-with-AWS-app sync-AWS-amplify-HGA](https://dev.to/dabit3/graphql-tutorial-how-to-manage-image-file-uploads-downloads-with-aws-appsync-aws-amplify-hga)

### [](#how-to-create-amp-query-images-and-files-using-graphql-with-aws-appsync-aws-amplify-and-amazon-s3)如何通过 AWS AppSync、AWS Amplify 和亚马逊 S3 使用 GraphQL 创建&查询图像和文件

[![How to upload files and images with GraphQL](../Images/8809a66fde0d1b89a101821dcdf6598d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qRZ8aMAL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8663e9ww7x7d51j5x09l.png)
...
[![](../Images/bcc9b91d1f8e135fa8919551420c8680.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n3pcuakR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tz9uzlv73y4eze4ca07k.png)

将策略更新为以下内容。您需要将**资源**字段更新为您的时段的资源名称(即`arn:aws:s3:::gqlimages6c6fev-dev`需要替换为您的时段的名称):

```
{  "Version":  "2012-10-17",  "Statement":  [  {  "Effect":  "Allow",  "Principal":  "*",  "Action":  "s3:GetObject",  "Resource":  "arn:aws:s3:::gqlimages6c6fev-dev/public/images/*"  }  ]  } 
```

<svg width="20px" height="20px" viewBox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-on"><title>Enter fullscreen mode</title></svg> <svg width="20px" height="20px" viewBox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-off"><title>Exit fullscreen mode</title></svg>

### [](#interacting-with-the-api-from-a-client-application)从客户端应用程序与 API 交互
