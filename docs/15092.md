...
> 原文:[https://dev.to/trusktr/meteor-vs-webpack-vs-parcel-39d7](https://dev.to/trusktr/meteor-vs-webpack-vs-parcel-39d7)

对，没错，我说的是[流星](https://www.meteor.com/)！

流星经常被忽视。出于我无法解释的原因，它被严重低估了。事实上，这只是 dev.to 上标记为`meteor`的第十篇帖子！

## [](#meteor-is-a-fantastic-piece-of-software)流星是一款神奇的软件。
...
## [](#meteor-vs-webpack-meteor-vs-parcel-what)流星 vs [Webpack](https://webpack.js.org/) ？流星 vs [包裹](https://parceljs.org/)？什么？
...
## [](#okay-so-what-are-the-differences)好吧，那有什么区别呢？
