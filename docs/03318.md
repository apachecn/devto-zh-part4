...
> 原文:[https://dev . to/bnevilleoneill/puffuses-with-react-hooks-36n 9](https://dev.to/bnevilleoneill/frustrations-with-react-hooks-36n9)

**作者:[保罗·考恩](https://blog.logrocket.com/author/paulcowan/)✏️**

## [](#what-problems-do-hooks-solve)钩子解决什么问题？
...
## [](#what-was-wrong-with-class-components)类组件怎么了？
...
## [](#to-hell-and-back-with-the-dependencies-array)赴地府，背同相依阵
...
## [](#react-relies-on-the-order-in-which-hooks-are-called)React 依赖于钩子的调用顺序
...
## [](#return-an-executable-function-from-the-hook)从钩子返回一个可执行函数
...
[https://codesandbox.io/embed/cxowi](https://codesandbox.io/embed/cxowi)T2】
