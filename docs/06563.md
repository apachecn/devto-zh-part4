...
> 原文:[https://dev.to/domysee/type-safe-redux-reducers-3o5i](https://dev.to/domysee/type-safe-redux-reducers-3o5i)

要解决的主要问题是在检查 Redux actions 的`type`属性后，如何向 TypeScript 显示具体的 action 类型是什么。

## [](#straightforward-solution)直截了当的解决
...
## [](#inferring-concrete-types-from-unions)从并集推断具体类型
...
## [](#using-unions-to-infer-the-action-type)利用联合来推断动作类型
...
## [](#removing-action-types-with-raw-returntype-endraw-)用`ReturnType`删除动作类型
