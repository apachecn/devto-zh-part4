...
> 原文:[https://dev.to/xanderyzwich/customizing-11ty-blog-1hm8](https://dev.to/xanderyzwich/customizing-11ty-blog-1hm8)
...
[![Unmodified blog](../Images/88effbdddd79b84206e74a21876acddb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UHm19WG1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://coreydmccarty.dev/img/Generic11ty.jpg)
...
## [](#edit-datametadatajson)编辑 _ 数据/元数据. json
...
## [](#delete-this-message-from-includeslayoutsbasenjk)从 _includes/layouts/base.njk 中删除此消息
...
## [](#still-a-work-in-progress)仍在进行中的工作
