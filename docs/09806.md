...
> 原文:[https://dev . to/bnevilleoneill/js-promises-race-vs-all-vs-all settled-11n 8](https://dev.to/bnevilleoneill/js-promises-race-vs-all-vs-allsettled-11n8)

## [](#the-what-why-and-when)什么，为什么，什么时候

[![](../Images/acc22f5862ec630b3e3e77536178ca1a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xDkv95Ao--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fgl2z7nc6msttoh3hiu5.png)
...
## [](#enter-promiseallsettled)输入 Promise.allSettled
...
## [](#when-do-you-use-raw-race-endraw-)什么时候用`race`？

信不信由你，有几个例子可以说明你为什么想用这种方法。现在让我给你两个例子:

### [](#n%C3%BAmero-1-performance-checks)第一步:性能检查
...
### [](#number-2-loading-indicator-should-i-show-it)数字 2:加载指示器，我要显示吗？
