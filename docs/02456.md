...
> 原文:[https://dev . to/azure/create-and-test-a-JavaScript-node-js-server less-function-on-azure-2d 3](https://dev.to/azure/create-and-test-a-javascript-node-js-serverless-function-on-azure-2d3)
...
# [](#create-an-azure-functions-app)创建一个 Azure 功能应用程序
