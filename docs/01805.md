...
> 原文:[https://dev . to/swell ham/up-and-running-with-FAK tory-in-elixir-16gl](https://dev.to/swelham/up-and-running-with-faktory-in-elixir-16gl)
...
## [](#we-have-faktory-running-whats-next)我们有 Faktory 跑步，接下来呢？
...
## [](#lets-perform-some-jobs)让我们执行一些工作吧！
...
## [](#jobs-with-multiple-arguments)具有多个参数的作业
...
## [](#what-happens-when-things-go-wrong)出了问题会怎么样？
