...
> 原文:[https://dev . to/moesif/mastering-API-analytics-for-API-programs-chapter-1-the-developer-funnel-58nn](https://dev.to/moesif/mastering-api-analytics-for-api-programs-chapter-1-the-developer-funnel-58nn)
...
## [](#the-developer-funnel)开发者漏斗

而传统的客户漏斗将仅由营销和销售漏斗组成。然而，作为一种产品，客户和合作伙伴包括开发者的 API 拥有所谓的*开发者漏斗*或
*集成漏斗*。开发者漏斗在营销漏斗之后，销售漏斗之前，有三个核心阶段:

[![Developer Integration Funnel](../Images/6c05ace8c14027d5d5cdddba0a572e41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PlGNPQ5i--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/api-analytics/developer-funnel.svg)

### [](#preintegration-stage)预整合阶段
...
## [](#developer-cohort-segmentation)开发商群体细分
...
### [](#building-profiles-of-users-and-companies)建立用户和公司的档案
...
[![List of companies/accounts](../Images/8bb719a1d19166821687284e4d252a68.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iezUlRs---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/api-analytics/companies.png)

### [](#understanding-api-design)了解 API 设计
...
[![Top companies per API operation](../Images/0810efadd31f3997197dcc09f2959293.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tFJBnzdL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/api-analytics/top-companies-per-API-operation.png)

### [](#defining-api-engagement)定义 API 约定
...
## [](#measuring-developer-acquisition)测量显影剂采集量
...
### [](#how-to-properly-measure-developer-marketing-channels)如何正确衡量开发者营销渠道
...
## [](#measuring-api-growth-and-engagement)衡量 API 增长和参与度

### [](#api-mau-and-api-dau)API MAU 和 API DAU

如果你想跟踪你的 API 程序的增长， *API 月活跃用户* (API MAU)和 *API 日活跃用户* (API DAU)是
每个数据驱动的产品负责人都应该跟踪的两个 KPI。

[![API DAU vs Total Events](../Images/724757c5a94718ca42c05cb2ee20e836.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v98PUXu1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/api-analytics/api-dau-vs-total-events.png)
...
### [](#28day-api-usage28dayactive-companies)28 天 API 使用量/28 天活跃公司
...
## [](#distinct-api-operationsapplication)不同的 API 操作/应用
