...
> 原文:[https://dev . to/dbottillo/how-I-make-my-legacy-app-modular-part-2-2 CIC](https://dev.to/dbottillo/how-i-made-my-legacy-app-modular-part-2-2cic)

这是 https://dev . to/dbottillo/how-I-have-modulated-my-legacy-app-part 1-4 mde 的第二部分。

在第 1 部分中，我展示了如何从一个大模块转移到三个大模块:

[![Three modules architecture](img/1315aa421751fffe347d9ebe3a735c36.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VPxGZcB3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6x351ek6lxae9fgwagot.jpg)
