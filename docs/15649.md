...
> 原文:[https://dev . to/progress/why-sign-in-with-apple-is-pretty-great-31fl](https://dev.to/progress/why-sign-in-with-apple-is-actually-pretty-great-31fl)
...
## [](#why-passwords-are-the-worst)为什么密码最差
...
[![A list of best selling internet & telecommunications books on Amazon](../Images/db64d2f69d1ec23748e5f9ecbe1cbedf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--zWwS56Zd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wq6lohfpa6q8h929at6b.png) 
*我们失败了。失败的**硬**。*
...
## [](#making-login-better)让登录更好

每个人都知道我们目前的登录方式并不理想，许多科技公司都试图让这一过程变得更好。登录界面可用性的一个重大改进是单点登录的出现，用户使用一个帐户来验证多个应用程序或服务。

[![A device showing sign in with Google and sign in with Facebook buttons](../Images/382b6383dd6dc0e960e8b55d6b00fe55.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--emNq7Sfr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0d89ef7sl0wstdwmuad1.png) 
...
[![An example of ‘Sign in with Apple’ in action in a sample app](../Images/3f4c9e2d56e9d1ec075ce2312b626065.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--aZeXncmk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eeq7lt81ljcx55ak2q7a.jpg) 
*示例应用程序中“登录苹果”的一个例子。*
