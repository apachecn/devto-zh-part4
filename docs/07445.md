...
> 原文：<https://dev.to/sirech/how-to-automate-rest-api-end-to-end-tests-in-a-ci-environment-with-postman-and-newman-d7n>
...
[![You got to test it](img/cdfa6665c98f5ea9117b56c15da58f2f.png "You got to test it")](https://res.cloudinary.com/practicaldev/image/fetch/s--_qjAMLrA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hceris.com/static/9ec962179ef8f33885ff20c37dbb1e62/acb04/introduction.jpg)
...
<figure>[![All to real](img/94cb46ad3bf224f5dbf14df73856201f.png "All to real")](https://res.cloudinary.com/practicaldev/image/fetch/s--DXzF8POB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hceris.com/static/76e69979abd0fbfdb82c1914aa6fa4a7/9128f/poke-e2e.png)

<figcaption>
 <small>由极客&戳/ [抄送由](https://creativecommons.org/licenses/by/3.0/)</small> 
</figcaption>
...
[![Postman export](img/403f3ab3ba24000a8c111f9fc684c1f4.png "Postman export")](https://res.cloudinary.com/practicaldev/image/fetch/s--lCOqVZKR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hceris.com/static/d2bf1c564dd734894c569366134220ac/7c1cd/export-postman.png)
...
很好，我们澄清了这一点！它作为一个 npm 包安装，这可能会产生一个简单的`package.json`:
...
如前所述，您不希望在该集合中硬编码变量，如 URL、参数或(但愿不会如此)密码。不灵活，也不安全。相反，我喜欢使用包含所有这些值的配置文件。但是如果我们想要提交那个文件，我们仍然需要想出一个方法来避免把秘密放在那里。我将它用作模板，并在运行时用 envsubst 替换值。配置文件看起来像这样
...
[![The test tab is on me](img/d00b3d74a6eb32fb5cc266e9a6422361.png "The test tab is on me")](https://res.cloudinary.com/practicaldev/image/fetch/s--rgc-syjJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hceris.com/static/ba9c632166d1582f8eafb0adf6b627c7/1d69c/test-tab.png)

我们的测试是用 *JavaScript* 编写的，使用的是 [Chai](https://www.chaijs.com/api/bdd/) 。假设我想测试我的调用传递了一个结果列表，我可以这样做:
...
[![Output](img/6a049b69657fde215f8d48bf8121ff10.png "Output")](https://res.cloudinary.com/practicaldev/image/fetch/s--9NBwrdQk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hceris.com/static/4ada27bc72a0a092f1ca972a5ed21cf2/1d69c/output.png)
