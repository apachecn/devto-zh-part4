...
> 原文:[https://dev . to/evil Marshall/sorbitting-a-gem-or-the-story of-the-first-adoption-3j3p](https://dev.to/evilmartians/sorbetting-a-gem-or-the-story-of-the-first-adoption-3j3p)
...
> ![unknown tweet media content](../Images/ba4430a254cdcd724768832e7b251a76.png)【AMR】@ amrabdelwahab![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)
...
## [](#rubanok-meets-sorbet)[鲁巴诺克](https://github.com/palkan/rubanok)遇上冰糕
...
### [](#-raw-bundle-exec-srb-init-endraw-)`bundle exec srb init`
...
### [](#-raw-bundle-exec-srb-tc-endraw-)`bundle exec srb tc`
...
### [](#problem-1-unsupported-features)问题 1。不支持的功能。
...
# [![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) 评论为 #1010](https://github.com/sorbet/sorbet/issues/1010#issuecomment-504709824) 

[![DarkDimius avatar](../Images/5571e4b38d8a2167cd590ba46fa55877.png)](https://github.com/DarkDimius) **[DarkDimius](https://github.com/DarkDimius)** commented on [<time datetime="2019-06-23T00:56:24Z">Jun 23, 2019</time>](https://github.com/sorbet/sorbet/issues/1010#issuecomment-504709824)
...
### [](#problem-2-limitations-of-flowsensitivity)问题二。[流量敏感性的局限性](https://sorbet.org/docs/flow-sensitive#limitations-of-flow-sensitivity)
...
### [](#problem-3-signatures-vs-modules)问题三。签名与模块。
...
### [](#problem-4-metaprogramming)问题四。元编程。
...
### [](#problem-5-runtime-checks)问题五。运行时检查。
...
> ![Dmitry Petrashko profile image](../Images/9c37e051b0a03c6e806f72ff2d67457a.png)德米特里·彼得拉什科@ darkdimius![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)[@ cm _ Richards](https://twitter.com/cm_richards)[@ sorbet _ ruby](https://twitter.com/sorbet_ruby)[@ _ solnic _](https://twitter.com/_solnic_)[@ stripe](https://twitter.com/stripe)我们在生产中运行。我们测量开销。如果开销是>= CPU 时间的 7%，我们就分页。2019 年 6 月 20 日 21 点 08 分[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1141815076615147520)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1141815076615147520)1[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1141815076615147520)2
...
### [](#problem-6-debugging)问题#6。调试。

我是 [`binding.pry`](https://github.com/deivid-rodriguez/pry-byebug) 的重度用户。

当我调试带有类型签名的代码时，我发现很难*进入*方法:

[![](../Images/cf8af9e220aa2537b7894b1139862648.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CVntHRtA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bqnuakatobw18sip8dz9.gif)

你能找到原方法藏在哪里吗？

## [](#in-conclusion-or-its-just-the-beginning)结论，或者只是开始
