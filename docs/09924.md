...
> 原文:[https://dev . to/stmcallister/assigning-a-Google-domain-to-git lab-pages-22ap](https://dev.to/stmcallister/assigning-a-google-domain-to-gitlab-pages-22ap)
...
## [](#gitlab-pages)GitLab 页

在 Pages 站点的 GitLab 存储库中，转到 Settings -> Pages。在“设置”页面上，单击右上角的绿色“新域”按钮。

[![GitLab Pages New Domain Button](../Images/498893c374489615be276763a64b7c4c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qw8crr4w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ymc6luk8pty6hmiy3q2.png)

在 New Pages Domain 页面上，输入您希望用于 GitLab pages 站点的域。还有输入证书和私钥的选项。因为我们的站点只是静态的，不处理任何类型的信息，所以我们没有设置这两个值。准备就绪后，单击创建新域。

[![GitLab Pages New Domain Form](../Images/2f63b16a6d93a7a6a27cb3d27d7e639b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kAIEpDMo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7jtcwu65tur2n5x8szhk.png)
...
[![GitLab Pages Domain Settings](../Images/e7c08b9a803dd69262c24327daa8f871.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XxV3Fbgm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cv4z57s25zaeqix8xqju.png)

## [](#google-domains)谷歌域名

在 Google 域中，选择您的域，转到 DNS 部分，向下滚动到自定义资源记录。您将添加两个资源记录来将您的 Google 域指向您的 GitLab 页面站点。

[![Google Domains DNS Custom Resources](../Images/7215e0278be32ceb84f79e0ca8dbac93.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RNDLQmPX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1f1z97aney2k9i3xpnny.png)
