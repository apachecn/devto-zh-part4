...
> 原文:[https://dev . to/eice blue/add-image-or-text-stamps-to-pdf-in-Java-2p7g](https://dev.to/eiceblue/add-image-or-text-stamps-to-pdf-in-java-2p7g)

PDF 印章通常用于合同、报告和受限材料中，以证明文件已经过审查并标记为“已读”、“合格”或“机密”等。这篇文章将向你展示我们如何通过使用 Java 的免费 Spire.PDF 来给 PDF 文档添加图像图章和文本图章。

## [](#add-image-stamp)添加图像图章
...
输出:
[![](../Images/f76240cd2e0365a2b4c5aee77c6aedf6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--mVC7OLbg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y1ar59csxzd9izl5nk8c.png)

## [](#add-text-stamp)添加文字戳
...
输出:
[![](../Images/0d7f0245302d9974e81eafd306333b49.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--L0lYaW0f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dmxfyfvbim5db20larfz.png)