...
> 原文:[https://dev . to/jinksi/schedule-your-netlify-build-with-github-actions-5a3d](https://dev.to/jinksi/schedule-your-netlify-build-with-github-actions-5a3d)
...
## [](#creating-a-scheduled-netlify-build-trigger-github-action)创建预定的网络构建触发 GitHub 操作
