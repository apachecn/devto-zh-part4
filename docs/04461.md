...
> 原文:[https://dev . to/bhekanik/super charge-your-git-history-with-better-commit-messages-32fk](https://dev.to/bhekanik/supercharge-your-git-history-with-better-commit-messages-32fk)
...
## [](#why-good-commit-messages-matter)为什么好的提交消息很重要
...
## [](#writing-a-great-git-commit-message)编写一个伟大的 Git 提交消息
...
### [](#1-limit-the-subject-line-to-50-characters)1。将主题行限制在 50 个字符以内
...
### [](#2-capitalize-the-subject-line)2。大写主题行
...
### [](#3-do-not-end-the-subject-line-with-a-period)3。不要以句号结束主题行
...
### [](#4-use-the-imperative-mood-in-the-subject-line)4。在主题行中使用祈使语气
...
### [](#5-separate-subject-from-body-with-a-blank-line)5。用一个空行将主题和正文分开
...
### [](#6-wrap-the-body-at-72-characters)**6。在 72 个字符处换行**
...
### [](#7-use-the-body-to-explain-what-and-why-vs-how)7。用身体来解释什么和为什么以及如何
...
### [](#revise-history-before-sharing)分享前修改历史
