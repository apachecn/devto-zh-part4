...
> 原文:[https://dev . to/4n duril/compilating-modern-language-features-with-the-typescript-compiler-36 m3](https://dev.to/4nduril/compiling-modern-language-features-with-the-typescript-compiler-36m3)
...
## [](#how-to-use-the-typescript-compiler-raw-tsc-endraw-to-transpile-your-code)如何使用 TypeScript 编译器`tsc`来传输你的代码
...
## [](#-raw-include-endraw-and-raw-outdir-endraw-)`include`和`outDir`
...
## [](#-raw-module-endraw-and-raw-moduleresolution-endraw-)`module`和`moduleResolution`
...
## [](#-raw-importhelpers-endraw-)`importHelpers`
...
## [](#should-you-use-raw-tsc-endraw-or-babel-for-transpiling)应该用`tsc`还是巴别塔来翻译？
