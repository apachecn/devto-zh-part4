...
> 原文：<https://dev.to/danielepolencic/scaling-microservices-with-message-queues-spring-boot-and-kubernetes-e8k>
...
[![Traffic](img/ab7a3b0a422d301e9ff2487a1c58d4ff.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--AcnsuXKM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c47ghtt6b99o7029yyje.png)
...
[![REST API](img/4b5deed64d24d61149fe1b2c53d2c21b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PXi4pmMy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/us2neqyl4b6qtqkrz6tn.gif)

今天是个大日子，你的店开始营业了。

您决定将应用程序的前端扩展到四个实例，后端扩展到四个实例，因为您预计网站会比平时更加繁忙。

[![Serving traffic](img/ea275ca15b993b40d564e8bdabfc14eb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CA4n52Zc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p3agx10q1s8ptqa3dgw0.gif)
...
[![Scaling out](img/c538d607fe5fcae28d10a9bf76b7d37f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hQVSYkKl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/el4279gdeeffu5shtikg.gif)
...
[![Too much traffic](img/48829688fab51c3731731c19f9871a56.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Ub38SBvE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/03gcrwcioj9es17qopzr.gif)
...
[![Decoupling front-end and backend with a message broker](img/b26e2f620d8102568926f0c71e577863.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Ucf4juuv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/swxu725o2ewoy20h9mt5.gif)
...
由于 [Spring Boot 与 JMS](https://spring.io/guides/gs/messaging-jms/) 有很好的集成，你可以用它来发送和接收异步消息。

您可以在[learn k8s/spring-boot-k8s-HPA](https://github.com/learnk8s/spring-boot-k8s-hpa)找到一个包含连接到 JMS 的前端和后端应用程序的示例项目。
...
[![Store front-end](img/5fd72c8bafcf8cd60ae1ec5b5d6cf9b0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--FssLQann--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mkmo8685yb98t3xtiil3.png)

**作为一个工作者**，应用程序在队列中等待消息并处理它们。

[![Store admin worker](img/11d2ffb5e7250d827ab60e5d25dade92.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--k8tcLzP4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0wr25nmlk7jbn4s4vmox.png)

> 请注意，在示例项目中，通过使用`Thread.sleep(5000)`等待五秒钟来模拟处理过程。
...
[![Store admin worker](img/fffb0f6281b6e485499f03ea2856a644.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--s4ZEAi46--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s2vbozef5ttecfx2zs9h.gif)
...
> 如果你在 Windows 上运行，你应该看看我们关于如何安装 Kubernetes 和 Docker 的详细指南。
...
> 请注意，如果你切换终端，你需要重新连接到`minikube`里面的 Docker 守护进程。每次使用不同的终端时，您都应该遵循相同的说明。
...
[![Kubernetes basic concepts](img/9dd49a1c24bead483c57d0e2f31cf6ad.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--IJxQcIkS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ein6gbxqmci8tg43xo6d.gif)
...
启用 autoscaler 后，队列中等待处理的消息越多，Kubernetes 就会创建越多的应用程序实例。
...
格式是纯文本，是公开[普罗米修斯指标](https://prometheus.io/docs/concepts/metric_types/)的标准。
...
> 当涉及到解释算法时，文档并没有太大的帮助。你可以[在代码](https://github.com/kubernetes/kubernetes/blob/bac31d698c1eed2b54374bdabfd120f7319dd5c8/pkg/controller/podautoscaler/horizontal.go#L588)中找到细节。
...
*但是，如果集群中没有足够的容量来扩展您的单元，该怎么办呢？*

如果您在集群中达到峰值容量，Kubernetes 将让 Pods 处于挂起状态，等待更多资源可用。

如果你能使用一个类似于水平 Pod 自动缩放器的自动缩放器，那就太好了。

好消息！

您可以拥有一个集群自动缩放器，当您需要更多资源时，它会向您的 Kubernetes 集群添加更多节点。

[![Cluster autoscaler](img/2141e7bd0e9b539306a97c06fde9daea.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dPBEXCav--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bfrroqs4t61828ejpbz4.gif)

集群自动缩放器有不同的形状和大小。

它也是特定于云提供商的。

> 请注意，您将无法使用`minikube`测试自动缩放器，因为根据定义它是单个节点。
...
> 这篇文章最初发表在 [Learnk8s 博客](https://learnk8s.io/blog/scaling-spring-boot-microservices/)上。

如果您喜欢这篇文章，您可能会发现下面的文章很有趣:

*   [小型 Docker 映像的 3 个简单技巧](https://learnk8s.io/blog/smaller-docker-images)并了解如何更快地构建和部署 Docker 映像。
*   Kubernetes 混沌工程:经验教训—第 1 部分，当 Kubernetes 出现问题时会发生什么？Kubernetes 能从失败中恢复并自愈吗？