...
> 原文:[https://dev . to/webhook relay/creating-a-simple-vue-polarizate-filter-j9m](https://dev.to/webhookrelay/creating-a-simple-vue-pluralize-filter-j9m)

有很多方法可以创建一个多元化的函数，但是在 Vue 中你应该使用过滤器。让我们创建一个，因为它总是很方便。

## [](#step-1-add-pluralize-package)第一步:添加复数包
...
## [](#step-2-register-filter)第二步:注册过滤器
...
## [](#step-3-use-the-filter)第三步:使用滤镜！
