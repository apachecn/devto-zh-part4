...
> 原文:[https://dev . to/pmbanugo/secure-react-chat-messaging-app-with-auth 0-4893](https://dev.to/pmbanugo/secure-react-chat-messaging-app-with-auth0-4893)
...
[![chat-messenger.gif](../Images/cfaf267f0fcb9de06999a15a53deb7bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ajEoIL3---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ucarecdn.com/49d354ea-f25e-4386-ab0e-6216b7757717/)
...
[![auth0-app](../Images/c0e25eecbf1735a8e1ef34330515b2d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Hxfmrujt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.ctfassets.net/1es3ne0caaid/6bWbdlVChiCQGYkiGAcieQ/773cfaec3f0713c33b78472b4aced418/secure-chat-javascript-auth0-clients.png)
...
## [](#secure-the-react-app-with-auth0)用 Auth0 保护 React 应用
...
### [](#working-with-our-auth-service)使用我们的认证服务
...
## [](#adding-stream-chat-messaging-for-realtime-conversation)为实时对话添加流聊天消息
...
[![stream chat new app.png](../Images/60e399f9133ddc05d03aa7a1f1dcf483.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Hq2VtlLP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ucarecdn.com/6c5692bf-f081-4272-a4ec-f867b80aa2f5/)
...
### [](#adding-the-user-list-page)添加用户列表页面
...
### [](#adding-the-conversation-page)添加对话页面
...
## [](#adding-the-token-server)添加令牌服务器
...
## [](#running-and-testing-the-app)运行和测试 App
