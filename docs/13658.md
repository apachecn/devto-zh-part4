...
> 原文:[https://dev . to/joaofbantunes/episode-025-integrating-identity server 4-part-5-frontend-ASP-net-core-from-0-to-overkill-155h](https://dev.to/joaofbantunes/episode-025-integrating-identityserver4-part-5-frontend-asp-net-core-from-0-to-overkill-155h)
...
## [](#handle-authenticated-and-unauthenticated-users)处理认证和未认证用户
...
### [](#get-information-about-the-current-user)获取当前用户的信息
...
#### [](#making-requests-to-the-web-api)向 web API 发出请求
...
#### [](#integrating-the-requests-with-the-store)将请求与存储整合
...
#### [](#load-user-information-and-restrict-route-access)加载用户信息，限制路线访问
...
### [](#adapt-ui-to-authenticatedunauthenticated-user)使用户界面适应认证/未认证用户
...
## [](#support-crosssite-request-forgery-token)支持跨站请求伪造令牌
