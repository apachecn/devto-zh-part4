...
> 原文:[https://dev . to/tarise/the-trials-and-traits-of-html-newsletters-26mp](https://dev.to/tarise/the-trials-and-tribulations-of-html-newsletters-26mp)

时事通讯是我生存的克星。幸运的是，我们不再需要研究它们了。以下是我们在管理简讯设计时学到的一些趣闻。

# [](#newsletter-testing)通迅测试
...
<figure>[![](../Images/4f51327c43e4a1072a656ce6f845b7a5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Y5yAyHho--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/864/1%2AVEdKClAseEfoV68Ox6agEQ.png) 
...
## [](#hate-outlookcoms-contextual-highlighting)讨厌 Outlook.com 的上下文突出显示？
...
## [](#avoid-deeply-nested-tables)避免深度嵌套的表格
...
## [](#include-both-embedded-css-and-inline-css)包括嵌入式 CSS 和内联 CSS
