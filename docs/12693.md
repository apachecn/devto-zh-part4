...
> 原文:[https://dev . to/dieter troy/AWS-shell-AWS-CLI-experience-enhanced-10d 3](https://dev.to/dietertroy/aws-shell-aws-cli-experience-enhanced-1od3)

你渴望 AWS CLI 工具中的自动完成和手册页吗？不要再看了，因为 [aws-shell](https://github.com/awslabs/aws-shell) 是来拯救(还是 shell？)这一天。

下面是一个使用 aws-shell 的例子:
[![aws-shell in wsl1](../Images/a0d7fe5b461492e70d0007aee5366fcc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Vl2m6D6---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://snag.gy/pFrPEL.jpg)
