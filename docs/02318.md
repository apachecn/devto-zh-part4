...
> 原文:[https://dev . to/erikwhiting 88/how-to-work-with-memory-optimized-objects-in-SQL-server-2 EIG](https://dev.to/erikwhiting88/how-to-work-with-memory-optimized-objects-in-sql-server-2eig)
...
### [](#why-memory-optimized-tables)为什么要内存优化表？
...
### [](#if-you-want-my-sample-code)如果你想要我的样本代码:
...
[![](img/67d1b6c16da829159c1a2ab73989c407.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nbQMT7r7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/erikscode.space/wp-content/uploads/2019/07/image.png%3Fresize%3D1024%252C71)
