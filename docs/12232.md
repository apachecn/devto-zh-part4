...
> 原文:[https://dev . to/bnevilleoneill/from-rest-to-graphql-a-different-way-to-create-an-API-with-Apollo-nodejs-3jd 2](https://dev.to/bnevilleoneill/from-rest-to-graphql-a-different-way-to-create-an-api-with-apollo-nodejs-3jd2)

[![](../Images/c40c8addf4767222988c8d363f86d30f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d8PT2J4t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9kkj8wt73muyzc9gxopb.png)
...
## [](#step-1-database-layer)第一步:数据库层
...
## [](#step-2-bootstrapping-the-application)步骤 2:引导应用程序
...
## [](#step-3-creating-the-database-models)第三步:创建数据库模型
...
## [](#step-4-implementing-the-database-models)第四步:实现数据库模型
...
## [](#step-5-setting-up-an-apollo-server)第五步:设置阿波罗服务器
...
## [](#step-6-creating-our-graphql-types-and-resolvers)步骤 6:创建我们的 GraphQL 类型和解析器
...
## [](#creating-the-graphql-types)创建 GraphQL 类型
...
## [](#creating-the-graphql-resolvers)创建 GraphQL 解析器
...
## [](#adding-the-ticket-module-to-our-apollo-server)将票务模块添加到我们的阿波罗服务器
...
[![](../Images/625e5458822257fecea4f8049850f80d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QyStGaZx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/scherma.png%3Fresize%3D730%252C463%26ssl%3D1)

## [](#step-7-creating-relations-between-data)第七步:创建数据间的关系

所以这很酷，但是如果能在得到票的时候自动得到用户名就更好了。在我们应用程序的当前状态下，我们只能获得与票相关联的用户 id。在这一步中，我们将创建票证和用户之间的关系。

## [](#adding-the-user-type-on-the-ticket-type)在票据类型上添加用户类型
...
## [](#adding-an-extra-resolver-for-the-user)为用户添加额外的解析器
...
[![](../Images/082e2da6345661137bcc3f47fd8a2cbf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e9R94vrV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/graphqlexample.png%3Fresize%3D730%252C463%26ssl%3D1)
