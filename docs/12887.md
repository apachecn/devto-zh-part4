...
> 原文:[https://dev . to/trilon/deploying-nestjs-apps-to-the-cloud-with zeit-now-1jc 4](https://dev.to/trilon/deploying-nestjs-apps-to-the-cloud-with-zeit-now-1jc4)
...
## [](#what-are-we-trying-to-achieve)我们在努力实现什么？
...
# [](#configuring-zeit-now-for-nestjs)现在为 NestJS 配置 Zeit
...
# [](#nowjson-configuration)Now.json 配置
...
## [](#what-is-this-configuration-doing)这个配置是干什么的？
...
# [](#building-amp-deploying)大楼&正在部署
...
# [](#nestjs-deployed-to-the-%E2%98%81-)NestJS 部署到☁！

如果你看上面(或者在你的终端中，如果你跟着看)，我们可以看到在终端中输出了一个 URL！它被自动复制到我们的剪贴板上，所以请打开浏览器看看吧！！

“你好，世界”的神奇荣耀...

[![NestJS Zeit Now deployment example](../Images/fb0365c7c5513b03e8286d22f0314d7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OOD6aWv5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/76n6xmfotb7f7r6wbqgh.png)
