...
> 原文:[https://dev . to/rocksetcloud/tableau-operational-dashboards-and-reporting-on-dynamo db-evaluating-redshift-and-Athena-311 a](https://dev.to/rocksetcloud/tableau-operational-dashboards-and-reporting-on-dynamodb-evaluating-redshift-and-athena-311a)
...
## [](#considerations-for-building-operational-dashboards-using-standard-bi-tools)使用标准 BI 工具构建运营仪表板的注意事项
