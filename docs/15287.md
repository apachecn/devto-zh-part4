...
> 原文:[https://dev . to/jkostolansky/using-PostgreSQL-advisory-locks-to-control-concurrency-3j0d](https://dev.to/jkostolansky/using-postgresql-advisory-locks-to-control-concurrency-3j0d)
...
## [](#a-simple-lockmanager)一个简单的锁管理器
...
原文:[使用 PostgreSQL 顾问锁控制并发](https://www.kostolansky.sk/posts/postgresql-advisory-locks/)