...
> 原文:[https://dev.to/joelvarty/using-gatsby-with-agility-cms-ojm](https://dev.to/joelvarty/using-gatsby-with-agility-cms-ojm)
...
### [](#create-a-free-agility-account)创建免费敏捷账户
...
## [](#hook-it-up-to-your-agility-cms-instance)将其连接到您的 Agility CMS 实例

编辑 **gatsby-config.js** 文件，用你的替换 *guid* 和 *apiKey* 。

你可以通过导航到设置，然后点击 API 键来找到你的 API 键。

[![alt text](../Images/b2ab7e6842ea419f11a6441cefe21660.png "Agility CMS - Settings - API Keys")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TRSv6Yhu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360035503851/mceclip0.png)
...
[![Alt Text](../Images/94d54e2e1d841d83bcdac8c1feba9594.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OQKoH_Nv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mjv2brybc17iyqdoy25u.png)
