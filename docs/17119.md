...
> 原文:[https://dev.to/rossdrew/functional-enums-in-java-34o1](https://dev.to/rossdrew/functional-enums-in-java-34o1)
...
### [](#approach-number-1-the-result-of-test-driven-development-tdd)方法 1:测试驱动开发(TDD)的结果
...
### [](#the-legacy-amp-and-the-beauty-of-tdd)遗产&和 TDD 之美

这导致了一些很难维护的代码，但却是正确的；感谢我们的测试，快速准确可验证的正确。这意味着我们可以搞乱其他实现，理论上，巨大的测试空间可以在很短的开发周期内发现任何错误。

### [](#approach-number-2-functional-java-code)方法二:函数式 Java 代码
