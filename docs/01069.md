...
> 原文:[https://dev . to/dipakkr/es6-a-comprehensive-guide-to-learn-es 2015-es6-2ao 1](https://dev.to/dipakkr/es6-a-comprehensive-guide-to-learn-es2015-es6-2ao1)
...
### [](#1-var-let-and-const)1。Var，let 和 const
...
### [](#5-array-and-object-destructuring)5。数组和对象析构
...
### [](#6-map-reduce-and-filter)6。映射、减少和过滤
...
### [](#7-iterables-and-looping)7。迭代和循环
...
### [](#8-rest-and-spread-operator)8。休息和传播算子
