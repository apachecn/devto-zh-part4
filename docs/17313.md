...
> 原文:[https://dev . to/prahladyeri/python-check list-publishing-a-package-to-pypi-4jlc](https://dev.to/prahladyeri/python-checklist-publishing-a-package-to-pypi-4jlc)
...
# [](#checklist-publishing-a-package-to-pypi)清单:将包发布到 PyPi
