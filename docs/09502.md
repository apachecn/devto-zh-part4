...
> 原文:[https://dev.to/bugudiramu/flutter-development-day-2-41e6](https://dev.to/bugudiramu/flutter-development-day-2-41e6)
...
### [](#using-real-device)使用真实设备:

#### [](#how-to-enable-developer-options)如何启用开发者选项:
...
### [](#creating-avd-android-virtual-device)创建 AVD (Android 虚拟设备):

*   打开 Android Studio / IntelliJ head 回到右上角的 AVD 管理/选择工具> Android > AVD 管理器并在那里创建一个。

*   如果您想运行应用程序，请按`F5`。

##### [](#here-we-go-we-ready-now)*我们走吧我们准备好了！*

#### [](#writing-your-first-flutter-app)编写你的第一个 Flutter App:
