...
> 原文:[https://dev . to/erikwhiting 88/how-to-use-c-functions-in-python-7do](https://dev.to/erikwhiting88/how-to-use-c-functions-in-python-7do)

您知道可以用 C 编写函数，然后直接从 Python 调用它们吗？是不是很酷？现在让我们跳过所有的背景和“我为什么需要这样做”的问题，直接进入代码吧！

# [](#first-the-c-function)第一，C 函数
...
# [](#the-prepython-part)前 Python 部分
