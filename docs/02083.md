...
> 原文:[https://dev . to/buildly/developing-APIs-based-on-open API-specification-2k nl](https://dev.to/buildly/developing-apis-based-on-openapi-specification-2knl)
...
## [](#what-is%C2%A0openapi)什么是 OpenAPI？
...
## [](#developing-apis-based-on-openapi%C2%A0spec)基于 OpenAPI 规范开发 API
...
## [](#why-openapi-specdriven-development)为什么要 OpenAPI 规范驱动开发？
