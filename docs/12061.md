...
> 原文:[https://dev . to/akira utio/generate-a-pdf-in-AWS-lambda-with-nodejs-and-puppeter-2b 93](https://dev.to/akirautio/generate-a-pdf-in-aws-lambda-with-nodejs-and-puppeteer-2b93)
...
## [](#creating-a-lambda-function)创建 lambda 函数
...
## [](#deployment-to-aws-lambda)部署到 AWS lambda
