...
> 原文:[https://dev . to/leolara/closing-a-go-channel-written-by-number-go routines-52 J2](https://dev.to/leolara/closing-a-go-channel-written-by-several-goroutines-52j2)
...
## [](#another-try-with-raw-select-endraw-)另试同`select`
...
## [](#the-solution-involves-wait-groups)解决方案涉及等待组
...
## [](#testing-for-race-conditions)测试竞态条件
...
# [](#using-a-mutex-lock-around-a-waitgroup)在 waitgroup 周围使用互斥锁
