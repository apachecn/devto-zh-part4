...
> 原文:[https://dev . to/plural sight/custom-angular-checkbox-with-ng model-support-3om 9](https://dev.to/pluralsight/custom-angular-checkbox-with-ngmodel-support-3om9)
...
### [](#add-the-html-template)添加 HTML 模板
...
### [](#registering-the-provider)注册提供商
