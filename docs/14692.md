...
> 原文:[https://dev . to/Dwayne/separating-application-logic-from-in-ui-8nj](https://dev.to/dwayne/separating-application-logic-from-the-ui-in-elm-8nj)

昨天，我开始实现我正在重新创建的一个简单计算器 web 应用程序的逻辑。

[![A simple calculator](../Images/1f8a20e3a41cf772a4fb940856312426.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OP_YzmWD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4t9yzd24schmve9udmjg.png)

我构建它的目标之一是使用 Elm 的特性将应用程序逻辑从 UI 中清晰地分离出来。

我相信我已经达到了我的目标，这就是为什么我如此兴奋地与你们分享我的进步。

## [](#so-what-did-i-do)那么我做了什么？
