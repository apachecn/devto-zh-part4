...
> 原文:[https://dev.to/farid_aditya/yuk-belajar-yii2-part-2-2okl](https://dev.to/farid_aditya/yuk-belajar-yii2-part-2-2okl)

#### [](#mengenal-controller-action-dan-view)Mengenal 控制器，动作丹视图
...
#### [](#controller-action-dan-view)控制器，动作丹视图
...
#### [](#mengirim-data-dari-controller-ke-view)Mengirim data dari Controller ke View
