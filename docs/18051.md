...
> 原文:[https://dev . to/jkettmann/password-based-authentic ation-with-graph QL-and-passport-8nd](https://dev.to/jkettmann/password-based-authentication-with-graphql-and-passport-8nd)
...
## [](#adding-the-graphql-local-strategy-for-passport)为 Passport 添加 GraphQL 本地策略
...
## [](#preparing-the-graphql-context)准备 GraphQL 上下文
...
## [](#implementing-the-login-mutation)实现登录突变
...
## [](#implementing-the-signup-mutation)实现签约突变
