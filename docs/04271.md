...
> 原文:[https://dev . to/god crampy/es6-arrow-functions-all-you-need-to-know-5h4p](https://dev.to/godcrampy/es6-arrow-functions-all-you-need-to-know-5h4p)
...
### [](#binding-in-vanilla-functions)绑定在普通函数中
...
### [](#binding-of-arrow-functions)绑定箭头功能
