...
> 原文:[https://dev . to/napicella/deduplicating-messages-July-once-processing-4o 2](https://dev.to/napicella/deduplicating-messages-exactly-once-processing-4o2)
...
### [](#common-pitfall-in-deduping-solutions)重复数据删除解决方案中的常见缺陷

##### [](#about-the-use-of-absolute-time)...关于绝对时间的使用
...
##### [](#about-the-ledger-consistency)...关于分类帐一致性
...
##### [](#about-reinventing-the-wheel)...关于重新发明轮子
