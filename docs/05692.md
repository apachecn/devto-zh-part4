...
> 原文:[https://dev . to/ant Janus/using-prefetch-and-caching-for-better-JavaScript-bundle-loading-2p 56](https://dev.to/antjanus/using-prefetch-and-caching-for-better-javascript-bundle-loading-2p56)
...
## [](#polling-for-new-bundle-version)轮询新捆绑包版本
