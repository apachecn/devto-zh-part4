...
> 原文:[https://dev . to/darthknoppix/make-a-complex-slider-in-react-using-SVG-4779](https://dev.to/darthknoppix/make-a-complex-slider-in-react-using-svg-4779)

## [](#creating-complex-interactions-with-svgs-using-react-and-pose)使用 React 和 Pose 创建与 SVG 的复杂交互

* * *

React 的用途远比您想象的多，让我们利用 React 和 Pose 从 SVG 创建一个交互式滑块，对用户拖动它做出响应。

[![Make a complex slider in React using SVG](../Images/16390586d7435f1714f88f1c437fcf5b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DTxFAshl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.sethcorker.com/content/images/2019/07/responsive-toggle.2019-07-05-7_06_10-pm-2.gif)
...
[![Make a complex slider in React using SVG](../Images/4b289c6070b3904d898b3f2c41f5cb82.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--68ZQ9rm1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.sethcorker.com/content/images/2019/07/Screenshot-2019-07-05-at-7.34.41-pm.png)

<figcaption>SVG 滑块标记</figcaption>

**提示:** *根据您用来生成 SVG 的工具，您可能会得到更多的标签，我通过对它运行 ImageOptim 来去除这些标签。*

### [](#using-react-to-control-the-svg)使用 React 来控制 SVG
...
### [](#making-the-slider-respond-to-events)使滑块响应事件
...
### [](#keeping-track-of-x-and-y)跟踪 X 和 Y
