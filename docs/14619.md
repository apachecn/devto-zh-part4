...
> 原文:[https://dev.to/aziziyazit/create-module-in-react-5gg](https://dev.to/aziziyazit/create-module-in-react-5gg)
...
### [](#create-module-children-as-a-consumers)创建模块子代作为消费者
