...
> 原文:[https://dev . to/Ian Rodrigues/deploying-containers-to-production-with-terra form-and-AWS-fargate-containing-2eb 5](https://dev.to/ianrodrigues/deploying-containers-to-production-with-terraform-and-aws-fargate-containerization-2eb5)
...
## [](#setting-up-the-local-environment)设置本地环境
