...
> 原文:[https://dev.to/irmerk/git-workflow-etiquette-1kgj](https://dev.to/irmerk/git-workflow-etiquette-1kgj)

## [](#repository-organization-for-clean-codebases)为干净的代码库组织仓库
