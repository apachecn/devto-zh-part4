...
> 原文:[https://dev . to/joaofbantunes/episode-029-化繁为简-the-BFF-with-proxy kit-ASP-net-core-from-0-to-overkill-33k 2](https://dev.to/joaofbantunes/episode-029-simplifying-the-bff-with-proxykit-asp-net-core-from-0-to-overkill-33k2)
...
## [](#introducing-proxykit-to-the-bff)将 ProxyKit 引入 BFF
...
### [](#quick-look-at-proxykit-vs-ocelot)快看 ProxyKit vs Ocelot
...
### [](#installing-and-configuring)安装和配置
...
### [](#preparing-for-more-backing-apis)准备更多支持 API
...
## [](#adjustments-to-mvc-based-behaviors)调整基于 MVC 的行为
...
### [](#enforce-authentication-at-middleware-level)在中间件级别实施认证
...
### [](#validate-antiforgery-tokens-at-middleware-level)在中间件层验证防伪令牌
