...
> 原文:[https://dev . to/snird/recursion-optimization-in-js-where-it-PTC-TCO-and-fud-4fka](https://dev.to/snird/recursion-optimization-in-js-where-is-it-ptc-tco-and-fud-4fka)

ES6 现在已经是旧闻了。它已经在所有现代浏览器上完全实现了。这里没什么可看的。我们用来检查进度的 kangax 的 ES6 兼容表现在应该都是绿色的，对吗？

其实不是。

[![ES6 compat](../Images/6acd17424d075054762ceba1b107b541.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dFhsCyCa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wdk8tparph1j8ej0dgob.png)
...
### [](#assumptions-moving-forward)假设向前移动
