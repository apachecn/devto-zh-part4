...
> 原文:[https://dev . to/Colin rubbert/self-hosted-web-analytics-with-matomo-and-azure-4m3f](https://dev.to/colinrubbert/self-hosted-web-analytics-with-matomo-and-azure-4m3f)

# [](#matomo-azure-)Matomo + Azure =📈

# [](#what-is-matomo)什么是马托莫？
...
### [](#creating-the-virtual-machine)创建虚拟机

使用 Azure 的免费帐户和点数，我们将利用其他一些免费市场 Azure 服务。

登录您新创建或现有的 Azure 帐户，搜索`Free services`

[![Azure Free Services](../Images/a463b8bad52f065dcba8d2d4156ded72.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YgEcn_hH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d1qmdf3vop2l07.cloudfront.net/touted-salmon.cloudvent.net/compressed/_min_/1501522ef66d789d4aa8ea093bdd18a7.png)
...
[![Azure B1S Free Linux](../Images/e387ffd741b3db19f2a18b5cb9930962.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--19ObEusw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d1qmdf3vop2l07.cloudfront.net/touted-salmon.cloudvent.net/compressed/_min_/f968c50c998a96788181f4f8a3733fcc.png)

我们需要配置我们的虚拟机，就像这样。明显填写自己的唯一信息。如果你计划从多台计算机访问你的虚拟机，你选择了`Password`而不是`SSH public key`，这就不那么麻烦了。

[![Azure create virtual machine](../Images/5c89b7d8787ff2b7db6a76e69d7f0123.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PJ9X6swP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d1qmdf3vop2l07.cloudfront.net/touted-salmon.cloudvent.net/compressed/_min_/fb54f52f88e3bcec7e36ce44053deb0c.png)

如果一切都配置正确，我们应该已经通过验证，如果你不修复你的错误，再试一次。然后点击`Create`开始创建您的虚拟机。

导航到您的虚拟机并检查`Public IP Address`是什么，然后我们将使用它 ssh 到我们的虚拟机。

### [](#configuring-the-virtual-machine)配置虚拟机
...
## [](#installing-matomo)安装 Matomo

### [](#installing-nginx-and-configure-nginx-for-matomo)为 Matomo 安装 Nginx 并配置 Nginx
...
### [](#download-amp-extract-matomo)下载&提取马托莫
...
### [](#installing-a-lets-encrypt-certificate-for-ssl)为 ssl 安装加密证书
...
[![Matomo installation setup page](../Images/e4e75bc2c4e54b1e96bc7dbefd0cac95.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2-tB2WTj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d1qmdf3vop2l07.cloudfront.net/touted-salmon.cloudvent.net/compressed/_min_/4be9e8f3abe8716ef0dcc23732ee6ac2.png)

### [](#completing-the-matomo-analytics-setup)完成 Matomo 分析设置

现在，完成 Matomo 安装过程，一旦到达`Database Setup`部分，请确保将您在本指南前面的`Creating a database`部分创建的信息归档。

[![Matomo database setup](../Images/68d773a8b1b50605fe0ae89874c91780.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jA6gOBHx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d1qmdf3vop2l07.cloudfront.net/touted-salmon.cloudvent.net/compressed/_min_/c1dc56749d140dc810ba1f80a7b14b6a.png)

继续浏览配置，一旦到达`Tracking code`部分，确保复制了跟踪代码片段。这是您将用来添加到您的网站，以收集分析信息。

## [](#congratulations-you-now-have-matomo-analytics-running-in-azure-cloud-instance)恭喜您，Matomo Analytics 现已在 Azure 云实例中运行！！！

[![Congratulations GIF](../Images/87ebf52b83127fc92f13f5de9cd5075f.png)T2】](https://i.giphy.com/media/YnSTMd4T9BISZcHcAL/giphy.gif)
