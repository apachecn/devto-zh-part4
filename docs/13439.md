...
> 原文:[https://dev . to/freekmurze/how-to-add-web mentions-to-a-laravel-powered-blog-52oo](https://dev.to/freekmurze/how-to-add-webmentions-to-a-laravel-powered-blog-52oo)
...
[![The Bridgy UI](../Images/20049ca4c235830c3c2e114a6de16a16.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pjIsGT_M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/webmentions/bridgy.png)
...
[![The Webmention.io UI](../Images/9926339890b3ce4ba2fd4c05011fc07a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0cAKQP-T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/webmentions/webmention.png)

web reference . io 支持发送 webhooks。我们可以对它进行配置，这样一旦他们得到一个网络提及(他们认为它不是垃圾邮件)，他们就把它发送到一个指定的 URL。[![Webhook settings on Webmention.io](../Images/8da368b4b060fe91648d6f2879c96ee8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZzIrtu6m--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://freek.dev/uploads/media/webmentions/webmention-webhook.png)

这样一来，让我们看看如何在 Laravel 应用程序中处理来自 web reference . ui 的 webhooks。

## [](#processing-webmentions)处理网页提及
...
## [](#using-webmentions-as-a-commenting-system-vs-disqus)使用 webmentions 作为评论系统 vs Disqus
