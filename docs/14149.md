...
> 原文:[https://dev . to/amcgrath 815/getting-undefined-error-for-string-variable-1e of](https://dev.to/amcgrath815/getting-undefined-error-for-string-variable-1eof)
