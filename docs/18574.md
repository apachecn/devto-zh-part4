...
> 原文:[https://dev . to/JPDA/private-app-service-to-app-service-calls-in-multi tenant-PAAs-51g 8](https://dev.to/jpda/private-app-service-to-app-service-calls-in-multitenant-paas-51g8)
...
## [](#integrating-with-the-vnet)与虚拟网络整合
...
[![service endpoints](../Images/8864389d7e1233f28f1e5cacf218669d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TIF2iiGj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/Annotation%25202019-06-14%2520141341.png)

创建后(从 VNet –>服务端点窗格)。在您想要访问我们的应用服务的所有子网上启用它。

[![service endpoints](../Images/f9ab483fb5223f912ae77407d6487163.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Hzb0LQLO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/vnet-service-endpoints.png)

一旦你启用了它们，进入第一个应用服务的网络面板(在我的例子中是`jpd-app-1`)。

[![networking pane](../Images/34ede630abd8b1ce1ac9cad706d1c358.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aAPPakfV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-networking.png)

配置虚拟网络集成，然后选择添加虚拟网络(预览)。选择虚拟网络，然后选择子网。

[![add feature](../Images/040e0e7b7cc38207c744745bc9f7324c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jt99Ywz---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-networking-add.png)
...
[![sites](../Images/5d572254488d9af10ca4cfb7d0502451.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--stkSuqZH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-access-kudu.png)
...
[![app2](../Images/1858b066e1fcf2b4fc990b37f2e4f13a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---SBb2IJk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-access-add-app-2.png)

## [](#repeat-for-the-other-app)对其他 app 重复
...
[![stopped](../Images/2c320ec7064b20cd57bc0f084dd44f78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LLAdTETz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-stopped.png)
...
[![app-1-curl](../Images/0de8555e1b8ba1b2fd55f71ad5d5f72f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GTrMsTCD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-curl.png)

这应该会返回一些 HTML/标记。如果是一个`403`，那就不对劲了。如果你得到一个`200/OK`，你就成功了！

[![app-1-to-app-2](../Images/32d7c1efe4930c895c3bf17b75fae488.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m25JbaGT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpda.dev/img/jpd-app-1-to-2-success.png)
