...
> 原文:[https://dev . to/melezhik/having-fun-with-sparrow 6-framework-2 FHM](https://dev.to/melezhik/having-fun-with-sparrow6-framework-2fhm)
...
# [](#task-of-generating-ado-pipeline-code)生成 Ado 管道代码的任务
...
## [](#parse-json-files-and-extract-variables)解析 JSON 文件，提取变量
