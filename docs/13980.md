...
> 原文:[https://dev.to/jrop/why-i-m-not-switching-to-zsh-4ngd](https://dev.to/jrop/why-i-m-not-switching-to-zsh-4ngd)
...
## [](#weighing-the-cost-of-adoption)权衡“采用成本”
