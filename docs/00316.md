...
> 原文:[https://dev . to/erikaheidi/PHP-in-the-command-line-implementing-command-controllers-13lh](https://dev.to/erikaheidi/php-in-the-command-line-implementing-command-controllers-13lh)
...
## [](#1-outsourcing-command-registration-to-a-raw-commandregistry-endraw-class)1。将命令注册外包给一个`CommandRegistry`类
...
## [](#2-implementing-command-controllers)2。实现命令控制器

现在我们将进一步重构命令，将特定的命令过程转移到专用的`CommandController`类中。

### [](#21-creating-a-raw-commandcontroller-endraw-model)2.1 创建一个`CommandController`模型
...
### [](#22-creating-a-concrete-command-controller)2.2 创建具体的命令控制器
...
### [](#23-updating-raw-commandregistry-endraw-to-use-controllers)2.3 更新`CommandRegistry`使用控制器
...
### [](#24-updating-the-raw-app-endraw-class)2.4 更新`App`类
...
### [](#25-registering-the-raw-hellocontroller-endraw-command-controller)2.5 注册`HelloController`命令控制器
...
## [](#conclusion-amp-next-steps)结论&下一步
