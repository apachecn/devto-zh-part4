...
> 原文:[https://dev . to/corvusetiam/building-svelte-3-budget-poll-app-2-1 cid](https://dev.to/corvusetiam/building-svelte-3-budget-poll-app-2-1cid)

# [](#where-we-ended)我们结束的地方
...
## [](#pollheader-component)PollHeader 组件
...
## [](#pollcontent-component)PollContent 组件
...
### [](#going-back-to-our-formpanel)返回到我们的表单面板
...
### [](#going-back-to-pollcontent)返回 PollContent
