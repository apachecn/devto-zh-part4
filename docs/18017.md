...
> 原文:[https://dev.to/inspector/php-perfomance-optimization-3m9k](https://dev.to/inspector/php-perfomance-optimization-3m9k)
...
## [](#start-with-php-7x)从 PHP 7.x 开始
...
## [](#sql-queries-improvements)SQL 查询改进
...
## [](#single-quote-wins-on-double-quotes-maybe)单引号胜在双引号上(也许)
...
## [](#opcache-configuration)OPcache 配置
