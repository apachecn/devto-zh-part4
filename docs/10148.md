...
> 原文:[https://dev . to/Cassidy codes/debugging-in-rails-with-pry-bundle-open-and-puts-1 njp](https://dev.to/cassidycodes/debugging-in-rails-with-pry-bundle-open-and-puts-1njp)
