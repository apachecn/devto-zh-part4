...
> 原文:[https://dev . to/mscharl/how-I-created-my-first-magic mirror-module-with-typescript-4dn 3](https://dev.to/mscharl/how-i-created-my-first-magicmirror-module-with-typescript-4dn3)

我最近创建了我的第一个 MagicMirror 模块。现在我想“谈谈”我是如何做到的。

## [](#the-build-tools)📦构建工具
...
## [](#the-development-environment)🏗️发展环境
