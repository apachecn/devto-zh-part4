...
> 原文:[https://dev . to/zmdominguez/on-device-debugging-part-iii-inspect-reset-repeat-ocj](https://dev.to/zmdominguez/on-device-debugging-part-iii-inspect-reset-repeat-ocj)
...
<center>
[![](../Images/7353ed56e377080c50c99ccd0ed689b4.png "source: imgur.com")](https://imgur.com/hyYqCEf)

<small>Additional actions</small>
</center>

### [](#environment-switcher)环境切换器

我们有一些不同的应用程序可以使用的环境。将切换器内置到应用程序中意味着我们可以在任何可用的环境中轻松测试我们的应用程序的行为。

<center>
[![](../Images/7859fb960c9fb7cbf9e010bf7678a443.png "source: imgur.com")](https://imgur.com/HvK6quk)
...
### [](#inspect-and-reset-preferences)检查并重置首选项
...
<center>
[![](../Images/3d7e2236b05a183774ba8db45f0b4081.png "source: imgur.com")](https://imgur.com/rlVuxP7)
