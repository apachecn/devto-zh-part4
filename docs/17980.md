...
> 原文:[https://dev . to/rfornal/hyper-lightweight-website-designs-1h3d](https://dev.to/rfornal/hyper-lightweight-website-designs-1h3d)

## [](#not-an-early-adopter)不尝鲜
...
## [](#it-all-starts-coming-together-)这一切开始汇集在一起...
...
### [](#hyper-lightweight-websites)超轻量网站
 ...
 **### [](#steps-to-build-a-hyperlight-website)搭建超轻网站的步骤:
...
### [](#things-you-want-to-keep-doing)你想继续做的事情:
 ...
 *### [](#things-you-want-to-stop-doing)你想停止做的事情:
...
### [](#recommendations-when-possible)建议(可能时)
