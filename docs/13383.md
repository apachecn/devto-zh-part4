...
> 原文:[https://dev . to/delete man 123/3-ways-to-use-es6-proxy-to-enhance-your-objects-mfg](https://dev.to/deleteman123/3-ways-to-use-es6-proxies-to-enhance-your-objects-mfg)
...
# [](#3-ways-to-use-es6-proxies-to-enhance-your-objects)使用 ES6 代理增强对象的 3 种方法
...
## [](#how-do-proxies-work-a-quick-intro)代理是如何工作的？快速介绍
...
## [](#enhancement-1-dynamic-property-access)增强#1:动态属性访问
