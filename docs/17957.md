...
> 原文:[https://dev . to/day brush/create-a-JavaScript-kinetic-typing-animation-with-scene-js-4jik](https://dev.to/daybrush/create-a-javascript-kinetic-typing-animation-with-scene-js-4jik)
...
[https://codepen.io/daybrush/embed/rELxqr?height=600&default-tab=result&embed-version=2](https://codepen.io/daybrush/embed/rELxqr?height=600&default-tab=result&embed-version=2)T2】
...
### [](#kinetic-typing-animation)动能打字动画
