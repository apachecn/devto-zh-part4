...
> 原文:[https://dev . to/ceceliacreates/express-basics-for-初学者-3e00](https://dev.to/ceceliacreates/express-basics-for-beginners-3e00)
...
## [](#install-and-require-express)安装并要求快递
...
## [](#assign-express-to-an-app-variable)将 express 赋给一个 app 变量
...
## [](#set-app-to-listen-on-a-specified-port)设置 app 监听指定端口
...
## [](#set-app-to-handle-data-parsing-for-json-and-urlencoded-requests)设置 app 处理 JSON 和 URLencoded 请求的数据解析
...
## [](#enable-automatic-return-of-static-files)启用静态文件自动返回
