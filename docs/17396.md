...
> 原文:[https://dev . to/jacobknaack/building-a-full-stack-SMS-enabled-chat-application-using-twilio-node-js-graph QL-and-cosmic-js-24 F3](https://dev.to/jacobknaack/building-a-full-stack-sms-enabled-chat-application-using-twilio-node-js-graphql-and-cosmic-js-24f3)

[![cosmic messenger splash](../Images/05bd003daf7d0bea1727e55152f24ccc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z1WYZYoy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/btzxs1o0lenwcwa8tqky.png)
...
## [](#building-our-web-server)构建我们的 Web 服务器
...
### [](#setting-up-our-entry-file)设置我们的录入文件
