...
> 原文:[https://dev.to/nabbisen/windows-linux-37mo](https://dev.to/nabbisen/windows-linux-37mo)
...
### [](#1-raw-unar-endraw-)#1。[T4`unar`](https://www.archlinux.org/packages/community/x86_64/unarchiver/)
...
### [](#2-raw-unzip-endraw-raw-convmv-endraw-)#2。 [`unzip`](https://linux.die.net/man/1/unzip) + [`convmv`](https://linux.die.net/man/1/convmv)
...
### [](#3-raw-7za-endraw-)#3。[T4`7za`](https://linux.die.net/man/1/7za)
