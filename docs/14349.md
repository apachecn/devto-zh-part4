...
> 原文:[https://dev . to/cale bmer/my-adventures-writing-a-cross-platform-virtualized-list-4l 90](https://dev.to/calebmer/my-adventures-writing-a-cross-platform-virtualized-list-4l90)
...
[![You can do it GIF](../Images/7bc826cad8b98282ec70d0ebf019eed5.png)T2】](https://i.giphy.com/media/12vJgj7zMN3jPy/giphy.gif)
...
*   [**从上到下滚动**](https://calebmer.com/assets/images/my-adventures-writing-a-virtualized-list/scroll-down.gif)
*   [**从底部滚动到顶部**](https://calebmer.com/assets/images/my-adventures-writing-a-virtualized-list/scroll-up.gif)
...
## [](#part-4-forking-react-native)第四部分:分叉反应原生
...
[![Behavior of a resized scroll view when we pin the scrolled window to top](../Images/bf653e5a281f55413da2f690b93dcdd2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JPW1ryaV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://calebmer.com/assets/images/my-adventures-writing-a-virtualized-list/pin-window-to-top.png)
...
[![Behavior of a resized scroll view when we pin the scrolled window to bottom](../Images/9099aa8a05252a15a3ab67f001d04658.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5mWgHe96--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://calebmer.com/assets/images/my-adventures-writing-a-virtualized-list/pin-window-to-bottom.png)
