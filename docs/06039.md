...
> 原文:[https://dev . to/seangwright/kentico-12-design-patterns-part-12-database-query-caching-patterns-43hc](https://dev.to/seangwright/kentico-12-design-patterns-part-12-database-query-caching-patterns-43hc)

<figure>

[![Cash, not cache](../Images/0a4e61a1663c8c73fb71f5ca320213a9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TFdE1ZBB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1zf6m4yfglqdxumsek3n.jpg)
...
## [](#what-are-we-caching-data-context-and-validity)我们在缓存什么？数据、上下文和有效性

### [](#the-data-raw-objectquery-endraw-and-raw-documentquery-endraw-)数据:`ObjectQuery`和`DocumentQuery`
...
### [](#the-context-cache-item-name-amp-query-parameters)上下文:缓存项名称&查询参数
...
### [](#the-validity-cache-dependencies-and-lifetime)有效性:缓存依赖和生存期
...
## [](#how-are-we-caching-raw-cachehelpercache-endraw-)我们是如何缓存的？`CacheHelper.Cache()`
...
### [](#the-very-advanced-approach-caching-through-interception-based-aop)非常高级的方法:通过基于 AOP 的拦截进行缓存
...
### [](#my-preferred-approach-caching-through-dependency-injection-di-decoration-based-aop)我的首选方法:通过[依赖注入](https://en.wikipedia.org/wiki/Dependency_injection) (DI)基于 AOP 的修饰进行缓存
...
## [](#the-problem-with-repositories-and-di-decoration-aop)仓库和 DI 装修 AOP 的问题。
...
## [](#the-solution-the-query-queryhandler-pattern)解决方案:查询，QueryHandler 模式
...
## [](#generating-cache-keys-with-raw-iquerycachekeyscreator-endraw-)用`IQueryCacheKeysCreator`生成缓存键
...
## [](#di-based-decoration-with-query-queryhandler)DI 基础装修用查询/ QueryHandler
