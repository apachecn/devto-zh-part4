...
> 原文:[https://dev . to/bnevilleoneill/introducing-react-16-8-featured-official-support-for-hooks-lbd](https://dev.to/bnevilleoneill/introducing-react-16-8-featuring-official-support-for-hooks-lbd)

[![](../Images/a1f94126a0d496542167371b2e23a9f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uVIBGNPm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5xf4p97hlb33bvnu23q8.jpg)
...
## [](#stable-support-for-hooks)稳定支撑挂钩
...
### [](#difficulty-of-reusing-stateful-logic)重用有状态逻辑的难度
...
### [](#classes-are-sometimes-confusing)班级有时会令人困惑
...
### [](#linting-rules-for-hooks)林挺规则为钩
...
### [](#can-i-use-hooks-right-away)可以马上用钩子吗？
