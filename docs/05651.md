...
> 原文:[https://dev . to/aero gear/graph back-the-evolution-of-the-graph QL-ecosystem-1 DBP](https://dev.to/aerogear/graphback-the-evolution-of-the-graphql-ecosystem-1dbp)
...
[![graphql logo](../Images/1ac5cefe63037d26b5a8777a6389260f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rxSkQi1H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wyo0ouclmymj2cfou7e7.png)

编写一个安全且高性能的 GraphQL 应用程序仍然是一项具有挑战性的任务，涉及到许多需要应用的技术决策和架构模式。

## [](#challenge-of-building-on-top-of-sample-apps)基于示例应用构建的挑战
...
## [](#sample-apps-working-with-your-business-logic)处理业务逻辑的示例应用程序
...
## [](#introducing-graphback)介绍 Graphback

[![Alt Text](../Images/8de5e144ec43704effba2d704ad24bae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--umOhFKwn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/b58zov9fctzk44qzwrln.png)
...
[![diagram](../Images/396ccafb97e94cf5429b5e4db5681707.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e_0mnsWb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c9q6rvbb9v534073cq6j.png)

## [](#graphback-to-resolve-major-issues-in-graphql-community)Graphback 解决 GraphQL 社区中的重大问题
...
## [](#ecosystem-of-templates)模板生态系统

Graphback 为开发人员构建了一个生态系统，开发人员可以将示例应用程序构建为模板，并可以通过附加功能和业务逻辑进行扩展。Graphback 模板遵循规范的实现，允许开发人员以传统的方式继续开发，并调整应用程序的各个方面。

[![Alt Text](../Images/99ce84e4eb5483d89cf81d181a76d210.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_-lHN1Qc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ss0zueqh885m8h5wra1y.gif)

## [](#not-just-a-graphql-server)不只是一个 GraphQL 服务器
