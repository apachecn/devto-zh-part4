...
> 原文:[https://dev . to/John Carroll/angular-how-to-easy-display-loading-indicators-4359](https://dev.to/johncarroll/angular-how-to-easily-display-loading-indicators-4359)
...
## [](#indicating-that-a-page-is-loading)表示页面正在加载
...
### [](#simplifying-form-submission-with-isloadingpipe)用 [IsLoadingPipe](https://gitlab.com/service-work/is-loading#isloadingpipe) 简化表单提交
...
### [](#improving-form-submission-with-isloadingdirective)用 [IsLoadingDirective](https://gitlab.com/service-work/is-loading#isloadingdirective) 改进表单提交
...
### [](#triggering-multiple-loading-indicators-at-once)一次触发多个加载指示灯
...
### [](#you-can-check-it-out-at-httpsgitlabcomserviceworkisloading)可以在:【https://gitlab.com/service-work/is-loading】T2 查看