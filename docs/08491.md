...
> 原文:[https://dev.to/hzlmn/diy-async-web-framework-4eh3](https://dev.to/hzlmn/diy-async-web-framework-4eh3)
...
## [](#asyncio-lowlevel-apis-transports-and-protocols)Asyncio 底层 API、传输和协议
...
## [](#making-server-protocol)制定服务器协议
...
## [](#requestresponse-objects)请求/响应对象
...
## [](#application-and-urldispatcher)应用程序和 UrlDispatcher
...
## [](#app-lifecycle-hooks)App 生命周期挂钩
