...
> 原文:[https://dev . to/bhuvanakundumani/snow flake-connector-for-python-using-environment-variables-206j](https://dev.to/bhuvanakundumani/snowflake-connector-for-python-using-environment-variables-206j)

[![Alt Text](../Images/bc9a1f508bd69983a75e0400d8ad17a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7AOozzdq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0soe1ikjmnh36ihevny4.png)
...
# [](#get-the-credentials-from-env)从取得国书。包封/包围（动词 envelop 的简写）
...
# [](#fire-up-an-instance-of-a-snowflake-connection)触发一个雪花连接的实例
