...
> 原文:[https://dev.to/avanslaars/don-t-dry-your-tests-2ak0](https://dev.to/avanslaars/don-t-dry-your-tests-2ak0)
...
## [](#lets-look-at-an-example)我们来看一个例子
...
### [](#clear-signals-of-intent)明确意图的信号
...
### [](#simplified-test-code-maintenance)简化测试代码维护
