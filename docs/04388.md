...
> 原文:[https://dev . to/getd/thinking-in-Java-learn-react-and-react-hooks-with-Java-code-1 ohf](https://dev.to/getd/thinking-in-java-learn-react-and-react-hooks-with-java-code-1ohf)
...
# [](#handle-raw-props-endraw-changes)处理`props`变化
