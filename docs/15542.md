...
> 原文:[https://dev . to/mikhailshilkov/hosting-a-static-website-on-azure-with-pulumi-1a3o](https://dev.to/mikhailshilkov/hosting-a-static-website-on-azure-with-pulumi-1a3o)
...
[![Static website running on Azure and defined in Pulumi](../Images/f04b66a75be2a52af89aed328e564d52.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0pDUZO4z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.pulumi.com/hs-fs/hubfs/PulumiStaticWebsite.png%3Fwidth%3D2400%26name%3DPulumiStaticWebsite.png)
...
## [](#configure-a-domain-dns-rule)配置域名 DNS 规则
...
## [](#custom-domain-and-tls)自定义域和 TLS
