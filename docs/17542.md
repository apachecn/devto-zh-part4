...
> 原文:[https://dev.to/gameoverwill/30-days-of-aws-day-12-7d4](https://dev.to/gameoverwill/30-days-of-aws-day-12-7d4)
...
## [](#aws-lambdas-in-the-real-world)现实世界中的 AWS Lambdas

你可以用成千上万种不同的方式使用 lambdas，但让我告诉你我如何在工作中使用它，这是最基本的一种。

[![IMAGE](../Images/2fd964dd91b990e73c516bfc294d9c16.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IxlSbcaO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ofjhcqjngx41djixqjr9.png)
