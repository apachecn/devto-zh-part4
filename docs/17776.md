...
> 原文:[https://dev . to/jasonswett/how-I-test-JavaScript-heavy-rails-applications-2oh 6](https://dev.to/jasonswett/how-i-test-javascript-heavy-rails-applications-2oh6)

我得到的一个常见问题是如何在 Rails 应用程序中测试 JavaScript。我的方法几乎完全简单而不复杂。

## [](#my-rails-javascript-testing-approach)我的 Rails + JavaScript 测试方法
...
## [](#testing-javascript-directly)直接测试 JavaScript
