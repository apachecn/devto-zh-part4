...
> 原文:[https://dev . to/tylerhs/materialize-modal-closing-immediately-when-attempting-load-data-from-a-URL-3no 4](https://dev.to/tylerhs/materialize-modal-closing-instantly-when-attempting-to-load-data-from-a-url-3no4)
