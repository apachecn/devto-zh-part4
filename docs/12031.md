...
> 原文:[https://dev . to/chochos/database-views-vs-table-functions-2 NPM](https://dev.to/chochos/database-views-vs-table-functions-2npm)
...
### [](#a-bit-of-metaprogramming)一点元编程
...
### [](#everythings-a-tradeoff)一切都是有得有失
