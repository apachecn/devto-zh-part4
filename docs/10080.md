...
> 原文:[https://dev . to/hag nerd/setting-up-tailwind-with-create-react-app-4jd](https://dev.to/hagnerd/setting-up-tailwind-with-create-react-app-4jd)
...
## [](#how-do-we-set-up-createreactapp-to-use-tailwind)我们如何设置 create-react-app 使用 Tailwind？
...
## [](#building-our-react-component)构建我们的 React 组件
...
[![](../Images/686e3a323a623a75e0c5306266e35884.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RyjJ1UIx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ofjwq1nujeugmrrdj884.png)

### [](#such-beauty-it-is-almost-too-much-to-behold)这样的美女。这几乎太多了！

* * *

## [](#checking-our-app-out-in-production)在生产中检验我们的应用
...
[![](../Images/0eec59e3e8d49ec67a7b317164079401.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FzZOpmqn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/okekz472vdgw6ymemptw.gif)

看看 CSS 包的大小。350KB...呀！怎么这么大！？

[![](../Images/ad3ced9db4e5c014142f48f3ca1d4f59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kiHNYsRB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cul3usx78uu0gumn4sk4.gif)

顺风产生类。很多课。它生成的样式表超过 3000 行。但是我们现在只使用了这些类中的一小部分，所以我们能做什么呢？

## [](#slimming-our-build)瘦身健体
...
[![](../Images/17bac0453fc0f6f1bcb35be6a47318ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MLsRv_yn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0wx5pm30wn1dltdrrtoi.gif)
