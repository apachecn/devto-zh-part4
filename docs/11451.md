...
> 原文:[https://dev . to/rakan nimer/server-side-rendered-real-time-web-app-with-next-js-AWS-amplify-graph QL-2j 49](https://dev.to/rakannimer/server-side-rendered-real-time-web-app-with-next-js-aws-amplify-graphql-2j49)
...
[![Amplify and Next.js](../Images/ce965c8b129ea63d5044d3ff0d82ba86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1f_x_DYZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/026cx817wn9ahvpnw4pb.png)
...
## [](#creating-our-app-skeleton)创建我们的应用框架
...
[![Todo list app skeleton displayed in the browser](../Images/212d78ab382113aa606a1d5a09fd0bfe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uyTDjjla--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6tpcjz46o5y47r4v0m8k.png)

## [](#adding-offline-functionality)添加离线功能
...
[![Working todo list screenshot](../Images/994d27534b932c7f80e56c0e5681839e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LJvD4Zik--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x6cw0kj5jnaxmsq7oyrf.png)

现在，让我们将我们的待办事项与云同步，以便能够与其他人共享和协作。

## [](#preparing-the-graqhql-schema-for-amplify-graphql-transform)为 Amplify GraphQL 转换准备 Graqhql 模式
...
## [](#setting-up-aws-amplify-on-your-computer)在电脑上设置 AWS Amplify
...
# [](#editing-the-backend)编辑后台

1.  编辑`amplify/backend/api/apiname/schema.graphql`。
2.  运行`amplify push`
3.  好了👍

# [](#saving-todos-in-the-cloud)在云端保存待办事项
...
## [](#fetching-initial-todos-on-the-serverside)在服务器端获取初始 todos
...
## [](#listening-to-todos-being-added-by-others)听别人添加的 todos
...
## [](#listening-to-todos-modified-and-deleted-by-others)听别人修改删除的 todos
...
[![Two browser windows on the same url using the app and seeing changes of one reflected in the other](../Images/c5cf0f3a40b85e58ebf3d43d13c3131a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U44ug7er--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lq0h5jxart3e3hcmdt5n.gif)
...
## [](#deploying-our-app-with-now)立即部署我们的应用程序
