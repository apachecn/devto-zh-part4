...
> 原文:[https://dev . to/ybogomolov/monadic Monday-compilation-July-4pal](https://dev.to/ybogomolov/monadicmonday-compilation-july-4pal)

最近，我在 Twitter 上发起了一个名为#monadicmonday 的小活动——每周一我都会发布一个帖子，介绍一些有用的、易于立即使用的 FP 内容。每个月我都会为那些喜欢读长篇文章的人做一个汇编。

# [](#episode-12-futures)第 12 集:期货
