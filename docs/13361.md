...
> 原文:[https://dev . to/hcysunyang/manage-asynchronous-calls-more-easy-in-vue-apps-48 F8](https://dev.to/hcysunyang/manage-asynchronous-calls-more-easily-in-vue-apps-48f8)
...
[![](../Images/27bcc25aa42138c428a368c05ded114e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iWAxIvi3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AYFoQM2KGU6oWfrKtfid_eg.png)

# [](#guide)向导

> 在 Vue 应用中更轻松地管理异步呼叫

## [](#what-does-an-asynchronous-call-mean)异步调用是什么意思？
...
## [](#waiting-for-the-loading-of-async-components)等待加载异步组件
...
### [](#1create-an-async-component-using-the-raw-lazy-endraw-function)1、使用`lazy`函数创建一个异步组件
...
### [](#2wrap-async-components-with-the-raw-ltsuspensegt-endraw-component)2、用`<Suspense>`组件包装异步组件
...
## [](#use-with-vuerouter)配合 vue-router 使用
...
## [](#how-to-display-loading-in-the-api-request)如何在 API 请求中显示加载
...
## [](#capture-all-async-calls-in-the-component-tree)捕获组件树中的所有异步调用
...
## [](#fork-a-resource-manager)分叉一个资源管理器
...
## [](#-raw-prevent-endraw-option-amp-duplicate-submissions)`prevent`选项&重复提交
