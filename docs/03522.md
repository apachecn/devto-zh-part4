...
> 原文:[https://dev . to/Hoang vvo/how-I-build-a-fully-fledged-app-with-next-js-and-MongoDB-part-2-user-profile-and-profile-picture-19cg](https://dev.to/hoangvvo/how-i-build-a-full-fledged-app-with-next-js-and-mongodb-part-2-user-profile-and-profile-picture-19cg)

## [](#this-does-not-reflect-the-recent-rewrite-of-nextjsmongodbapp-check-out-the-latest-version)这并不能反映 nextjs-mongodb-app 最近的重写。查看[最新版本](https://dev.to/hoangvvo/how-i-build-a-full-fledged-app-with-next-js-and-mongodb-part-2-user-profile-and-profile-picture-hcp)。
...
## [](#what-we-are-making)我们在制造什么

[![User Profile Feature: How I build a full-fledged app with Next.js and MongoDB](img/97b7230fa9eb9f25228a598dfef93bdc.png)T2】](//images.ctfassets.net/rgbpfpd0hrww/3SON0nw56pTo9MNuXlq9H2/def7376b13e7887c6f9dfff2fee3f82e/nextjs-mongodb-app_User_profile_GIF.gif)
...
## [](#building-the-user-profile)建立用户档案

### [](#the-user-profile-page)用户简介页面

[![Profile Page - How I build a full-fledged app with Next.js and MongoDB](img/4bdae2943e45982772efb6c82605ae1a.png)T2】](//images.ctfassets.net/rgbpfpd0hrww/1cJVUmv3CHdmupdHxthqab/ae04eab3c14905eaeecca68aa25563b8/Profile_Page.png)
...
### [](#the-profile-setting-page)概要文件设置页面

#### [](#building-the-profile-update-api)构建概要文件更新 API
...
#### [](#the-profile-settings-page)概要文件设置页面

[![Profile Settings Page - How I build a full-fledged app with Next.js and MongoDB](img/499cef17b127e7e6f933e1792f7d2a6f.png)T2】](//images.ctfassets.net/rgbpfpd0hrww/7dsO9DeEmlz71EkuDuNxh9/503949e1385acb29d160ac84e08c751e/Profile_Settings_Page.jpg)
...
## [](#building-the-profile-picture-functionality)建立个人资料图片功能

个人资料图片是一个更复杂的工作，所以我专门为它的一部分。我们需要一个地方来存放我们的图片。我选择 [Cloudinary](https://cloudinary.com) 来托管我的图像，但是你可以使用任何服务。

### [](#add-profile-picture-to-settings-page)添加个人资料图片到设置页面
...
### [](#building-the-profile-picture-upload-api)建立个人资料图片上传 API
...
##### [](#process-the-profile-picture)处理轮廓图片
...
#### [](#displaying-the-profile-picture)显示个人资料图片
