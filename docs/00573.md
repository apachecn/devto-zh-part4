...
> 原文:[https://dev . to/pcma gas/make-and-deploy-a-server less-application-into AWS-lambda-1 ijd](https://dev.to/pcmagas/make-and-deploy-a-serverless-application-into-aws-lambda-1ijd)
