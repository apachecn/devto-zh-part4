...
> 原文:[https://dev . to/ashrafalam/progressive-we B- applications-pwa-quick-start-sample-project-with-vue-js-2 nmi](https://dev.to/ashrafalam/progressive-web-applications-pwa-quick-start-sample-project-with-vue-js-2nmi)
...
## [](#pwa-weather-application-features)PWA 天气应用功能
...
## [](#give-a-star-star)给个星！⭐️

如果你喜欢或正在使用这个项目来学习或开始你的解决方案，请给它一个[星](https://github.com/AshrafAlam/vue.pwa.weather.app)。谢谢！

[![Alt Text](../Images/5d7f91b8884fe8245b2f20ba637da6be.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nr8S4ivE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2t0exe8wl8cqa7fno72x.PNG)

## [](#tools-amp-apis)工具&API

### [](#web-frameworks-amp-plugins)Web 框架&插件
...
### [](#run-in-local-environment)在本地环境下运行
...
### [](#build-production-output)建立生产输出
