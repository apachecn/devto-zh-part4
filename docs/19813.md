...
> 原文:[https://dev . to/kewah/react-hooks-by-example-use state-use callback-use effect-usereducer-4l1i](https://dev.to/kewah/react-hooks-by-example-usestate-usecallback-useeffect-usereducer-4l1i)
...
## [](#the-class-way-without-hooks)类方式(无挂钩)
