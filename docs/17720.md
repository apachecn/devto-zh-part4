...
> 原文:[https://dev . to/olpeh/how-to-create-and-deploy-a-slack-bot-47oi](https://dev.to/olpeh/how-to-create-and-deploy-a-slack-bot-47oi)

## [](#background-and-expectations)背景和期望
...
[![Screenshot of the Slack App Event Subscriptions page.](../Images/7a0dcef01015b707242e33b82a9970be.png)T2】](https://olavihaapala.fi/images/10-slack-bot/events.png)
...
### [](#4-completely-unrelated-problems)4。完全不相关的问题
...
### [](#5-add-the-bot-to-a-workspace)5。将机器人添加到工作区

> 最后，将您的机器人添加到您的工作区。

将新创建的 bot 添加到工作区非常简单。我决定把它添加到我们的工作松弛区，对不起；).

### [](#6-reply-to-an-event)6。回复一个事件？
...
### [](#7-post-response-to-slack-api)7。发布对松弛 API 的回应
...
[![Screenshot of the Slack chat.postMessage documentation page about token.](../Images/3600ef9b0decf20fd1bd099328dd735c.png)T2】](https://olavihaapala.fi/images/10-slack-bot/token.png)
...
[![Screenshot of the Slack chat.postMessage API error message response.](../Images/c877cbaa32d809880d585570d7b13805.png)T2】](https://olavihaapala.fi/images/10-slack-bot/error.jpg)

这快把我逼疯了，因为我不确定我是否有正确的令牌，或者错误是否在其他地方。你可以在我的推文中看到我的沮丧(点击图片查看原推文):

[![Screenshot of my tweet where I'm frustrated about the above error.](../Images/707d8729dca5cc86e2909dba1e4bfc19.png)T2】](https://twitter.com/0lpeh/status/1136518208993841153)

经过一段时间的努力，我发现我的请求有效负载是作为字符串而不是 JSON 发送的。这就造成了问题。我一直有正确的令牌(我猜)。现在，我的机器人开始工作并多次响应事件，如下图所示:

[![Screenshot of the Slack bot responding with duplicate messages.](../Images/0704ddf6b33e146daa76a1bc22e7bfd4.png)T2】](https://olavihaapala.fi/images/10-slack-bot/duplicates.png)

### [](#8-avoid-duplicates)8。避免重复

结果是我的机器人甚至对自己发布的消息都有反应。我必须把这些过滤掉，但这还不够。有时它仍然会发布重复的回复。我必须通过检查事件 id 并忽略已经看到的事件来避免重复。

这是我的机器人的样子和工作原理的 GIF 图:

[![GIF of my slack bot and how it works.](../Images/c41953ff79e08af1448ed95a77793b84.png)T2】](https://twitter.com/0lpeh/status/1138154635351461888)
