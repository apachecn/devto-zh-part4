...
> 原文:[https://dev . to/rickvdbosch/using-triggers-bindings-in-azure-functions-v2-1n k1](https://dev.to/rickvdbosch/using-triggers-bindings-in-azure-functions-v2-1nk1)
...
## [](#writing-to-blob-storage)写入 Blob 存储器
