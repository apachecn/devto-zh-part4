...
> 原文:[https://dev.to/voluntadpear/rm-rf-overdose-mfk](https://dev.to/voluntadpear/rm-rf-overdose-mfk)
...
## [](#an-introduction-to-raw-rm-endraw-)简介`rm`
...
## [](#dont-try-this-at-raw-home-endraw-)不要在`/home`尝试这个
...
## [](#what-can-i-do-to-prevent-this)怎么做才能防止这种情况？
...
[![Screenshot of the example rm -rf command of this post with the zsh "agnoster" theme](../Images/98fc27be2a00bb3f9a0d8f4f2f77e819.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zqtlMeuU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tcljs78ydwh593jrazhw.png)
