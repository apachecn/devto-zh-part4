...
> 原文:[https://dev . to/wozzo/using-https-with-react-create-app-windows-fn8](https://dev.to/wozzo/using-https-with-react-create-app-windows-fn8)

# [](#using-https-with-react-create-app)通过 react 创建应用程序使用 HTTPS
...
[![chrome https certificate warning](../Images/7aa6a54770d72bece4a2946bd59959bf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hZU79DiN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nn366f6spc5h010zw44v.png) 
该证书不可信，因此您总是会得到警告。上面的链接描述了如何创建您自己的证书并将其用于 webpack dev server，但是由于 react 脚本的工作方式，您将无法传入指定使用哪个证书的变量，也无法传入用于保护证书的任何密码。

## [](#creating-a-certificate-that-will-be-used)创建将要使用的证书
