...
> 原文:[https://dev . to/skat kov/jam stack-progressive-mailchimp-sign-up-form-with-netlify-13 m3](https://dev.to/skatkov/jamstack-progressive-mailchimp-sign-up-form-with-netlify-13m3)
...
## [](#1-implementing-a-form-submission)1。实现表单提交
...
## [](#2-implementing-an-ajax-request)2。实现 AJAX 请求
...
## [](#3-setting-up-environment-for-functions)3。为函数设置环境
...
## [](#4-building-a-netlify-function)4。构建网络功能
...
[![Alt Text](img/d27a57e0867582590d2ffac7a7572974.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g5E7trMT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q1g1xio6oedmzs7g3t0h.png)
