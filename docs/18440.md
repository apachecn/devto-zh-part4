...
> 原文:[https://dev . to/theodesp/using-terraform-remote-state-for-collaboration-4661](https://dev.to/theodesp/using-terraform-remote-state-for-collaboration-4661)
