...
> 原文:[https://dev . to/zak Henry/observable-web workers-with-angular-8-4k 6](https://dev.to/zakhenry/observable-webworkers-with-angular-8-4k6)
...
## [](#creating-your-first-web-worker-in-angular)在 Angular 中创建您的第一个网络工作者
...
## [](#implementing-observablewebworker)实现可观察-webworker
