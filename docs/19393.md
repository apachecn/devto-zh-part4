...
> 原文:[https://dev . to/staff for/load-testing-ASP-net-core-signalr-4 PPF](https://dev.to/staff0rd/load-testing-asp-net-core-signalr-4pff)
...
## [](#hosting-crankier-inside-a-container)在一个容器内承载胡思乱想
...
## [](#hosting-benchmarkserver-inside-a-container)在容器内托管 BenchmarkServer
...
## [](#container-client-results)容器客户端结果
...
## [](#crankier-running-on-vms)虚拟机上运行的 Crankier
...
## [](#monitoring-client-vm-connections)监控客户端虚拟机连接
...
### [](#standardd2sv3-server)标准服务器 _D2s_v3
...
### [](#standardd8sv3-server)标准 _D8s_v3 服务器
...
### [](#standardd32sv3-server)标准 _D32s_v3 服务器
