...
> 原文:[https://dev.to/samcre/istio-sds-y-cert-manager-4a9e](https://dev.to/samcre/istio-sds-y-cert-manager-4a9e)
...
## [](#qu%C3%A9-es-sds-y-mtls)是 SDS 吗？mTLS？
...
## [](#instalando-istio-con-mtls-y-sds)用 mTLS 和 SDS 安装本能
...
# [![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) 用  #1702](https://github.com/jetstack/cert-manager/issues/1702) 安装时验证 WebhookConfiguration 时缺少“caBundle”

[![andrei-dascalu avatar](../Images/1564593e4fd0ce6c46055202c2e33fa0.png)](https://github.com/andrei-dascalu) **[andrei-dascalu](https://github.com/andrei-dascalu)** posted on [<time datetime="2019-05-19T23:23:36Z">May 19, 2019</time>](https://github.com/jetstack/cert-manager/issues/1702)
...
## [](#configurando-gateways-y-virtualservices)配置网关和虚拟服务
...
### [](#fuentes-y-m%C3%A1s-informaci%C3%B3n)来源及更多信息
