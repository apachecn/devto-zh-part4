...
> 原文:[https://dev . to/angular/deploying-an-i18n-angular-app-with-angular-CLI-2fb9](https://dev.to/angular/deploying-an-i18n-angular-app-with-angular-cli-2fb9)
...
## [](#a-fresh-i18n%C2%A0app)一个新鲜的 i18n app
...
## [](#prepare-the-app-for-production)准备 app 投入生产
...
### [](#linuxmacos-users)Linux/macOS 用户
...
## [](#apache2-configuration)Apache2 配置
...
## [](#bonus-add-links-to-the-different-languages)奖励:添加不同语言的链接
...
### [](#bonus-2-angular-translator-application)加成 2:角度翻译器应用
