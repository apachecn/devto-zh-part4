...
> 原文:[https://dev . to/ampersanda/shimming-web page-scroll-with-request animation frame-2la](https://dev.to/ampersanda/shimming-webpage-scroll-with-requestanimationframe-2la)

[![](../Images/fae99bc5d4c756745eaae00f2d18a3a2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J0XOVjkb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8n1euynk65hupaqtfkop.gif)
...
# [](#supporting-requestanimationframe)支持 requestAnimationFrame
...
# [](#getting-the-scroll-progress)获取滚动进度
...
## [](#updating-the-scroll-progress)更新滚动进度
