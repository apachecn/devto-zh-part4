...
> 原文:[https://dev.to/protium/flutter-background-services-19a4](https://dev.to/protium/flutter-background-services-19a4)
...
[![abraham](../Images/a5bf8aa605cc760922678e4597404650.png)](/abraham) [## 动荡的一个月
...
这就是结果
[![](../Images/764fc884d8f958e7b728827dfb156921.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--A60AqvPV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pkvf4zdpzu9mmogfak0t.png)

## [](#app-service-flutter-method-call)App 服务:颤振方法调用
...
## [](#building-the-android-service)构建 Android 服务
...
### [](#1-it-should-be-able-to-bind-a-connection-with-the-main-activity)1)它应该能够与主活动绑定一个连接
...
### [](#2-it-should-start-stop-and-get-current-seconds-on-demand)2)应根据需要启动、停止并获取当前秒数
...
## [](#connecting-to-the-service)连接到服务
...
### [](#connecting-from-the-activity)从活动中连接
...
### [](#connecting-activity-to-flutter)连接活动到颤振
...
### [](#connecting-flutter-to-activity)连接颤振到活动
...
## [](#what-ive-learned-from-flutter)我从旋舞中学到了什么
...
*   How important and useful is `flutter analyze` You can see all of that in the repo
    ...
    ## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) [ protiumx ](https://github.com/protiumx) / [Rest the rest](https://github.com/protiumx/rest) 
    ...
    **Note:** This repurchase has not been maintained.
    ...
    [![Get it on Google Play](../Images/5eaf08f648d44140495f1cba89953ed0.png)](https://play.google.com/store/apps/details?id=dev.protium.rest) 
    ...
    *   Flutter SDK
    ...
    [![](../Images/af37c4020283924ba6ef0980cba58ffd.png) T2]](https://github.com/protiumx/rest./images/screenshot1.png) 

    [![](../Images/2da5b2708f54cb35ad3b2c2293d7f5d1.png) T2]](https://github.com/protiumx/rest./images/screenshot2.png) 
    ...
    [![Buy Me A Coffee](../Images/16a7676038339a1414537286d90f2315.png) T2]](https://www.buymeacoffee.com/p3kqm9Z2h) 
