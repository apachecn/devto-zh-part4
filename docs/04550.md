...
> 原文:[https://dev . to/stewy earth/making-a-simple-counter-in-JavaScript-html-2 ici](https://dev.to/stewyearth/making-a-simple-counter-in-javascript-html-2ici)

# [](#making-a-simple-counter-in-javascript-amp-html)用 javascript 制作一个简单的计数器& HTML

这是我在这里的第一个帖子！如果有任何困惑，请随时给我写评论，我会尽量更新我的帖子，使其更加清晰！

## [](#step-1-html-setup)步骤 1 - HTML 设置
...
## [](#step-2-adding-javascript)第二步-添加 Javascript

### [](#selecting-our-dom-elements)选择我们的 DOM 元素
...
### [](#adding-event-listeners)添加事件监听器
