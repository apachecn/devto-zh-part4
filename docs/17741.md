...
> 原文:[https://dev . to/bnevilleoneill/real-time-processing-with-web-workers-2hjg](https://dev.to/bnevilleoneill/real-time-processing-with-web-workers-2hjg)

[![](../Images/f02eca64c46e411658cdf1a2aadd52da.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8D-q5eto--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rt36pdou6yawrpjeojdh.png)
...
## [](#building-a-realtime-text-analyzer)构建实时文本分析器
...
## [](#performance-issues-with-the-single-thread)单线程的性能问题
...
## [](#a-web-worker-for-the-text-analyzer)一个文本分析器的 Web 工作人员
...
## [](#web-workers-restrictions)网络工作者限制
