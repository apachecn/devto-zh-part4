...
> 原文:[https://dev . to/adrienpoly/critical-CSS-with-rails-and-web packer-sprocketsless-part-1-2 bck](https://dev.to/adrienpoly/critical-css-with-rails-and-webpacker-sprocketsless-part-1-2bck)
...
## [](#understanding-purgecss)了解采购

[![Alt Text](../Images/b834396bc22d685adf050950273cdee9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--q-X3Lyoq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4anqgftf0j9v8zih0mh5.png)
...
## [](#multiple-pack-with-multiple-rules)多个装多个规则
...
#### [](#our-criticaljs-entrypoint)我们的 critical.js 入口点
...
## [](#postcss-purgecss-configuration)PostCSS / PurgeCSS 配置
...
## [](#inline-css-from-webpacker)来自 Webpacker 的内联 CSS
