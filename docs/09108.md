...
> 原文:[https://dev.to/carcruz/styled-terminal-with-iterm-4c8g](https://dev.to/carcruz/styled-terminal-with-iterm-4c8g)
...
[![carcruz-iterm](../Images/394e7a26736915f7f88378d18fc5dbd2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--33GVdzSi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ymquha320a4u9jz6ldjp.png)

#### 左侧面板中的 [](#tabs-in-left-panel) 选项卡
...
[![](../Images/3e6eb30b21ef5c9c20c75509bdd2edb7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OBmsuMjb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4tms8995w84q4vu76tcl.png)

要改变酒吧的位置，只需转到`iTerm > Preferences > Appearance`，在`General`你会看到`Status bar location`，将其设置为`Bottom`

#### [](#customize-spaceshipprompt)自定义飞船-提示
