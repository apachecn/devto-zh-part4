...
> 原文:[https://dev . to/danielepolencic/scaling-带消息队列的微服务-spring-boot-and-kubernetes-e8k](https://dev.to/danielepolencic/scaling-microservices-with-message-queues-spring-boot-and-kubernetes-e8k)
...
[![Traffic](../Images/ab7a3b0a422d301e9ff2487a1c58d4ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AcnsuXKM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c47ghtt6b99o7029yyje.png)
...
[![REST API](../Images/4b5deed64d24d61149fe1b2c53d2c21b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PXi4pmMy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/us2neqyl4b6qtqkrz6tn.gif)

今天是个大日子，你的店开始营业了。

您决定将应用程序的前端扩展到四个实例，后端扩展到四个实例，因为您预计网站会比平时更加繁忙。

[![Serving traffic](../Images/ea275ca15b993b40d564e8bdabfc14eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CA4n52Zc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p3agx10q1s8ptqa3dgw0.gif)
...
[![Scaling out](../Images/c538d607fe5fcae28d10a9bf76b7d37f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hQVSYkKl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/el4279gdeeffu5shtikg.gif)
...
[![Too much traffic](../Images/48829688fab51c3731731c19f9871a56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ub38SBvE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/03gcrwcioj9es17qopzr.gif)
...
[![Decoupling front-end and backend with a message broker](../Images/b26e2f620d8102568926f0c71e577863.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ucf4juuv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/swxu725o2ewoy20h9mt5.gif)
...
## [](#coding-a-spring-application)编码一个 Spring 应用程序
...
[![Store front-end](../Images/5fd72c8bafcf8cd60ae1ec5b5d6cf9b0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FssLQann--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mkmo8685yb98t3xtiil3.png)

**作为一个工作者**，应用程序在队列中等待消息并处理它们。

[![Store admin worker](../Images/11d2ffb5e7250d827ab60e5d25dade92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k8tcLzP4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0wr25nmlk7jbn4s4vmox.png)

> 请注意，在示例项目中，通过使用`Thread.sleep(5000)`等待五秒钟来模拟处理过程。

通过更改`application.yaml`中的值，您可以在任一模式下配置应用程序。

## [](#dryrun-the-application)试运行应用程序

默认情况下，应用程序作为前端和工作程序启动。

您可以运行应用程序，只要您有一个本地运行的 ActiveMQ 实例，您就应该能够购买商品并让系统处理这些商品。

[![Store admin worker](../Images/fffb0f6281b6e485499f03ea2856a644.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s4ZEAi46--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s2vbozef5ttecfx2zs9h.gif)
...
## [](#sending-and-receiving-messages-with-jms)用 JMS 发送和接收消息
...
## [](#deploying-your-application-to-kubernetes)将您的应用部署到 Kubernetes
...
[![Kubernetes basic concepts](../Images/9dd49a1c24bead483c57d0e2f31cf6ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IJxQcIkS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ein6gbxqmci8tg43xo6d.gif)

### [](#deploy-activemq)部署 ActiveMQ
...
## [](#scaling-manually-to-meet-increasing-demand)手动缩放以满足不断增长的需求
...
## [](#exposing-application-metrics)公开应用指标
...
## [](#consuming-application-metrics-in-kubernetes)在 Kubernetes 中使用应用程序指标
...
## [](#whats-better-than-autoscaling-instances-autoscaling-clusters)什么比自动缩放实例更好？自动缩放聚类
...
[![Cluster autoscaler](../Images/2141e7bd0e9b539306a97c06fde9daea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dPBEXCav--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bfrroqs4t61828ejpbz4.gif)
