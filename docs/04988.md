...
> 原文:[https://dev . to/angular/angular-performance-virtual-scrolling-with-the-CDK-50pl](https://dev.to/angular/angular-performance-virtual-scrolling-with-the-cdk-50pl)
...
## [](#leverage-the-angular-cdk-to-implement-virtual-scrolling)利用角度 CDK 实现虚拟滚动
