...
> 原文:[https://dev . to/dcrane 604/how-to-learn-python-without-first-need-to-learn-python-9je](https://dev.to/dcrane604/how-to-learn-python-without-first-needing-to-learn-python-9je)
...
### [](#simple-python-installations)简单的 Python 安装
