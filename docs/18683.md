...
> 原文:[https://dev . to/pqina/generating-image-thumbnails-in-the-browser-using-JavaScript-and-file pond-10b 8](https://dev.to/pqina/generating-image-thumbnails-in-the-browser-using-javascript-and-filepond-10b8)
...
## [](#showing-a-resized-preview)显示调整大小后的预览
...
## [](#generating-multiple-thumbnails)生成多个缩略图
