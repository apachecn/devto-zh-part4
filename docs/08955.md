...
> 原文:[https://dev . to/first clown/should-you-always-use-getters-in-vuex-4p0c](https://dev.to/firstclown/should-you-always-use-getters-in-vuex-4p0c)
...
## [](#can-you-directly-access-vuex-state-from-a-component)可以从一个组件直接访问 Vuex 状态吗？
...
## [](#should-you-directly-access-vuex-state-from-a-component)*是否应该*从一个组件直接访问 Vuex 状态？
