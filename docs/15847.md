...
> 原文:[https://dev . to/seif _ ghe zala/how-to-make-your-own-split pane-react-component-with-0-dependencies-gjg](https://dev.to/seif_ghezala/how-to-make-your-own-splitpane-react-component-with-0-dependencies-gjg)
...
<figure>![Elements section of the Chrome Dev Tools showing a horizontal SplitPane component](../Images/ca042c40c8d4ba1963d8703cde669766.png)
...
<figure>![Sources section of the Chrome Dev Tools showing a vertical SplitPane component](../Images/c4388b1ce77863a4a5c13ea03111c05e.png)
...
[![](../Images/1ff6f6ab4ae3a7908fb9eeabeb9e84e0.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--EdulR5qS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6x4u131nzof8jkv448lj.gif) alt= "最终结果">
...
## [](#the%C2%A0trick-spoiler-alert)💡诀窍(剧透警报)
...
## [](#step-1-basic%C2%A0setup)第一步:基本设置
...
## [](#step-2-getting-the-top-pane%C2%A0height)第二步:获取顶部窗格高度
...
### [](#the-height-of-the-top-pane-should-be-in-splitpane)顶部窗格的高度应该在 SplitPane 中
...
### [](#updating-the-top-pane%C2%A0height)更新顶部窗格高度
...
## [](#step-3-detecting-the-drag-difference)第三步:检测阻力差
...
### [](#one-more-tiny-improvement%C2%A0)👆还有一个小小的改进
