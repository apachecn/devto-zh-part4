...
> 原文:[https://dev . to/rhanarion/build-a-progressive-web-app-in-docker-with-nginx-to-deploy-to-kubernetes-or-docker-swarm-253 f](https://dev.to/rhanarion/build-a-progressive-web-app-in-docker-with-nginx-to-deploy-to-kubernetes-or-docker-swarm-253f)
...
[![Lighthouse scores, don't let the bugged checkmark fool you it passes the PWA tests ;)](../Images/6ed2074abe0bad6bcb46fe7849296d57.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fuZHBBdy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rhazn.com/img/posts/build-a-progressive-web-app-in-docker-with-nginx-to-deploy-to-kubernetes-or-docker-swarm/scores.png)

# [](#building-in-docker)建筑在码头上
...
# [](#building-the-final-container)建造最终容器
