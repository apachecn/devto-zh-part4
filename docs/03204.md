...
> 原文:[https://dev . to/maxime 1992/building-an-enigma-machine-with-only-typescript-and-then-use-angular-di-system-to-accurally-instantiate-it-2e2h](https://dev.to/maxime1992/building-an-enigma-machine-with-only-typescript-and-then-use-angular-di-system-to-properly-instantiate-it-2e2h)
...
# [](#2-enigma-app)2 -英格玛 app

现在的目标是构建以下内容:

[![View of the app](img/0a25a08abb641aa2b5a54f80d4ed2453.png "View of the app")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---WHy38VD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/maxime1992/my-dev.to/master/blog-posts/enigma-part-2/assets/encrypt-page.png)
...
## [](#a-display-the-initial-config-rotors-and-current-ones)A -显示初始配置转子和当前转子
...
## [](#b-encrypt-a-message-from-the-app)B -加密来自应用程序的消息

现在我们已经能够显示转子的状态，让我们开始这个应用程序最重要的部分:信息的加密🙌！

### [](#b1-logic-and-template)B1 -逻辑和模板
