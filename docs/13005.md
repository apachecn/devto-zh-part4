...
> 原文:[https://dev . to/gajesh/the-complete-flask-初学者教程-124i](https://dev.to/gajesh/the-complete-flask-beginner-tutorial-124i)
...
## [](#why-flask-and-what-can-you-do-with-it)为什么要烧瓶，可以用它做什么？
...
## [](#setting-up-virtual-environments)设置虚拟环境
...
## [](#some-basic-terminologies)一些基本术语
...
## [](#working-with-routes-templates-and-sessions-in-the-flask)在 Flask 中使用路线、模板和会话

### [](#routes-in-flask)烧瓶中的路线
...
T3![Variables in Flask](../Images/f2387995f58a489594fef298aa1b3013.png)T5】
...
### [](#note-on-url-behavior)关于 URL 行为的说明
...
### [](#accessing-url-using-method-names)使用方法名访问 URL
...
### [](#static-files-and-templates)静态文件和模板。
...
### [](#reading-data-from-forms-and-working-with-sessions)从表单中读取数据并使用会话
...
## [](#managing-user-accounts-in-flask-using-flaskuser)使用 Flask-User 管理 Flask 中的用户帐户
...
### [](#dont-reinvent-the-wheel)不要多此一举
...
## [](#reference-and-further-reading)参考和进一步阅读
