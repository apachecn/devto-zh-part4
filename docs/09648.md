...
> 原文:[https://dev.to/valgaze/from-zero-to-aws-documentdb-9on](https://dev.to/valgaze/from-zero-to-aws-documentdb-9on)
...
# [](#amazon-documentdb-with-mongodb-compatibility)“亚马逊 DocumentDB(与 MongoDB 兼容)”
...
# [](#step-i-set-up-lambda-role)第一步:设置 Lambda 角色
...
# [](#step-ii-create-a-lambda-function-api-gateway)第二步:创建 Lambda 函数+ API 网关
...
# [](#step-iii-create-a-documentdb-cluster)第三步:创建 DocumentDB 集群
...
# [](#step-iv-update-lambda-function-with-new-code-connection-string)第四步:用新代码+连接字符串更新 Lambda 函数
...
# [](#further-reading-lambda-vpc)延伸阅读-λ+VPC
...
# [](#further-reading-lambda-optimizations)进一步阅读- Lambda 优化:
...
# [](#further-reading-lamba-proxy-integration)延伸阅读- Lamba 代理整合
