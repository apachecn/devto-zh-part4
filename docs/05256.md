...
> 原文:[https://dev . to/kball/Friday-frontend-two-years-running-edition-24 E3](https://dev.to/kball/friday-frontend-two-years-running-edition-24e3)
...
##### [](#creating-a-maintainable-icon-system-with-sass)[用 Sass 创建可维护的图标系统](https://css-tricks.com/creating-a-maintainable-icon-system-with-sass/)

这是一个关于如何构建一个完全封装在一个 CSS 文件中的自定义图标系统的精彩展示。比许多 CSS/SCSS 示例更强烈地使用 Sass 特性，所以这是学习更多 Sass 的好资源。

##### [](#can-you-rotate-the-cursor-in-css)[可以在 CSS 中旋转光标吗？](https://css-tricks.com/can-you-rotate-the-cursor-in-css/)
...
##### [](#css-can-do-this-and-its-terrifying)[CSS 可以做到这一点...而且很恐怖！](https://www.aaron-powell.com/posts/2019-08-14-css-can-do-this-and-its-terrifying)
...
##### [](#pure-css-alien-commuter-falling-asleep-on-his-way-to-work)[纯 CSS:外星人通勤上班路上睡着](https://codepen.io/perbyhring/full/jpQwav)
...
##### [](#using-native-javascript-modules-in-production-today)[如今在生产中使用原生 JavaScript 模块](https://philipwalton.com/articles/using-native-javascript-modules-in-production-today/)
...
##### [](#use-javascript-generator-functions-to-reduce-memory-utilization)[使用 JavaScript 生成器函数降低内存使用率](https://dev.to/treyhuffine/use-javascript-generator-functions-to-reduce-memory-utilization-26be-temp-slug-9971242)

生成器是 JavaScript 中相对较新的特性之一，我还没有开始使用它，但是我越来越多地听说了它们，本文强调了使用它们的一个好处:与 node 中的流非常相似，您可以使用相对最少的内存处理大量数据。

##### [](#logicless-jsx)[无逻辑 JSX](https://verekia.com/react/logic-less-jsx/)

这是一篇关于如何让 JSX 更具可读性的精彩文章。JSX 是构建动态组件的一个超级强大的工具，但是这种能力经常导致组件过于复杂，难以理解和维护。这篇文章通过一系列实践来指导你实现可读的、可维护的 JSX。

##### [](#react-layouts)[反应过来布局](https://react-layouts.com/)

一组通用布局的抓取并运行 React 实现。设置 rebass、主题 ui 和情感的版本。我不得不承认，我仍然害怕看到这样的 CSS-in-JS，但是在这里进行复制/粘贴的方便性绝对是好的。

#### [](#other-awesomeness)其他牛气

##### [](#midyear-adda-web-amp-app-accessibility-lawsuit-report)[年中 ADDA Web & App 无障碍诉讼报告](https://blog.usablenet.com/midyear-ada-web-accessibility-lawsuit-report-blog)
...
##### [](#vue-community-guide)[Vue 社区指南](https://vue-community.org/)
...
##### [](#why-i-have-a-problem-with-react)[为什么我的反应有问题](https://www.sonniesedge.net/posts/react/)
...
##### [](#faster-image-loading-with-embedded-image-previews)[通过嵌入式图像预览加快图像加载速度](https://www.smashingmagazine.com/2019/08/faster-image-loading-embedded-previews/)
