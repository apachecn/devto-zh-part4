...
> 原文:[https://dev.to/freekmurze/refactoring-to-actions-5fa](https://dev.to/freekmurze/refactoring-to-actions-5fa)

在我们最近在 [Spatie](https://spatie.be) 的项目中，我们已经开始使用一个叫做“动作”的概念。它让我们的控制器和模型保持苗条。这是一种简单的做法。在这篇博文中，我想给你解释一下。

## [](#from-logic-in-controllers-and-models)来自控制器和模型中的逻辑...
