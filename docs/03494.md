...
> 原文:[https://dev.to/teekatwo/getting-started-using-gatsby-c6e](https://dev.to/teekatwo/getting-started-using-gatsby-c6e)
...
### [](#video-tutorials-are-great-starting-points)视频教程是很好的起点
...
### [](#using-gatsby-cli-to-develop-a-site)使用 Gatsby CLI 开发一个站点
...
## [](#were-do-you-go-from-here)你从这里去了哪里
