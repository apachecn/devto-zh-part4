...
> 原文:[https://dev.to/kendru/using-variables-and-values-1lm9](https://dev.to/kendru/using-variables-and-values-1lm9)
...
[![Binding a Var to a Value](img/9fc19e20d40807cc894415ec2dc236c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WQt06iNQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter9/binding-var.png)
...
## [](#creating-local-bindings-with-let)用 let 创建本地绑定
