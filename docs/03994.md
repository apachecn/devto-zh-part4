...
> 原文:[https://dev . to/this dot media/continuously-integrated-angular-with-azure-devo PS-2k 9l](https://dev.to/thisdotmedia/continuously-integrating-angular-with-azure-devops-2k9l)
...
# [](#creating-the-azure-devops-project)创建 Azure DevOps 项目
...
[![Creating an Azure DevOps project](img/b96fb3380914ecd9436a5251f90c1ae8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tkmoysG_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g4k8tekixmzvmpylc7fq.png)

创建项目后，您将被带到项目的仪表板。

# [](#adding-the-code-to-azure-devops)向 Azure DevOps 添加代码
...
# [](#creating-a-build-pipeline)创建构建管道
...
[![Creating a Build Pipeline](img/339cf630ff0a643605b3e9ffe85adcb1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0UsH9Q4F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h5bezc3zlbyud0pti9g8.png)
...
[![Build Results](img/07010ef5abf21c90f4b11b80bb6ada8d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GxKkkoXr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5z5mja33511djjwzt4mw.png)
...
[![Build Step Console Output](img/b060e43ec22d4ceca8c0aed4fda1b45e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IE_RsNOZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e23c7wj0623oht38p6xw.png)

## [](#finetuning-the-build-pipeline)微调构建管道
...
[![Build Pipelines Overview](img/2a1afb1c0c9dfd7113ba718b1c1a308d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fxfGVjPj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n90n1ql5vrhzy92lbj71.png)
...
[![Separated npm install and ng build](img/2ce192dce9f69bc95fa1872583488225.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6RD94N3s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/elu2ad8t6qleu8a0r8jr.png)

Azure DevOps 现在集成为在每次提交给 master 时运行`ng build`。除了构建项目之外，我们可能还想运行所有的单元测试，这样我们就知道所有的代码仍然按预期工作。

### [](#running-unit-tests-on-azure-devops)在 Azure DevOps 上运行单元测试
...
[![Test step output](img/cabd4687ba1a2898927017db1e406d2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_OghASag--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hhpj89qgio8b9f0b8jd5.png)

尽管这给了我们关于测试所需的所有信息，Azure DevOps 有一个显示测试报告的内置功能，使您能够更容易地导航成功/失败的测试。

### [](#publishing-test-results-to-azure-devops)将测试结果发布到 Azure DevOps
...
[![Publis Test Results task](img/5443717e5f0939a117b35020409cff0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jw5o8qBs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qexzcfozq51ewly3um4g.png)
...
[![Publish Test Results step](img/657e2aceb51682a0e9cffac294937b42.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7ygc9oBb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p4jz5pc1hxz9vzqfqr78.png)

### [](#configuring-karma-to-publish-junit)配置 Karma 发布 JUnit
...
[![Test Results](img/343276bef58c560aacc0c00ea6836e24.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8IrNGNd5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9188vckvg9fv173hk1uf.png)
...
[![Failed test details](img/9f96bd4b2654f0762db7fed89e3c8038.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ELDyVL39--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yta0wkrpytenp4q8z7jh.png)

### [](#showing-code-coverage-in-a-build-pipeline)显示构建管道中的代码覆盖率
...
[![Code Coverage Results](img/19dc021b97843cbf4fbd25f76848c003.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Qv9u1Q0_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/beungetiwbetf2qinluj.png)
...
[![Download Artifacts](img/e90d5849fb5d632cfb489fa0592a596b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--X24c-4E6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zp2urr0vm8ua8matu0kb.png)
