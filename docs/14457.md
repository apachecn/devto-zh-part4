...
> 原文:[https://dev . to/sync fusion/how-to-use-timeline-view-in-xamarin-forms-scheduler-1i6e](https://dev.to/syncfusion/how-to-use-timeline-view-in-xamarin-forms-scheduler-1i6e)
...
在这篇博客中，我将介绍 Scheduler 中时间轴视图的主要特性。如果您是 Scheduler 控件的新手，那么我们建议您在继续下一步之前通读其[入门文档](https://help.syncfusion.com/xamarin/sfdataform/getting-started)。【T2![Timeline View in Xamarin Forms Scheduler](../Images/c32454d950cc9ecb23a95ac49dae2847.png)

<figcaption>Timeline View in Xamarin Forms Scheduler</figcaption>

</figure>

## [](#working-hours-customization)工作时间定制
...
[![Customized working hours](../Images/b33c8ede258ffb08d9571442cd66468b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q2Tlo5e1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/06/Customized-working-hours.png)

<figcaption>Customized working hours</figcaption>

</figure>

## [](#support-for-limiting-time-slots)支持限制时隙
...
[![Limiting time slots](../Images/69755ef87b8452b382691d99da70ebc2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--R0-09dW1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/06/Limiting-time-slots.png)
...
## [](#schedule-and-manage-events)安排和管理事件

时间线视图允许您计划和管理各种事件，如全天事件、跨时段事件和重复事件。每个视图根据事件在各自日期内的持续时间显示事件在时间段内的情况。默认情况下，全天事件将在时间段的顶部呈现，然后是跨度事件，接着是重复事件和正常事件。

<figure>

您可以在时间线视图中快速重新安排任何事件，方法是将它从一个时间段拖到另一个时间段。还可以限制某些约会的重新安排，并防止在某个时间取消约会。[![Schedule and manage events](../Images/7fbcf2b5880a6ffbf45fb86e89e193a0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--APXKDA-A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/06/Schedule-and-manage-events.gif)
...
## [](#personalized-timeline-view)个性化时间线视图
...
[![Personalized Timeline View](../Images/7af23bdd7db5d8decf6abc085298e516.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a_flBWip--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/06/Personalized-Timeline-View.png)
