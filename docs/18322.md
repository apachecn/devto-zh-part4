...
> 原文:[https://dev . to/liammyles/how-I-TDD-an-accessible-react-accordion-MCB](https://dev.to/liammyles/how-i-tdd-an-accessible-react-accordion-mcb)
...
## [](#why-i-only-think-about-the-current-test)为什么我只考虑当前的测试
...
## [](#things-i-try-not-to-worry-about)我尽量不担心的事情
...
# [](#what-i-have-in-the-end)我到底有什么

所以我做了所有这些测试，使用模拟真实用户如何使用它的测试库。并创建了一些非常健壮的代码。我已经通过了所有的测试，甚至还添加了一些新的测试，这些都不是我的首要任务。这就是我的结局。

[![Picture of passing tests](../Images/9da485f973e3a8d32f809ca5de760af6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h5e7BhK9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/iy8uet8e9x6k4awpkze0.png)

[![Picture of rendered component](../Images/bd3218fc79634e36c075d031d9c7237d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K9XGtew4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d52fvxcz6uubgf31psvt.png)
...
# [](#check-out-these-resources)查看这些资源！
