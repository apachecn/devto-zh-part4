...
> 原文:[https://dev . to/miku 86/PostgreSQL-how-to-setup-our-installed-PostgreSQL-39hf](https://dev.to/miku86/postgresql-how-to-setup-our-installed-postgresql-39hf)
...
## [](#create-a-new-postgresql-database-cluster)创建新的 PostgreSQL 数据库集群
...
## [](#create-a-role-database-user)创建角色(=数据库用户)
