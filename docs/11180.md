...
> 原文:[https://dev.to/hassam7/angular-cdk-virtual-scroll-4ldj](https://dev.to/hassam7/angular-cdk-virtual-scroll-4ldj)

# [](#what-is-virtual-scrolling)什么是虚拟滚动？
...
[![Installing CDK](../Images/aac57f09e6700bb3274cd3d4d94cc65d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3xRmPtBT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/ScWpEbn.png)
...
[![Virtual Scroll in dev tools](../Images/49b7ad0c8011a3d94d5679b1f44647ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w3m6jk0b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/0dPEjTI.png)

现在，如果您滚动列表，您将看到创建了有限数量的 DOM 元素，这导致了内存和 cpu 使用的减少。

# [](#items-with-variable-heights)高度可变的物品
