...
> 原文:[https://dev . to/oinak/mocks-and-stubs-in-ruby-unit-tests-a-cheat sheet-pgh](https://dev.to/oinak/mocks-and-stubs-in-ruby-unit-tests-a-cheatsheet-pgh)
...
## [](#1-incoming-query)1。传入查询:

*   断言方法的返回值

## [](#2-incoming-command)2。输入命令
...
### [](#with-dependency-injection)同依赖注入
