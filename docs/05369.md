...
> 原文:[https://dev.to/goatmale/three-things-from-today-8-29-2ai9](https://dev.to/goatmale/three-things-from-today-8-29-2ai9)

# [8/29·T1](#829)

### [](#back-at-it-again)又回来了。

大家好！希望你周四过得愉快。我知道我是。我很高兴与你分享我今天学到或发现有趣的三件事。

##### [](#1-what-does-kubernetes-kubeproxy-actually-do)1。Kubernetes kube-proxy 实际上是做什么的？

在我学习 K8s 的过程中，我一直试图将每个组件分解成快速可理解的部分。今天我快速浏览了一下 kube-proxy。

### [](#so-what-does-kubeproxy-actually-do)那么 kube-proxy 实际上是做什么的？
...
##### [](#2-linux-programming-interface-new-book-im-reading)2。 [Linux 编程接口](http://man7.org/tlpi/index.html)——我正在看的新书

好吧，我实话实说，通过 Safari 这样的服务，你可以随意使用大量的书籍，这让你只能阅读第一章，对于很多书来说，其他的真的不多。我希望实际上保持这种状态，并学习许多使 Linux 工作的低级魔法。

##### [](#3-safeeyes-foss-linux-eye-strain-prevention-tool)3。[安全眼](http://slgobinath.github.io/SafeEyes/)👀- FOSS Linux 眼睛疲劳预防工具
