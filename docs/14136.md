...
> 原文:[https://dev . to/azure/getting-started-with-azure-cognitive-services-CMA](https://dev.to/azure/getting-started-with-azure-cognitive-services-cma)

# [](#the-beginning)开头

[![Robot](../Images/5d8d0818f059851e6ff8f1af93f44edb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UD1qP3O7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ehs6kq2ldbcfhzm6hbda.png) 
...
[![What do you see in this picture?](../Images/74af187f94b4061d7b8d8eebc4116f74.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rQRt7F6V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jeirnkk7v7v4y1x9xtb9.png) 
...
# [](#the-bigger%C2%A0picture)大局

现在我们知道了什么是 AI，ML 和不同的 ML 技术是什么，我们可以画出更大的图:
[![The bigger picture](../Images/fe0d28325a663af101deba49fe559b43.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--foUiNyBn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m30lh3whvi2umozqewvf.png) 
...
[![Dog](../Images/ad9dea980b611479b78fc7de2c70a03d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VEJzB4UJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2i3uv87quxtvsd5bxf64.png)

这些步骤的结果被称为**“模型”**，生成模型的过程被称为**“训练”**。你可能在*之前听过这句话*“我正在训练我的模特”。这基本上意味着我要多次经历步骤 1 & 2 来识别一个模式。

[![Training a model](../Images/5b3fce1d6d9fcae8fb9312a3088a312a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o1T4vb-o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fr61jjqfmjtibnckn441.png)
...
*   数据准备
*   创建并测试算法的结果
*   向应用程序展示您的模型![Challenges](../Images/4aa1091e26a687aea68793941b212bc0.png)
...
[![Dog or Muffin](../Images/1ede4881fd05c70d14789c34465d0d74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rkxPqM4s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qxdkrqpyp1gmz4290vxk.png)
...
## [](#expose-your-model-to-the-app)将你的模型暴露在应用程序中

任何将数据暴露给不同应用程序的人都知道，创建一个满足不同应用程序需求的可靠且安全的 REST API 并不容易。

[![Expose your model to the app](../Images/629303acfb9d71aebaeb6bb216b82f1c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cyN5jZgI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jiv7g7jqy78q061uh8zm.png)

# [](#is-there-an-easier%C2%A0way)有没有更简单的方法？
...
你的过程会变成如下画面:
[![Cognitive Services](../Images/e02835b75dcd38956559178511b172b6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Hw_uJsnt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bd4bap9zbshhb5x4vm2o.png)
...
[![List of Azure Cognitive Services](../Images/7c7ccbe6dd4c2016f4a8d3635076e97e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ty7hirUy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/otrjmwf5qvn820fevi1j.png)
...
[![Azure portal](../Images/3224e8856057c9924f95d6f3f1c130fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9eP-9qzI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jmlnie5k6fzmxulac0ve.png)
