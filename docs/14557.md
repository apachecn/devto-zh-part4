...
> 原文:[https://dev . to/lemuelogbunude/kot Lin-sequences-vs-kot Lin-collection-functions-4e5j](https://dev.to/lemuelogbunude/kotlin-sequences-vs-kotlin-collection-functions-4e5j)
...
### [](#should-you-use-sequences-in-all-cases)是否应该在所有情况下都使用序列？
