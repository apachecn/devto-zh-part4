...
> 原文:[https://dev . to/WPAN as/using-dagger-2-in-Android-and-kot Lin-2381](https://dev.to/wpanas/using-dagger-2-in-android-and-kotlin-2381)

# [](#what-made-me-do-this-article)是什么让我做了这篇文章？
...
# [](#how-to-setup-dagger-2-with-kotlin)如何用 Kotlin 设置匕首 2？
...
# [](#provide-modules-to-inject)提供模块注入
...
# [](#prepare-your-application)准备您的申请
