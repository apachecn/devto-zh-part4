...
[![Página inicial do GitHub atualmente](../Images/d201a7265e141819bf5cdf21b33fc269.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KLHos-iG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ca2pyzgamadnsl53fbgn.png)

<figcaption>Screenshot da página inicial do GitHub atualmente.</figcaption>

## [](#comunidade-open-source)开源社区
...
## [](#stars-e-forks)星辰 e 叉

[![Stars e forks](../Images/3999d4b3fd5ffdc3067752e5abc70e5f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3wp2Ivjm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pu4yui075180v6w6k318.png)

访问 GitHub 上的公共存储库时，可以给出类似于最著名社交网络的**、*功能，也可以做出**fork】，即创建一条狗主页屏幕上显示了您所关注的人在公共存储库中提供的‘T6’stars’和 **forks** ，这是一项旨在扩大开源项目范围的功能。*****

 *****## [](#pull-requests-prs-e-issues)拉式请求(PR)e 问题

从**fork**开始，在完成您认为必要的更改后，您可以提交请求，将修改后的内容附加到所选存储库中的原始内容。该申请为**拉式申请**，这是对平台上某个项目的最典型贡献形式，将由维护者审查。请注意以下打开新 PR 的过程:

[![Submetendo uma nova PR](../Images/69e2180cb7df7a675ad6a957325d01ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ix2AnAjX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/DsAq3NW.gif)
...
[![Submetendo uma nova issue](../Images/f6b7be3658d97a3e49624669edfa080f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vVNbfgMy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/n0TkrzC.gif)

## [](#descobrindo-reposit%C3%B3rios-e-contribuindo)发现存储库并作出贡献
...
[![](../Images/a9bc1fb129fe4f1f7140c363ed663017.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ijDM0krI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pjm9maf3lt611kbhjlzr.png)
...
## [](#explorando-o-github)探索 o GitHub

访问开源项目新闻的另一种方法是访问 GitHub 页 ，该页除了显示推荐项目外(如上一主题所示)，还允许这些项目的社区之间建立联系。您可以浏览受托人内容、按主题和标签搜索项目、访问与推荐技术相关的帖子、文章、事件和会议信息，以及其他信息。

[![](../Images/5b5d20c4aceae26448b0c1f8428ec0cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b_6lYXJO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ngl2p0mpmwzd6x8dzziq.png)
