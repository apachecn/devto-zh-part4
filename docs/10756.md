...
> 原文:[https://dev . to/miloszpp/strict-function-types-in-type script-协方差-逆变-双变量-53kc](https://dev.to/miloszpp/strict-function-types-in-typescript-covariance-contravariance-and-bivariance-53kc)
...
## [](#covariance-contravariance-and-bivariance)协方差、逆变和双变量
