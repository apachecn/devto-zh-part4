...
> 原文:[https://dev . to/feli pedsc/custom-validators-com-reactive forms-sincronos-e-assincronos-573 I](https://dev.to/felipedsc/custom-validators-com-reactiveforms-sincronos-e-assincronos-573i)
...
## [](#valida%C3%A7%C3%A3o-s%C3%ADncrona)同步验证
...
#### [](#mas-o-que-%C3%A9-esse-retorno-s-string-boolean-)但这是什么回报 **{ [s: string]: boolean }** ？！
...
#### [](#porque-retornamos-null-quando-o-valor-%C3%A9-v%C3%A1lido)为什么值有效时我们返回 null？
...
[![](../Images/efc88132e54f9a4c1138b9e916ed9981.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uX1CfsWc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/psvblt12w37e19k17xjp.PNG)

如果我们有**键:true** ，角度已经确定控件无效:

[![](../Images/d4a5d55bc68dc693528f610c60fc497a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k73z9SKp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7n6plmubf92nldlpjeqc.PNG)

现在，如果我们有 **key: false** ，控件将检测到 **errors** 中的某个东西，尽管我们希望表明控件是有效的，但当传递某个东西给属性时，角度将认为控件是无效的:

[![](../Images/4ebc023eba442366c3e7d5db4a1dadfa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--x-AjjAoY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7gh2aacxu2xnbcqln5ka.PNG)

* * *

## [](#valida%C3%A7%C3%A3o-ass%C3%ADncrona)异步验证
...
[![](../Images/7b55053b814e72d5807efebcca184e90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tHSBHb_p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3zkd7karc1fc5ygsgt4v.png)
