...
> 原文:[https://dev . to/scrimba/how-to-recreate-medium-s-article-layout-with-CSS-grid-17ce](https://dev.to/scrimba/how-to-recreate-medium-s-article-layout-with-css-grid-17ce)
...
[![Click the image to get to the full CSS Grid course.](../Images/b0623a7a0c1e3772c2f52efbbbcd5edf.png) ](https://scrimba.com/g/gR8PTE?utm_source=dev.to&utm_medium=referral&utm_campaign=gR8PTE_recreate_medium_layout_article) *点击图片进入完整的 CSS 网格课程。*
...
[![](../Images/b803072d1ed0c9fe807fc0db44a53d44.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Dg4bXrT0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A78oGaexa4dc4cox9b3TIwA.png)

不是特别优雅。所以还是用 CSS 网格来修复吧。我们将一步一步地做它，以便你能容易地跟上。

### [](#basic-setup-for%C2%A0margins)基本页边距设置
...
[![](../Images/7d9618b62027b9c3d8057a464f20734f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K3U95VlP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A7OmrcS4aCFyiqPBK93IpJg.png)
...
[![](../Images/d16a8e0b5bc81ce2e47d6604eb9e770e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CpLX_L_A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2560/1%2ATv8dyhSJfSjtcevJ3rfK6g.jpeg)
...
[![](../Images/5bcc8b75882f70511a18f81e5c5f0ea3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--u2v6T8OX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A50nsmqw-saQJXQNb0nuhnA.png)

### [](#expanding-with-more%C2%A0columns)用更多列展开

然而，这并没有让我们走完全程，因为 Medium 还有一些其他的布局需要我们考虑。让我们来看看其中的几个:

#### [](#midsized-images)中型图片

这是介于普通和全幅之间的图像选项，我们称之为*中型*图像。看起来是这样的:

[![](../Images/f710cb75be6187060d245645406777b6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4ykGbpi9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2AkcNKt8kvMpl3c590yOMQpg.jpeg) 
...
[![I’ve added pointers to make it easier to recognise the different columns.](../Images/1e12ef3ef69dee08946fd6d854d307cd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--bPCU0HTI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AYgYXxuC1tzrUdurfhirtww.png) 
我添加了指针，以便更容易识别不同的列。
...
[![](../Images/40d8739641f463a04e708978c3265a8b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J2h9c4k8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2AJabCqoB2CfZzy7toJcAj3A.png)
...
[![](../Images/2772b4dcc00eddcdc62e426e4be4c8e1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GslDqEnt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2ASiTYghcUyboIplQOfFQTqA.png)

### [](#sidemarks)**侧标记**

现在我们还需要支持最后一件事。Medium 有一种非常好的方式来表示文章中的哪些内容最突出。文本变成绿色，并在右侧得到一个顶部高亮显示的*。*

 *[![](../Images/f894dc3970e20156008a76cf087d9693.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gyZCU3Wc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ALUik3S2fM6I5P0b_k8EmpQ.png)
