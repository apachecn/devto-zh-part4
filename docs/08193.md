...
> 原文:[https://dev . to/sandordargo/the-big-STL-algorithms-tutorial-modificing-sequence-operations-copy-et-al-1751](https://dev.to/sandordargo/the-big-stl-algorithms-tutorial-modifying-sequence-operations-copy-et-al-1751)
...
## [](#-raw-copybackward-endraw-)`copy_backward`
