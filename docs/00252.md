...
> 原文:[https://dev . to/Mellon _ dev/first-look-ef core-3-and-the-azure-cosmosdb-provider-3 NLB](https://dev.to/mellon_dev/first-look-efcore-3-and-the-azure-cosmosdb-provider-3nlb)
...
[![Azure Portal showing the new Collection created by Entity Framework](img/7d1a0b6eeee9fc4d5ed442cc08cc31d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NFO6szMw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uzsc5wgziv830w56k4kt.PNG)
...
[![Azure Portal showing the Collection named Jobs](img/b25a54468652d0cf5c9ad0ed96855166.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CEtB6xek--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ziddsw6q442qjb02xx16.PNG)

### [](#embedded-collections)嵌入式收藏
...
[![Job with embedded Contacts array](img/acb2889bcca7f72e3758819fd7b4fe17.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NQJS4q4Y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/86btpe3rp8k5roqa9s48.PNG)

### [](#multiple-models-in-one-collection)一个系列中的多个型号

Cosmos 提供者支持在同一个集合中存储多个实体类型。为此，EF Core 在我们的文档中添加了一个名为`Discriminator`的字段。如果我们看一下数据库中的最后一个文档，我们可以看到每个对象都有一个**鉴别器**字段。

[![Discriminator field highlighted in document](img/b76055c98206b2e9d7bb1b1bc22774e3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HlO9O7H---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xnc41vnjwxkrmovh9f3a.PNG)

还要注意`id`列，它对于 Cosmos 集合/分区中的每个条目都是唯一的，EF Core 通过连接鉴别符和主键值来生成值，使用“|”作为分隔符

#### [](#linked-entitiesdocuments)链接实体/文档
...
[![Job with linked Resource document](img/c07920e49d7d2b359ff88e6051291d32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5ABLi7od--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rih67c9k5le40ps3z15x.PNG)

#### [](#loading-linked-entities)加载链接实体
...
#### [](#loading-multiple-linked-entities)加载多个链接实体
