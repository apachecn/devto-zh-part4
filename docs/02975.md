...
> 原文:[https://dev . to/bnevilleoneill/understand-array-methods-by-implementing-them-all-them-IHA](https://dev.to/bnevilleoneill/understand-array-methods-by-implementing-them-all-of-them-iha)
...
## [](#iterating-over-collections)迭代集合

### [](#foreach)[。forEach](https://github.com/maciejcieslar/array-methods/blob/master/src/for-each.ts)
...
#### [](#a-logging-utility-function)一个日志记录实用功能
...
### [](#map)[。地图](https://github.com/maciejcieslar/array-methods/blob/master/src/map.ts)
...
### [](#filter)[。过滤器](https://github.com/maciejcieslar/array-methods/blob/master/src/filter.ts)
...
### [](#reduce)[。减少](https://github.com/maciejcieslar/array-methods/blob/master/src/reduce.ts)
...
### [](#findindex)[。findIndex](https://github.com/maciejcieslar/array-methods/blob/master/src/find-index.ts)
...
### [](#find)[。找到](https://github.com/maciejcieslar/array-methods/blob/master/src/find.ts)
...
### [](#indexof)[。](https://github.com/maciejcieslar/array-methods/blob/master/src/index-of.ts)的索引
...
### [](#lastindexof)[.lastIndexOf](https://github.com/maciejcieslar/array-methods/blob/master/src/last-index-of.ts)
...
### [](#every)[。每隔](https://github.com/maciejcieslar/array-methods/blob/master/src/every.ts)
...
### [](#some)[。有的](https://github.com/maciejcieslar/array-methods/blob/master/src/some.ts)
...
### [](#includes)[。包括](https://github.com/maciejcieslar/array-methods/blob/master/src/includes.ts)
...
### [](#flat)[。平坦](https://github.com/maciejcieslar/array-methods/blob/master/src/flat.ts)
...
### [](#flatmap)[。平面图](https://github.com/maciejcieslar/array-methods/blob/master/src/flat-map.ts)
...
## [](#joining-appending-and-reversing-arrays)连接、追加和反转数组

### [](#concat)[。串联](https://github.com/maciejcieslar/array-methods/blob/master/src/concat.ts)
...
### [](#join)[。加入](https://github.com/maciejcieslar/array-methods/blob/master/src/join.ts)
...
### [](#reverse)[。反向](https://github.com/maciejcieslar/array-methods/blob/master/src/reverse.ts)
...
## [](#adding-removing-and-appending-values)添加、删除和追加值

### [](#shift)[。换档](https://github.com/maciejcieslar/array-methods/blob/master/src/shift.ts)
...
### [](#unshift)[。未换档](https://github.com/maciejcieslar/array-methods/blob/master/src/unshift.ts)
...
### [](#slice)[。切片](https://github.com/maciejcieslar/array-methods/blob/master/src/slice.ts)
...
### [](#splice)[。拼接](https://github.com/maciejcieslar/array-methods/blob/master/src/splice.ts)
...
### [](#pop)[。砰砰声](https://github.com/maciejcieslar/array-methods/blob/master/src/pop.ts)
...
### [](#push)[。按下](https://github.com/maciejcieslar/array-methods/blob/master/src/push.ts)
...
### [](#fill)[。填充](https://github.com/maciejcieslar/array-methods/blob/master/src/fill.ts)
...
## [](#with-generators)带发电机

最后三种方法的特殊之处在于它们返回生成器的方式。如果您不熟悉生成器，可以跳过它们，因为您可能不会很快使用它们。

### [](#values)[。数值](https://github.com/maciejcieslar/array-methods/blob/master/src/values.ts)
...
### [](#keys)[。按键](https://github.com/maciejcieslar/array-methods/blob/master/src/keys.ts)
...
### [](#entries)[。条目](https://github.com/maciejcieslar/array-methods/blob/master/src/entries.ts)
