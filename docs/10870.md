...
> 原文:[https://dev . to/sync fusion/how-to-create-a-flow-from-data-without-specifying-coordinates-in-wpf-3fkh](https://dev.to/syncfusion/how-to-create-a-flowchart-from-data-without-specifying-coordinates-in-wpf-3fkh)
...
## [](#common-flowchart-symbols)常见流程图符号

不同的流程图符号具有不同的含义，用于表示流程图中的特定状态。下表描述了最常见的流程图符号。

| **符号** | **名称** | **描述** |
| ![Terminator - Flow Chart Shape](../Images/722d89f40314f5963291b6b96353b62b.png) | 终止符/开始/结束 | 指示进程的开始或结束。 |
| ![Data - Flow Chart Shape](../Images/9b598fd4156bb9a74f0012766f7dba9f.png) | 数据 | 表示进程的数据输入或输出。 |
| ![Process - Flow Chart Shape](../Images/3561b8128fb2a04c97a0745bb42ab3cf.png) | 过程 | 表示一个或一组操作和数据操作。 |
| ![Decision - Flow Chart Shape](../Images/e5bbc33baf3ecbe77e899d69ba0ceda3.png) | 决定 | 显示了决定从两条路径中选择一条的分支点。 |
| ![Document - Flow Chart Shape](../Images/864e5010aa595ca03dc85f9623ff763c.png) | 文件 | 代表流程中的单个文档或报表。 |
| ![SubProcess - Flow Chart Shape](../Images/a83ed327619376971caefeda04d65c3a.png) | 子流程/预定义流程 | 表示组合起来执行在别处定义的特定任务的一系列操作。 |
| ![Database - Flow Chart Shape](../Images/c88c11cbe1386bcb9e5401313eaae1ed.png) | 数据库ˌ资料库 | 表示允许搜索、排序和筛选的信息集合。 |
| ![DataStorage - Flow Chart Shape](../Images/558fc94ef793f1a923b415e2ab5c873b.png) | 数据存储 | 表示在流程中存储数据的步骤。 |
| ![Manual Input - Flow Chart Shape](../Images/6fd2ada94ff1f445c955a81caa8c3591.png) | 人工输入 | 表示将数据手动输入到流程中的字段或步骤。 |
| ![Manual Operation - Flow Chart Shape](../Images/02daab8881c3c0150877830e55cd5ca0.png) | 手控 | 表示流程中必须手动完成而不是自动完成的操作。 |
| ![Preparation - Flow Chart Shape](../Images/53ca9b4694a604cbb4b094f31cf3b050.png) | 准备 | 表示过程中另一个步骤的设置或初始化过程。 |
| ![On Page Reference - Flow Chart Shape](../Images/9672933582e60d86c5dee59c16eb43c9.png) | 页面上的参考 | 代表一对带标签的连接线，用于链接流程图中的长线条或易混淆的线条。 |
| ![Off Page Reference - Flow Chart Shape](../Images/303d3c87ed9da1479de6a8cde9316f15.png) | 离页参考 | 代表用于链接不同页面上的两个流程图的带标签的连接线。 |
| ![Multi Document - Flow Chart Shape](../Images/334714b9ac94d90e127e277586830cdf.png) | 多文档 | 代表一个流程中的多个文档或报表。 |
| ![Flow Line - Flow Chart Shape](../Images/a3d165fef60abdf52776e320571b9701.png) | 流线 | 表示从一个步骤到另一个步骤的流动方向。 |

## [](#getting-started-with-a-simple-flowchart)从简单的流程图开始

让我们使用 [Syncfusion 图表库](https://www.syncfusion.com/wpf-ui-controls/diagram)创建一个简单的流程图，如下图所示。图表控件具有内置的高性能布局算法，可以自动排列每个流程图符号，并且它支持可视化来自数据源的流程图。【T2![Flowchart Built with the Diagram Control’s Automatic Layout Algorithm](../Images/7d8ea3f24c351ca42c87f834776ecd65.png)
...
### [](#flowchart-orientation-customization)流程图方向定制
...
[![Horizontal Flowchart](../Images/2819d43aabcbfa415f92bb1d43447ca1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0IwaIQ2r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Horizontal-Flowchart.png)

*水平流程图*

### [](#customize-the-decision-symbol-output-directions)自定义决策符号输出方向
...
[![Flowchart with Decision Branch](../Images/730604d79217bb24f79dcdfb4d8aa51e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l4BmFXnS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Flowchart-with-Decision-Branch.png)

*带有决策分支的流程图*

### [](#customize-yes-and-no-branch-line-text)自定义是和否分支线文本
...
[![Custom Branch Line Text](../Images/a02c1514f70a94395b8f3e6f9f01181b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LZjf1QIT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Custom-Branch-Line-Text.png)
