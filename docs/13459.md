...
> 原文:[https://dev . to/Ben Robertson/color-swacks-in-story book-4aa 9](https://dev.to/benrobertson/color-swatches-in-storybook-4aa9)
...
[![The color swatches from Brad Frost's pattern lab](../Images/b359d6bb5eabb8a0bce7969fdb307e44.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BE4LsWOF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://benrobertson.io/assets/img/color-swatches/brad-frost-pattern-lab.png)

不过，如果它是可维护的，我只想添加它。我不希望我们不得不单独更新故事书，而不去改变颜色。

## [](#exporting-scss-variables-for-use-in-javascript)导出 SCSS 变量用于 JavaScript
...
[![The color swatches, grouped by type in Storybook.](../Images/b47d8ea4a16032cf3b09b273ae491770.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XUlDWCHM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://benrobertson.io/assets/img/color-swatches/final-swatches.png)
