...
> 原文:[https://dev.to/jccguimaraes/designing-an-api-1e3d](https://dev.to/jccguimaraes/designing-an-api-1e3d)
...
### [](#what-is-an-uml-sequence-diagram)什么是 UML 序列图？
...
[![small-example](../Images/0b366ace4564470eefac7b7328c05a03.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--plC5r96I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6d99osiyx4nluwrjastf.png)
...
## [](#planning-with-sequence-diagrams)用序列图进行规划
...
[![capture](../Images/4be9afd9b5dbb10b39e76428f3f1c0ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SYMGLoo1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hw2d3up9w0aqav7ey0xc.png)

### [](#tooling-for-plantuml)用于 PlantUML 的工具
...
## [](#writing-the-contract-in-the-openapi-specification)编写 OpenAPI 规范中的契约
...
### [](#organising-the-contract-structure)组织合同结构
...
## [](#testing-against-the-api)对照 API 进行测试
...
### [](#converting-openapi-to-postman-collection)将 OpenAPI 转换为 Postman 集合
