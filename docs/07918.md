...
> 原文:[https://dev . to/aaronc 81/causes-a-programming-language-feature-concept-2ag 0](https://dev.to/aaronc81/causes-a-programming-language-feature-concept-2ag0)
...
# [](#proposing-a-language-which-includes-causes)提出一种包含原因的语言
...
# [](#what-is-gained-from-doing-this)这样做有什么收获？

在编写代码时，考虑一个方法的原因似乎是另一个障碍，所以为什么要这么麻烦呢？

## [](#effortless-idempotency)毫不费力的等幂
...
## [](#extra-assertions-for-free)免费额外断言
