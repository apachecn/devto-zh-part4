...
> 原文:[https://dev . to/anastasionico/good-practices-PHP-security-how-to-management-password-18bm](https://dev.to/anastasionico/good-practices-php-security-how-to-manage-password-18bm)
...
## [](#3-rules-for-password-security)密码安全的三大法则

### [](#never-know-user-passwords)永远不知道用户密码
...
### [](#do-not-restrict-passwords)不限制密码
...
### [](#never-email-passwords-in-clear)永远不要在邮件中清除密码
...
## [](#how-to-hash-users-password)如何散列用户的密码
...
## [](#hashing-and-verify-a-password-in-php-7)在 PHP 7 中散列和验证密码

### [](#hashing-the-password-with-passwordhast)用 password_hast 散列密码
...
## [](#verify-the-users-password)验证用户的密码
...
[![](img/fb99e7d4cedf4d83ac3a3b4e1d71d28d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--35ecHO5---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://anastasionico.uk/img/1/download.jpeg)
...
## [](#how-to-create-a-user-registration-system-in-php)如何在 PHP 中创建用户注册系统
...
### [](#step-1-creating-a-database-table-using-a-sql-language)第一步:使用 SQL 语言创建数据库表
...
### [](#step-3-register-the-user)第三步；注册用户
...
### [](#step-4-create-the-login-form)第四步:创建登录表单
...
### [](#step-5-allow-the-user-to-access-the-web-application)第五步:允许用户访问 web 应用程序
