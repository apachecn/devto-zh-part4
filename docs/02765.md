...
> 原文:[https://dev . to/ramitd 1995/selenium-automation-testing-with-disabled-JavaScript-settings-is-it-worth-your-time-3l8p](https://dev.to/ramitd1995/selenium-automation-testing-with-disabled-javascript-settings-is-it-worth-your-time-3l8p)
...
## [](#things-that-can-be-done-with-javascript-amp-things-that-cant-be)用 JavaScript 能做的事情&不能做的事情！

我相信您一定很想知道在禁用 JavaScript 后是否有必要测试 web 应用程序？然而，在我回答这个问题之前，我们需要了解作为一名测试人员，你能用 JavaScript 做什么&你不能做什么！

### [](#things-you-can-do-with-javascript)用 JavaScript 可以做的事情

*   访问和修改网页上可见的所有内容，如文本、图像、视频或任何其他类型的私人数据。
*   访问 web 服务器发送的 cookies。
*   向其他服务器发出数据捕获请求。

### [](#things-you-cant-do-with-javascript)用 JavaScript 做不到的事情
...
## [](#why-would-a-user-visit-your-website-with-javascript-disabled)为什么用户会在禁用 JavaScript 的情况下访问您的网站？
...
[![javascript](img/90c54a53791a68c40815a22af718f582.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--It78AxCq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.lambdatest.com/blog/wp-content/uploads/2019/08/javascript.png)
...
## [](#why-testing-with-javascript-disabled-should-be-a-part-of-your-qa-checklist)为什么禁用 JavaScript 的测试应该是你的 QA 清单的一部分？
...
## [](#how-to-disable-javascript-for-manual-testing)如何禁用 JavaScript 进行手工测试

我将在两种浏览器中演示该过程，即 Google Chrome 和 Mozilla Firefox，以帮助您将该过程集成到跨浏览器测试清单中。我会使用 LambdaTest 来帮助我访问不同的浏览器，而不用经历安装它们的麻烦。

### [](#1-google-chrome)1。谷歌浏览器

在 Chrome 浏览器中测试一直是测试人员优先考虑的事情。以下是谷歌搜索默认情况下的表现方式。也就是说，启用 JavaScript 时。

[![Disable JavaScript For Manual Testing](img/af7d8a7f8937417cc5a94b638b5daa0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W1artqNG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.lambdatest.com/blog/wp-content/uploads/2019/08/pasted-image-0-7.png)
...
[![Disable JavaScript](img/9371707b2d8e5a75688d5e4dbe586203.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xaQxZPAH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.lambdatest.com/blog/wp-content/uploads/2019/08/Disable-JavaScript.png)
...
[![enabled javascript](img/ad326531962bda97e7c2a53440ddac5e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CfdHz88e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.lambdatest.com/blog/wp-content/uploads/2019/08/enabled-javascript.png)
...
## [](#how-to-disable-javascript-for-automation-testing-with-selenium)如何使用 Selenium 禁用 JavaScript 进行自动化测试
...
[![](img/5ca15e434455da9426a2aad75efd7d47.png)T2】](https://accounts.lambdatest.com/register/?utm_source=dev&utm_medium=Blog&utm_campaign=Ramit-12092019&utm_term=Ramit)