...
> 原文:[https://dev . to/oncode/accessibility-developer-guide-setup-and-use-a-blind-user-s-environment-199n](https://dev.to/oncode/accessibility-developer-guide-setup-and-use-a-blind-user-s-environment-199n)
...
## [](#create-raw-insert-endraw-key)创建`Insert`键
...
## [](#install-screen-reader-amp-browsers)安装屏幕阅读器&浏览器
...
# [](#usage-of-screen-reader)屏幕阅读器的用法

## [](#focus-and-browse-mode)焦点和浏览模式
