...
> 原文:[https://dev . to/awwsmm/create-a-dynamic-prompt-string-in-bash-3617](https://dev.to/awwsmm/create-a-dynamic-prompt-string-in-bash-3617)

你可能见过一些很酷的`zsh`提示，在提示中显示当前 Git 分支的名称，像这个来自 [`oh-my-zsh`](https://github.com/robbyrussell/oh-my-zsh) :

[![](../Images/710ede536f794475106fdd8f21a5df62.png)T2】](https://github.com/robbyrussell/oh-my-zsh)
