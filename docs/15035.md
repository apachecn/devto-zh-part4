...
> 原文:[https://dev . to/rk eene/network-load-balancing-with-cluster IP-93o](https://dev.to/rkeene/network-load-balancing-with-clusterip-93o)

## [](#loadbalancer-less-load-balancing)负载均衡器少负载均衡
