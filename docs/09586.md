...
> 原文:[https://dev . to/marcglasberg/async-redux-flutter-s-non-boilerplate-version-of-redux-3c1o](https://dev.to/marcglasberg/async-redux-flutter-s-non-boilerplate-version-of-redux-3c1o)

### [](#async-redux-flutters-nonboilerplate-version-of-redux)Async Redux: Flutter 的非样板版 Redux
...
[![](../Images/5f423642bac5a464fd62f9c261ff2c27.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wk9NSxvG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/969/1%2AO34Rwgxfa3NiE7F_QW683Q.png)

#### [](#changing-state-is-optional)改变状态是可选的
...
#### [](#before-and-after-the-reducer)减速器前后
...
### [](#processing-errors-thrown-by-actions)处理动作抛出的错误
