...
> 原文:[https://dev . to/johnridesabike/bucklescript-belt-s-map-and-set-customizing-key-types-2cel](https://dev.to/johnridesabike/bucklescript-belt-s-map-and-set-customizing-key-types-2cel)
...
## [](#example-a-raw-beltset-endraw-of-tuples)举例:元组的一个`Belt.Set`
...
## [](#example-a-raw-beltmap-endraw-of-records)举例:一条`Belt.Map`的记录
