...
> 原文:[https://dev . to/angular/decorators-do-not-work-as-you-may-expect-3g mj](https://dev.to/angular/decorators-do-not-work-as-you-might-expect-3gmj)
...
# [](#quick-recap-on-decorators)对装修工的快速回顾
...
# [](#exploring-decorators-under-the-hood)探索装饰者的引擎盖下
...
# [](#creating-instancetargeted-decorators)创建面向实例的装饰器
