...
> 原文:[https://dev . to/samandar/convert-a-string-to-a-valid-filename-2l5p](https://dev.to/samandar/convert-a-string-to-a-valid-filename-2l5p)

将字符串转换为适用于 unix 和 windows 系统的有效安全文件名
