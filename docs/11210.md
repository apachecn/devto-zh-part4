...
> 原文:[https://dev . to/aduranil/how-to-use-web sockets-with-redux-a-step-by-step-guide-to-writing-understand-connecting-socket-middleware-to-your-project-km3](https://dev.to/aduranil/how-to-use-websockets-with-redux-a-step-by-step-guide-to-writing-understanding-connecting-socket-middleware-to-your-project-km3)
...
### [](#step-1-define-an-action-that-will-be-used-to-establish-a-websocket-connection)步骤 1:定义一个将用于建立 websocket 连接的动作
...
### [](#step-2-dispatch-your-action-to-open-a-new-websocket-connection)第二步:分派您的动作来打开一个新的 websocket 连接
...
### [](#step-3-write-the-websocket-middleware)第三步:编写 websocket 中间件
...
[![](../Images/0e92948bdc2bf60168454ee3f0b46dab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--axRZ2ugn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ektai3m4gnb8f5e9tucp.png)
...
### [](#step-4-create-the-store-with-your-new-middleware)第 4 步:用您的新中间件创建商店
