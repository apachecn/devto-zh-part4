...
> 原文:[https://dev . to/it minds/how-to-architecture-your-JavaScript-API-using-nestjs-with-a-graph QL-API-example-part-1-2-2 JCB](https://dev.to/itminds/how-to-architecture-your-javascript-api-using-nestjs-with-a-graphql-api-example-part-1-2-2jcb)
...
# [](#mongodb-and-mongoose)MongoDB 和 Mongoose
...
# [](#creating-a-productmodel)创建产品模型
