...
> 原文:[https://dev.to/jplindstrom/perl-i-never-write-snippets-3ae0](https://dev.to/jplindstrom/perl-i-never-write-snippets-3ae0)
...
## [](#moomoose-lazy-attribute)Moo/Moose 懒惰属性
...
## [](#other-moomoose-attributes)其他 Moo/Moose 属性
...
# [](#start-using-raw-yasnippet-endraw-)开始使用`yasnippet`
