...
> 原文:[https://dev.to/felipedsc/introducao-aos-reactive-forms-3ehl](https://dev.to/felipedsc/introducao-aos-reactive-forms-3ehl)
...
![](../Images/d223567a5f75a2ac72fa2c8425b850cc.png)
...
### [](#definindo-a-estrutura-do-formul%C3%A1rio)定义表格结构
...
### [](#adicionando-refer%C3%AAncias-ao-template)添加对模板的引用
...
### [](#valida%C3%A7%C3%B5es)验证

通过检查元素，您可以看到角度向输入中添加了一些类，以标识接触过哪些元素以及哪些元素无效，例如:

[![](../Images/ba9641d9386bbb1d777dce8978a08c88.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LcJDrfK6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/edqq6wle8u7wlizx31y4.PNG)
...
[![](../Images/ab0ad01538e2c4a30c017634be2fb8b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I9TDUjSE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/41p44aj6b9ihys5d2s3i.PNG)
...
## [](#formarray-de-telefones)电话的形式阵列
...
## [](#pr%C3%A9definindo-valores-do-formul%C3%A1rio)预定义表单值
...
## [](#limpando-o-formul%C3%A1rio)清理表格
...
## [](#tratando-dados-antes-de-enviar-ao-servidor)服务员
...
## [](#detectando-mudan%C3%A7as-de-valores-e-estado)侦探
