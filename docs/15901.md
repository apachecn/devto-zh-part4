...
> 原文:[https://dev . to/jeffpereira/testing-form-reset-with-enzyme-kp3](https://dev.to/jeffpereira/testing-form-reset-with-enzyme-kp3)
...
### [](#making-sure-the-modal-closes)确保模态关闭
...
### [](#testing-the-modals-content)测试模态的内容
...
### [](#making-sure-the-form-resets)确保表单复位
