...
> 原文:[https://dev . to/rachelsoderberg/create-a-simple-web-scraper-in-c-1l1m](https://dev.to/rachelsoderberg/create-a-simple-web-scraper-in-c-1l1m)
...
1.  启动 Visual Studio 并创建新的 C#。NET Windows 窗体应用程序。
    ...
    [![Visual Studio New Windows Forms App](../Images/2c0e16062d30982ac435fe9196768c16.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4D8bhJB5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hbd5i4lw5b0d34j46ndq.PNG)

2.  设计一个基本的表单，带有一个启动 scraper 的按钮和一个用于打印结果的富文本框。

    [![Basic Form Design](../Images/6c0df5ccdc00eb861c0ee2332142e1b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M3C0jRQM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rdz8wnswc6f8xa9g2y01.PNG)

3.  通过在解决方案资源管理器中右键单击您的项目名称并选择“管理 NuGet 包”,打开您的 NuGet 包管理器。搜索“AngleSharp”并单击安装。

    [![AngleSharp](../Images/846caf6f90c5145e47eb67f7ca32fbdf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HkqJxiRK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dqrdgryd1yflyroyakzz.PNG)
...
5.  创建另一个新方法来获取和显示 AngleSharp 文档的结果。在这里，我们将解析文档并检索任何匹配我们的查询条件的文章。这可能会很棘手，因为没有两个网站使用相同的 HTML 命名约定-这可能需要一些试验和错误，才能使“article link”LINQ 查询正确:
    ...
    [![Document Example](../Images/0eb7bfda87444b7a5a8cb0d27d2e5fef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m90x0U6S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yfqoqugbzcb1cogyumal.PNG)
...
9.  最后，我们有一个干净的，对人类友好的结果！如果一切顺利，并且自撰写本文以来文章没有发生重大变化，那么运行您的代码应该会产生以下结果(以及更多...有很多！)是你的申请从 Ocean Networks 上刮下来的:
    ...
    [![Web Scrape Results](../Images/c5499c8e2d5943031ef227b559938160.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gOmxu0JU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dy1zki97mpi4bffwjfax.PNG)
