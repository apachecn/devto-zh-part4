...
> 原文:[https://dev . to/just alever/let-s-build-with-ruby-on-rails-extending-device-series-confirmation-emails-EGF](https://dev.to/justalever/let-s-build-with-ruby-on-rails-extending-devise-series-confirmation-emails-egf)
...
### [](#creating-authenticated-routes)创建认证路由
...
### [](#making-confirmable-work)制作可确认的作品
