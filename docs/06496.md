...
> 原文:[https://dev . to/bnevilleoneill/the-state-of-semantic-jsx-4pa 6](https://dev.to/bnevilleoneill/the-state-of-semantic-jsx-4pa6)
...
## [](#accessibility-in-react-jsx)可达性在反应过来的 JSX

为了实现语义 JSX，有一些工具和实践可以帮助您的 React 应用程序更加用户友好。我们将在这一部分讨论这些工具和实践。

## [](#before-react-fragments)反应过来之前的碎片
...
## [](#using-react-fragment)使用 React 片段
...
## [](#things-to-note-when-using-fragments)使用片段时要注意的事项

*   当使用空标签时，它不支持使用键来映射数据
*   键是目前唯一受`<React.Fragment>`标签支持的属性

## [](#how-does-this-help-write-semantic-jsx)这对写语义 JSX 有什么帮助？
...
## [](#focus-amp-focus-management)聚焦&聚焦管理
...
## [](#achieving-focus-management-in-react-using-raw-ref-endraw-)使用`ref`在 React 中实现焦点管理
...
## [](#other-helpful-tips-when-implementing-semantic-jsx)实现语义 JSX 时的其他有用提示

### [](#1-setting-page-titles-using-componentdidmount)1。使用 componentDidMount 设置页面标题
...
### [](#2-react-accessibility-linter-eslintpluginjsxa11y)2。react accessibility linter(eslint-plugin-jsx-a11y)
...
### [](#3-writing-semantic-html)3。编写语义 HTML

大多数情况下，编写具有语义的代码可以大大有助于一个更易访问的平台，在本文的前面，我陈述了实现这一点的方法。同时参考本[指南](https://www.w3.org/WAI/standards-guidelines/wcag/)可以对此有所帮助。

## [](#conclusion)结论

在本文中，我们试图理解应用于 React 应用程序的 web 可访问性的基础知识，并从总体上了解一些可访问性原则。我希望我们在构建 React 应用程序时将这些实践付诸实践，为每个人提供一个更好的 web。编码快乐！[😄](https://s.w.org/images/core/emoji/12.0.0-1/72x72/1f604.png)
