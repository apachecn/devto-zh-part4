...
> 原文:[https://dev . to/danihodovic/caching-tricks-with-cloud flare-workers-57eb](https://dev.to/danihodovic/caching-tricks-with-cloudflare-workers-57eb)
...
## [](#why-do-i-need-cache-variation)为什么我需要缓存变异？

最好通过一个实际的例子来解释为什么通过不同的头进行缓存是有用的。

[![](../Images/778c876c0a9b84ad73500f0e8be0278f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CqU-oAGU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4xr9kryzh2lw3xda270x.png)
...
## [](#cloudflare-workers-to-the-rescue)Cloudflare 工人前来救援
