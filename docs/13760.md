...
> 原文:[https://dev.to/shortdiv/the-journey-to-async-await-2n4p](https://dev.to/shortdiv/the-journey-to-async-await-2n4p)
...
## [](#the-coming-of-async-js)异步 JS 的到来
...
## [](#they-call-it-callback-hell)他们称之为回调地狱
...
## [](#asyncawait-is-here-to-stay)Async/Await 将继续存在
