...
> 原文:[https://dev.to/vnglst/forgit-me-nots-2koa](https://dev.to/vnglst/forgit-me-nots-2koa)

## [](#squashing-commits-on-windows)在 Windows 上挤压提交
...
## [](#rebasing-without-pulling-master)不拉师傅就换基
...
## [](#copy-file-from-master-to-current-branch)将文件从主文件复制到当前分支
...
### [](#update-last-commit-with-current-changes)用当前更改更新上次提交
...
## [](#oh-no-i-deleted-all-my-work)哦不，我把我的作品都删了！？
...
## [](#if-gitignore-is-not-working)如果。gitignore 不起作用
