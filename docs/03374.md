...
> 原文:[https://dev . to/gite den/sharing-components-with-angular-and-bit-1no 5](https://dev.to/giteden/sharing-components-with-angular-and-bit-1no5)
...
## [](#creating-an-angular-ui-components-collection)创建有角度的 UI 组件集合

[Bit](https://bit.dev) 最近增加了对 Angular 编译器的支持。让我们看看如何将 *Bit* 与任何 Angular 项目集成。

### [](#creating-a-workspace)创建工作区
...
### [](#initialize-bit-in-your-project)初始化项目中的 Bit
...
### [](#adding-the-angular-compiler)添加角度编译器
...
### [](#creating-a-component-and-syncing-it-with-bit)创建组件并与 Bit 同步
...
### [](#installing-the-exported-component-in-your-project)在项目中安装导出的组件
...
## [](#exploring-bits-platform)探索 Bit 的平台
...
[![](img/c36184dedbd43ecfebe34fc0787d47fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qCFIuGrF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/6720/1%2Agu6wFqv-GQ1WByEvizBaYg.png)
...
[![](img/e1a2b1a52f7714ac598bafa53929479b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cGGJnhLh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/6598/1%2A6SVLXh6WwOVsP1JTf3vBrA.png)
