...
> 原文:[https://dev.to/goatmale/three-things-from-today-8-30-57ok](https://dev.to/goatmale/three-things-from-today-8-30-57ok)
...
## [](#1-spark-s3-tweaking)1。火花 S3 调整
...
## [](#2-helm-3-beta-2-is-released)2。头盔 3 beta 2 发布
...
## [](#3-what-is-apache-zeppelin-how-is-it-different-than-jupyter)3。什么是阿帕奇齐柏林飞艇？和 Jupyter 有什么不同？
