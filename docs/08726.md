...
> 原文:[https://dev . to/gothamv/get-started-with-python-in-under-10 minutes-3a5j](https://dev.to/gothamv/get-started-with-python-in-under-10-minutes-3a5j)

所以你想学习如何编码？你以前没有编码经验，还是来自另一种编程语言？你来对地方了。这是用 Python 编程的初学者终极指南。我们不会深入编程。但是我们将尽快开始编写代码。所以让我们开始吧！

## [](#part-i-setting-up-the-coding-environment)第一部分:设置编码环境
...
[![Follow the GIF if you have any confusions.](../Images/295f81b71b9a41e7bdd573cea5eb4796.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--cnArY3xe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AQXQFArTYxQlZfFzI9YyysQ.gif) *如有困惑，请跟随 GIF。*

现在我们有了一个 IDE，让我们写第一行代码吧！

## [](#part-ii-lets-write-some-code)第二部分:我们写点代码吧！

在您开始编码之前，在任何编程语言中，从编写代码打印“Hello World！”开始都是一个传统所以让我们不要打破传统，就这么做吧！

## [](#1-lets-print-stuff-using-python-)1。让我们用 Python 打印东西:

repl 的中间部分是你写代码的地方。右边叫做控制台。就当是你和 python 之间的中间人吧。控制台是您对 python 程序进行输入/输出的地方。

[![](../Images/f920fe20a83b19ab1fa419f6fa27fa58.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gw0wB128--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/6816/1%2ACNoFX5BkVE5aLSN_vPMnKg.png)
...
[![](../Images/667a0627881fc93b0bb392ffb8920dd4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eTfs6UDi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AmH4OsX34RB1-mmU18PbEBQ.gif)
...
## [](#2-comments-in-python)2。Python 中的注释
...
## [](#3-variables-in-python)3。Python 中的变量

把变量想象成一个盒子，你在里面储存东西。你可以储存数字，字符，句子等等。现在让我们处理数字、字符和句子(字符串)。

### [](#lets-assign-a-number-to-a-variable)让我们给一个变量赋一个数。
...
### [](#lets-assign-a-characterstring-to-a-variable)让我们给一个变量赋值一个字符/字符串。
...
## [](#4-arithmetic-operations-in-python)4。Python 中的算术运算
...
## [](#6-getting-input-from-the-user)6。从用户那里获得输入。
...
### [](#and-thats-pretty-much-it-for-the-basics)基本就这么多了。