...
> 原文:[https://dev . to/nya Garcia/pokeapi-rest-in-nodejs-with-express-typescript-MongoDB-and-docker-part-3-494 a](https://dev.to/nyagarcia/pokeapi-rest-in-nodejs-with-express-typescript-mongodb-and-docker-part-3-494a)
...
## [](#the-coding-begins)编码开始

### [](#preview)预览

和往常一样，我们将在这篇文章的结尾先预览一下我们的目录:

[![](../Images/00c3a53e3e0dcee39d7d3dfb22eba049.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RlBfn-Ih--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cas94h463z0tel1vkcbi.png)
...
### [](#pokeservice-querying-the-database)PokeService:查询数据库
...
### [](#implementing-get-routing)实现获取路由
...
[![](../Images/b192e138863ae43adb37eebfff7780dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xJ5-X-7A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d17qwbhch9hioz00277q.png)

因为我们没有将任何数据引入到我们的数据库中，所以我们接收到一个空数组。我们现在已经成功地完成了我们的第一个数据库查询！

### [](#adding-a-new-pokemon)添加新的口袋妖怪
...
[![](../Images/616986de8491d00882f0e0f338ad0b03.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YarERRCI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pygqsfzu49c48mtlmycu.png)

如果一切顺利，你应该会收到你刚刚添加的口袋妖怪作为输出。为了仔细检查，我们可以使用 GET 路径:

[![](../Images/9c3c9c67b05cf5014c2c966ece504acc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--r0-NUdsk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5hdr2y0zl6sbr71kes5t.png)

如您所见，我们的数据库中现在有了一个杰尼龟。不用担心“_id”和“_v”字段。它们是由 Mongooose 自动生成的，我们将在后面处理它们。

### [](#deleting-a-pokemon)删除一个口袋妖怪
...
[![](../Images/cadbe3fc4fa91788c48c63dbd8c827bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QlVKa0NP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5fwlgihbwzu2q47doyzr.png)

如您所见，我们收到了“删除成功”的消息。如果找不到我们指定 id 的口袋妖怪，我们将收到“找不到口袋妖怪”的消息。

我们可以通过从数据库中获取所有口袋妖怪来仔细检查我们的 squirtle 是否已被正确删除:

[![](../Images/cb851d87d82cf1d091ef0b3fc501cf53.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gtzw_Ec7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dg6rg2w0s19q38ffk3fw.png)

空数组=无口袋妖怪=杰尼龟已成功删除。

### [](#updating-a-pokemon)更新口袋妖怪
...
[![](../Images/d5d33e1ebbc5b30e64d032bfa1923f8e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DpFdy2_b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lzev91n0fpykb2r25cf4.png)

让我们获得所有的口袋妖怪来检查我们的杰尼龟:

[![](../Images/dbdd22230c3a3d55c138916921934872.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nxgoUVkY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zq23mv37sspwryd6lv0j.png)
