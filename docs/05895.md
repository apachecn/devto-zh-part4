...
> 原文:[https://dev . to/raicupata/compute-values-on-component-mount-with-react-hooks-state-vs-ref-4 epk](https://dev.to/raicuparta/compute-values-on-component-mount-with-react-hooks-state-vs-ref-4epk)
...
## [](#-raw-usestate-endraw-and-raw-useeffect-endraw-)`useState`和`useEffect`
...
## [](#conclusion-state-vs-ref-vs-memo)结论:状态 vs 参照 vs 备忘录
