...
> 原文:[https://dev . to/robo geek/ref links-vs-symlinks-vs-hard-links-and-how-can-help-machine-learning-projects-1cj 4](https://dev.to/robogeek/reflinks-vs-symlinks-vs-hard-links-and-how-they-can-help-machine-learning-projects-1cj4)
...
# [](#the-trick-to-rearranging-gigabytes-of-training-data)重新整理千兆字节训练数据的诀窍
...
# [](#versioned-datasets-using-file-copying)使用文件复制的版本化数据集
...
[![File copy scenario](../Images/a3f16442593c543542efe5cb04cb944f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OmQyDJyP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1hox1cyly1dsnqxfp2tv.gif)
...
[![XKCD](../Images/60155c3dc8c26ef2641b63ed44b0f9ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yNsBtwem--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgs.xkcd.com/comics/porn_folder.png)

来源:https://www.xkcd.com/981/

# [](#versioned-datasets-using-hard-links-and-symlinks)使用硬链接和符号链接的版本化数据集

显然，复制文件来处理数据集版本是缓慢的，并且是对磁盘空间的低效使用。在类 Unix 环境中，一个自古以来就存在的选项是硬链接和符号链接。虽然 Windows 过去不支持文件链接，但是“`mklink`”也可以支持两种类型的链接。

[![Hard Links and Symbolic Links](../Images/7e47a02f5152413ff2668b317ce1b270.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GjgWiJ2H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nt9y47pghodhzyixcgb4.png)
...
[![The hard link scenario](../Images/a40093bdaf8f6e64709948d56f710c38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--S0-edCTG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2fyvuusadfhhzjiqgwy6.gif)
...
[![Styles of links](../Images/ba62ea2358fce40eb29efc8c56796021.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--afwSrBzL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x94lpqmuswdaizdq05vn.png)

# [](#versioned-datasets-using-reflinks)使用引用链接的版本化数据集
...
[![Reflinks](../Images/c1ed4b07f08f238e58716e6b9b57a059.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kFEZNFcM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hda2xvpq1068vyjwfx4c.png)
...
[![The reflink scenario](../Images/d9df49aa2c96edc9ec346840623b9211.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iFWF0qPQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l3hwn2uer6cubc1rlbra.gif)
...
[![Results](../Images/68abe68ad9faa1a3ff0a9e91ebf006e8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2dE_Mly6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9duojm0vyjqm5vqnasm3.png)
