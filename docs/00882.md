...
> 原文:[https://dev . to/bnevilleoneill/improve-UX-in-react-apps-by-showing-skeleton-ui-5a3i](https://dev.to/bnevilleoneill/improve-ux-in-react-apps-by-showing-skeleton-ui-5a3i)
...
### [](#how-skeleton-screens-improve-ux)骷髅屏幕如何提升 UX
...
### [](#different-skeleton-ui)不同的骨架 UI
...
### [](#react-content-loader)React 内容加载器
...
### [](#skeleton-ui-example-using-react)使用 React 的骨架 UI 示例
