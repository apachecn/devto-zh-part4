...
> 原文:[https://dev . to/joaofbantunes/episode-028-multiple-service-instances-tweaks-ASP-net-core-from-0-to-overkill-4ald](https://dev.to/joaofbantunes/episode-028-multiple-service-instances-tweaks-asp-net-core-from-0-to-overkill-4ald)
...
## [](#what-is-data-protection-in-aspnet-core-and-why-should-i-care)什么是 ASP.NET 核心中的数据保护，我为什么要关注？
...
## [](#why-has-it-been-working-well-until-now)为什么一直到现在都很好用？
...
## [](#using-a-shared-directory-to-store-data-protection-keys)使用共享目录存储数据保护密钥
...
## [](#identityserver-signing-credentials)标识服务器签名凭证
