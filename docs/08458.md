...
> 原文:[https://dev . to/gattalraouf/12500-an-Android-developer-s-nightman-1i3b](https://dev.to/gattalraouf/12500-an-android-developer-s-nightmare-1i3b)
...
## [](#debugging-the-error)调试错误

### [](#attempt-1-checking-if-i-missed-enabling-google-signin-on-firebase)尝试 1:检查我是否错过了在 Firebase 上启用 Google 登录

虽然我 100%确定我确实启用了它，但我还是检查了，我所要做的就是前往我的 Firebase 控制台，选择我的应用程序，并在身份验证登录方法下，检查谷歌登录是否启用。

[![Alt Text](../Images/ba9669cdd5855a12cc6f51fa2da9e9fd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oSdeIyqh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tk3giz4aat6suv4sw67y.png)

**—假设被驳回👎**

### [](#attempt-2-checking-if-the-project-support-email-is-configured)尝试 2:检查是否配置了项目支持电子邮件

在谷歌搜索了一番后，我发现应该提供支持电子邮件以便登录工作，我知道我没有配置它，所以我应用了以下过程来添加它:
在 Firebase 控制台的我的应用程序中，在身份验证登录方法下，并启用了谷歌登录，我选择了谷歌登录选项。最后添加了支持邮件。

[![Alt Text](../Images/2c2980359fa4866560f399390bdb013c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GKJFx3El--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oteryo7lhbx8rhab2gau.png)

添加了支持邮件后，我很乐观，修复了问题，重新构建了应用程序并再次测试，但令人惊讶的是 12500 再次出现…
**——假设被驳回👎**

### [](#attempt-3-checking-if-the-sha1-certificate-fingerprint-is-configured-correctly)尝试 3:检查 SHA-1(证书指纹)配置是否正确
...
[![Alt Text](../Images/6fa93e4204a7929c61471974c2c1c4f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i8lFl5ry--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y12yv14a140ozx1ht87i.png)

PS:确保每次更改 SHA-1 时更新 google-services.json 文件。
总之，不管我把 SHA-1 换了多少次，12500 一直显示…
**——假设被驳回👎**

### [](#attempt-4-add-an-application-logo-to-your-project-in-the-google-cloud-platform-console)尝试 4:在[谷歌云平台](https://console.developers.google.com/apis/)控制台中为您的项目添加应用程序徽标
...
[![Alt Text](../Images/a36c521530f5e59f96cf05268285ef34.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yaFmKVk8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/43tgakdde5bk9hakwzql.png)
