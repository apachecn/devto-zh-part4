...
> 原文:[https://dev . to/cosimo/JVM-memory-usage-monitoring-tools-2 MMF](https://dev.to/cosimo/jvm-memory-usage-monitoring-tools-2mmf)
...
[![](../Images/f07c6c1d9c7c26a2862651e7da133795.png "jvm-mon console screenshot")](http://www.streppone.it/cosimo/blog/wp-content/uploads/2019/06/jvm-mon.png) 我挺喜欢 jvm-mon 的，它很清晰，数据也容易理解。图表会根据运行时间的长短动态调整大小。
...
这是 jps_stat 执行时的样子: [![jps_stat console screenshot](../Images/841b0573e065c19c68d69ac6c5f11589.png)](http://www.streppone.it/cosimo/blog/wp-content/uploads/2019/06/jps_stat.gif)
