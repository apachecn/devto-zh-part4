...
> 原文:[https://dev . to/patrixr/publishing-my-vitals-over-the-cloud-132 e](https://dev.to/patrixr/publishing-my-vitals-over-the-cloud-132e)
...
[![](../Images/db3b81e605614df2f7088bc3f09f249b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8Ls8LAlk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://files.tronica.io/manual-uploads/vitals_diagram.png)

## [](#using-the-fitbit-api)使用 Fitbit API
...
### [](#step-1-registering-an-application)第一步:注册应用程序
...
[![](../Images/b7d7618e0d67300937fa6f84cc95b494.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l7uxszhm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://files.tronica.io/manual-uploads/vitals_fitbit_app_screenshot.png)

### [](#step-2-authenticate)第二步:认证

为了快速、轻松地进行身份验证，我使用了 [passport-fitbit-oauth2](https://www.npmjs.com/package/passport-fitbit-oauth2) 模块。

#### [](#creating-the-strategy)创建策略
...
#### [](#hooking-it-up-to-expressjs)挂接到 ExpressJS
...
### [](#step-3-retrieving-data)第三步:检索数据
...
[![](../Images/328d6942c9dd43333d3267186e9e8846.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GbR-muT4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://files.tronica.io/manual-uploads/vitals_app_screenshot_montage_large.png)

## [](#securing-the-app)保护应用程序
...
[![](../Images/9b49ee343e1ba8a8f6df978ad41ca002.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xrjQxweg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://files.tronica.io/manual-uploads/vitals_pocket_admin_screenshot.png)

## [](#improvement-ideas)改进思路
