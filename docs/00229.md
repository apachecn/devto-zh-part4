...
> 原文:[https://dev . to/mande EPM 91/how-to-ssh-to-AWS-servers-using-an-ssh-config-file-3 adn](https://dev.to/mandeepm91/how-to-ssh-to-aws-servers-using-an-ssh-config-file-3adn)
...
## [](#what-we-will-do-in-this-tutorial)本教程我们会做什么？
...
### [](#what-are-public-and-private-keys)什么是公钥私钥？
...
### [](#how-to-use-an-ssh-config-file)如何使用 SSH 配置文件
...
### [](#localforward-or-local-port-forwarding)本地转发或本地端口转发
