...
> 原文:[https://dev . to/eon 01/a-gentle-introduction-to-kubernetes-52en](https://dev.to/eon01/a-gentle-introduction-to-kubernetes-52en)
...
## [](#developing-a-trending-git-repositories-api-flask)开发一个趋势 Git 仓库 API (Flask)
...
[![](../Images/4108bcdef6b591f24f3a14a4f7c0248b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vh5KmUFf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/700/0%2AKiSZZKqTjMbJctp2.png)
...
# [](#pushing-the-image-to-a-remote-registry)将镜像推送到远程注册表
...
# [](#installing-minikube)安装 Minikube
...
# [](#deploying-to-kubernetes)部署到 Kubernetes
...
[![](../Images/3bdc0749031888dfff319bd0630c5e65.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vleHQEYZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/700/0%2AmwCXFaN5w0oUBVNk.png)
...
[![](../Images/feac2dfb6d791098f977b61e4a30d599.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tdcchvI5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/700/0%2AnPRugWQwhZ72uINE.png)
...
## [](#inconvenient-of-load-balancer-service)负载均衡服务不方便
...
[![](../Images/3895ee49d4d1f36a100565c9314e2071.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m7EMl-gY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/700/0%2AOlQ6zKtb0jSGz9N5.png)

([照片信用](https://medium.com/google-cloud/kubernetes-nodeport-vs-loadbalancer-vs-ingress-when-should-i-use-what-922f010849e0)

# [](#an-api-gateway)一个 API 网关

Ambassador 是一个开源的 Kubernetes-Native API 网关，构建在 Envoy 代理之上。它为流量管理和应用安全提供了解决方案。它被描述为一个专门的控制平面，将 Kubernetes 的注释翻译成特使配置。

所有流量都由高性能特使代理直接处理。

[![](../Images/a2383739249c49600483a7eaa6216409.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CwrdLGZm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/700/0%2AF_w9BHPSoH-AVplC.png)
...
## [](#edge-proxy-vs-service-mesh)边缘代理 vs 服务网格
...
# [](#accessing-the-kubernetes-api)访问 Kubernetes API
...
## [](#using-an-api-client)使用 API 客户端
...
## [](#accessing-the-api-from-inside-a-pod)从 POD 内部访问 API
