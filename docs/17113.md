...
### [](#automatic-translation-of-c-linq-queries-to-sql-for-efficient-querying)Automatic translation of C# Linq queries to SQL for efficient querying
...
### [](#using-anonymous-objects-to-select-only-the-data-you-need)Using anonymous objects to select only the data you need
...
### [](#using-automappers-projectto-to-load-only-the-data-that-you-want)Using [Automapper's ProjectTo](https://automapper.readthedocs.io/en/latest/Queryable-Extensions.html) to load only the data that you want
...
### [](#explicit-joins-for-mostly-efficient-loading-of-related-data)Explicit joins for (mostly efficient) loading of related data
...
### [](#automated-generation-of-codefirst-migrations)Automated generation of code-first migrations
...
### [](#you-cant-mix-returning-anonymous-objects-and-entity-types)You can't mix returning anonymous objects and entity types
...
### [](#explicit-joins-are-inefficient-when-loading-data-from-many-related-tables)Explicit joins are inefficient when loading data from many related tables
...
### [](#related-entities-can-be-included-unexpectedly-even-with-asnotracking)Related entities can be included unexpectedly even with AsNoTracking()
...
### [](#saving-untracked-entities-is-fraught-with-danger)Saving untracked entities is fraught with danger
...
## [](#might-there-be-a-better-way)Might there be a better way...?
...
### [](#imagining-a-new-api-for-writing-data-to-the-database)Imagining a new API for writing data to the database
...
## [](#what-about-other-orms)What about other ORM's?
