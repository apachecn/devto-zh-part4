...
> 原文:[https://dev . to/gnsp/making-the-flag-of-India-using-pug-and-less-3bdi](https://dev.to/gnsp/making-the-flag-of-india-using-pug-and-less-3bdi)

在这篇文章中，我们将制作印度国旗(三色旗)。作为一个题外话和有趣的事实，许多其他国家的国旗有 3 种颜色，而印度国旗实际上有 4 种颜色。

[![Tricolour](../Images/44601975110109240664a9f36dacee90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DoX2pFw8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jwymep5tm3xvcevmv5vy.png)
...
这是包含我们在这篇文章中讨论的代码的笔。
[https://codepen.io/gnsp/embed/oNveGGj?height=600&default-tab=result&embed-version=2](https://codepen.io/gnsp/embed/oNveGGj?height=600&default-tab=result&embed-version=2)T2】
