...
> 原文:[https://dev . to/julietter/how-to-upgrade-from-react-native-0-57-to-0-59-part-2-upgrading-to-0-59-2921](https://dev.to/julietter/how-to-upgrade-from-react-native-0-57-to-0-59-part-2-upgrading-to-0-59-2921)

[![](../Images/6efd1beb915ff919fc3006634c829a52.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7g2QxAOo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/proxy/1%2Atg4oPcJpJ7dOTE9x0WstQg.jpeg)

#### [](#welcome-to-part-2)欢迎来到第二部分！
...
#### [](#part-2-upgrading-to-react-native-059)第二部分:升级反应原生 0.59 ⬆️
...
#### [](#step-1-update-your-raw-packagejson-endraw-)第一步:更新你的`package.json` ⬆️
...
#### [](#step-3-add-a-new-raw-metroconfigjs-endraw-file)第三步:添加一个新的`metro.config.js`文件🆕
...
#### [](#step-4-update-raw-androidbuildgradle-endraw-)第四步:更新`android/build.gradle` ⬆️
...
#### [](#step-5-update-gradle)第五步:更新格拉德⬆️
...
#### [](#step-6-update-raw-androidappbuildgradle-endraw-)第六步:更新`android/app/build.gradle` ⬆️
...
#### [](#step-7-update-raw-androidgradlew-endraw-and-raw-androidgradlewbat-endraw-)第七步:更新⬆️的`android/gradlew`和`android/gradlew.bat`
...
#### [](#step-8-add-a-new-raw-androidappsrcdebugandroidmanifestxml-endraw-)第八步:添加新的`android/app/src/debug/AndroidManifest.xml`🆕
...
#### [](#step-9-remove-the-system-alert-window)第九步:删除系统提醒窗口🚨
...
#### [](#step-10-update-ios-files)第十步:更新 iOS 文件🍎
...
#### [](#step-11-trim-the-fat)第十一步:修剪肥肉！✂️
...
#### [](#step-12-test-test-test)第十二步:测试，测试，测试🧪
...
[![](../Images/b5f8cf6328455eda24ce1ab4c91d67ce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xelyHLeY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/proxy/1%2AfNFOi-aa-bSLwOMpTy3l1g.png)
