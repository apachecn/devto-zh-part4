...
> 原文：<https://dev.to/pajasevi/my-react-stack-for-2019-486l>
...
# 路由:[反应路由器](https://reacttraining.com/react-router/)
...
### 荣誉奖#1: [clsx](https://github.com/lukeed/clsx)

要连接类名，使用 clsx——它比`classNames`库更快更小。

# 国际化:[react-i18 下一步](https://react.i18next.com/)
...
# 日期时间操作:[卢克森](https://moment.github.io/luxon/)
...
### 荣誉奖#2: [洛达什](https://lodash.com/)

当谈到实用程序库时，我们不能忘记 Lodash。这个库使得以同样的方式处理数据结构、对象和数组变得非常容易。

# API 通信: [Axios](https://github.com/axios/axios) ， [Superagent](https://github.com/visionmedia/superagent)
...
# 表单处理和验证: [Formik](https://jaredpalmer.com/formik/) & [Yup](https://github.com/jquense/yup)
