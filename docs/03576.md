...
> 原文:[https://dev . to/spaghettifunk/part-2-监控-记录-报警-1bc7](https://dev.to/spaghettifunk/part-2-monitoring-logging-and-alarming-1bc7)
...
### [](#problem-2-system-metrics)问题二:系统度量
...
### [](#solution-2-node-exporter)解决方案二:节点导出器
...
### [](#problem-3-application-metrics)问题 3:应用度量
...
### [](#solution-3-prometheus)方案三:普罗米修斯
...
[![Prometheus](img/54c9ca7ff1955f0086ebca3ffa0498ef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4jyTKvqC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://478h5m1yrfsa3bbe262u7muv-wpengine.netdna-ssl.com/wp-content/uploads/2018/08/prometheus_kubernetes_diagram_overview.png)
...
### [](#problem-4-fetching-the-logs)问题 4:获取日志
...
### [](#solution-4-logstash)解决方案 4: Logstash
