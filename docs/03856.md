...
> 原文:[https://dev . to/maciekgrzybek/build-and-deploy-to-NPM-your-react-component-with neutrino-js-little-bits-27o 7](https://dev.to/maciekgrzybek/build-and-deploy-to-npm-your-react-component-with-neutrino-js-little-bits-27o7)
...
### [](#1-create-a-project-yarn-or-npx)1。创建一个项目- yarn 或 npx
...
### [](#2-build-a-component-or-use-the-default-one)2。构建一个组件或使用默认组件
...
### [](#4-prepare-packagejson-file)4。准备 package.json 文件
