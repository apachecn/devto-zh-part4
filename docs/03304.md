...
> 原文:[https://dev.to/hiddewie/creating-a-custom-cycling-map-3g2a](https://dev.to/hiddewie/creating-a-custom-cycling-map-3g2a)
...
#### [](#background-land-use)背景:土地利用

地图的背景将是白色的，覆盖着森林(浅绿色)。

#### [](#contours-and-hillshade)等高线和山体阴影

在背景上，山体阴影将被打印(具有低不透明度)，这样山体变得可见。等高线被添加到其中，这样丘陵和山脉将通过等高线环变得可见。正常的等高线是每隔 20 米，较粗的等高线是每隔 100 米。

[![Hillshade](img/3d4f8d73bdc9a7b5a6c49fab2cf42b90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hB8cvVRx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/efo8qfd5tc93tnrr3zym.png)

#### [](#cities-and-military)城市和军事

山体阴影化后，增加了两种特殊的土地利用类型。城市(有住宅用地)和军事区被特别标明。城市需要在地图上可见:它们为道路网络和名称提供结构。军事区域是平民的禁区。

[![Cities and military](img/a73dc7213631e2afd213cb8eca837ee6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jHbPPJn6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ueofxuxy0z605oomvh7.png)

#### [](#borders)边框

国家的边界需要是可见的。它们具有透明的厚背景，因此在大比例的地图结构中很容易看到。

[![Border](img/768c519968b2a1da1b4e25ee656de7be.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fHrdHjgC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d1nkohmnqoa3o5214khs.png)

#### [](#water)水

水对于全面了解该地区(以及森林地区)非常重要。湖泊为地图提供了结构，溪流和河流也提供了丘陵、山脉和山谷的信息。河流和小溪总是垂直于等高线，平行于山谷。

[![Water](img/b9df5618ef3d284c6a58abf7d7a49119.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6R09yYEr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1s00a8txawv9dhzkhe2b.png)

#### [](#trains)车次

火车轨道显示了大城市和城镇之间的联系。它们在风景中是可见的，因为它们又长又直。车站通常列在路标上。

[![Trains](img/c17c80c8dbd7c6448bb0c18552a1775e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3K1KUYsG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y21dujgpc5hsedx6pxse.png)

#### [](#roads-and-bridges)道路(和桥梁)
...
[![Roads](img/2d53010a2318b71bf01ce4ed0a3e5b30.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SaXJwYk0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fbyi8n7528gq672qhfvq.png)

#### [](#names-of-cities-roads-and-contours)城市、道路和等高线的名称
...
[![labels](img/8544882d854dc7742faf129a14d90cad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YI-6umq0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j4tmhz03cvyu92734zwc.png)

#### [](#places-of-interest-icons)名胜古迹(图标)
...
[![Places of interest](img/5a4af2390a6834b71d54077576045ca1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---hTDit9---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/onf1slnyf20nk670vm2v.png)
...
# [](#scripting-it-all-together)一起编写脚本
...
[![End result](img/9caf1e52dfa2445ce86c5fff0c749405.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xjHpxNNC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ghe904aqf0bdg8ep17i0.png)
