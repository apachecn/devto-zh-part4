...
> 原文:[https://dev . to/terabytetiger/my-documentation-reading-process-3fnn](https://dev.to/terabytetiger/my-documentation-reading-process-3fnn)
...
## [](#the-docs-in-question)有问题的文档

我在这里提到的具体文档是 jQuery 的 [`attr()`函数](https://api.jquery.com/attr/)

## [](#function-keywords)功能关键字

如果你对一个函数的某些部分的具体用词有点不清楚，我不怪你——有很多部分！如果你不确定我在用什么词，需要复习，或者只是喜欢可爱的信息图表，看看韦斯·博斯的这条推文:

> ![unknown tweet media content](../Images/361c9ae005f3590b89f92e910af56648.png)![Wes Bos profile image](../Images/8706e6fb8ba89ac39a1d26bc37d8d75c.png)韦斯博斯[@韦斯博斯](https://dev.to/wesbos)![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)我这里还缺什么吗？我在教授函数时，试图将所有抛出的单词可视化下午 17:07-2019 年 3 月 13 日[![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)](https://twitter.com/intent/tweet?in_reply_to=1105878111609147394)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=1105878111609147394)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=1105878111609147394)

# [](#working-through-the-problem)解决问题
...
## [](#first-pass-at-raw-attr-endraw-)第一次通过`attr()`
...
## [](#back-to-raw-attr-endraw-)回`attr()`
