...
> 原文:[https://dev . to/Evan winter/using-web-workers-in-a-Gatsby-project-3c A8](https://dev.to/evanwinter/using-web-workers-in-a-gatsby-project-3ca8)
...
## [](#add-workerizeloader-to-webpack-bundle)将 workerize-loader 添加到 Webpack 包
