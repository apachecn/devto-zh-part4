...
> 原文:[https://dev . to/Samantha Ming/pad end-string-method-in-JavaScript-3d 24](https://dev.to/samanthaming/padend-string-method-in-javascript-3d24)

[![Code Tidbit by SamanthaMing.com](../Images/1b0575a9d15b1124ac8fcb1a3ca63a7b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LX4zjn78--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a54dhpu49c42kyb5g76u.png)
...
### [](#2nd-parameter-character)第二参数:字符
...
### [](#tabular-format-only-works-with-monospace-font)表格格式仅适用于等宽字体
...
[![Proportional-vs-monospace-v4.jpg](../Images/31edb05719b7002e1d2e222e93028cb1.png)](https://commons.wikimedia.org/wiki/File:Proportional-vs-monospace-v4.jpg#/media/File:Proportional-vs-monospace-v4.jpg) 
...
### [](#watch-out-padend-with-emojis)小心！带表情符号的 padEnd
