...
> 原文:[https://dev.to/mmazzarolo/charles-proxy-automation-1884](https://dev.to/mmazzarolo/charles-proxy-automation-1884)
...
## [](#charles-commandline-options)查尔斯命令行选项
...
## [](#charles-web-interface-and-web-services)查尔斯网络接口和网络服务
...
### [](#getting-a-setting-status)获取设置状态
