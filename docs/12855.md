...
> 原文:[https://dev.to/listnux/fun-with-imagemagick-57d1](https://dev.to/listnux/fun-with-imagemagick-57d1)
...
## [](#imagemagick-commandline-tools)ImageMagick 命令行工具。
...
结果:
[![text logo with imagemagick](../Images/8a9f0103b13a83b8fa07b7f6872ebb44.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eEiFqr_a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rzeezj86n1753s5iff94.png)

## [](#2-resize-images)2。调整图像大小:
...
## [](#3-crop-images-from-center)3。从中心裁剪图像:
...
## [](#5-combine-multiple-images-into-a-gif)5。将多个图像合并成一个 gif:
...
[![gif image from previously downloaded static pictures](../Images/67b0e2080d16b0b1a485fb807902eff3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fbu50Tum--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cgesr1xcfxs8rnsq1bzy.gif)

## [](#6-create-a-gradient)6。创建渐变:
...
[![Gradient created with ImageMagick](../Images/7aa2853988d112ac7780ef028a6afe69.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YgPOJLg8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qo1r7nu5btov1jzivdqp.png)

## [](#7-create-a-text-logo-with-a-3d-effect)7。创建具有 3D 效果的文本徽标:
...
[![text logo with 3D effects](../Images/806ef128144b68c0f80ecc68bfdaccf7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4waJVJeG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d2vjw6o0xitzrbnpx1hd.png)
...
[![star field effect](../Images/a05d72005cdb5b96aeaab4158816355f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vVF8kRSi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f1zh5av0igada6698kp3.png)
