...
> 原文:[https://dev . to/ajkerrigan/fetch-a-bunch-of-AWS-resource-tags-without-be-throttled-4 hhc](https://dev.to/ajkerrigan/fetch-a-bunch-of-aws-resource-tags-without-being-throttled-4hhc)
...
## [](#fetching-tags-simplest-way)抓取标签-最简单的方法
...
## [](#avoiding-api-rate-limits-throttling)避免 API 速率限制/节流
...
## [](#the-resource-groups-tagging-api)资源~~组~~标记 API
