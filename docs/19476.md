...
> 原文:[https://dev.to/bnevilleoneill/what-s-new-in-nuxtjs-2-8-20g1](https://dev.to/bnevilleoneill/what-s-new-in-nuxtjs-2-8-20g1)

[![](../Images/64b8753bc9824f4dc0cf9ae5f1fcee32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TNNJrVXM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uk4sqhseugkqhr5bclrb.png)
...
[![](../Images/18c08ef7b01ce736fb4fcc6a7f0e123f.png)T2】](https://logrocket.com/signup/)

## [](#improvements)改进

在使用 NuxtJS 时，已经做了一些改进来增强开发人员的体验。让我们探索其中的一些。

### [](#ssr-universal-rendering-logs-grouping)SSR(通用渲染)日志分组

从 NuxtJS v2.7 开始，所有 SSR 日志都被报告给浏览器控制台。你不再需要切换屏幕。如下图所示，所有日志的结果都直接显示在浏览器中。

[![](../Images/40c25ba12399a80bcd1bbe16ab8eb920.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E8xGtxKV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i0.wp.com/user-images.githubusercontent.com/904724/57533442-12acec80-733e-11e9-92e9-950718b198ac.gif%3Fssl%3D1)

然而，当你试图一次记录两件或更多事情时，事情会变得很混乱，因为你的浏览器日志会不断地被弄乱。从 NuxtJS v2.8 开始，SSR 日志现在被分组，以避免污染浏览器控制台。

[![](../Images/117f55385e0a4ed56c56bdf5e8918185.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PtCdEqjA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i2.wp.com/user-images.githubusercontent.com/904724/58566291-a3396700-8230-11e9-9dd6-09c3ff8578d2.gif%3Fssl%3D1)

### [](#code-building-indicator-in-the-browser)代码浏览器中的建筑指示器

NuxtJS v2.8 附带的另一个令人兴奋的特性是一个指示器，可以在浏览器中显示新更改的构建状态。

[![](../Images/5dda43dec3fde136e899dc7dfb10845e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wv7FUpwX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i1.wp.com/user-images.githubusercontent.com/904724/58547105-129a6100-8207-11e9-9c61-a93956a17727.gif%3Fssl%3D1)
...
### [](#automatic-detecting-of-page-directory-creation)**自动检测页面目录创建**
...
### [](#simplified-mount-error-logs)**简化挂载错误日志**

在创建应用程序时，大多数时候肯定会出现错误。发生错误时立即看到正确的错误消息将使调试过程更快更容易。从 Nuxtv2.8 开始，当安装应用程序时出现错误时，错误会以开发模式记录到控制台，这样更容易跟踪。

之前:

[![](../Images/2b20443c4ae919afe20ca7340dbc0f3a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gsS8iMy0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/user-images.githubusercontent.com/640208/58495799-ac66fd00-8178-11e9-969f-f80dad9a75e3.png%3Fssl%3D1)

之后:

[![](../Images/eadc1f6888a675d7f11fc04a358298de.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U0Q8caaj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/user-images.githubusercontent.com/640208/58496300-e2f14780-8179-11e9-9923-ebc3b637fb1d.png%3Fssl%3D1)

### [](#improved-lazy-loaded-components)改进的懒惰加载组件
...
### [](#minified-spa-fallback-html-files)**缩小的 SPA 回退 HTML 文件**
...
[![](../Images/09bfb17bd14845fd123f0faf729e9e95.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Bazv2-Qm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/user-images.githubusercontent.com/5158436/57982252-ed179580-7a57-11e9-8e78-79535b92ebb6.png%3Fssl%3D1)
...
<figure>[![](../Images/c65ba863edc56df991c5848c6ca0733f.png)](https://logrocket.com/signup/)
