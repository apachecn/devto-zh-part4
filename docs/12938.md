...
> 原文:[https://dev . to/莎拉 _ 马驰/reverse-a-string-four-JavaScript-solutions-2 nbm](https://dev.to/sarah_chima/reverse-a-string-four-javascript-solutions-2nbm)

*本文最初发表在我的[博客](https://sarahchima.com/blog/reverse-a-string/)T3 上*

反串问题是一个常见的算法问题。在本文中，我们将考虑四种 JavaScript 解决方案。

### [](#a-little-background-info)一点背景信息
...
### [](#solution-1-using-the-array-reverse-method)解 1。使用 array reverse()方法
...
### [](#solution-2-good-ol-forloop)解决方案 2:良好的 Ol' For-loop
...
### [](#solution-3-using-the-arrayreduce-method)解决方案 3 -使用 Array.reduce()方法
...
### [](#solution-4-using-recursion)解决方案 4——使用递归
