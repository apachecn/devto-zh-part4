...
> 原文:[https://dev . to/mydiemho/create-and-deploy-azure-functions-with-server less-20ai](https://dev.to/mydiemho/create-and-deploy-azure-functions-with-serverless-20ai)
...
## [](#install-azure-plugin)安装 Azure 插件
...
#### [](#generate-service-principals)生成服务委托人
...
### [](#test-deployed-functions)测试部署的功能
...
### [](#api-management)[API 管理](https://docs.microsoft.com/en-us/azure/api-management/)
