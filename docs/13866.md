...
> 原文:[https://dev . to/akashkava/JavaScript-typescript-async-tips-108 o](https://dev.to/akashkava/javascript-typescript-async-tips-108o)

请随意添加更多提示。

# [](#do-not-create-async-if-only-last-return-statement-has-await)如果只有最后一条 return 语句有 await，则不创建异步
...
# [](#do-not-omit-raw-asyncawait-endraw-when-catching-exceptions)捕捉异常时不要省略`async/await`...
...
# [](#use-raw-promiseall-endraw-)使用`Promise.all`
...
## [](#you-can-use-raw-promiseall-endraw-without-an-array-as-well)你也可以在没有数组的情况下使用`Promise.all`
...
# [](#combining-delay-with-cancellation)延迟与取消相结合
...
## [](#api-call-needs-some-work-given-an-example-with-xmlhttprequest)Api 调用需要一些工作...举一个 XmlHttpRequest 的例子
...
# [](#for-best-use-you-can-combine-all-tips-and-create-best-ux)为达到最佳使用效果，您可以组合所有提示并创建最佳 UX。