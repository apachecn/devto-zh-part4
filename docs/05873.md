...
> 原文:[https://dev . to/hasura HQ/join-identity-data-from-okta-with-postgres-using-hasura-remote-joins-3 agj](https://dev.to/hasurahq/join-identity-data-from-okta-with-postgres-using-hasura-remote-joins-3agj)
...
[![](../Images/ca073e58a2417e919a66c587a2f8ae55.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--91kEF6cm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/content/images/2019/08/okta-remote-joins.png)
...
[![](../Images/66a5698318f008986542b52ca82ef4b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Uoz2Omje--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/content/images/2019/08/create-table-users.png)

## [](#adding-okta-api-as-remote-schema)添加 Okta API 作为远程模式

为了能够通过 Hasura 查询 Okta 数据，需要使用 Hasura 控制台将其添加为`Remote Schema`。

### [](#deploy-custom-resolver)部署自定义解析器

[![](../Images/0bbe47db71628974bb6c039604762110.png)T2】](http://glitch.com/edit/#!/import/github/praveenweb/okta-remote-schema)
...
[![](../Images/e8a8cb608826cbd02c31bca3e2abf4e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UUz_qinG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/content/images/2019/08/okta-add-remote-schema.png)

现在让我们添加名为`userInfo`的远程关系

[![](../Images/a7a7ce7e4ea328bd0ed3393b28d40197.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eETILTV7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/content/images/2019/08/okta-remote-relationship.png)
