...
> 原文:[https://dev . to/lewish/building-a-typescript-monorepo-with-bazel-4o7n](https://dev.to/lewish/building-a-typescript-monorepo-with-bazel-4o7n)
...
## [](#all-your-code-in-one-repo)一次回购你的所有代码
...
## [](#a-basic-bazel-ts-rule)一个基本的巴泽尔 TS 法则
...
## [](#dependencies-between-packages)包之间的依赖关系
...
## [](#managing-multiple-packages)管理多个包
...
## [](#building-npm-packages)建筑 NPM 套餐
...
## [](#publishing-npm-packages)发布 NPM 套餐
