...
> 原文:[https://dev . to/morin oko/adding-custom-JavaScript-in-rails-6-1ke 6](https://dev.to/morinoko/adding-custom-javascript-in-rails-6-1ke6)
...
# [](#method-1-create-a-custom-directory-and-require-it-in-raw-applicationjs-endraw-)方法一:创建自定义目录，并在`application.js`中要求
...
# [](#method-2-add-custom-javascipt-within-the-raw-appjavascriptpacks-endraw-directory)方法二:在`app/javascript/packs`目录下添加自定义的 JavaScipt
...
# [](#method-3-using-raw-javascriptpacktag-endraw-for-separate-javascript-files-packs)方法三:使用`javascript_pack_tag`进行单独的 JavaScript 文件(包)
