...
> 原文:[https://dev . to/gualtierofr/examples-of-property-wrappers-15pb](https://dev.to/gualtierofr/examples-of-property-wrappers-15pb)
...
### [](#getting-remote-entities)获取远程实体
