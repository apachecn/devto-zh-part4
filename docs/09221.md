...
> 原文:[https://dev.to/katzueno/auto-git-deploy-php-script-2djc](https://dev.to/katzueno/auto-git-deploy-php-script-2djc)
...
# [](#how-to-set-it-up)如何设置

## [](#1-set-up-git)1。设置 git

准备好你的 git 回购

## [](#2-setup-server)2。设置服务器
...
## [](#3-git-clone-to-the-server)3。Git 克隆到服务器
...
### [](#separate-git-directory-and-work-directory-more-secure)将 Git 目录和工作目录分开(更安全)
...
## [](#3-set-your-config-amp-upload-the-file)3。设置你的配置&上传文件
...
## [](#4-setup-a-webhook-and-test-drive)4。设置 webhook 并进行试驾
