...
> 原文:[https://dev . to/spygi/recipes-for-scalable-cost-effect-web-apps-in-heroku-with-NPM-nodejs-2 CNG](https://dev.to/spygi/recipes-for-scalable-cost-effective-web-apps-in-heroku-with-npm-nodejs-2cng)

我正在使用 Heroku 部署一个 web 应用程序。该应用程序是作为一个 MVP 开始的，在真正的用户使用它之前，我希望部署尽可能便宜和简单，但面向未来。

[![](../Images/c7f6c385c8b800bf442e34ddf8fc2031.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lc3hpVeC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jhf75ivlcsa1oi15euet.png)
...
## [](#some-heroku-basics%C2%A0first)先来点英雄本色
...
### [](#things-i-tried-that-dont%C2%A0work)我尝试过但不起作用的方法
...
### [](#the-heroku-way-async%E2%80%8A%E2%80%8Acould-work)英雄(？)方式(异步)-可以工作
...
## [](#what-actually%C2%A0works)究竟是什么在起作用

### [](#1-the-manual-way%E2%80%8A%E2%80%8Awithout-independent-deployment)1。“手动”方式——没有独立部署
...
#### [](#2-the-multiprocfile-way)2。多文件方式
...
[![Spyros Giannakakis](../Images/61a4838f420b6a3b8e6d29cf21bb5d27.png)](https://medium.com/@spygi/scalable-cost-effective-web-architectures-for-heroku-eb8f1f55a4b6) [## Heroku 中具有 npm、NodeJS 的可扩展、经济高效的 web 应用程序的配方| Spyros Giannakakis | Medium
