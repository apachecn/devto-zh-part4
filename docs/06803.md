...
> 原文:[https://dev.to/fosteman/kid-s-to-do-redux-1ma](https://dev.to/fosteman/kid-s-to-do-redux-1ma)
...
## [](#step-1-begin-with-creating-react-app)第一步:从创建 React 应用开始
...
## [](#step-2-redux-instance)第二步:还原实例
...
## [](#step-3-components)第三步:组件

### [](#-raw-todoapp-endraw-)`TodoApp`
