...
> 原文:[https://dev . to/Mustapha/angular-unit-testing-101-with-examples-6mc](https://dev.to/mustapha/angular-unit-testing-101-with-examples-6mc)
...
# [](#angular-automated-testing)角度自动化测试

### [](#skeleton-of-a-test)骨骼的一种测试
...
### [](#configuration-amp-instantiation)配置&实例化
...
#### [](#dealing-with-http-requests)处理 HTTP 请求
...
#### [](#dealing-with-the-angular-router)处理角路由器
...
#### [](#dealing-with-asynchronous-code)处理异步代码

值得注意的是，自从我写这篇文章以来，已经有了新的和改进的方法来测试异步代码。我将在以后的文章中回到这个主题。

##### [](#dealing-with-promises)处理承诺
...
##### [](#dealing-with-observables)处理可观测量
...
[![conclusion](../Images/1e831e5bc7167230fc0cb167729f0e27.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BOGLk7jq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://media0.giphy.com/media/xT1R9UtRPsEyItf0je/giphy.gif%3Fcid%3D790b7611d1a17646f51dfeda549ffb343e0d345e19f7c418%26rid%3Dgiphy.gif)
...
[![mustapha](../Images/6bdfdf3b2211f22eadcf26ba89e0b921.png)](/mustapha) [## Angular:用 ngTemplateOutlet 构建更多动态组件🎭
