...
> 原文:[https://dev.to/neilberg/leaping-into-linked-lists-3876](https://dev.to/neilberg/leaping-into-linked-lists-3876)
...
[![linked list schematic](../Images/5ee407300835c5f242da3f7a3d631dd0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eA_dT6GL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/10oy6n74yyeeosxhcgli.png)

#### [](#creating-node-and-singlylinkedlist-classes)创建 Node 和 SinglyLinkedList 类
...
#### [](#adding-node-at-index-k)在索引处添加节点 *k*
...
#### [](#removing-nodes-at-index-k)删除索引处的节点 *k*
...
[![doubly linked list schematic](../Images/a0feabb40890328fbb5bd02eaba48beb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--giXTWeQX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ss577krhrgc8d054z72w.png)

#### [](#creating-node-and-doublylinkedlist-classes)创建节点和双链接列表类
...
#### [](#adding-nodes-at-the-head)在头部添加节点
...
#### [](#addings-nodes-at-the-tail)在尾部添加节点
...
#### [](#adding-nodes-at-index-k)在索引处添加节点 *k*
...
#### [](#adding-nodes-at-an-element)在一个元素上添加节点
...
#### [](#removing-nodes-at-the-head)去除头部节点
...
#### [](#removing-nodes-at-the-tail)删除尾部节点
...
#### [](#removing-nodes-at-target-element)删除目标元素处的节点
