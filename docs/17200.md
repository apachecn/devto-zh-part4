...
> 原文:[https://dev.to/gemhar/var-let-and-const-decoded-30k2](https://dev.to/gemhar/var-let-and-const-decoded-30k2)
...
## [](#so-when-should-we-use-var-let-or-const-)**那么什么时候应该用 *var* ， *let* 或者 *const* ？**
...
### [](#the-popular-and-as-well-as-my-opinion-is-that-)这个流行和我一样的看法是:
