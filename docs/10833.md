...
> 原文:[https://dev . to/lambdatest/top-8-JavaScript-automation-testing-frameworks-in-2019-32dk](https://dev.to/lambdatest/top-8-javascript-automation-testing-frameworks-in-2019-32dk)
...
[![](../Images/6b9f45569abc4792bc8db7a76a4feb61.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IvFah3vb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AugFiM20m0MB8u00yOpxZig.jpeg)
...
[![](../Images/19f537c37426d7e7d5a4d6f8110b4001.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QQ3bu155--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2110/1%2A_C4fQm1EsrCDSp-KYVWUXQ.png)
...
## [](#what-makes-jest-a-popular-javascript-automation-testing-framework)是什么让 Jest 成为流行的 JavaScript 自动化测试框架？
...
[![](../Images/5f5fc783378a4045734b61e81cc1b3e1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HR1tf8Op--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A45OCfuJKnrgoDw680gfu5w.png)

Mocha 是一个 **JavaScript 测试框架**，旨在测试使用 Node.js 运行的应用程序。Mocha 被评为 2018 年 stateofjs 调查中排名第二的 JavaScript 自动化测试框架。

[![](../Images/f96d61195094cf60f5b801223249cc6a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lMwhW0PC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2100/1%2AxnjRPBgkNG8kvQuXDSRNwA.png)
...
## [](#what-makes-mocha-a-popular-javascript-automation-testing-framework)是什么让 Mocha 成为流行的 JavaScript 自动化测试框架？
...
## [](#areas-where-mocha-can-do-better)摩卡可以做得更好的领域！
...
[![](../Images/f1ddb241c89934352f77a727e4337254.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4MwJ-Vwo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/3040/1%2ApjjzxtNc4Ah1dU89QcfZHA.jpeg)
...
[![](../Images/51cf3e2452afca05136dd357bd588027.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P_7p0MpM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2066/1%2AuI7Lf9K7ekieThOjD5KVbQ.png)
...
## [](#what-makes-jasmine-a-popular-javascript-automation-testing-framework)是什么让 Jasmine 成为流行的 JavaScript 自动化测试框架？
...
## [](#areas-where-jasmine-can-do-better)茉莉可以做得更好的领域！
...
[![](../Images/0a20b2143e5ff91773461dff987a293d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FrcyBjHK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2100/1%2AHQeDb4KYQML3tK___tgPYA.jpeg)
...
## [](#what-makes-nightwatch-a-popular-javascript-automation-testing-framework)是什么让 Nightwatch 成为流行的 JavaScript 自动化测试框架？
...
## [](#areas-where-nightwatch-can-do-better)夜巡可以做得更好的领域！
...
[![](../Images/2f1b8d17b5e946aee7cedecf11112eee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f6cs43RD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A8FualX4XQbOUJDrg8yQAjQ.jpeg)
...
## [](#what-makes-protractor-a-popular-javascript-automation-testing-framework)是什么让量角器成为流行的 JavaScript 自动化测试框架？
...
## [](#areas-where-protractor-can-do-better)量角器可以做得更好的地方！
...
## [](#is-protractor-the-best-javascript-automation-testing-framework-for-you)量角器是不是最适合你的 JavaScript 自动化测试框架？
...
## [](#6-selenium-webdriver)6。Selenium Webdriver

[![](../Images/aed926e3e05dbd500ffad24794b1d5aa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--khPUgWTi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A-yauD1PxgsdiOJQMqnmu1w.jpeg)
...
## [](#what-makes-selenium-a-popular-javascript-automation-testing-framework)是什么让 Selenium 成为流行的 JavaScript 自动化测试框架？
...
## [](#areas-where-selenium-can-do-better)硒可以做得更好的领域！
...
## [](#7-puppeteerlibrary)7。木偶师(图书馆)

[![](../Images/0528f746d327e7c8b93de7636b9519ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a5JkNlzj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A7FpVClFKd_D_Wu9pzL8eTw.png)
...
## [](#what-makes-puppeteer-so-popular)是什么让木偶戏如此受欢迎？
...
## [](#8-karmatest-runner)8。Karma(试跑者)

[![](../Images/0faa99942a7460c548832eeb4479588e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--gHUFsELh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A-lBRfNcY9yr53I9RkbbcRw.png)

[![](../Images/57d5ee946a65c8c535359a1125a5c3fa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LrTI6L5_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2156/1%2A0yN9Hs293XTNhrK0m60iJQ.png)

Karma 的开发是为了给开发者带来一个测试环境。一个他们不必太担心配置的环境。他们只能编写代码，并从测试用例中立即获得反馈。

## [](#prerequisites-for-installation)安装先决条件
...
## [](#what-makes-karma-so-popular)是什么让因果报应如此流行？
...
## [](#areas-where-karma-can-do-better)因果报应可以做得更好的领域！

令人惊讶的是，使用因果报应并没有什么明显的缺点。

## [](#should-you-use-karma)该不该用因果报应？

目前，Karma 被认为是最好的 JS 框架之一。与 Jest 相比，Jest 有许多未修复的错误，并且不支持。本机环境中的 mjs 文件。甚至，一个错误有多个 Jest 错误消息。然而，这些问题在业力中并不存在。

## [](#9-cypress)9。柏树

[![](../Images/8cb2736899c8ce01873e9476fa8625ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1YYp0bMd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A21LLjXL8vgr9OsQRuFlSFA.png)

Cypress 是为现代网络构建的下一代前端测试工具。使用 Cypress，开发人员可以编写端到端测试、集成测试和单元测试。Cypress 基于 JavaScript——流行的前端语言，只支持 Mocha JS 框架。

[![](../Images/d7a25e77a9f5071dd14825edd50f2c3f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pe5lFc2w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2252/1%2Aqp-Z6SVGhJ0k44QpWq3TvA.png)
...
## [](#areas-where-cypress-can-do-better)柏树可以做得更好的领域！
