...
> 原文:[https://dev . to/MBO gan/better-logging-for-lambda-functions-3db](https://dev.to/mbogan/better-logging-for-lambda-functions-3db)
...
## [](#logging-is-essential-for-serverless-functions)日志记录对于无服务器功能至关重要
...
## [](#you-need-more-than-aws-cloudwatch)你需要的不止是 AWS CloudWatch
...
## [](#using-papertrail-with-aws)通过 AWS 使用 Papertrail
...
## [](#logging-and-debugging-a-lambda-function)记录和调试一个 Lambda 函数

让我们来看看我们的 Lambda 函数。我们的函数是用 Node.js 写的，检索比特币的最新价格。

[![](../Images/5a66260c68a907126cfb88e1b65b7911.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5jsNP-B6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ftjdhkwtwwtmjsbpoclh.png)
...
[![](../Images/02f87ffec49c2405b1e85801f944834a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2X8_OFhz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l3ckj92kp2h6egl18mwn.png)

现在让我们使用 [live tail mode](https://papertrailapp.com/solution/tail-log-files/) 来重新部署和监控我们的日志，这样我们就可以实时看到当用户调用我们的代码时发生了什么。

[![](../Images/6313969bda5c0fe5cf8f0111eccb3303.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jisANbmt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t2ak1jnfwwqjpr1v88ug.png)*paper trail-Live Tail View*
...
## [](#proactively-monitor-with-papertrail-alerts)通过纸质跟踪警报进行主动监控
...
[![](../Images/4fb74ee71f275a26f5c705785aad9304.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6T02lVhx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1ngl2j2oibuv3oxrnyca.png)*paper trail–预警配置*

现在，我们输入警报的详细信息并保存。

[![](../Images/c2592ded482045c893183c5d48b0f0f5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ey6pMsqX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9cl267c06xsejlyl4xmq.png)*paper trail–预警配置*
