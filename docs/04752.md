...
> 原文:[https://dev . to/kapantzak/creating-the-typewriter-effect-with-use-of-async-generators-5f1e](https://dev.to/kapantzak/creating-the-typewriter-effect-with-the-use-of-async-generators-5f1e)
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) [卡潘扎克](https://github.com/kapantzak) / [文本输入](https://github.com/kapantzak/text-typing)

### 简单打字效果

<article class="markdown-body entry-content container-lg" itemprop="text">

[![npm version](../Images/bd85e2d3961a5128bff768ce6703263a.png)T2】](https://badge.fury.io/js/text-typing)

# 文本打字

一个创建打字机效果的工具，有一个简单的，基于承诺的 api。

[![text-typing gif](../Images/612d472630e90b391c25e811df4b6c4a.png "text-typing")T2】](https://github.com/kapantzak/text-typingimg/text-typing.gif?raw=true)
