...
## [](#separando-os-arquivos-do-componente-calculadoravue)从‘calculator . view’组件中分离文件
...
[![Screen-Shot-06-20-19-at-07-24-PM.png](img/22d264cc66245b5aa8d7554de80f2eb5.png)T2】](https://postimg.cc/zVYmKNJ2)

完成后，我们现在将执行文件分离。

## [](#realizando-a-separa%C3%A7%C3%A3o-do-bloco-style)进行风格块分离
...
## [](#realizando-a-separa%C3%A7%C3%A3o-do-bloco-script)进行脚本块分离
...
## [](#finaliza%C3%A7%C3%A3o-do-desenvolvimento-do-arquivo-indexvue)完成‘index . view’文件的开发
