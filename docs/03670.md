...
> 原文:[https://dev . to/gnsp/making-a-neon-clock-using-react-hooks-mei](https://dev.to/gnsp/making-a-neon-clock-using-react-hooks-mei)

### [](#a-little-bit-of-backstory)一点点背景故事
...
## [](#the-clock-making)时钟制作

下面是它的样子(我们将在本文中构建的时钟)

[![The Neon Clock](img/b5668ecaa787276a3200e05c67042372.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--50I_h2Xm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z46kdigs0x6hr5zh38kn.png)
...
### [](#scaffolding-the-page-in-pug)在帕格身上搭起了书页
...
### [](#writing-the-application-in-javascript)用 Javascript 编写应用程序

#### [](#getting-the-time-and-reading-it-out)获取时间并读出
...
#### [](#rendering-the-clock-and-readout-components)渲染时钟并读出组件
...
#### [](#the-roman-numerals-on-the-dial)表盘上的罗马数字
...
#### [](#placing-and-rotating-the-hands)放置并旋转双手
