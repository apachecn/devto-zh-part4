...
> 原文:[https://dev . to/samjakob/automatically-build-your-flutter-app-apks-with-Travis-ci-4ha 0](https://dev.to/samjakob/automatically-build-your-flutter-app-apks-with-travis-ci-4ha0)
...
## [](#step-1-create-travis-configuration)第一步:创建 Travis 配置
...
## [](#step-2-upload-the-finished-build-to-wetransfer)步骤 2:将完成的构建上传到 WeTransfer

[![WeTransfer Upload Screen](../Images/f6e0b4ced17657c91edac63155158734.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JDXj-qrj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1628740457513/iVceJnS1f.png)
...
## [](#step-3-execute-pre-and-post-build-webhooks)步骤 3:执行预构建和后构建 web-hooks

[![We have web-hooks that send a message to a channel in our Discord server when a build has started or ended.](../Images/f7b4ec30f1612617e445f6f11927535a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3fKBTLrv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1628740459500/K-Rm5aCiN.png) 
