...
> 原文:[https://dev . to/yaw pitch/the-35-words-you-need-to-python-13pe](https://dev.to/yawpitch/the-35-words-you-need-to-python-13pe)

## [](#in-the-beginning-were-pythons-keywords)在一开始是 Python 的关键词
...
### [](#first-some-conventions)首先，有些约定俗成
...
## [](#on-to-the-keywords)对着关键词

### [](#one-that-does-nothing)一事无成的人
...
### [](#three-for-making-decisions)三为决策
...
### [](#five-that-are-operators)五即符

接下来的五个关键字都像一个操作符，表示对对象和/或表达式执行的操作。

#### [](#boolean-logic-operators)布尔逻辑运算符
...
#### [](#identity-checking-operators)身份检查操作员
...
#### [](#membership-testing-operators)成员资格测试操作员
 ...
 *##### [](#looping-through-the-members-of-a-collection)循环遍历集合的成员
...
### [](#three-for-importing-other-things)三个用于导入其他东西
...
### [](#five-for-exceptional-situations)五为例外情况
...
#### [](#to-signal-that-theres-a-problem)表示有问题
...
#### [](#to-signal-that-a-particular-condition-is-not-met)表示不满足特定条件
...
#### [](#to-catch-a-signal-and-react-to-it)捕捉信号并对其作出反应
...
### [](#four-for-writing-functions)四位为书写功能
...
#### [](#anonymous-unnamed-functions)匿名(未命名)函数
...
##### [](#stop-the-function-and-give-back-a-value)停止功能并返回一个值
...
##### [](#pause-the-function-and-give-back-a-value)暂停功能并返回一个值
...
### [](#three-for-manipulating-namespaces)三个用于操纵名称空间
...
#### [](#write-to-the-top-from-anywhere)从任何地方写到最上面
...
#### [](#write-to-the-parent-from-the-child)从子写给父
...
### [](#one-for-defining-new-types-of-object)一个用于定义新类型的对象
...
### [](#one-for-working-within-a-context)一个用于在上下文中工作
...
### [](#and-finally-two-for-working-asynchronously)最后…两个异步工作
