...
> 原文:[https://dev . to/coly 010/using-message format-with-transloco-30em](https://dev.to/coly010/using-messageformat-with-transloco-30em)

# [](#guitar-using-messageformat-with-transloco)🎸通过 Transloco 使用 MessageFormat
