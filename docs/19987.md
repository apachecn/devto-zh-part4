...
> 原文:[https://dev . to/zenith ar/how-I-write-micro-service-part-3-h0p](https://dev.to/zenithar/how-i-write-micro-service-part-3-h0p)
...
# [](#persistence-implementations)持久性实现
...
### [](#schema-migrations-handling)模式迁移处理
...
### [](#user-persistence-adapter)用户持久性适配器
...
### [](#squad-persistence-adapter)小队持续适配器
