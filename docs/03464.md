...
> 原文:[https://dev . to/codingcatdev/adding-angular-components-to-your-static-site-43jk](https://dev.to/codingcatdev/adding-angular-components-to-your-static-site-43jk)
...
## [](#why-angular-components)为什么有角分量

我需要增加对 https://AJonP.com 的付款，这样我们就可以开始支持更长的课程教程。所以我在 Twitter 上发起了一个投票，看看我们应该用什么来构建 web 组件。

[![Twitter Poll](img/0cbaca68f9933304f68570656a23d294.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NL5O2WVs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ajonp/image/upload/h_800%2Cq_auto/v1568114418/ajonp-ajonp-com/blog/xfjzcgib93wjghj5a5a6.webp)
