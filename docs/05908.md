...
> 原文:[https://dev . to/quickly _ react/what-is-graph QL-and-how-to-use-with-react-js-part-2-26lh](https://dev.to/quickly_react/what-is-graphql-and-how-to-use-with-react-js-part-2-26lh)

[![intersections part 2](../Images/27b967429334106cc65ba4b86b7033ed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q9JSd6zN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.unsplash.com/photo-1558131716-fe15c66cb56f%3Fixlib%3Drb-1.2.1%26ixid%3DeyJhcHBfaWQiOjEyMDd9%26auto%3Dformat%26fit%3Dcrop%26w%3D968%26q%3D80)

欢迎回来！

[![we are back](../Images/c072c9c8687d1040172e63c2f65b92c1.png)T2】](https://i.giphy.com/media/ASd0Ukj0y3qMM/source.gif)

在我们上一篇[文章](https://dev.to/what-is-graphql-part-1/)中，我们讨论了什么是 GraphQL 以及它是如何工作的。在这一部分中，我们将了解如何将 GraphQL 与 API 包装一起使用。

## [](#how-to-use-graphql-with-api-wrappers)如何将 GraphQL 与 API wrappers 一起使用？

GraphQL 也有两个 API 包装器的实现:

1.  **服务器端**:

[![server wrapper](../Images/39cc217c4d271b5ef084b14feb5a7fb5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RTNZM2YS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./s_w.png)
...
[![here we go](../Images/d06f3b62af8867c440534caa0cbabbee.png)T2】](https://i.giphy.com/media/dujg3dNjrf119zBXYD/source.gif)
...
[![post titles](../Images/9e9a5383b4464d571446c39009eee894.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NYI5Qpnk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./posts.png)

-列出`id:1`的帖子详细信息

[![post](../Images/e775b18f7ee19a185be094f624290067.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wA--G0uH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./post.png)
...
[![its done](../Images/43c5bcacccc466c356a9b2ae3ca9cca7.png)T2】](https://i.giphy.com/media/oxdVsTscIKUwg/giphy.gif)

希望您对 GraphQL 的服务器端包装器的工作原理有所了解。

1.  **客户端包装器**

[![server wrapper](../Images/de5dd1c4506d90a3575f21d275d6ef67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8JZ3S7qA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./c_w.png)
...
[![Lets go](../Images/02383c167027b1ed8ed0eac27daf3e5b.png)T2】](https://i.giphy.com/media/3o7TKUM3IgJBX2as9O/giphy.gif)
...
[![party](../Images/206348fa3db1bf1df1885496e1f21879.png)T2】](https://i.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif)