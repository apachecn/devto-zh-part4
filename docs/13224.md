...
> 原文:[https://dev . to/danvoyce/locally-reward-location core-nem-17pb](https://dev.to/danvoyce/locally-reward-locationcore-nem-17pb)
...
## [](#trusted-nis-servers-mobile-applications-and-private-keys)可信 NIS 服务器、移动应用和私钥
...
## [](#how-are-users-rewarded-and-what-data-is-accepted)用户如何获得奖励，接受哪些数据？
