...
> 原文：<https://dev.to/irfaan008/suggestion-needed-generate-complex-pdf-using-puppeteer-28h5>

虽然 chrome headless 是市场上最好的选择，它提供了用于生成 PDF、屏幕截图或几乎任何 chrome 可以做的事情的开源标签。我试着用它在我的 HTML 中生成 PDF。

这就是我想要的最终输出
[![header](img/957029b431ef43101681d430b691929b.png)](https://ibb.co/BLSbTG7) 

第二页:
[![page2](img/7274d0011a82357daf8e2caa29cccc87.png)](https://ibb.co/48gKz5G)
...
1.  边框断开，不尊重页面。这里我没有设置单独的页眉模板，因此没有收到第二页的页眉。
    [![Screenshot-2019-07-20-at-2-11-27-AM](img/47d655cbefe6d72d8c9c9bbc01c7d365.png)T3】](https://ibb.co/3mbY6LN)

2.  如果我单独设置页眉模板，那么边框的行为会很奇怪。它在标题模板完成后开始

[![Screenshot-2019-07-20-at-2-13-53-AM](img/0d7b75d49c647343aa70517fed14dbda.png)](https://ibb.co/QQrTK1P)
