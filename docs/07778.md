...
> 原文:[https://dev . to/iggredible/JavaScript-start-using-memo ization-to-reduce-computing-time-5cjk](https://dev.to/iggredible/javascript-start-using-memoization-to-reduce-computing-time-5cjk)
...
[![tearful cry](../Images/1e924b34d226682d890958e9e3d5a15e.png)T2】](https://i.giphy.com/media/qQdL532ZANbjy/giphy.gif)

我们能做些什么来缩短这样一个昂贵的函数吗？

# [](#enter-memoization)进入记忆状态
...
# [](#how-do-we-use-memoization-on-fibonacci)我们如何在斐波那契上使用记忆化？
...
# [](#how-does-memoization-works)记忆化是如何工作的？
...
# [](#sweet-i-am-going-to-memoize-every-function-in-sight)甜！我要记住我看到的每一个功能！
...
# [](#thats-nice-but-we-probably-would-never-use-fibonacci-in-real-life-is-there-an-example-of-real-life-use-of-memoization)真好。但是我们可能永远不会在现实生活中使用斐波那契数列。有记忆化在现实生活中应用的例子吗？
