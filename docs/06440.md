...
> 原文:[https://dev . to/hrbrmstr/polyglot-fizz buzz-in-r-plus-why-can-t-Johnny-code-4k9n](https://dev.to/hrbrmstr/polyglot-fizzbuzz-in-r-plus-why-can-t-johnny-code-4k9n)
...
### [](#the-aforementioned-weeds)前述“野草”
...
说结果是 [![🤷🏻‍♀️](../Images/c893ca48c63a24d3b56c18273258ac65.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rf_ZQSRL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/12.0.0-1/72x72/1f937-1f3fb-200d-2640-fe0f.png) 因为这是一个玩具例子，但我想表明耶鲁安的{V8}可以超级快，特别是当没有值编组要做，有些事情你可能认为应该更快，不是。
