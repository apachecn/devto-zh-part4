...
> 原文:[https://dev . to/jamesmh/building-a-net-core-scheduled-job-worker-service-376h](https://dev.to/jamesmh/building-a-net-core-scheduled-job-worker-service-376h)
...
# [](#worker-service-template)工人服务模板
...
# [](#configuring-coravel)配置 Coravel
...
# [](#scheduling-your-invocable)调度您的可调用
...
# [](#configuring-as-a-windows-service)配置为 Windows 服务
