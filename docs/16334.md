...
> 原文:[https://dev . to/Mike born/cf script-gotchas-and-syntax-guides-4j0o](https://dev.to/mikeborn/cfscript-gotchas-and-syntax-guides-4j0o)
...
## [](#using-the-assignment-operator-instead-of-equality-operator)使用赋值运算符而不是相等运算符
...
## [](#cfscript-syntax-guides)CFScript 语法指南
