...
> 原文:[https://dev . to/jasterix/3-JavaScript-snippets-to-get-you-started-1lh](https://dev.to/jasterix/3-javascript-snippets-to-get-you-started-1lh)
...
#### [](#add-api-objects-to-dom)向 DOM 添加 API 对象
...
#### [](#add-event-handler-to-delete-item-from-dom-on-click)添加事件处理程序，点击时从 DOM 中删除项目
