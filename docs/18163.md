...
> 原文:[https://dev . to/jackharner/sick-console-bro-how-to-style-your-console-log-with-CSS-198 l](https://dev.to/jackharner/sick-console-bro-how-to-style-your-console-log-with-css-198l)
...
[![](../Images/b50078a4e75d841136884a383d147b25.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IFc6TpQW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://harnerdesigns.com/wp-content/uploads/2019/06/styled-console-update.png)

## [](#styling-multiple-strings-in-one-log)在一个日志中样式化多个字符串
...
## [](#reusing-styles-across-log-messages)跨日志消息重用样式
