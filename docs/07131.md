...
> 原文:[https://dev . to/ba weaver/decorating-ruby-part-three-prepending-decoration-1 ehc](https://dev.to/baweaver/decorating-ruby-part-three-prepending-decoration-1ehc)
...
# [](#what-does-prepending-look-like)前置是什么样子的？
...
# [](#decorating-with-prepend)用前置装饰

再一次，我们需要知道一些事情，并冒险深入元编程的兔子洞几米。

## [](#modules-on-the-fly)模块在飞
...
## [](#the-classy-metaprogramming-extraordinaire)卓越的元编程
...
## [](#but-what-about-method-added)但是关于方法的补充呢？
