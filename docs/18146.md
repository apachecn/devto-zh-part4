...
> 原文:[https://dev . to/generally 23/linear-searching-algorithm-in-JavaScript-g76](https://dev.to/generally23/linear-searching-algorithm-in-javascript-g76)

# [](#naive-linear-searching-approach)朴素线性搜索法

## [](#first-what-is-linear-search)首先什么是线性搜索？
