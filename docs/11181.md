...
> 原文:[https://dev . to/iuriimednikov/a-bit-about-marker-interfaces-in-Java-b1e](https://dev.to/iuriimednikov/a-bit-about-marker-interfaces-in-java-b1e)
...
## [](#what-is-a-marker-interface)什么是标记接口？
...
## [](#marker-interfaces-vs-annotations)标记接口与注释
