...
> 原文:[https://dev . to/peterj/how-to-get-started-with-kubernetes-and-minikube-basics-1 他](https://dev.to/peterj/how-to-get-started-with-kubernetes-and-minikube-basics-1ohe)
...
## [](#managing-your-minikube-cluster)管理您的 Minikube 集群
...
## [](#interacting-with-your-kubernetes-cluster)与您的 Kubernetes 集群互动
