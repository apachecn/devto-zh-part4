...
> 原文:[https://dev . to/brob/creating-an-11ty-plugin-SVG-embed-tool-4k 58](https://dev.to/brob/creating-an-11ty-plugin-svg-embed-tool-4k58)
...
## [](#what-is-an-11ty-plugin)什么是 11ty 插件？
...
## [](#new-plugin-embed-an-svg-from-a-file)新插件:从文件中嵌入一个 SVG
...
## [](#creating-a-plugin-for-11ty)为 11ty 创建插件
...
## [](#installation-of-the-plugin)安装插件

### [](#1-install-the-package)1。安装软件包
...
### [](#2-require-the-package-in-our-config-file)2。需要我们的配置文件中的包
...
### [](#4-use-the-filter-in-our-templates)4。使用我们模板中的过滤器
