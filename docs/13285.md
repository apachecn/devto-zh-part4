...
> 原文:[https://dev.to/romainlanz/deploy-your-adonis-website-17ec](https://dev.to/romainlanz/deploy-your-adonis-website-17ec)
...
## [](#step-1-create-a-server)第一步:创建服务器
...
[![Digital Ocean interface to create a VPS](../Images/a7bc194d23031b25c809238dad5e8625.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nd5hy6LI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/RomainLanz/slynova.io/master/content/posts/images/create-droplets.png)

默认情况下，您可以保留其他设置，确保选择靠近您的目标受众的区域。

## [](#step-2-secure-your-server)第二步:保护您的服务器
...
### [](#change-the-root-password)更改 root 密码

键入命令`passwd`并将密码改为长而复杂的形式。当你在你的服务器上工作时，你不需要记住它。把它存放在安全的地方。

### [](#update-your-server)更新你的服务器
...
## [](#step-3-create-a-deploy-user)第三步:创建部署用户
...
## [](#step-4-install-required-dependencies)第四步:安装所需的依赖项
...
## [](#step-5-deploy-your-application)步骤 5:部署您的应用程序
...
## [](#step-6-configure-nginx)第六步:配置 Nginx
...
## [](#step-7-automate-via-a-script-the-deployment)步骤 7:通过脚本自动化部署
...
## [](#step-8-add-ssl-certificate)第八步:添加 SSL 证书
