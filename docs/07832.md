...
> 原文:[https://dev . to/kball/Friday-frontend-pleasant-CSS-quick-hits-edition-3b4k](https://dev.to/kball/friday-frontend-delightful-css-quick-hits-edition-3b4k)
...
##### [](#css-empty-selector)[CSS:空选择器](https://dev.to/samanthaming/css-empty-selector-b6f)

一个简单但未被充分利用的伪选择器，`:empty`选择器可以在许多方面让你的生活变得更容易。这是一本非常简单的读物，首先解释了选择器是如何工作的，然后强调了它可以为您解决的一些常见的 UI 问题。

##### [](#staggered-css-transitions)[交错 CSS 转场](https://css-tricks.com/staggered-css-transitions/)

多么有趣的小效果！使用`transition-delay`属性创建交错的 CSS 动画。爱死了！

##### [](#css-units-explained)[CSS 单位说明](https://alligator.io/css/css-units-explained/)
...
##### [](#handling-unused-css-in-sass-to-improve-performance)[处理 SASS 中未使用的 CSS 以提高性能](https://www.smashingmagazine.com/2019/08/handling-unused-css-sass-performance/)
...
##### [](#the-differing-perspectives-on-cssinjs)[关于 CSS-in-JS 的不同观点](https://css-tricks.com/the-differing-perspectives-on-css-in-js/?ref=heydesigner)
...
##### [](#javascript-promise-combinators-all-race-allsettled)[JavaScript Promise 组合子:。all()，。race()，。allSettled()](https://2ality.com/2019/08/promise-combinators.html)
...
##### [](#modern-react-testing-part-1-best-practices)[现代反应测试，第 1 部分:最佳实践](https://blog.sapegin.me/all/react-testing-1-best-practices/)
...
##### [](#getting-more-out-of-vue-async-components)[充分利用 Vue 异步组件](https://logaretm.com/blog/getting-more-out-of-vue-async-components/)

这是一个有趣的练习，研究了一系列利用异步加载来根据需要拆分和加载代码的方法。通常这种对话会从异步组件开始和停止，但是它们会比这更深入。

#### [](#other-awesomeness)其他牛气

##### [](#native-lazyloading-for-the-web)[【原生懒人】为网页加载](https://web.dev/native-lazy-loading)
...
##### [](#time-to-first-byte-what-it-is-and-why-it-matters)[第一个字节的时间:它是什么，为什么重要](https://csswizardry.com/2019/08/time-to-first-byte-what-it-is-and-why-it-matters/)

有趣的是，我还没有看到前端开发人员讨论过性能的一个方面——甚至一个字节返回到客户端浏览器之前的纯延迟。着眼于所有可能导致这种情况的因素，并挖掘一些新的可用工具来开始打破这种局面并加以改进。

##### [](#building-a-fullstack-serverless-application-with-cloudflare-workers)[用 Cloudflare Workers 构建全栈无服务器应用](https://css-tricks.com/building-a-full-stack-serverless-application-with-cloudflare-workers/)
...
##### [](#all-the-best-engineering-advice-i-stole-from-nontechnical-people)[我从非技术人员那里偷来的所有最好的工程建议](https://medium.com/@bellmar/all-the-best-engineering-advice-i-stole-from-non-technical-people-eb7f90ca2f5f)
