...
> 原文:[https://dev . to/bansal/server less-contact-form-handling-for-static-websites-12md](https://dev.to/bansal/serverless-contact-form-handling-for-static-websites-12md)

当你在做一个静态网站时，这意味着你不想管理服务器或者想节省成本。然而，静态网站不能处理联系表单，这意味着您需要一个后端服务器来处理联系表单请求。但是如果需要服务器，那么做一个静态网站的逻辑是什么？因此，简单的解决方案是无服务器的联系形式。

## [](#why-go-serverless)为什么要去无服务器？
...
### [](#step-1-create-project)第一步:创建项目

(如果您没有 Google 云帐户，请创建一个，然后创建项目)

[![create project in google cloud account](../Images/e61b729f3e13f095ba756aebc7dfd678.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wwF75NGc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f9eayig8khuy1stqz733.png)

### [](#step-2-create-function)第二步:创建函数

点击左上角的菜单图标。向下滚动并在计算部分找到云函数。

[![Create Cloud function](../Images/959f21dcd392a3465175afcdbfdd498f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PObFEqov--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nph0hmy8o0h0pifoqd0j.png) 
然后点击*创建功能*按钮。

### [](#step-3-configure-cloud-function)第三步:配置云功能
...
[![Configure Cloud function](../Images/8f3917474bb30c6e34eda6a12c1b904a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EV-JOIJO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5lpzekvbuedwk187mgjb.png)

### [](#step-4-add-code-to-editor)第四步:向编辑器添加代码
...
[![Import code](../Images/e7d35607af217928b88634691f891759.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rBOMbjiR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/33xfn30rsjq3kue0jd7c.png)

### [](#step-5-set-environment-variables)第五步:设置环境变量
...
[![Set Environment variables](../Images/e8a159877ef0640de9de29d9b4cbec61.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2fbYLWNx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/90lgrwitsi4zugulehhq.png)

> 注意:除了设置环境变量，您还可以更改`index.js`文件中的配置值。

## [](#get-http-endpoint)获取 http 端点
