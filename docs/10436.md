...
> 原文:[https://dev . to/wchr/how-to-create-and-run-cron-jobs-in-node-4eh0](https://dev.to/wchr/how-to-create-and-run-cron-jobs-in-node-4eh0)

如果你想在你的应用上自动完成某些任务，省去手动完成这些任务的麻烦，比如删除日志文件、自动发送电子邮件，或者将你的数据库数据备份到 MongoDB/SQL 转储文件中，我们可以说没有更多的`cron jobs`可以提供帮助。

## [](#what-is-a-cronjob)什么是 cronjob？
...
# [](#simple-node-cron-job-template)简单节点 Cron 作业模板
...
# [](#where-to-use-cron-jobs)在哪里使用 Cron 作业
...
# [](#resources-and-recommendations)资源和建议
