...
> 原文:[https://dev . to/wesleylhandy/improving-touch-events-on-a infinite-scrolling-component-kg7](https://dev.to/wesleylhandy/improving-touch-events-upon-an-infinite-scrolling-component-kg7)

[![Closeup of a butterfly sitting on the tip of the someone's index finger](../Images/fd8265bf50cbce7950f62e0cd107a3c1.png)T2】](/static/9262257e3e1dba7123eb7236d14248d8/de376/butterfly-finger.jpg)
...
## [](#solution-debugging-css-)解决方案:调试 CSS？？
...
## [](#solution-debugging-raw-touchend-endraw-event-handler-)解决方案:调试`touchend`事件处理程序！！
...
### [](#-raw-click-endraw-comes-after-raw-touchend-endraw-)`click`跟在`touchend`之后
