...
> 原文:[https://dev . to/Allen ball/AWS-ec2-user-data-shell-script-3 ocj](https://dev.to/allenball/aws-ec2-user-data-shell-script-3ocj)
...
### [](#ebs-file-system-volumes)EBS 文件系统卷
...
### [](#attach-and-mount-ebs-volumes)连接并装载 EBS 卷
