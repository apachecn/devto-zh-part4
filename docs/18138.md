...
> 原文:[https://dev . to/just alever/let-s-build-with-ruby-on-rails-extending-device-series-adding-custom-fields-22em](https://dev.to/justalever/let-s-build-with-ruby-on-rails-extending-devise-series-adding-custom-fields-22em)
...
#### [](#update-the-application-controller)更新应用控制器
...
#### [](#update-views-to-reflect-new-fields)更新视图以反映新字段
...
#### [](#create-a-helper-around-the-logic)围绕逻辑创建一个助手
