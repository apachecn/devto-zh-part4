...
> 原文:[https://dev . to/pimpled developer/story-of-how-I-speed-a-site-for-my-portfolio-using-nuxt-js-and-content ful-4il 4](https://dev.to/pimpledeveloper/story-of-how-i-speeded-up-a-website-for-my-portfolio-using-nuxt-js-and-contentful-4il4)
...
## [](#technologies-i-used-for-it)我为它所用的技术
...
[![](../Images/e3dcaff4eb7b5fe6522d902f440c34eb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--E1tjUeF2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3aapoxtxobrz28p8gqnc.png) 
Nuxt.js 是一个创建 Vue.js 应用的框架。它还可以帮助您轻松构建服务器呈现的 Vue.js 应用程序。
最重要的是，它有能力用 generate 命令生成静态网站。听起来这已经满足了我的需求，不是吗？

## [](#netlify)Netlify

[![](../Images/5200c6c74c502d9d98394781071b03e4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--KSYZqR2h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l1e029lzneghskhm39jw.gif) 
Netlify 为静态网站提供托管服务。
...
[![](../Images/342e0eb8d3d6f4050156ae4dad48137e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ycSLAB_S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/okhfqmeseslmn2bz3u10.png) 
知足者无头 CMS。
Contentful 让你写的帖子可以通过 API 访问，让你可以在任何地方获取你的内容。你可以在 markdown 中写文章。

## [](#lets-dive-into-more-details)让我们深入了解更多细节。
