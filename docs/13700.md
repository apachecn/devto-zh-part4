...
> 原文:[https://dev . to/numtostr/environment-variables-in-node-js-the-right-way-15ad](https://dev.to/numtostr/environment-variables-in-node-js-the-right-way-15ad)
...
## [](#1-using-packagejson)1。使用 package.json
...
## [](#2-different-keys-files)2。不同的密钥文件
...
## [](#3-raw-env-endraw-comes-to-the-rescue)3。`.env`前来救援
...
#### [](#-configuring-the-dotenv)~配置 dotenv
...
### [](#points-to-be-considered)需要考虑的要点
