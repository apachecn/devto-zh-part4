...
> 原文:[https://dev . to/Allen ball/automount-autofs-executable-map-for-Amazon-EBS-volumes-d93](https://dev.to/allenball/automount-autofs-executable-map-for-amazon-ebs-volumes-d93)
...
### [](#-raw-autoebs-endraw-executable-map)`auto.ebs`可执行地图
