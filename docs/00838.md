...
> 原文:[https://dev . to/sophia Brandt/format-and-fix-all-files-with-beauty-and-eslint-recursively-1gld](https://dev.to/sophiabrandt/format-and-fix-all-files-with-prettier-and-eslint-recursively-1gld)
...
## [](#configure-eslint-and-prettier)配置 ESLint，更漂亮
...
## [](#optional-precommit-hook)可选:预提交挂钩
