...
> 原文:[https://dev . to/raymondcamden/multiple-ways-of-API-integration-in-your-jam stack-4mh 6](https://dev.to/raymondcamden/multiple-ways-of-api-integration-in-your-jamstack-4mh6)
...
## [](#option-one-direct-access-to-a-remote-api)选项一-直接访问远程 API
...
## [](#option-two-an-api-proxy)选项二——一个 API 代理
...
## [](#option-three-using-the-build-process)选项三-使用构建过程
