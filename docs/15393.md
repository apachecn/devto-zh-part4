...
> 原文:[https://dev . to/aaronc 81/first-impressions-of-sorbet-a-ruby-type-checker-3ef 7](https://dev.to/aaronc81/first-impressions-of-sorbet-a-ruby-type-checker-3ef7)
...
[![](../Images/801979f9ba9779eeca1b8add76246404.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PupKaGt9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fj2z0vmfyrp7dfrpx7lc.png)

### [](#it-makes-code-safer)它使代码更安全

显然，作为一个静态类型系统，Sorbet 为您的 Ruby 代码带来了静态类型的所有优点。在类型检查器的帮助下，准确的类型签名可以发现您正在编写的代码中的许多常见错误。

## [](#what-i-dont-like-as-much)我不太喜欢什么

### [](#it-doesnt-support-structural-interfaces)不支持结构化接口
