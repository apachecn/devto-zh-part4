...
> 原文:[https://dev . to/halan/4-ways-of-symmetric-cryptography-and-JavaScript-how-to-AES-with-JavaScript-3o1b](https://dev.to/halan/4-ways-of-symmetric-cryptography-and-javascript-how-to-aes-with-javascript-3o1b)
...
# [](#dealing-with-data-not-text)处理数据，而不是文本
...
# [](#what-is-an-operation-mode)什么是运营模式？
...
# [](#lets-encrypt-something)让我们加密一些东西
...
# [](#references-and-useful-links)参考资料和有用链接
