...
> 原文:[https://dev . to/angular/creating-a-simple-memory-cache-for-your-angular-universal-website-or-application-KDC](https://dev.to/angular/creating-a-simple-memory-cache-for-your-angular-universal-website-or-application-kdc)
...
## [](#our-example-application)我们的应用举例
...
### [](#simple-diagram-for-basic-rendering)用于基本渲染的简单示意图

[![](../Images/d35618c877ff7ee728619aed1e448226.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F_Fs08H0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y3sfq5ye063ex1lhzncm.png)
...
### [](#code-for-basic-rendering)代码为基本渲染
...
## [](#a-simple-memorycache-implementation)一个简单的内存缓存实现

[![](../Images/719aa59f0d9918a7e4697ad40bcfcd91.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--u3ELfeOp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6wv0d7o5m06gp1u6ngts.png)
...
### [](#code-for-cached-rendering)代码用于缓存渲染
...
### [](#cache-only-the-existing-pages)仅缓存现有页面
...
## [](#possible-extensions-and-improvements)可能的扩展和改进
...
### [](#create-an-interface-for-your-cache)为你的缓存创建一个接口
...
### [](#use-a-separate-caching-layer)使用单独的缓存层
...
### [](#serverside-render-only-specific-pages)服务器端只渲染特定页面
...
### [](#use-a-file-based-cache-instead-of-memory-cache)使用基于文件的缓存，而不是内存缓存
