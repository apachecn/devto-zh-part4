...
> 原文:[https://dev . to/upward trajectory/let-s-look-in-images-while-talking-other-images-BBG](https://dev.to/upwardtrajectory/let-s-look-at-images-while-talking-about-other-images-bbg)

### [](#a-quick-summary-of-microsofts-common-objects-in-context-image-database)微软*上下文中常见对象的快速总结*图像数据库
...
[![Let's talk about that](../Images/398492fce9eb65d75c1833d18b5fb508.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pzEOpS-V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://media1.tenor.com/images/2f93a5bd8c8ab67d92cd039ced056d14/tenor.gif%3Fitemid%3D12726853)
...
T3![iconic images vs non-iconic](../Images/9a6c86de1149fc968dcce63de71d0cbe.png)T5】
...
[![comparison](../Images/73f56fd712ded6a7b98100e82493895c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--R_HYRi86--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/UpwardTrajectory/ms_coco_blog/blob/master/image_db_comparison.png%3Fraw%3Dtrue)

我希望你和我一样喜欢研究这些图表。现在我们都在一个良好的顶部空间，让我们潜入巨大的规划和努力，进入创造可可小姐。为了简洁，我将在大纲中这样做。

### [](#how-it-was-done)这是怎么做到的
...
[![Bullet time](../Images/9eaff2cb55cbc005a88e63eb5372d80f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uLOIKC_F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://i.imgur.com/4nvICeP.gif)

对比“低预算”版本。

[![LEGO bullet time](../Images/fb8815029b9fff85dc531b0e63394b16.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NyTv4M7q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://media0.giphy.com/media/13ihNcbag4xLt6/giphy.gif)

我提出这一点，因为即使我们在过去几年里已经看到了许多很酷的图像识别和着色演示，以至于认为它们是正常的，如果没有建立一个大规模、复杂标记的自然场景图像数据集这一相当无聊的任务，这一切都是不可能的。

### [](#thanks-microsoft-coco)感谢微软 COCO。

[![image segmentation gifs](../Images/cf6d615e156e675244c2ebda78d8f23a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YgbSJogm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://liuziwei7.github.io/projects/vsreid/demo.gif)
