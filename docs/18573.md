...
> 原文:[https://dev . to/guin/what-mean-in-JavaScript-a-guide-to-rest-and-spread-part-1-1 FMD](https://dev.to/guin/what-does-mean-in-javascript-a-guide-to-rest-and-spread-part-1-1fmd)

## [](#what-is-the-rest-parameter-and-spread-operator)什么是休止参数和传播算子？
...
## [](#dive-into-the-rest-parameter)潜入休息参数
...
### [](#using-the-raw-arguments-endraw-object)使用`arguments`对象:
...
### [](#using-the-rest-operator)使用 rest 运算符
