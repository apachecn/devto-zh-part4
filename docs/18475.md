...
> 原文:[https://dev . to/tetra gius/variant-of-micro-services-on-the-web-1m 48](https://dev.to/tetragius/variant-of-microservices-on-the-web-1m48)
...
#### [](#communication-between-modules)模块间的通信

模块通过请求共享服务经由内核进行通信。或者根据合同中规定的协议通过 RxJS 总线。

## [](#explanation-in-the-code)代码中的解释

#### [](#inside-the-module)模块内
