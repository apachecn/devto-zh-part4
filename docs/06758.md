...
> 原文:[https://dev . to/惠晶/where-did-CSS-named-colors-come-from-l8](https://dev.to/huijing/where-did-css-named-colours-come-from-l8)
...
## [](#what-do-the-specifications-say)说明书怎么说？
...
## [](#so-whats-this-x11-all-about)那么这个 X11 到底是怎么回事呢？
...
### [](#segue-into-paint-colour-names)续入油漆颜色名称
...
### [](#a-story-about-raw-orange-endraw-)一个关于`orange`的故事
...
[![Cover of the January 1999 issue of Web Techniques magazine](../Images/eaca29355e032239aef669f812cf0cba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--065trbdr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/css-colours/web-techniques%402x.jpg)
