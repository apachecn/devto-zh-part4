...
> 原文:[https://dev.to/madhur/consuming-from-kafka-47kj](https://dev.to/madhur/consuming-from-kafka-47kj)
...
3 最后也是我首选的方式是使用[卡夫卡溪流](https://kafka.apache.org/documentation/streams/)T2】
