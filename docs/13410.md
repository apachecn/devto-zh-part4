...
> 原文:[https://dev . to/exa cs/node-js-12-supports-es-modules-do-you-know-the-difference-commonjs-and-es 2015-modules-hg9](https://dev.to/exacs/node-js-12-supports-es-modules-do-you-know-the-difference-between-commonjs-and-es2015-modules-hg9)
...
## [](#pre-nodejs-12-commonjs-aka-cjs)Pre Node.js 12。CommonJS(又名 CJS)
...
### [](#barepaths-module-resolution-in-nodejs)光秃的小路。Node.js 中的模块解析
...
## [](#the-future-es-modules-aka-esm)未来。ES 模块(又称 ESM)
...
### [](#bare-paths-module-name-resolution)光秃秃的小路。模块名称解析
...
## [](#import-a-cjs-module-into-a-esm-project)将 CJS 模块导入 ESM 项目
...
### [](#alternative-make-an-intermediate-module)备选:做一个中间模块。
...
## [](#import-a-esm-module-into-a-cjs-project)将 ESM 模块导入 CJS 项目
...
### [](#alternative-make-intermediate-modules-using-the-raw-esm-endraw-package)替代:使用`esm`包制作中间模块
