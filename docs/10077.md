...
> 原文:[https://dev . to/psqrrl/managing-design-tokens-using-story book-5975](https://dev.to/psqrrl/managing-design-tokens-using-storybook-5975)
...
## [](#managing-design-tokens-with-storybook)用故事书管理设计令牌
...
### [](#design-tokens-as-stories)把代币设计成故事
...
### [](#introducing-the-storybook-design-token-addon)介绍[故事书设计令牌插件](https://github.com/UX-and-I/storybook-design-token)
...
[![](../Images/c2768094b608fc515b708041f10570d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mJswFT_1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s64bw0bi0u2c54z27zhx.png)
