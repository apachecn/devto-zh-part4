...
> 原文:[https://dev . to/gite den/5-questions-for-building-a-mono repo-4fl 3](https://dev.to/giteden/5-questions-for-building-a-monorepo-4fl3)

### [](#before-diving-into-lerna-bit-and-other-monorepo-tools-think-what-youre-building-who-youre-building-it-for-and-why)在投入 [Lerna](https://lerna.js.org/) 、 [Bit](https://bit.dev) 和其他 monorepo 工具之前，想想你在构建什么，你在为谁构建，为什么要构建。
...
## [](#1-what-are-you-building-library-app)1。你在建造什么？(图书馆？App？)
...
## [](#3-whos-going-to-use-these-package)3。谁会使用这些包？
...
## [](#4-how-will-you-manage-changes-and-prs-and-dependencies-in-the-repo)4。您将如何管理变更和 PRs？(以及回购中的依赖关系……)
...
## [](#5-are-you-working-on-an-opensource-project)5。你正在做一个开源项目吗？
