...
> 原文:[https://dev . to/nickjj/a-python-CLI-tool-to-help-diff-we b-framework-versions-2d pi](https://dev.to/nickjj/a-python-cli-tool-to-help-diff-web-framework-versions-2dpi)
...
### [](#demo-video-of-using-and-building-this-tool)使用和构建该工具的演示视频
