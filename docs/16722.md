...
> 原文:[https://dev . to/jessekphillips/argument-parsing-into-structure-4p4n](https://dev.to/jessekphillips/argument-parsing-into-structure-4p4n)

更新:把这个做成一个项目-

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[JesseKPhillips](https://github.com/JesseKPhillips)/[struct opt](https://github.com/JesseKPhillips/structopt)
