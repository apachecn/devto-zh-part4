...
> 原文:[https://dev . to/ogurinkaben/初学者指南-JavaScript-arrays-part-2-411 p](https://dev.to/ogurinkaben/beginner-s-guide-to-javascript-arrays-part-2-411p)
...
## [](#what-is-the-filter-method-)什么是 filter()方法？
...
## [](#additional-array-methods)附加数组方法
