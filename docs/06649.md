...
> 原文:[https://dev.to/voralagas/first-day-to-redux-531](https://dev.to/voralagas/first-day-to-redux-531)

我刚刚学会 Redux，我在这里分享让我明白发生了什么的事情...

## [](#lets-start-with-why-to-use-redux)先说为什么要用 Redux:
...
[![Alt Text](../Images/0570433ace1747c78c478e2b1f5dfbb8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6FBCjTcb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u4jh8mkvtnzrhzdfwtam.png)
...
3.  Reducer:
    ...
    [![Redux flow](../Images/1c426496b14a7ce41783977ab1a30cdf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fCDvEpjd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.stack.imgur.com/LNQwH.png)
...
### [](#create-and-dispatch-an-action-)创建并调度一个动作:
...
### [](#define-a-reducer-function-and-handle-the-action-props)定义一个减速器功能并处理动作道具:
...
### [](#dividing-state-with-multiple-reducer-)用多个减速器划分状态:
...
### [](#refactoring-of-reducer-function-)减速器功能的重构:
...
[![Console output after dispatch call](../Images/4e837d26e90eceb720d438ad21cc3ebe.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--sgIg0Hdc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5c64p0w9larumwhhk23s.png) 
