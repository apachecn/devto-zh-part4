...
> 原文:[https://dev . to/antonmelnyk/understanding-JavaScript-type-conversions-43n](https://dev.to/antonmelnyk/understanding-javascript-type-conversions-43n)
...
# [](#what-is-type-conversion)什么是类型转换？
...
## [](#string-type-conversion)字符串类型转换
...
## [](#type-conversions-for-objects)对象的类型转换
...
## [](#comparison-and-type-conversion)比较和类型转换
