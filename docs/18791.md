...
> 原文:[https://dev . to/jacoboakley/we B- development-with-a-chrome book-installing-nodejs-3fo 0](https://dev.to/jacoboakley/web-development-with-a-chromebook-installing-nodejs-3fo0)
