...
> 原文:[https://dev . to/oliverjumpertz/you-should-consider-adding-more-detail-to-your-commit-messages-l7g](https://dev.to/oliverjumpertz/you-should-consider-adding-more-detail-to-your-commit-messages-l7g)
...
### [](#a-reminder-about-what-git-is)提醒你什么是 git
...
### [](#reason-about-why-code-you-see-is-as-it-is)为什么你看到的代码是这样的原因

#### [](#a-possible-scenario)一种可能的情景
...
#### [](#how-we-could-have-saved-a-lot-of-time)我们本可以节省很多时间
...
### [](#create-a-change-log-for-your-next-release)为你的下一个版本创建一个变更日志
