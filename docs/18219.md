...
> 原文:[https://dev . to/seang Wright/kentico-12-design-patterns-part-5-front-end-dependency-management-5m 0](https://dev.to/seangwright/kentico-12-design-patterns-part-5-front-end-dependency-management-5m0)

<figure>

[![](../Images/19a9a0ebc578065ba5a481389d7e24be.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bNitp1zO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f990qahf699vx8vcohri.jpg)
...
## [](#using-raw-systemweboptimization-endraw-)使用`System.Web.Optimization`
...
## [](#the-problems-with-raw-systemweboptimization-endraw-)与`System.Web.Optimization`的问题
...
## [](#using-clientside-tools)使用客户端工具
...
### [](#removing-raw-systemweboptimization-endraw-)移除`System.Web.Optimization`
...
### [](#creating-clientside-code)创建客户端代码
...
### [](#using-clientside-build-ouptut)使用客户端构建输出
...
### [](#endtoend-build-coordination)端到端构建协调
