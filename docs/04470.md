...
> 原文:[https://dev . to/gnsp/open sourcing-class d-a-fast-and-modern-class names-alternative-2g ca](https://dev.to/gnsp/opensourcing-classd-a-fast-and-modern-classnames-alternative-2gca)
...
## [](#enter-raw-classd-endraw-)输入 [`classd`](https://www.npmjs.com/package/classd)
...
#### [](#install-using-package-manager)使用软件包管理器安装
...
#### [](#use-in-es6-modules)在 ES6 模块中使用
...
#### [](#use-in-commonjs-modules-nodejs)在 Commonjs 模块中使用(Nodejs)
...
### [](#well-what-are-raw-classdedupe-endraw-raw-classdfn-endraw-and-raw-classdedupefn-endraw-)嗯，什么是`classDedupe`、`classdFn`、`classDedupeFn`？
...
### [](#what-about-performance-and-stability-)性能和稳定性怎么样？
...
[![JSPerf benchmark](img/587538ce203fe0e0fdfb70a57a59ff7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oeeygcz4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ffmeo7wjdrvkdllzcp9i.png)

### [](#source-code-and-contributing)源代码和投稿
