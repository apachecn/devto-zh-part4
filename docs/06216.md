...
> 原文:[https://dev . to/7 D1/resizing-persistent-volumes-in-eks-aks-gke-3oa 7](https://dev.to/7d1/resizing-persistent-volumes-in-eks-aks-gke-3oa7)
...
## [](#amazon-elastic-kubernetes-service)亚马逊弹性 Kubernetes 服务
...
## [](#google-kubernetes-engine)谷歌库柏发动机
