...
> 原文：<https://dev.to/moesif/in-depth-guide-to-serverless-apis-with-aws-lambda-and-aws-api-gateway-part-2-3jh5>
...
*   [SNS](https://aws.amazon.com/en/sns/) 是一项服务，允许我们将一个λ结果并行分发给许多其他λ。
