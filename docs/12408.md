...
> 原文:[https://dev . to/tarunmangukiya/creating-my-first-react-package-react-unicons-29 a9](https://dev.to/tarunmangukiya/creating-my-first-react-package-react-unicons-29a9)
...
## [](#publishing-it-as-npm-package)发布为 npm 包
