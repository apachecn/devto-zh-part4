...
> 原文:[https://dev . to/softchris/http-mocking-for-your-tests-in-react-26 F6](https://dev.to/softchris/http-mocking-for-your-tests-in-react-26f6)

在 [Twitter](https://twitter.com/chris_noring) 上关注我，很乐意接受您对主题或改进的建议/Chris

> Nock 习惯于嘲笑对 HTTP 的调用。它使我们有可能指定要监听哪些 URL 以及用什么来响应。这是一篇相当短的文章，展示了如何使用库 nock。

[![alt text](../Images/c9bb4d7a6eb61995558ac58b342c4ffe.png "nocking it out of the park")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zPribx7I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h22lmad60f73rgspmb4w.jpg)
...
## [](#why-mock%C2%A0http)为什么要嘲讽 HTTP？
...
我们最后得到如下:
[![alt text](../Images/afd0ebabde7feca80fb08458dcc9a34e.png "network request failed")](https://res.cloudinary.com/practicaldev/image/fetch/s--qaSzjUWW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c28jytvm1gimwpb7npx1.png)
...
[![alt text](../Images/ac25baa0c2488d2af1ed31bff55a4687.png "passing unit test")](https://res.cloudinary.com/practicaldev/image/fetch/s--G7ATPjcL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hsikrkl5jbv6eejm1cs3.png)

一切正常，我们成功地用 nock 模拟了我们的 HTTP 调用。

[![alt text](../Images/193b00af15575c42cdecd1ac1116a53c.png "homerun celebration - our test works")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kqg0FObG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m7ajo8wx7qywfq11qzcj.gif)

### [](#handle-query-parameters-using%C2%A0query)处理查询参数使用。查询()
...
现在看起来是这样的:
[![alt text](../Images/955a033dccff914ff21b3d3bd48a1ac0.png "nock assertion fails")](https://res.cloudinary.com/practicaldev/image/fetch/s--to8MgGky--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xrns0dkrrkt3z90czwdq.png)

### [](#block-http%C2%A0calls)拦截 HTTP 呼叫
