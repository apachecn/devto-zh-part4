...
> 原文:[https://dev . to/fpim/easy-and-effective-python-type-checker-2ol 8](https://dev.to/fpim/easy-and-effective-python-type-checker-2ol8)
...
### [](#hack-2-auto-type-check)Hack 2 -自动类型检查
