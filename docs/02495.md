...
> 原文:[https://dev . to/gate 3/sending-real time-events-to-the-client-from-node-child-process-2 kid](https://dev.to/gate3/sending-realtime-events-to-the-client-from-node-child-process-2kid)
...
# [](#now-for-some%C2%A0code)现在为一些代码
