...
> 原文:[https://dev.to/swiip/the-weight-of-js-1aad](https://dev.to/swiip/the-weight-of-js-1aad)
...
> ![Takashi Mochizuki profile image](../Images/7fb269ae65c8d4bea3bc30be8604ff7f.png)望月隆@ mochi _ wsj![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)Switch OS UI 会话:在尽可能削减玩家等待时间的情况下，Switch 的 home 菜单设计资源已经不到 200KB。太神奇了。[twitter.com/mochi_wsj/stat…](https://t.co/gnINFXnFPp)2018 年 8 月 22 日下午 14:39望月隆@ mochi _ wsjホームメニューのリソースはなんと200kb 以下 https://t.co/g63Z9W9xOM[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1032276091279302656)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1032276091279302656)170[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1032276091279302656)391

他们几乎不需要考虑网络问题(据我所知)，但他们非常关心应用程序的性能和流动性。

最后:“代码越少，bug 越少”。我一直很喜欢这句话。交付更少的代码(包括您和第三方的代码)对于稳定性来说总是更好的。

## [](#tools-dont-solve-everything)工具不能解决一切
...
[![Minification Diagram](../Images/25afe29a8bda0f134c51e891fe1d7eff.png)T2】](https://public.chartblocks.com/c/5ce570fc3ba0f6d07e63d2c9?t=a95c1edce5b7d21)
...
[![Compression Diagram](../Images/52d0be2c061ddead2b910654537117cf.png)T2】](https://public.chartblocks.com/c/5ced4a1f3ba0f66a7e57560b?t=95e776621bbc403)
...
[![Parse and compile time chart of the most popular websites](../Images/4ff98d5435fb2d97e392f6ab8c7975dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ykW0gepr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3rx7ho3vps2t6cn9to57.png)
...
### [](#compiling-vs-runtime)编译 vs 运行时
...
[![Import Code](../Images/6a60e0c4dddf38d2a84c0a0a9a7dfc41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GJA4UDSg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hoiwq7hgqn2fee2pfo48.png)

[![Bundle Analyzer](../Images/91097a0a831e9311e91d4da1df5b6b57.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RLWxrfiL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8n6m8unn6hrgj7gqgqff.png)

它们非常花哨，但是要小心，因为问题是在代码编辑器中担心重量已经太迟了。当你选择你的筹码时，你必须事先考虑这个问题。

如前所述，通常使用不同的测量方法。主要是压缩前后。为了简单起见，从现在开始，我将使用压缩前(但缩小后)的数字。

### [](#common-frameworks-and-library)常用框架和库
...
[![Weight of things diagram](../Images/da83f7daad17e19799da6faa0308fdc6.png)T2】](https://public.chartblocks.com/c/5d1a0f363ba0f6d81845627b?t=2999c8ac5b1c983)

### [](#hello-world-weight-vs-real-world-weight)Hello 世界体重 vs 真实世界体重
...
[![Hello app vs Real app diagram](../Images/45f29d2eb79fc6e58b9a2eb153ef62d3.png)T2】](https://public.chartblocks.com/c/5d1a1d2f3ba0f6d71e45627a?t=462bcc52236cd5f)
...
### [](#the-weight-of-your-code)你的代码的权重
...
### [](#the-weight-of-other-things)其他事物的重量
...
[![Jeweler working on a ring](../Images/875932e6eb86c75408be655bf963b980.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tesQjqU4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g76z1l35m71o1vnnacit.jpg)

这篇文章中的所有数据都是根据 GitHub 知识库计算出来的:

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[Swiip](https://github.com/Swiip)/[js 的重量](https://github.com/Swiip/weight-of-js)
