...
> 原文:[https://dev . to/cpow/scraping-Reddit-s-API-in-nodejs-with-snoowrap-2m9n](https://dev.to/cpow/scraping-reddit-s-api-in-nodejs-with-snoowrap-2m9n)
...
### [](#installing-snoowrap)安装 snoowrap
...
### [](#setting-up-snoowrap)设置 Snoowrap
...
[![New Web App on Reddit](../Images/03f9e00cfa971580112af8807bd0d2da.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EgP6-km_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dlev7p49d56thtltlmjj.png) 
<small></small>
...
### [](#the-script-for-querying-realestate-subreddit)查询房地产子编辑的脚本
