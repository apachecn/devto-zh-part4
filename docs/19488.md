...
> 原文:[https://dev . to/restore dev/how-to-write-a-magento-2-console-command-1gl 8](https://dev.to/restoreddev/how-to-write-a-magento-2-console-command-1gl8)
...
### [](#2-create-console-command-class)2。创建控制台命令类
...
### [](#3-register-command-in-magento)3。Magento 中的注册命令
