...
> 原文:[https://dev . to/mark Johnsons 303/building-a-portfolio-site-with vue-bulma-and-air table-5a 58](https://dev.to/markjohnson303/building-a-portfolio-site-with-vue-bulma-and-airtable-5a58)
...
## [](#adding-header-and-footer)添加页眉和页脚
...
## [](#building-the-projects-page)构建项目页面

项目页面是事情开始变得有趣的地方。我们将从 Airtable 中提取信息，并显示每个项目的摘要卡。

### [](#set-up-airtable)设置 Airtable
...
### [](#build-a-card-for-displaying-projects)建立展示项目的卡片
...
### [](#creating-a-service-to-bring-in-projects)创建服务以引入项目
...
### [](#displaying-the-project-cards)显示项目卡片
...
## [](#crete-the-project-view)克里特项目视图
