...
> 原文:[https://dev . to/prototyp/react-use effect-explained-with-life cycle-methods-296n](https://dev.to/prototyp/react-useeffect-explained-with-lifecycle-methods-296n)
...
## [](#componentdidupdate-equivalent)componentDidUpdate 等价
...
## [](#componentwillunmount-equivalent)组件将卸载等效
