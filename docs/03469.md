...
> 原文:[https://dev . to/fpim/setting-up-python-s-windows-embedded-distribution-proper-1081](https://dev.to/fpim/setting-up-python-s-windows-embeddable-distribution-properly-1081)

## [](#embeddable-distribution)可嵌入分布
