...
> 原文:[https://dev . to/dillion megida/we B- accessibility-for-frontend-development-series-3kp 7](https://dev.to/dillionmegida/web-accessibility-for-beginners-part-3-of-frontend-development-series-3kp7)

## [](#what-is-accessibility)什么是无障碍？

顾名思义，它是可访问的东西的质量。它是容易理解和使用的东西的品质。

## [](#web-accessibility)网页无障碍？
...
## [](#making-your-website-accessible)使您的网站易于访问
...
#### [](#1-using-raw-alt-endraw-text-for-images)1。对图像使用`alt`文本
...
#### [](#2-transcripts-for-audio)2。音频抄本
...
#### [](#3-web-responsiveness)3。Web 响应能力
