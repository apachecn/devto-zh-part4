...
> 原文:[https://dev . to/leomercier/deploying-a-Gatsby-site-to-fire base-with-Google-cloud-build-ci-CD-511 c](https://dev.to/leomercier/deploying-a-gatsby-site-to-firebase-with-google-cloud-build-ci-cd-511c)
...
# [](#cloudbuildyaml-config)Cloudbuild.yaml 配置
...
# [](#authorising-firebase)授权 Firebase
