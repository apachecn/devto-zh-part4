...
> 原文:[https://dev . to/fabiothiroki/create-a-graph QL-API-using-spring-boot-32o 2](https://dev.to/fabiothiroki/create-a-graphql-api-using-spring-boot-32o2)
...
# [](#spring-boot-setup)Spring Boot 设置
...
[![Pikachu appearing](../Images/47e29038cdc087105515b61d97021338.png)T2】](https://i.giphy.com/media/xuXzcHMkuwvf2/giphy.gif)
...
# [](#fetch-pokemons-from-database)从数据库中取出口袋妖怪
