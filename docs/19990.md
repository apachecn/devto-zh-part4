...
> 原文:[https://dev . to/angular/better-sharing-on-social-media-platform-with-angular-universal-1d1o](https://dev.to/angular/better-sharing-on-social-media-platforms-with-angular-universal-1d1o)
...
## [](#angular-universal-and-seo-problems-with-spas)角万能和 SEO 问题与 spa
...
## [](#indexing-capabilities-of-spas-by-search-engines)搜索引擎对 spa 的索引能力
...
[![Going Beyond Google: Are Search Engines Ready for JavaScript Crawling & Indexing?](../Images/084cc60aebac33547ae7222ab0607a9f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--L6haInKB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p4m38v6sw774iknoehpb.png)
...
### [](#the-2nd-wave-of-indexing)第二波指数化
...
## [](#google-bing-and-others-are-not-the-only-search-engines)谷歌、必应等并不是唯一的搜索引擎
...
## [](#how-do-social-media-platforms-crawl-your-page)社交媒体平台如何抓取你的页面？
...
#### [](#facebook-sharing-debugger)脸书共享调试器
...
#### [](#linkedin-post-inspector)LinkedIn 帖子检查员
...
## [](#using-the-meta-and-title-services-in-angular)在 Angular 中使用元和标题服务
...
## [](#watch-out-for-overoptimization)小心过度优化
