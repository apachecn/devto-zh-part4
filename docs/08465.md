...
> 原文:[https://dev.to/loq24/when-i-hated-typescript-3kl](https://dev.to/loq24/when-i-hated-typescript-3kl)
...
## [](#vscode-intellisense)VSCode 智能感知

这是使用 Typescript 的另一大优势。在编码时看到这些建议会让您意识到，如果不在 javascript 代码中使用 Typescript，您会错过很多东西。

[![Intelligent Code](../Images/b53a8786a17180eb7110f83ca6990fe3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--392s3R-4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g53egqabdq5fyau9ww4p.png)

### [](#my-react-project-with-typescript)我的 React 项目带打字稿
