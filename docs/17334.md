...
> 原文:[https://dev.to/selbekk/the-10-component-commandments-2a7f](https://dev.to/selbekk/the-10-component-commandments-2a7f)
...
[![An illustration of a person thinking about APIs](../Images/6d8dd8da5d44c1a36acf221e95b77143.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UkzFrUiz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tzruxhdpzm8tc2sroarv.jpg)

## [](#whats-an-api)什么是 API？
...
### [](#minimize-your-api-surface)最小化你的 API 面
...
## [](#the-10-component-commandments)十大构件戒律

[![An illustration depicting the JSX "<Commandments />"](../Images/5f52857d403bf1605d3fff6d549e037f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V2VIARcT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8halntamxnndr2fb5a6s.jpg)
...
### [](#2-allow-for-contextual-semantics)2。考虑上下文语义
...
### [](#3-avoid-boolean-props)3。避免布尔道具
...
### [](#4-use-raw-propschildren-endraw-)4。使用`props.children`
...
### [](#5-let-the-parent-hook-into-internal-logic)5。让父对象与内部逻辑挂钩
...
### [](#6-spread-the-remaining-props)6。传播剩余的道具
...
### [](#7-give-sufficient-defaults)7。给出足够的默认值
...
### [](#8-dont-rename-html-attributes)8。不要重命名 HTML 属性
...
### [](#9-write-prop-types-or-types)9。写出正确类型
...
### [](#10-design-for-the-developers)10。为开发者设计
