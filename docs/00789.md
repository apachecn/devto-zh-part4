...
> 原文:[https://dev . to/enappd/firebase-cloud-functions-in-ionic-4-complete-guide-4b 64](https://dev.to/enappd/firebase-cloud-functions-in-ionic-4-complete-guide-4b64)
