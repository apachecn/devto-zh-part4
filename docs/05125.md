...
> 原文:[https://dev . to/devopscar/using-rollout-io-feature-flags-for-apps-deployed-via-Jenkins-x-ci-CD-54 J1](https://dev.to/devopsoscar/using-rollout-io-feature-flags-for-apps-deployed-via-jenkins-x-ci-cd-54j1)
...
# [](#rollout-dashboard-configuration)卷展栏仪表板配置
...
[![Create Flag](../Images/9352a9bb45019f784ab734513a264e88.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ggiEwqVH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9xsde66i7ugqal12jycl.png)

调用标志`jenkinsx environment`，这将映射到我们通过代码创建的内部名称`ski-rollout.jenkinsx_environment`。

1.  创建一个**目标组**，并按如下所示进行配置

[![Target Group](../Images/3248d5b2e7f4de715b6668c930f98564.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UyBM0zXO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6rj5w9uwn0jpr1zw4whm.png)
...
[![Experiment](../Images/0de2689ebb2f35f7275e5d446f642b69.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aBM5Bjfe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e0jazmvj4a2qtt5ap0ow.png)
...
[![Button showing in Staging](../Images/ef107f3d5ed22aec3c68c771f609b298.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PU5DGFV9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9exwgs9cxvx4d6pt9uhe.png)
