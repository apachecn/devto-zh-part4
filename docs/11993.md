...
> 原文:[https://dev . to/byrro/how-to-optimize-lambda-memory-and-CPU-4d J1](https://dev.to/byrro/how-to-optimize-lambda-memory-and-cpu-4dj1)
...
## [](#cpu-allocation)CPU 分配

[![CPU](../Images/db1c50276c349fb44ff853427a05556b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--09jNg3cK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gwik9ech7pz5qfj1m9cu.PNG)
...
# [](#timesensitive-workloads)时间敏感型工作负载

[![Clock watch](../Images/fe9af838add1042150316efb37d9c7c5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XO3JEFs8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6mi2qs2gaclynx1hiqm4.PNG)
...
[![CloudWatch metrics - duration](../Images/ad44f384ce816619a196a23505146875.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UKjkyR8K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9ec9s5txrlq24flqyeb8.PNG)
...
### [](#extracting-memory-usage-from-cloudwatch-logs)从 CloudWatch 日志中提取内存使用情况

CloudWatch Logs 记录了我们需要的数据，但不是以一种易于消费的方式。

在每个 Lambda 调用日志的末尾，您会发现类似下面这样的一行:

[![CloudWatch Logs - memory usage](../Images/aaa01338588e8d1522eb8fbfc7120d54.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C59f5HAI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9bmx7i9wnyqkcqe8lpce.png)
...
### [](#tracking-memory-with-thirdparty-services)用第三方服务追踪记忆
...
[![Dashbird - memory usage stats](../Images/b5fcfee232998a3a0e965f11f9407599.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T9s9G-n_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/32pvvzqqqkalmm308mxp.png)
