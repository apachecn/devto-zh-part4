...
> 原文:[https://dev . to/renegade coder 94/solutions-to-the-producers-consumers-problem-252 c](https://dev.to/renegadecoder94/solutions-to-the-producers-consumers-problem-252c)

撇开读者-作者问题不谈，让我们来谈谈另一个同步问题:生产者-消费者。

## [](#producersconsumers-problem-overview)生产者——消费者问题概述
...
## [](#producersconsumers-problem-solutions)生产者-消费者问题解决方案
