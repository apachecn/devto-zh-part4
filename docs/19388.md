...
> 原文:[https://dev . to/brandonskeritt/greedy-algorithms-for-初学者-4pho](https://dev.to/brandonskerritt/greedy-algorithms-for-beginners-4pho)

贪婪算法的目标是在给定的时刻做出最佳选择。每一步它都选择最优的选择，而不知道未来。它试图用这种方法找到解决整个问题的全局最优方法。

## [](#why-are-greedy-algorithms-called-greedy)贪婪算法为什么叫贪婪？
...
## [](#what-are-greedy-algorithms-used-for)贪婪算法是用来干什么的？
...
## [](#how-do-i-create-a-greedy-algorithm)如何创建贪婪算法？
...
# [](#counting-change-using-greedy)清点零钱使用贪心
...
## [](#is-greedy-optimal-does-greedy-always-work)是贪优？贪心总管用吗？
...
[![Greedy Algorithms](../Images/2c83947badfbf0823eb907c84411b503.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pjCdyD5o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-33-.png)

我们的第一步是选择起始节点。让我们选择 a。所有的距离都从无穷大开始，因为我们不知道它们的距离，直到我们到达一个知道距离的节点。

[![Greedy Algorithms](../Images/87dde0afa1f8d5deb437dc1312d15e28.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oXhOoYh_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-35-.png)
...
[![Greedy Algorithms](../Images/9221db5879d3b08a31df14c93e0c6092.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4aWBozH6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-36-.png)

我们可以从 c 到 B。我们现在需要选择一个最小值。min(4，2 + 1) = 3。

[![Greedy Algorithms](../Images/f3ae214f34d1079727fc65ca56435aaa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F69uLCim--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-37-.png)

由于 A -> C -> B 小于 A -> B，我们用这个信息更新 B。然后，我们加上我们现在可以到达的其他节点的距离。

[![Greedy Algorithms](../Images/031296bbd4b1366ab2a032f305a46a33.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q5phll_---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-40-.png)

我们的下一个最小的顶点是 B，它有一个我们还没有访问过的节点，是 3。我们拜访 b。

[![Greedy Algorithms](../Images/1bdd5e8b2aa40128b4436dde8c30f98d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T1THiw3E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-41-.png)

我们对 b 做同样的事情。然后我们选择我们还没有访问过的最小的顶点，d。

[![Greedy Algorithms](../Images/e3fdd2fdd7cebc992a904067f58410d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JbHSvQ1B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-42-.png)

这次我们不更新任何距离。最后一个节点是 e。

[![Greedy Algorithms](../Images/0cba4b1c0e4523c3a0e09774fd04cdb7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---sid7lGU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-43-.png)

又没有更新了。为了找到从 A 到其他节点的最短路径，我们回溯我们的图。

我们首先选择 A，然后 C，然后 b。如果你需要创建一个从 A 到所有其他节点的最短路径，你可以使用右边的表格来运行这个算法。

[![img](../Images/cd635946ec2522ae03b1e9f3f04a2db1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SIprxT36--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Screenshot_2019-06-23-Greedy-Algorithms.png)

使用此表很容易画出图中从 A 到所有其他节点的最短距离:

[![Greedy Algorithms](../Images/3f4df2d1761f1c5e74f1450237530bda.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f4LQulX6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Blank-Diagram-44-.png)

* * *

## [](#fractional-knapsack-problem-using-greedy-algorithm)利用贪婪算法求解分数背包问题
...
！[]([https://sker ritt . blog/content/images/2019/06/截图 _ 2019-06-23-Greedy-Algorithms-1-。png](https://skerritt.blog/content/images/2019/06/Screenshot_2019-06-23-Greedy-Algorithms-1-.png)

解决分数背包问题的第一步是计算每件物品的价值/重量。

[![img](../Images/e5068aa4f5d9adf2e3117d75d8b3f19f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2GqnZ95v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/Screenshot_2019-06-23-Greedy-Algorithms-2-.png)
...
## [](#greedy-vs-divide-amp-conquer-vs-dynamic-programming)贪婪 vs 除法&征服 vs 动态规划

[![Greedy Algorithms](../Images/60bf4d3c49f30911c18201a2f1789ee3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QOijg1AO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skerritt.blog/content/images/2019/06/image-10.png)
...
[![](../Images/7eb98057e92572389168fa3b8b8e603c.png)T2】](https://pages.convertkit.com/90901878aa/2e1e72f089#becomebetterdev)