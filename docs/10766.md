...
> 原文:[https://dev . to/key van _ m _ sade GHI/building-chat-web-components-with-stencil js-and-ionic-4-537 b](https://dev.to/keyvan_m_sadeghi/building-chat-web-components-with-stenciljs-and-ionic-4-537b)

向神奇开发者社区问好！我想和你分享我使用 StencilJS 构建 Web 组件库的经验，并听取你宝贵的反馈/意见。

这是我做的:

[![Assister Chat](../Images/56ed511b834384316a5251b9f90e56ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b70DSsK3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/gt0TjLS.gif)
...
# [](#technology-choice)技术选择

在选择合适的工具上，我[挣扎了](https://github.com/assister-ai/assister/issues/7) **很多次**。

## [](#you-should-think-long-and-hard-about-react)你应该好好想想**的反应**
...
# [](#stenciljs-does-it-have-the-answers)StencilJS，它有答案吗？
