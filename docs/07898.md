...
> 原文:[https://dev.to/thepeoplesbourgeois/o-1-dev-complexity-1ee5](https://dev.to/thepeoplesbourgeois/o-1-dev-complexity-1ee5)

##### [](#jump-ahead-to-the-refactors)跳到前面的[重构](#when-should-i-refactor)
...
> 写作是人性的，编辑是神性的。
> 
> ##### [](#%E2%80%83%E2%80%82stephen-king-on-writing-a-memoir-of-the-craft)—斯蒂芬·金，*论写作:手艺回忆录*
...
### [](#1-more-than-two-levels-of-internal-indentation)1。多于两层的内部缩进
...
### [](#2-more-than-three-cases-of-branching-logic)2。分支逻辑的三种以上情况
...
### [](#3-more-than-one-kind-of-entity-being-handled-in-one-block)3。在一个块中处理多种实体
...
### [](#4-wait-what-did-i-just-read)4。“等等，我刚才读了什么？”
