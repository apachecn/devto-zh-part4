...
> 原文:[https://dev . to/jamesqquick/build-a-pokedex-with-vanilla-JavaScript-358m](https://dev.to/jamesqquick/build-a-pokedex-with-vanilla-javascript-358m)
...
## [](#fetch-pokemon-data-using-the-pokeapi)使用 PokeAPI 获取口袋妖怪数据
...
## [](#converting-the-pokemon-data)转换口袋妖怪数据
...
## [](#animate-pokemon-card-on-hover)悬停时动画口袋妖怪卡
