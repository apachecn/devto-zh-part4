...
> 原文:[https://dev . to/rocksetcloud/operational-analytics-what-every-every-a-software-engineer-should-know-on-low-latency-queries-on-large-dataset-38 m3](https://dev.to/rocksetcloud/operational-analytics-what-every-software-engineer-should-know-about-low-latency-queries-on-large-data-sets-38m3)

*作者[德鲁巴·博尔塔库尔](https://www.linkedin.com/in/dhruba/)T3】*

### [](#introduction-to-operational-analytics)**运营分析简介**
...
### [](#definition-of-operational-analytics-processing)**运算分析处理的定义**
...
[![operational analytics - 2@2x](../Images/2b174557c83b4d7ef7c8bf29ee29117b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OE0eeN3p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.ctfassets.net/1d31s1aajogl/7wX9tAICRzQfClsmtM4Ub9/e9da36f27e57e9fd18a6d283a8246691/operational_analytics_-_2_2x.jpg)

类似地，许多 OLAP 系统也支持一些基本的交易形式。例如，OLAP 雪花数据仓库明确声明它是为批量更新和涓流插入而设计的(参见 3.3.2 节标题为[并发控制](http://info.snowflake.net/rs/252-RFO-227/images/Snowflake_SIGMOD.pdf))。它们对整个数据文件使用写入时复制方法，并将全局键值存储作为日志。数据库服务器位于日志前面意味着流写速率只能达到数据库服务器能够处理的速度。
...
### [](#comparisons-with-other-data-systems)**与其他数据系统的比较**
...
[![Findings](../Images/430a9b03f29298cda43f4a40caa6431d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--c4_dxQUK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vhwbzxgydo81ix40noq2.png)
