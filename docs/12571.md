...
> 原文:[https://dev . to/aryanjnyc/concrete-steps-to-get-off-the-tutorial-跑步机-2a77](https://dev.to/aryanjnyc/concrete-steps-to-get-off-the-tutorial-treadmill-2a77)

我最近收到一封邮件，询问如何摆脱[教程跑步机](https://www.thewebdevcoach.com/blog/2018-12-14-learning-to-code-get-off-the-tutorial-treadmill/):

[![An email from a Nigerian student asking how to create their own web development project.](../Images/ced43649966013244a09bc76a5402d41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Fa4uxVgt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.thewebdevcoach.com/img/screen-shot-2019-07-18-at-11.00.24-pm.png)

我的教程跑步机博客帖子是不可否认的模糊和隐喻。在这里，我将构建一些具体的行动，你可以采取这些行动来最终编写你自己的项目。

# [](#build-a-foundation)建立基础
