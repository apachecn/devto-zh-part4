...
> 原文:[https://dev . to/jet rockets/command-for-create-zip-archive-without-gem-s-1jjp](https://dev.to/jetrockets/command-for-create-zip-archive-without-gem-s-1jjp)
