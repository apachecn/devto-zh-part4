...
> 原文:[https://dev . to/duranenmanuel/two-exceptual-use-cases-for-the-spread-operator-you-may-not-know-of-5ap 8](https://dev.to/duranenmanuel/two-exceptional-use-cases-for-the-spread-operator-you-may-not-know-of-5ap8)
...
## [](#optionalconditional-spreading)可选/有条件扩散
...
## [](#copy-objects-and-exclude-selected-properties)复制对象并排除选中的属性
