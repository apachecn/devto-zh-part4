...
> 原文:[https://dev . to/isalevine/ruby-on-rails-graph QL-API-tutorial-from-rails-new-to-first-query-76h](https://dev.to/isalevine/ruby-on-rails-graphql-api-tutorial-from-rails-new-to-first-query-76h)
...
# [](#creating-the-rails-app)创建 Rails 应用
...
# [](#adding-graphql)添加 GraphQL

### [](#add-graphql-gem-to-gemfile)将‘graph QL’gem 添加到 Gemfile
...
# [](#filling-out-the-new-graphql-files)填写新的 GraphQL 文件

好了，我们现在有了构建第一个查询所需的所有文件和目录！但是，其中一些文件仍然需要更多的代码。

### [](#define-the-graphql-types-and-their-fields)定义 GraphQL 类型及其字段
...
### [](#define-fields-on-querytype)在 QueryType 上定义字段
...
# [](#writing-our-first-query)编写我们的第一个查询
...
### [](#execute-query-in-insomnia)执行失眠查询
...
[![screenshot of Insomnia running query and showing return data](img/4b531e03608b3069068313edd3d82c4d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--58HM_nme--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p57k51mvolx8j1ezvpj6.png)
...
[![screenshot of Insomnia running query with fewer fields, and showing return data](img/620df7c49ce87e5175469fb4290d1c26.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V0NypNuH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cf1vcwra6ofmt3yph6k9.png)
