...
> 原文:[https://dev . to/auth 0/building-an-audio-player-app-with-angular-and-rxjs-4c6n](https://dev.to/auth0/building-an-audio-player-app-with-angular-and-rxjs-4c6n)
