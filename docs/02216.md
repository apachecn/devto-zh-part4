...
> 原文:[https://dev . to/oliverjumpertz/building-a-project-with type script-express-mocha-and-chai-13fc](https://dev.to/oliverjumpertz/building-a-project-with-typescript-express-mocha-and-chai-13fc)

## [](#what-are-we-going-to-build)我们要造什么？
...
## [](#adding-typescript-tslint-and-express)添加 TypeScript、TSLint 和 Express
...
## [](#testing-our-initial-setup)测试我们的初始设置
...
## [](#adding-mocha-and-chai-for-testing)加入摩卡和柴进行测试
...
### [](#quick-compile-during-development)开发时快速编译
...
### [](#cleaning-up-before-we-build)建造前的清理
