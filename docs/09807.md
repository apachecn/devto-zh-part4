...
> 原文:[https://dev . to/GK sander/enforcing-rules-in-js-with-getter-and-setter-1 plk](https://dev.to/gksander/enforcing-rules-in-js-with-getters-and-setters-1plk)
...
## [](#example-a-rectangle-with-a-fixed-perimeter)举例:周长固定的矩形

### [](#a-little-scratch-work)一点点擦伤的工作
...
[![](../Images/942d29c3730ea4ca2b31c77360a6daeb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JE5W-b_f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/38qe9jxi3wkh3p1pcg3r.png)
...
### [](#coding-our-rectangle-rules)编码我们的矩形规则
...
### [](#adding-bumpers-to-our-dimensions)给我们的尺寸增加“保险杠”
...
## [](#using-our-class-with-vue)用 Vue 使用我们的类
