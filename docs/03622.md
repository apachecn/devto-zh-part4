...
> 原文:[https://dev . to/vyasriday/这到底是什么 javascript-37n1](https://dev.to/vyasriday/what-the-heck-is-this-in-javascript-37n1)
...
### [](#an-analogy-to-understand-scope-in-javascript)比喻理解 JavaScript 中的作用域
...
#### [](#what-do-you-think-which-approach-can-have-bad-consequences)你认为哪种做法会产生不好的后果？？
...
#### [](#what-endraw-this-raw-actually-is)究竟什么是`this`？

在 JavaScript 中,`this`是函数内部或作用域中的一个`object`,它可以是任何值，这取决于函数是如何定义或如何调用的。

让我们在不同的背景下理解这一点

### [](#case-1-default-this-binding)情况 1 -默认此绑定
...
### [](#case-2-implicit-binding)案例二:隐式绑定
...
### [](#case-3-binding-endraw-this-raw-with-endraw-apply-raw-)案例三:`this`与`apply`绑定
...
### [](#case-4-the-endraw-new-raw-keyword)案例四:`new`关键词
