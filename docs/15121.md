...
> 原文:[https://dev.to/areknawo/ecmascript-2019-and-beyond-12c6](https://dev.to/areknawo/ecmascript-2019-and-beyond-12c6)
...
你现在可能知道了(可能是因为以前和 Babel 一起工作的缘故)，ECMAScript 规范是由不同的[](https://github.com/tc39/proposals)**提案产生的。每个提案需要经过 5 个不同的阶段...**
...
## [](#dynamic-import)[【动态导入()】](https://v8.dev/features/dynamic-import)
...
## [](#bigint)[BigInt](https://v8.dev/features/bigint)
...
## [](#private-class-fields)[私有类字段](https://v8.dev/features/class-fields)
...
所以，这篇文章到此为止。考虑在 Twitter 上关注我的[](http://twitter.com/areknawo)**[**，在我的脸书页面**](http://facebook.com/areknawoblog) ，或者查看我的个人博客 获取更多精彩内容。一如既往，祝您愉快！*****