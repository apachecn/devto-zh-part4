...
> 原文:[https://dev . to/Mr _ CEA/using-redis-for-token-in-node-js-42g 7](https://dev.to/mr_cea/using-redis-for-token-blacklisting-in-node-js-42g7)
...
#### [](#why-use-inmemory-instead-of-database)为什么用内存代替数据库
...
### [](#using-redis-for-validating-token-in-node)使用 Redis 验证节点中的令牌
...
### [](#using-redis-for-blacklisting-in-node)使用 Redis 将节点列入黑名单
