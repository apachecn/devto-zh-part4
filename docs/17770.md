...
> 原文:[https://dev . to/Stephen fluin/the-differences-between-function-and-arrow-functions-4663](https://dev.to/stephenfluin/the-differences-between-function-and-arrow-functions-4663)
