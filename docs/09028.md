...
> 原文:[https://dev . to/morin oko/dynamic-method-handling-with-method missing-and-respond to missing-in-ruby-and-rails-oac](https://dev.to/morinoko/dynamic-method-handling-with-methodmissing-and-respondtomissing-in-ruby-and-rails-oac)
...
# [](#background-amp-original-code)背景&原码
