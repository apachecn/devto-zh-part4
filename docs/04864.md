...
> 原文:[https://dev . to/getd/express-middleware-is-just-a-fancy-way-of-chaining-a-bunch-of-functions-explained-in-3-mins-43jf](https://dev.to/getd/express-middleware-is-just-a-fancy-way-of-chaining-a-bunch-of-functions-explained-in-3-mins-43jf)
...
# [](#middleware-function-with-raw-next-endraw-)中间件==功能同`next()`
...
# [](#example-1-require-user-authentication-for-certain-routes)例 1:某些路由需要用户认证。
...
# [](#example-2-require-user-authentication-for-all-routes)例 2:所有路由都需要用户认证。
...
# [](#example-3-parse-json-request-body-into-object)例 3:将 JSON 请求体解析成对象。
...
# [](#example-4-configurable-middlewares)示例 4:可配置中间件
