...
> 原文:[https://dev . to/bnevilleoneill/anomalies-in-JavaScript-arrow-functions-2 afh](https://dev.to/bnevilleoneill/anomalies-in-javascript-arrow-functions-2afh)

[![](../Images/c6256751797a5834789fe3d5e260dffe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XBnpgKSH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jmlh0u81ofjptar1pgfn.jpg)
...
## [](#named-function-parameters)命名函数参数
...
### [](#how-do-arrow-functions-treat-duplicate-parameters)箭头函数如何处理重复的参数？
...
### [](#what-are-you-getting-wrong)你怎么回事？
...
### [](#can-you-do-this-differently)能不能换个方式做这个？
...
### [](#so-what-about-arrow-functions)那么箭头函数呢？
...
### [](#what-can-you-do-to-fix-the-raw-this-endraw-binding)你能做些什么来修复`this`绑定？
