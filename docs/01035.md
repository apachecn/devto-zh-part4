...
> 原文:[https://dev . to/muneerzargar/JavaScript-primitive-values-vs-reference-values-ways-to-fix-object-mutability-3n JB](https://dev.to/muneerzargar/javascript-primitive-values-vs-reference-values-ways-to-fix-object-mutability-3njb)
...
[![Stack Representation](img/02acf57542cd2948779a6175180150e7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--goQbXM65--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fky42ddyy446sa4tdcib.png)
...
[![what gif](img/e9ca48d70e7973a069acea9d3c87561b.png)T2】](https://i.giphy.com/media/10JLZFAZ7AomjK/giphy.gif)

在这里，我们看到两个对象包含与属性相关的相同值，这是因为对象以特殊方式处理，即堆栈上的内存块保存该对象的内存地址(指针),该地址又存储在堆中。

[![Heap Representation](img/b7a75e53767843ac7b65c97347319f6a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MBwTHfvZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cexq4xbs2uvj6h6baka6.png)
...
[![Fix that gif](img/c795e48a3c6af9a9fc7902319feebae8.png)T2】](https://i.giphy.com/media/PrEUkNFD9pN2o/giphy.gif)
