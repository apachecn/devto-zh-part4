...
> 原文:[https://dev . to/anssamghezala/how-to-build-your-reusable-component-1 MCB](https://dev.to/anssamghezala/how-to-build-your-reusable-component-1mcb)
...
# [](#building-the-table-component)构建表格组件
...
# [](#feature-1-making-a-table-that-acts-exactly-like-the-html%C2%A0table)特性#1:制作一个和 html 表格完全一样的表格。

假设您想要显示以下数据:

[![](../Images/06f6200eb3fe043e40aa2fb22d8e3ff9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P8XdHSns--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AtOz0B4iHAa2QyIQ9acIGyQ.png)

有两种方法可以做到:

## [](#1-using-the-table-exported-components)1-使用表导出组件
...
## [](#2-using-a-data-prop%C2%A0object)2-使用数据道具对象
...
# [](#feature-2-adding-styles-to-our-table-and-making-it-styles-customisable)功能#2:向我们的表格添加样式，使其成为“可定制的样式”
...
# [](#feature-3-adding%C2%A0themes)功能三:添加主题

现在让我们添加一个预构建的主题化系统，用户可以用它来设计表格的样式。我们将做两个简单的主题:黑暗和光明。

[![](../Images/c8348cb2905181e2c6f4dd72ad05de38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z4-YjmOx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://miro.medium.com/max/1400/1%2AwrD1LD7rNKopu4lRHdtqfw.gif)
...
# [](#feature-4-display-density)特性#4:显示密度
