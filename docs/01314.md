...
> 原文:[https://dev . to/Allen ball/adding-support-to-Java-invocation handler-implementations-for-interface-default-methods-h64](https://dev.to/allenball/adding-support-to-java-invocationhandler-implementations-for-interface-default-methods-h64)
