...
> 原文:[https://dev . to/gite den/how-we-share-and-reuse-code-between-bit-3 fek](https://dev.to/giteden/how-we-share-and-reuse-code-between-microservices-with-bit-3fek)

### [](#how-we-effectively-share-and-sync-code-between-our-nodejs-microservices-without-compromising-their-independence-or-creating-coupling-using-bit)我们如何使用[位](https://bit.dev/)在 Node.js 微服务之间有效地共享和同步代码，而不损害它们的独立性或产生耦合。
...
### [](#sharing-code-between-services)服务间共享代码
...
### [](#example-our-userauthentication-middleware)例子:我们的用户认证中间件

[![Our express/user-auth component synced in multiple services](../Images/10cb4fd1383f12579f37cfbc9f2428bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fA03M-31--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1000/1%2AAKFDQhTEQEriFsE19rseBg.png)
...
### [](#why-this-is-more-helpful-to-us-than-npm-modules)为什么这比 NPM 模块对我们更有帮助
...
### [](#is-it-ok-to-share-servicespecific-code)可以共享服务特定代码吗？
...
[![A React Hero Component with Bit](../Images/62c441229976a5c80bc06abc8f2a4eec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KDP14N7y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1000/1%2AEW7hjct1RduBrJj43xHO5g.png)