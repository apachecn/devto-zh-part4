...
> 原文:[https://dev . to/eice blue/create-read-and-remove-bulleted-and-numbered-lists-in-word-in-Java-16co](https://dev.to/eiceblue/create-read-and-remove-bulleted-and-numbered-lists-in-word-in-java-16co)

## [](#introduction)简介

Microsoft Word 提供了项目符号和数字来帮助我们将 Word 文档中的项目列表整理得井井有条。本文演示了如何在 Word 文档中添加项目符号和编号列表，然后在 Java 应用程序中读取和删除 Word 文档中的项目符号和编号列表。

## [](#the-library-we-need)我们需要的库
...
输出:
[![](../Images/649e99708059e60cd20839ec52370e21.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--y2X9YEyk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nzemgfnzjd471uscw6hi.png)
...
输出:
[![](../Images/aefd611576124c3c7786c01ecad8dc47.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--XSdMP7AW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2gde2bqg04nc30gcxw94.png)
...
输出:
[![](../Images/0cc965019aeef588cec4b3fe270d9962.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--uKu-UWG6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ug3w49rcgid9ntvvvq25.png)
...
输出:
[![](../Images/8ca99a2144cf5fa1d90595689e2bdecc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--byA5jTHU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8w7q8d4wuah803kuxrhr.png)
