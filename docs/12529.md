...
> 原文:[https://dev . to/mimafogeus 2/your-buttons-get-wider-on-how-how-to-solve-this-4bhi](https://dev.to/mimafogeus2/your-buttons-get-wider-on-hover-because-you-change-their-font-weight-here-s-how-to-solve-this-4bhi)

**所以，**不久前，我不得不实现一个设计，要求按钮在悬停时改变它们的`font-weight`。这里有一个问题:

[![Example of a jumpy button](../Images/7ed1097ae33714adc48bf1a2e9933b65.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PbOTBlFt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u6r9z0ftiy010hz7dqbg.gif)
...
# [](#duplicate-the-label-with-css)用 CSS 复制标签
...
### [](#the-button-itself-wasnt-changed-much)按钮本身没怎么变:
...
# [](#example-implementation-in-react)示例:React 中的实现
