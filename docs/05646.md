...
> 原文:[https://dev.to/sematext/sematext-experience-is-here-2lm6](https://dev.to/sematext/sematext-experience-is-here-2lm6)
...
[![](../Images/6c2208beedcf8edc16c455a6fa727573.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eqA_KoRQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/08/experience-app.png)
...
## [](#overview-of-sematext-experience-capabilities)语义体验能力概述
...
## [](#benefits-of-sematext-experience-amp-feature-rundown)语义体验的好处&功能概述

### [](#get-alerts-when-performance-is-affecting-ux)当性能影响 UX 时获得警报

您可以根据页面负载、HTTP 请求或页面事务 Apdex 分数设置实时警报。当你的分数从优秀变得很差时，你希望你的开发者注意到这一点。

### [](#singlepage-application-support)单页面应用支持
...
### [](#single-score-to-rule-them-all)单分统治一切

我们使用 Apdex 评分快速向网站所有者传达访问者对网站性能的看法。

[![](../Images/c516d74cf4215048acd70f73d2bffd1a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PTHuwUCx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/08/apps.sematext.com_ui_rum_25840_overview.png)
...
### [](#record-any-ui-interaction-with-onpage-transactions)记录任何 UI 与页面上事务的交互
...
### [](#inspect-individual-sessions)检查单个会话

Sematext Experience 允许您检查单个会话，并查看页面加载事件、页面上事务和会话期间发出的 HTTP 请求的时间线。该会话还包括用户信息和元数据，如浏览器信息、地理位置等。

[![](../Images/6600885d17c108b7ff46ba60fcc3e18a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SacNhFkx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/08/apps-local.sematext.com_3000_.png)

### [](#inspect-performance-data-from-a-highlevel-overview-to-individual-requests)从高级概述到单个请求检查性能数据
...
[![](../Images/9f96225e6baa2e51fdebede76d204055.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4j0mDmsj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/08/filters.png)
