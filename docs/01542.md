...
> 原文:[https://dev . to/jmfayard/what-does-JavaScript-better-than-kot Lin-3l6d](https://dev.to/jmfayard/what-does-javascript-better-than-kotlin-3l6d)
...
科特林也有[对象析构](https://kotlinlang.org/docs/reference/multi-declarations.html#destructuring-declarations)T2】
