...
> 原文:[https://dev . to/bright devs/how-to-clear-database-in-spring-boot-tests-4mab](https://dev.to/brightdevs/how-to-clear-database-in-spring-boot-tests-4mab)
...
# [](#cleaning-database-with-sql)用 SQL 清理数据库
