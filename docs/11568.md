...
> 原文:[https://dev . to/swim burger/how-to-ui-test-using-selenium-and-net-core-on-windows-Ubuntu-and-maybe-MAC OS-50ec](https://dev.to/swimburger/how-to-ui-test-using-selenium-and-net-core-on-windows-ubuntu-and-maybe-macos-50ec)
...
## [](#1-creating-the-net-core-test-project)1。创建。网络核心测试项目
...
## [](#2-add-selenium-to-the-test-project)2。将硒添加到测试项目中
...
## [](#3-write-a-ui-test-using-selenium)3。使用 Selenium 编写一个 UI 测试
