...
> 原文:[https://dev . to/gite den/a-guide-to-component-driven-development-cdd-1fo 1](https://dev.to/giteden/a-guide-to-component-driven-development-cdd-1fo1)

### [](#let-components-drive-the-development-of-your-applications)让组件驱动你的应用开发。

[![](img/8f6178fa1be2dc9e7f4e8aba5825aea8.png "Isolate. Share. Collaborate. Reuse.")T2】](https://bit.dev)
...
## [](#ui-component-driven-development)UI 组件驱动开发
...
## [](#tools-for-component-driven-development)构件驱动开发的工具
...
### [](#component-development-and-collaboartion-bit)组件开发与协作:Bit
...
### [](#ui-component-explorers-storybook-and-styleguidist)UI 组件资源管理器:StoryBook 和 Styleguidist
...
[![](img/3dff8f482cd5f544582c7d74dc9562a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z0EPfJd9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/4312/1%2A8T0opytn0oYuEMpd8PRTsw.gif)
...
[![](img/349a65517177df444402790c506782b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9Z5q4jcs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/2412/1%2A9V2nSEgH1VUbmXd5Dq-hnA.gif)
...
## [](#architectures-of-component-driven-development)构件驱动开发的架构
...
### [](#why-build-a-library)为什么要建图书馆？

所以事实是这样的。Git 存储库不是为项目间共享的原子组件而构建的。包经理也不是。两者都是为仓库而建的。组件不是存储库。

[![](img/b48db9212fc64de680416f54bcea19eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fos8GWVP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AZ6sxp1OBjNRt9SEUvKljSw.jpeg)
...
## [](#7-keys-to-building-a-good-cdd-oriented-ui-library)打造一个好的面向 CDD 的 UI 库的 7 个关键

[![](img/a3f305d4494d6416da3736df36022322.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ibln6HRc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A-xfmjoUi0rWe52Gje-3QJw.jpeg)
...
[![](img/45d8cc0df4cee62b4c04d35ac413dba7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LadA_QQR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AqbDzKo9cg7oTnoERAodd6Q.png)
