...
> 原文:[https://dev . to/samthor/Google-assistant-now-supports-open-close-devices-2512](https://dev.to/samthor/google-assistant-now-supports-open-close-devices-2512)
