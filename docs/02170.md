...
> 原文:[https://dev . to/azure/shift-your-node-express-APIs-to-server less-b87](https://dev.to/azure/shifting-your-node-express-apis-to-serverless-b87)
...
[![Shifting to Serverless](img/a54bcea8a6e5eedc940eaffbdd398cb4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CJPRHQUM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1etett7tpuyeutfj00zr.jpg)
...
## [](#planning-the-shift-to-serverless)计划向无服务器转变
...
## [](#about-the-sample-project)关于样本项目
...
## [](#node-and-express-apis)节点和 Express APIs
...
[![Tour of Heroes](img/1d521bb70d4cdc7a17f674abed392aff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eqwLZYky--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bp83wqpwc4ne6lot6x8d.jpg)

### [](#run-and-debug-the-express-app)运行并调试快递 App
...
[![Debugging Angular](img/71e8885dee793fed9d3d7668ab3b62dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jFibXBvj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ak08usxnehfpgfj8vg9a.jpg)

这里，调试器在 Express 应用程序中的断点处停止。

[![Debugging Express](img/76ac56dd02973607b5aa4efb09e1ffcf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mCcoxu61--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z328yfch0tflkw46wk88.jpg)

> 文件*。vscode/launch.json* 和*。vscode/tasks.json* 是该项目的调试体验不可或缺的一部分。我鼓励您探索这些文件，并为自己的目的复制/重构它们的内容。

## [](#making-the-shift)制造转移
...
### [](#express-azure-functions)快递👉Azure 函数
...
### [](#shifting-routes-create-your-first-function)移动路线-创建您的第一个功能
...
### [](#data-shift-the-services-to-serverless)将服务数据转移到无服务器
...
#### [](#shift-the-code-from-express-to-functions)将代码从 Express 转移到 Functions
...
### [](#create-the-remaining-functions)创建剩余功能
...
### [](#looking-at-the-functions-app)查看功能 App
...
## [](#debug-node-express-and-angular)调试节点表达和角度
...
[![Debugging Azure Functions](img/ef17cabe38f70a77c76b831dee293222.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lgMpQg0u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2l27psjcsqyh8f2u32ls.jpg)

> 以防你错过了这些文件*。vscode/launch.json* 和*。vscode/tasks.json* 是该项目的调试体验不可或缺的一部分。我鼓励您探索这些文件，并为自己的目的复制/重构它们的内容。

## [](#optional-remove-the-express-app)可选-删除快递 App
