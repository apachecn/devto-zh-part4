...
> 原文:[https://dev . to/kiarathedev/understanding-js-ternary-operators-5 epi](https://dev.to/kiarathedev/understanding-js-ternary-operators-5epi)
...
[![overwhelmed](../Images/2b18f526a4d3393ca0b02f598797998b.png)T2】](https://i.giphy.com/media/oubM1tKqnLW5G/giphy.gif)

不要担心！条件(三元)操作符可以很容易使用，并将简化您的代码，即使只是一点点。

### [](#what-do-ternary-operators-represent)三元运算符代表什么？
