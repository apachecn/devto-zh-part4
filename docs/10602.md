...
> 原文:[https://dev . to/yakimych/when-typescript-lies-and-how-make-it-honest-305 b](https://dev.to/yakimych/when-typescript-lies-and-how-to-make-it-honest-305b)
...
## [](#when-typescript-lies-api-responses)当类型脚本说谎时— API 响应
...
[![Intellisense provides potentially unreliable type information](../Images/bae5d9b2bbad0555418bb21127115acd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jRp4eIVT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ihlhoo63apnpux40um8f.png)
...
[![An object that cannot be undefined according to the type system is undefined at runtime](../Images/388264dd3238c069194381a9ccd98af6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2jsMrpgy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ecttt7yn3r64prrneybk.png)
...
## [](#when-typescript-lies-jsonparse)当 TypeScript 说谎时— JSON.parse()
...
[![Intellisense tells us getDate() exists and is safe to use, but it crashes at runtime](../Images/ef77135204001f0fae5bdc2844eef190.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jaCpiZ1I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m21cdrn2rv2znkss415z.png)

[![Runtime errors when trying to call getDate() on an actual string](../Images/4d59d52011a3d57d66fa0a980e2c525b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jpa2v3Es--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u9cfnrojm6eh1i49domf.png)
...
## [](#how-to-make-it-honest)如何做到诚实

有几种方法可以缓解这些问题——有些需要更多的魔法，有些需要更多的代码。

### [](#the-less-magical-approach)不太神奇的方法
...
[![The type system prevents us from returning undecoded JSON](../Images/f1e3dc404e571f602b1a7ed648f70acc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--sxWxR5_4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4m2f89i5r5g53ejmq8b7.png)T3】
...
[![If we get to the return statement in runtime, the type is guaranteed to be correct according to TypeScript](../Images/469eac9bddbc7b5e5b81151519e76ced.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tE1lzi2N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/56bhdb7ppsq1o9cpaqz0.png)
...
### [](#the-magical-approach)采用“神奇”的方法
...
### [](#the-crazybutfun-approach)“疯狂但有趣”的方法
