...
> 原文:[https://dev . to/hallessandro/create-a-http-server-with-python-e25](https://dev.to/hallessandro/create-a-http-server-with-python-e25)
...
### [](#create-a-http-server)创建一个 HTTP 服务器
...
[![Alt Text](img/913f43ca1d3991575e1f8ca3a909c6cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cFAgJeoL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7gn01sex96ergck4lrob.png)
