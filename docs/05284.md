...
> 原文:[https://dev . to/unbug/swift-and-JavaScript-comparison-snippets-collection-types-548 p](https://dev.to/unbug/swift-and-javascript-comparison-snippets-collection-types-548p)
...
### [](#mutability-of-collections-arrays)集合的可变性:数组
