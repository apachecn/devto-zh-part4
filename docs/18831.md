...
> 原文:[https://dev . to/mjraadi/sanity-tip-for-JavaScript-devs-learn-to-run-asynchronous-functions-in-array-map-44b 7](https://dev.to/mjraadi/sanity-tip-for-javascript-devs-learn-to-run-asynchronous-functions-in-array-map-44b7)
...
### [](#why-use-asynchronous-function-inside-raw-arraymap-endraw-)为什么在`Array.map()`里面使用异步函数
...
### [](#the-solution-raw-promiseall-endraw-)解:`Promise.all`
