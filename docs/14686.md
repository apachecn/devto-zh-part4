...
> 原文:[https://dev . to/riccardoodone/scripting-in-haskell-and-pure script-5c IC](https://dev.to/riccardoodone/scripting-in-haskell-and-purescript-5cic)
...
## [](#haskell-stack-scripting)Haskell 堆栈脚本
...
## [](#a-nontrivial-haskell-stack-script)一个非平凡的 Haskell 堆栈脚本
