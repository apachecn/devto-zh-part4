...
> 原文:[https://dev . to/blakec/exploring-the-helm chart-custom-resource-in-k3s-2l 52](https://dev.to/blakec/exploring-the-helmchart-custom-resource-in-k3s-2l52)
...
### [](#helmchart-resource-raw-spec-endraw-)HelmChart 资源`spec`
...
## [](#creating-a-helmchart)创建 HelmChart
...
## [](#installing-a-helmchart)安装 HelmChart
...
### [](#installing-via-kubectl)通过 kubectl 安装
...
### [](#installing-using-autodeploying-manifests)使用自动部署清单安装
...
### [](#installation-process-under-the-hood)引擎盖下的安装流程
...
### [](#verifying-the-chart-installation)验证图表安装
...
## [](#updating-a-helmchart)更新 HelmChart
...
## [](#deleting-a-helmchart)删除 HelmChart
