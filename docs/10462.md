...
> 原文:[https://dev . to/macmacky/how-to-configure-web pack-and-vue-from-the-ground-up-4c 19](https://dev.to/macmacky/how-to-configure-webpack-and-vue-from-the-ground-up-4c19)
...
我们的**index.html**文件。
T3![HTML File](../Images/79272b4fe56d4f5a4b9dc2809fc2c065.png)T5】

我们的 **webpack.config.js** 文件。
T3![Webpack Config](../Images/09758d57e466c2d027ad2fa365e37864.png)T5】
...
我们的 **app.js** 文件。
T3![App.js](../Images/cd6cf1e4543d5374e2cbbfd3e1a613d8.png)T5】
...
我们的 **Main.vue** 文件。
T3![Main.vue](../Images/e321683a5fe98265e2b92b7e1cb73ade.png)T5】

我们的 **package.json** 文件。
T3![package.json](../Images/7a742c78ec8ddbc7d76a399b424eafe1.png)T5】
...
[![Home](../Images/46033b00dfbd9c91450880a9b1656561.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--GAzych5x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2zf3n6oz88qpsldmlkkl.png)
[![About](../Images/50c799aeefc7cc1f7f4a57f52ca9b053.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--j40fKxpT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lc4ymaq9j0c4mg407qgm.png)
[![Contact](../Images/e6465a3c7d1d29e22873cc5f76037fd3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--bslttKQk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/52p1dr5pn2ytqb4mulad.png)

我们修改的 **Main.vue** 文件。
T3![Modified Main](../Images/56b861076580ed9a67cbf8235ac0a56e.png)T5】

在根文件夹中创建一个 router.js 文件。
[![router.js](../Images/18cd0fb3bad65c87eadedbde9b6ff074.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--Hbv7sOwJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xmk18d4s63e3mbzbepsm.png)

我们修改的 **app.js** 文件。
T3![Modified app.js](../Images/c44812959887f5ccfd56a19074dafb51.png)T5】

再次运行 **npm start** 命令。

#### [](#thanks-for-reading-this-post)感谢阅读本帖。

### [](#have-a-nice-day-everyone-smiley)祝大家愉快😃。