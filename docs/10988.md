...
> 原文:[https://dev.to/_staticvoid/entendendo-async-iterators-1opo](https://dev.to/_staticvoid/entendendo-async-iterators-1opo)
...
### [](#for-await-e-nodejs)为 Await e Node.js
...
### [](#iterando-ass%C3%ADncronamente)异步迭代
