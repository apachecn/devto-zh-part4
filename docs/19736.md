...
> 原文:[https://dev . to/samvloeberghs/lessons-learned-on-offline-capabilities-with-service-workers-using-work box-143m](https://dev.to/samvloeberghs/lessons-learned-on-offline-capabilities-with-service-workers-using-workbox-143m)
...
## [](#what-will-we-discuss-in-this-post)本帖我们会讨论什么？
...
## [](#serve-the-raw-indexhtml-endraw-for-all-deeplinks-while-offline)为所有深度链接提供`index.html`(离线时)
...
### [](#service-worker-active-during-firsttime-usage-of-your-application)首次使用您的应用程序时处于活动状态的服务人员
...
## [](#avoid-using-global-state-in-the-service-worker)避免在服务工作器中使用全局状态
...
### [](#now-what-was-going-wrong)现在出了什么问题？
...
### [](#so-how-to-correctly-share-the-raw-oauthtoken-endraw-with-the-service-worker)那么如何正确的与服务人员分享`OAuthToken`？
