...
> 原文:[https://dev.to/pheeria/css-battle-4-ups-n-downs-46i5](https://dev.to/pheeria/css-battle-4-ups-n-downs-46i5)

这张很漂亮。三次形状都一样，只是方向和位置不同。让我们把它作为第一个解决方案。

## [](#1-absolute-positions)1。绝对位置
...
## [](#2-using-marginpadding)2。使用边距/填充
