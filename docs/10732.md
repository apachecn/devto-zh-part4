...
> 原文:[https://dev.to/lankydandev/corda-flows-can-do-anything-17a8](https://dev.to/lankydandev/corda-flows-can-do-anything-17a8)
...
### [](#retrieving-a-value-from-a-service)从服务中检索值
...
### [](#calling-code-inside-the-node-to-reduce-code-duplication)在节点内部调用代码，减少代码重复
...
### [](#executing-logic-that-cant-be-done-via-rpc)执行不能通过 RPC 完成的逻辑
