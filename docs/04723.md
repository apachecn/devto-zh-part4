...
> 原文:[https://dev . to/Rubin/resolving-path-alias-in-nestjs-projects-11o 1](https://dev.to/rubiin/resolving-path-alias-in-nestjs-projects-11o1)
...
# [](#path-mapping-to-the-rescue)路径映射到救援！
