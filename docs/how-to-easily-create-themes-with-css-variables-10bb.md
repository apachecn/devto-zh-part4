...
> 原文：<https://dev.to/scrimba/how-to-easily-create-themes-with-css-variables-10bb>
...
> 我还在我的免费 8 部分 CSS 变量课程中创建了一个关于主题创建的截屏。
...
[![](img/0dadb1b5bcfbc8fe5972d38650e0ff3d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--AJSnBI70--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AEu0wU_hiyqOqrhyxNamvsg.png)
...
如果你正在努力理解这里发生的事情，请查看我的[5 分钟学会 CSS 变量的文章](https://medium.freecodecamp.org/learn-css-variables-in-5-minutes-80cf63b4025d)，或者报名参加[课程。](https://scrimba.com/g/gcssvariables?utm_source=dev.to&utm_medium=referral&utm_campaign=gcssvariables_create_themes)
...
我们之前解决这个问题的方法是为`.featured`项中的每个元素创建一个定制的 CSS 选择器，就像这样:
...
然而，有了 CSS 变量，事情就变得简单多了。我们将简单地覆盖`.featured`类中的变量，就像这样:
...
[![As you can see, the ‘project d’ item looks a bit different than the rest.](img/2e89cacf361d35e00f16a779439b3f00.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--aFsTLvzf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AQYSniAuCy5MkF202RvMUDQ.png)
