...
> 原文:[https://dev . to/m _ aamir/a-brief-introduction-to-Java-lambda-expressions-2p3f](https://dev.to/m_aamir/a-brief-introduction-to-java-lambda-expressions-2p3f)
...
#### [](#lambda-expressions-also-allow-you-to-capture-variables)Lambda 表达式也允许你捕捉变量。
...
##### [](#instance-variable-capture)实例变量捕获
...
##### [](#static-variables-capture)静态变量捕捉
...
##### [](#applying-a-transformationmap-function-across-an-array-or-a-list)对数组或列表应用变换/映射函数
...
##### [](#filter-names-based-on-starting-character)根据起始字符过滤名称
