...
> 原文:[https://dev.to/zenika/immutability-in-javascript-2b6h](https://dev.to/zenika/immutability-in-javascript-2b6h)
...
### [](#highlighted-by-modern-frameworkslibraries)现代框架/库所强调的
...
### [](#why-do-we-need-utility-libraries)我们为什么需要实用程序库？
