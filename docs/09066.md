...
> 原文:[https://dev . to/naimlatifi 5/understanding-this-in-JavaScript-cm2](https://dev.to/naimlatifi5/understanding-this-in-javascript-cm2)
...
#### [](#-raw-this-endraw-with-arrow-function-gt)`this`带箭头功能= >
