...
> 原文:[https://dev . to/t 04 glovern/AWS-robo maker-初学者-机器人指南-模拟-4hgi](https://dev.to/t04glovern/aws-robomaker-beginner-s-guide-to-robot-simulation-4hgi)
...
## [](#just-like-the-simulations)就像模拟一样
...
[![ROS over VNC 1](img/63bb2c3f05373a1922366cd0ba83edf3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3YW4cjAx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fskf1ennu1f13dab29hr.png)

## [](#simulating-locally)局部模拟
...
[![ROS over VNC 2](img/1719264da43f84add00072c5f0d61102.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wuu6Sb-_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zc5e702y2mru6az52fhh.png)

### [](#execute-simulation-locally)本地执行模拟
...
[![ROS over VNC 3](img/d961953b5421499280eb459797fb28c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ram5RKXq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/knnjziysr4awufotm1o9.png)

### [](#viewing-simulation-locally)本地查看模拟
...
[![ROS over VNC 4](img/ee12999517d6aded86d51bff2f1ad5c4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qjGYplMP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aps5odzwoehppaxs3fn7.png)

和基本显示类型中的机器人状态

[![ROS over VNC 5](img/470916fe7b7a89f5c61137c7f427fe7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M1XMAV_f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/50trax7aeo05714yooez.png)

四处游玩，添加一些其他可选显示器。下面是一个`Camera`和`LaserScan`数据的例子。

[![ROS over VNC 6](img/77417088c4fd0813daa01df46860597e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tDdutMeh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0lc89et3mrzegb19kq2b.png)

完成后，关闭 RViz，让我们进入下一步。

## [](#simulating-on-robomaker)在机器人身上模拟
...
### [](#robomaker-simulation-job)RoboMaker 模拟作业
...
[![ROS over RoboMaker 1](img/10c93075a728923b5848e5c77706a0d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--abhmBeDI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zlkrkx9cyjw5pdqqpia8.png)

现在，您应该能够在 3D 空间中与模拟进行交互。

[![ROS over RoboMaker 2](img/115ff83271f8ee613f30f0e8fef63f89.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nAO9vQoO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8yrxt9bqgxxarmg6k5hy.png)
