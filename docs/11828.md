...
> 原文:[https://dev . to/mongo park/optimize-the-hell-out-of-your-JavaScript-programs-with-memo ization-11l 8](https://dev.to/mongopark/optimize-the-hell-out-of-your-javascript-programs-with-memoization-11l8)
...
[![Confused now.gif](../Images/1d609ca25edd070bc09d604c797b8145.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4wANSVZ0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1563864716681/8a81fZvfH.gif)

那是我第一次思考最优化的概念。

如果你是好奇型的，运行未优化的递归斐波纳契数列，数列最大为 50.....明天见！😃

## [](#so-what-is-optimization)那么什么是优化呢？
...
## [](#a-memoized-fibonacci-function)记忆化的斐波那契函数。
...
## [](#comparing-performance-with-raw-perfhooks-endraw-)与`perf-hooks`对比表现。
