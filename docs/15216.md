...
> 原文:[https://dev . to/giladmaayan/from-devo PS-to-devsecops-how-to-make-the-move-2eio](https://dev.to/giladmaayan/from-devops-to-devsecops-how-to-make-the-move-2eio)

[![](../Images/0b9b42b6b61aef014991f2ad0bb93400.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Qgjqg9D6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4tkrstlerh9z6mdy64k6.jpg) 
...
## [](#what-is-devsecops)什么是 DevSecOps？
...
## [](#why-should-you-make-the-move-to-devsecops)您为什么应该迁移到 DevSecOps？
...
## [](#3-key-elements-to-consider-when-making-the-move)采取行动时要考虑的 3 个关键因素

### [](#1-continuous-feedback-loop)1。连续反馈回路
...
## [](#other-key-steps-for-successful-devsecops-implementation)成功实施 DevSecOps 的其他关键步骤
