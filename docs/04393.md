...
# [](#5-diret%C3%B3rio-raw-aws-endraw-arquivo-de-configura%C3%A7%C3%A3o-e-credenciais-para-v%C3%A1rios-perfis-dev-e-prod)5。`~/.aws`目录-多个配置文件(Dev 和 Prod)的配置文件和凭据
