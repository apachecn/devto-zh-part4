...
> 原文:[https://dev . to/vladimirnovick/custom-auth-for-hasura-with-netlify-205](https://dev.to/vladimirnovick/custom-auth-for-hasura-with-netlify-205)
...
#### [](#setting-up-our-hasura)设置我们的 Hasura
...
## [](#getting-users-into-hasura)让用户进入 Hasura

在这一部分，我们将确保在注册时，用户将被写入用户表。

#### [](#create-netlify-site)创建网络生活网站
...
## [](#creating-custom-auth-webhook)创建自定义认证 webhook
...
[![](../Images/6d8adcbcb6d89010ecceb1711a5ba663.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LZJA2NXB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5ntchflu6qy51fwazyyv.jpg)
