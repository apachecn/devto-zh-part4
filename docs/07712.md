...
> 原文:[https://dev . to/trilon/learn-how-to-deploy-nestjs-server less-apps-to-azure-functions-df8](https://dev.to/trilon/learn-how-to-deploy-nestjs-serverless-apps-to-azure-functions-df8)

> **最初发表于 [Trilon 博客](https://trilon.io/blog/deploy-nestjs-azure-functions)由[Kamil Mysliwiec](https://twitter.com/kammysliwiec)T5】**

## [](#deploy-nestjs-to-production-series)将 NestJS 部署到生产系列:
...
# [](#serverless-nestjs-with-microsoft-azure)微软 Azure 无服务器 NestJS
...
## [](#what-are-azure-functions-)什么是 Azure 功能？
...
## [](#getting-nestjs-setup)获取 NestJS 设置
...
# [](#introducing-nestjs-azure-functions-schematics)📯NestJS Azure 功能示意图简介
...
# [](#installing-nestjs-azure-functions-schematics)安装 NestJS Azure 功能示意图
...
## [](#local-azure-functions-development)本地 Azure 功能开发
...
#### [](#open-up-that-url-raw-httplocalhost7071api-endraw-in-your-browser-you-should-see)在浏览器中打开网址`http://localhost:7071/api/`，你会看到:

<figure>[![NestJS Azure Functions local development](../Images/5d2a5f940a73894182f338f7ff72df13.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--piAC5fTx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m1equa78t9lgr7w4oi3m.png)
...
[![NestJS globalPrefix](../Images/2faa510f2e458d11ad01a3995ef3392b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1QTldL92--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f3g0w6o8eaknaz5xvllo.png)
...
# [](#deploying-nestjs-to-azure-functions)将 NestJS 部署到 Azure 函数
...
## [](#install-the-azure-functions-vscode-extension)安装 Azure 功能 VSCode 扩展
...
[![VSCode Extensions - Install Azure Functions](../Images/ba287bb5c6533b317c43a6047f17d802.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rXlsJDMQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q3150mqwek6eafmq2gpc.png)

一旦安装完毕，你会注意到在*左侧*工具条上有一个新的**图标**，选择它打开 Azure 功能选项。

**1。登录或注册(到 Azure)**

[![VSCode Extension - Azure Functions](../Images/60258f005feba1b2765ea8e39f8037b9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F9Ze2U7W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5894y83ebngo6lsdfux5.png)

**2。点击“部署到功能应用”* *箭头**图标，选择“在 Azure 中创建新的功能应用”。**

[![VSCode Extension - Azure Functions](../Images/8d3cbc46164369655dfe04574442f6b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--catVDM9---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rbieelzu71n5oisosusl.png)

**3。为您的 Azure 函数选择一个唯一的名称，然后按 Enter。**

> **注意**:这一步可能需要一些时间，因为它将创建存储组和您的新功能应用。未来的部署会快得多，不用担心！:)

[![Deploying Azure Function](../Images/d317eba91175470f246c3aeee13b2226.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F1dvkzSH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q0ddxsu6xr29clehb34c.png)
...
# [](#serverless-nestjs-deployed-to-the-%E2%98%81-)无服务器 NestJS 部署到☁！
...
[![Deploy NestJS to Azure Function live demo](../Images/e089a00e415eed54a36b9f87bd60863a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n1WDOz17--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6ckwu3xbu4j12ulk3cw9.png)
