...
> 原文:[https://dev . to/gajesh/all-you-need-to-know-on-python-virtual-environments-29l 8](https://dev.to/gajesh/all-you-need-to-know-about-python-virtual-environments-29l8)

几乎每个参与过任何项目并使用过 python 包的人都不得不处理不同分支和项目中不同版本的包。虚拟环境使这一过程变得更加容易。

## [](#why-shouldnt-i-install-python-packages-directly-on-my-system)为什么我不应该直接在我的系统上安装 python 包？
...
### [](#creating-and-working-with-a-project)创建和使用项目
...
## [](#advanced-usage-and-pipenv)高级用法和 Pipenv
...
### [](#installing-and-running-packages)安装和运行软件包
...
### [](#specifying-python-version)指定 Python 版本
...
### [](#managing-virtual-environment)管理虚拟环境

#### [](#-pipenv-install)$ pipenv 安装
