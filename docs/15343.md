...
> 原文:[https://dev . to/the fern/how-to-setup-a-Jekyll-blog-and-link-to-dev-to-5 EAP](https://dev.to/thefern/how-to-setup-a-jekyll-blog-and-link-to-dev-to-5eap)
...
## [](#configure-configyml)配置 _ 配置. yml
...
## [](#publish-posts-to-devto-with-rss-feed)使用 RSS Feed 将帖子发布到开发人员
