...
> 原文:[https://dev . to/idrisrampurawala/creating-django-models-of-an-existing-d b-288m](https://dev.to/idrisrampurawala/creating-django-models-of-an-existing-db-288m)
...
# [](#django-inspectdb-command)Django inspectdb 命令
