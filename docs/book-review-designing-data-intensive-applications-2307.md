...
> 原文：<https://dev.to/henrikwarne/book-review-designing-data-intensive-applications-2307>

《设计数据密集型应用程序》是一本多么棒的书啊！它用清晰的语言、非常详细的内容和毫不含糊的方式涵盖了数据库和分布式系统。我特别喜欢作者 Martin Kleppmann，他非常了解这个理论，而且似乎对他描述的系统类型有很多实践经验。

[![](img/36ff16376749f5e9df3ab4e908beaaeb.png)](https://henrikwarne1.files.wordpress.com/2019/07/dsc_1971.jpg)
