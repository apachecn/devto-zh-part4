...
> 原文:[https://dev . to/Dai _ Shi/four-different-approach-to-non-redux-global-state-libraries-570h](https://dev.to/dai_shi/four-different-approaches-to-non-redux-global-state-libraries-570h)

##### [](#from-the-consuming-perspective)从消费角度
...
### [](#approach-1-multiple-contexts)方法一:多重语境
...
### [](#approach-2-select-by-property-names-or-paths)方法二:按属性名(或路径)选择
...
### [](#approach-3-select-by-selector-functions)方式 3:通过选择器功能选择
...
### [](#approach-4-state-usage-tracking)方法 4:状态使用追踪
