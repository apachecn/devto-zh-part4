...
> 原文:[https://dev.to/dbanty/python-rest-api-flask-basics-3ffn](https://dev.to/dbanty/python-rest-api-flask-basics-3ffn)
...
### [](#running-on-the-command-line)运行在命令行上
