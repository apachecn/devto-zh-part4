...
> 原文:[https://dev . to/sendilkumarn/reduce-your-web assembly-binaries-72-from-56kb-to-26kb-to-16kb-40mi](https://dev.to/sendilkumarn/reduce-your-webassembly-binaries-72-from-56kb-to-26kb-to-16kb-40mi)

# [](#every-byte-counts-optimize-them)每一个字节都很重要——优化它们
...
## [](#use-the-latest-dev-branch)使用最新的开发分支
...
# [](#thus-we-reduced-the-code-another-40-from-raw-26kb-endraw-to-raw-16kb-endraw-)因此我们从`26KB`到`16KB`又减少了大约 40%的代码。
