...
> 原文:[https://dev . to/kabi SAS software/running-multiple-docker-containers-in-parallel-with-Jenkins-1gib](https://dev.to/kabisasoftware/running-multiple-docker-containers-in-parallel-with-jenkins-1gib)
