...
> 原文:[https://dev . to/agility CMS/using-react js-with-agility-CMS-gl7](https://dev.to/agilitycms/using-reactjs-with-agility-cms-gl7)
...
[![Agility CMS - Pages](img/202955d4d2a7f47de4bf68c62b933dd5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XHKmlO3L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360034672212/mceclip0.png)
...
[![Agility CMS - Module](img/d238dbae20d74fb0c404e54a2fd45ce4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JCwmaJyz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360034676552/mceclip1.png)

在这个 React 站点中，每个*模块*对应一个 React 组件:

也就是我们在浏览器中看到的:

[![Jumbotron Preview Screenshot](img/93f3c4f7f0959013b423d75222230361.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kH3_TlI9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360034677252/mceclip1.png)

### [](#shared-content)共享内容

这是您存储非特定于页面的结构化内容的地方。在这个例子中，我们有一个*帖子*的列表，以及一个代表我们的*全局标题*内容的项目。

[![Shared Content](img/21d4a177c1e4804a1831d79eff36ceec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0k05SD_U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360034677632/mceclip2.png)

## [](#media-amp-documents)媒体&文档

这是您为 web 应用程序存储静态资产的地方。通常这是用于图像，视频和 pdf，但也可以存储任何你想包括字体资产等。存储在这里的一切都是通过高可用性 CDN 提供的。

[![Media and Documents](img/925fb074adc0881c66992c5665081cea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d1WDBP1O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360034735412/mceclip3.png)
...
### [](#retrieving-your-fetch-api-key-and-preview-api-key)检索您的获取 API 密钥和预览 API 密钥
...
[![Page Preview Screenshot](img/4c0ab2bda3c094cf31b346e405ec8a62.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mlcLKnS---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://help.agilitycms.com/hc/article_attachments/360034762232/mceclip1.png)

## [](#deploying-your-web-app)部署您的网络应用
