...
> 原文:[https://dev . to/dot net/how-you-can-build-a-web-API-using-graph QL-net-core-and-entity-framework-1 ago](https://dev.to/dotnet/how-you-can-build-a-web-api-using-graphql-net-core-and-entity-framework-1ago)

# [](#%C2%A0building-a-web-api-using-graphql-net-core-and-entity-framework)使用 GraphQL 构建 Web Api。Net 核心和实体框架
...
## [](#%C2%A0build-our-web-api)构建我们的 Web Api
...
## [](#%C2%A0integrate-graphql)整合 GraphQL
...
### [](#adding-the-graphql-route)添加 GraphQL 路线
...
[![](../Images/3bddf0b0d2ccaa36bbbbc63c238e0123.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bZZnSvLQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i0wo3u2rqo3i2ygovfhh.png)

这里我们创建了三个查询`AllBooks`、`Author`和`AllBooksWithAuthor`。

我们可以点击`Play`按钮轻松运行其中一个查询，这允许我们选择一个特定的查询:

[![](../Images/7f991cb6d13b6b531fb5c58cc9b0ac94.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K7XBSkVr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/woczpm9wbi4qzk8dfk3w.png)

运行该查询，我们得到以下结果:

[![](../Images/32ca1aed179d9f3a1be121fd459b6178.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---iTcFocS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wxs4se3dqkj2mbwvbr67.png)
...
[![](../Images/2f58cd17e72dc913ada00a67db3a5267.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MSbiBQXB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3wy429n4zzfry41mf3br.png)

显然，我们可以编写许多查询，并选择我们想要的一个。此外，我们可以查看右侧窗格，看到可以浏览我们的模式定义:

[![](../Images/0157e3897254d8e03ac937c8ed9302a7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E4swzaSl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jue75s6vvbmnvvl3ckvs.png)

点击`Docs`链接将显示从顶级开始的所有类型:

[![](../Images/5ecab03b51d9747b2af1b696a9ded1fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HUolk3sw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8duehqxhdrjxhwsn3swa.png)

然后，我们可以根据需要深入查看，看看我们可以查询什么，我们有哪些自定义类型等等:

[![](../Images/2245faf980f0fcece67f56f9a889d93a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g0LemibN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0acor4xa2fr8dd47pcq4.png)

## [](#%C2%A0adding-a-database-with-entity-framework)用实体框架添加数据库
...
### [](#%C2%A0define-a-database-in-code)定义一个数据库中的代码
...
### [](#replace-the-stubbed-code)替换存根代码
...
[![](../Images/2e0c64ad7ca71f585373253b41e16771.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--exnpgzvP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/emrxedu66t6trcrvy0i9.png)

看起来我们列出书籍的查询工作正常，它从数据库中给我们提供了书名。

接下来，让我们尝试进行一次突变:

[![](../Images/47712f29d734d0e56756af967a7099f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BjUvXn2d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qch5h4jstjayqgu54zst.png)
