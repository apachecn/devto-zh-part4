...
> 原文:[https://dev . to/jospohr/proper-i18n-with-Gatsby-i18 next-and-sanity-io-5g8a](https://dev.to/jospohr/proper-i18n-with-gatsby-i18next-and-sanity-io-5g8a)
...
## [](#wrap-content-with-i18nextprovider)用 I18nextProvider 包装内容
...
## [](#optimize-sanity-i18n)优化理智 I18n
...
## [](#redirecting-to-the-correct-language)重定向到正确的语言
