...
> 原文：<https://dev.to/bnevilleoneill/the-7-best-javascript-date-libraries-2pli>

[![](img/51b8f44baf74d746cbffafaa95dcb0e9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--qocPOzie--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u9seo0fyfc7q0u9zp7bp.png)
...
那么，当我说 JavaScript 还没有准备好的时候，我是什么意思呢？我的意思是，这个对象的 API 对于我们的日常需求来说还不够丰富，它没有你所期望的来自这样一个对象的高级支持来处理诸如国际化、时区支持等问题。
...
Moment.js 是 Node.js 和 vanilla JavaScript(使其与浏览器兼容)最古老、最著名的日期相关库之一。正因为如此，他们有时间让它与许多最常见的 web 开发工具兼容，例如:
...
[![twitter time](img/8bbb02ede1a8d68768d0cec3b1b07a78.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZmaXitMJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/twittertime.png%3Fresize%3D396%252C230%26ssl%3D1)
...
*关于代码的一个简短说明:尽管它与库主页上显示的例子相同，但我不得不修改它以与 Node.js 兼容。*

## [t1](#luxon)[豪华](https://moment.github.io/luxon)
...
[![day js downloads](img/603122285ca8a8a18d99e17ab61ea71e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--148hW4H8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/dayjsdownloads.png%3Fresize%3D1178%252C559%26ssl%3D1)
...
关于我们上一个库的另一件很酷的事情是，它可以在适当的时候观察夏令时，所以会发生以下情况:
...
另一方面，如果你有非常具体的需求，考虑一下用 **ms** 或者 **Spacetime。**
...
帖子[7 个最好的 JavaScript 数据库](https://blog.logrocket.com/javascript-date-libraries/)首先出现在[博客](https://blog.logrocket.com)上。