...
> 原文:[https://dev . to/ankursheel/add-curshut-fonts-with-ligations-to-vs-code-46o 2](https://dev.to/ankursheel/add-cursive-fonts-with-ligatures-to-vs-code-46o2)
...
[![Final Output Code Snippet](img/2f8df67a71405083cc077ded64dda5e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xhqM6K0d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k1n8jgfdu3sdgm34rzhf.png)

现在，我们知道了我们要实现的目标，让我们看看如何实现它。

## [](#updating-vs-codes-settings)更新 VS 代码的设置
