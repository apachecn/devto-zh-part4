...
> 原文:[https://dev . to/Phillip Kent/I-spend-an-whole-Saturday-trying-to-understand-reduce-27 m2](https://dev.to/phillipkent/i-spent-an-entire-saturday-trying-to-understand-reduce-27m2)
...
[![Animation of accumulator value: a + b = ab, ab + c = abc, and onward through an array of the English alphabet](../Images/a32cca7d672234cd781860c03f0f8112.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--053FRcdz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bkx0mzwqdz5q8j3foajf.gif)

如果这没有帮助，下面是我为自己写的例子，以确保我理解了累加器的基本性质。
[https://codepen.io/phillipkent/embed/KKPmPXj?height=600&default-tab=js&embed-version=2](https://codepen.io/phillipkent/embed/KKPmPXj?height=600&default-tab=js&embed-version=2)T2】

## [](#how-i-got-here)我是怎么来的
...
## [](#the-resources-that-clicked-for-me)为我点击的资源
