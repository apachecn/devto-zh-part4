...
> 原文:[https://dev . to/vonagedev/how-to-send-SMS-messages-with-go-l0f](https://dev.to/vonagedev/how-to-send-sms-messages-with-go-l0f)
...
## [](#using-the-nexmo-api-client-for-go)使用 Nexmo API 客户端进行 Go
...
## [](#send-sms-messages-with-go)用 Go 发送短信
