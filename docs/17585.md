...
> 原文:[https://dev.to/shimphillip/this-is-it-you-got-this-6a2](https://dev.to/shimphillip/this-is-it-you-got-this-6a2)
...
## [](#-raw-this-endraw-as-global)`this`作全局
...
## [](#-raw-this-endraw-in-methods)`this`在战法上
...
## [](#-raw-this-endraw-using-call-apply-and-bind)`this`使用调用、应用和绑定。
...
## [](#-raw-this-endraw-in-function-constructors)`this`在函数构造函数中
...
## [](#-raw-this-endraw-with-classes)`this`同课
...
## [](#-raw-this-endraw-in-arrow-functions)箭头功能中的`this`
...
## [](#-raw-this-endraw-with-html)`this`同 HTML
