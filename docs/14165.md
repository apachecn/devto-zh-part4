...
> 原文:[https://dev . to/rpalo/fixing-python-markdown-code-blocks-with-python-2 mng](https://dev.to/rpalo/fixing-python-markdown-code-blocks-with-python-2mng)
...
> ![Ryan Palo profile image](../Images/e9e05f2e852d09ef0f88120663120f3f.png)瑞安帕洛@ paytastic![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)嘿 [@ulyssesapp](https://twitter.com/ulyssesapp) 我能在我的减价导出中控制制表符和空格吗？Python 代码片段似乎不应该用制表符导出。2019 年 7 月 02 日下午 14:12[![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)](https://twitter.com/intent/tweet?in_reply_to=1146059025206743045)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=1146059025206743045)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=1146059025206743045)
...
## [](#lets-do-it-in-python)用 Python 来做吧
...
### [](#parsing-arguments-with-argparse)用 argparse 解析参数
...
## [](#tabs-are-for-people-who-mix-their-corn-and-potatoes-together)标签是给世卫组织人把他们的玉米和土豆混合在一起的
