...
> 原文:[https://dev . to/bigardone/dynamic-base-path-for-an-elm-spa-458h](https://dev.to/bigardone/dynamic-base-path-for-an-elm-spa-458h)
...
### [](#passing-the-base-path-to-the-elm-application)将基本路径传递给 Elm 应用程序
...
### [](#elm-routing-and-the-base-path)榆树路由和基路径
...
### [](#gluing-it-all-together)把一切粘合在一起
