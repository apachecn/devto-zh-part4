...
> 原文:[https://dev . to/Stephen Weiss/programmatic-page-generation-43h](https://dev.to/stephencweiss/programmatic-page-generation-43h)

# [](#programmatic-page-generation)程序化页面生成
...
*   盖茨比`reporter`是一个内置的控制台日志。`Panic`是错误状态。
    1.  如果我通过了错误检查，那么我知道我至少返回了一些东西，这意味着我可以取出我们的节点。在我迄今为止非常简单的例子中——我有两个:![](../Images/e54109117797972b72cbed8c837b5536.png)
