...
> 原文:[https://dev.to/kendru/making-choices-3h0g](https://dev.to/kendru/making-choices-3h0g)
...
## [](#example-adventure-game)举例:冒险游戏

[![Text-Based Adventure Game](img/1503af2bd4918dd60896b8f2c4be7f17.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tjAJSS4p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter10/adventure-screenshot.png)
...
## [](#making-simple-choices-with-if-and-when)用 if 和 when 做简单的选择
...
#### [](#expressions-that-ask-questions)表示提问的表情
...
[![Conditional Evaluation](img/e6b30749d35e1589964cf9f4a129b7a1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--y6XqCxLb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter10/selecting-expressions.png)
...
### [](#conditional-evaluation-with-when)条件求值用时
...
### [](#applying-if-and-when)应用 if 和 when
...
## [](#more-complex-choices-with-cond)用 cond 进行更复杂的选择
...
[![Replacing Nested If With Cond](img/7d8989e40a275f8127e01697d12058d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p-9h-BjA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter10/cond-if-comparison.png)

*用 Cond 替换嵌套 If*

### [](#repeated-tests-with-condp)用 condp 重复测试
