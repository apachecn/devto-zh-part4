...
> 原文:[https://dev.to/thamaraiselvam/mean-stack-cheat-sheet-5a1n](https://dev.to/thamaraiselvam/mean-stack-cheat-sheet-5a1n)

## [](#deprecated-)弃用！！！

自从我更新这篇文章已经 2 年了，请参考各自的文件来了解最新的变化。

### [](#mean-stack-cheat-sheet-github-repository)[意思是堆栈备忘单 Github 库](https://github.com/thamaraiselvam/MEAN-Stack-Cheat-Sheet)
...
[![Shortcut](../Images/6a4d69d12088c1ece7cc6b2612131750.png)T2】](https://i.giphy.com/media/uGjzzKY4BhtKw/giphy.gif)
...
## [](#what-the-heck-is-mean-stack)到底是什么意思栈
...
[![mongo](../Images/94818825220129c618795fb6d5e5dcaf.png)T2】](https://i.giphy.com/media/3otPoHMzdMgfZznjpe/giphy.gif)

### [](#mongodb-introduction)MongoDB 简介

#### [](#what-is-mongodb-and-where-to-be-used-)*什么是 MongoDB，用在哪里？*
...
#### [](#how-to-install-mongodb-and-robo-3t)*如何安装 MongoDB 和 Robo 3T？*

安装 MongoDB 和[Robo 3T](https://robomongo.org/download)(Robo 3T——以前的 Robomongo 是为 MongoDB 爱好者提供的免费轻量级 GUI)

#### [](#how-to-install-the-mongoose-node-module)*如何安装猫鼬节点模块？*
...
### [](#work-with-mongoose)与猫鼬一起工作

#### [](#start-with-schema)*从图式开始？*
...
### [](#basic-curd-functions)基本凝乳功能

> Mongoose 模型为 CRUD 操作提供了几个静态助手函数。

#### [](#create)*[创造()](https://mongoosejs.com/docs/api.html#model_Model.create)*
...
#### [](#find)*[找()](https://mongoosejs.com/docs/api.html#model_Model.find)*

查找文档

更新数据库中的一个文档，但不返回它。

#### [](#update)*[更新()](https://mongoosejs.com/docs/api.html#model_Model.update)*
...
[![node cats](../Images/852b2c3f58ae7a1de0d6af085e25d947.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M5_GFNey--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://user-images.githubusercontent.com/6559664/60865631-0c56c600-a244-11e9-972e-c367bcff55f6.gif)

### [](#what-is-nodejs)什么是节点。射流研究…

*   Node.js 是一个建立在 Chrome 的 V8 JavaScript 引擎上的服务器端平台(JavaScript 运行时)
*   它是一个开源的服务器环境，并且是免费的
*   它可以在各种平台上运行(Windows、Linux、Unix、Mac OS X 等)。)

### [](#why-nodejs)为什么 Node.js

#### [](#asynchronous-and-event-driven)异步和事件驱动
...
#### [](#single-threaded-but-highly-scalable)单线程但高度可扩展
...
### [](#where-to-use-nodejs)何处使用 Node.js
...
#### [](#javascript-engine-vs-javascript-runtime)JavaScript 引擎 vs JavaScript 运行时
...
### [](#some-common-npm-packages)一些常见的 NPM 套餐
...
[![REST API](../Images/00fb49e96acf8ef6bfbc6f29a595c676.png)T2】](https://i.giphy.com/media/e3NinswgSNdRu/giphy.gif)
...
[![Express cat](../Images/6bda0f1d43eed1408f878a9d5e5f9bc0.png)T2】](https://i.giphy.com/media/3oriNYQX2lC6dfW2Ji/giphy.gif)

### [](#what-is-express)*什么是快递*
...
### [](#create-hello-world-rest-api-with-express)*用 Express 创建 Hello World REST API*
...
[![angular cat](../Images/bd6afff95ff51976f408c9fded1f3acb.png)](https://i.giphy.com/media/r7Y17m4862kdW/giphy.gif)T3】
...
#### [](#step-1-install-nodejs)第一步:安装 Node.js

Angular 需要 Node.js 版本 10.9.0 或更高版本。要安装 node.js，请转到[安装节点](#where-to-use-nodejs)

#### [](#step-2-install-the-angular-cli)第二步:安装 Angular CLI
...
### [](#create-and-run-an-application)创建并运行应用程序

现在是时候创建你的第一个角度应用程序了。

#### [](#create-new-angular-application)创建新的角度应用
...
[![practice cat](../Images/ba3fd29f8cfed9f787212881310b6344.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kEckmmeA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://user-images.githubusercontent.com/6559664/61043713-8f1e8300-a3f4-11e9-8650-3fbb51dbab47.gif)