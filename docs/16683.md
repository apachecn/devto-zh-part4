...
> 原文:[https://dev . to/setevoy/nginx-multi-branch-deployment-with-ansi ble-nginx-map-and-http-headers-jh0](https://dev.to/setevoy/nginx-multi-branch-deployment-with-ansible-nginx-map-and-http-headers-jh0)

[![](../Images/78085e4140d88b37a268ebde3e60aac9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--r6fzzO2X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2012/09/nginx_logo2.jpg) 我们有一个标准的 LEMP 设置 NGINX，PHP-FPM。
...
### [](#nginx-raw-map-endraw-)NGINX `map`
...
[![](../Images/b9e1de60cd8b5c049833133cf03e7614.png "NGINX: multi-branch deployment with Ansible, NGINX map and HTTP Headers")T2】](https://rtfm.co.ua/wp-content/uploads/2019/06/Screenshot_20190625_173225.png)
