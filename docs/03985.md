...
> 原文:[https://dev . to/arnellebalane/async-clipboard-API-access-the-clipboard-using-JavaScript-36pb](https://dev.to/arnellebalane/async-clipboard-api-accessing-the-clipboard-using-javascript-36pb)
...
### [](#writing-to-the-clipboard)写入剪贴板
...
### [](#reading-from-the-clipboard)从剪贴板中读取
...
[![Clipboard access permission prompt in Chrome](img/648af310dbe8b76155407444dde6806a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xL3fnwZc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p9goykbyq4vgkfnyy9a0.jpg)

> **注意:**在 Chrome 中，当用户多次解除(据我观察约 3 次)时，读取剪贴板的权限会被自动拒绝。
> 
> **注意:**在撰写本文时，Firefox(68 版)还不支持`readText()`方法，MDN 文档声明它只在浏览器扩展中受支持。

### [](#checking-clipboard-access-permissions)检查剪贴板访问权限
...
### [](#write-an-image-to-the-clipboard)将图像写入剪贴板
...
### [](#reading-an-image-from-the-clipboard)从剪贴板中读取图像
...
## [](#browser-support-amp-feature-detection)浏览器支持&特征检测
