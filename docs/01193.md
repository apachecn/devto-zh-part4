...
> 原文:[https://dev . to/erikaheidi/bootstrapping-a-CLI-PHP-application-in-vanilla-PHP-4ee](https://dev.to/erikaheidi/bootstrapping-a-cli-php-application-in-vanilla-php-4ee)
...
## [](#1-setting-up-directory-structure-amp-entry-point)1。设置目录结构&入口点
...
## [](#2-setting-up-source-dirs-and-autoload)2。设置源目录和自动加载
...
## [](#3-creating-an-output-helper)3。创建输出助手
...
## [](#4-creating-a-command-registry)4。创建命令注册表
