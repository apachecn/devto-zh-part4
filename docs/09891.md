...
> 原文:[https://dev . to/cmendibl 3/gitops-deploying-apps-in-azure-kubernetes-service-aks-with-flux-4a Li](https://dev.to/cmendibl3/gitops-deploying-apps-in-azure-kubernetes-service-aks-with-flux-4ali)
...
## [](#1-download-the-helm-template)1。下载头盔模板
...
## [](#2-bake-the-template-with-your-repo-i-dont-use-tiller)2。烘烤模板与您的回购(我不使用蒂勒)
...
## [](#3-deploy-the-configuration-to-your-cluster)3。将配置部署到您的集群
...
## [](#4-get-the-fluxctl-cli)4。获取 fluxctl CLI

下载 [fluxctl CLI](https://github.com/fluxcd/flux/releases/tag/1.13.2)

## [](#5-use-fluxctl-to-get-the-public-key)5。使用 fluxctl 获取公钥
