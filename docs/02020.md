...
> 原文:[https://dev.to/danburzo/a-css-only-layout-debugger-1o9j](https://dev.to/danburzo/a-css-only-layout-debugger-1o9j)
...
### [](#showing-the-padding-around-elements)显示元素周围的填充
...
### [](#making-our-inspector-hoveraware)让我们的检查员能够感知悬停
...
### [](#extra-credits-identifying-the-elements)额外学分:识别元素
