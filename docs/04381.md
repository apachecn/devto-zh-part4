...
> 原文:[https://dev.to/yashints/let-s-write-html-like-a-pro-28h5](https://dev.to/yashints/let-s-write-html-like-a-pro-28h5)
...
[![Emmet to the rescue](img/9d71686308acf89474ac942bae77fe3e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ykBI07L7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mdprvimfdfxuzk8r1hvz.gif)
...
## [](#-raw-hr-endraw-shouldnt-be-used-for-formatting)`hr`不应该用于格式化
...
## [](#be-careful-when-you-use-the-raw-title-endraw-attribute)使用`title`属性时要小心
...
## [](#single-or-double-quotes)单引号或双引号
