...
> 原文:[https://dev . to/gamersuji/c-intro-to-the-abstract-classes-4m 0](https://dev.to/gamersuji/c-intro-to-the-abstract-classes-4m0)

## [](#what-are-abstract-classes)什么是抽象类？

### [](#abstract-classes-are-a-combination-of-both-a-normal-class-default-class-and-an-interface)抽象类是普通类(默认类)和接口的组合。
...
### [](#lets-jump-into-an-example-to-see-how-to-create-an-abstract-class)让我们跳到一个例子，看看如何创建一个抽象类。
...
### [](#lets-start-writing-the-class-that-inherits-the-sleep-class)让我们开始编写继承**睡眠**类的类。
...
### [](#this-is-one-of-the-main-reasons-an-abstract-class-is-called-an-abstract-class)这是一个抽象类被称为抽象类的主要原因之一。
...
### [](#wait-what-are-virtual-methods)等等！什么是虚拟方法？
...
### [](#lets-write-a-short-virtual-method-inside-our-sleep-class)让我们在睡眠类内部写一个简短的虚拟方法
...
### [](#this-is-the-main-reason-why-we-use-an-abstract-class-instead-of-a-normal-class)这是我们使用抽象类而不是普通类的主要原因。
