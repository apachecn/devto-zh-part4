...
> 原文:[https://dev . to/adamklein/build-your-own-virtual-scroll-part-ii-3j 86](https://dev.to/adamklein/build-your-own-virtual-scroll-part-ii-3j86)
...
## [](#calculating-the-nodes-positions)计算节点的位置
...
我们必须在开始
[![calculate node position and container height](../Images/509c72f5ab250a926dc7e10e5cef7b59.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tlzba_CQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f5s764bc31re4pwsz2f1.png) 时进行全通

## [](#the-container-height)容器高度

现在我们有了节点的位置，这是一个非常简单的步骤。我们简单地取**最后一个节点的位置**并加上它的**高度**。

## [](#figuring-out-the-visible-nodes)算出可见节点
...
[![find visible nodes](../Images/76d286888629642371431c08f81d146d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GnksiGsT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5x436kb7qcr5yc4zwlge.png)

## [](#shifting-the-nodes-down)将节点下移
...
# [](#virtual-scroll-on-a-tree)在树上虚拟滚动
