...
> 原文:[https://dev.to/mishafb/an-introduction-to-the-canvas-2ffe](https://dev.to/mishafb/an-introduction-to-the-canvas-2ffe)
...
[![Result of the previous code snippet](img/665defcb24552e7750020a031447e537.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NZTQML3M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i0yb50xollw0b7xdhupr.png)
...
### [](#transformation-order-matters)转换顺序至关重要！
...
## [](#thats-it-for-this-tutorial)本教程到此为止！
...
## [](#next-up-mouse-and-keyboard-input-for-your-interactive-webapps)**接下来:**鼠标和键盘为你的交互式 webapps 输入