...
> 原文:[https://dev . to/angelesbroullon/installing-visual-basic-6-0-in-windows-10-1kjn](https://dev.to/angelesbroullon/installing-visual-basic-6-0-in-windows-10-1kjn)
...
## [](#1-delete-all-the-files-from-the-previously-failed-vb6-installation-attempts)1。-删除先前失败的 VB6 安装尝试中的所有文件
...
## [](#2-modify-the-installation-files-to-adapt-them-to-current-tech)2。-修改安装文件以适应当前的技术
...
## [](#3-execute-the-wizard-installer)3。-执行向导安装程序
...
## [](#4-execute-the-application)4。-执行应用程序

总是在管理员模式下运行(右键单击 Visual Basic 6.0，然后选择“以管理员身份运行”)。然后，它在这里，准备运行和调试古老的 dll。

[![The Visual Studio 6 main screen](../Images/9444245d770b465f91795c56c237c1e9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wErEu7Lg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vqb63sesqgzizfhevfma.png)
