...
> 原文:[https://dev . to/amroessam/publish-your-first-NPM-package-vue-263h](https://dev.to/amroessam/publish-your-first-npm-package-vue-263h)
...
### [](#1-creating-the-component)1。创建组件
