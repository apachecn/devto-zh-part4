...
> 原文:[https://dev . to/devblackops/infra structure-testing-with-pester-and-the-operation-validation-framework-1a5p](https://dev.to/devblackops/infrastructure-testing-with-pester-and-the-operation-validation-framework-1a5p)
...
## [](#what-about-your-infrastructure)你的基础设施怎么样？
...
#### [](#getanswertestsps1)Get-Answer.tests.ps1
...
#### [](#osservicestestsps1)os.services.tests.ps1
...
## [](#operation-validation-framework)操作验证框架
...
[![Do you know what this means?](../Images/55d8da1641f5e7eaf1937dbacac8559c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sL-OFWlc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xphvb6pi743w6wf01532.jpg)

#### [](#servicestestsps1)services.tests.ps1
...
[![Service test results](../Images/91b2b11464ede435020edebaa0d621d5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U9AEjqKp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ck2zoquwi5bplognose9.png)
...
[![Logical disk tests](../Images/cb9fb308827587ce7cc3cd55ecd18ed8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NpawauA7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c51mwidwyhpu5q53829v.png)
...
[![Running OVF tests](../Images/e6423eea69ea51f85f7d41a2c4566313.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tjxPfi3D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sysc3z1g4jbsgajlpqvi.png)

要执行 OVF 测试并覆盖默认参数，我们可以使用`-Overrides`参数。我们也可以显示纠缠输出。这个框架很酷的一点是，你可以开发一个通用模块来测试某项技术，然后根据环境定制设置。

[![Override OVF test parameters](../Images/a074da943649ff0be9989e0ee50c7c6c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6zV3NOyl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i9po1h59oss97miw7taz.png)
