...
### [](#en-el-n%C3%BAcleo%C2%A0angular)**在角核**中:
...
### [](#mejoras-de-rendimiento-en-procesamiento-de-im%C3%A1genes)**图像处理性能提高**:

使用 PNGcrsh 可减小图像的重量，pngcrsh 是一种优化程序，可使所有 png 文件的图像变小。

### [](#cambios-del-api%C2%A0p%C3%BAblica)**公共 api 变更**:

Createinjector()是用于 Ivy 计划渲染器的 API，将于今年晚些时候以 beta 形式呈现。
计划要求 Ivy 上市时再出口 API。

### [](#cambios-en-la-sintaxis)**语法变化**:
...
### [](#otras-nuevas-caracter%C3%ADstica-planeadas-para-angular-80-podr%C3%ADan%C2%A0incluir)**计划用于角度 8.0 的其他新特性可能包括**:
...
### [](#quieres-probarlo-por-ti-mismo-puedes-hacerlo%C2%A0aqu%C3%AD)**自己试试看？你可以在这里做**:
