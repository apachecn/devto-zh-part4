...
> 原文:[https://dev . to/lpellis/how-to-add-Twitter-and-Facebook-cards-to-your-vue-app-47kl](https://dev.to/lpellis/how-to-add-twitter-and-facebook-cards-to-your-vue-app-47kl)

添加推特/脸书卡片是改善人们分享你的网站的体验的一个很好的方式，并且只需要几分钟就可以添加到你的 vue 网站。

### [](#what-are-twitter-cards)什么是推特卡？
...
### [](#displaying-twitterfacebook-cards-on-your-site)在你的网站上展示推特/脸书卡片
...
### [](#last-steps-prerendering)最后一步，预渲染
