...
> 原文:[https://dev . to/xpirit/creating-the-azure-functions-updates-Twitter bot-25hc](https://dev.to/xpirit/creating-the-azure-functions-updates-twitterbot-25hc)

## TL；速度三角形定位法(dead reckoning)

前往[https://twitter.com/az_func_updates](https://twitter.com/az_func_updates)并关注该帐户，了解最新的 Azure Functions 版本！

## [](#what-im-trying-to-solve)我在努力解决什么
...
[![Azure Functions Updates component diagram](../Images/1961c888bc9313b4ff697a0902d3542e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FvOK1iVX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jbi4jav35yyqnayvvg0c.png)

### [](#storage-azure-table-storage)存储:天蓝色桌面存储
...
[![Azure Storage Table with repository configurations](../Images/ea95628ac6756dc4cb3e0e0518b864a1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vXGO8UyJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/omtpwjs2pkzyjnylfp9v.png)

从 GitHub 检索到的发布信息存储在`Releases`表中:

[![Azure Storage Table with release info from GitHub](../Images/23e617e59d493a87d63d96b901438adf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---P5sz2nN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/00v946icxlt9pueanl4y.png)

我没有存储整个 GitHub Release 对象，只存储了我需要的(或者计划很快使用的)属性。

### [](#compute-azure-functions)计算:Azure 函数
