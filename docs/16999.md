...
> 原文:[https://dev . to/lkopacz/an-introduction-to-accessible-labeling-18lo](https://dev.to/lkopacz/an-introduction-to-accessible-labeling-18lo)
...
### [](#nesting-inputs-in-labels)标签中嵌套输入
...
## [](#using-raw-arialabel-endraw-)使用`aria-label`
...
## [](#-raw-ariadescribedby-endraw-and-raw-arialabelledby-endraw-)`aria-describedby`和`aria-labelledby`
