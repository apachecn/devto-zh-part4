...
> 原文:[https://dev . to/coryrylan/using-web-components-in-angular-forms-35ij](https://dev.to/coryrylan/using-web-components-in-angular-forms-35ij)
...
## [](#web-components-in-angular)腹板构件呈角形
...
[![Web Component working with Angular Forms](../Images/c68c805aae579cd2fa28bd44de54bc8c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lXF_k9hN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i2sfrc9n9rwq2mscrrbf.png)
...
## [](#extending-behavior-with-directives)用指令扩展行为
