...
> 原文:[https://dev.to/hi_iam_chris/git-hooks-and-huskyjs-13gb](https://dev.to/hi_iam_chris/git-hooks-and-huskyjs-13gb)
...
#  [](#a-branch-name-where-you-want-to-prevent-git-push-in-this-case-its-master) 要防止 git 推送的分支名。在这种情况下，它是“主人”
