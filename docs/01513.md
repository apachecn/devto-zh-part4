...
> 原文:[https://dev . to/aryanjnyc/stand-up-a-node-js-server-with-nestjs-including-typescript-and-graph QL-FAO](https://dev.to/aryanjnyc/stand-up-a-node-js-server-with-nestjs-including-typescript-and-graphql-fao)
...
## [](#sprinkle-in-graphql)洒在 GraphQL 上
...
### [](#resolvervalidationoptions)解决验证选项
...
### [](#writing-a-graphql-resolver-with-nestjs)用 NestJS 编写 GraphQL 解析器
...
[![GraphQL playground with the messages mutation and the returned message](img/6408ef8485539550c102c787988f75c1.png "GraphQL Playground")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_aDZbInN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1kvxaix9eof604o7y13m.png)
