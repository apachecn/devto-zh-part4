...
> 原文:[https://dev . to/berndruecker/zee be-io-a-horizontally-scalable-distributed-workflow-engine-23 G3](https://dev.to/berndruecker/zeebe-io-a-horizontally-scalable-distributed-workflow-engine-23g3)

### zee be . io——一个可横向扩展的分布式工作流引擎

#### [](#say-hello-to-cloudnative-workflow-automation%E2%80%8A%E2%80%8Apart-1)向云原生工作流自动化问好—第 1 部分
...
[![](../Images/4f52042eb8fc36b6a19874bc33685e8e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ed4dELuR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/536/1%2Axtwqo_eQHXbFzyI6BFvcig.png)
...
[![](../Images/bbfd01b6a7f35e7a193363a1515673af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZdZWv8PS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AMneH_JzZvyoyee2H_-HclA.png)

那么，我们如何实现这一目标呢？一个重要的想法是建立一个事件源系统。

### [](#an-event-sourced-workflow-engine)源于事件的工作流引擎

传统的工作流引擎在数据库表中捕获工作流实例的当前状态。如果状态改变，数据库表被更新。简化后，看起来是这样的:

[![](../Images/4e9526c091ea3b83a4380c25559807ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XUkUL5w5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/890/1%2Ah92buKDp91nBA32bgPJdzg.png)
...
### [](#zeebe-architecture-and-usage-example)Zeebe 架构及用法举例
...
[![](../Images/b6c1cf2a47d4b70fbfad462799f969b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hvJ2aVWu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/732/0%2AHmcj6fx4-gRxV8-A.png)
...
#### [](#native-language-clients-supporting-reactive-programming-streaming-and-backpressure)支持反应式编程、流和反压的母语客户端
...
[![](../Images/6b73c3c646deffba018472a7eb0b36b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--euKq4J4_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/799/1%2AGno2migrFvSmwV_iXbuX7g.png)
...
#### [](#transaction-and-atleast-once-semantics)事务和至少一次语义
...
[![](../Images/64bc62c3af09c813c3738522e228cf4e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QImHp2ky--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/761/1%2ArJ5Jda_O5zVbI2CvwTaHYw.png)
...
<figure>[![](../Images/5fc42aaf13090f5ce6243d3425359638.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--I05JfaJH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AaADL2jp5tNkGFq2f.png) 
...
[![](../Images/ea6c8d6d376ecf2ff969c337b038206f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9R4SsDeV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2A9rnNlobQvfSAenkz.png)
