...
> 原文:[https://dev . to/mokkapps/how-I-set-up-a-new-angular-project-4b7d](https://dev.to/mokkapps/how-i-set-up-a-new-angular-project-4b7d)
...
### [](#why-should-i-consider-using-cypress-instead-of-protractor)为什么要考虑用柏树代替量角器？
...
### [](#why-should-i-consider-using-jest-instead-of-jasmine)为什么要考虑用 Jest 而不是 jasmine？
...
### [](#effective-development-practices)有效的开发实践
...
## [](#ui-component-explorer)UI 组件浏览器
...
## [](#use-domaindriven-design-for-your-models)为你的模型使用领域驱动设计
