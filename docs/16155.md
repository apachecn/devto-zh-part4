...
> 原文:[https://dev.to/fosteman/mixins-1b0a](https://dev.to/fosteman/mixins-1b0a)
...
#### [](#-snowballing-complexity)-滚雪球式的复杂
...
##### [](#code-redundancy-indirection-and-more-dependencies-occur)代码冗余，发生间接和更多的依赖。

### [](#alternative-patterns-utilized-in-facebook)脸书采用的替代模式
