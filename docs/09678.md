...
> 原文:[https://dev . to/seang Wright/kentico-12-design-patterns-part-9-the-different-way-to-store-content-in-kentico-12-MVC-52je](https://dev.to/seangwright/kentico-12-design-patterns-part-9-the-different-ways-to-store-content-in-kentico-12-mvc-52je)

<figure>

[![](../Images/9b78861256824b9b8066b8fc7e55b030.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oTKKi4Cz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9fkq74z9v0k8yox0uuk5.jpg)
...
## [](#content-storage-patterns)内容存储模式
...
### [](#application-settings-or-kentico-settings-module)🔸应用程序设置或 Kentico 设置模块
...
[![](../Images/f20d6549cfd71bbd92b3aa8b98d944ea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MXQVyP3D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0kq6kitk8c9kbz3jrcei.jpg)
...
[![](../Images/dbf1529e1dcb43d1d79644bafcef7d90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wEclwIaP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cmuzgovby9k3lccr3rh9.jpg)

<figcaption>Here is the node in the MVC site web.config file where settings can be stored.</figcaption>

</figure>

### [](#resource-resx-file-or-kentico-localization-module)🔸资源(。resx)文件或 Kentico 本地化模块
...
[![](../Images/e7ed6b110b9d419afda346971e847fce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KYs1Wmkj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nh98n36vexl8c2q2qsng.jpg)
...
[![](../Images/eebc40154a5842a08cba466ff32cebc0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h_SLECt8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/32uqw0m6ldv82w2mk5n7.jpg)
...
### [](#custom-table-or-custom-module-class)🔸自定义表格或自定义模块类
...
#### [](#example-custom-tables)示例-自定义表格:
...
#### [](#example-custom-module-class)示例-自定义模块类:
...
[![](../Images/b88f3fca3be1643f6e191bf2cfcaa9bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8t-vPp87--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4zoo7c65qa1v6dgqixs7.jpg)
...
### [](#-raw-pagebuilder-endraw-functionality-sections-widgets)🔸`PageBuilder`功能(部分/部件)
...
<figure>[![](../Images/76ae6c6e9b47f53e1c5e18b79aebe12c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tj_I0DMi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d37l2emoa88a85sw7es9.jpg) 

<figcaption>这里是 CMS Pages 模块中显示的对话框，用于编辑上面 NumberWidget 局部视图显示的值。</figcaption>

</figure>

## [](#comparing-custom-page-type-and-raw-pagebuilder-endraw-content)对比自定义页面类型和`PageBuilder`内容
