...
> 原文:[https://dev . to/cmendibl 3/visual-studio-code-remote-containers-azure-区块链-20om](https://dev.to/cmendibl3/visual-studio-code-remote-containers-azure-blockchain-20om)
...
## [](#1-devcontainerjson-file)1。devcontainer.json 文件
