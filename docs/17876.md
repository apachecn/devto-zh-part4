...
> 原文:[https://dev . to/joecannatti/humans-can-code-too-idempertighteness-42jc](https://dev.to/joecannatti/humans-can-code-too-idempotency-42jc)

《人类也能编码》是一个内容系列，面向任何不是来自传统计算机科学背景的人，并试图更好地理解软件开发。这包括那些刚刚开始编程生涯的人，以及那些只想了解开发人员到底在说些什么的商务人士。

## [](#its-a-scary-term)这是一个可怕的术语
...
### [](#so-whats-the-difference-between-those-two)那么，那两者有什么区别呢？
...
[![](../Images/5a48274aafe3d385009dcc9ef8407d06.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p-wSiKjk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://zafulabs.files.wordpress.com/2019/06/idempotency.png%3Fw%3D680)

## [](#example-precalculating-review-count)示例:预计算审核次数
...
## [](#example-backup-to-s3-cloud-based-file-system)示例:备份到 S3(基于云的文件系统)
