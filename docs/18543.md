...
> 原文:[https://dev . to/doylecodes/getting-started-with-PostgreSQL-5g 29](https://dev.to/doylecodes/getting-started-with-postgresql-5g29)

## [](#why-postgresql)为什么要用 PostgreSQL？
...
## [](#creating-a-postgresql-database)创建 PostgreSQL 数据库
...
### [](#setting-up-the-digitalocean-database)建立数字海洋数据库

1.  [注册数字海洋](https://m.do.co/c/e3e79529827f)
2.  创建新项目
3.  创建托管数据库。我使用了 PostgreSQL，在编写本文时这是唯一的选择。您需要在这里设置一些选项，但这是不言自明的。![create managed database](../Images/03b05c250c16dfa3401a2cbc31caf539.png)
4.  数据库将被创建，您可以在您的项目中看到它。转到 it 以完成设置。![db list](../Images/5131dedda4ba9513fb84c45bde35aa18.png)
5.  添加您的 IP 地址，以便数据库访问不对公众开放。![ip address](../Images/e07d6eb5a753c615d6840fe3a96683e2.png)
6.  下载 SSL 证书，我们将使用它进行连接。![ssl](../Images/99d586c4945ed6657dbb3fba4f3d6123.png)
...
### [](#set-up-connection)设置连接

首先，这是我必须连接到我的数据库。我从 node-postgres 上的[文档中获取了所有内容，但我在其中留下了注释来解释每一部分。您可以从您的 DigitalOcean 访问所有配置选项，如下图所示。
T3![config options](../Images/93e955015a9e70fabfa6aaf70c06a19f.png)T5](https://node-postgres.com/) 
...
### [](#testing-out-the-database)测试出数据库
