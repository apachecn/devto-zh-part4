...
> 原文:[https://dev . to/caffiendkitten/understanding-password-managers-and-my-attempt-at-building-one-p-1-1 NID](https://dev.to/caffiendkitten/understanding-password-managers-and-my-attempt-at-building-one-p-1-1nid)
...
[![](img/cda00ee2253aae57ab088b635a1040ba.png)T2】](https://i.giphy.com/media/vY9GIP99KJz9K/giphy.gif)
...
## [](#1-cryptography-and-kerckhoffss-principle)1。密码学与克尔克霍夫原理
...
## [](#2-secure-coding-practices)2。安全编码实践
...
## [](#3-proper-storage-of-passwords)3。密码的正确存储
...
## [](#4-password-digests-jwt-serializers)4。密码摘要/ JWT/序列化程序。
...
## [](#5-localstoragesessionstorage)5。本地存储/会话存储
...
## [](#6-encryptiondecryption)6。加密/解密
...
## [](#7-keys-to-the-kingdom-are-important-to-hide)7。王国的钥匙藏起来很重要
...
[![](img/ec20e3dc443dd6422701f51de18088e5.png)T2】](https://i.giphy.com/media/GmupHhsefxgti/giphy.gif)
