...
> 原文:[https://dev . to/sete voy/kubernetes-part-2-a-cluster-set-up-on-AWS-with-AWS-cloud-provider-and-AWS-load balancer-4 mlh](https://dev.to/setevoy/kubernetes-part-2-a-cluster-set-up-on-aws-with-aws-cloud-provider-and-aws-loadbalancer-4mlh)

[![](../Images/176eddd1c1df5c8f2c0a1707dc6d92fd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1omKf2Bs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2017/06/kuber-1.png) 在第一部分——[Kubernetes:第一部分——架构和主要组件概述](https://rtfm.co.ua/en/kubernetes-part-1-architecture-and-main-components-overview/#Deployment)——我们快速浏览了一下 Kubernetes。
...
### [](#preparing-aws)准备 AWS

#### [](#vpc)VPC

用 *10.0.0.0/16* CIDR 制造一个 VPC:

[![](../Images/60fe4502632680efb2d08bbe960f42d3.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155148.png)

添加一个名为*kubernetes.io/cluster/kubernetes*的标签，其值为*所拥有的*——K8s 将使用该标签进行与 Kubernetes 堆栈相关的 AWS 资源自动发现，它还会在创建新资源的过程中添加这样一个标签:

[![](../Images/a91e6285be471d5f59ac7fe68ca621b5.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155223.png)

启用 *DNS 主机名*:

[![](../Images/2488e2dd4e68032f41dbdbe099dc0b66.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155306.png)

[![](../Images/11adfb06e7cef43995fca6672afd83a6.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155322.png)

#### [](#subnet)子网

在此 VPC 中创建新子网:

[![](../Images/2d14770f399f7701c5189bb66978d454.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155431.png)

为将放置在此子网中的 EC2 实例启用公共 IP:

[![](../Images/804da94ba4cc2cfa7d6a82611b8ffd5d.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155456.png)

[![](../Images/3bbd79d84e73f94ef102952ba1de6748.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155520.png)

添加标签:

[![](../Images/a4b9cf2e66667a14e19a59a40cc14127.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155553.png)

#### [](#internet-gateway)互联网网关

创建一个 IGW，将流量从子网路由到互联网:

[![](../Images/fb90e69c2b5d8eef0f3ec9dd2f5a2135.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155626.png)

对于 IGW，也添加标签，以防万一:

[![](../Images/d4b52e74b9a8470e3664e454c54c1f57.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155734.png)

将此 IGW 附加到您的 VPC:

[![](../Images/e901385059fbdda1000d95e18791d3de.png)T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155756-1.png)

[![](../Images/4c187fc92888042c04be05b777ee20f5.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155811.png)

#### [](#route-table)路由表

创建路由表:

[![](../Images/0fbeaafbf1e01f693b3b1e422a4bf083.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155842.png)

在此添加标签:

[![](../Images/80b0c453c3f2945a6186987fb32519da.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155913.png)

点击*路由*选项卡，通过我们上面创建的 IGW 向 *0.0.0.0/0* 网络添加一条新路由:

[![](../Images/9a8ee57355f5beca647519da92c38444.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_155947.png)

将此表附加到子网-*编辑子网关联*:

[![](../Images/16a494724cfb7584523ec9d198ebf083.png "Kubernetes: знакомство, часть 2 - создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_160029-1.png)

选择您之前创建的子网:

[![](../Images/f7022de43ee11c3e635b2fd672e7d91b.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_160104.png)
...
[![](../Images/29e2793c5754bf789414fcf8bfeef0ec.png "Kubernetes: знакомство, часть 2 - создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_161414-1.png)

保存它:

[![](../Images/be03ffbab81456ef25c8ed05965b0258.png "Kubernetes: знакомство, часть 2 - создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_161512-1.png)

转到*角色*，使用 EC2 类型创建一个角色:

[![](../Images/0be871be8543b07a3500f83fbb29cae8.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_161625.png)

点击*权限*，找到并附上上面添加的策略:

[![](../Images/f205dd615e1a8db7376ea905f8d198f6.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_161716.png)

[![](../Images/3ec25f1ddbf19d0242ce4ec40e88f2cb.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_161807.png)

##### [](#iam-worker-role)IAM 工作者角色
...
[![](../Images/92660c90b280f0d9ee9e77e152770c6b.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162026.png)

并创建一个*k8s-cluster-iam-master-role*:

[![](../Images/028cf08aa3a23004f34b0252e9478ed4.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162131.png)

#### [](#running-ec2)运行 EC2

使用 t2.medium 类型创建 EC2(最小类型，因为 cKubernetes master 至少需要 2 个 CPU 内核)，使用您的 VPC，并将*k8s-cluster-iam-master-role*设置为 IAM 角色:

[![](../Images/f3133a5a97cf7d6802b10f4b5c29b92c.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162304.png)

添加标签:

[![](../Images/d75819e3bccbed92605d121a2d7047bf.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162337.png)

创建一个*安全组*:

[![](../Images/e850d00a2edee7a7675af7fba593f8c0.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162418.png)

Wile Master 正在加速运行–使用*k8s-cluster-iam-Worker-role*以同样的方式创建一个 Worker 节点:

[![](../Images/d4c9ad2c57aafa2101937109a3e94d69.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162648.png)

标签:

[![](../Images/6641826f1f51d2c05509ace51a52cca6.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162716.png)

附加现有 SG:

[![](../Images/0d425d89ed5d07b00557e37d37813f03.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_162740.png)
...
### [](#a-kubernetes-cluster-set-up)一个 Kubernetes 集群建立起来

#### [](#kubernetes-installation)不间断安装
...
##### [](#-raw-kubeadm-reset-endraw-)`kubeadm reset`
...
#### [](#flannel-cni-installation)法兰绒 CNI 装置
...
#### [](#attaching-the-worker-node)附加工作节点
...
### [](#load-balancer-creation)负载平衡器创建
...
[![](../Images/bb0c78be30b4718a1106a8ee6c7d3e84.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_165633.png)

实例–这是我们的工作节点:

[![](../Images/e82357ea5411222de989008d1e5864c6.png "Kubernetes: знакомство, часть 2 - создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_165650-1.png)
...
##### [](#aws-load-balancer-no-worker-node-added)AWS 负载平衡器–未添加工作节点
...
[![](../Images/a3a4166fcc4ee36ab9b3981c05097d2b.png "Kubernetes: создание кластера с AWS Cloud provider и AWS LoadBalancer")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190809_165039.png)
