...
> 原文:[https://dev . to/nestjs/publishing-nestjs-packages-with-NPM-21fm](https://dev.to/nestjs/publishing-nestjs-packages-with-npm-21fm)
...
[![npm install](../Images/96df82ae2c61e6eec4a5c25387ef4f9b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--phpBBNQC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6t7bci79p15a0wej84kw.gif)
...
### [](#setting-up-for-development)为开发而设置
...
#### [](#clone-the-module-starter-repo)克隆模块启动器 repo
...
### [](#install-the-package-into-the-test-app)将包安装到测试 app 中
...
### [](#use-the-package-in-the-test-app)使用测试 app 中的包
...
#### [](#give-the-package-a-unique-scoped-name-for-npm)给软件包一个唯一的 npm 作用域名称

##### [](#a-few-notes-about-npm)关于 npm 的几点注记
...
#### [](#once-ready-publish-the-package)一旦准备好，发布包
...
#### [](#search-for-your-package-on-wwwnpmjscom)在 www.npmjs.com[搜索您的包裹](http://www.npmjs.com)

前往[https://www.npmjs.org](https://www.npmjs.org)，寻找你的包裹。

* * *

[![search-npmjs](../Images/4d6edaba5e2c02381d46386c2b769977.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FKuKb_ML--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lf35il3cylwrewxskvm0.png)

* * *

### [](#install-the-published-npm-package-in-your-test-app)在您的测试应用中安装发布的 npm 包
