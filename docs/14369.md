...
> 原文:[https://dev . to/azure/using-easy auth-appservice-authentic ation-with-ASP-net-core-1c J1](https://dev.to/azure/using-easyauth-appservice-authentication-with-asp-net-core-1cj1)
...
## [](#installing-the-solution)安装解决方案
