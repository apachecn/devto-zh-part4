...
> 原文:[https://dev . to/prahladyeri/how-to-trim-your-Ubuntu-installation-of-extra-fat-and-make-it-fast-58ib](https://dev.to/prahladyeri/how-to-trim-your-ubuntu-installation-of-extra-fat-and-make-it-faster-58ib)
...
## [](#remove-unwanted-items-from-startup-applications)从启动应用程序中删除不需要的项目
...
[![Startup Applications (Ubuntu)](../Images/17eb7bea68a9da9ffddb50b00408131e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T6tmgm7K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://prahladyeri.github.io/uploads/2017/09/startup_applications.png)
...
## [](#remove-unnecessary-background-services-such-as-cups-and-avahidaemon)删除 cups、avahi-daemon 等不必要的后台服务
...
## [](#disable-hud-if-you-dont-use-it)禁用 HUD(如果不使用)
...
## [](#disable-evolution-processes-if-you-use-thunderbird-or-anything-else-instead)禁用进化进程(如果你用雷鸟或者别的什么代替)
...
## [](#remove-gnome-software-center-only-if-you-dont-use-it)移除 GNOME 软件中心(仅在不使用时)
