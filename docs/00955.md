...
> 原文:[https://dev.to/stephenafamo/better-scheduling-in-go-4f7e](https://dev.to/stephenafamo/better-scheduling-in-go-4f7e)

[![](img/ce4d56209b585f18f8fe0c5879dd859c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g32yznFA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/stephenafamo.com/blog/wp-content/uploads/2019/09/cropped-Scheduling-in-Go.png%3Ffit%3D1334%252C750%26ssl%3D1)
...
## [](#using-raw-timeafter-endraw-)利用 [`time.After()`](https://golang.org/pkg/time/#After)
...
## [](#using-raw-timeticker-endraw-)利用 [`time.Ticker`](https://golang.org/pkg/time/#Ticker)
...
### [](#dangers-of-using-raw-timetick-endraw-)使用 [`time.Tick()`](https://golang.org/pkg/time/#Tick) 的危险性
...
### [](#limitations-using-raw-timetick-endraw-)局限性使用 [`time.Tick()`](https://golang.org/pkg/time/#Tick)
...
## [](#extending-raw-timetick-endraw-using-a-custom-function)扩展 [`time.Tick()`](https://golang.org/pkg/time/#Tick) 使用自定义功能
...
### [](#whats-happening-in-the-function)函数中发生了什么
...
## [](#examples-of-using-the-custom-function)使用自定义功能的例子
