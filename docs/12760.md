...
> 原文:[https://dev . to/bnevilleoneill/a-complete-guide-to-the-node-js-event-loop-1o5h](https://dev.to/bnevilleoneill/a-complete-guide-to-the-node-js-event-loop-1o5h)

[![](../Images/d4395668e3c5c42d091c5ee468a5d689.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2NCpJsdy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/044hlrpdmwp9ym78wlxn.jpeg)
...
## [](#a-brief-refresh-on-threads)线程上的短暂刷新
...
<figure>[![Understanding Threads](../Images/109eb0f94c52cb0392753b2bc565bb3f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8y46Y9Rg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/understanding-threads.png%3Fssl%3D1) 
...
<figure>[![How Multi-core Machines Process Threads](../Images/b2febe3c3b02b586176bfcadd9833e5f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--XJhGiEAb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/multi-core-machines.png%3Fssl%3D1) 
...
[![Feeding Node.js The Example File](../Images/4012333c248d4c70ebad05fde20deb9b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--saeTHW6D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/feeding-node-myprogram.png%3Fresize%3D730%252C307%26ssl%3D1)

特别是，我将首先写一个简短的图形解释，说明在任何事件循环周期中发生了什么，然后我将更深入地探索这些阶段。

<figure>[![Illustrating The Node.js Event Loop](../Images/371a6b3d6b58281f2965e6c23513360c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CGb8dccx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/blog.logrocket.com/wp-content/uploads/2019/07/illustrating-event-loop.png%3Fssl%3D1) 

<figcaption>对事件循环的图形化解释。</figcaption>

</figure>

### [](#step-1-raw-performchecks-endraw-)第一步:`performChecks`

我不需要告诉你事件循环实际上是一个循环。这意味着它有一个特定的条件来决定循环是否需要再次迭代。事件循环的每次迭代被称为**节拍**。

#### [](#what-are-the-conditions-for-the-event-loop-to-perform-a-tick)事件循环执行滴答的条件是什么？
...
### [](#step-2-performing-a-tick)第二步:执行滴答
...
## [](#common-questions-and-myths-about-the-event-loop)关于事件循环的常见问题和误区

### node . js 是完全单线程的吗？

这是对这项技术非常普遍的误解。Node 运行在单线程上，但是 Node.js 标准库中包含的一些函数却没有(例如`fs`模块函数)；它们的逻辑在 Node.js 单线程之外运行。这样做是为了保持我们程序的速度和性能。

### [](#where-are-these-other-threads-outsourced)这些其他线程外包到哪里去了？
...
### [](#so-the-event-loop-is-kind-of-a-stacklike-structure)所以事件循环是一种类似堆栈的结构？
