...
> 原文:[https://dev . to/rpm 4 real/in-line-rename-of-pandas-aggregates-3i6n](https://dev.to/rpm4real/in-line-renaming-of-pandas-aggregates-3i6n)
...
## [](#higherorder-renaming-function)高阶重命名功能
