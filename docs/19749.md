...
> 原文:[https://dev.to/bnevilleoneill/what-s-new-in-nuxt-2-7-3gf4](https://dev.to/bnevilleoneill/what-s-new-in-nuxt-2-7-3gf4)

[![](../Images/3ffbac5f44422e75f2937e6e6b1e2dcc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W_D1H3nc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vec75fctpckfgc7es9j6.png)
...
GitHub 上有超过 20，000 个 [![⭐](../Images/ae03549d61f256a5ee2a7246b9c60e07.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--N_KR-JfB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/12.0.0-1/72x72/2b50.png) 的应用程序，并且有大量专门的社区成员不断提供支持，构建具有 SSRA 和 SPA 特性的高性能、稳定和高效的 VueJS 应用程序从未如此简单。
...
[![](../Images/14fe55f4e054447d1a8dc5ec6951568a.png)T2】](https://logrocket.com/signup/)

## [](#ssr-universal-rendering-logs-in-your-browser)浏览器中的 SSR(通用渲染)日志
...
## [](#automatic-detecting-of-store-directory-creation)自动检测商店目录的创建
...
[![](../Images/336242c5284e2ec5a975ae5faa32d883.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uxZlFTJ3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i0.wp.com/user-images.githubusercontent.com/904724/57455462-70243900-726b-11e9-8b1b-675e31f17c44.gif%3Fssl%3D1)

## [](#extending-babelpresets-and-babel-envname-api)扩展 babel.presets 和 babel envName API
...
## [](#ignore-not-found-warnings)忽略“未找到”警告
