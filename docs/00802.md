...
> 原文:[https://dev . to/hasurahq/the-ultimate-guide-to-handling-jwts-on-frontend-clients-graph QL-252 a](https://dev.to/hasurahq/the-ultimate-guide-to-handling-jwts-on-frontend-clients-graphql-252a)
...
## [](#introduction-what-is-a-jwt)简介:什么是 JWT？
...
#### [](#but-if-i-have-a-valid-and-signed-jwt-and-someone-steals-it-from-the-client-cant-they-use-my-jwt-forever)但是如果我有一个有效的、签名的 JWT，有人从客户端偷走了它，难道他们不能永远使用我的 JWT 吗？
...
[![](img/7f4e2694f9f3cd749c56e24c7f414cbf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jG_Dq1oi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/conteimg/2019/08/Group.png)
...
[![](img/0abc8cd6d1afeb0d8ecf260261401190.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ApIB4zyl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/conteimg/2019/08/Screen-Shot-2019-08-29-at-12.54.53.png)

#### [](#ugh-this-seems-complicated-why-shouldnt-i-stick-to-good-old-session-tokens)唉！这似乎很复杂。为什么我不应该坚持使用旧的会话令牌呢？
