...
> 原文:[https://dev . to/almadiredy/full-stack-101-1-installing-node-zeit-now-and-deploying-5d 70](https://dev.to/almadireddy/full-stack-101-1-installing-node-zeit-now-and-deploying-5d70)
...
### [](#installing-the-zeit-cli)安装 ZEIT CLI
...
### [](#no-magic-breaking-down-the-npm-install-command)没有魔法:分解 npm 安装命令
...
[![Screenshot of hello world app](img/bceadcfd978fdb0ebfdd061b01146754.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--S6b3dSxb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/4P7uJoz.png)
