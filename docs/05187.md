...
> 原文:[https://dev . to/pen cillr/looks-like-I-have-to-use-vim-now-3988](https://dev.to/pencillr/looks-like-i-have-to-use-vim-now-3988)

## [](#that-awkward-moment)那个尴尬的时刻
...
[![What have I done](../Images/75eca75c7898c9f0d9238be224a6e8aa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pu5iEq-s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mczeauitn8gnubpysivt.gif)

## [](#not-another-vim-praising-post)不是又一个 Vim 赞帖
...
## [](#still-there-are-those-times)尽管如此，还是有那些时候
...
[![hamza](../Images/f4c2b6ed44ae8852191397fdc6151502.png)](/hamza) [## Vim 入门——您需要知道的最基本的知识
...
#### [](#manipulating-text-blocks)操纵文本块
...
#### [](#plugins-and-other-ways-of-heresy)外挂和其他异端方式
...
#### [](#the-dessert-my-raw-vimrc-endraw-)甜品:我的`.vimrc`
...
[![plusone](../Images/bd3b8ee97acaff7cbc33b5e3b2aa3592.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cWeSEbX8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ypvzafveynm5q1njmrs3.gif)