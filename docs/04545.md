...
[![](img/176eddd1c1df5c8f2c0a1707dc6d92fd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1omKf2Bs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2017/06/kuber-1.png)
...
[![](img/7b01d7f17cbb8ab41d092cb650f58d87.png "Kubernetes: аутентификация и авторизация в AWS EKS - aws-iam-authenticator и IAM")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190831_115046.png)
...
### [](#aws-eks-authentication-and-authorization)AWS EKS 认证和授权

下图详细描述了这一过程:

[![](img/631bff5e2fe4ad296872a7df9f434133.png "Kubernetes: аутентификация и авторизация в AWS EKS - aws-iam-authenticator и IAM")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/1_QQJZp8zc27jCkbJLaIVhZQ.png)

### [](#aws-eks-iam-authentication)AWS EKS IAM 认证
...
[![](img/97fc9d92ed8ddc4d8504f6ef0733e708.png)T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/1_N8rXK8rR0J3IEaYWBd_cqA.png)
...
#### [](#-raw-kubectl-endraw-authentification)`kubectl`认证
...
#### [](#aws-cli-vs-raw-awsiamauthenticator-endraw-)AWS CLI vs `aws-iam-authenticator`
...
[![](img/d23c029ddcdc0729e7f477b6ee392664.png "Kubernetes: знакомство, часть 4 - аутентификация в AWS EKS, aws-iam-authenticator и AWS IAM")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190831_144427-1.png)

#### [](#-raw-heptioauthenticatoraws-endraw-vs-raw-awsiamauthenticator-endraw-)`heptio-authenticator-aws` vs `aws-iam-authenticator`
...
### [](#aws-eks-raw-awsauth-endraw-configmap)AWS EKS `aws-auth`配置图
...
#### [](#adding-a-new-user-to-the-clusters-configmap)向集群的配置图添加新用户
...
#### [](#root-aka-cluster-creator)“根”又名集群创建者
...
[![](img/6879a4744211f45ebfeb1dd24a2b71cc.png "Kubernetes: аутентификация и авторизация в AWS EKS, часть 1 - aws-iam-authenticator и IAM")T2】](https://rtfm.co.ua/wp-content/uploads/2019/08/Screenshot_20190831_155845.png)
