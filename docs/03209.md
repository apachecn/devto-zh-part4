...
> 原文:[https://dev . to/iuriimednikov/Java-optional-vavr-option-an-essential-introduction-10cb](https://dev.to/iuriimednikov/java-optional-vavr-option-an-essential-introduction-10cb)
...
### [](#finding-cars-with-java-optional)用 Java 可选找车
...
### [](#finding-cars-with-vavr-option)使用 Vavr 选项查找汽车
