...
> 原文:[https://dev . to/kai Walter/setting-secrets-when-hosting-functions-runtime-in-a-container-4obp](https://dev.to/kaiwalter/setting-secrets-when-hosting-functions-runtime-in-a-container-4obp)
