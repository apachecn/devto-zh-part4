...
> 原文:[https://dev . to/codegram/adopting-the-jam stack-building-CMS-backed-static-websites-with-vue-or-react-480 l](https://dev.to/codegram/adopting-the-jamstack-building-cms-backed-static-websites-with-vue-or-react-480l)
...
## [](#whats-the-jamstack)什么是 JAMStack？
...
## [](#no-doubt-no-doubt-should-i-use-it)无疑，无疑。该不该用？
...
## [](#how-does-the-developer-experience-look-like)开发者体验是什么样子的？
...
## [](#sold-how-can-i-start-using-it-today)售出。今天怎么开始用？

我确信我还缺少很多工具和服务，但是这里有一个我曾经使用过的工具和服务的汇编，我真的可以推荐！

### [](#web-application-frameworks)Web 应用框架
...
#### [](#your-ci-of-choice-s3-cloudfrontcloudflare)您选择的 CI+S3+【CloudFront | cloud flare |。*]
...
[![](../Images/06d89b9efe2ea8009f454a3f71d025ad.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--XlYqBOJh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ua613dwhoti9kakz1id2.gif) 
*给你一些时间休息，让它沉下去*

## [](#things-that-ive-learned-working-with-the-jamstack)我在使用 JAMStack 时学到的东西

### [](#rebuilding-after-every-change-is-totally-fine)每一次变化后的重建都完全没问题
...
### [](#highly-dynamic-content-can-also-be-served)还可以提供高度动态的内容
