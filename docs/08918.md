...
> 原文:[https://dev . to/rakan nimer/pagination-sorting-with-AWS-amplify-4l 37](https://dev.to/rakannimer/pagination-sorting-with-aws-amplify-4l37)
...
[![What the channel page should look like](../Images/f36d92a1fc61b57cac98ca2a368a9660.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8OdMjsBm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lgaed7j0wnf58makup8z.png)

*   `channels`按上次更新日期降序排列的频道列表(最新的总是在顶部)。用户可以添加频道并实时查看添加的频道。

[![What the channels page should look like](../Images/106ec068e8da7290e0f2c4362344a537.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jEgDznMJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/430gsiipeghyl0ef7vq0.png)

*   `me`当前用户的简档路线，用于编辑用户的基本信息。一个有 3 个字段的表单用户名，网址，简历

[![What the profile page should look like](../Images/d7ec88d7f178bd9a913e6a126aa8bd3d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xBhBhjNZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x130wve4ud2twd7pofjj.png)

> 调色板取自 [@dabit3](https://dev.to/dabit3) 的优秀[会议应用程序盒](https://github.com/dabit3/conference-app-in-a-box/)

## [](#defining-local-state)定义本地状态
...
## [](#defining-the-data-model-with-graphql)用 GraphQL 定义数据模型
...
### [](#creating-our-custom-queries)创建自定义查询

#### [](#-raw-getchannellist-endraw-)`getChannelList`
...
#### [](#-raw-getchannelmessages-endraw-)`getChannelMessages`
...
#### [](#-raw-updatechannel-endraw-)`updateChannel`
...
### [](#using-our-custom-queries)使用我们的自定义查询
...
代码由 AWS Amplify 控制台构建和部署。要部署你自己的，你可以点击这个按钮 [![amplifybutton](../Images/51508332abcfc80db7c7ad175ea69bbf.png)](https://console.aws.amazon.com/amplify/home#/deploy?repo=https://github.com/rakannimer/pagination-and-sorting-with-aws-amplify) 或者只是将你的库连接到 Amplify 控制台，就这样。
