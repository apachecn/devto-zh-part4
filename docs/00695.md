...
> 原文:[https://dev . to/atorn blad/don-t-forget-to-build-that-app-2md 6](https://dev.to/atornblad/don-t-forget-to-build-that-app-2md6)
...
# [](#compatibility-with-earlier-android-versions)兼容早期 Android 版本🤜🤛
...
## [](#detecting-device-reboots)检测设备重启
