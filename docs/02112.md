...
> 原文:[https://dev . to/s _ Aitchison/page-titles-and-a11y-in-single-page-applications-esp-react-vue-4ok 8](https://dev.to/s_aitchison/page-titles-and-a11y-in-single-page-applications-esp-react-vue-4ok8)

(这篇文章的一个版本只详细描述了 React 的实现，最初发布在[Up Your A11y:Handling Page Titles in React](https://www.upyoura11y.com/page-titles/))

## [](#why-is-the-page-title-important-for-accessibility)为什么页面标题对可访问性很重要？
...
## [](#managing-the-page-title-in-vue)管理 Vue 中的页面标题
