...
> 原文:[https://dev.to/vintharas/vim-s-secret-language-8oc](https://dev.to/vintharas/vim-s-secret-language-8oc)
...
[![](../Images/e05f6efe5343078c4f144b456ea86474.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dlFWu67C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vim-secret-language-reuse.jpg)
...
使用 Vim，你将看到一段文本，你将不再仅仅看到单词或文本，你将看到无限数量的操作符和动作同时被应用的可能性 <sup id="fnref1">[1](#fn1)</sup> 。
