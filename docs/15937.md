...
> 原文:[https://dev.to/kdekooter/a-poor-man-s-vue-seo-solution-d2l](https://dev.to/kdekooter/a-poor-man-s-vue-seo-solution-d2l)
...
# [](#render-static-html-from-vue-templates)从 Vue 模板渲染静态 HTML

## [](#include-vue-templates)包括 Vue 模板
...
## [](#render-markdown-content)渲染降价内容
...
## [](#compile-to-html-in-a-build-step)在构建步骤中编译成 html
...
# [](#serve-static-html-to-web-spiders)为网络蜘蛛提供静态 HTML
