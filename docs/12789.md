...
> # [](#una-clase-deber%C3%ADa-de-tener-una-%C3%BAnica-responsabilidad)A class should have only one responsibility.
...
> # [](#a-code-smell-is-a-surface-indication-that-usually-corresponds-to-a-deeper-problem-in-the-system-martin-fowler)"Code smell is a superficial sign, usually corresponding to a deeper problem in the system". —martin fowler

该术语由 Kent Beck 在 1999 年与 Martin Fowler 合着出版的《t0》* refactoring:improving the design of existing code*一书中作了总结。

## [](#a-qu%C3%A9-huele-una-clase-que-no-cumple-con-el-srp)不符合 SRP 的班级闻起来像什么？
...
## [](#c%C3%B3mo-solucionamos-el-srp)我们解决 SRP 了吗？
