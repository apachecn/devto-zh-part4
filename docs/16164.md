...
> 原文:[https://dev . to/drewtownchi/the-magic-of-vue-s-dynamic-components-for-list-of-data-5j 8](https://dev.to/drewtownchi/the-magic-of-vue-s-dynamic-components-for-lists-of-data-5j8)
...
## [](#using-html-templates)使用 HTML 模板
...
## [](#moving-all-of-the-logic-to-child-components)将所有的逻辑移动到子组件
...
## [](#bringing-in-a-dynamic-component)引入动态成分
