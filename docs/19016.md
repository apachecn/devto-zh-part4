...
> 原文:[https://dev . to/Maxwell _ dev/Goldilocks-and-the-three-behavioral-patterns-a-design-patterns-intro-576](https://dev.to/maxwell_dev/goldilocks-and-the-three-behavioral-patterns-a-design-patterns-intro-576)
...
## [](#getting-the-bikes-ready-with-a-strategy)根据策略准备好自行车
...
## [](#communicating-the-trip-with-an-interpreter)与翻译沟通行程
...
## [](#letting-the-porridge-cool-with-a-visitor)和客人一起让粥凉了
...
## [](#tasting-the-porridge-with-state)品尝着粥与粥
...
## [](#measuring-the-return-path-with-a-template)用模板测量返回路径
...
## [](#waking-goldilocks-with-a-command)用命令唤醒金发女孩
...
## [](#the-design-pattern-quest-continues)设计模式探索继续
