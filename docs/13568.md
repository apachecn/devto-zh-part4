...
> 原文:[https://dev . to/sleeplessbyte/Tetris-选择工具并设置项目-4kh6](https://dev.to/sleeplessbyte/tetris-choosing-the-tools-and-setting-up-the-project-4kh6)
...
[![Photo showing various machines in the Arcade "Lightroom", in New Brighton, Wallasey, United Kingdom](../Images/ae87a369791f52607e9f562de58c3622.png "Photo by Carl Raw (https://unsplash.com/@carltraw) on Unsplash (https://unsplash.com/)")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dJcgWzhE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kmddjw275q1tzeym5f74.jpg)
...
### [](#linting-and-styleguides)林挺和 Styleguides
...
## [](#initialisation-of-the-project)项目的初始化
...
## [](#setting-up-raw-typescript-endraw-correctly)正确设置`typescript`
...
## [](#setting-up-raw-babel-endraw-correctly)正确设置`babel`
...
## [](#setting-up-raw-eslint-endraw-correctly)正确设置`eslint`
...
### [](#testing-the-raw-eslint-endraw-configuration)测试`eslint`配置
...
## [](#setting-up-raw-jest-endraw-correctly)正确设置`jest`
...
### [](#enabling-raw-jestdom-endraw-extensions)启用`jest-dom`扩展
...
### [](#getting-a-coverage-report)获取覆盖报告
...
## [](#setting-up-raw-prettier-endraw-correctly)正确设置`prettier`
...
### [](#automatically-formatting)自动格式化
