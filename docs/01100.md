...
# [](#what-is-a-promise)什么是承诺？

根据 MDN 文档:**承诺是一个对象，表示异步操作的最终完成或失败，以及它的结果值**。

# [](#why-do-we-use-promises-in-javascript)为什么我们在 JavaScript 中使用承诺？
...
# [](#different-states-in-a-promise)不同状态中的一个承诺
...
# [](#getting-to-know-more-about-the-promise-object)进一步了解承诺对象
...
[![javascript-promise-object-in-depth-part-one](img/6171ac42454d2d71202f5bf17a360b20.png "Javascript Promise Object In Depth Part One")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YMbrXVce--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-GZOYWtwYeMk/XXzAjrtQLuI/AAAAAAAABWM/OsBgVWbtqf0EriX5iZaVf92kn7alq20JQCLcBGAsYHQ/s640/javascript-promises-object-in-depth-two.png)

如果我们进一步展开，我们将看到类似如下所示的内容。请注意，图像中突出显示的部分。

[![javascript-promise-object-in-depth-part-two](img/f29490aa0a1cf36919ab7566cf5ade39.png "Javascript Promise Object In Depth Part Two")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---t5fQyyN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-qDYHH0SbOJo/XXzBA-EggEI/AAAAAAAABWU/er4iJkiHkLotgMe57uhdwO7b8EJGl07ewCLcBGAsYHQ/s640/javascript-promises-object-in-depth-three.png)

## [](#static-methods-in-promise-object)许诺对象中的静态方法
...
# [](#creating-a-promise-in-javascript)用 Javascript 创建承诺
...
# [](#invoking-the-promise-in-javascript)调用 Javascript 中的承诺
...
## [](#non-technical-point-of-view)非技术观点
...
### [](#implementing-promise-chaining-in-javascript)在 Javascript 中实现承诺链
...
## [](#what-is-promiseall)什么是 Promise.all()？
...
[![javascript-promise-race-output](img/be2649de2033dcd49c4b132af89d9a63.png "Javascript Promise Race Output")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VPXeHCip--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-O0yHCcm0YWg/XXzyQv1FkPI/AAAAAAAABXQ/tEAPqdtVfeMrJslmjOMkkVBpgUA2_B2HQCLcBGAsYHQ/s640/javascript-promises-object-promise-race-output.png)
...
# [](#writing-javascript-promises-with-es6es2015-es7)写 Javascript 承诺用 ES6/ES2015，ES7
