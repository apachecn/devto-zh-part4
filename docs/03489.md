...
> 原文:[https://dev . to/nested software/py torch-image-recognition-with-convolutionary-networks-4k 17](https://dev.to/nestedsoftware/pytorch-image-recognition-with-convolutional-networks-4k17)
...
## [](#simple-convolutional-network)简单卷积网络
...
[![convolutional network](img/34c18de8f732826eb4ce198cc379c502.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5_CircOt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p4q7xbnn5o13noe9hqnk.png)
...
[![convolutional layer with max pooling](img/d0adc2304d1c266ef1fc8c339fe75ed8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0Tk9vS3f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ctzw0mndjoonee3ybzmh.png)
...
[![normalize output](img/84febf64c55b17494cf4605cbdf4cb00.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s8dEOMLa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/onbx2gx8j8qcs2jqejka.png)

我们将使用一个名为 [*softmax*](https://en.wikipedia.org/wiki/Softmax_function) 的函数来代替。使用 softmax，我们通过对每个输出应用指数函数来调整上述公式:

[![softmax output](img/151e9cffdda235c4e2505a0241194371.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VTWRoPpF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0vzj1rupkekbepd3ssw1.png)
...
[![loss function comparison](img/b9239e96179abb7030fa738679fabe05.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WT6yOarq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nvstofwjzk07bkkv3iq3.png)
...
## [](#results-for-simple-convolutional-network)结果为简单卷积网络
...
## [](#add-a-second-convolutional-layer)添加第二个卷积层
...
[![second convolutional layer](img/d7806c9276154dfc9cd3c0a25b6c0037.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BpoPdSxW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/86n04id9njyuys2wvwc4.png)
...
## [](#results-for-two-convolutional-layers)两个卷积层的结果
...
## [](#replace-sigmoid-with-relu)用 ReLU 替换乙状结肠
...
## [](#expand-the-training-data)扩展培训数据
...
## [](#results-with-expanded-training-data)扩充训练数据后的结果
...
## [](#add-fully-connected-layer-and-dropout)添加全连通层和漏接层
...
[![final network training progress](img/05395f91a7906539506f8e0e7c708ad9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8t5Wkxqb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jy1pkhoreratz7vktc0w.png)
