...
> 原文:[https://dev . to/nya Garcia/understanding-the-JavaScript-spread-operator-from-beginner-to-expert-5bdb](https://dev.to/nyagarcia/understanding-the-javascript-spread-operator-from-beginner-to-expert-5bdb)
...
# [](#what-we-are-going-to%C2%A0learn)我们要学什么
...
# [](#why-you-should-use-the-spread%C2%A0operator)为什么要使用 spread 运算符
