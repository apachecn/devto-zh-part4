...
> 原文:[https://dev . to/bnevilleoneill/how-to-use-form-builders-in-angular-8-to-validate-reactive-forms-239m](https://dev.to/bnevilleoneill/how-to-use-form-builders-in-angular-8-to-validate-reactive-forms-239m)
...
## [](#forms-controls-and-form-groups-in-angular)窗体控件和窗体组成角度
...
## [](#generating-form-controls)生成表单控件
...
### [](#registering-the-form-builder)注册表单生成器
...
### [](#displaying-input-values-and-status)显示输入值和状态
