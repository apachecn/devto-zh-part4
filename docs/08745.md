...
> 原文:[https://dev . to/houstonhhaynes/achieving-full-screen-pbp-in-4k-one-person-s-journey-4 AKP](https://dev.to/houstonhhaynes/achieving-full-screen-pbp-in-4k-one-person-s-journey-4akp)

# [](#theory-vs-practice)理论 vs 实践
...
## [](#bigger-and-wider-is-not-always-better)更大(更宽)并不总是更好
...
## [](#reading-the-fine-print)阅读小字

这是我买的第一台 4K 显示器的照片，下面是我对 PBP 的初次尝试。

[![Philips 4K PBP double letter boxing](../Images/34001621138f991efac854c28b2c77cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vlPKsIV9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/phxtc131csezypjezs09.jpg)
...
## [](#take-two-this-time-with-feeling)取两个，这个时候用感觉

第二台显示器更轻，耗电更少，几乎不会灼伤屏幕，而且比我的首选便宜了近 100 美元。所以我觉得自己在很多方面都很幸运。然而，第二次 PBP 结果并不比第一次好多少。

[![ViewSonic 4K PBP letter-boxing](../Images/9be7ddc5a8bfb299acbe0b60025c519c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kXMkgc2K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mkoxrksc9p8u0uaipa3k.jpg)

当全屏运行时，图像缩放到显示区域的最大高度，仍然会出现文字框。

[![ViewSonic monitor input Full Screen setting](../Images/2c6452ded39a26ccf4b4a97c5a921f19.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H9nBfKq0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9kh6hu8ltln9d4phu1hg.jpg)
...
## [](#checking-under-the-other-hood)(其他)发动机罩下检查

一周后，我收到了第二个技术支持团队的电子邮件，通过电话联系，尝试另一种可能的解决方案。我并不抱什么希望，但一旦我们开始讨论这个问题，我就明白了这个想法:电脑的视频驱动程序可能会按照 16:9 的纵横比来调整输出。

[![NVidia Control Panel settings - Full Screen](../Images/9109417d82c89eb6737b27b00d388a44.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J1aBI7-4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mwss4ydl2zqp3b7y0mw0.png)

一旦我们检查了 NVidia 控制面板，我们看到它被设置为将选择的分辨率格式化为“纵横比”。这实际上意味着，当分辨率设置为非 16:9 分辨率时，驱动程序会对显示器的输出进行字母装箱。一旦设置变成了“全屏”，一切就水落石出了。

[![ViewSonic 4K with proper PBP configuration](../Images/15b4ed19d1ceff82485a8960cd1ef249.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kz2Amu-e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/w2uq8k9s09gqywz18kz3.jpg)
...
## [](#greater-than-the-sum-of-its-parts)大于其各部分之和
