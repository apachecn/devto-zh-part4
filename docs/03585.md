...
> 原文:[https://dev . to/lampewebdev/CSS-quickies-CSS-variables-or-how-you-create-a-white-dark-theme-easy-1i0i](https://dev.to/lampewebdev/css-quickies-css-variables-or-how-you-create-a-white-dark-theme-easily-1i0i)
...
### [](#lets-talk-about-raw-custom-properties-endraw-aka-raw-css-variables-endraw-)先说`Custom properties`又名`CSS Variables`。
...
#### [](#defining-a-css-variable)定义一个 CSS 变量
...
##### [](#multiple-fallback-values)多个回退值
...
##### [](#what-if-my-fallback-value-needs-a-comma)我的回退值需要逗号怎么办？
...
#### [](#making-a-theme-switcher-with-custom-variables)用自定义变量制作主题切换器
