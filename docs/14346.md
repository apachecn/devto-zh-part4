...
> 原文:[https://dev . to/miloszpp/the-meaning-of-union-and-intersection-types-hk1](https://dev.to/miloszpp/the-meaning-of-union-and-intersection-types-hk1)
...
## [](#union-and-intersection-of-object-types)对象类型的并集和交集
...
[![Intersection of sets](../Images/0ba0f4666fe3da36bded07fcdb72f823.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L8aGCZiU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tpbziuorp9smrysig3kw.png)

## [](#relationship-between-types-and-sets)类型与集合的关系
...
## [](#understanding-union-and-intersection-types)了解并集和交集类型
...
## [](#realworld-example-of-intersection-type)现实世界中交集类型的例子
