...
> 原文:[https://dev . to/kgoralski/deep-dive-into-micro services-architecture-h54](https://dev.to/kgoralski/deep-dive-into-microservices-architecture-h54)
...
## [](#monoliths-vs-microservices)单片 vs 微服务
...
[![Microservices patterns](../Images/a314439247a988c27b4d3dd45dcadaca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5IAw56cA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://docs.microsoft.com/en-us/azure/architecture/microservices/images/microservices-patterns.png)
...
### [](#the-effects-of-the-fallacies)谬误的影响
...
## [](#the-10-commandments-of-microservices)微服务的十大戒律
...
## [](#microservices-and-teams)微服务和团队
...
## [](#microservices-should-be-organized-around-business-capabilities-and-domain)微服务应该围绕业务能力和领域进行组织
...
## [](#reactive-programming-and-microservices)无功编程和微服务
...
## [](#microservices-solve-organizational-problems-and-cause-technical-problems)微服务解决组织问题，引发技术问题

来自 Go +微服务= Go Kit [I] -彼得·波尔贡，Go Kit

【https://youtu.be/NX0sHF8ZZgw?t=729】T2

## [](#problems-solved-problems-caused-lessons-learned)解决的问题、引发的问题、吸取的教训
...
## [](#internal-communication-and-rest-vs-messaging)内部沟通与休息 vs 消息传递
...
## [](#microservices-antipatterns-and-pitfalls)微服务反模式和陷阱
