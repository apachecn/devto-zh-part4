...
> 原文:[https://dev . to/on myway 133/how-to-add-indicator-under-tab-bar-buttons-in-IOs-5bl 6](https://dev.to/onmyway133/how-to-add-indicator-under-tab-bar-buttons-in-ios-5bl6)

## [](#selectionindicatorimage)选择指示标志
...
## [](#custom-uitabbar-or-uitabbarcontroller)自定义可展开或可展开控制器
...
## [](#handle-uitabbarcontrollerdelegate)处理 UITabBarControllerDelegate
