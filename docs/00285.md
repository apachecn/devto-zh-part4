...
> 原文:[https://dev . to/dg92/JavaScript-feature-you-may-not-know-in-2019-2020-4p 5d](https://dev.to/dg92/javascript-feature-you-might-not-know-in-2019-2020-4p5d)

# [](#private-class-field)私有类字段👇
...
# [](#stringmatchall)String.matchAll()👇
...
# [](#locale-string-with-bigint)带 BigInt 的区域设置字符串👇
...
# [](#globalthis-keyword)GlobalThis 关键字👇
...
[![Alt Text](img/788c5854c1461b800d53b0521c3804f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---OdaIA0w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1wpoe7wmuqiul5ufqzxu.png)
...
# [](#stable-sorting-consistent-and-reliable-result-now)稳定排序—(现在一致可靠的结果)👇
