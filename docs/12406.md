...
> 原文:[https://dev.to/vicradon/my-journey-using-freecodecamp-3m19](https://dev.to/vicradon/my-journey-using-freecodecamp-3m19)
...
## [](#1-destructuring)1。解构

这需要很多东西，例如:

### [](#a-array-destructuring)A .数组析构
...
#### [](#inline-variable-creation)行内变量创建
