...
> 原文:[https://dev . to/danial Malik/a-beginner-s-guide-to-clean-code-part1-naming-conventions-139 l](https://dev.to/danialmalik/a-beginner-s-guide-to-clean-code-part1-naming-conventions-139l)
...
### [](#intention-of-the-variable-should-be-clear-from-its-name)变量的意图从它的名字就应该清楚。
...
### [](#variable-names-should-be-meaningfully-distinct)变量名应该是有意义的不同
...
### [](#variable-names-should-be-pronounceable)变量名应该是可发音的。
...
### [](#searchable-variables-and-constants-should-be-used)应该使用可搜索的变量和常量。
...
### [](#class-names-should-always-be-nouns)类名应该永远是名词。

*   类名和对象应该总是像`Person`、`Car`、`Record`之类的名词。避免通用和特定语言的技术名称，如`Info`、`Manager`和`Controller`。

### [](#method-names-should-have-a-verb)方法名应该有动词

*   方法名应该有动词或动词短语名(最好在开头)，比如`get`、`set`和`delete`。

### [](#decide-a-standard-for-names-serving-similar-purposes)为类似目的的名称确定一个标准。
...
### [](#use-context-with-variable-names-wherever-is-necessary)在任何需要的地方使用带有变量名的上下文。
