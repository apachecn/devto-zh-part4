...
> 原文:[https://dev . to/cmendibl 3/visual-studio-code-remote-containers-azure-ansi ble-1 oc4](https://dev.to/cmendibl3/visual-studio-code-remote-containers-azure-ansible-1oc4)
...
## [](#1-devcontainerjson)1。devcontainer.json
