...
> 原文:[https://dev.to/tomayac/project-fugu-at-w3c-tpac-2ngi](https://dev.to/tomayac/project-fugu-at-w3c-tpac-2ngi)
...
##### [](#breakout-session-js-builtin-modules)分组讨论 JS 内置模块
...
##### [](#breakout-session-new-module-types-json-css-and-html)分组会议新模块类型:JSON、CSS 和 HTML
...
##### [](#breakout-session-mini-app-standardization)分组会议迷你 App 标准化
...
##### [](#breakout-session-for-a-more-capable-webproject-fugu)一个更有能力的网络的分组会议——府谷项目
