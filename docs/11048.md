...
> 原文:[https://dev . to/kristijanfistrek/JavaScript-pattern-that-changed-everything-for-me-4c fa](https://dev.to/kristijanfistrek/javascript-pattern-that-changed-everything-for-me-4cfa)
...
[![](../Images/2d450581698110f05aff9c925920e828.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FAIR9xpq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0itpe03ifven1ssth3oq.jpg)

### [](#what-will-this-post-be-about)**这个帖子是关于什么的？**
...
### [](#2-javascript-pattern-that-changed-everything)**2。改变一切的 Javascript 模式**
