...
> 原文:[https://dev . to/chromium dev/hello-darkness-my-old-friend-3jcg](https://dev.to/chromiumdev/hello-darkness-my-old-friend-3jcg)

#### [](#overhyped-or-necessity-learn-everything-about-dark-mode-and-how-to-support-it-to-the-benefit-of-your-users)矫枉过正还是迫不得已？了解关于黑暗模式的一切，以及如何支持它以使你的用户受益！
...
### [](#dark-mode-before-dark-mode)黑暗模式前的黑暗模式

[![](../Images/9374721b810d7fc2e894a6b4dc2ee5b6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DMQ-0ujp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/640/0%2AYZQl9JWZBeUzhdLF.jpg) 
...
[![](../Images/f30bba9fa0efb9e2c2642fbbd1cae30a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--JynDJ8Z1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/698/0%2AILIBhfzAmuuP6fAK.jpg) 
...
[![](../Images/f414845e39e68b20d1abdbcbc6a3a3b6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EA_UDgfO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/0%2AQOV2uc-yZ1Tef17O.png) 
...
[![](../Images/2ffc48afffae4ee34f5f66c36156bda4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fImk0Jui--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/500/0%2A7glgTBgIbbQOgpju.jpg) 
...
#### [](#dark-mode-for-aesthetic-reasons)出于审美原因的黑暗模式
...
[![](../Images/ee90e6b969296b2028248bae2ae2b606.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NgXd-OC_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/531/0%2AZfv5E4GlFzQp4ZLN.png) 

<figcaption>系统 7 CloseView ( [来源](https://archive.org/details/mac_Macintosh_System_7_at_your_Fingertips_1992) )</figcaption>

#### [](#dark-mode-as-an-accessibility-tool)黑暗模式作为辅助工具
...
### [](#activating-dark-mode-in-the-operating-system)激活操作系统中的黑暗模式

现在我已经介绍了为什么黑暗模式对许多用户如此重要的背景，让我们回顾一下您如何支持它。

[![](../Images/09bb6592149e6f18c322b93c5d188f8b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0w4FiTWe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/610/0%2AErOuqrV3HKXKLA3w.png) 
...
### [](#supporting-dark-mode)支持黑暗模式

### [](#finding-out-if-dark-mode-is-supported-by-the-browser)查看浏览器是否支持黑暗模式
...
### [](#dark-mode-in-practice)黑暗模式中的练习
...
[![](../Images/29e82251960f2c68c30cd9d089e784a6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Axrwmzji--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2Al9ceKHmGLlj7jmxy.png) 

<figcaption>轻模式站点加载优先级最低的暗模式 CSS。</figcaption>

[![](../Images/7d1be70c408e50dc9b845ca78b275b69.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_59dZS6S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2A0AmWb_46uTpJ-jk-.png) 

<figcaption>黑暗模式下的站点加载优先级最低的光明模式 CSS。</figcaption>

[![](../Images/dfcee023b267161825b857f0d0daeda2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jzfaDJY4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AfJt_2qBrh-Jr2xqF.png) 

<figcaption>在不支持 prefers-color-scheme 的浏览器上，默认浅色模式的站点以最低优先级加载深色模式的 CSS。</figcaption>

### [](#reacting-on-dark-mode-changes)对黑暗模式变化做出反应
...
[![](../Images/4b7d617e54b8178bfada79b66020de88.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--smP1NKHv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2Awh4lG2vnLdTRcu5U.png) 

<figcaption>英雄形象在黑暗模式下略微变暗。</figcaption>

[![](../Images/013f046179c6962d377f81e3c5f4de21.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--03529tiO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AwHfT_my7AgR5o09a.png) 
...
#### [](#customizing-dark-mode-recolorization-intensities-with-javascript)用 JavaScript 自定义深色模式重新着色强度
...
### [](#invert-vector-graphics-and-icons)反转矢量图形和图标
...
[![](../Images/762f310a5b0f6623e116f79f44bbe19e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--epkkiF9---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/744/0%2AtMg3mLZc7MdOoj8c.png) 

<figcaption>图标在黑暗模式下是倒置的。</figcaption>

[![](../Images/6ffd1d014d54ef2311592be378bd4492.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5dUrXHVx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/744/0%2A9vONLnkqYt3BiDx4.png) 
...
### [](#smooth-transitions-between-modes)模式间平滑过渡
...
### [](#art-direction-with-dark-mode)艺术方向用黑暗模式
...
### [](#dark-mode-but-add-an-optout)黑暗模式，但是增加了一个选择退出
...
[![](../Images/ec3088792fbd39bf5384d5a569a1fb04.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--U0FxTRGJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/140/0%2AuXh_I436B20vKFFc.png) 

<figcaption><【黑暗模式】-在光明模式中切换>。</figcaption>

[![](../Images/7c90fa390e8e9bb014a5d58b3197f616.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--p77Kyrv4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/140/0%2A-YKdMX1aGAEMXKh5.png) 
...
## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)[Google chrome labs](https://github.com/GoogleChromeLabs)/[黑暗模式切换](https://github.com/GoogleChromeLabs/dark-mode-toggle)

### 一个自定义元素，允许您轻松地把一个黑暗的模式🌒在您的站点上切换或切换:

<article class="markdown-body entry-content p-5" itemprop="text">

[![Published on webcomponents.org](../Images/36c87959b1de571063c36be23cb283a2.png)T2】](https://www.webcomponents.org/element/dark-mode-toggle)

# `<dark-mode-toggle>`元素

一个自定义元素，让您可以轻松地把一个*黑暗模式<g-emoji class="g-emoji" alias="waxing_crescent_moon" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f312.png">🌒</g-emoji>* 在你的网站上切换，这样你可以根据 [`prefers-color-scheme`](https://drafts.csswg.org/mediaqueries-5/#prefers-color-scheme) 最初坚持你的用户的偏好，但也允许他们(可选地永久地)只为你的网站覆盖他们的系统设置。

<g-emoji class="g-emoji" alias="books" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4da.png">📚</g-emoji>全部阅读(！)关于黑暗模式在相关文章[你好黑暗，我的老朋友](https://web.dev/prefers-color-scheme/)。
...
<g-emoji class="g-emoji" alias="warning" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/26a0.png">⚠️</g-emoji> 自定义元素假设您已经将 CSS 组织在不同的文件中，这些文件是根据样式表的对应`link`元素中的 **`media`** 属性有条件地加载的。这是一个很好的性能模式，因为你不会强迫人们根据他们当前的主题偏好下载他们不需要的 CSS，但是不匹配…
