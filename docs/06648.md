...
> 原文:[https://dev . to/aminnairi/a-router-without-a-web-server-in-vanilla-JavaScript-3bmg](https://dev.to/aminnairi/a-router-without-a-web-server-in-vanilla-javascript-3bmg)

我看到一个关于如何用纯 JavaScript 创建路由器的帖子。因为它不是在谈论散列路由，我决定创建这个帖子来与你分享我的知识。

## [](#why-would-i-do-that)我为什么要这么做？
...
## [](#what-is-a-hashed-router)什么是哈希路由器？
...
## [](#how-can-i-implement-a-hashed-router)如何实现散列路由器？
