...
> 原文:[https://dev.to/pradhvan/context-managers-in-python-26ng](https://dev.to/pradhvan/context-managers-in-python-26ng)
...
#### [](#writing-your-own-context-manager)编写自己的上下文管理器
