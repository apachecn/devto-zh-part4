...
[![](../Images/448c84147ec24240e68d857144ce8844.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nD1WHama--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AODhvAjHjB8zPErBYhOFePQ.gif) 
*使用位共享其组成部分(一个例子)*

# [](#refer%C3%AAncias-do-projeto)项目参考
...
# [](#novo-tipo-raw-unknown-endraw-)新型`unknown`
...
# [](#defaultprops-suporte-em-jsx)默认道具支持 em JSX
...
# [](#tipos-mapeados-em-tuplas-e-arrays)元组和数组中映射的类型
...
# [](#sele%C3%A7%C3%A3o-de-vers%C3%A3o)版本选择
