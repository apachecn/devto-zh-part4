...
> 原文:[https://dev . to/remote synth/getting-started-with-offline-data-in-web-apps-pt-3-cam](https://dev.to/remotesynth/getting-started-with-offline-data-in-web-apps-pt-3-cam)
...
## [](#what-is-indexeddb)什么是 IndexedDB？
