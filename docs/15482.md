...
> 原文:[https://dev . to/bnevilleoneill/switching-between-node-versions-during-3c2l](https://dev.to/bnevilleoneill/switching-between-node-versions-during-development-3c2l)

[![](../Images/88fd371086028416212c5de19883264b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Zkgubq-8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3jegxmmdvigxx39pus24.jpg)
...
## [](#nvm-for-windows)用于 Windows 的 NVM
...
### [](#getting-application-1-running)让应用程序 1 运行
...
### [](#getting-application-2-running)让应用程序 2 运行
...
## [](#n-node-version-manager)n 节点版本管理器
...
### [](#using-a-node-binary-directly)直接使用节点二进制
