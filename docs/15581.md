...
> 原文:[https://dev . to/torianne 02/breaking-down-es6-arrow-functions-m5g](https://dev.to/torianne02/breaking-down-es6-arrow-functions-m5g)
...
### [](#arrow-functions-with-blocks)箭头功能用块
...
### [](#other-noteworthy-characteristics)其他值得注意的特征

我没有涵盖箭头函数的所有用例或特征，但是我想简要地介绍一下箭头函数的两个非常重要的方面。我也将提供链接，以便让你进一步研究这个主题。

#### [](#no-separate-raw-this-endraw-)没有单独的`this`
