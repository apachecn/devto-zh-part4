...
> 原文:[https://dev . to/Samantha Ming/string-starts with-method-in-JavaScript-1 m81](https://dev.to/samanthaming/string-startswith-method-in-javascript-1m81)

[![CodeTidbit by SamanthaMing.com](../Images/4b12c588224cded3b90cc1dce986e351.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L7Y16oqk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xfluwenv5wb48tsjbjee.png)
...
## [](#-raw-startswith-endraw-parameters)`startsWith`()参数
...
#### [](#exceeding-strings-length)超过字符串长度
...
#### [](#start-at-the-1st-index)从第 1 个索引开始
...
#### [](#start-at-the-2nd-index)从第 2 个索引开始
