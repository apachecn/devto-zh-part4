...
> 原文:[https://dev . to/Alec cool 213/beautiful-developer-tools-fish-shell-2hcd](https://dev.to/aleccool213/beautiful-developer-tools-fish-shell-2hcd)
...
| ![](../Images/abc4d8094aeef523109f244695b10e43.png) |
...
[![](../Images/12d5a45f586a110127e621d6ad9ca7d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I2S2WdWr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://res.cloudinary.com/dscgr6mcw/image/upload/v1565390429/fish-post/2019-08-09_18.40.08.gif)

#### [](#inline-autosuggestions-based-on-history)基于历史的内嵌自动建议
...
[![](../Images/1c2fec2978a63a07f9cb0fcb61f22526.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FDtkr8SZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://res.cloudinary.com/dscgr6mcw/image/upload/v1565390672/fish-post/2019-08-09_18.44.14.gif)

> 有趣的事实是，如果搜索结果是巨大的，鱼壳将分页！

#### [](#tab-completion-using-man-page-data)选项卡使用手册页数据完成
...
| ![example-of-fish-shell-tab-complete](../Images/2ee6ab369d35ddb9ba9fe4bfec0aba5f.png) |

#### [](#intuitive-wildcard-support)直观的通配符支持
...
| ![](../Images/38d2a47f96a9bd59b40f3f04a32817d8.png) |

#### [](#web-based-configuration)基于 Web 的配置
...
[![](../Images/698d844ef365ed2cee00f07d4949e4ec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tCMxVSYy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/dscgr6mcw/image/upload/v1565391525/fish-post/Screenshot_at_Aug_09_18-58-33.png)
...
| ![spacefish-shell-prompt-example](../Images/8d1658634335c8eaaad9d4563b40889a.png) |
...
#### [](#but-its-easy-to-be-compatible)但是很容易兼容...
