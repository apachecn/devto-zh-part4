...
> 原文:[https://dev.to/kelleyvanevert/introducing-literal-jsx-1plm](https://dev.to/kelleyvanevert/introducing-literal-jsx-1plm)

*非常简短的介绍:(1)看起来是这样的:*

[![](../Images/9d0c72cfb450f0c1d6e86378437da903.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dgMqIlq_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dti6i5hz1tz1z.cloudfront.net/items/060z40080y0s0e0X2m1G/Image%25202019-06-29%2520at%25207.09.25%2520PM.png)
...
[![](../Images/c652e18af4a9d8e9c22b943ccf74d8fc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wv6s5DH7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h2j04y5tddmywbq2be39.png)
...
## [](#thesis-jsx-is-about-ergonomics-and-intent)论文:JSX 是关于人体工程学和意图的
...
[![](../Images/7fa154ac851df679cad0b86a7f3d3a9a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZAKBQY9j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kqjisyxnwhfk9hncq621.png)

## [](#thesis-json-was-an-important-invention-as-a-standard)论文:JSON 是一项重要发明*作为标准*
...
### [](#use-case-content-authoring)用例:内容创作
...
### [](#use-case-actual-programmatic-exchange-of-ui-data)用例:UI 数据的实际编程交换

因为这将使更灵活，传统的分割(一方面)在*应用程序*之间，它需要理解如何可视化地构造数据；以及(另一方面)内容*，它需要遵循应用程序中预先定义的结构。*

 *## [](#literal-jsx-defined)字面 JSX，定义
...
[![](../Images/f62e6ad6989438af5e86e454a7b81149.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wssg7cQe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://dti6i5hz1tz1z.cloudfront.net/items/0v1V3e1g1n1x0s0h4411/Screen%2520Recording%25202019-06-29%2520at%252008.43%2520PM.gif)

然后，我们扩展了 JSON 的语法，以包括非终结符的“元素”:

[![](../Images/0eba0c2e67ce415fc8b029fcbcd74256.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JIMrYXhd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dti6i5hz1tz1z.cloudfront.net/items/1Q0E0D2B3r0Z1R2U280b/Image%25202019-06-29%2520at%25208.44.26%2520PM.png)
