...
> 原文:[https://dev . to/sauce kode/how-reduce-function-really-works-3j6m](https://dev.to/saucekode/how-reduce-function-really-works-3j6m)
...
[![](../Images/05f9f5f879ebfefa6591b8326053e9cd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MIMM2ZDc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qhh8y1ak570bo0tg5tue.png)

这是一些关于 reduce()如何工作的代码，但现在我将向您展示它真正是如何工作的。

准备好了。设置。走吧。

## [](#reduce-under-the-hood)减少引擎盖下的()

[![](../Images/81be6fb9f87b54bff56478d46427ee38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7HYEdM3J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p4smdyrc817t86w0h8e0.png)

这是 reduce()函数的扩展。

现在，我将把它分成几个部分，让你自己理解这是如何发生的。这是简单的数学，在 Javascript 中，它被称为增广加法/加法。

## [](#breaking-it-into-chunks)把它打碎成块
