...
> 原文:[https://dev . to/antjanus/my-personal-git-tricks-cheat sheet-23 J1](https://dev.to/antjanus/my-personal-git-tricks-cheatsheet-23j1)
...
## [](#rebase-on-top-of-originmaster)在原点/主顶点上重设基础
...
## [](#checkout-older-version-of-a-file-like-a-lock-file)签出旧版本的文件(像一个锁文件！)
...
## [](#bash-command-aliases)Bash 命令别名
