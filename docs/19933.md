...
> 原文:[https://dev . to/NWT gck/simple-chat-over-only-http-without-web socket-and-webrtc-1n4m](https://dev.to/nwtgck/simple-chat-over-only-http-without-websocket-and-webrtc-1n4m)
...
这是一个简单的聊天演示视频。
[https://www.youtube.com/embed/WeLkjg7nsvY](https://www.youtube.com/embed/WeLkjg7nsvY)T2】

## [](#how-to-use-piping-server-in-javascript)如何在 JavaScript 中使用管道服务器？
...
## [](#secure-chat-via-piping-server)通过管道服务器进行安全聊天
