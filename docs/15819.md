...
> 原文:[https://dev . to/khansubhan 95/using-redirects-with-netlify-and-Jekyll-4hp](https://dev.to/khansubhan95/using-redirects-with-netlify-and-jekyll-4ohp)

我的[博客](https://mskhan.in)是用 Jekyll 制作的，托管在 Netlify 上。我很惊讶地得知 Netlify 支持重定向。下面是如何为 Jekyll(或任何静态生成器)配置它的方法

### [](#step-1-create-a-redirects-file-in-project-root)第一步:在项目根目录下创建一个 _redirects 文件
...
### [](#step-2-include-redirects-in-configyml)第二步:在 _config.yml 中包含 _ 重定向
...
### [](#step-3-deploy-to-netlify)第三步:部署到网络生活
