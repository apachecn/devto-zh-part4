...
> 原文:[https://dev . to/feli pedsc/can deactivate-confirm Ando-se-o-usualio-deseja-abandonar-a-pagina-e-descartar-altera coes-5bma](https://dev.to/felipedsc/candeactivate-confirmando-se-o-usuario-deseja-abandonar-a-pagina-e-descartar-alteracoes-5bma)
...
### [](#incluindo-o-guard-nos-providers)包括警卫服务提供商
...
### [](#aplicando-o-guard-%C3%A0-rota)值班警卫
...
### [](#implementando-a-interface)实现一个接口
