...
> 原文:[https://dev.to/kendru/expressions-and-evaluation-42da](https://dev.to/kendru/expressions-and-evaluation-42da)
...
### [](#understanding-expressions)理解表情
...
#### [](#clojurescript-expressions)ClojureScript 表达式
...
#### [](#statementoriented-javascript-code)面向语句的 JavaScript 代码
...
[![Comparing Expressions and Statements](img/01d9aeeb27f54896b32152e0843a05d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J8FYqLar--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/comparing-expressions-and-statements.png)
...
## [](#evaluating-clojurescript-code)评估 ClojureScript 代码
...
[![Evaluating an Expression, Step 1](img/357e994385b03c8ef654c9805c9ccc68.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MRiCuJVN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/eval-step-1.png)
...
[![Evaluating an Expression, Step 2](img/7194c2968e2c65189675700a2c69b2e1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XctpRrIr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/eval-step-2.png)

*评估表达式，步骤 2*

原来的 s 表达式差不多可以求值了，但是首先要求值最后的内部 s 表达式，`(range)`。这个 s 表达式内部只有一个表达式，`range`，所以它将被解释为一个没有参数的函数。

[![Evaluating an Expression, Step 3](img/b3416df0b114bfcd09b984c33aa25314.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uC0sP9XN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/eval-step-3.png)

*评估表达式，步骤 3*

最后，表达式将被“从内向外”求值，从调用`range`函数开始，一直到最外面的 s 表达式。

[![Evaluating an Expression, Step 4](img/b00232287ffa925e8bf1c6e8c96c3981.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--10k4b3eg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/eval-step-4.png)
...
[![Evaluating an Expression, Step 5](img/f632bb2a26c56c79a52ffbcc28749637.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JmV6ShPv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/eval-step-5.png)

*评估表达式，步骤 5*

下一个表达式被解释为对`take`函数的调用，带有参数、`5`和一个无限的数字序列。这个表达式的值是序列，`(0 1 2 3 4)`，由`(range)`生成的无限序列的前 5 个元素。对`take`的调用被替换为这个返回值，求值再次向外继续。

[![Evaluating an Expression, Step 6](img/ec9bb160ddc0fbad03e60762081fc8e3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZCS1LxNp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter4/eval-step-6.png)
