...
> 原文:[https://dev . to/John found/interest-hash-tree-implementation-PMC](https://dev.to/johnfound/interesting-hash-tree-implementation-pmc)
...
## [](#adding-strings-to-the-tree)给树添加字符串。
...
## [](#searching-the-string-in-the-set)在集合中搜索字符串。
