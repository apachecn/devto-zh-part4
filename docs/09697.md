...
> 原文:[https://dev . to/deleteman 123/3-flavors-of-the-for-loop-in-JavaScript-and-when-to-use-them-2jbl](https://dev.to/deleteman123/3-flavors-of-the-for-loop-in-javascript-and-when-to-use-them-2jbl)
...
## [](#the-classic-for-loop)经典 For 循环
...
## [](#the-for-in-and-for-of-pair)此为...一对中的……
...
## [](#the-fancy-and-functional-foreach-loop)花哨而实用。forEach 循环
