...
> 原文:[https://dev . to/sync fusion/introducing-sync fusion-s-new-JavaScript-barcode-generator-control-3 FIP](https://dev.to/syncfusion/introducing-syncfusion-s-new-javascript-barcode-generator-control-3fip)
...
## [](#generate-1d-or-linear-barcodes)生成 1D 或线性条形码
...
生成的 Code 128 条形码将类似于以下条形码。[![Code 128 barcode](../Images/6eb100c1e39b54308ede6e612b6d86d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4TIb2ola--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.syncfusion.com/blogs/wp-content/uploads/2019/08/Code-128-barcode.png)
...
生成的二维码将如下图所示。[![QR code](../Images/ca4d1575c651785ebf0cd91b64a075a1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SeQiQwDK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.syncfusion.com/blogs/wp-content/uploads/2019/08/QR-code-1.png)

## [](#generate-data-matrix)生成数据矩阵
...
以下是生成的数据矩阵条形码的屏幕截图。[![Data Matrix barcode](../Images/922edb477c0847bd2d2baa9de6ed603b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MiALJWIi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.syncfusion.com/blogs/wp-content/uploads/2019/08/Data-Matrix-barcode.png)
