...
> 原文:[https://dev . to/open-graph QL/building-powerful-graph QL-servers-with-rust-3gla](https://dev.to/open-graphql/building-powerful-graphql-servers-with-rust-3gla)
...
## [](#setting-up-an-http-server)设置 HTTP 服务器
...
## [](#creating-the-graphql-schema)创建 GraphQL 模式
...
[![Members query in graphiql](img/dd08a0e3d9039113cf5d30f50a49c5df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--26HdPS0g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t22qyi7xarthf9xm2yvl.png)
...
## [](#setting-up-postgres-for-real-data)为真实数据设置 Postgres
...
## [](#wiring-up-our-handlers-with-diesel)给我们的搬运工装上柴油
...
[![More complex query in graphiql](img/db78ad9838e959da456f6668056b379d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BnizTmBw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1gsj02nf5m8le9ujjbr8.png)

我真的很喜欢这样的结果，但是为了使本教程完整，我们还必须添加一点东西。

## [](#the-create-member-mutation)创建成员突变
...
### [](#other-neat-reading-material)其他整洁的阅读材料
