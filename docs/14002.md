...
> 原文:[https://dev . to/wongjiahau/how-to-reuse-100-stateless-react-components-319 c](https://dev.to/wongjiahau/how-to-reuse-100-stateless-react-components-319c)
...
## [](#example-1-signupdialog)例 1: SignUpDialog
...
## [](#example-2-datepicker)例 2:日期选择器
