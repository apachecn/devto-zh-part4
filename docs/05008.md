...
> 原文:[https://dev . to/steadbytes/TPP-topic-16-the-power of-plain-text-3a JH](https://dev.to/steadbytes/tpp-topic-16-the-power-of-plain-text-3ajh)
...
#### [](#plain-text-representation)纯文本表示
...
### [](#version-2-variable-length-raw-directions-endraw-)版本 2(可变长度`directions`)
