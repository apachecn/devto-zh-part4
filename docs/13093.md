...
> 原文:[https://dev . to/themagickoal 1/re confirm-integrating-device-into-a-non-standard-registration-system-1563](https://dev.to/themagickoala1/reconfirmable-integrating-devise-into-a-non-standard-registration-system-1563)
...
## [](#bypassing-confirmable-for-registration)绕过可确认注册
