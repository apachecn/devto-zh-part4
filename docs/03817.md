...
> 原文:[https://dev.to/remast/go-for-the-rest-1jp9](https://dev.to/remast/go-for-the-rest-1jp9)
...
# [](#create-and-run-the-restful-web-application)创建并运行 RESTful web 应用程序
...
# [](#guide-through-the-app)通过 App 引导
...
# [](#create-a-health-check-action)创建健康检查动作
...
# [](#more-about-actions-and-routes)更多关于行动和路线
