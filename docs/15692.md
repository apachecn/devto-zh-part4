...
> 原文:[https://dev . to/evil mars on/danger-on-rails-make-robots-do-some-code-review-for-you-5a3h](https://dev.to/evilmartians/danger-on-rails-make-robots-do-some-code-review-for-you-5a3h)
...
## [](#github-reintegration)GitHub 重新整合
...
### [](#step-1-creating-a-new-github-app)第一步。创建新的 GitHub 应用程序。
...
### [](#step-2-adding-a-token-generator)第二步。添加令牌生成器。
...
## [](#modulirizing-raw-dangerfile-endraw-)模块化`Dangerfile`
...
## [](#bonus-danger-meets-brakeman)加成:危险遇上布雷克曼
...
[![](../Images/ba407bd32621e697d76ebb41c7372084.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ORX9HoF8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/61sm73gox3tb91sg5rfl.png)
