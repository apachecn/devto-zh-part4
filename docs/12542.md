...
> 原文:[https://dev . to/jankleinert/node-js-session-management-using-express-sessions-redis-and-passport-part-1-cja](https://dev.to/jankleinert/node-js-session-management-using-express-sessions-redis-and-passport-part-1-cja)
...
### [](#get-the-code-for-the-craft-beer-name-demo-app)获取精酿啤酒名称演示应用的代码
...
[![demo app screenshot](../Images/17670399483c5b1b3a4ea993b73401a5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ahj5M_Ns--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jankleinert.com/assets/images/blog/node-redis-beer-demo.png)

### [](#understanding-the-demo-app)了解演示应用
...
[![dir structure](../Images/aa9fff0c1cf8e56aabf53cb6d33288eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5GSfoYIb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jankleinert.com/assets/images/blog/node-redis-dir-structure.png)
...
[![client and server](../Images/858b9fc7d94dd5b2e277a2ff94987b91.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VibQhl5---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jankleinert.com/assets/images/blog/node-redis-cookie.png)

在客户端，cookie 与会话 ID 一起存储，但不存储任何会话数据。在应用程序的会话存储中(在本例中是 Redis)，会话 ID 也与会话数据一起存储。

### [](#add-a-session-info-panel-to-the-app)给应用程序添加会话信息面板
...
### [](#add-expresssession-and-connectredis-to-appjs)将 express-session 和 connect-redis 添加到 app.js
...
### [](#add-session-management-code-to-routesindexjs)向/routes/index.js 添加会话管理代码
...
### [](#session-management-in-action)会话管理在行动！
...
[![session with cookie](../Images/9b8c5747b3cc1514f87abc286237991c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--muCYxhuQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jankleinert.com/assets/images/blog/node-redis-session-id-cookie.png)
...
[![redis-cli](../Images/ef7ca008e168de37e4870b50838472cc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Pieh5EM---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jankleinert.com/assets/images/blog/node-redis-redis-cli.png)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[1 月小](https://github.com/jankleinert) / [复会示范](https://github.com/jankleinert/redis-session-demo)
...
[![screenshot](../Images/fe3fc660d42dc1f119417546b6d9cf82.png)T2】](https://raw.githubusercontent.com/jankleinert/redis-session-demo/master/screenshot.png)
