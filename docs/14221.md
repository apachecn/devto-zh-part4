...
> 原文:[https://dev . to/laurieontech/5-uses-for-the-spread-operator-b9i](https://dev.to/laurieontech/5-uses-for-the-spread-operator-b9i)

spread 操作符是 JavaScript 开发人员的最爱。这是一个强大的语法，有许多应用。

事实上，数量如此之多，以至于很难把它们都记录下来。在本帖中，我们将回顾 spread 运算符的 5 种最常见的用法。

# [](#copying-an-array)复制一个数组
...
# [](#pass-arguments-as-arrays)将参数作为数组传递
...
#javascript #webdev #productivity #beginners](/laurieontech/3-powerful-examples-of-destructuring-assignment-jlf)[![laurieontech image](../Images/ca0667c84fcd9741a29fbc42fbc0816c.png)](/laurieontech) [## 出口、进口和违约，天啊！

### 劳丽 Apr 29 ' 19 分钟阅读

#javascript #react #webdev #beginners](/laurieontech/exports-and-imports-and-defaults-oh-my-fa3)[![laurieontech image](../Images/ca0667c84fcd9741a29fbc42fbc0816c.png)](/laurieontech) [## 引入 Object.fromEntries
