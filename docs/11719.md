...
> 原文:[https://dev . to/dillion megida/semantic-html-part-1-of-frontend-development-series-NLB](https://dev.to/dillionmegida/semantic-html-part-1-of-frontend-development-series-nlb)
...
# [](#writing-semantic-html)编写语义 HTML
...
##### [](#nb-you-can-choose-to-add-classes-but-at-least-those-sections-now-have-meanings)注意:你可以选择添加类，但至少，那些节现在有了意义。
