...
> 原文:[https://dev . to/malexe/how to-drop-down-list-with-branch-from-git lab-project-31cc](https://dev.to/malexe/howto-drop-down-list-with-branches-from-gitlab-project-31cc)
