...
> 原文:[https://dev . to/jalerson/be-circuit-when-using-error-reporting-services-and-server less-functions-5ei 9](https://dev.to/jalerson/be-careful-when-using-error-reporting-services-and-serverless-functions-5ei9)
