...
> 原文:[https://dev . to/scout APM/monitoring-AP dex-with-scout-APM-49cl](https://dev.to/scoutapm/monitoring-apdex-with-scout-apm-49cl)
...
[![](../Images/56763a4c4409111d98d256a6e9f2b2b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yMQmiNdV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cmg149doqswlchcgh4ig.png)
...
[![](../Images/9c24fcf4b2e73095d2919253bcf320d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---v3_V2KP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oa092d2czggqiknn287w.png)
...
## [](#using-scout-to-measure-apdex)使用 Scout 测量 Apdex

你的申请的 Apdex 分数在 Scout 的主图表上是可见的。您可以使用下图所示的 APDEX 选项随时打开或关闭此指标。然后，您可以尝试将 Apdex 分数与另一个指标相结合，以识别相关的模式。

[![](../Images/2e0828869f949eda8e99eff8f0d38f51.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j5T_oKLv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s1i2p8slpkjdarbcwg35.png)

## [](#how-to-improve-your-apdex-score)如何提高自己的 Apdex 分数？
...
[![](../Images/2c20abe23ad4676a91ec233765dbf15b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AlXcz8yx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nw9rw41rmuvt8uwa88bs.png)
