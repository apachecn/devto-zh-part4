...
> 原文:[https://dev . to/drozerah/vue-js-SVG-responsive-component-318 f](https://dev.to/drozerah/vue-js-svg-responsive-component-318f)
...
[![gif](../Images/38dad435ad56a8a66ffa4fe102233cd0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KuD1qCTs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://raw.githubusercontent.com/Drozerah/MyGitHubStorage/master/gif/svg-component/vue-svg-component.gif)

## [](#check-it-out-)看看吧！

### [](#get-a-local-copy-of-this-repository)获取该存储库的本地副本
...
### [](#compiles-and-hotreloads-for-development)编译并热加载用于开发

```
$ npm run serve 
```

### [](#compiles-and-minifies-for-production)编译并缩小用于生产
