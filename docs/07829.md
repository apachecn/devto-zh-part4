...
> 原文:[https://dev . to/ogurinkaben/beginner-s-guide-to-JavaScript-arrays-part-1-1p2n](https://dev.to/ogurinkaben/beginner-s-guide-to-javascript-arrays-part-1-1p2n)
...
### [](#removing-items-from-an-array)从数组中删除项目
...
### [](#modifying-items-in-an-array)修改数组中的项目
...
## [](#iterating-and-displaying-contents-of-an-array)迭代显示数组内容
