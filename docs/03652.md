...
> 原文:[https://dev . to/Stephen Weiss/getting-a-basic-react-app-up-and-running-28im](https://dev.to/stephencweiss/getting-a-basic-react-app-up-and-running-28im)
...
## [](#adding-react-to-a-website)向网站添加 React
...
### [](#our-first-react-component)我们的第一个反应元件
...
### [](#using-webpack-and-babel-to-bundle-our-app)使用 Webpack 和 Babel 捆绑我们的应用
...
[![hello world](img/3cdbbead88b781fe5d05a802a801f74a.png)T2】](///static/341e77df9a6f81d4932d980bee130e32/fd831/hello-world.png)
...
## [](#adding-a-second-react-component)添加第二个 React 组件
...
### [](#part-deux-a-new-react-component)Part Deux:一个新的 React 组件
...
## [](#resources-additional-reading)资源/附加阅读
