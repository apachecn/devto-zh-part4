...
> 原文:[https://dev . to/iggredible/start-using-promisify-to-avoid-js-callback-spaghetti-59mk](https://dev.to/iggredible/start-using-promisify-to-avoid-js-callback-spaghetti-59mk)

异步代码在 JS 编程中很常见，比如从端点获取数据和读取 dir/文件。通常，它们要求我们传递一个*回调*函数，该函数将在动作完成时执行。

# [](#the-problem-with-callback-async)回调异步的问题
...
[![big spaghetti](../Images/88782d619d630288341658ec9f1d7702.png)T2】](https://i.giphy.com/media/r9jG5FH7chblC/giphy.gif)

# [](#better-way-to-handle-async-promises)处理异步的更好方法:承诺
...
# [](#putting-the-two-together-replace-all-callbacks-with-promises)把两者放在一起:用承诺代替所有的回电
...
[![delicious spaghetti](../Images/0abb08ebda40ef774779318acbb1307a.png)T2】](https://i.giphy.com/media/3o72F2CaK3Hk53WxGg/giphy.gif)
