...
# [](#openstack-conceitos)开放叠:概念

[![Alt Text](img/e4ce706857aa22831cc05e0c1b76a7a7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rP2SpwSy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n58izzmom8bp808rmeyq.png)
...
# [](#openstack-componentes)OpenStack:组件

由于 OpenStack 充当组件管理器，因此了解每个组件的作用非常重要:每个组件都有其管理云基础架构的责任。因为有许多组件，所以我们不需要详细了解每个组件，所以我们将概括介绍最常用的组件:

## [](#openstack-compute-nova)OpenStack 计算(Nova)

[![Alt Text](img/24de4513ad8d68e1ccd62ac3019740a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z7xBvf5d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kxnbyrceret9m5km22zg.png)

负责虚拟化框架。它是访问和全面管理 OpenStack 计算资源(包括编程、构建和删除)的工具。

它与虚拟机管理程序(硬件和操作系统之间的软件层)不兼容，并且与大多数虚拟机管理程序兼容。

## [](#openstack-block-storage-cinder-cinder)露天堆块堆存煤渣(煤渣)

[![Alt Text](img/5153be07f1dfdc7d1641a6420322935e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tV75mRw6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cju49zb8kk1sbhe7nyqt.png)

负责新的 OpenStack 阵列服务。
使用 Cinder，您可以通过 Horizon 界面或 CLI 管理卷。

## [](#openstack-object-storage-swift)OpenStack 对象存储(Swift)

[![Alt Text](img/d548e2e7a6e638dd239ec2f19cffcdc1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--odgLjyPw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d8o495zf1kvbaztwd4kl.png)

它是一项高度容错的服务，用于存储和检索非结构化数据对象。虽然 Cinder 负责数量，但 Swift 负责对象。

## [](#openstack-image-service-glance)OpenStack 影像服务(一瞥)

[![Alt Text](img/384039cb05a3508617773f6488133f2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cEQ3vyeR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t8r73kudrehh7fdwswlu.png)

负责虚拟机映像功能。它存储和检索来自多个位置的虚拟机磁盘映像。

## [](#openstack-networking-neutron)OpenStack 联网(中子)

[![Alt Text](img/6680ee4b6739fdd31cdf6315685ba639.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aiYaQfPG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6fynnrvuni20iy2dc32y.png)

负责 OpenStack 的网络服务功能。将网络连接到其他 OpenStack 服务。

## [](#openstack-identity-keystone)OpenStack 标识(KeyStone)

[![Alt Text](img/24de4513ad8d68e1ccd62ac3019740a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z7xBvf5d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kxnbyrceret9m5km22zg.png)

负责身份验证和授权，定义访问 OpenStack 功能的规则。它也是所有服务的端点目录。

## [](#openstack-dashboard-horizon)OpenStack 仪表盘(Horizon)

[![Alt Text](img/84e39d78903d2d64470188472532a0c5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YgDHDJhk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9rkdqe3hu46uw345v7a1.png)
...
## [](#openstack-primeiros-passos)打开塔克:第一步
