...
> 原文:[https://dev . to/Dwayne/let-s-build-a-random-quote-machine-in-elm-part-1-3n 64](https://dev.to/dwayne/let-s-build-a-random-quote-machine-in-elm-part-1-3n64)
...
## [](#structure-the-app-using-html)使用 HTML 构建应用程序
...
[![A screenshot of the app after step 1 is completed.](../Images/5c5c997aaf1347a162493fb57d84df38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s7PP-ePo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d5c9exb57ythoaybco6y.png)

更多详情，请点击[此处](https://github.com/dwayne/elm-random-quote-machine/blob/tutorial/tutorial/step-01.md)。

## [](#style-the-app-using-css)使用 CSS 样式化应用程序
...
[![A screenshot of the app after step 2 is completed.](../Images/2d6156991841731fb68b684e93ae6b55.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w1EUmHHc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6gd3j0xl2krjwf8iwzps.png)
