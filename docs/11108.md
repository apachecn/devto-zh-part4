...
> 原文:[https://dev . to/ecnepsnai/all-about-Apache-Cassandra-snapshot s-3oo 2](https://dev.to/ecnepsnai/all-about-apache-cassandra-snapshots-3oo2)

欢迎来到“关于 Apache Cassandra 的一切”的开篇文章，这是我将在 dev.to 上专门写的关于 Apache Cassandra 的新系列文章！

* * *

# [](#the-concept-of-a-snapshot)“快照”的概念

在计算中，快照是数据或机器状态的时间点副本。

你曾经做过这样的事情吗？

[![Screenshot of the windows file explorer showing multiple word documents each being a draft of the same essay](../Images/3743a2186e1ff7ff88cee405e102f18c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vSwA0XyD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nja4d08zs7tdg65mldjz.PNG)
...
# [](#how-cassandra-takes-snapshots)卡珊德拉如何拍摄快照

当你用 Apache Cassandra 拍快照时，它会创建一个所有实时表格的硬链接。很简单，对吧？这比你想象的要复杂一点

## [](#whats-a-hard-link)什么是硬链接？
...
# [](#where-cassandra-stores-snapshots)卡珊德拉存储快照的地方
...
# [](#how-snapshots-affect-capacity)快照如何影响容量
...
# [](#restoring-from-a-snapshot)从快照恢复
...
## [](#remove-one-or-more-snapshots)删除一个或多个快照
