...
> 原文:[https://dev . to/maxime 1992/building-scalable-robust-and-type-safe-forms-with-angular-3n F9](https://dev.to/maxime1992/building-scalable-robust-and-type-safe-forms-with-angular-3nf9)
...
[![](../Images/eca165f03cfde5cf63a3746e783d5115.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Ap4_oNya--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sgrwp78td5w2loat4ulj.png)
*3D visualiser 模拟机器将如何切割零件。*

我们表单中的一个很好的例子是当我们想在一个零件上标注一个特定的孔时。我们可以在不同类型的注释中进行选择，并选择特定的行为:

[![](../Images/2a78351c6c699d4ff4afcfed0e6fabbc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--MzYJW9_8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zf5h3re7gnsn7pfgdwdd.png)
*2 种形式注释一个孔的例子。*
...
# [](#introduction-to-the-demo-and-understand-what-we-want-to-build-as-an-example)介绍演示并理解我们要构建的示例

为了展示构建一个好的表单有多困难，我们开发了一个应用程序。主要想法是:“银河销售”，人们可以决定出售`Droid` ( `Assassin`、`Astromech`、`Medical`、`Protocol`)或`Vehicle` ( `Spaceship`、`Speeder`)。

[![](../Images/efb885454814699c56861de0170cda81.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BpcR0u8c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dpkth2zu4axvrnqh23bn.png)
...
[![](../Images/22b9265549cd742779a03231801a5f9b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IiH6J1uC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/prlx7do0rrb70kpw5tyq.png)

良好的...不完全是。Github 上有一个长期存在的问题。

# [![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) 反应形式不强烈 #13721](https://github.com/angular/angular/issues/13721) 

[![asfernandes avatar](../Images/6e2d8f2aa6e23902c465b0c8661f9a98.png)](https://github.com/asfernandes) **[asfernandes](https://github.com/asfernandes)** posted on [<time datetime="2016-12-30T15:14:52Z">Dec 30, 2016</time>](https://github.com/angular/angular/issues/13721)
...
## [](#everything-in-one-file-fire)一切尽在一档🔥
...
## [](#breaking-down-the-form-into-sub-components-thumbsup)将表单分解成子组件👍
...
## [](#breaking-down-the-form-into-sub-components-the-right-way-tada)把表单分解成子组件，正确的方式！🎉
...
## [](#understanding-the-power-of-raw-controlvalueaccessor-endraw-)了解`ControlValueAccessor`的力量
...
[![](../Images/6f59e463dd771d48b25aa3dda704748d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s7TlxUCy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dknl4ccqo9ikw2v60vie.png)

> 话够了，给我看看代码！

## [](#building-the-demo)构建演示
...
[![](../Images/73078129c14853b60d5129b221721aea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--om7l9prY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f8x6ojs1xaaui965q8h4.png)
...
## [](#going-further-with-remapping-andor-polymorphism)进一步使用重映射和/或多态
