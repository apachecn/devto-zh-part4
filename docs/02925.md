...
> 原文:[https://dev . to/Lynn/monitoring-an-API-with-Prometheus-and-grafana-using-spring-boot-actuator-46hi](https://dev.to/lynn/monitoring-an-api-with-prometheus-and-grafana-using-spring-boot-actuator-46hi)
...
[![Alt Text](img/e26e2eb589df1f2a3988aba5ff8dd487.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_o3labN1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z9343huujdrlv8971xhi.png)
...
[![Alt Text](img/255f552618adbeb2531d94da64730129.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Nw5RPGl---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zlw99ekjtolidtgneaq8.png)

**-** 在首页点击“创建你的第一个数据源”。这将打开一个添加数据源的页面。

[![Alt Text](img/3edc4cacb72149d1f8958e1b92a5e4a5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Nn3g7x-l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7b91p6tup2z6jti9e9jz.png)
