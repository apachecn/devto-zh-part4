...
> 原文:[https://dev . to/bnevilleoneill/7-optimization-techniques-in-react-5d ag](https://dev.to/bnevilleoneill/7-optimization-techniques-in-react-5dag)

[![](../Images/47b866fc057e1107b49252a127df2fa7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--APIk0M55--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xow8ggj596vh2w7w07xv.png)
...
## [](#how-to-use-reactfragment-to-avoid-adding-extra-nodes-to-the-dom)如何使用 React。片段，以避免向 DOM 添加额外的节点
...
## [](#use-reactsuspense-and-reactlazy-to-load-components-declaratively)使用 React。悬念和反应。懒得以声明方式加载组件
...
## [](#prevent-unnecessary-rerendering-with-shouldcomponentupdate)用 shouldComponentUpdate()防止不必要的重新渲染
...
## [](#use-reactpurecomponent)使用 React。纯组件
...
## [](#remove-unused-dom-elements-with-componentdidunmount)用 ComponentDidUnmount()移除未使用的 DOM 元素
...
## [](#use-reactmemo-to-cache-components)使用 React。缓存组件备忘录
