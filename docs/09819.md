...
> 原文:[https://dev.to/justalever/how-to-extend-tailwind-css-14d6](https://dev.to/justalever/how-to-extend-tailwind-css-14d6)
...
### [](#internalpersonal-approach)内部/个人方法
...
#### [](#adding-new-utilities-via-css)通过 CSS 添加新的工具
...
### [](#fancy-postcss-approach)花式 PostCSS 方法
...
### [](#external-open-source-approach)外部/开源方式
