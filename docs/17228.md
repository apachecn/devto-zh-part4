...
> 原文:[https://dev . to/tchaflich/how-to-actual-to-a-text-gradient-in-CSS-3a 33](https://dev.to/tchaflich/how-to-actually-animate-a-text-gradient-in-css-3a33)
...
## [](#animating-background-position)动画背景位置
...
[![A cat walking on a spinning chair. The gif loop is very good.](../Images/b9f976d46b1ec92730223aff8472c551.png)T2】](https://i.giphy.com/media/82CItLnbSh8hzsXK3H/giphy.gif)

当循环复位时，它处于开始时的相同位置，使得循环不太明显。(可能还会有*一跳*，但应该很小。)

[![A fluffy white cat sitting in a tree. At the last minute, the camera turns downward.](../Images/4ce4be3ef812995516472c788cb8059a.png)T2】](https://i.giphy.com/media/U7P0B9vQmKNZFzDr6e/giphy.gif)
...
## [](#animating-background-position-with-gradients)动画背景位置*带渐变*
...
## [](#adding-more-flags-refactoring)添加更多旗帜🏳️‍🌈(重构)

在我制作了最初的彩虹动画后，看起来...太容易了。在与 CSS 的永恒斗争中，我需要更加努力。我想知道，这能被推广吗？我能表现出更多的骄傲吗？

[![A code screenshot showing the bi pride flag using multiple colors in a row for color stops.](../Images/0a7af85e23f55a0b77081bfac1cdd0dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CZgbKk3A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wq4lbxq9kusqsbl8wleh.PNG)

在 bi pride flag 中，我发现了另一个有趣的警告。为了使跳跃不那么明显，渐变应该尽可能平滑。使用基于百分比的色标通常效果不佳；简单地复制颜色会有更好的效果。

[![Trans pride flag colors (blue, pink, and white) against a white background.](../Images/ef9c3125ae864f58210381e9681c4e69.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RoMa92UC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bt2jyk8b1wd14h8c2866.png)

嗯，我真的想在那里看到一个文本阴影，使白色部分不要融入背景太多。白色出现在一些不同的旗帜上，所以这肯定是一个普遍问题。

[![The text is now covered entirely in darkness. Oh no!](../Images/2dfece7d958a7329530357f0532343b8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_I830Oj2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x6hu8uw9c1rn821x0qlh.png) 
*进展顺利。*
...
#### [](#2-div-overplayed-on-each-other)2 div 互相过招

### [](#2-div-overplayed-on-each-other)2 div 互相过招

## [](#2-div-overplayed-on-each-other)2 div 互相过招

[![A gif of a dog hopping away, with lots of "nope" text overlaid.](../Images/d4a9f48365ba46c64f6a94edb2263516.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VTPopjxU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://media.tenor.co/images/60d6ac6564c529d7c964aa9e66c62bce/raw)

不要再走那条路了！你不能逼我！

[![The text with trans-pride gradient now has a dark background](../Images/67f91c3b6b041d668c4ed68e2c08ad78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5R1v86Jt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/civo96oh90vugll6ajqq.png)
...
[![Frodo from LOTR in front of the volcano: "It's done."](../Images/1537478b5f7c62aa6125e6682bdbb2ba.png)T2】](https://i.giphy.com/media/zCME2Cd20Czvy/giphy.gif)

### [](#wrapup-fun-facts)总结有趣的事实
...
[![Dazzling, luminescent glitter text reading "peace out homies"](../Images/a5dd1b5f761f248c8260071e96ff0ea4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4wk8HZMj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yqjqx5hp8n7oiy2swelh.gif)*