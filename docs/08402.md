...
> 原文:[https://dev.to/scoutapm/benchmarking-ruby-code-3gkc](https://dev.to/scoutapm/benchmarking-ruby-code-3gkc)
...
## [](#rubys-benchmarking-module)Ruby 的基准测试模块
...
## [](#measuring-a-single-block-of-code)测量单个代码块
...
## [](#comparing-multiple-blocks-of-code)比较多个代码块
