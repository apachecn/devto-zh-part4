...
> 原文:[https://dev . to/sofianehamlaoui/convert-iso-images-to-docker-images-18jh](https://dev.to/sofianehamlaoui/convert-iso-images-to-docker-images-18jh)

### [](#convert-iso-images-to-docker-images)🐳将 ISO 图像转换为 docker 图像

没错。我正在寻找一种方法或技巧来转换 ISO 文件到 docker 图像，很难找到一个！但唯一的一个并没有真正解释，缺乏一些信息。所以我们来了！！

### [](#choosing-the-iso-file-)选择 ISO 文件:

在开始这个过程之前！请记住，你必须使用一个[](https://en.wikipedia.org/wiki/Live_CD)****，*** 是指操作系统的可启动版本。*
