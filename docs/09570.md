...
> 原文:[https://dev.to/trackjs/how-to-avoid-ad-blocker-errors-495b](https://dev.to/trackjs/how-to-avoid-ad-blocker-errors-495b)
...
## [](#tip-1-dont-expect-analytics-to-work)提示 1:不要指望数据分析会奏效
...
## [](#tip-2-avoid-advertisingrelated-words)秘诀 2:避免与广告相关的词汇
...
*   **`/images/myImage-900x300.jpg`** 文件名中包含常见广告尺寸的图像。
...
## [](#tip-3-run-an-ad-blocker-locally)提示 3:在本地运行广告拦截器
