...
> 原文:[https://dev . to/geefygeorge/creating-a-tomee-react-application-using-micro profile-part-1-24](https://dev.to/geefygeorge/creating-a-tomee-react-application-using-microprofile-part-1-24)
...
[![Constellations - TomEE and React Demonstration](img/85f69c14671481e78ce87f6f40ac37a6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uI17pq3_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://davidsalter.uk/asseimg/tomeereact.png)

## [](#creating-the-back-end)创建后端
...
## [](#create-a-persistence-layer)创建持久层
...
## [](#populate-persistence-layer)填充持久层
...
## [](#create-jaxrs-endpoint)创建 JAX-RS 端点
