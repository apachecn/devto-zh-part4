...
> 原文:[https://dev . to/jasny/developing-a-PHP-extension-in-clion-3oo 1](https://dev.to/jasny/developing-a-php-extension-in-clion-3oo1)
...
### [](#cmake-profiles)CMake 配置文件

在 CLion 的项目设置中，我们创建了多个 CMake 概要文件；每个 PHP 版本一个。

创建新的配置文件并编辑环境设置。我们将修改`$PATH`，以便使用正确的`php`、`phpize`和`php-config`可执行文件。

[![CLion Profile env settings for PHP](../Images/f86f6969077c1cf17684409bff88b4ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JF8D98A6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9nuou63c836igjtncgxn.png)

复制现有的`PATH`条目，并将其粘贴为自定义环境变量。在值前面加上您想要使用的 PHP 版本的`bin`目录的路径。

### [](#php-cli-symlink)PHP CLI 符号链接
...
## [](#custom-build-configurations)定制构建配置
...
[![make build configuration for PHP in CLION](../Images/eb4bc4d415a05cffbca85702ab824ec1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4OEV-Loo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lgvjv6fg8xqc75mma405.png)
...
### [](#clean-toolbar-button)清理工具栏按钮

在工具栏中添加`Clean` ( `Ctrl-Shift-F9`)可能会有所帮助。

[![Toolbar config in CLION](../Images/5657b65e3fb76eb9b2cce468bc78a8f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qtcALZYm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h48ak2yol4nzuwugi2oc.png)

## [](#optional-makefile-targets)可选 Makefile 目标
