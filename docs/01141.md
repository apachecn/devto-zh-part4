...
> 原文:[https://dev . to/fhammerschmidt/reason-react-best-practices-2cb 7](https://dev.to/fhammerschmidt/reason-react-best-practices-2cb7)
...
## [](#the-identity-trick)身份诡计

### [](#zerocost-reactstrings)零成本 React.strings！
...
### [](#keep-your-codebase-free-of-magic)让你的代码库免于魔法！
...
### [](#use-the-pipes-like-mario)像马里奥一样用管子！
...
### [](#pipe-parameter-position-paranoia)管道参数位置偏执狂！
