...
> 原文:[https://dev . to/aminnairi/compose-your-function-for-a-better-rehability-3k7](https://dev.to/aminnairi/compose-your-function-for-a-better-reusability-3ck7)

今天我们将学习用 JavaScript 实现一个 curry 函数。这个函数将帮助我们创建更多的可重用函数。

## [](#what-is-currying)什么是阿谀奉承？
...
## [](#how-to-implement-currying-in-javascript)如何在 JavaScript 中实现 currying？
