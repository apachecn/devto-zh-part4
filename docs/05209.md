...
> 原文:[https://dev . to/naorlivne/nebula-container-orchestrator-container-orchestrator-for-IOT-devices-distributed-systems-48f 7](https://dev.to/naorlivne/nebula-container-orchestrator-container-orchestration-for-iot-devices-distributed-systems-48f7)
...
# [](#different-requirements-leads-to-different-orchestrators)不同的需求导致不同的指挥者
