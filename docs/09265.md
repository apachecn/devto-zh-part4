...
> 原文:[https://dev . to/trilon/how-to-delete-all-node modules-folders-on-your-machine-43dh](https://dev.to/trilon/how-to-delete-all-nodemodules-folders-on-your-machine-43dh)
...
[![](../Images/75a1e959c6e1a2adf0faa2d05d121c7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IXLfDqOb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cnorkdsd8nmcse1erid7.png)
...
## [](#list-all-nodemodules-found-in-a-directory)列出一个目录中找到的所有 node_modules:
...
## [](#delete-all-nodemodules-found-in-a-directory)删除一个目录中找到的所有 node_modules:
...
#### [](#powershell-users)Powershell 用户:
...
### [](#comment-below-id-love-to-hear-how-much-you-saved)评论下面我很想听听你存了多少钱！
