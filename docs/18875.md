...
> 原文:[https://dev . to/exam pro/test unit-writing-test-code-in-ruby-part-1-of-3-44 m2](https://dev.to/exampro/testunit-writing-test-code-in-ruby-part-1-of-3-44m2)
...
### [](#hello-world-testcase-example)Hello World TestCase 示例
...
### [](#thoughts-on-testunit)关于 TestUnit 的想法
