...
> 原文：[https://dev.to/xuorig/caching-graphql-the-elephant-in-the-room-137b](https://dev.to/xuorig/caching-graphql-the-elephant-in-the-room-137b)

> This post is a preview of a book im working on, on building great GraphQL servers, if you're interested you can check it out here: [https://book.graphqlschemadesign.com](https://book.graphqlschemadesign.com) 💚
...
### [](#graphql-breaks-serverside-caching)GraphQL breaks server-side caching?
...
### [](#graphql-amp-http-caching)GraphQL & HTTP Caching
...
### [](#customizability-vs-optimizability-again)Customizability vs Optimizability, Again
...
### [](#how-important-is-http-caching-to-you)How Important is HTTP Caching to you?
