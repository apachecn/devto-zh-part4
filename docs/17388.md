...
> 原文:[https://dev . to/dzhavat/when-is-navigation cancel-triggered-44hc](https://dev.to/dzhavat/when-is-navigationcancel-triggered-44hc)
...
### [](#when-a-route-guard-returns-raw-false-endraw-)当一个路线守卫返回时`false`
...
### [](#on-redirect-initiated-by-a-route-guard)由路由守卫发起重定向
