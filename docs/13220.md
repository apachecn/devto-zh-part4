...
> 原文:[https://dev . to/danvoyce/displaying-geo fences-and-polygons-on-Google-maps-3lio](https://dev.to/danvoyce/displaying-geofences-and-polygons-on-google-maps-3lio)
...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <title>Beacons and Geofences Map</title>
  </head>
  <body>
    <div id="map"></div>
    <script>
...
## [](#displaying-beacons-and-geofences)显示信标和地理围栏
...
## [](#final-result-map-done)最终结果，地图完成！

[![](../Images/0dff329bee75c73e0fbbd9681e9ca461.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sF54_H8V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kkdp8e8ymxvug4ouaxdf.png)
