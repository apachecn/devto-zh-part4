...
[![](../Images/d08217459e07622a8aaf4eb03dfa70d8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4KX6KzIg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A8SQPvwOQJi9jDG73yhP5-g.jpeg)
...
### [](#react-hooks-are-amazing)React Hooks are Amazing
...
### [](#html5-has-a-builtin-api-for-form-validation-but-use-cases-are-limited)HTML5 has a Built-in API for Form Validation, But Use Cases Are Limited.
...
### [](#use-git-mv-to-rename-and-move-files)Use git mv To Rename and Move Files
...
### [](#git-projects-are-caseinsensitive-by-default)Git projects are case-insensitive by Default.
