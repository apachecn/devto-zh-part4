...
> 原文:[https://dev . to/it next/the-ultimate-free-ci-CD-for-your-open-source-projects-3bkd](https://dev.to/itnext/the-ultimate-free-ci-cd-for-your-open-source-projects-3bkd)
...
## [](#what-will-you-learn-here)在这里你会学到什么？
...
[![Free time in black hole](../Images/da8968158eb139b64a5a7e370976858e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HqLhuTB---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/free-time-hole.jpg)
...
### [](#then-it-was-fine-somehow)然后就没事了。不知何故。
...
##### [](#uncertainty-is-not-welcome)不确定性不受欢迎

最后，还有一个最可怕的问题，它白白花费了我生命中无数的时间:脆弱的构建😱。

[![Fighting the build matrix](../Images/0fb0efda036e26115010afb1911f5df2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9ZE_LtOO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/matrix-fight.jpg)
...
### [](#1-prepare-your-repository)1。准备您的存储库
...
### [](#2-create-the-azure-devops-project)2。创建 Azure DevOps 项目

在您的 Azure DevOps 帐户中，创建一个新项目并为其命名:

[![create project](../Images/b292d39fbfe6c64b44923b9070c81bf7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zv5zjkJK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/1-create-project.png)

### [](#3-setup-the-pipeline)3。设置管道

之后，进入左侧的**管线**部分:

[![select pipelines](../Images/6cf0d6a3f871f48d12e4f861c6028723.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5RaHfAx5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/2-pipelines.png)

然后点击`New pipeline`开始设置过程:

[![new pipeline](../Images/60eb57c3a14941539b379517b9caa02f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--quHNclM3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/3-new-pipeline.png)

选择`GitHub (YAML)`，然后按照流程将您的帐户与 Azure DevOps 关联:

[![choose github](../Images/4728198a22282d8becd994b72e2751b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3oEBUn0I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/4-github.png)

选择您的存储库，然后在 GitHub 上授权应用程序。

之后，选择第一个`Node.js`选项(或任何其他与您的技术组合相关的选项):

[![choose nodejs](../Images/9c37ef60bbf831ab177dedf8bd805137.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eMt3VfuD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/5-nodejs.png)
...
### [](#4-customize-the-yaml)4。自定义 YAML
...
### [](#5-adding-a-build-matrix)5。添加构建矩阵

现在你已经有了一个可以工作的 CI，但是使用 Azure Pipelines 的好处之一是你可以很容易地添加跨平台的构建，所以让我们开始吧。

在菜单中选择`Edit pipeline`返回 YAML 编辑器:

[![choose edit pipeline](../Images/5857a30dc6cfcf45a56fc8e49c5831f0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--amxwHr7N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/6-edit.png)
...
#### [](#6-add-a-status-badge-optional)6。添加状态徽章(可选)

[![build succeeded badge](../Images/1e7a2ebb442dda17e407d6f10c0c51a5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V5lToS8r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/badge.png)
...
[![click status badge](../Images/c4f215489aee258beb00f5976707ae33.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gWMAGQGT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/8-status.png)

然后使用按钮复制 markdown 代码，并将其粘贴到资源库根目录下的`readme.md`文件的顶部:

[![copy markdown](../Images/ad11260f0ab4ea3d26c23e13b61cd787.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---xJsB9H_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/9-copy.png)

一旦它被提交到`master`分支，它将在你的项目的 GitHub 文档中可见。徽章状态将根据`master`上的最后一次提交自动更新。

> 要与其他人一起完成这个状态徽章，请查看 [https://shields.io](https://shields.io) 。
> 你甚至可以自己造: [![badges are awesome](../Images/9e325a3a7cbb0b66f92768173618b512.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--peOUBy7z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://img.shields.io/badge/badges-are%2520awesome%2520%25F0%259F%2598%258E-blue)

#### [](#7-enjoy-your-evenings)7。享受你的夜晚

就是这样！

一旦新的 commit 或 PR 被推送到您的存储库，CI 将会处理它，并直接在 GitHub 上显示结果:

[![pull request status checks](../Images/d4703b1851b69853ac748c9871590c2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qd9zdFDc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/sinedied/articles/master/articles/oss/azure-pipelines-for-oss/assets/7-pr.png)
