...
> 原文:[https://dev . to/the Geoff Stevens/how-to-create-your-own-vs-code-extension-pack-nab](https://dev.to/thegeoffstevens/how-to-create-your-own-vs-code-extension-pack-nab)
...
## [](#why-you-should-create-extension-packs)为什么要创建扩展包
...
## [](#building-your-extension-pack)构建您的扩展包
...
[![thegeoffstevens](../Images/f6d141cda926a983166b15bc0df0646c.png)](/thegeoffstevens) [## 在 30 分钟或更短时间内在 VS 代码市场推出“产品”
...
[![Terminal with completed yo code prompts](../Images/ae638c0558c138e0bd53267a5172eb64.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LLsTbRkX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/24l4m1esua63l7um53ur.png)
...
[![More info tab on VS Code marketplace](../Images/cea779e3d770b6c13a463f3b2a6e6c99.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PGgKPx45--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3hi7uz2vma6fnofap23h.png)
...
### [](#link-to-a-github-repository)链接到一个 GitHub 仓库
...
### [](#design-an-eyecatching-icon)设计一个醒目的图标
...
### [](#write-a-descriptive-readme-and-changelog)写一个描述性的 README 和 changelog
...
### [](#tidy-up-your-project)整理好你的项目

最后，我建议在发布前删除`vsc-extension-quickstart.md`和任何其他无关文件！

## [](#publishing-your-extension-pack)发布您的扩展包
