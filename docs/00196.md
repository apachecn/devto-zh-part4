...
> 原文:[https://dev . to/xiel/hooks-to-persist-state-in-the-query-string-or-history-state-in-react-44a 7](https://dev.to/xiel/hooks-to-persist-state-in-the-query-string-or-history-state-in-react-44a7)
...
## [](#intro-benefits-of-good-urls)简介:好网址的好处
...
## [](#introducing-usequerystate)简介:useQueryState()
...
[![Demo of use Query State](img/0536abeb57bb43f808a7021b7f86a221.png)T2】](https://0nzex.csb.app)
...
## [](#if-not-safe-for-the-url-uselocationstate)如果对 URL 不安全:useLocationState()
...
### [](#are-you-using-raw-reactrouter-endraw-or-another-popular-router)你用的是 **`react-router`** 还是其他流行的路由器？
