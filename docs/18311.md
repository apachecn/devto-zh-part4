...
> 原文:[https://dev . to/Hugo _ _ df/tail wind-CSS-1-x-impressions-development-and-production-setup-for-static-sites-with-tail wind-CLI-and-purge CSS-CLI-6en](https://dev.to/hugo__df/tailwind-css-1-x-impressions-development-and-production-setup-for-static-sites-with-tailwind-cli-and-purgecss-cli-6en)
...
## [](#first-impressions-of-tailwind-css)顺风 CSS 的第一印象
...
## [](#setting-up-tailwind-css-v1x-for-a-static-site-with-yarn-tailwind-cli-and-purgecss-cli)使用 Yarn、Tailwind CLI 和 PurgeCSS CLI 为静态站点设置 Tailwind CSS v1.x

### [](#getting-up-and-running-with-tailwind-cli)使用顺风 CLI 启动并运行
...
### [](#production-purgecss-configuration-for-tailwind)顺风生产采购配置
...
## [](#get-started-with-a-productionready-tailwind-css-for-static-sites-on-netlify)从 Netlify 上的静态网站的生产就绪的顺风 CSS 开始
