# 在几分钟内从 OpenCart 1.5 升级到 OpenCart 3

> 原文:[https://dev . to/next _ cart/upgrade-from-open cart-1-5-to-open cart-3-in-a-minutes-2k 25](https://dev.to/next_cart/upgrade-from-opencart-1-5-to-opencart-3-in-a-few-minutes-2k25)

# [](#step-by-step-guide-on-how-to-upgrade-opencart-15-to-opencart-3)如何将 OpenCart 1.5 升级到 OpenCart 3 的分步指南
...
# [](#what-data-can-me-migrated-from-opencart-15-to-opencart-3)哪些数据可以从 OpenCart 1.5 迁移到 OpenCart 3
...
# [](#how-to-migrate-opencart-15-to-opencart-3-with-nextcart)如何用 Next-Cart 将 OpenCart 1.5 迁移到 OpenCart 3
