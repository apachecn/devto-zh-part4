...
> 原文:[https://dev . to/app signal/build-and-play-the-go-game-with-phoenix-live view-58g](https://dev.to/appsignal/building-and-playing-the-go-game-with-phoenix-liveview-58g)
...
[![The Go game, implemented with Phoenix LiveView](../Images/078ef88a3feeeb726ae8483a9c109154.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_FVTYwbr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.appsignal.com/images/blog/2019-06/go.png)
...
## [](#preventing-illegal-moves)防止非法移动
...
## [](#scoring-history-and-the-ko-rule)计分、历史和 Ko 规则
