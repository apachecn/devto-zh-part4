...
> 原文:[https://dev . to/easily failed/why-we-make-room-for-console-log-2j 52](https://dev.to/easilybaffled/why-we-make-room-for-console-log-2j52)
...
## [](#-raw-consolelog-gt-undefined-endraw-)`console.log -> undefined`
...
## [](#-raw-consoletap-endraw-)`console.tap`
...
[![NPM](../Images/d45d07d7d26da22955db3de77e68fc00.png)T2】](https://nodei.co/npm/console.tap/)
