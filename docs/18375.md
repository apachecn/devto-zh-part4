...
> 原文:[https://dev.to/thegroo/one-to-run-them-all-1mg6](https://dev.to/thegroo/one-to-run-them-all-1mg6)
...
## [](#running-kafka-from-a-dockercompose-file)从 docker-compose 文件运行卡夫卡
...
[![terminal consumer / producer](../Images/4c124d2b191e3b760d779784a8acfc3f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t8Lm38vz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rjqtzn8b0n6z2jiad1mt.png)
...
### [](#confluent-kafka-and-zookeeper-images)融合的卡夫卡与动物园管理员形象
...
## [](#command-line-using-docker-images)命令行使用 docker 图片
...
### [](#managed-kafka-offers-in-the-cloud)托管云中的卡夫卡
...
### [](#kubernetes-or-swarm-versions)Kubernetes 或 Swarm 版本
