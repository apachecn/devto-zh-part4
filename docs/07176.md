...
> 原文:[https://dev . to/track js/debugging-denied-to-get-unsafe-header-in-chrome-1lc 6](https://dev.to/trackjs/debugging-refused-to-get-unsafe-header-in-chrome-1lc6)
...
[![Code snippet console output](../Images/28b68db5964a89114805353c27e32fca.png)T2】](///assets/images/blog/2019-08-refused-unsafe-header/console.png)

<cite>[代码片段控制台输出](/assets/images/blog/2019-08-refused-unsafe-header/console.png)</cite>
