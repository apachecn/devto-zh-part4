...
> 原文:[https://dev . to/black smoke 16/OQ-a-portable-performant-jq-wrapper-18ka](https://dev.to/blacksmoke16/oq-a-portable-performant-jq-wrapper-18ka)
...
#### [](#consuming-json-and-output-xml)消耗 JSON 并输出 XML
...
#### [](#consuming-json-and-output-yaml)消耗 JSON 并输出 YAML
...
#### [](#consume-yaml-from-a-file-and-output-xml)从文件中消耗 YAML 并输出 XML
...
#### [](#consume-json-transform-it-and-output-xml)消费 JSON，转换它，输出 XML
...
#### [](#jeopardyjson-2)Jeopardy.json (#2)
