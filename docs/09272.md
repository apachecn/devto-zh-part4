...
> 原文:[https://dev.to/nestedsoftware/tic-tac-toe-with-mcts-2h5k](https://dev.to/nestedsoftware/tic-tac-toe-with-mcts-2h5k)
...
[![mcts playout](../Images/eaed7b3389554a7f175787b2b3dbef14.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KXgJHlNA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6dpz3fabybointn48xte.png)
...
## [](#selection-and-upper-confidence-bound)选择和置信上限
...
[![ucb1](../Images/38edc6118c16bc0960b4aff7e4dbf0c4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EgY9iYGb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eh886tke4wwtsywdd8xr.png)
...
[![ratio numerator](../Images/fc835354722f802040d4c331113eacb9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lHr-ghvs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qj85q41542hacbmixfj7.png)

如果我们继续增加对父节点的访问次数，而不访问给定的子节点，我们可以看到上面的整体探索项将逐渐增加。但是，因为它是按自然对数缩放的，所以相对于访问次数来说，这种增加是缓慢的。

每当我们访问一个子节点时，分母就会增加，从而导致探索项减少:

[![ratio denominator](../Images/6329a3fc7c403145f000b3525fc87407.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xshtk6dK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x6i8btrl4sa55hchrl5l.png)
...
[![multiple parent nodes](../Images/16a5a8c7b67c8c73655ae7d990a0abe5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FFvUOSvn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o7yq2vhssxbhwmtounfv.png)
...
[![results against various opponents](../Images/4bd464a732ab7d8ecf5f9b6a92be66eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--38YuJcPM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fzlxjjcv96epvpi2x96j.png)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [嵌套软件](https://github.com/nestedsoftware) / [ tictac](https://github.com/nestedsoftware/tictac)
