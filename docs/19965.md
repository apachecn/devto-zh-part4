...
> 原文:[https://dev . to/awwsmm/how-to-experimentally-determine-the-shell-you-re-use-4 fel](https://dev.to/awwsmm/how-to-empirically-determine-which-shell-you-re-using-4fel)

## [](#finding-unique-shell-variables)寻找唯一的外壳变量
