...
> 原文:[https://dev . to/raymond Camden/two-tips-for-native script-and-vue-development-on-the-playground-nd0](https://dev.to/raymondcamden/two-tips-for-nativescript-and-vue-development-on-the-playground-nd0)
...
### [](#save-then-save-then-save-again)保存，再保存，再保存
...
### [](#errors-and-damn-errors)错误和该死的错误
