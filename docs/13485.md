...
> 原文:[https://dev . to/devblackops/using-poshbot-middleware-for-rate-limiting-notifications-in-slack-51n 0](https://dev.to/devblackops/using-poshbot-middleware-for-rate-limiting-notifications-in-slack-51n0)
...
## [](#poshbot-middleware)PoshBot 中间件
...
## [](#middleware-hook-stages)中间件钩子阶段
...
## [](#adding-the-middleware-hook)添加中间件钩子
...
### [](#ratelimitingnoticeps1)限速 _ 通知. ps1
