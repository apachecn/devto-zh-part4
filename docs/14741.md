...
> 原文:[https://dev . to/Dai _ Shi/four-patterns-for-global-state-with-react-hooks-context-or-redux-2g DG](https://dev.to/dai_shi/four-patterns-for-global-state-with-react-hooks-context-or-redux-2gdg)

##### [](#and-the-libraries-i-developed)和我开发的库

### [](#introduction)简介

当您开始开发 React 应用程序时，全局状态或共享状态是最大的问题之一。该不该用 Redux？钩子提供了类似 Redux 的解决方案吗？我想展示使用 Redux 的四种模式。这是我个人的观点，主要针对新的应用。

### [](#pattern-1-prop-passing)模式一:道具传球
...
### [](#pattern-3-multiple-contexts)模式三:多重语境
