...
> 原文:[https://dev . to/_ rich/building-a-pdf-generator-on-AWS-lambda-with-python 3-and-wkhtmltopdf-50kl](https://dev.to/_rich/building-a-pdf-generator-on-aws-lambda-with-python3-and-wkhtmltopdf-50kl)
...
### [](#python3-dependencies)Python3 依赖关系
