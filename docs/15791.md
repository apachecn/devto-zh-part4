...
> 原文:[https://dev . to/this dot media/consideration-in-migrating-from-ember-to-react-3c FM](https://dev.to/thisdotmedia/considerations-in-migrating-from-ember-to-react-3cfm)
...
## [](#exploring-ember-and-react-general-differences)探索余烬与反应——一般差异
...
## [](#porting-your-ember-app-to-react)移植您的 Ember 应用程序以作出反应
