...
> 原文:[https://dev . to/sense deep/you-don-t-need-a-sumosplunkdog-54j 3](https://dev.to/sensedeep/you-don-t-need-a-sumosplunkdog-54j3)
...
## [](#what-does-logging-look-like-in-big-sites)大站点的日志是什么样子的？
...
## [](#enterprise-logging-issues)企业日志问题
...
### [](#delays-please-wait-for-your-logs-)延迟，请等待您的日志...
...
## [](#the-strengths-of-cloud-watch)云手表的长处
...
[![Cloudwatch Components](../Images/34211112ce16adf343895a05c8343122.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0qcaMxd0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.sensedeep.com/images/blog/cloudwatch/cloudwatch-components.png)
...
### [](#log-data-is-not-aggregated)日志数据不汇总
...
## [](#transform-cloudwatch-with-sensedeep)用 SenseDeep 改造 CloudWatch
...
[![Cloudwatch with SenseDeep](../Images/1880e9a5082b57cf17d61acd206f490b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RKMNP8MX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.sensedeep.com/images/blog/cloudwatch/cloudwatch-with-sensedeep.png)

AWS CloudWatch 和 SenseDeep 共同为中小型网站提供了全面的日志记录解决方案，是诉诸传统企业日志记录解决方案的有效、简单的替代方案。

[![SenseDeep](../Images/abb2920852ee855f858600cdfba78442.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wnEYzrjq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.sensedeep.com/images/sensedeep/drag-viewer.png)

## [](#try-sensedeep)试试 SenseDeep
