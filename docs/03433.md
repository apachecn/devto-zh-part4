...
> 原文:[https://dev . to/nabe NDU 82/interview-preparation-basic-JavaScript-2-5ac 2](https://dev.to/nabendu82/interview-preparation-basic-javascript-2-5ac2)
...
### [](#this-inside-global-scope)“此”在全局范围内
...
### [](#this-inside-a-method)“这个”里面有一个方法
...
### [](#this-inside-a-function)“这个”里面有一个函数
