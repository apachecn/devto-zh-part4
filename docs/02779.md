...
> 原文:[https://dev . to/azure/migracion-de-una-aplicacion-mean-a-arquitectura-server less-y-azure-functions-44no](https://dev.to/azure/migracion-de-una-aplicacion-mean-a-arquitectura-serverless-y-azure-functions-44no)
...
## [](#comprendendo-la-estructura-del-proyecto-mean)了解项目结构意思

在本项目中，我们将侧重于两个文件夹:API 和 **front** 。如下图所示:

[![Screen-Shot-09-11-19-at-12-04-PM.png](img/f6d6f5329b0ff17f6217ccd0b89684e9.png)T2】](https://postimg.cc/RJKKF34d)
...
## [](#qu%C3%A9-son-azure-functions-%EF%B8%8F)它们是蓝色功能吗？⚡️
...
## [](#plantillas-importantes-en-azure-functions)蓝色功能中的重要模板
...
[![Screen-Shot-09-11-19-at-12-42-PM.png](img/1cea6e7ca048487dcb8a75c1f74f5a39.png)T2】](https://postimg.cc/5HCTSV5r)

嗯，在这种蓝函数的概述之后，我们就可以开始迁移了！往前走！

## [](#instalaci%C3%B3n-del-paquete-azure-functions-core-tools)蓝色功能核心工具套装的安装
...
[![gif-serverless-07.gif](img/e830fa0a29e050f1f59c309f63e59731.png)T2】](https://gifyu.com/image/hYvM)

太好了！现在我们可以创建自己的功能。为此，请在您的计算机上创建本地文件夹并□！

## [](#creando-una-nueva-aplicaci%C3%B3n-en-azure-functions)创建蓝色函数新应用

既然我们已经安装了软件包，我们就创建一个新的应用程序。为此，只需按照 gif 等步骤进行操作:

[![gif-serverless-08.gif](img/df4f2824ed7f9058d4e5712a6a725f8a.png)T2】](https://gifyu.com/image/hYqP)

请注意，打开 Visual Studio 代码时，我们必须单击右下角的“`YES`”按钮以启用项目中的某些重要文件。

## [](#creando-una-conexi%C3%B3n-en-mongodb)在蒙戈布建立连接
...
[![Screen-Shot-09-11-19-at-02-05-PM.png](img/6ac457e3b56bc274a6dd475f0174267b.png)T2】](https://postimg.cc/CRVryLtH)
...
## [](#creando-la-funci%C3%B3n-createfuncionario)创建‘create official’功能
...
[![gif-serverless-09.gif](img/f7b5857da806260b9d7ff5d05ece5650.png)T2】](https://gifyu.com/image/hYI8)
...
[![gif-serverless-11.gif](img/b2a631e7c161d4e89fa73ed405083539.png)T2】](https://gifyu.com/image/hYI5)
...
[![gif-serverless-122d9fa9f9e2c32e04.md.gif](img/dc23cd5f25ab707d3ef909bb6c357667.png)T2】](https://gifyu.com/image/hYuM)

妙极了！😍

∞让我们列出员工名单！

## [](#creando-la-funci%C3%B3n-getfuncionarios)创建‘get officers’功能

和以前一样，我们用命令创建了一个新的函数:`func new`，命名函数`GetFuncionarios`，然后更改文件:`function.json` e `index.js`

**(点击图片观看 gif)**

[![gif-serverless-1390be8d86cc5d4218.md.gif](img/8d443815dfeb968d50c00d3642686a5e.png)T2】](https://gifyu.com/image/hYuz)
...
[![gif-serverless-14.gif](img/2abb577d869169a61f1236add0ba4930.png)T2】](https://gifyu.com/image/hYdI)
...
## [](#creando-la-funci%C3%B3n-updatefuncionario)创建‘更新官员’功能
...
## [](#creando-la-funci%C3%B3n-deletefuncionario)创建【删除官员】功能
...
[![gif-serverless-156824eb58eaca624e.md.gif](img/4d5d4f154837af0bffdf110f5a4b5577.png)T2】](https://gifyu.com/image/hYnX)
