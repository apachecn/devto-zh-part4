...
> 原文:[https://dev . to/nikhilswain/5-named-array-methods-in-JavaScript-1i6a](https://dev.to/nikhilswain/5-famous-array-methods-in-javascript-1i6a)

#### [](#map-reduce-filter-some-every-)map()，reduce()，filter()，some()，every()。

JavaScript 为我们提供了许多有用的方法来简化我们的工作。在本文中，我们将仔细研究一些 JavaScript 著名的**数组方法**，它们将帮助我们高效地编码。

[![](img/782c372d9a30ed776537649ef52ba62c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PVmynwsj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/627/1%2Ara6r7nqtZD13yTTwhC6VRw.png)
