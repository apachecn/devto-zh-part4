...
> 原文:[https://dev . to/stereo booster/building-high-performance-Hugo-theme-3b 9](https://dev.to/stereobooster/building-high-performance-hugo-theme-3b9)
...
### [](#only-asynchronous-scripts-nonasync-scripts-block-dom-construction-and-delay-page-rendering)只有异步脚本。非异步脚本会阻止 DOM 构造并延迟页面呈现。
...
### [](#external-resources-need-to-have-set-dimensions)外部资源需要有设定的维度。
...
### [](#css-must-be-inlined-and-size-bound)CSS 必须内联，大小绑定。
...
### [](#font-loading-must-be-efficient)字体加载必须高效。
...
### [](#only-run-animations-on-the-gpu)只在 GPU 上运行动画。
