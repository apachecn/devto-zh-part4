...
> 原文:[https://dev . to/bjyurkovich/get-started-with-your-IOT-devices-using-io tery-io-4c2d](https://dev.to/bjyurkovich/get-started-with-your-iot-devices-using-iotery-io-4c2d)
...
## [](#setting-up-an-iotery-account)设置小额账户
...
[![](../Images/0bd983540640d52de3cfebd1b7abdaa8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rqL8IjqR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/88i4a316su43xpgnsh61.png)
...
[![](../Images/8f7e9dba07cc62fbaadcefd0b741dc22.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fnntIm7I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xc3zru795gkp122vrvmn.png)

## [](#configuring-iotery-for-our-temperature-sensor)为我们的温度传感器配置 Iotery
...
#### [](#creating-the-device-type)创建设备类型
...
[![](../Images/cf5640a0c21a13d8c248ee4fa6e68254.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ot2eLFFP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t12ar3n0whvlpa40u8rd.png)
...
[![](../Images/a7d89f043011e1f8490c4228b37bbce4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Cp983aRR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/w9f69oiwo621bgivxapb.png)
...
#### [](#creating-data-types)创建数据类型

为了向云报告数据，我们需要告诉 Iotery 预期的数据类型。在这种情况下，我们将报告一个温度，因此我们需要创建一个`Temperature`数据类型，并将其分配给我们的`Temperature Sensor`设备类型。

[![](../Images/9248640b02d64637ae23b63f96caab31.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7egTWxD2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/04xaezv600c10beqb67l.png)
...
## [](#setting-up-our-raspberry-pi-temperature-sensor)设置我们的树莓 Pi 温度传感器
...
[![](../Images/030a64e7b06115724cbdea889e30132f.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--AmxlwUe8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v1aporax2angd6c0z1so.png)

太好了，我们正在向云报告，我们还有一些时间来设置我们的设备以响应报告命令！

## [](#setting-up-commands-for-our-temperature-sensor)为我们的温度传感器设置命令

我们希望能够随时从我们的 Pi 请求温度，所以我们需要向它发送一个命令。就像以前一样，我们必须告诉 Iotery 我们将发送什么类型的命令。我们只需要一个命令:`REPORT_TEMPERATURE`。
[![](../Images/a57d785a377fe216eaa5cd322561f20f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ACxdwtui--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h396hn2cltep5ybs8uqb.png)
...
#### [](#add-the-necessary-imports)添加必要的进口
...
#### [](#mqtt-set-up-and-connection-to-broker)MQTT 设置并连接到代理
...
#### [](#starting-the-mqtt-loop)启动 MQTT 循环
...
[![](../Images/20fcf1092d1334837f2e6957578e6fe4.png)T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--A-_yRJf2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xv8zj6mpv04qaxhs0wc0.png)
