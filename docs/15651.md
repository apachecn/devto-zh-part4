...
> 原文:[https://dev.to/lxxxvi/middleman-tailwindcss-webpack-ap3](https://dev.to/lxxxvi/middleman-tailwindcss-webpack-ap3)
...
## [](#setup-a-middleman-project)设置中间人项目
...
### [](#add-livereload-optional)添加 Livereload(可选)
...
## [](#create-raw-postcssconfigjs-endraw-)创造`postcss.config.js`
...
## [](#activate-webpack-as-raw-externalpipeline-endraw-)激活网络包为`:external_pipeline`
...
## [](#change-stylesheet-and-javascript-paths-in-raw-sourcelayoutslayouterb-endraw-)更改`./source/layouts/layout.erb`中的样式表和 javascript 路径
...
[![](../Images/3919016eb4bf1741e1fddad12fe08d06.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zE401ADP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o5age2s4t98nm5ljic6c.png)
