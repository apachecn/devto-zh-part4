...
> 原文:[https://dev . to/azure/announcing-the-rabbit MQ-extension-for-azure-functions-2mbo](https://dev.to/azure/announcing-the-rabbitmq-extension-for-azure-functions-2mbo)
...
## [](#how-to-get-started-with-the-rabbitmq-trigger)如何开始使用 RabbitMQ 触发器
...
#### [](#javascript-typescript-python-java-and-powershell-functions)JavaScript、TypeScript、Python、Java 和 PowerShell 函数
...
#### [](#example-c-trigger-and-output-binding)示例 C#触发器与输出绑定
...
#### [](#example-functionjson)示例 function.json
...
## [](#redelivery-and-deadletter)送还和死信
