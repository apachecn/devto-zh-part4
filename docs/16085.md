...
> 原文:[https://dev . to/uri shaked/curl-the-cloud-20gb-files-and-I-7g 9](https://dev.to/urishaked/curl-the-cloud-20gb-files-and-i-7g9)
...
[![Copy as cURL(bash)](../Images/fe1ad9bf0c79fc83533230c0a314e346.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hT7jAeGj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qv854bff82978ksdmlur.png)

## [](#copying-the-file-to-google-cloud-storage-or-aws)将文件复制到 Google 云存储或 AWS
...
## [](#uploading-the-file-directly-to-vimeo)直接上传文件到 Vimeo
...
## [](#uploading-to-other-places-google-drive-dropbox-etc)上传到其他地方——Google Drive、Dropbox 等。
