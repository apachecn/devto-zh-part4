...
> 原文:[https://dev . to/beznet/build-a-rest-API-with-node-express-MongoDB-4ho 4](https://dev.to/beznet/build-a-rest-api-with-node-express-mongodb-4ho4)
...
## [](#connecting-to-our-database)连接到我们的数据库
...
## [](#lets-test-our-database-connection)让我们测试一下我们的数据库连接！
...
[![](../Images/6a85aee517b7d651e5c6eeac6d7df1dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AeWL38G2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1eg6v5zu79s73pu5i3sl.png)

酷！我们已经成功地启动了我们的服务器，我们的数据库似乎正在运行。

## [](#setting-up-our-server-to-accept-json)设置我们的服务器接受 JSON
...
## [](#creating-our-routes-folder-amp-file)创建我们的航线文件夹&文件
...
[![](../Images/ef57c35d3ef5bb47a34f429569a34a4f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ypp4w6Yv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kr3wenx3n5o8qjy05t5f.png)

在第 9 行，我们可以看到服务器发回了“hello world”。这意味着我们的 API 工作正常！好了，到目前为止我们已经做了很多，让我们休息一下，然后我们将开始制作模型。

## [](#making-the-model)制作模型
...
## [](#routes-create-and-get-subscribers)路线–创建并获得用户
...
## [](#lets-create-and-get-our-first-subscriber)让我们创建并获得我们的第一个订户吧！
...
[![](../Images/5d555e95f2a9e66a879db346ad4827c7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_jbayxgl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n2095ojafy3fksfc78ex.png)
...
[![](../Images/e819b4f2d0557f7ddb6e7a0dd9e574f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qLOVL3Zf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/51zg5x6qaawdvzh5ea1z.png)

我们的响应将类似于我们的创建订户响应，因为我们的数据库中只有一个用户，但是如果您创建了多个订户，这将为您填充所有的订户。

## [](#the-middlewhat-the-middleware)中间——什么？中间件！
...
## [](#route-get-one-subscriber)路线–获得一个订户
...
[![](../Images/e8c99776b74a6a1fc2172ca96e28fae4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qFCVnSaF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8cew3a9fonj1pzyyor2o.png)
...
[![](../Images/48ba870fc8c4115f4fe83fdb4466e2ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XQEqWvNh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yuk16o3zjex5n6xuh322.png)

如果一切顺利，我们应该不会看到右边的响应发生变化，因为我们只是调用刚刚创建的同一个用户。给自己拍一下背，你的中间件功能，并获得一条路线的作品！

## [](#route-delete-subscriber)路由–删除订户
...
## [](#route-update-subscriber)路线–更新订户
...
[![](../Images/0836ff8c75a0686ef3b8acf2378c626d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I6LKwY8h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l2do2uh9ivqlren4gp95.png)
...
[![](../Images/69f6d3ef49e96af7c83ad7f3fb7a0c32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9hYEnU1_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/duat7pwxz9cmd6yvdjsv.png)
...
[![](../Images/32b5a56f1edf4ab6da2957d9ead25605.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--etL8EbN2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f86mz37ip99ylei0nauz.png)

好了，如果我们运行上面的补丁请求，我们应该看到 Lizzy 的名字改为 Tommy:

[![](../Images/e06f3cededa84cc48cca49b8c181ada1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CXgpwfRa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nj7cl7qtkto45nyikidq.png)
