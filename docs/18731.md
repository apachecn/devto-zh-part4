...
> 原文:[https://dev . to/michalbryxi/advanced-counter cache-in-rails-with-SQL-triggers-1b 95](https://dev.to/michalbryxi/advanced-countercache-in-rails-with-sql-triggers-1b95)
...
## [](#offloading-work-to-the-database)将工作卸载到数据库
