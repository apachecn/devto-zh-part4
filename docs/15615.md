...
> 原文:[https://dev . to/Amir MOH 10/cool-kids-handle-state-with-hooks-52p 3](https://dev.to/amirmoh10/cool-kids-handle-state-with-hooks-52p3)
...
[![calculator-gif](../Images/83f16e8493eb0e035bbbe6bb66aae491.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fmIf9mno--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AEWxHgl3Ek64DGyHfCPPYWw.gif)
...
# [](#i-using-a-class-component)I-使用一个类组件
...
# [](#ii-using-a-functional-component)II-使用功能组件

## [](#a-using-the-usestate-hook)a)使用 useState 钩子
...
## [](#b-using-the-usereducer-hook)b)使用 useReducer 挂钩
...
### [](#step1-configuring-the-usereducer)步骤 1:配置用户用户
...
### [](#step2-defining-the-logic-for-the-user-input)第二步:定义用户输入的逻辑
...
### [](#step3-defining-the-logic-for-the-calculator)第三步:定义计算器的逻辑
