...
> 原文:[https://dev . to/10x learner/advent-of-code-matchsticks-puzzle-8-3jb 0](https://dev.to/10xlearner/advent-of-code-matchsticks-puzzle-8-3jb0)

# [](#advent-of-code-matchsticks-puzzle-8)代码的出现——火柴棒——谜题 8
