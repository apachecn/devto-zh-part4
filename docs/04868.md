...
> 原文:[https://dev . to/getd/x-www-form-urlencoded-or-form-data-explained-in-2-mins-5hk 6](https://dev.to/getd/x-www-form-urlencoded-or-form-data-explained-in-2-mins-5hk6)
...
[![Alt Text](../Images/20487719596948caccea2e5780562231.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gRcWyTJ_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pzucwhmiybpy01w42z0q.png)

# [](#api-to-send-request)API 发送请求
...
# [](#api-to-handle-response)处理响应的 API
