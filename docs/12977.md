...
> 原文:[https://dev . to/app signal/JavaScript-iterators-and-iterables-1 bak](https://dev.to/appsignal/javascript-iterators-and-iterables-1bak)
...
## [](#on-linked-lists-and-rubyists)在链表和 Rubyists 上
...
## [](#so-whats-an-iterator)那么，什么是迭代器呢？
...
## [](#-raw-iterator-endraw-the-invisible-property)`@@iterator` -无形的财产
...
## [](#building-the-raw-linkedlist-endraw-)大厦`LinkedList`
