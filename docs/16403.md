...
> 原文:[https://dev . to/wernancheta/making-accessible-react-native-apps-555](https://dev.to/wernancheta/making-accessible-react-native-apps-555)
...
## [](#designing-apps-with-accessibility-in-mind)设计应用程序时要考虑可访问性
...
### [](#make-large-clickable-actions)做出大的可点击动作
...
### [](#make-buttons-descriptive)使按钮具有描述性
...
### [](#use-good-contrasts-and-a-readable-font-size)使用良好的对比度和易读的字体大小
...
## [](#accessibility-testing-tools)易访问性测试工具
