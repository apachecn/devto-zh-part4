...
> 原文:[https://dev . to/jorgaelvarez/secure-firestore-rules-for-firebase-52df](https://dev.to/jorgealvarez/secure-firestore-rules-for-firebase-52df)
...
## [](#some-thoughts-on-security)关于安全的一些想法
...
### [](#grantdeny-access-to-documents)授予/拒绝访问文档
...
### [](#use-functions-to-improve-clarity)利用函数提高清晰度
...
### [](#return-only-a-subset-of-documents)只返回文档的子集
...
### [](#allow-special-permission-to-administrators)允许管理员的特殊权限
...
### [](#filter-by-current-user)按当前用户过滤
