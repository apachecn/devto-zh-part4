...
> 原文:[https://dev . to/luv preet 33/dockerizing-a-django-application-1a 1](https://dev.to/luvpreet33/dockerizing-a-django-application-1ia1)
...
## [](#keeping-the-image-size-as-small-as-possible)保持图像尺寸尽可能小
...
## [](#installing-private-pip-packages-while-building-the-image)构建映像时安装私有 pip 包
...
## [](#building-pip-packages-while-building-the-image)构建映像时构建 pip 包
...
## [](#keeping-the-number-of-layers-minimum)保持层数最少
