...
> 原文:[https://dev . to/abused media/using-netlify-functions-to-fetch-external-files-1a4b](https://dev.to/abusedmedia/using-netlify-functions-to-fetch-external-files-1a4b)
...
## [](#welcome-lambda-functions)欢迎 Lambda 函数
