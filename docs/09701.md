...
> 原文:[https://dev . to/ash/bring-new-CSS-techniques-to-production-1 lfn](https://dev.to/ash/bringing-new-css-techniques-to-production-1lfn)
...
## [](#adapting-to-both-display-size-and-browser-capabilities)适应显示尺寸*和*浏览器功能
...
## [](#managing-fallback-styles)管理回退方式
...
## [](#the-new-frontend-baseline)新增前端基线
...
### [](#fallbacks-for-css-grid)后退为 CSS 网格
...
### [](#fallbacks-for-css-custom-properties)后退为 CSS 自定义属性
...
## [](#fully-embracing-the-new-baseline)全面拥抱*新基线*
