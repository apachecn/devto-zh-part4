...
> 原文:[https://dev.to/andi1984/variable-fonts-1i9l](https://dev.to/andi1984/variable-fonts-1i9l)
...
## [](#status-quo-before-variable-fonts)变字体前的现状
...
### [](#control-design-axes-by-fontvariationsettings)通过字体-变化-设置控制设计轴
...
## [](#variable-fonts-in-the-wild)野外可变字体！
