...
> 原文:[https://dev . to/nickforall/testing-your-phoenix-elixir-app-with-github-ci-2g h1](https://dev.to/nickforall/testing-your-phoenix-elixir-app-with-github-ci-2gh1)
...
## [](#connecting-with-the-database)与数据库连接
