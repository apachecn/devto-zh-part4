...
> 原文:[https://dev . to/prvnbist/create-a-tags-input-component-in-react js-ki](https://dev.to/prvnbist/create-a-tags-input-component-in-reactjs-ki)

[![Tags Input Demo](../Images/04f90ee16ec5fe224ee77bb051b6efbc.png "Tags Input Demo")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LqFUom3H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cltf78wmensp4vfwluvf.gif)
...
## [](#remove-tags-functionality)删除标签功能
...
## [](#lets-import-tagsinput-component-into-our-base-component)让我们将标签输入组件导入到我们的基本组件中
