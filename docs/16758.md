...
> 原文:[https://dev . to/pesse/叙说-星球大战-电影-with-utplsql-annotations-3 hkh](https://dev.to/pesse/narrate-star-wars-movies-with-utplsql-annotations-3hkh)
...
[![](../Images/4f6748565e18e9ecac49ad8ce34201fe.png)T2】](https://cleandatabase.files.wordpress.com/2019/06/utplsql_annotations_starwars_movies-e1561497249965.png)

## [](#takeaway-1-eachannotations-are-not-called-in-childsuites)要点 1:“每个”——注释在子套件中不被调用
...
## [](#takeaway-2-before-and-after-annotations-can-be-parameterized-with-methodreferences)要点 2:“之前”和“之后”注释可以用方法引用参数化
...
## [](#takeaway-3-you-can-reference-the-same-method-from-different-annotations)外卖 3:可以从不同的标注中引用相同的方法
...
## [](#takeaway-4-you-cannot-rely-on-the-order-of-contexts-and-tests-but-on-the-order-of-setup-and-teardown)要点 4:你不能依赖于上下文和测试的顺序，而是依赖于安装和拆卸的顺序
