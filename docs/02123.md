...
> 原文:[https://dev.to/jay_tillu/constructors-in-dart-5adh](https://dev.to/jay_tillu/constructors-in-dart-5adh)

*   构造函数是帮助创建对象的类的特殊方法(函数)。顾名思义，它构造了新的对象。

*   它通过初始化实例变量的值来帮助创建对象。所以我们可以说，它的主要目标是为实例变量提供值。

## [](#how-constructor-is-different-from-other-methods-of-class)构造函数如何不同于类的其他方法
...
#### [](#syntax-of-declaring-constructor)声明构造函数的语法
...
#### [](#syntax-of-defining-a-named-constructor)定义命名构造函数的语法
