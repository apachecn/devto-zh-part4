...
> 原文:[https://dev . to/usmanaziz/verify-digital-signatures-in-documents-using-c-4g 25](https://dev.to/usmanaziz/verify-digital-signatures-in-documents-using-c-4g25)
...
### [](#steps-to-verify-digitally-signed-pdf-document)验证数字签名 PDF 文档的步骤
