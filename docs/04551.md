...
> 原文:[https://dev . to/bright devs/listview with sections adapter-for-Android-listview-simple-way-to-implement-list-view-with-sections-4pn 9](https://dev.to/brightdevs/listviewwithsectionsadapter-for-android-listview-simple-way-to-implement-list-view-with-sections-4pn9)
