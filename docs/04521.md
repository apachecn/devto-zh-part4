...
> 原文:[https://dev . to/bnevilleoneill/how-to-create-a-react-native-app-with-PostgreSQL-and-graph QL-part-1-4 eck](https://dev.to/bnevilleoneill/how-to-create-a-react-native-app-with-postgresql-and-graphql-part-1-4eck)
...
## [](#how-to-set-up-an-apollo-server-with-express)如何用 Express 设置 Apollo 服务器
...
## [](#adding-postgresql-with-sequelize)添加带 Sequelize 的 PostgreSQL
...
## [](#how-to-connect-resolvers-to-the-database)如何将解析器连接到数据库
