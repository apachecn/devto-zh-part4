...
> 原文:[https://dev . to/wiredviews/kentico-CMS-quick-tip-integration-testing-roles-h6i](https://dev.to/wiredviews/kentico-cms-quick-tip-integration-testing-roles-h6i)

<figure>

[![](../Images/2ed2c3f4d0a6ca1186cb19f0268e1403.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0AOWvA2r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3m03fz5cuocblxc2hpu6.jpg)

<figcaption>Photo by [Jase Bloor](https://unsplash.com/@jasebloor) on [Unsplash](https://unsplash.com)</figcaption>

</figure>

## [](#know-your-roles)了解自己的角色！🧐
...
## [](#write-integration-tests)编写集成测试

检查数据库是否总是符合我们代码期望的最好方法是编写，然后运行一些集成测试。

> 如果您以前没有为您的 Kentico 站点编写过集成测试，请查看我的帖子“设置集成测试”:
> 
> [![seangwright](../Images/e9e13f3e057a4f58b01316c7a9d6eeea.png)](/seangwright) [## Kentico 12:设计模式第 8 部分——设置集成测试
> 
