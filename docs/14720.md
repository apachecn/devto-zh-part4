...
> 原文:[https://dev . to/brain hub/why-I-choose-effector-of-redux-or-mobx-3d l7](https://dev.to/brainhub/why-i-choose-effector-instead-of-redux-or-mobx-3dl7)
...
### [](#integration-with-react)与 React 融合
...
### [](#integration-with-other-frameworks)与其他框架集成
...
## [](#advanced-usage-raw-combine-endraw-raw-map-endraw-)高级用法:`combine`，`map`
...
## [](#comparison-with-other-state-managers)与其他国家管理者的比较
...
## [](#why-did-i-choose-effector)我为什么选择效应器
