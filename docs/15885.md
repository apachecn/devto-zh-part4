...
> 原文:[https://dev . to/njnareshjoshi/why-we-should-follow-method-overriding-rules-31lo](https://dev.to/njnareshjoshi/why-we-should-follow-method-overriding-rules-31lo)
...
## [](#method-overriding-and-its-rules)法覆写及其规则
...
[![Why We Should Follow Method Overriding Rules](../Images/31f8ca0e60548faab8356ccace381745.png "Why We Should Follow Method Overriding Rules")T4】](////3.bp.blogspot.com/-hhpGgaXYUgg/WjqobOrC3PI/AAAAAAAAMr8/HMu27uIEnLg9MkvYSGfxYy_8mjc0ZEq8QCK4BGAYYCw/s1600/method-overriding-rules.JPG)
...
## [](#why-overriding-method-must-have-the-same-name-and-same-argument-list)为什么重写方法必须有相同的名称和相同的参数列表
...
## [](#why-overriding-method-must-have-the-same-or-covariant-return-type)为什么重写方法必须有相同或协变的返回类型
...
## [](#why-overriding-method-must-not-have-a-more-restrictive-access-modifier)为什么重写方法不能有更严格的访问修饰符
...
## [](#why-overriding-method-may-have-less-restrictive-access-modifier)为什么重写方法可能有限制较少的访问修饰符
...
## [](#why-overriding-method-must-not-throw-new-or-broader-checked-exceptions)为什么重写方法一定不能抛出新的或更广泛的检查过的异常
...
## [](#why-overriding-method-may-throw-narrower-checked-exceptions-or-any-unchecked-exception)为什么重写方法可能抛出更窄的检查异常或任何未检查异常
