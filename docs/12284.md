...
> 原文:[https://dev . to/孙同/grub 4 dos-guide-loading-installing-grub 4 dos-from-Linux-314j](https://dev.to/suntong/grub4dos-guide-loading-installing-grub4dos-from-linux-314j)
...
### [](#load-via-syslinux)通过 SysLinux 加载
...
### [](#load-via-legacy-grub)通过(遗留)Grub 加载
...
### [](#load-from-linux-kexec)从 Linux 加载(kexec)
...
### [](#installing-grub4dos-code-to-the-mbr)安装 Grub4dos 代码到 MBR
...
### [](#installing-grub4dos-code-to-the-partition-boot-sector)将 Grub4dos 代码安装到分区引导扇区
