...
> 原文:[https://dev . to/clem 109/automating-user-interactions-with-cypress-2n 6h](https://dev.to/clem109/automating-user-interactions-with-cypress-2n6h)
...
[![](../Images/29de8f3c69d3937c3c9a46ba873209c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XKnGJzaK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2Ak4-5E9kKm4oqb6wn4FmaSg.jpeg)

### [](#what-is-cypress)柏树是什么？
...
### [](#editing-mocks-on-the-fly)编辑模拟练习
...
### [](#waiting-for-api-requests)等待 API 请求
...
### [](#writing-tests-for-different-devices)为不同的设备编写测试
...
### [](#e2e-tests-are-not-unit-tests)E2E 测试不是单元测试
...
### [](#common-issues-faced)面临的共同问题

当构建或 E2E 测试时，我们必须克服许多问题，以确保它们可靠地工作。我们的主要难点是在 CI 环境中(Circle CI ),测试经常失败。

[![](../Images/6fcf33d58b39c081cc3b55e7de03d084.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MNqXV4KV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ArzBqx4sW2xu4l8uWNJneBw.jpeg)

可能有许多事情会出错，最终导致测试失败，但是第一步是确定哪里有问题。

### [](#page-performance-issues)页面性能问题
...
### [](#best-practices-and-key-learnings)最佳实践和主要经验
