...
> 原文:[https://dev . to/tyrrrz/creative-use-of-extension-methods-in-c-1 Fe 5](https://dev.to/tyrrrz/creative-use-of-extension-methods-in-c-1fe5)
...
## [](#adding-methods-to-enums)向枚举添加方法
...
## [](#refactoring-model-classes)重构模型类
...
## [](#making-interfaces-more-versatile)让界面更加通用
