...
> 原文:[https://dev . to/nahuelhds/setup-dark-mode-in-slack-on-MAC OS-1 MND](https://dev.to/nahuelhds/setup-dark-mode-in-slack-on-macos-1mnd)
...
### [](#first-configure-the-general-theme%C2%A0)首先，配置通用主题👨‍💻
...
### [](#second-choose-a-proper-sidebar-theme%C2%A0)其次，选择一个合适的侧边栏主题💅
...
### [](#enjoy-the-darkness%C2%A0)享受黑暗😈

就是这样。您现在可以打开 Slack 并查看结果！

### [](#bonus-step-automatize-this%C2%A0)加成一步！自动化这个🤓
