...
> 原文:[https://dev . to/cole _ ruche/JavaScript-console-API-and-methods-3 emf](https://dev.to/cole_ruche/javascript-console-api-and-methods-3emf)
...
### [](#consoledir-and-consoledirxml)console.dir()和 console.dirxml()
...
### [](#consolegroup-consolegroupcollapsed-and-consolegroupend)console.group()，console.groupCollapsed()和 console.groupEnd()
...
### [](#consoletime-and-consoletimeend)控制台. time()和控制台. timeEnd()
