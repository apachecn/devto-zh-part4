...
> 原文:[https://dev . to/Yong Liang 24/solve-the two-sum-problem with-JavaScript-4jlk](https://dev.to/yongliang24/solve-the-two-sum-problem-with-javascript-4jlk)

### [](#objective)目标

给定一个数字数组和一个目标数字，从数组中找出两个数字之和等于目标数字。不能对同一指数求和两次。

### [](#brutal-force-solution)残暴的武力解决
...
### [](#use-keyvalue-pairs-solution)使用键/值对解决方案
