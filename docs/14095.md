...
> 原文:[https://dev . to/hackersandslackers/define-relationships-between-sqlalchemy-data-models-gn2](https://dev.to/hackersandslackers/define-relationships-between-sqlalchemy-data-models-gn2)

[![Define Relationships Between SQLAlchemy Data Models](../Images/660fe60f94c9539049e0120d992087da.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CwYnNg4d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackersandslackers-cdn.storage.googleapis.com/2019/07/sqlalchemy-relationships.jpg)
...
## [](#set-up-some-data-models)建立一些数据模型
...
### [](#performing-a-onetomany-join)执行一对多连接
