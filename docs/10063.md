...
> 原文:[https://dev . to/dobro/Erlang-chess-and-bitboards-the-application-the-should-to-appeared-one-day-22ni](https://dev.to/dobro/erlang-chess-and-bitboards-the-application-that-was-supposed-to-appear-one-day-22ni)

我发现没有用 Erlang 写的象棋表示。于是，我写了**宾博**。

[![Binbo in Erlang shell](../Images/b3e204a6aab48419a2820f65fcbb6a73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f-2cSUdi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ecq4mukdp61gs7vzd1w.png)
...
## [](#binbo-and-magic-bitboards)宾博和魔法棋盘
