...
> 原文:[https://dev . to/sobiodarlington/better-error-handling-with-async-await-2e5m](https://dev.to/sobiodarlington/better-error-handling-with-async-await-2e5m)

本文旨在建议一种在使用 async/await 语法时处理错误的更好方法。事先了解承诺是如何起作用的很重要。

## [](#from-callback-hell-to-promises)从回调地狱到承诺
...
#### [](#user-profile-example-1)用户简介示例 1
...
#### [](#user-profile-example-2)用户简介示例 2
...
## [](#promises-with-with-asyncawait)承诺与异步/等待
...
#### [](#user-profile-example-3)用户简介示例 3
...
### [](#wait-theres-a-problem)等等！有一个问题
...
#### [](#user-profile-example-4)用户简介示例 4
...
### [](#but-error-handling-could-be-improved)...但是错误处理可以改进

*你怎么知道有错误的是来自哪个异步请求？*

我们可以对异步请求调用一个`.catch`方法来处理错误。

#### [](#user-profile-example-5)用户简介示例 5
...
#### [](#user-profile-example-6)用户简介示例 6
