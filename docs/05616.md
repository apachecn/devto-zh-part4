...
> 原文:[https://dev . to/bnevilleoneill/you-don-t-need-babel-with-node-1l7n](https://dev.to/bnevilleoneill/you-don-t-need-babel-with-node-1l7n)
...
## [](#debabeling-step-1-dealing-with-modules)消除混乱的第一步:处理模块
...
## [](#debabeling-step-2-using-modern-async-control-flow)消除混乱步骤#2:使用现代异步控制流
...
## [](#debabeling-step-3-keep-the-sugar)脱涩第三步:留着糖！
...
## [](#finally-why-you-still-might-need-babel)最后，为什么你可能仍然需要巴别塔
