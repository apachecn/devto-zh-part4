...
> 原文:[https://dev . to/gloria maris/using-children-props-for-authenticated-routing-in-react-router-V5-and-react-16-9-3e0m](https://dev.to/gloriamaris/using-children-props-for-authenticated-routing-in-react-router-v5-and-react-16-9-3e0m)
...
#### [](#what-is-a-raw-children-endraw-prop)什么是`children`道具？
...
#### [](#new-component-raw-privateroute-endraw-)新组件:`PrivateRoute`
