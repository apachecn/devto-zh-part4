...
> 原文:[https://dev . to/k _ penguin _ sato/my-joint-of-go-maps-ranges-blh](https://dev.to/k_penguin_sato/my-journey-of-go-maps-ranges-blh)

# [](#maps)地图

`map`是一个无序的键值对集合，其中每个键都是唯一的。

### [](#declaring-a-map)宣告地图
...
### [](#%E2%91%A0-makemapkeytypevaluetype)① make(映射[key_type]value_type)
...
### [](#retrieving-values-from-a-map)从地图中检索值
...
### [](#checking-the-existence-of-a-key-in-a-map)检查地图中是否存在关键字
...
### [](#deleting-a-key-from-a-map)从地图中删除一个键
...
### [](#skipping-the-index-key-or-value)跳过索引、键或值
