...
> 原文:[https://dev . to/up division/how-to-deploy-laravel-on-Google-compute-engine-on-Linux-3h 30](https://dev.to/updivision/how-to-deploy-laravel-on-google-compute-engine-on-linux-3h30)
...
## [](#preparing-your-project)准备您的项目

不像 GAE，在 GCE 上部署你不需要改变什么。然而，你可以把你的应用程序放在 docker 容器中，就像这里解释的那样，让你的工作更容易。

## [](#creating-a-compute-engine-instance)创建计算引擎实例
...
## [](#setting-up-a-compute-engine-machine)设置计算引擎机
...
[![img1](img/16542b6ded7007f2c72f48583c5c3f74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fc8EFDPj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/r78znp7rl9m5oju88r1w.png)
...
[![img2](img/1935d588fd3c987c4f339e5f1a1c978c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6vqjX8Wz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kw988hatdsewd6qpu22a.png)
...
[![img3](img/f740900cf06779256de8e2a0fc366436.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YLOYa4tF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jj08y8n5ajvo4lekpql1.png)

[![img4](img/f3a61a7e0e59a178e6720b03b61a0586.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LoWe_rrn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0nokmd8vqf77ycdbyz1a.png)

在授权选项卡中，在名称输入中添加实例的名称，在网络输入中添加 ip 地址。

[![img5](img/ff6e90a8b03e5cdfd59a3bd955db89d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pCPecU_1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lbjpi0qc84p23pu6ac4w.png)

1.  使用数据库用户名、主机和名称设置您的。环境文件

## [](#instance-groups-and-ssl)实例组和 ssl
...
## [](#creating-an-instance-group)创建一个实例组

转到您的虚拟机实例列表。在第一个实例末尾的 3 个点上，单击**新建实例组**。

[![img6](img/53d0e04e520d4c40a375fde57ac4a6e9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1DXsCwCl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6y6i0n2yjh6fkgl73jfq.png)

选择 unmanaged(或者不选择，取决于您的需要),并在页面末尾添加第二个实例。单击创建。

如果你想选择管理，你需要创建一个实例模板，谷歌可以在流量增加时自动旋转。为此，当实例启动时，您还需要一个启动脚本来运行。你可以用 bash 来写。

[![img7](img/efdf3d50faf4796f93d77ef499677018.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0GFOIUgf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k5kbt253aux88kl1hnvj.png)

[![img8](img/d9d5791865451bc7df186e22695e562d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qNuSXlAE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/42d9hmxvtnp8ku7u1f10.png)

## [](#setting-up-the-domain)设置域

转到左侧菜单，选择 VPC 网络

[![img9](img/240a71ce39afbfd890d5140d586e4705.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PmIRIWQ4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/r73w8mckags89q86yivi.png)

现在选择外部 IP 地址，并确保您的实例运行在静态 Ip 地址上。如果它不保留一个。

[![img10](img/4bb9edc1058f73c3853adc1b46b518c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ak7Sn2T9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4j1axh5jx9o5nclty07q.png)

要在实例组上设置域，您需要进入左侧菜单并单击网络服务

[![img11](img/79305ea0eeb7d374a215f3e1c8738062.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZmDhb6MA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d882iclfhkntsvr61z9k.png)

在左侧菜单中，您需要选择云 DNS

[![img12](img/b6e0f56c33c5c85398437866581c4f6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OzrLB9d3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p36b5bwzan6u0gj47vcx.png)
...
[![img13](img/26fc7daf7726aaf8c290a512f2358154.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GDLm1SSV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z33m5w3u78gykzvshsa6.png)

然后，我们需要创建一个记录，将我们保留的 IP 地址连接到我们正在设置的域。单击您所在区域的名称，然后在页面顶部添加记录集。

[![img14](img/b4057ef346fcf1a3cab60f6e9a9439b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--csAVCBe8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/83ixmwmud8o8aba7lh9c.png)

[![img15](img/babb73bc7e45632704ec57231570062c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BmWjTzZV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2cmjqgu5ue0c8en4s919.png)

添加一个 A 记录。复制实例的 IP，并将其粘贴到 IPv4 地址输入中。如果你想使用一个子域添加到 DNS 名称输入。

[![img16](img/d54396e5f9a080da93da394d0ae211d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OSceZxJc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ephjpcs6u6ao46a4ivzu.png)
...
[![img17](img/410b916b60e139f1ccc992340d64fc3c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--q4yssUgw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ov69mkogsj6pwe8gm35j.png)
...
[![img18](img/d8d94dcf7e14fbdb35393d1af7f54c2f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xi8I0UiO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m03amarw422dw0c68myy.png)

单击开始配置。给它一个名字，然后点击后端配置。

[![img19](img/b8f48f0497d0736197a690665474cf07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9_zZGCNb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u903kmaobpa67a42fg6b.png)

选择创建后端服务和后台存储桶，然后选择创建后端服务

[![img20](img/cdc2a52644ba338777a0420f069d4c96.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qpvIphlG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ua7nwlzw0t6upfdgx3uz.png)

给它一个名称，选择实例组并将协议编辑为 https

[![img21](img/fd8d6713e807d6c1da1e893d320f880b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3Ki5kVb5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jfyv9ald5mb3bqc65qjr.png)

我还向下滚动并选中了启用云 CDN。在单击创建之前，我需要创建一个运行状况检查。

[![img22](img/f4131279eb5a01f66683ae0828370be0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Zdm55aco--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ng437nkubipr6v8c58sd.png)
