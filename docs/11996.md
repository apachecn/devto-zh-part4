...
> 原文:[https://dev . to/_ rich/crime-data-exploration-with-python 3-and-pandas-part-2-23l 1](https://dev.to/_rich/crime-data-exploration-with-python3-and-pandas-part-2-23l1)
...
## [](#top-10-states-ranked-by-total-homicides)凶杀案总数排名前十的州
...
## [](#top-10-states-ranked-by-total-homicides-relative-to-the-population-size)根据凶杀案总数相对于人口规模排名的前 10 个州
