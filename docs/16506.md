...
> 原文:[https://dev . to/themarcba/beginner-s-guide-to-es6-destructing-ein](https://dev.to/themarcba/beginner-s-guide-to-es6-destructuring-ein)
...
### [](#using-a-different-variable-name)使用不同的变量名
...
### [](#defining-a-default-value)定义默认值
...
### [](#use-destructing-in-a-function-parameter)在函数参数中使用析构
...
### [](#extracting-from-nested-objects)从嵌套对象中提取
...
## [](#destructuring-arrays-%E2%9B%93)破坏阵列⛓
...
### [](#ignoring-items-in-an-array)忽略数组中的项目
...
### [](#using-the-rest-operator)使用*休息*操作符
...
### [](#swapping-variables-using-destructuring)使用析构交换变量
