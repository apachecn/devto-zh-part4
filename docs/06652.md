...
> 原文:[https://dev . to/michielmulders/creating-custom-区块链-transactions-with-the-SDK-introducing-lisk-bills-bf1](https://dev.to/michielmulders/creating-custom-blockchain-transactions-with-the-sdk-introducing-lisk-bills-bf1)
...
# [](#introduction-to-custom-transactions)自定义交易介绍
...
# [](#custom-transactions-to-grow-the-lisk-ecosystem)定制交易以壮大 Lisk 生态系统
...
# [](#benefits-of-custom-transactions)自定义交易的好处
...
# [](#lisk-bills-blockchainbased-invoicing)Lisk 账单——基于区块链的开票

[![Lisk Bills Logo](../Images/10fa84ffc9a5b02be3922444877316a0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PkGU5NTa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hu90nxfydpqno4nhrxhr.png)
...
[![Lisk Bills Sign In](../Images/3a3cd8d4f8893658f1b306a39b4ae588.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tFSe449_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4l7z55w4zoz87xy52217.png)

# [](#custom-transaction-1-invoice)自定义交易 1:发票
...
[![Lisk Bills Diagram Transactions](../Images/5e07b13e787d39cb1a2861c7e158471f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fLnAbi6y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oqy6jv1kaffzcq4yip2j.png)

以下数据存储在事务的资产字段中。由于这是一个普通的 *BaseTransaction* ，我们可以简单地指定 Bob 的 Lisk 地址作为事务的接收者。

[![Lisk Bills Send Invoice](../Images/87517c90c64a7161b7272405c80e350f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H-0QOhDk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9etww6aha74oyurji1r0.png)
...
# [](#custom-transaction-2-payment)自定义交易 2:付款
...
[![Lisk Bills Pay Invoice](../Images/3529e40cc246cdec5b06b2810b82ccf5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CzeMrM14--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5xgbuk2jfdv2z60gc5vu.png)
...
# [](#how-to-register-custom-transactions)如何注册自定义交易？
...
# [](#considerations-of-using-custom-transactions)使用自定义交易的注意事项
