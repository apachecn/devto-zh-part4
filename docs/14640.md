...
> 原文:[https://dev . to/byrro/4-steps-to-solve-lambda-cold-starts-281 l](https://dev.to/byrro/4-steps-to-solve-lambda-cold-starts-281l)

如果你喜欢无服务器和 AWS Lambda，你可能也讨厌冷启动。这是一个分步指南，指导您实施一个成功的策略来保持 AWS Lambda 功能预热，减轻冷启动延迟问题。

# [](#anatomy-of-cold-starts)解剖感冒开始了
...
# [](#xlambda-power-to-the-rescue)X-Lambda 力量前来救援

[![Ice cubes on fire](../Images/72e02167b6eff56296c8d46173e31c58.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4hUDC2SD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hoatgeadvkwmvfulemc6.jpg)
...
## [](#1-which-functions-to-keep-warm)1。它的功能是保暖

[![Fire](../Images/66587cb88843c64c4212681e33651f27.png "Fire")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HW15a0sW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/dashbird/xlambda/raw/master/images/fire.png)
...
## [](#2-customize-scaling-options)2。自定义缩放选项
...
## [](#3-minor-adjustments-to-our-functions-code-to-handle-warming-requests)3。对我们的函数代码做了微小的调整，以处理升温请求
...
## [](#4-make-sure-everything-is-running-as-expected)4。确保一切按预期运行
