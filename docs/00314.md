...
> 原文:[https://dev . to/muhajirdev/how-to-watermark-a-image-with-node-js-4n 64](https://dev.to/muhajirdev/how-to-watermark-an-image-with-node-js-4n64)

[![](img/f7d16f2e10999d4fc85c5138fe9a1d6c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sj4oRczg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hashnode.imgix.net/res/hashnode/image/upload/v1569411659931/o29o1SXQQ.png%3Fw%3D1600%26h%3D840%26fit%3Dcrop%26crop%3Dentropy%26auto%3Dformat%26q%3D60)

这将是一个非常简单的教程。

首先，让我们创建一个 node.js 项目

## [](#creating-a-nodejs-project)创建 Node.js 项目
...
## [](#okay-okay-slow-down-i-dont-get-it-what-does-the-code-do)好的，好的。慢点。我不明白。代码是做什么的？
