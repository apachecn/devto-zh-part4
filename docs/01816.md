...
> 原文:[https://dev . to/solace devs/installing-photon-OS-on-a-Dell-edge-gateway-3001-3002-50dd](https://dev.to/solacedevs/installing-photon-os-on-a-dell-edge-gateway-3001-3002-50dd)
...
## [](#create-bootable-usb-media-from-photon-os-iso)从 Photon OS ISO 创建可启动的 USB 介质
...
## [](#configure-the-boot-menu-for-automated-start)配置自动启动的引导菜单
...
## [](#configure-kickstarter-for-headless-installation)配置 kickstarter 进行无头安装
...
## [](#add-bios-script-to-instruct-gateway-to-boot-from-usb)添加 BIOS 脚本，指示网关从 USB 启动
...
## [](#install-onto-gateway-using-the-usb-media)使用 USB 介质安装到网关上
