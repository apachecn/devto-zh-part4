...
> 原文:[https://dev . to/ya shints/6-points-you-need-to-know-about-async-await-in-JavaScript-1d1o](https://dev.to/yashints/6-points-you-need-to-know-about-async-await-in-javascript-1d1o)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ tc39 ](https://github.com/tc39) / [提案-顶层-等待](https://github.com/tc39/proposal-top-level-await)
...
## [](#-raw-await-endraw-can-take-in-a-thenable)`await`可以取用一个“thenable”
...
## [](#-raw-async-endraw-class-methods)`async`类方法
