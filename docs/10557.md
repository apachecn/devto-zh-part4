...
> 原文:[https://dev.to/ruyadorno/ntl-4-0-0-9n1](https://dev.to/ruyadorno/ntl-4-0-0-9n1)

刚刚发布了一个新版本的 **ntl** (Npm 任务列表:列出和运行 Npm 任务的交互式 cli 菜单)，它终于提供了最近最受欢迎的功能之一:使用自定义运行器(如 yarn 或 pnpm)的能力。

[![ntl demo gif](../Images/010127b068a3aeb90ad61abf5a003858.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SKnMkTHY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://i.imgur.com/ZjjQ7Vi.gif%3F1)
