...
> 原文:[https://dev . to/timdeschryver/writing-a-dev-to-blog-post-with-vs code-1fn](https://dev.to/timdeschryver/writing-a-dev-to-blog-post-with-vscode-1fn)
...
## [](#writing-a-devto-post)写一篇开发帖子

这个扩展的默认模板是`dev.to`模板。要创建新的博客文章，在浏览器中右键单击或使用命令面板并选择`📝 New Blog Post`

[![Gif on how to create a new blog post](../Images/e21193db49f2baa3fcb90dc9a6e44895.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--N9nI6tPl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://raw.githubusercontent.com/timdeschryver/new-blog-post/master/other/new-blog-post.gif)

## [](#publishing-to-devto)发布到开发到
...
[![Image showing how to publish to dev.to](../Images/3a821e55f317a08f211b076079b093c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0b-z7SvD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/timdeschryver/new-blog-post/master/other/publish-dev-to.png)
