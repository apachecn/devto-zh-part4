...
> 原文:[https://dev . to/roesslerj/your-2-basic-visual-regression-testing-options-13jg](https://dev.to/roesslerj/your-2-basic-visual-regression-testing-options-13jg)

# [](#pixelcomparison-based-visual-regression-testing)基于像素比较的视觉回归测试

[![Visual bug on Netflix](../Images/c8acf2ee464f3ecee23efac25eb275ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1O1X4HUJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n18x59qw8j4yxtbvnsto.png)
...
[![Pixel-Diff example](../Images/7505785fab9fe45a067c1223927b8568.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BYLZlDDM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l06s4kudjl30kgcqlzba.png)

# [](#deep-visual-regression-testing)深度视觉回归测试

web 走了一条不同的路线，比较所有呈现的元素和它们各自的 CSS 属性。因此，与其报告页面像素不同，需要人工检查并解释差异，不如重新检查报告它们不同的确切方式:

[![Login example as reported by recheck](../Images/2feb80fbea79760fd68b29849c4663dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DDLDDWmr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/io9yjey03del0oa8ut71.png)
...
# [](#filtering-changes)过滤变化

在更改登录按钮的情况下，过滤所有这些按钮将只显示下面的更改。

[![Login example, filtered](../Images/b65ac1c4b842073e9967181e0edf1294.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YOtEQxwm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ct5qnb550a2f74tyweyg.png)
...
[![Budget differences, filtered](../Images/6e26f3b7a03d15261c312dc9d8883ca2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uSWXCQem--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p28w5cu1er2bjhrh1qgh.png)
