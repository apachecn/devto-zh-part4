...
> 原文:[https://dev . to/crai overflow/enforcing-conventi on-commits-using-git-hooks-1o5p](https://dev.to/craicoverflow/enforcing-conventional-commits-using-git-hooks-1o5p)
...
## [](#building-a-dynamic-regex-string)构建动态正则表达式字符串
...
### [](#validating-the-commit-message)验证提交消息
...
## [](#making-your-git-hook-global)让你的 Git 挂钩全球化
