...
> 原文:[https://dev . to/champi/front-end-best-practices-featured-vuejs-1b5p](https://dev.to/champi/front-end-best-practices-featuring-vuejs-1b5p)

[![Buy Me A Coffee](../Images/8741c1bafaddaa2b9ee9d5b1c31c3e03.png)T2】](https://www.buymeacoffee.com/champi)

# [](#best-practices-for-frontend-web-development)前端 Web 开发的最佳实践

## [](#css)CSS

### [](#bem)很好

#### [](#block-element-modifier-a-concept-for-writing-maintainable-css)Block 元素修饰符一个用于编写可维护 css 的概念。
...
#### [](#using-colors-fonts-sizes-and-breakpoints)使用颜色、字体、大小和断点。
...
#### [](#stop-using-raw-px-endraw-use-raw-rem-endraw-instead)停用`px`，改用`rem`
...
#### [](#writing-media-queries)编写媒体查询

##### [](#use-raw-em-endraw-in-your-media-queries)在您的媒体查询中使用`em`
...
##### [](#write-as-many-media-queries-as-you-see-fit)写下你认为合适的媒体问题
...
#### [](#complex-component-state)复杂组件状态
...
##### [](#pages-components-networklayer)页面-组件-网络层
...
*   网络层:
    这是连接到*后端*并管理数据流的层。
    [![networkLayer](../Images/e77201dc4b85309ac36aa77263ef85ec.png)T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--XDan_eEq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.ibb.co/YWxLT2M/Screen-Shot-2019-06-20-at-2-04-13-AM.png)
