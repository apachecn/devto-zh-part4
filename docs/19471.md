...
> 原文:[https://dev . to/brob/routing-contact-form-emails-to-different-address-with-netlify-zapier-and-send grid-83n](https://dev.to/brob/routing-contact-form-emails-to-different-addresses-with-netlify-zapier-and-sendgrid-83n)
...
## [](#the-basic-setup-form-html)基本设置:表单 HTML

[![Form image](../Images/92466b438f6418db1072e3297661edb2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---V1dweQX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://bryanlrobinson.com/images/netlify-form-form.jpg)
...
## [](#setting-up-a-zap-for-form-routing)为表单路由设置 Zap
...
### [](#setting-up-your-zap-trigger)设置您的 Zap 触发器

[![Zap Trigger](../Images/97a961d694fcd9181a0b129cbd61ab79.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ceUTk2u9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://bryanlrobinson.com/images/netlify-form-zap-trigger.jpg)
...
### [](#building-your-zaps-action)建立你的 Zap 的行动

[![Zap Action with Email Address Selected](../Images/eb634684da4689d429e6ab49f18831b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--u_wPE6ER--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://bryanlrobinson.com/images/netlify-form-zap-action.jpg)
...
## [](#creating-a-serverless-form-processor)创建无服务器表单处理器
...
### [](#setting-up-our-serverless-function)设置我们的无服务器功能
...
### [](#setting-up-our-email-provider-sendgrid)设置我们的电子邮件提供商:SendGrid
...
### [](#parse-the-form-submission)解析表单提交
...
### [](#setting-up-the-outgoing-webhook-in-netlify)在 Netlify 中设置外发 Webhook
...
[![Formatted email with an h1 and some strong tags](../Images/c01c2d436aaae07aa24b82a9fb5e4071.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l1qQ_0t_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://bryanlrobinson.com/images/netlify-form-email.jpg)

## [](#conclusion-form-routing-is-a-breeze-with-netlify-zapier-and-sendgrid)结论:使用 Netlify、Zapier 和 SendGrid，表单路由轻而易举
