...
> 原文:[https://dev . to/peterj/what-is sticky-sessions-and-how-to-configure-them with-istio-1e1a](https://dev.to/peterj/what-are-sticky-sessions-and-how-to-configure-them-with-istio-1e1a)
