...
> 原文:[https://dev . to/hasura HQ/building-blog-CMS-in-reason ml-with-graph QL-and-server less-using-hasura-part-1-4c 6h](https://dev.to/hasurahq/building-blog-cms-in-reasonml-with-graphql-and-serverless-using-hasura-part-1-4c6h)
...
### [](#what-it-means-for-us-as-developers)对于我们这些开发者来说意味着什么？
...
### [](#what-about-npm-and-all-these-packages-we-are-used-to-in-javascript-realm)那么在 JavaScript 领域我们习惯的 npm 和所有这些包呢？
...
### [](#adding-reasonml-to-your-project)向您的项目添加原因
