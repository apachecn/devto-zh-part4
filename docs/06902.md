...
> 原文:[https://dev . to/rocksetcloud/the-Kafka-connect-plugin-for-rockset-and-how-it-works-455 f](https://dev.to/rocksetcloud/the-kafka-connect-plugin-for-rockset-and-how-it-works-455f)
...
[![Alt Text](../Images/beb38aefbeaa920a092d23a5572389da.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6kQyXMNw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yeyd709nbrwp873is97j.png)

## [](#implementing-a-working-plugin)实现一个工作插件

### [](#what-is-kafka-connect-and-confluent-hub)什么是卡夫卡连接与合流枢纽？
...
[![Kafka Connect Architecture](../Images/89c3b7ea4e98d27b7a0bf6d5358c92e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9UhDqbVd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.ctfassets.net/1d31s1aajogl/FbsTWbMJ2mGVx7yiBlCXZ/408d88c01d52752ab097e7e24f5e6722/Kafka_Connect_Architecture.jpg)

### [](#kafka-connect-will-call-methods-in-the-plugin-that-we-implement)Kafka Connect 将调用我们实现的插件中的方法
...
### [](#the-role-of-the-config-file-one-config-for-kafka-connect-and-one-for-every-plugin)配置文件的作用——一个配置用于 Kafka Connect，一个配置用于每个插件
...
## [](#listing-it-in-confluent-hub)将其列入合流枢纽
...
[![Rockset Confluent Hub](../Images/ffa2387d42db01bd0350ce46fb188a49.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zKp3s8VW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.ctfassets.net/1d31s1aajogl/6TIT3Pbn8xl9MjHNEYwXuP/5c488701add9fa5c627a616481dfcda8/Rockset_Confluent_Hub.png)

### [](#supporting-avro-with-schema-registry)用模式注册表支持 Avro
...
### [](#smaller-things-versioningpackaging-logging-documentation-testing-graceful-error-handling)更小的事情——版本控制/打包、日志、文档、测试、优雅的错误处理
