...
> 原文:[https://dev . to/Victoria/SQL-injection-and-XSS-what-white-hat-hackers-know-about-trusting-user-input-481 b](https://dev.to/victoria/sql-injection-and-xss-what-white-hat-hackers-know-about-trusting-user-input-481b)
...
# [](#sql-injection-attacks)SQL 注入袭击
...
[![A monitor with an SQL Select command that gets all your base](../Images/32251b77f76bf992385aaa96ab921a4d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z02llPoo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cc03exnsparf2mz6140m.png)
...
# [](#sql-injection-mitigation)SQL 注入缓解
...
# [](#cross-site-scripting-xss-attacks)跨站脚本(XSS)攻击
...
[![An HTML dance party with a little JS cutting in](../Images/6e7ca6fbadb8ea7a9dfbd258b0d2b9df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DA6A20-B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mjw1chiwvqir10nutov5.png)
...
[![A screenshot of the XSS page example](../Images/b5204f4f219cfbaebc625323ca593a39.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lwPHSu8D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8yhxj10f5akpe7y26i1a.png)
...
## [](#stored-and-reflected-xss)储存和反映 XSS
...
# [](#xss-attack-mitigation)XSS 的攻击缓解
...
## [](#avoiding-direct-injection)避免直接喷射
...
# [](#pay-attention-to-your-inputs)注意你的输入
