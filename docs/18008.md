...
> 原文:[https://dev . to/bsod Mike/how to-improve-your-developer-home lab-network-with-xcp-ng-pf sense-ubiquity-unifi-29nl](https://dev.to/bsodmike/howto-improve-your-developer-homelab-network-with-xcp-ng-pfsense-ubiquity-unifi-29nl)
...
# [](#appliance-ports-yes-its-a-pc-though-in-this-case)设备端口(是的，在本例中是一台 PC...)
...
# [](#ubiquity-unifi-switch-8-managed-poe-gigabit-switch)无处不在的 Unifi 交换机 8 托管 PoE+千兆交换机
...
# [](#ubiquity-unifi-switch-8-port-configuration)无处不在的 Unifi 交换机 8 端口配置
...
[![](../Images/b790224304ed92342299519ddc1d44fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J8P7sGSP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hkqpl66qniacxpidqmif.jpg)

现在，如果我们将交换机端口配置文件更改为**配置文件-VLAN2** -神奇的事情发生了-笔记本电脑现在获得了 192.168.100.0/24 IP -耶！！这一点至关重要，因为这是 pfSense 中的虚拟端口(xn1)。

[![](../Images/4138066042f000e8dd0372ac7e48cc38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZItZ8s53--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/awh06fn0ji0du5k7fsjo.jpg)

# [](#great-so-why-would-you-do-this)太好了，那么你为什么要这样做呢？
...
## [](#downsides-to-this-approach)这种方法的缺点
