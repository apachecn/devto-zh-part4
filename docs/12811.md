...
> 原文:[https://dev . to/Sara fian/JSON path-for-composite-types-in-powershell-with-extra-tools-for-debugging-5d F4](https://dev.to/sarafian/jsonpath-for-composite-types-in-powershell-with-extra-tools-for-debugging-5df4)
...
## [](#tracing-on-types-to-help-compose-jsonpaths)跟踪类型以帮助编写 JSONPaths
...
## [](#tracing-on-object-instance-to-extract-jsonpaths-with-values)跟踪对象实例，提取 JSONPaths 的值
...
# [](#why-not-get-operation)为什么得不到操作？
