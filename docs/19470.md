...
> 原文:[https://dev . to/Hugo _ _ df/jest-exclude-file-function-statement-from-test-coverage-b1b](https://dev.to/hugo__df/jest-exclude-file-function-statement-from-test-coverage-b1b)
...
## [](#why-would-i-want-to-exclude-files-from-coverage)为什么我要将文件排除在覆盖范围之外？
...
## [](#exclude-files-from-jest-coverage-by-not-running-relevant-tests-using-configuration)通过不使用配置运行相关测试，将文件从 Jest 覆盖范围中排除
...
## [](#exclude-files-from-coverage-by-not-including-it-in-the-coverage-collection-configuration)通过不将文件包括在覆盖范围集合配置中，从覆盖范围中排除文件
...
## [](#exclude-file-from-jest-coverage-at-the-file-level)从文件级 Jest 覆盖中排除文件
...
## [](#exclude-function-from-jest-coverage)从 Jest 覆盖中排除功能
...
## [](#exclude-statement-from-jest-coverage)从 Jest 报道中排除陈述
