...
> 原文:[https://dev . to/robotsquidward/intro-to-client-side-git-hooks-24mn](https://dev.to/robotsquidward/intro-to-client-side-git-hooks-24mn)
...
[![Screen Shot 2019-08-12 at 10 20 40 AM](../Images/47fd824faa728a4bab67dcf3819a7540.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j_vZu26I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/10855762/62872161-e1500e00-bcea-11e9-8490-0533a31fc589.png)
...
## [](#introducing-git-hooks)引入 Git 挂钩
...
### [](#clientside-git-hooks)客户端 Git 挂钩
...
### [](#writing-a-git-raw-precommit-endraw-hook)写一个饭桶`pre-commit`挂钩
...
### [](#add-a-custom-raw-precommit-endraw-step)添加自定义`pre-commit`步骤
