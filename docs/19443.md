...
> 原文:[https://dev . to/riccardoodone/folding-trees-in-pure script-3 bpe](https://dev.to/riccardoodone/folding-trees-in-purescript-3bpe)
...
## [](#using-the-foldable-typeclass)使用可折叠的 Typeclass
