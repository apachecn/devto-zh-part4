...
> 原文:[https://dev . to/Marcos looten/destructing-objects-in-JavaScript-4lb 6](https://dev.to/marcoslooten/destructuring-objects-in-javascript-4lb6)
...
## [](#assigning-values-to-different-named-variables)给不同的命名变量赋值
...
## [](#assign-only-some-values-keep-the-rest)只分配一些值，保留其余的
