...
> 原文：<https://dev.to/jaredwolff/how-to-use-particle-s-powerful-bluetooth-api-1gfp>
...
附:这个帖子很长。如果你想下载一些东西，点击这里获得一份格式精美的 PDF 文件。
...
2.  创建新项目。我挑选了一个合适的地点，然后命名为`ble_mesh`
    ...
    [![Create a new Project in Particle Workbench](img/120006340f5f4afb6ca4ff3c678fdcbe.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--M3Du4xOY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-13_at_5-4348ea15-e220-4138-8d28-a8c5de99e9fe.32.11_PM.png)

3.  去你的`/src/`目录并打开你的`<your project name>.ino`文件

4.  然后，确保您将设备操作系统的版本更改为> **1.3.0**

    [![Select DeviceOS Version](img/4d49e724f96305c7065283b6e7db1a73.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--B95agg3B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-13_at_5-9d20c90b-e27c-4609-9917-2ec1bb849727.40.15_PM.png)
...
2.  在你的`.ino`文件的顶部设置你的 UUIDs
    ...
    [![Online GUID Generator](img/fa36cfc7be582703a19f1dbf45eed050.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--icItX-y9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-14_at_11-343e1df6-69e8-4560-98b9-f2f54caeb7d3.28.46_AM.png)
...
4.  初始化`Setup()`中的每个特性
    ...
    下一个参数是回调函数。当数据被写入这个回调时，这个函数将被激发。
...
2.  [在此下载 1.3.0-rc.1 镜像。](https://github.com/particle-iot/device-os/releases/tag/v1.3.0-rc.1)对于氙气，你需要 **[氙气-系统-part1@1.3.0-rc.1.bin](mailto:xenon-system-part1@1.3.0-rc.1.bin) 。**对于其他，查找 **[硼-系统-part1@1.3.0-rc.1.bin](mailto:boron-system-part1@1.3.0-rc.1.bin)** 和 **[氩-系统-part1@1.3.0-rc.1.bin](mailto:argon-system-part1@1.3.0-rc.1.bin) 。**文件在页面底部的**资产**下

    [![Assets location on DeviceOS Release Page](img/ccf2e06f76ef44f88911a1ec2be22a87.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wJDAZVYe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-14_at_11-df9b46f4-e230-484e-b69e-828526f5566e.39.39_AM.png)
...
6.  在可视化代码中，使用 **Command + Shift + P** 组合键弹出命令菜单。选择**粒子:编译应用程序(本地)**
    ...
    [![Compile application (local) choice](img/066af8396591003363173698c85020be.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--gddvjdBv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-13_at_10-8cb8dda2-73ae-4b0d-af5b-33892d66752e.52.19_PM.png)

7.  修复任何可能出现的错误。

8.  然后，打开同一菜单，选择 **Flash 应用程序(本地)**

    [![Flash application (local) choice](img/d0a3f7b9d0f3a9da6cce5c92ffa0af90.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_hrAXN9K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-13_at_10-4ff7bc95-58f1-497f-9edf-9eadb69e3abb.51.59_PM.png)
...
10.  检查一个名为**“Xenon-”**的设备是否在做广告。为您的设备插入带有唯一 ID 的**。**

     **[![Light Blue Explorer Scan Results](img/cc9a54f657948f62abdf17ccfe618bfb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ar-UuVom--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2187-aa8b88cc-f423-4b5a-8bb0-e1f75c3b7dd9.png)** 
***   找到您的设备并单击名称。

    *   查看服务和特性列表。包括我们目前设定的服务和特色 UUID 吗？例如，服务 UUID 是否显示为**6e 400001-b5 a3-F393-e0a 9-e 50 e 24 DCCA 9 e**？

    [![Confirm Light Blue Explorer has new characteristic UUIDs](img/1260740c4755b887bdb635dd0c5cd3d3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fR_5i-mA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2188-d7759af0-964e-4067-9ca2-d78edd190410.png)
...
5.  **写 FF** 。红色 LED 应该会亮起。
    ...
    [![Write new value choice](img/4ca4fa8c0d05e168a294b8432fd9f273.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--HnuXhVXz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2191-b8ad0693-f4f8-4828-ae99-b0a0e204cc50.jpg)

    [![Write the hex value of 0xff](img/005fa1f8fc05d07c638838be2b62943e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7uikPJDl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2190-2c799875-22e5-44bc-9edc-c647cf8669f6.png)
...
2.  让我们先设置氩气。**如果不是闪烁的蓝色，按住模式按钮直到它闪烁蓝色。**
    ...
    [![Particle Argon with Blue LED](img/14fe33766302285e40b40906912d3da9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--THW0VU3F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_1216-f78725ab-a9f5-4270-b389-73d6dddb1f62.jpg)

    注:如果您已经对应用程序进行了编程，LED 将默认关闭。**按住模式按钮 5 秒钟，然后继续。**

3.  完成配对过程。这个应用程序会引导你完成所有的步骤。确保您记住了网状网络的管理员密码。

    [![Particle Setup App Board Choice](img/d4288bd8a0e6a4c65840d3d1851d55e5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--omHZeUvv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2194-2482aa12-082c-4786-8883-860b50b4cd53.png)

    [![Scan the sticker](img/5ae1c75cec6ddce0f39764f82e12eb60.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NokXqnuT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2195-2d030603-e59f-4e76-9d1a-9d4f2c078a4e.png)

    [![Pairing with your Argon](img/b0558d0dde0f456bdc01150ce62dba79.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--k0koPkrv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2198-80bb83d8-818b-4cd8-a583-9262da9b5121.png)

    [![Enter wifi password](img/0afaa93161a0a3fa71b86792c16fb913.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Mk6l7pLl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2199-e3c107dd-2704-4aa3-9781-550ad14ea7fc.png)
...
6.  一旦我们有了一个漂亮的固态青色 LED(连接到粒子云)，我们将编程应用程序。使用下拉菜单中的**云闪**选项。
    ...
    [![Cloud Flash option](img/4f455ea9cb6a7ada6e30184e4759bbd7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UQOXwX7s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-15_at_9-a50458b1-ade1-4d4d-818b-ef214f3fec5d.55.19_AM.png)
...
9.  使用**云闪**来闪烁你的氙气灯。使用您在设置手机应用程序时提供的名称。只要设备连接到粒子云或处于安全模式(紫色 LED)，它就应该可以编程。
    ...
    [![Confirm board type, deviceOS version and device name](img/a3bf6bf9460340f92739d2bd6fb81bf7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--q_Oht98h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-15_at_10-2f76843b-3cee-4818-adfb-7ece4173df2d.06.32_AM.png)

    [![Cloud flash option](img/4701421dccb5c7459c3444b317ad2256.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--MAPg3brV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/Screen_Shot_2019-07-15_at_10-8e140009-440c-480d-838e-b83c782a8c96.08.47_AM.png)

10.  一旦连接上，让我们开始有趣的部分。打开**浅蓝色探索者。**连接到**氩气**或**氙气**。

    [![Select either the Argon or Xenon](img/35390fdeea3e2a98535f086d79f42b51.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--GgwjVTds--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_2200-e1c513ba-6689-4652-b442-e5c6f916d619.png)

11.  选择一个 LED 特性并更改值。

    [![Argon and Xenon with red LEDs on](img/956175870f7b8046be98fa2b6328c80e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--e64DhxkR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-use-particles-powerful-bluetooth-aimg/IMG_0627-2db8ab26-99e1-46a2-9583-97126fbe2594.jpg)
