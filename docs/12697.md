...
### [](#louverture-et-le-d%C3%A9coupage-du-fichier)文件的打开和拆分
...
### [](#r%C3%A9cup%C3%A9rer-le-nom-du-fichier-dans-le-document-word)检索 Word 文档中的文件名
...
### [](#enregistrer-chaque-document-en-pdf)将每个文件储存为 PDF
