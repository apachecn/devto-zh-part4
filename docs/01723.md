...
> 原文:[https://dev . to/michaeljota/the-introduction-to-typescript-you-may-missing-MNP](https://dev.to/michaeljota/the-introduction-to-typescript-you-may-be-missing-mnp)
...
## [](#introducing-typescript-compiler-raw-tsc-endraw-and-type-annotations)介绍 Typescript 编译器(`tsc`)和类型注释
...
## [](#introducing-interfaces-types-and-type-aliases)介绍接口、类型和类型别名
...
## [](#bonus-typing-javascript)奖励:输入 JavaScript
