...
> 原文:[https://dev.to/luispa/how-to-safely-store-a-password-5fao](https://dev.to/luispa/how-to-safely-store-a-password-5fao)
...
## [](#why-not-md5-sha1-sha2-sha3-etc)为什么不是{MD5，SHA1，SHA2，SHA3 等}？
...
# [](#bcrypt-solves-these-problems)bcrypt 解决了这些问题
