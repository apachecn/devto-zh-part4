...
> 原文:[https://dev . to/bzinoun/IBM cloud-k8s-ready-ci-CD-tool chain-1n3f](https://dev.to/bzinoun/ibmcloud-k8s-ready-ci-cd-toolchain-1n3f)
...
### [](#step2-non-blocking-step)第二步:非阻塞步骤
...
# [](#%F0%9F%9B%A0-toolchain)🛠工具链

[![](../Images/1efb7b2227a1eb6de3ff04968c883aab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tS9bFITX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jkgjvggy4xwpeyg1ch9f.png)
...
### [](#verify-docker-file)验证 Docker 文件
...
## [](#verify-k8s-deployments-file)验证 K8S 部署文件
