...
> 原文:[https://dev . to/mckabue/arrow-functions-don-t-have-the-local-variable-arguments-as-do-other-functions-52ba](https://dev.to/mckabue/arrow-functions-don-t-have-the-local-variable-arguments-as-do-other-functions-52ba)
