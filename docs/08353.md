...
> 原文:[https://dev . to/prathamesh/advanced-multi-db-techniques-in-rails-6-14mb](https://dev.to/prathamesh/advanced-multi-db-techniques-in-rails-6-14mb)
...
### [](#automatic-connection-switching-between-read-replica-and-write-databases)读取副本和写入数据库之间的自动连接切换
...
### [](#manual-switching-between-write-and-read-databases)写和读数据库之间的手动切换
