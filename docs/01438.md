...
> 原文:[https://dev . to/marcostreng/how-to-add-data-attributes-to-your-component-library-and-benefit-from-them-your-e2e-tests-148 l](https://dev.to/marcostreng/how-to-add-data-attributes-to-your-component-library-and-benefit-from-them-in-your-e2e-tests-148l)
...
## [](#the-data-and-why-we-sometimes-need-it)数据-*以及为什么我们有时需要它
