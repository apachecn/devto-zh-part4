...
> 原文:[https://dev.to/azrulaziz/javascript-scope-simplified-3laf](https://dev.to/azrulaziz/javascript-scope-simplified-3laf)

范围和其他一些东西，我总是忘记它是关于什么的，所以我决定写下来，希望它能留在我的脑海里。

## [](#scope-oneliner-definition)**作用域单行定义:**

作用域是一种规则，它决定了在哪里可以找到变量以及如何使用变量。

### [](#scope-amp-lexical-environment)范围&词法环境
...
##### [](#scope-amp-execution-context)**范围&执行上下文**
