...
> 原文:[https://dev . to/idrisrampurawala/configuring-ssh-for-git-2of 1](https://dev.to/idrisrampurawala/configuring-ssh-for-git-2of1)
...
# [](#adding-key-to-the-sshagent)向 ssh-agent 添加密钥
...
# [](#add-your-public-key-to-the-server-github-bitbucket)添加你的公钥到服务器(GitHub，BitBucket)
...
# [](#change-the-remote-url-to-your-repository)将远程 URL 更改为您的存储库
