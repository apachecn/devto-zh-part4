...
> 原文:[https://dev . to/vivekkodira/automate-a-multi-window-experience-on-ITER m2-2j9e](https://dev.to/vivekkodira/automate-a-multi-window-experience-on-iterm2-2j9e)

## [](#tldr)TLDR

这个帖子是一个教程。最终结果将是一个脚本，它在一台远程机器上创建几个会话，并行运行命令。跳到结尾看最终的脚本，或者继续阅读一步一步的教程

## [](#why-would-you-want-iterm-automation)您为什么想要 iTerm automation？
...
## [](#creating-multiple-sessions)创建多个会话
...
[![session numbering](../Images/3633e99f5d0b19d577f6a162844ac16a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iUExMOsh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/24nnqseppufckrn1xx06.png)
