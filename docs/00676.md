...
> 原文:[https://dev . to/lukyhenson/react-hooks-what-is-it-how-use-it-pt-2-using-use state-and-use effect-4 mee](https://dev.to/lukyhenson/react-hooks-what-is-it-how-to-use-it-pt-2-using-usestate-and-useeffect-4mee)

在第二部分，在我们的项目示例之后，我将向您展示如何使用`useState`和`useEffect`。

### [](#third-step-continuing-to-use-usestate)第三步:继续使用“使用状态”
...
### [](#fourth-step-using-useeffect)第四步:使用 useEffect
...
[![to be continued](img/5c86c766672014929ba5ffdc0772230e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M7amY-63--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ydfudxm1k67q7npg62b8.jpg)
