...
> 原文:[https://dev . to/jaken Herman/setting-up-automatic-react-application-deployed-on-heroku-dynos-3ha 4](https://dev.to/jakenherman/setting-up-automatic-react-application-deploys-on-heroku-dynos-3ha4)
