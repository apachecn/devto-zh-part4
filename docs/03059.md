...
> 原文:[https://dev . to/paulasantamaria/improving-your-ci-pipeline-for-node-js-2 aab](https://dev.to/paulasantamaria/improving-your-ci-pipeline-for-node-js-2aab)
...
## [](#about-continuous-integration)关于持续集成
...
## [](#find-problems-in-your-code-with-eslint)用 ESLint 发现代码中的问题
...
### [](#install-and-setup-eslint)安装并设置 ESLint
...
### [](#add-eslint-script-to-your-packagejson)将 ESLint 脚本添加到您的 package.json
...
### [](#add-a-new-step-to-your-pipeline)向您的管道添加新步骤
...
## [](#better-reports-for-test-results)更好的报告测试结果
...
[![The test results as shown by Azure DevOps using JUnit reports](img/a078fd0586daca994e696900fde78d2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--46NjjFn8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/Mo4pnIH.jpg)

### [](#generate-the-xml-report)生成 XML 报表
