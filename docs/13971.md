...
> 原文:[https://dev . to/sumitkharche/build-simple-todo-application-using-svelte-and-cosmic-js-3 LPM](https://dev.to/sumitkharche/build-simple-todo-application-using-svelte-and-cosmic-js-3lpm)
...
# [](#create-svelte-application)创建苗条的应用程序
