...
> 原文:[https://dev.to/jay_tillu/types-of-function-in-dart-34m7](https://dev.to/jay_tillu/types-of-function-in-dart-34m7)
...
## [](#function-with-no-arguments-and-no-return-type)没有参数也没有返回类型的函数
...
## [](#function-with-no-arguments-and-return-type)不带参数的函数，返回类型
...
## [](#function-with-arguments-and-no-return-type)带参数且无返回类型的函数
...
## [](#function-with-arguments-and-with-return-type)带参数和返回类型的函数
