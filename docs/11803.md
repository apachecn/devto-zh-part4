...
> 原文:[https://dev . to/intrincetic cloud/adding-Google-sign-in-to-your-web app-using-the-js-library-3n0g](https://dev.to/intricatecloud/adding-google-sign-in-to-your-webapp-using-the-js-library-3n0g)
...
## [](#create-your-own-sign-in-button)创建自己的签到按钮
...
## [](#how-to-handle-some-common-user-scenarios)如何处理一些常见的用户场景
...
### [](#listening-for-when-user-signs-in)用户登录时监听
...
### [](#checking-if-the-user-is-signed-in)检查用户是否登录
...
### [](#only-allowing-users-from-a-particular-domain-to-login)只允许特定域的用户登录
...
### [](#only-allowing-certain-users-to-login)只允许某些用户登录
...
### [](#hiding-content-until-after-the-user-logs-in)隐藏内容直到用户登录后
...
### [](#send-the-token-to-identify-the-user-not-their-id)发送令牌来识别用户(不是他们的 ID)
