...
> 原文:[https://dev . to/stanimiravlaeva/a-deep-dive-into-hot-module-replacement-with-web pack-part-two-handling-updates-3c1f](https://dev.to/stanimiravlaeva/a-deep-dive-into-hot-module-replacement-with-webpack-part-two-handling-updates-3c1f)
...
[![Hot Module Replacement process](../Images/62a2008bf69c1c0bd6a56e7182986a23.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dGLKc9AW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j27uvbdlva5xt0eqg0sn.png)
...
[![Devtools: Hot Module Replacement enabled](../Images/51ee1bbbaa7546e0fc2c485c8d250f46.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1csUiFcc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i18g1nxgwnmd6pljdiy0.gif)
...
# [](#whats-in-the-project)项目里有什么？

下图显示了项目结构(不包括`node_modules`):

[![Project structure](../Images/3f55151cedbfc23b63f629785ee245b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8hweM3fp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wmbg4sfstxw1f5frh39c.png)
...
[![HMR: The tree isn't updated on change.](../Images/379c43a84b32cd96716d3b389669ef82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jqd7bg0X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fyv1t0tuol99wq9uiat1.gif)
...
[![HMR: Tree is updated on change.](../Images/b972af14f828229e99bc8c52001c4c13.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yhZXVk3i--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q2yun2dz1m7itpszwhpi.gif)

# [](#disposal-of-old-modules)旧模块的处理
...
[![Decrease blinkrate](../Images/f7dafae26a66ca9c5224bd80cfb8bf1a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nT-PrGp9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hfdm8ox14g2obifpf6wu.gif)
...
[![Lights Dispose](../Images/785da248489455c83f31504494e9ca78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TMdcOtU_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6d9erzo6hayhtnap57gt.gif)

# [](#parentaccepted-modules)父级接受的模块
...
[![index.js -> lights.js -> tree.js](../Images/667e0df422ab4dd8ae176aa326404737.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nYsldTK5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c9dzun9ldkf2vfyj7dv8.png)

让我们通过修改`tree.js`中`NEEDLE_CLASS`的值来测试 HMR 过程。

[![Update NEEDLE_CLASS](../Images/fe9ff41cbe8013b60c8e903b3fa2e929.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MN9kRbjQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hjvzwzqbsetu36226xpc.gif)
...
# [](#refresh-strategies)刷新策略

让我们想象一下`tree.js`所有可能的更新处理场景。

## [](#self-accept-in-treejs)在 tree.js 中自我接受

如果`tree.js`中有*自接受*，webpack 执行该模块。导入`tree.js`(它的“父母”)的模块没有被通知这个变化。

[![Self accept by tree.js](../Images/cea8982bba9c7657656dd6dfe4416c91.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v7gpf-EV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ghgqp40sg77131if6asi.gif)

## [](#parent-accept-in-lightsjs)在 lights.js 中父接受
...
[![parent accept in lights.js](../Images/2fd4a6ce7933ccdadb94eb38412dc1b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WI9UMzyP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tmjpkyiam4kdam5fdjiv.gif)
...
[![parent accept in index.js](../Images/9e231ef7ccc3794f93bc57254c8b920b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YiatBKVd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/310wsll80byt82ho1lyn.gif)

## tree . js 没有更新处理程序

Webpack 继续寻找处理程序，直到它找到一个*‘根’*模块——一个没有在任何其他模块中导入的模块。在这种情况下，`webpack-dev-server`将退回到全页面重新加载，而在**的情况下，**将重启应用程序。

[![missing update handler](../Images/ce34918f49b709e8ce02ff518c6dbda3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UqcpK51u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k3itc5utmurf4q5rdrlt.gif)

# [](#choosing-an-update-handler)选择更新处理程序
...
[![Change causes full page reload](../Images/c9ea382ce4a671edbb3d25b543338673.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UmWs3_dR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0ocxo9m1vfsopdgi5u0t.gif)

Aaaand...HMR 进程失败了。我们得到的不是刷新，而是整页重载。

我必须承认我对你撒了谎。`tree.js`模块实际上不仅在`lights.js`中导入，也在`index.js`中导入。这是真正的依赖关系图:

[![lights.js -> tree.js -> index.js -> lights.js](../Images/6f749865ace29de025bb97da206f04d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fGOnw4AL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0lnt3xuf2z010y6d79qo.png)

更改后的模块应该在其依赖图的每个分支的**中有一个更新处理程序。目前，我们不接受对`index.js`中`tree.js`的更改，即将到来的热更新被拒绝。**

[![hot update is rejected](../Images/47042eb0e7abce3d8e13a501246a03bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P_kMXPTj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5pj0uzd1uayi6f9q34em.gif)
...
[![Hot update is accepted](../Images/599c60748ef58e23189d4b4d059addf1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7p9zFVUg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2685kirvvzqwm5dio01c.gif)

在我们放弃之前，让我们最后一次尝试更改`NEEDLE_CLASS`的值:

[![Parent update works](../Images/19777051ba5ee40dbc72df4c76082cee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dnAmvHqQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0r167lvn0c6qps56kw7e.gif)
...
[![Final update works](../Images/449dc2fee2ce9fc73959fa483a97960f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8H4SR8NF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h8low94q8v9x7a2cg808.gif)
