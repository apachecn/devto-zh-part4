...
> 原文:[https://dev.to/harbolaez/js-spread-syntax-ldg](https://dev.to/harbolaez/js-spread-syntax-ldg)

# [](#js-spread-syntax)JS 传播语法

### [](#learn-the-basics-of-the-javascript-spread-operator)学习 JavaScript Spread 运算符的基础知识

* * *

扩展语法是 ES6 引入的。是一个非常好的工具，可以让您的 javascript 代码更加简洁易读。

### [](#mdn-definition)**MDN** 定义:
