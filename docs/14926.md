...
> 原文:[https://dev . to/Martin Gaston/just-my-type-rolling-a-fresh-typescript-project-with-jest-eslint-and-beauty-in-2019-2cfk](https://dev.to/martingaston/just-my-type-rolling-a-fresh-typescript-project-with-jest-eslint-and-prettier-in-2019-2cfk)
...
#### [](#1-raw-packagejson-endraw-)1。`package.json`
...
#### [](#2-raw-jestconfigjs-endraw-)2。`jest.config.js`
...
#### [](#3-raw-tsconfigjson-endraw-)3。`tsconfig.json`
...
### [](#bonus-1-add-a-git-hook)加成 1:加一个 Git 挂钩
...
### [](#bonus-2-vs-code-settings)奖金 2: VS 代码设置
