...
> 原文:[https://dev . to/seattledataguy/automating-file-loading-into-SQL-server-with-python-and-SQL-1k H2](https://dev.to/seattledataguy/automating-file-loading-into-sql-server-with-python-and-sql-1kh2)

将文件加载到数据库中并不是令人兴奋的工作。这可能是单调乏味的工作。通常情况下，它会受到像 SSIS 这样的工具的约束，当一个小的变化发生时，这些工具就会崩溃。

[![](../Images/acbf5fdcba84d26850d9ea2871a5696b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M_DNYB1s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xm3yui6locudqlni5nn9.png)
...
[![](../Images/9cc019c0f87fa05fdb365a6933519b52.png)T2】](https://youtu.be/OnzBuzRX3FE)
