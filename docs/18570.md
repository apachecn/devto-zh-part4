...
> 原文:[https://dev.to/pnomolos/advanced-bundler-4fbe](https://dev.to/pnomolos/advanced-bundler-4fbe)

下面将是一篇(希望经常)更新的文章，提供帮助充分利用 Bundler 的技巧。

### [](#dry-multiplatform-gemspecs-20190614)干式多平台 gemspecs (2019-06-14)
...
##### [](#gemnamegemspeccommon)gemname.gemspec.common
...
##### [](#gemnamegemspec)gemname.gemspec
...
##### [](#gemnamejavagemspec)gemname-java.gemspec
