...
> 原文：<https://dev.to/bnevilleoneill/building-better-react-forms-with-formik-4jh1>
...
下面是一个基本的 React 表单的例子，它没有库，只有最少的引导样式:
...
有了 Yup 的对象模式验证器，您就不必再手动编写`if`条件了。你可以通过[访问它的 GitHub repo](https://github.com/jquense/yup) 来了解更多关于 Yup 和它能做什么样的验证。
...
我喜欢以“Formik”的方式编写表单，但是如果您喜欢 redux-form，那也没问题。[![😉](img/d01d77fce0ff5b3851e7fc16aa3e21dc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CDd67yc0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.oimg/core/emoji/12.0.0-1/72x72/1f609.png)
...
如果您想了解更多关于 Formik 的信息，请前往文档或观看其创建者的演示。感谢阅读！【T2[https://www.youtube.com/embed/oiNtnehlaTo](https://www.youtube.com/embed/oiNtnehlaTo)
...
帖子[用 Formik 构建更好的反应表单](https://blog.logrocket.com/building-better-react-forms-with-formik/)最先出现在[博客](https://blog.logrocket.com)上。