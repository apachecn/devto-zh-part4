...
> 原文:[https://dev . to/decudio ly/callbacks-trait-objects-and-associated-types-oh-my-2o2i](https://dev.to/deciduously/callbacks-trait-objects-and-associated-types-oh-my-2o2i)
...
### [](#lingering-concern-phantomdata)挥之不去的担忧——phantom data？
