...
> 原文:[https://dev . to/app signal/the-ultimate-check list-to-July-international ization-device-59m 6](https://dev.to/appsignal/the-ultimate-checklist-to-properly-internationalize-devise-59m6)
...
## [](#when-not-to-use-the-devisei18n-gem)什么时候(不)使用 design-i18n 宝石？
...
## [](#step-one-set-locale)第一步:设置区域设置
...
## [](#step-five-the-active-record-attributes)第五步:活动记录属性
...
## [](#step-six-check-every-devise-view)第六步:检查每一个设计视图
...
### [](#mini-checklist-for-the-devise-forms)设计表格的迷你检查表
...
## [](#step-seven-the-active-record-error-messages)第七步:主动记录错误信息
...
## [](#step-eight-fix-the-labels-we-just-broke)第八步:修复我们刚刚打破的标签
...
## [](#step-nine-update-navigation-links)步骤九:更新导航链接
...
## [](#step-ten-translate-the-mailers)第十步:翻译邮件人。
