...
> 原文:[https://dev . to/risa FJ/beginner-s-guide-to-oauth-understanding-access-tokens-and-authorization-codes-2988](https://dev.to/risafj/beginner-s-guide-to-oauth-understanding-access-tokens-and-authorization-codes-2988)
...
# [](#what-are-authorization-codes-and-access-tokens)什么是授权码和访问令牌？
...
[![](../Images/a7b8b9619e7c75c4789e5cf12fb01ad9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LWuZ-jwZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/txuse5twhl8flhukvj5l.png)
...
### [](#step-1-user-clicks-the-sign-in-with-google-button-in-your-app)第一步。用户点击应用程序中的“使用 Google 登录”按钮

### [](#step-2-redirect-to-the-google-consent-screen)第二步。重定向至谷歌同意屏幕
...
### [](#step-3-the-user-clicks-allow-on-the-consent-screen)第三步。用户点击同意屏幕上的“允许”

### [](#step-4-the-page-redirects-to-your-raw-callbackuri-endraw-)第四步。页面重定向到您的`callback_uri`
...
### [](#step-5-exchange-the-authorization-code-for-an-access-token)第五步。将授权码换成访问令牌
...
### [](#step-6-save-the-access-token)第六步。保存访问令牌
...
# [](#use-refresh-tokens-to-get-new-access-tokens)使用刷新令牌获取新的访问令牌
...
## [](#refresh-tokens-gotchas)刷新令牌陷阱

### [](#1-you-should-reuse-them)1。你应该重复使用它们
...
### [](#2-they-can-become-invalid-too)2。它们也会变得无效
