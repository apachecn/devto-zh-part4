...
> 原文:[https://dev . to/Mustapha/7-tips-to-boost-your-productivity-as-a-web-developer-4jh 7](https://dev.to/mustapha/7-tips-to-boost-your-productivity-as-a-web-developer-4jh7)

作为一名软件开发人员，有时只要使用合适的工具就可以提高工作效率。如果你每天能节省一分钟，你一年就能节省四个小时，如果你不休假的话

所以，不多说了，这里是我的 7 个建议，可以帮助你节省时间:

## [](#a-faster-raw-queryselector-endraw-)更快一点`querySelector`
...
## [](#inspecting-an-element)检查一个元素

当您检查一个元素(使用 devtools 的 inspect 工具)时，您可以使用的另一个有用的特性是`$0`。检查完一个元素后，您可以通过键入`$0`在控制台中访问它:

<figure>

[![Inspecting an element](../Images/3ce4e666ad329e301a2a639a67dbab89.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JsLvMKs7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/1TfN5Wy/0-2019-08-15-13-17-49.gif)

<figcaption>Inspecting an element with "$0"</figcaption>

</figure>

## [](#the-powers-of-the-raw-console-endraw-object)物体的力量`console`
...
[![Using console.table](../Images/def1bc17a9fafb11a62629957cadeb86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BrpYkFnw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/m4VDGwx/table.gif)
...
[![Using debugger](../Images/f1dbe9f13a9c4c95d7e407f66fca5bc6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dhYIELaF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/TR8dSHG/debugger.gif)

<figcaption>Using debugger</figcaption>

</figure>

## [](#did-you-know-about-raw-designmode-endraw-)你知道`designMode`吗？
...
[![Setting document.designMode to ON](../Images/a761f3546b9da7820236fe7f375fe4ef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BU22qmsd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/9ptR8R3/Untitled-2019-08-13-20-33-20.gif)
...
## [](#taking-advantage-of-object-destructuring)利用对象析构
...
[![mustapha](../Images/6bdfdf3b2211f22eadcf26ba89e0b921.png)](/mustapha) [## 你可能还不知道的 7 个惊人的 CSS 属性
