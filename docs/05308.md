...
> 原文:[https://dev . to/team hive/using-algolia-with-firebase-angular-apps-28c 6](https://dev.to/teamhive/using-algolia-with-firebase-angular-apps-28c6)

# [](#what-is-algolia)什么是 Algolia？

Algolia 是一个超级强大、可扩展的 API 服务，允许开发人员将不同形式的数据发送到他们的平台，并在其上快速执行搜索、排序和复杂的过滤查询。该服务非常快，通过使用副本索引来预先构建常见的查询条件，以尽可能快地发送回您的数据。

## [](#why-use-algolia-with-firebase)为什么要用 Algolia 搭配 Firebase？
...
## [](#firebase-cloud-functions)Firebase 云功能
