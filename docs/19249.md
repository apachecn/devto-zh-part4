...
> 原文:[https://dev . to/delph/functional-programming-with-JavaScript-1jl](https://dev.to/delph/functional-programming-with-javascript-1jl)
...
## [](#mutating-vs-nonmutating-methods)变异与非变异方法
...
## [](#currying-and-partial-application)逢迎而局部应用
