...
> 原文:[https://dev . to/loujaybee/3-terraform-features-to-help-you-refactor-your-infra structure-effortly-c53](https://dev.to/loujaybee/3-terraform-features-to-help-you-refactor-your-infrastructure-effortlessly-c53)

有没有创建过应用程序，比如网站？你创建应用程序，让一切工作。但是当你想要改变时，这个想法会让你害怕得要死。

这听起来像你吗？我也经历过同样的情况。编写灵活多变的代码并不容易。当谈到编写灵活的基础设施时，Terraform 这样的工具可以帮助我们。

[![](../Images/b79590aa1b4c7b210a5caf345de093a6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8-M52xNT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/www.thedevcoach.co.uk/wp-content/uploads/2019/08/terraform.png%3Ffit%3D760%252C399%26ssl%3D1)
...
## [](#an-introduction-to-terraform)地形简介
...
[![](../Images/ce59fefb716090e00bf9a4d417386bb2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XvDHo6ik--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/www.thedevcoach.co.uk/wp-content/uploads/2019/08/terraform-planning.png%3Fresize%3D760%252C675%26ssl%3D1)

*地形规划命令的例子*

### [](#terraform-apply)地形应用
...
## [](#3-terraform-features-to-help-refactor-infrastructure)3 个平台特性有助于重构基础设施

好了，希望现在你应该很好地掌握了 Terraform 的工作原理。现在，让我们进入正题，看看一些更高级的特性，以及它们如何使我们能够编写灵活且易于管理的基础架构代码，以便我们可以毫不费力地进行更改！

听起来不错吧？我们开始吧！

### [](#turning-infrastructure-into-code-with-terraform-import)把基础设施变成代码:用 Terraform 导入。
...
[![](../Images/0f72576ef2003e96c1483ada5e7153f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OQNjt244--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.thedevcoach.co.uk/wp-content/uploads/2019/08/terraform-import.png%3Fresize%3D760%252C321%26ssl%3D1)

*terra form 导入命令的描述。*

### [](#monolithic-to-manageable-infrastructureascode-with-remote-state)整体到可管理的基础设施代码:远程状态
...
[![Multi-Account AWS Terraform Setup with Encrypted Remote State on S3 Backend](../Images/07a6f37a40b7beb08bc7a9a49a0575d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AKMZik6L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/xpu9xkeqmm25weon2hdkq715-wpengine.netdna-ssl.com/wp-content/uploads/2018/02/test-1.png%3Fw%3D760%26ssl%3D1)

*来源:[restcomm](https://www.restcomm.com/multi-account-aws-terraform-setup-encrypted-remote-state-s3-backend/)T3】*

### [](#managing-all-things-cloud-with-terraform-hcl)管理万物云:使用 Terraform HCL
...
[![Image result for terraform providers](../Images/16fa15ff7e9ab1383cc92a0f4d6b1407.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9kELQXdq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/anthonyspiteri.net/wp-content/uploads/2018/06/Terraform_1.png)
