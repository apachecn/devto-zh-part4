...
> 原文:[https://dev . to/sandrogiacom/kubernetes-for-Java-developers-deploy-application-413k](https://dev.to/sandrogiacom/kubernetes-for-java-developers-deploy-application-413k)

## [](#hello-java-dev)你好 Java 开发者
...
## [](#prepare-the-environment-for-the-big-moment)为重要时刻准备环境
...
## [](#prepare-demo-application)准备演示应用程序

转到 java-kubernetes 目录，键入`make`查看所有的`make`选项。

### [](#create-minikube-machine)创建 minikube 机器

`make k-setup`启动 **minikube** ，启用 **ingress** ，创建**命名空间**“dev-to”。

## [](#create-kubernetes-resources)创建 kubernetes 资源

检查包含子目录 **app** 和 **mysql** 的 kubernetes 文件夹。

[![](../Images/8b9ee4d1d68f93e9de56513c72fd13df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CkYpjKYO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gik8s3f53uotkamw9hna.png)
...
### [](#build-application-and-docker-image)构建应用程序和 docker 映像
