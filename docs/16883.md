...
> 原文:[https://dev . to/prot ICM/tips-and-tricks-for-better-JavaScript-conditionals-and-match-criteria-409 f](https://dev.to/proticm/tips-and-tricks-for-better-javascript-conditionals-and-match-criteria-409f)
...
### [](#1-first-things-first-trivial-but-not-trivial)1。首要的事情，琐碎，但不琐碎
...
### [](#2-for-multiple-conditions-use-raw-arrayincludes-endraw-)2。对于多个条件，使用`Array.includes`
...
### [](#3-for-matching-all-criteria-use-raw-arrayevery-endraw-or-raw-arrayfind-endraw-)3。使用`Array.every`或`Array.find`匹配所有标准
...
### [](#4-for-matching-partial-criteria-use-raw-arraysome-endraw-)4。使用`Array.some`匹配部分标准
...
### [](#5-return-early-instead-of-raw-ifelse-endraw-branching)5。提前返回而不是分支
...
### [](#7-use-optional-chaining-and-nullish-coalescing)7。使用可选的链接和无效合并
