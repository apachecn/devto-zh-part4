...
> 原文:[https://dev . to/joaofbantunes/episode-026-getting-started-with-docker-ASP-net-core-from-0-to-overkill-152](https://dev.to/joaofbantunes/episode-026-getting-started-with-docker-asp-net-core-from-0-to-overkill-152)
...
## [](#containerizing-an-aspnet-core-application)将 ASP.NET 核心应用程序容器化
...
### [](#getting-the-application-into-the-image)将应用程序放入图像
...
### [](#building-the-application)构建应用程序
...
### [](#setting-the-application-up-for-running)设置应用程序运行
...
### [](#building-the-image-and-running-the-container)构建镜像并运行容器
...
## [](#containerizing-the-vuejs-spa)容器化 Vue.js SPA

### [](#building-the-container)建筑容器
