...
> 原文:[https://dev . to/shostarsson/application-obfuscation-on-IOs-3d2c](https://dev.to/shostarsson/application-obfuscation-on-ios-3d2c)
...
### [](#advantages-of-obfuscation)混淆的优点
...
### [](#disadvantages-of-obfuscation)混淆视听的弊端
...
## [](#install-dexprotector-on-macos-mojave)在 MacOS 上安装 dex protector(Mojave)

由于我们想要混淆我们的 iOS 应用程序，我们首先必须在 MacOS 计算机上安装 Dexprotector(因为混淆只能在 MacOS 计算机上运行，因为它基于 XCode 来执行一些操作)。

* * *

## [](#1-install-homebrew-package-manager)1。安装自制软件包管理器
...
## [](#2-install-jenv-to-handle-multiple-java-jdk)2。安装 Jenv 来处理多个 Java JDK

根据项目的位置来管理将要使用的 Java Jdk 是很好的。jEnv 非常适合高效、轻松地管理您的 Java 环境。

### [](#21-install-jenv-using-homebrew)2.1。用自制软件安装 Jenv
...
### [](#22-enable-jenv-on-your-shell)2.2。在您的 Shell 上启用 jenv
...
### [](#23-reload-your-shell-environment)2.3。重新加载您的 shell 环境
...
## [](#3-install-java-jdk-8)3。安装 Java JDK 8
...
### [](#31-install-java-jdk-8-using-homebrew)3.1 使用自制软件安装 Java JDK 8
...
### [](#32-register-jdks-with-jenv)3.2 向 jenv 注册 JDK
...
## [](#4-apple-developer-console-configuration)4。Apple 开发人员控制台配置

为了使 Dexprotector 运行以混淆 iOS 应用程序，我们必须从发布应用程序的苹果开发者帐户中获取一些信息。

首先，我们必须得到一个“**签名证书名**

### [](#41-check-the-installed-signing-certificate)4.1 检查已安装的签名证书
...
### [](#42-how-to-get-a-valid-signing-certificate)4.2 如何获取有效的签名证书？

前往苹果开发者账户上的“[证书、标识符&档案](https://developer.apple.com/account/resources/certificates/list)”。

单击“+”图标创建新证书。
[![](../Images/73dcf4e56971e0b07f8c988147f6f434.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--0BOO4I5M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xl593gr6f377rywtw9yt.jpg)

选择“iOS 应用程序开发”,因为您想要混淆 iOS 应用程序。

点击“继续”按钮。
[![](../Images/4fa24593c848fbbd57972e574a4955ae.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--0VgZHGYN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vv1mq91nez0ue5q2t208.jpg)
...
6.  选取“存储到磁盘”，然后点按“继续”。
    [![](../Images/9ac4a0e1b542d4c4f14e43f22ef39083.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--2x6oHhwc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rpnl439sf15iectip7af.png)

上传您刚刚创建的证书签名请求，然后单击“继续”。然后，您可以下载您的证书，并双击它将其添加到您的钥匙串中。
[![](../Images/86381c9bd9fd1b8aa93fd550ed5c1edc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SBqCuSF0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ivo4ty5g1ztmywnj5jjf.jpg)
...
## [](#5-install-and-configure-dexprotector-on-ios)5。在 iOS 上安装和配置 Dexprotector

### [](#51-retrieve-dexprotector-packages)5.1 检索 Dexprotector 包
...
### [](#52-install-the-packages)5.2 安装包
...
[![](../Images/082c1593de95d836304ea7d9890ab8d5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RGiGERK2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gee0qt0w9lsiiomy5i87.jpg)

[![](../Images/68d0dd576af02106703a1588cfb12c2f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1F6UTvp7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o06jlv3fi5m955hnx13x.jpg)

### [](#53-configure-java-environment)5.3 配置 Java 环境
...
### [](#6-script-to-automate-it)6。脚本来实现自动化

为了实现这一切的自动化，我创建了一个脚本，您可以使用它一次性完成所有这些工作。

可在 Github 上获得

## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png)[【shosta】](https://github.com/Shosta)/[【右旋保护自动化】](https://github.com/Shosta/DexprotectorAutomation)
...
下面是脚本在一个终端上执行的结果:
[![](../Images/a626bfa19df3736d93591358f89d7d71.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7hLM6SDK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7ydoryu67cfsu9su9wxx.jpg)
