...
> 原文：<https://dev.to/bnevilleoneill/node-js-12-the-future-of-server-side-javascript-3gma>

[![](img/a293478b8f39a9775dc887c7194f4961.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--TjUTkdjs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/38cvnp62cmlglakb9quc.png)

## 简介

自从 2009 年第一次发布以来，Node.js 已经成为一项改变游戏规则的技术。简而言之，它允许开发人员使用 JavaScript 在服务器端运行脚本，在页面被发送到用户的 web 浏览器之前生成动态 web 内容。因此，Node.js 代表了一种“JavaScript 无处不在”的范式，围绕一种编程语言统一了 web 应用程序开发，而不需要服务器端和客户端脚本使用不同的语言。
...
从低级的改进中退一步，对于节点生态系统中的开发者和模块制造商来说，也有一些很酷的东西。
...
## ES6 模块支持，差不多了![🙌](img/373e63b309d80d488b9bc2d7a6a430bc.png)
...
随着通过内部改进和 V8 引擎的 C++升级而为 Node.js 带来的新功能，对 Node.js 12 提出了新的最低要求。在 macOS 和 Windows 之外的平台上，代码库现在至少需要 GCC 6 和 glibc 2.17。发布的二进制文件使用这个新的工具链最小值，并包括新的编译时性能和安全性增强。
...
帖子 [Node.js 12:服务器端 JavaScript 的未来](https://blog.logrocket.com/node-js-12/)首先出现在 [LogRocket 博客](https://blog.logrocket.com)上。