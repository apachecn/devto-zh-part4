...
> 原文:[https://dev . to/laurieontech/introducing-object-from entries-1d5l](https://dev.to/laurieontech/introducing-object-fromentries-1d5l)

我一直很喜欢这个系列，因为它给了我真正深入了解这些新特性的机会。

今天，我们来看看`Object.fromEntries`！

# [](#lets-start-with-objectentries)让我们从 Object.entries 开始
...
# [](#enter-objectfromentries)输入 Object.fromEntries
...
# [](#one-thing-to-watch-out-for)要注意的一件事
