...
> 原文:[https://dev . to/itsrainingmani/extending-the-string-prototype-in-JavaScript-typescript-254 a](https://dev.to/itsrainingmani/extending-the-string-prototype-in-javascript-typescript-254a)

## [](#what-is-an-object-prototype)什么是对象原型
...
## [](#extending-the-string-prototype-in-javascript)在 JavaScript 中扩展字符串原型
...
## [](#this-but-in-typescript)这可是在打字稿里
