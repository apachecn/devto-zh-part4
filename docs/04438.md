...
> 原文:[https://dev . to/blakec/install-openwrt-onto-a-TP-link-TL-Mr 3020-router-via-a-serial-port-from-MAC OS-b3i](https://dev.to/blakec/install-openwrt-onto-a-tp-link-tl-mr3020-router-via-a-serial-port-from-macos-b3i)
...
## [](#step-1-prepare-the-environment)步骤 1 -准备环境

### [](#configure-a-static-ip-on-your-ethernet-interface)在以太网接口上配置一个静态 IP
...
[![macOS manual IPv4 address configuration on Ethernet](img/632041b8f91e9b885570aeca7b0ed4b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5lIlKUGO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jaeq2ivo1u9h6i2fxzsm.png)
...
[![Configuring a static IP on macOS](img/14497fb9bd988385116d059078109a15.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KPxIH-f---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9qb4c06la042omxoh0hl.png)

### [](#download-the-openwrt-firmware)下载 OpenWrt 固件
...
### [](#configure-the-tftp-server)配置 TFTP 服务器
...
## [](#step-2-open-the-device)第二步-打开设备

稍微撬一下，路由器的顶部就会脱落。插入塑料工具，小心撬开塑料顶盖。

[![Prying open the top of a TP-Link TL-MR3020 with a screwdriver](img/7088811537c54b88ce2c619c69dcb86b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2irkQz_u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ywgafjvh0scax1nkqmx5.jpg)

## [](#step-3-connect-the-usb-adapter-to-the-uart-pins-on-the-router)步骤 3 -将 USB 适配器连接到路由器上的 UART 引脚

将 USB 适配器插入电脑。

接下来，将 UART 适配器的发送、接收和接地线连接到路由器上的相关引脚，这些引脚在下图中 RAM 的正下方突出显示。

[![TL-MR3020 UART pin location](img/f62169b1f7ee0236b5fd724ce64f066e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DXo7g5c1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/551qgtguwihf3xemvc6c.jpg)
...
[![Jumper connections to UART connections on TL-MR3020](img/5d305110a0e9e2f3fb22f37a4cc5e414.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tMnzqdiU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0hrg04yhuz029w6p03h5.jpg)

## [](#step-4-connect-the-ethernet-cable-to-the-router)步骤 4 -将以太网电缆连接到路由器

在您的计算机和路由器的以太网端口之间连接以太网电缆。

## [](#step-5-initiate-a-console-connection-to-the-router)步骤 5 -启动与路由器的控制台连接
...
## [](#step-6-power-on-the-router)步骤 6 -打开路由器电源
...
## [](#step-7-download-the-firmware-onto-the-router)步骤 7 -将固件下载到路由器上
...
## [](#step-8-install-the-firmware-onto-the-routers-flash-memory)步骤 8 -将固件安装到路由器的闪存中
...
## [](#step-9-boot-the-openwrt-os)步骤 9 -启动 OpenWrt 操作系统
