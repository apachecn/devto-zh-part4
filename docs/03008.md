...
> 原文:[https://dev . to/apex 95/fuzzing-tessera CT-cloud-vision-generating-ocr-proof-images-210 l](https://dev.to/apex95/fuzzing-tesseract-cloud-vision-generating-ocr-proof-images-210l)
...
### [](#2-binarization)2。二值化

[![Result of the binarization procedure, using an adaptive threshold](img/cb30145a148cce5e0fc2167c3b9b86f2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NO17VPhA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://codingvision.net/imgs/posts/evaluating-the-robustness-of-ocr-systems/binarization.png)
...
### [](#3-adaptive-classification)3。适应性分类

[![Tesseract's adaptive classifier incorrectly recognizes an 'h' as a 'b', in the first image. In the second sample, Tesseract observes a correct 'h' character (confidence is larger than a threshold) adjusts the classifier's configuration and correctly classifies the first 'h'](img/12be8c21dc56fedd8007c09c2e8f4880.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lhxycglD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://codingvision.net/imgs/posts/evaluating-the-robustness-of-ocr-systems/adaptive-classifier.png)
...
[![Applying noise in an image usually decreases readability, which is not what we want here](img/a6b11bfc8d767c8e3951eb53bf459f70.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---I7UC78h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://codingvision.net/imgs/posts/evaluating-the-robustness-of-ocr-systems/noise-readability.png)

### [](#5-dictionaries)5。字典

OCR 系统将尝试通过使用带有预定义单词的词典来提高其准确性。在这种情况下，改变单词中的单个字符(即:增量方法)可能无效。

## [](#targeted-ocr-systems)有针对性的 OCR 系统

[![Tested locally on Tesseract 4.0 and remotely on Google's Cloud Vision OCR](img/fecd9bd26d866a7e4cd4e0db7343cc07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W5lp5sN9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://codingvision.net/imgs/posts/evaluating-the-robustness-of-ocr-systems/tesseract-gocr.png)
...
[![Different working modes for small and large characters, in order to preserve readability. Both managed to entirely hide the given text when tested on Tesseract 4.0](img/afe95f30a821044f10f1ba55b1df1049.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CWftqyjE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://codingvision.net/imgs/posts/evaluating-the-robustness-of-ocr-systems/modes.png)
...
[![Possible loop in the recognition process: the same text gets recognized multiple times. The bottom-left and the top-right corners are 'merged' into an oblique text row so the recognition process is sent back to already processed text](img/7110c56bdddb3c225e2664fe5610e6cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z1p1CJmX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://codingvision.net/imgs/posts/evaluating-the-robustness-of-ocr-systems/cloud_ocr_bug.png)
