...
> 原文:[https://dev . to/Raphael _ jamba los/deploy-rails-in-Amazon-ECS-part-5-integrate-sidekiq-and-redis-for-background-processing-150 f](https://dev.to/raphael_jambalos/deploy-rails-in-amazon-ecs-part-5-integrate-sidekiq-and-redis-for-background-processing-150f)
...
# [](#13-creating-a-task-definition-for-sidekiq)13 |为 Sidekiq 创建任务定义
...
# [](#14-creating-a-sidekiq-ecs-service)14 |创建 Sidekiq ECS 服务
...
# [](#15-start-an-ec2-instance-for-redis)15 |为 Redis 启动 EC2 实例
...
[![Alt Text](img/bbfa4bdd0733f302b1efcf234324647b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mHGK4pqT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y4ba9n5dxbvk86htrc2r.png)
...
[![Alt Text](img/daadf4b5cf459641836dced890b74582.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yMiOGbRp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/prb5dygq3kwzjjoizh0g.png)
...
[![Alt Text](img/51aa02c587e37914141203e9d85c0810.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8eVSiJz---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hjvigm9grys4zuha9o3i.png)
...
[![Alt Text](img/df4b779596ec39796b9e38c2ddfecb59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aHMW8R5g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a9ac3ciqwl5k2kh2akji.png)

# [](#16-revising-task-definition)16 |修改任务定义
...
[![Alt Text](img/252b5221bc33be29bef2a0f2d0bd3a41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VJzqIx7A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yi9sl7qneh8m5xufqpp8.png)
...
# [](#17-updating-the-service)17 |更新服务

现在，我们已经为 web 和 Sidekiq 更新了任务定义，是时候部署了！

**(17.1)** 点击*简单红宝石 app* 服务。在该页面上，单击“更新”

[![Alt Text](img/ff95b1c642b4d36d78c1d69f8fe676c4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RMvuBg5V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/me6w11x7c2dv4yx7ukgv.png)

**(17.2)** 选择该服务的任务定义的最新版本。然后勾选“Force New Deployment”以确保这个新版本立即得到部署。

[![Alt Text](img/0182d931dd2ca2a1e325afcc21b1f5aa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CH698rBp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uo8k2h7frhggrk5it1ai.png)

**(17.3)** 在这里监控你的部署。您的更改需要几分钟才能生效。您应该可以在这里看到您的新版本是否已经部署。如果`PRIMARY`的运行计数为 1+,则您的应用已经部署

[![Alt Text](img/04b1de00d0cb1a60ec9ebba7ca4e3a2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SyzMZPJY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jr0py7yt65as48ocp5hl.png)
...
[![Alt Text](img/e2fbe627f7dc49ca359b2ca540140385.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AD8yIFG4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nvdbss0ifctwlfol1uda.png)
