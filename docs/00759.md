...
> 原文:[https://dev . to/radix DLT/Java-client-library-general-use-code-examples-1986](https://dev.to/radixdlt/java-client-library-general-use-code-examples-1986)
...
# [](#initializing-the-application-api)初始化应用程序 API
