...
> 原文:[https://dev . to/softchris/hooks-for-react-js-the-new-ketchup-38p](https://dev.to/softchris/hooks-for-react-js-the-new-ketchup-38p)

[![alt text](../Images/888123d2a590ad9ee7546a7b1427c252.png "Hooks article")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HyaKLjhR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kmy6h6706sin3knkj9li.png)
...
## [](#problems-hooks-are-trying-to%C2%A0address)钩子试图解决的问题
...
## [](#the-selling-point-of%C2%A0hooks)挂钩的卖点
...
## [](#a-second-hook-example%E2%80%8A%E2%80%8Ausing-a%C2%A0cart)第二个挂钩例子——使用手推车
...
## [](#introducing-the-effect%C2%A0hook)引入效果挂钩
...
[![alt text](../Images/3351cc3563a7e2bdda2d4992b29e71ae.png "Effect demonstration, aha moment")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IS7lTg0n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f7pr7hvwphy73fabwy40.gif)
...
### [](#accessing-the-dom%C2%A0tree)访问 DOM 树
...
### [](#handling-set-up-tear%C2%A0down)搬运设置/拆除
...
## [](#can-i-create-my-own%C2%A0hook)可以自己创建钩子吗？
...
### [](#creating-an-admin-page-for-our-feature%C2%A0flag)为我们的功能标志创建一个管理页面
