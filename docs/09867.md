...
> 原文:[https://dev . to/lampewebdev/the-guide-to-visual-studio-code-shortcut s-higher-productivity-and-30-of-my-favorite-shortcut s-you-need-to-learn-mb3](https://dev.to/lampewebdev/the-guide-to-visual-studio-code-shortcuts-higher-productivity-and-30-of-my-favourite-shortcuts-you-need-to-learn-mb3)
...
[![hands typing quickly on a keyboard](../Images/7e6ae7c5ada4f0ac6077f6fe33d1cdb3.png)T2】](https://i.giphy.com/media/eMxZ6lPl8dW9O/giphy.gif)

# [](#shortcut-cheat-sheets)快捷备忘单
...
# [](#keyboard-shortcuts-settings-json)键盘快捷键设置(JSON)
...
[![Keyboard Shortcut Settings GUI](../Images/015805d3abda51509212bdf593a9dba7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_8rtHdyE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3etyosi4ljtp1d9lvk5i.png)
...
## [](#key-bindings-json-file)键绑定 JSON 文件
...
## [](#focus-the-integrated-terminal)聚焦综合终端
...
## [](#search-for-a-file-in-your-project)搜索项目中的文件
...
## [](#switch-to-a-recent-open-workspace)切换到最近打开的工作区
...
## [](#split-your-editor-window)拆分你的编辑窗口
...
## [](#close-your-current-editor-window)关闭当前编辑窗口
...
## [](#close-only-the-saved-editor-windows)仅关闭已保存的编辑窗口
...
## [](#change-the-language-of-your-current-file)更改当前文件的语言
...
## [](#moving-a-line-up-or-down)上下移动一行。
...
## [](#comment-out-the-current-selection)注释掉当前选择
...
## [](#select-multiple-lines-of-code)选择多行代码
...
## [](#fold-and-unfold-your-code)折叠和展开您的代码
