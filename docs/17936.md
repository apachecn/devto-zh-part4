...
#### [](#using-a-normal-raw-if-endraw-)Using a Normal `if`
...
#### [](#switching-only-content-using-ternaries)Switching Only Content Using Ternaries
...
#### [](#switching-elements-tree-using-ternaries)Switching Elements Tree Using Ternaries
...
##### [](#using-an-implicit-null)Using an Implicit Null
