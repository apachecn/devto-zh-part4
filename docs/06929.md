...
> 原文:[https://dev . to/nikvdp/how-to-easy-clone-a-Linux-installation-to-another-machine-2pbl](https://dev.to/nikvdp/how-to-easily-clone-a-linux-installation-to-another-machine-2pbl)
...
# [](#step-1-bind-mount-the-root-filesystem)步骤 1:绑定挂载根文件系统
...
# [](#step-2-raw-tar-endraw-up-the-source-file-system)第二步:`tar`启动源文件系统
...
# [](#step-3-on-the-dest-machine-boot-from-a-livecd)步骤 3:在 dest 机器上从 live-cd 引导
...
# [](#step-4-partition-the-drive-on-the-destination-machine)第四步:对目标机器上的驱动器进行分区
...
[![gparted](../Images/9a4a73d61b78b0a2a36ee5c5388caaae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C9Fcwr7r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yovh4hv1ddxw9tbmyppg.png)
...
[![partitions](../Images/9afc7a5e7e0a1a0cb6f98a18ee41aae7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qMMVuwRl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s487gwrc0gqgp0rj44cv.png)
...
# [](#step-5-mount-the-destination-filesystem)步骤 5:挂载目标文件系统
...
# [](#step-6-use-raw-tar-endraw-to-extract-your-image-to-the-destination-filesystem)第 6 步:使用`tar`将您的映像解压到目标文件系统
...
# [](#step-7-raw-chroot-endraw-into-the-newly-extracted-filesystem-to-install-a-bootloader)第七步:`chroot`进入新解压的文件系统安装 bootloader
...
# [](#step-8-run-raw-grubinstall-endraw-from-inside-the-chroot)第 8 步:从 chroot 内部运行`grub-install`
