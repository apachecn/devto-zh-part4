...
> 原文:[https://dev . to/heroku/12-factor-apps-a-retrospect-and-look-forward-4j4f](https://dev.to/heroku/twelve-factor-apps-a-retrospective-and-look-forward-4j4f)
...
## [](#creation-of-twelvefactor-apps)十二要素应用的创建
...
## [](#how-the-twelvefactor-app-changed-application-development-and-devops)十二要素应用如何改变应用开发和开发运营
...
## [](#just-as-important-today-as-seven-years-ago)今天和七年前一样重要
