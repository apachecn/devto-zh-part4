...
> 原文:[https://dev . to/data form/how-to-write-unit-tests-for-your-SQL-queries-2hd 7](https://dev.to/dataform/how-to-write-unit-tests-for-your-sql-queries-2hd7)
...
### [](#the-benefits-of-unit-tests)单元测试的好处
...
### [](#why-isnt-sql-unit-testing-widespread)为什么 SQL 单元测试不普遍？
...
### [](#test-case-support-in-dataform)测试用例以数据形式支持
