...
> 原文:[https://dev . to/Martinez peck/recogniting-objects-in-images with-tensor flow-and-small talk-1 nep](https://dev.to/martinezpeck/recognizing-objects-in-images-with-tensorflow-and-smalltalk-1nep)

在这篇文章中，我将使用 Smalltalk 的 TensorFlow 库展示一个简单的图像对象识别示例。

### [](#doing-machine-learning-without-python-with-smalltalk-seriously)不用 Python 做机器学习？用 Smalltalk？真的吗？
...
#### [](#single-image-inception-v3)单幅图像——盗梦空间 V3

第一个示例使用此图像运行:

[![](../Images/732cf10f5a4fec6fd6e499e02da4be4d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VwWKNgkB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/github.com/vasmalltalk/tensorflow-vast/raw/master/examples/labelImage/grace_hopper.jpg%3Fresize%3D183%252C215%26ssl%3D1)
...
#### [](#single-image-mobilenet-v1)单一图像–V1 移动网络
...
#### [](#multi-image-inception-v3)多画面——盗梦空间 V3
...
[![](../Images/1954d660d599ebd0c67ab73aa9bb88e5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4DExVt6x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/marianopeck.wpcomstaging.com/wp-content/uploads/2019/08/Screen-Shot-2019-08-06-at-3.48.58-PM.png%3Ffit%3D748%252C454%26ssl%3D1)
...
### [](#now-imagine-tensorflow-smalltalk-arm-gpu)现在想象一下… TensorFlow + Smalltalk + ARM + GPU
