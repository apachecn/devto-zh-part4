...
> 原文:[https://dev . to/elec web/remove-outline-when-click-but-keep-it-when-tab-in-react-3fe 5](https://dev.to/elecweb/remove-outline-when-click-but-keep-it-when-tab-in-react-3fe5)
