...
> 原文:[https://dev . to/Dai _ Shi/react-hooks-oriented-redux-coding-pattern-without-thunks-and-action-creators-1 ngg](https://dev.to/dai_shi/react-hooks-oriented-redux-coding-pattern-without-thunks-and-action-creators-1ngg)

##### [](#with-typescript)同打字稿
...
#### [](#srcstoreactionsts)src/store/actions.ts
...
#### [](#srcstorereducersts)src/store/reducers.ts
...
#### [](#srccomponentsapptsx)src/components/App.tsx
