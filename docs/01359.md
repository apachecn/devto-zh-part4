...
> 原文:[https://dev . to/bnevilleoneill/testing-react-applications-in-2019-51c](https://dev.to/bnevilleoneill/testing-react-applications-in-2019-51c)
...
## [](#general-testing-concept)一般测试概念
...
## [](#javascript-testing-frameworks)JavaScript 测试框架
...
## [](#testing-react-applications)测试 React 应用程序

有许多方法可以测试 React 应用程序。我们将会看到其中的一些。

### [](#unit-testing-react-components)单元测试 React 组件
...
## [](#a-recommended-testing-tool)推荐的测试工具

### [](#reacttestinglibrary)反应-测试-库
