...
> 原文:[https://dev.to/tomerbendavid/startup-primer-2on5](https://dev.to/tomerbendavid/startup-primer-2on5)

# [](#startup-primer)启动引物

## [](#run-jekyll-with-docker)用 docker 运行 jekyll
...
## [](#licsening-software)李森宁软件

1.  [keygen.sh](https://keygen.sh/)

## [](#marketing-and-bootstraping-startup)营销和引导创业
