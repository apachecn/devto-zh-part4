...
> 原文:[https://dev . to/ricardourwer/SVG-icons-in-elixir-and-phoenix-1hi 4](https://dev.to/ricardoruwer/svg-icons-in-elixir-and-phoenix-1hi4)
...
现在让我们在文件`assets/static/images/icons.svg` :
中创建我们的图标
