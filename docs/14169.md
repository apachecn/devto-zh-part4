...
> 原文:[https://dev.to/deepu105/my-reflections-on-golang-38jk](https://dev.to/deepu105/my-reflections-on-golang-38jk)

*最初发布于[deepu . tech](https://deepu.tech/reflection-on-golang/)T3。*

我喜欢 [Go](https://golang.org/) 吗？是的。我会把它用在我所有的用例中吗？肯定不是。

> ![𝔻𝕖𝕖𝕡𝕦 𝕂 𝕊𝕒𝕤𝕚𝕕𝕙𝕒𝕣𝕒𝕟 profile image](../Images/25ea17c00ba085dc6f0080bf1b2bce1a.png)[@ deep u105](https://dev.to/deepu105)![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)@ siddhantaratah[@ Bruno Borges](https://twitter.com/brunoborges)在研究过这些语言的大部分之后，我不会为了一般目的而选择 Go，至少不是当前版本的 Go，可能 2.0 更有潜力。2019 年 03 月 07 日上午 06:41[![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)](https://twitter.com/intent/tweet?in_reply_to=1103546225851277313)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=1103546225851277313)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=1103546225851277313)
...
### [](#language-provided-code-style-and-vetting)语言提供代码样式和审核
...
### [](#goroutines-amp-channels)Goroutines &频道
...
### [](#type-assertion-and-switches)类型断言和开关
...
> ![unknown tweet media content](../Images/ad723512ff1f041abf3ca6eac84315b4.png)![𝔻𝕖𝕖𝕡𝕦 𝕂 𝕊𝕒𝕤𝕚𝕕𝕙𝕒𝕣𝕒𝕟 profile image](../Images/25ea17c00ba085dc6f0080bf1b2bce1a.png)[【deep u105】](https://dev.to/deepu105)![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)vs code 中的代码内测试覆盖率高亮显示为 [@golang](https://twitter.com/golang) 华而不实。这是确保您拥有良好覆盖率的最佳方式
> [@ code](https://twitter.com/code)2019 年 2 月 14 日上午 10:24[![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)](https://twitter.com/intent/tweet?in_reply_to=1095992144152748033)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=1095992144152748033)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=1095992144152748033)
...
[![](../Images/94a503f2b02842e41f7429f6ba3871b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--r0aO2iN4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/chcyfvlj52k6xgrg5adg.png)

### [](#doesnt-need-a-runtime)不需要运行时

Go 不需要 JVM 或 NodeJS 这样的运行时，Go 应用可以使用[标准 Go 工具](https://golang.org/pkg/go/build/)编译成可执行的跨平台二进制。这使得 Go 应用程序具有可移植性和平台独立性。

## [](#what-i-dont-like-about-go)我不喜欢围棋的什么
...
### [](#too-much-boilerplatenot-suitable-for-dry)样板文件太多(不适合干)
...
### [](#confusing-pointer-behaviors)令人困惑的指针行为
...
### [](#weird-interface-construct)怪异的界面构造
...
[![pauljlucas](../Images/b970f916c82d0101f366effb7eac1b4c.png)](/pauljlucas) [## 当零的时候！=零

### 保罗 j 卢卡斯 5 月 28 日 187 分钟阅读

#go #pitfall](/pauljlucas/go-tcha-when-nil--nil-hic)

### [](#single-gc-algorithm)单 GC 算法
...
### [](#so-where-would-i-use-go)那么我会在哪里使用 Go 呢？
...
### [](#where-i-wouldnt-use-go)我哪里不会用围棋？
