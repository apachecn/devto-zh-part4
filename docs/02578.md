...
> 原文:[https://dev . to/mustafaanaskh 99/react-state-for-dummies-how-that-before-react-fp3](https://dev.to/mustafaanaskh99/react-state-for-dummies-how-was-it-before-react-fp3)
...
## [](#lets-do-it-the-jquery-way)用 jQuery 的方式吧！
...
## [](#saving-the-input-in-the-localstorage)将输入保存在本地存储器中
...
## [](#reading-data-and-displaying-them)读取数据并显示
...
## [](#efficiency-in-displaying-newly-created-data)显示新创建数据的效率
