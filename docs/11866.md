...
> 原文:[https://dev . to/dzhavat/quick-switching-between-branch-4h8m](https://dev.to/dzhavat/quickly-switching-between-branches-4h8m)
...
[![dzhavat](../Images/f3a50c17296423d037e4a3e2cb68a7bf.png)](/dzhavat) [## 使用 git checkout 提高工作效率
