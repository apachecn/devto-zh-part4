...
> 原文:[https://dev . to/Mike born/storing-and-using-datetime offsets-in-lucee-M8](https://dev.to/mikeborn/storing-and-using-datetimeoffsets-in-lucee-m8)
...
## [](#problem-one-utc-offset-truncation)问题一:UTC 偏移量截断
...
## [](#problem-two-datetimeoffset-retrieved-as-java-object)问题二:DateTimeOffset 作为 Java 对象检索
...
[![image of SQL query: "Select getutcdate() at time zone 'Central Standard Time' rendering as java object](../Images/85ebc937f97c4eae82b2ff3cd1807200.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EnCHASdG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wvwy9y3xlbno2pixrstd.png)
...
## [](#formatting-dates-in-iso-8601-format)用 ISO 8601 格式格式化日期
