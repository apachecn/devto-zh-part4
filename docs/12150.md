...
> 原文:[https://dev . to/dev cord/react-hooks-use effect-use callback-use memo-3o 42](https://dev.to/devcord/react-hooks-useeffect-usecallback-usememo-3o42)
...
# [](#examples-of-useeffect)使用效果的例子

### [](#updating-the-page-title)更新页面标题
...
### [](#fetching-data-from-an-api-into-local-state)从一个 API 取数据到本地状态。
...
### [](#fetching-data-from-an-api-into-local-state-based-on-a-query)根据查询从 API 获取数据到本地状态。
...
### [](#dispatching-a-redux-action)调度一个 Redux 动作。
...
### [](#example-of-usecallback)使用回调的例子
