...
> 原文:[https://dev . to/jillesvangurp/using-cloudfront-S3-and-route-53-for-hosting-395 o](https://dev.to/jillesvangurp/using-cloudfront-s3-and-route-53-for-hosting-395o)
...
## [](#url-rewrites-using-s3)Url 使用 S3 重写
...
## [](#cors-header-for-our-stellartoml)CORS 头球攻门
