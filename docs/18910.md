...
> 原文:[https://dev . to/milandhar/the-benefits-of-pair-programming-470h](https://dev.to/milandhar/the-benefits-of-pair-programming-470h)
...
[![Office Space Gif](../Images/0be72c7773885a170d69aebb127dd775.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3hWAtgMt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thumbs.gfycat.com/EntireDistantFlyingfish-size_restricted.gif)
...
## [](#economics-of-pair-programming)结对编程的经济学

在犹他大学的一项研究中，没有接触过结对编程的学生被分配成对完成三项任务，1/3 的学生作为对照组独自完成。从下图中可以看出，在第一个项目所示的调整期之后，结对的学生只比单独的学生多花了大约 15%的时间。

[![time comparison graph](../Images/c08f79467fa59d490c7a03f92f8b22a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AoCtQN3f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2ADUS6MPMwq_7cS8PMUQF35Q.png)

抵消了花在结对编程上增加的工时，结对产生的代码比单独开发的代码缺陷少 15%(见下图)。由于解决一个 bug 平均需要 4 到 16 个小时，结对编程减少 bug 的好处将超过大多数项目中额外的工时成本。

[![defects comparison graph](../Images/8197658260d8fd14cf42ac8e8874bc0b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0HzTI15g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ai2-s2-public.s3.amazonaws.com/figures/2017-08-08/731a6c7310be8ed0f8f281850b0b8322014a643a/2-Figure2-1.png)
...
[![satisfaction comparison graph](../Images/e8e394c8f894ae0baf2201bc04c4dc9b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h__kHbLd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.researchgate.net/profile/Alistair_Cockburn/publication/2333697/figure/fig1/AS:334438278942720%401456747707636/Pair-Enjoyment-A-programmer-comments-It-is-psychologically-soothing-to-be-sure-that.png)

## [](#design-quality)设计质量

结对编程的另一个效果是提高了最终程序的设计质量。在犹他大学的研究中，成对的程序员比单独的程序员完成了更高质量的项目，并且用更少的代码实现了与单独的程序员相同的功能。

[![design comparison graph](../Images/61a720477dbbf6d896ced97750819f66.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aGpoCNwe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AOmZRbGuLp0DOYwIpcggI2Q.png)

# [](#styles-of-pair-programming)结对编程的风格

有几种风格的结对编程适合不同的场景和队友之间的经验水平。

## [](#drivernavigator)驾驶员-导航仪
...
#### [](#sources-i-referenced-in-this-post)我在这篇文章中引用的来源:
