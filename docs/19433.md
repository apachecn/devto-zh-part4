...
> 原文:[https://dev . to/abid MIT/difference-between-command-and-declarative-code-226 o](https://dev.to/abidemit/difference-between-imperative-and-declarative-code-226o)

## [](#definition-and-code-example)定义和代码示例:
