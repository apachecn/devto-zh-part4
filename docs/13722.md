...
> 原文:[https://dev . to/contacts hadab/understanding-var-let-and-const-in-JavaScript-54fc](https://dev.to/contactshadab/understanding-var-let-and-const-in-javascript-54fc)
...
## [](#-raw-var-endraw-keyword)`var`关键词
...
#### [](#local-scope-function-scope)局部作用域(函数作用域)
...
### [](#issues-with-raw-var-endraw-)与`var`的问题
