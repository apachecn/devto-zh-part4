...
> 原文:[https://dev . to/Uriel _ hedz/caching-Ajax-request-with-session storage-1638](https://dev.to/uriel_hedz/caching-ajax-request-with-sessionstorage-1638)
...
## [](#using-sessionstorage)使用 SessionStorage
