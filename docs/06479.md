...
> 原文:[https://dev . to/heratpatel/git-flow-a-successful-git-branching-model-1j6f](https://dev.to/heratpatel/git-flow-a-successful-git-branching-model-1j6f)
...
[![Feature brach workflow](../Images/3f5aec0d6dbf6eb2daa8dd25b0905975.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--80ZOUids--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gk3yk0u24k5849fplyy2.png)

#### [](#creating-a-feature-branch)创建特征分支

*   运行`git flow feature start <<FEATURE_NAME>>`。
*   例如`git flow feature start authentication`，其创建分支**特征/认证**。
*   进行与该功能相关的更改，并将其推至原点。

#### [](#finishing-a-feature-branch)整理一个特征分支

*   运行`git flow feature finish <<FEATURE_NAME>>`。
*   例如`git flow feature finish authentication`，将**特征/认证**分支合并为**开发**分支，**将**本身从**本地**和**原点**中删除。

#### [](#summary-actions)汇总动作
...
[![Release branch workflow](../Images/85c7ad951baba82a066694581f310b46.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--A57dbxFl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pyeszwkiezdk5owzq2tq.png)

#### [](#creating-a-release-branch)创建发布分支

*   运行`git flow release start <<VERSION_NUMBER>>`。
*   例如`git flow release start 0.0.1`，创建分支 **release/0.0.1** 。
*   进行与发布相关的更改，并将其推至原点。

#### [](#finishing-a-release-branch)整理一个发布分支
...
[![Hotfix branch workflow](../Images/46cf552c567097e0e19069a96203bfae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hFtoPgwf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wo935eqxtakkfylqzn7y.png)

#### [](#creating-a-hotfix-branch)创建热修复分支
