...
> 原文:[https://dev . to/edemagbenyo/nodejs-authentic ation-with-cookies-and-session-part-2-2752](https://dev.to/edemagbenyo/nodejs-authentication-with-cookies-and-session-part-2-2752)
...
## [](#about-cookies-and-session)关于 Cookies 和会话
...
### [](#authentication-with-cookie-parser)用 cookie 解析器认证
...
### [](#authentication-with-session)会话认证
