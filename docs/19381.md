...
> 原文:[https://dev . to/arielgueta/keeping-browser-tabs-in-sync-using-local storage-angular-akita-p39](https://dev.to/arielgueta/keeping-browser-tabs-in-sync-using-localstorage-angular-akita-p39)

在这篇文章中，我们将学习当用户打开多个标签页时，如何保持应用程序状态的同步。我们将通过使用 Web 存储 API 和 Akita 来实现这一点。需要基本的秋田知识。

## [](#create-contacts-page)创建联系人页面
