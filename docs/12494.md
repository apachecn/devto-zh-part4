...
> 原文:[https://dev . to/pauld/deploy-ror-on-gae-and-code ship-ci-CD-pipeline-21k 4](https://dev.to/pauld/deploy-ror-on-gae-and-codeship-ci-cd-pipeline-21k4)

## [](#a-continuous-integration-and-continuous-deployment-to-google-app-engine-with-ruby-on-rails)与 Ruby on Rails 持续集成并持续部署到 Google App Engine
...
## [](#now-moving-on-to-cloudbees-codeship)现在转到 CloudBees CODESHIP
...
## [](#cloudbuildyaml-which-is-doing-to-build-the-docker-and-push-to-gae)CloudBuild.yaml 正在构建 docker 并推送到 GAE
...
这里的文件结构是
[![FileStructure](../Images/4291cb2f134a7d621250da3ef3d9ee76.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--sWnqu0yh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gn19nidi9qj3qlwl0p45.png)