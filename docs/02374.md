...
> 原文:[https://dev . to/rob Marshall/Gatsby-with-WordPress-caching-downloaded-media-images-to-reduce-build-time-1d2m](https://dev.to/robmarshall/gatsby-with-wordpress-caching-downloaded-media-images-to-reduce-build-time-1d2m)
