...
> 原文:[https://dev . to/evil Marshall/left hook-crystal ball-and-git-magic-for-smooth-development-experience-33mc](https://dev.to/evilmartians/lefthook-crystalball-and-git-magic-for-smooth-development-experience-33mc)
...
## [](#setting-up-lefthook)设置左勾手

Lefthook 是我们自己用 Go 编写的 git hook 管理器。单一独立二进制。快速、可靠、功能丰富、语言无关。

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [阿克维德](https://github.com/Arkweid) / [左勾拳](https://github.com/Arkweid/lefthook)

### 快速和强大的 Git 挂钩管理器，适用于任何类型的项目。

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Build Status](../Images/098cd5a723d83d87bd365ca8153a3383.png)T2】](https://camo.githubusercontent.com/ef6d3c7ccef1a40874c10f8a85b08b58639da288/68747470733a2f2f6170692e7472617669732d63692e6f72672f41726b776569642f6c656674686f6f6b2e7376673f6272616e63683d6d6173746572)

# 左钩拳

> 最快的多语言 Git hooks 经理

[![](../Images/4637d2bc81b39ee76f3152cb5bb20995.png "Lefthook logo")T2】](https://raw.githubusercontent.com/Arkweid/lefthook/master/./logo_sign.svg)
...
<g-emoji class="g-emoji" alias="book" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4d6.png">📖</g-emoji> [看了介绍帖](https://evilmartians.com/chronicles/lefthook-knock-your-teams-code-back-into-shape?utm_source=lefthook)
...
[![Sponsored by Evil Martians](../Images/14ebd19001df8446f427d5e629d6a791.png)](https://evilmartians.com/?utm_source=lefthook)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [顶层](https://github.com/toptal) / [水晶球](https://github.com/toptal/crystalball)
...
[![Build Status](../Images/3df9adbefcfafd7b120b58834e197ce8.png)](https://travis-ci.org/toptal/crystalball)[![Maintainability](../Images/a8aff037309af5b3dc833c531ca53a82.png)](https://codeclimate.com/github/toptal/crystalball/maintainability)[![Test Coverage](../Images/fa7656020e8affb6f5fc89d5366475e7.png)](https://codeclimate.com/github/toptal/crystalball/test_coverage)
...
## [](#keeping-crystalball-uptodate)保持 Crystalball 最新
...
## [](#automate-other-routine-tasks)自动化其他常规任务
...
### [](#install-missing-gems-on-a-raw-git-checkout-endraw-)在一个`git checkout`上安装丢失的宝石
...
### [](#automatically-rollback-and-apply-database-migrations)自动回滚并应用数据库迁移
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [恩维克](https://github.com/Envek) / [左勾拳-水晶球-举例](https://github.com/Envek/lefthook-crystalball-example)
...
[![Sponsored by Evil Martians](../Images/14ebd19001df8446f427d5e629d6a791.png)](https://evilmartians.com/) 
