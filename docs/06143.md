...
> 原文:[https://dev . to/dschlauderaff/creating-an-ember-spa-with-auth 0-authentic ation-with-a-rails-API-4pp 0](https://dev.to/dschlauderaff/creating-an-ember-spa-with-auth0-authentication-with-a-rails-api-4pp0)
...
### [](#setup-the-rails-api)设置 Rails api
