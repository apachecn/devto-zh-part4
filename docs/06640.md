...
> 原文:[https://dev . to/olus hola _ k/working-with-rabbit MQ-in-golang-1kmj](https://dev.to/olushola_k/working-with-rabbitmq-in-golang-1kmj)

# [](#introduction)简介

你好。我是奥卢苏拉！我是后端软件工程师。我最近买了 Golang，我对它的功能非常感兴趣，主要是在速度方面。在本文中，我将使用 RabbitMQ 建立一个简单的 Golang 项目。

# [](#what-is-rabbitmq)什么是 RabbitMQ？
...
# [](#golang-workspace-setup)GoLang 工作区设置
...
# [](#rabbitmq-setup-with-docker)用 Docker 设置 RabbitMQ
...
[![RabbitMQ User Interface](../Images/993a1f778cd57180961fab2f8980a10f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ev_pWIe2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1hdsgg31w53u0gzprykv.png)

# [](#connect-and-publish-messages-with-rabbitmq)用 RabbitMQ 连接并发布消息
...
[![Test Queue With Published Data](../Images/aa29aa10b8cb4c10e9497ce962d87239.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Nsv1Me0E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lpmiyaytpu3nwlkvs2h0.png)

# [](#consume-the-message-in-a-queue)消耗队列中的消息
