...
> 原文:[https://dev . to/bnevilleoneill/building-a-design-system-with-grommet-and-story book-1kif](https://dev.to/bnevilleoneill/building-a-design-system-with-grommet-and-storybook-1kif)
...
## [](#what-exactly-is-a-design-system)到底什么是设计系统？
...
## [](#customizing-the-grommet-theme)自定义扣眼主题
...
## [](#deploying-your-documentation-as-a-static-app)将文档部署为静态应用程序
