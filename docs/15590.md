...
> 原文:[https://dev . to/droopytersen/react ify-vanilla-js-libraries-with-hooks-FGD](https://dev.to/droopytersen/reactify-vanilla-js-libraries-with-hooks-fgd)
...
## [](#example-library-shavejs)范例库:Shave.js
...
[![](../Images/7fe3c1db3961332217aff5a52f7373f1.png)T5】](https://res.cloudinary.com/practicaldev/image/fetch/s--tMG9RENg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/de5temujs1pm225nsupa.PNG)

## [](#vanilla-js-usage)普通 JS 用法
...
### [](#overriding-the-dom-element)覆盖 DOM 元素
