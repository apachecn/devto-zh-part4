...
> 原文:[https://dev . to/track js/lessons-learn-from-a-buggy-react-upgrade-438](https://dev.to/trackjs/lessons-learned-from-a-buggy-react-upgrade-438)
...
[![Blank page](img/bf1d8135fcc9e2fc8071f9b9ff57e3be.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/blank-page.png)

这就是我:

[![Me, confused about what went wrong](img/bee610d2ab3205bf8af13a4848b0ad55.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/me1.png)
...
[![Chrome dev-tool. Network tab.](img/456666c64923598bc6100126ab75423c.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/devtools.png)

* * *

### [](#ok-so-lets-do-it)好吧，那就这么办吧……

于是，我点了`F12`。我看到的是同一个空白页。`F12`没反应。然后我点击了鼠标的右键。一样的。所以，我想关闭标签。没什么。我的浏览器卡住了。这就是我:

[![Me, Angry and Frustrated that the browser was stuck.](img/1b34742163924479a981b01f2ff1c259.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/me2.png)

* * *

## [](#tip-2-take-a-break)秘诀二:休息一下
...
[![Rage Room](img/6995c5014e3a4bd799cd62ab7c5048ca.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/rage-room.png)

### [](#ok-so-lets-continue)好了，那我们继续…
...
## [](#bigmegahuge-tip-3-stop-script-execution)(Big-Mega-Huge)提示 3:停止脚本执行
...
[![Chrome dev-tools. Source tab](img/c8fbda6dece5f7f8b332dc5b58b8f9e3.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/devtools2.png)
...
[![Me, declaring victory!](img/0c61ab30beee4f11d75331608aa1eb38.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/me3.png)

* * *

## [](#tip-4-know-your-ecosystem)秘诀 4:了解你的生态系统
...
[![The JS mechanism and the Event Loop](img/e3dcbb29ea18536c9e7f88f13cabe626.png)T2】](///asseimg/blog/2019-09-lessons-learned-from-a-buggy-react-upgrade/ecosystem.png)
...
## [](#tip-5-dont-use-busy-waiting-in-javascript)提示 5:不要在 JavaScript 中使用忙等待
...
## [](#tip-6-make-it-asynchronous)提示 6:让它异步
