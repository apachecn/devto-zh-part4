...
> 原文:[https://dev . to/holi ccl/deploying-mason ite-2-project-with-nginx-and-guni corn-3pnj](https://dev.to/holiccl/deploying-masonite-2-project-with-nginx-and-gunicorn-3pnj)
...
## [](#requirements-used-for-this-guide)用于本指南的要求
...
## [](#installing-your-web-app)安装您的网络应用
...
## [](#install-nginx-amp-gunicorn)安装 nginx & gunicorn
...
# [](#nginx-and-gunicorn-configuration)Nginx 和 Gunicorn 配置
...
还有哒哒！
[![](../Images/57982488c5fe1060850bbdb8cec3a3a9.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--g5AAXFRo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4ppfqdyegqrtkdsezpbn.png)
