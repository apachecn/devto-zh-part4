...
> 原文:[https://dev . to/em nudge/the-hazards-of-passing-CSS-through-js-a-look-into-CSS-transform-and-consistencies-44n 0](https://dev.to/emnudge/the-hazards-of-passing-css-through-js-a-look-into-css-transform-and-inconsistencies-44n0)
...
# [](#manipulating-css-with-js)用 JS 操作 CSS
...
# [](#optional-values-and-css-parsing)可选值和 CSS 解析
...
# [](#solution-01-local-state)解 01 -本地状态
...
# [](#solution-02-css-variables)解 02 - CSS 变量
...
# [](#solution-03-css-typed-object-model)解决方案 03 - CSS 类型化对象模型
