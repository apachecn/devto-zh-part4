...
> 原文:[https://dev . to/mkdev/docker less-part-2-how-to-build-container-image-for-rails-application-without-docker-and-docker file-48e 8](https://dev.to/mkdev/dockerless-part-2-how-to-build-container-image-for-rails-application-without-docker-and-dockerfile-48e8)
...
### [](#what-is-a-container-image)什么是容器图像？
...
### [](#with-buildahfile)同 Buildahfile
...
### [](#you-say-dockerless-but-you-still-rely-on-dockerfile)你说无 docker 却还依赖 Dockerfile！
...
### [](#building-images-with-buildah-directly)直接用 Buildah 构建图像
