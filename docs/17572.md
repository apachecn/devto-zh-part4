...
> 原文:[https://dev . to/uddeshjain/building-first-web-server-with-nodejs-14p 6](https://dev.to/uddeshjain/building-first-web-server-with-nodejs-14p6)
...
# [](#first-web-server-with-node-and-express)第一个 Web 服务器与节点和 express
...
[![See you soon](../Images/de50156989e82684a1f5f5560163cf54.png)T2】](https://i.giphy.com/media/26vUF60UHCAnsXOpy/giphy.gif)