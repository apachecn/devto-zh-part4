...
> 原文:[https://dev.to/scmmishra/javascript-async-and-promises-5coj](https://dev.to/scmmishra/javascript-async-and-promises-5coj)

世界上最容易被误解的编程语言，JavaScript 有很多真正了不起的工程。它本身就是万维网的语言。JavaScript 是为 web 设计的，这意味着它应该是异步的，这通常会给第一次尝试学习这种语言的大多数人带来困惑。

## [](#but-what-the-heck-is-asynchronous)但是异步到底是什么？
...
[![](../Images/dfe0faf2e51fa57526c60a4bbdad3f64.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--RaAPxaED--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sjwy8hp7cyag1jvhpba5.png) 
...
[![](../Images/d2b5978babf27139313e4496e560a053.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E8gi5loc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./images/async/callback-hell.png)

基于回调的代码不可避免地导致开发人员不得不编写几乎不可读甚至某种程度上不可维护的代码。在承诺到来之前，复杂的回调需要对 JavaScript 做任何有用的事情。

## [](#introducing-promises)介绍承诺
