...
> 原文:[https://dev . to/this dot media/build-a-text-editor-in-the-browser-nh9](https://dev.to/thisdotmedia/build-a-text-editor-in-the-browser-nh9)
...
[![FileReader API](../Images/d4254d0bdbd8c11efebcd312f21d0d8d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F-ajGJY8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4ls70t87044ovrmgxxxy.png)

## [](#filereader-in-action)FileReader 在行动
...
### [](#change-the-filereader-output-to-be-of-type-data-url)将 FileReader 输出更改为数据 URL 类型
...
### [](#use-the-data-url-to-provide-a-download-functionality)使用数据 URL 提供下载功能
...
### [](#provide-input-to-the-client-to-update-some-text)向客户端提供输入以更新一些文本
...
### [](#use-the-filereader-to-read-a-file-uploaded-using-an-input-of-type-file)使用文件阅读器读取使用文件类型输入上传的文件
