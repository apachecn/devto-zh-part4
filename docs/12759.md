...
> 原文:[https://dev . to/berndruecker/how-we-build-a-highly-scalable-distributed-state-machine-10hd](https://dev.to/berndruecker/how-we-built-a-highly-scalable-distributed-state-machine-10hd)

#### [](#say-hello-to-cloudnative-workflow-automation%E2%80%8A%E2%80%8Apart-2)向云原生工作流自动化问好—第 2 部分

[![](../Images/7808dac69da83da48ff4b9b686767c1f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vNcNrCMp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/528/1%2AZDy0wSgUZL3rIsAK_j-ZGQ.png)
...
[![](../Images/90500ee30318238583691629404d0a59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HgjX0Hjk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/821/1%2AhUckhSMMQdw-vrIysoFJxw.png)
...
[![](../Images/a8b7b09cc410172b7c5e373f5cf001d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--65RT1UjT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/684/1%2AISoTuuY1qqmX4ch7sFEDcQ.png)
...
[![](../Images/d3f1ba7d4710f4f82139388d1bf59845.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9bFU2CCz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/837/1%2A4LCppmmxDYCaZDNruQUaHg.png)
...
### [](#the-single-writer-principle)单一作家原则
...
#### [](#the-event-handling-loop)事件处理循环
...
[![](../Images/186b056ab3899fdf15f0370ac1614e78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ab3ceGFY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/931/1%2AwW-UR3BIE4uGqknqxpVyrg.png)
...
### [](#stream-processing-and-exporters)流处理和出口商
...
[![](../Images/d8db0aa94ef173885d8788cf54fc5201.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8bLQr_uP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/708/1%2AasS6WoX1wLmQqDjJMyrcdw.png)
...
### [](#peertopeer-clusters)对等集群

为了提供容错和弹性，您运行多个 Zeebe 代理，这些代理形成一个对等集群。我们的设计不需要任何中央组件或协调器，因此不存在单点故障。

[![](../Images/71e33940c1dd0404ed0ad4ec2c2d037b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rTqDTYmR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/422/1%2ATiKv6M45ZZX9PWvE7xmzlA.png)
...
### [](#replication-using-the-raft-consensus-algorithm)复制使用 Raft 一致性算法
...
<figure>[![](../Images/e45e7ef8019ba0063e187d23fc009d61.png)](http://thesecretlivesofdata.com/raft/)
...
[![](../Images/b745bb7b1e0fdd47fda7d076af58feeb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D0hVBX6L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/422/1%2AQxkXQwLt0ad2kTsc5KilWw.png)
...
[![](../Images/44cf8bd4039d85eafe3f197393fdea4b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2zidX2XG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/476/1%2Ax3lT8w4R0p2TN6JYnD9PnQ.png)
...
[![](../Images/490e9fe48d772f0f03e082f4b8e9ea29.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zT3gDqgu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AY-sfHlwof7N_CGTPz2ZKrg.png)

客户端与 Zeebe 网关对话，该网关知道 Zeebe 代理集群拓扑结构，并将请求路由到该请求的正确领导者。这种设计使得在云中或者在 Kubernetes 中运行 Zeebe 变得非常容易，因为只需要从外部访问网关。

### [](#scale-out-by-partitioning)**通过分区进行横向扩展**

到目前为止，我们讨论了让一个线程处理所有工作。如果你想利用多个线程，你必须创建**分区**。每个分区代表一个单独的物理仅附加日志。

[![](../Images/a7339608dcd51eff7e1feef6751742bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1AlATGtD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/851/1%2AnOmrKz8fgHaGUkwmbxhsKA.png)
...
[![](../Images/e7e0ba8d8967763b23f843a9bc487f12.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nN4xI8U1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/541/1%2AXMGTYlDN7LLrJXEA2guaZw.png)
...
[![](../Images/4065f3e69512c6d959c3c58439cb5bb1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YiVUqfoX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/894/1%2AmzNCWpQ7LDuvubwxi2b7Sw.png)
...
[![](../Images/b5b22ed6669f41bd8fbbf73a54a5d78d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a_QnCSHk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/921/1%2ACaNmes4xooO7S4rHseokNg.png)
