...
> 原文:[https://dev.to/thefern/better-commit-messages-3dnm](https://dev.to/thefern/better-commit-messages-3dnm)

## [](#better-commit-messages)更好地提交消息
...
## [](#save-the-template-in-your-home-directory)将模板保存在您的主目录中
...
## [](#activate-template-on-git)在 git 上激活模板
...
## [](#configuring-your-editor)配置你的编辑器
