...
> 原文:[https://dev . to/bnevilleoneill/writing-a-working-chat-server-in-node-1k 42](https://dev.to/bnevilleoneill/writing-a-working-chat-server-in-node-1k42)
...
[![](img/0312a5e69f13220c5ae0f9cb6463dec8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AFwunHKV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blog.logrocket.com/wp-content/uploads/2019/09/owl.jpg%3Fresize%3D610%252C610%26ssl%3D1)

因此，在本文中，我想与您分享一个实际的聊天服务器，请注意，由于媒体的限制，它有点基础，但您将能够从第一天开始使用它。事实上，我已经在我的一个个人项目中使用它了。

## [](#what-does-a-chat-server-do)聊天服务器是做什么的？
...
## [](#defining-the-chat-server)定义聊天服务器
...
## [](#delivering-private-messages)传递私人信息
...
## [](#broadcasting-to-the-entire-room)广播到整个房间
