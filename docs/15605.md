...
> 原文:[https://dev . to/ivanalejandro 0/redux-and-single-purpose-functions-100 I](https://dev.to/ivanalejandro0/redux-and-single-purpose-functions-100i)
...
## [](#single-purpose-functions)单一用途功能
...
## [](#run-some-code)运行一些代码

如果你想看看我们的例子，有更多的测试和几个额外的行动，去[这个报告](https://github.com/ivanalejandro0/test-refactor-redux-reducers)。

或者，由于 CodeSandbox，您可以现场使用它:

[![Edit test-refactor-redux-reducers](../Images/0b3f0135583496627e3621355d8e9248.png)T2】](https://codesandbox.io/s/github/ivanalejandro0/test-refactor-redux-reducers/tree/master/?module=%2Fsrc%2Freducers%2FusersById.test.js&previewwindow=tests)
