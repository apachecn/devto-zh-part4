...
> 原文:[https://dev.to/tlhunter/osgood-and-couchdb-125k](https://dev.to/tlhunter/osgood-and-couchdb-125k)
...
## [](#sample-crud-application)样本积垢应用
...
## [](#application-configuration-raw-appjs-endraw-)应用配置:`app.js`
...
## [](#create-user-worker-raw-createjs-endraw-)创建用户工作者:`create.js`
