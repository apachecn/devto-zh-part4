...
> 原文:[https://dev . to/nileshshanyal/SQL-injection-step-by-step-part-2-6 F8](https://dev.to/nileshsanyal/sql-injection-step-by-step-part-2-6f8)
...
[![Posts Home Page](../Images/0325c2b72fb4a890be64226414514052.png "Posts Home Page")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fjJKQX6q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-EfbaQp3uNMQ/XQJws8cNluI/AAAAAAAAAzY/-JW45ehrar8fBwAppTF_aTy6VRxMZCpVgCLcBGAs/s640/posts_home_page.png)

### [](#creating-the-posts-table)**创建帖子表**
...
[![Posts Table Structure](../Images/8c85b9446463876b05e34248762d3697.png "Posts Table Structure")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---YtMs0ol--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-xpwouCQAb6w/XQJ9MzmITJI/AAAAAAAAAzw/TNMMf-Pmt-4cgnVloCIF-ow4NN8Bm9xkwCLcBGAs/s640/posts_tbl_structure.png)

posts 表的数据如下。

[![Posts Table Data](../Images/3c88c7b8a1f7ad82f9eb4a39036bd810.png "Posts Table Data")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ypfj_AEC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-69rxk-NOvDY/XQJ-K1NJEKI/AAAAAAAAAz8/gf-nC372w-sd_3DRbFvyv2P-IqcRC0eKgCLcBGAs/s640/posts_tbl_data.png)
...
[![First Attempt To Get Number Of Columns](../Images/2b6985494b11470f6fdca87605cfd769.png "First Attempt To Get Number Of Columns")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2hbRV7B6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-TikXiU13wKY/XQR9hTOnr-I/AAAAAAAAA0s/9REmgaPRQiQBPKiqqlJn9mJoEk6Q3Y3dQCLcBGAs/s640/num_of_columns1.png)

最终尝试的屏幕截图如下所示。

[![Final Attempt To Get Number Of Columns](../Images/fd82c5a7ec91306ea2ba4f540b067af0.png "Final Attempt To Get Number Of Columns")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cGA3d_2I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-aWvDgd4O_VU/XQR9viXcMbI/AAAAAAAAA0w/RdJVToOUrDIDfM3pG4zd0gHXd5smO_pfwCLcBGAs/s640/num_of_columns_final.png)

从上面的屏幕截图中，我们看到了错误消息。因此，我们知道，posts 表正好包含 4 列。

让我们**使用**这个信息来获得这个应用程序中使用的数据库的大量信息。

### [](#getting-mysql-database-name)**获取 MySQL 数据库名称**

[![Getting Mysql Database Name](../Images/ae060ae15164f690553663ef7fe470d5.png "Getting Mysql Database Name")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QeJ-UmFQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-Q0meLE5K1Gc/XQR_hLt3pZI/AAAAAAAAA08/VX7aV1JEBaocm6rSD5JgodiaV8RcKzqPgCLcBGAs/s640/get_db_details.png)

### [](#getting-mysql-database-tables)**获取 MySQL 数据库表**

[![Getting Mysql Database Tables](../Images/b511da8487bc49279c2d6cfe9c3c06f6.png "Getting Mysql Database Tables")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yVFfwpvn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-4s8B-CnVNqM/XQSAK3GTwsI/AAAAAAAAA1Q/O61k5J3_vSQ-qCL3DYm2l9w4IirMNbgOQCLcBGAs/s640/list_of_tables.png)

### [](#getting-columns-of-users-table)**获取用户表的列**

[![Getting Columns Of users Table](../Images/33580099e767a2d2bee9ce6b75298067.png "Getting Columns Of users Table")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FVcLaFlU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-9UjVWpak2SI/XQSAlXEnSuI/AAAAAAAAA1c/X0MMHz5etmEj4Ij4HgfRj4AazXz2m7f4wCLcBGAs/s640/users_table_columns.png)

### [](#getting-id-username-and-password-columns-of-users-table)**获取用户表的 id、用户名和密码列**

[![Getting id, username and password columns of users Table](../Images/741981b2da93e633f77384509bfe6b2d.png "Getting id, username and password columns of users Table")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1ehbCodD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-HiXXSkbqTuc/XQSA-nqXwrI/AAAAAAAAA1k/DcPFOFM3igkNTeLVj7yG9SurXRSg8MvtgCLcBGAs/s640/users_table_records.png)

### [](#preventing-sql-injection)**阻止 SQL 注入**
