...
> 原文:[https://dev.to/azure/home-grown-iot-processing-data-5cnm](https://dev.to/azure/home-grown-iot-processing-data-5cnm)
...
## [](#processing-data-with-functions)用函数处理数据
