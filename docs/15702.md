...
> 原文:[https://dev . to/bnevilleoneill/exploring-sapper-svelte-a-quick-tutorial-cl7](https://dev.to/bnevilleoneill/exploring-sapper-svelte-a-quick-tutorial-cl7)

[![](../Images/f261062b73bcf5c8743b794e2c6ba249.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5XIurMOc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e4gf5enbcs1xbqoakade.jpg)
...
在本文中，我们将从较高的层面来看一下 Sapper，它如何帮助您构建成熟的轻量级应用程序，以及分解服务器渲染的应用程序。 [![😁](../Images/c10695d626b135aa2c96e9699ffc9a07.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Z9XGTBmA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/12.0.0-1/72x72/1f601.png) 到本文结束时，你应该对 Sapper 有足够的了解，明白是什么让它令人敬畏。
...
嗯，很有道理。[![🤓](../Images/f1429a510cde04140f7054ca24e56ae5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QSre4hF9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/12.0.0-1/72x72/1f913.png)
...
#### [](#-raw-serviceworkerjs-endraw-)`service-worker.js`
...
不过，这里有一个警告:虽然 Sapper 在支持第三方模块方面做得近乎完美，但是有些模块需要访问`window`对象，正如您所知，您不能从服务器端访问`window`。简单地导入这样一个模块会导致你的编译失败，世界会变得有点暗淡。【T2![🥺](../Images/f224f710cd5ac1f9ebbda027e92b09fa.png)
...
现在你已经了解了 Sapper 的基础知识，是时候开始使用它了。创建一个小项目，打破东西，修复东西，到处乱搞，只是感受一下 Sapper 是如何工作的。你可能会坠入爱河。[![❤](../Images/00dac1f9d527f50a78e0e7af4db6d55a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ovFHVbVK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/12.0.0-1/72x72/2764.png)
