...
> 原文:[https://dev . to/raddevon/understanding-JavaScript-callback-functions-9n 5](https://dev.to/raddevon/understanding-javascript-callback-functions-9n5)
...
## [](#calling-plays-in-specific-scenarios)在特定场景下调用播放
...
## [](#a-real-use-case-for-callback-functions)回调函数的真实用例
...
## [](#other-uses-for-callback-functions)回调函数的其他用途
