...
> 原文:[https://dev . to/al _ khovansky/intro-to-screen-capture-API-scanning-QR-codes-bgi](https://dev.to/al_khovansky/intro-to-screen-capture-api-scanning-qr-codes-bgi)

###### [](#cover-image-by-lianhao-qu)封面图片由[连浩渠](https://unsplash.com/@lianhao)
...
[![Demo](../Images/591753d5225b0b54bc7dc50d2906c464.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vGNoXW3G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8uzbfjocz9lfqocbdivi.gif)
...
[![1password](../Images/55b9904edfe78b849f9eaa0d4834bf8e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UaOFd3YE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ki4shg42yoqsswsn2cur.png)

相当整洁。但是我们不能让浏览器窗口捕捉它下面的任何东西。或者我们可以吗？

## [](#enter-getdisplaymedia)Enter getDisplayMedia
