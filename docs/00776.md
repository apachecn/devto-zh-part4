...
> 原文:[https://dev . to/dantheman 999301/running-Gatling-in-azure-container-instances-part-2-adding-an-API-to-control-Gatling-3b1o](https://dev.to/dantheman999301/running-gatling-in-azure-container-instances-part-2-adding-an-api-to-control-gatling-3b1o)
...
# [](#step-one-creating-a-custom-docker-runtime-container)第一步——创建自定义 Docker 运行时容器
...
# [](#step-two-creating-the-api)第二步-创建 API
...
### [](#the-controller-gatlingcontrollercs)控制器(GatlingController.cs)
