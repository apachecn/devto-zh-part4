...
> 原文:[https://dev . to/right from basics/connecting-name cheap-domain-with-github-pages-3nn 6](https://dev.to/rightfrombasics/connecting-namecheap-domain-with-github-pages-3nn6)
...
#### [](#1-register-on-namecheap)1。在 Namecheap 上注册

只需进入 [Namecheap 主页](https://www.namecheap.com/)并注册一个账户。

#### [](#2-select-a-cool-domain)2。选择一个酷域
...
#### [](#3-get-a-github-repository)3。获取 GitHub 存储库
...
#### [](#4-create-a-cname-record-in-your-repository)4。在存储库中创建 CNAME 记录

用你的域名创建一个名为 CNAME 的文件。就是这样。例如我的 CNAME 文件包含这个:
`harishv.me`。

#### [](#5-go-to-namecheaps-dashboard)5。转到 Namecheap 的仪表板

在高级 DNS 部分下，添加以下记录。CNAME 记录的值遵循您在步骤 3 中创建的 GitHub URL。A 记录用于将域名指向托管服务器的 IP 地址，在您的例子中，托管服务器是 GitHub 的。

[![Namecheap Records](../Images/2664bf9be616d63314ac1e3d13655be5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8crL04S9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/rightfrombasics.com/wp-content/uploads/2018/12/Screenshot-2018-12-08-at-11.31.42-AM.png%3Fw%3D1896%26ssl%3D1)
