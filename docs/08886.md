...
> 原文:[https://dev . to/torianne 02/building-ruby-tests-r spec-helper-methods-and-hooks-2d D1](https://dev.to/torianne02/building-ruby-tests-rspec-helper-methods-and-hooks-2dd1)
...
[![code showing after hooks](../Images/951c096583578bae5bc63dd1fa65080c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vv8k7BS9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/75vo0vroxeouwsgtaniq.png)

在看这条线下面之前，花点时间考虑一下你认为这些会以什么顺序打印出来！

[![answers to above code](../Images/77ec2690537e21077a3b56eb7581b766.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rrxwxpkK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mvrzgzoqjmj8gh32iack.png)

你是对的吗？！如果你是，耶！如果没有，请花一点时间重新阅读上面的描述。特别注意斜体的单词和作为参数传递给每个`after`语句的单词。

### [](#-raw-let-endraw-and-raw-before-endraw-)`let`和`before`

在这一节中，我们将讨论助手方法`let`和钩子`before`。`before`类似于`after`，因为它也可以接受`all`和`each`这两个自变量。不同的是，这种挂钩类型要么在*所有*测试执行之前被激发，要么在*每个*测试执行之前被激发。

[![code showing before hooks](../Images/d9d5da745996fcd93f981341e7c83d0b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7fcIqzzP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/34mhyb8kfz23x05vvpja.png)

还是那句话，看看你能不能猜出正确的输出顺序！

[![answers of before hooks code](../Images/ca23f42770e1d4f2dc0ac2c15020ade8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zjYB8cOj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9hf7yaxsw2rm9hqm6zyg.png)
...
[![side by side comparison of before and let](../Images/6ca7aa525000b4542a1a82287a8828f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3cURdzsF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zyn157e2dta7hbvemnpb.png)
...
[![code showing non-error when using typo](../Images/66e7c170cc33acd341234efa5d4d65af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--q9fqkCXC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e9cpivph1e08v7isclbe.png)

如果你在使用`let`时不小心拼错了`user`，你会收到一个`NameError`错误。

[![code showing error message when typo](../Images/114e8375ec486ce1b28fbe1c2b654f59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DyZ_BeTz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7w3ibf0j83ptlzo4may7.png)
