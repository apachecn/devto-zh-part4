# 使用 Next-Cart 从 BigCommerce 迁移到 Shopify

> 原文:[https://dev . to/next _ cart/migrate-from-big commerce-to-shopify-with-next-cart-53hk](https://dev.to/next_cart/migrate-from-bigcommerce-to-shopify-with-next-cart-53hk)

# [](#what-data-can-be-migrated-from-bigcommerce-to-shopify)哪些数据可以从 BigCommerce 迁移到 Shopify
...
# [](#how-to-migrate-bigcommerce-to-shopify-with-nextcart)如何使用 Next-Cart 将 BigCommerce 迁移到 Shopify
