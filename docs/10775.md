...
> 原文:[https://dev.to/aka_dude/let-s-write-tagged-union-in-c-1chf](https://dev.to/aka_dude/let-s-write-tagged-union-in-c-1chf)
...
## [](#what-are-variadic-templates)什么是可变模板？
...
## [](#templating-feel-the-power)模板化:感受力量
