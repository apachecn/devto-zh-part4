...
> 原文:[https://dev.to/ddarrko/how-to-write-more-testable-code-oi7](https://dev.to/ddarrko/how-to-write-more-testable-code-oi7)
...
## [](#how-can-we-write-more-testable-code)怎样才能写出更多可测试的代码？
...
## [](#now-lets-get-to-testing)现在让我们开始测试
