...
> 原文:[https://dev . to/jasterix/when-do-you-actual-need-to-use-花括号-in-react-25mh](https://dev.to/jasterix/when-do-you-actual-need-to-use-curly-braces-in-react-25mh)

要回答这个问题，当你不需要花括号时，解释起来会更容易

#### [](#3-instances-where-you-dont-need-a-curly-brace)不需要花括号的 3 种情况:
...
#### [](#use-curly-braces-where-you)在下列情况下使用花括号:
...
#### [](#brief-example-of-curly-braces-in-action)花括号作用的简要例子:
