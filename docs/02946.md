...
> 原文:[https://dev . to/rhanarion/deploy-to-Google-kubernetes-engine-using-git lab-ci-42gb](https://dev.to/rhanarion/deploy-to-google-kubernetes-engine-using-gitlab-ci-42gb)
...
# [](#update-the-kubernetes-service-with-the-new-docker-image)用新的 docker 映像更新 kubernetes 服务
