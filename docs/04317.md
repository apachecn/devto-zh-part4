...
> 原文:[https://dev . to/mkf/want-to-log in-to-a-bash-5-not-in-etc-shell-while-having-your-shell-and-log in-shell-set-to-bin-bash-that-stay-on-v4-3k2i](https://dev.to/mkf/want-to-login-to-a-bash-5-not-in-etc-shells-while-having-your-shell-and-login-shell-set-to-bin-bash-which-stays-on-v4-3k2i)
