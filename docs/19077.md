...
> 原文:[https://dev . to/sk HMT/creating-a-native-executable-in-windows-with-graalvm-3g7f](https://dev.to/skhmt/creating-a-native-executable-in-windows-with-graalvm-3g7f)
...
## [](#things-to-know-before-you-get-started)入门前要知道的事情
...
## [](#steps-to-run-graalvm-1900s-raw-nativeimage-endraw-in-windows)在 Windows 中运行 GraalVM 19.0.0 的步骤`native-image`
...
## [](#update-as-of-graalvm-1930-still-no-support-for-swing-nor-javafx)更新:截至 GraalVM 19.3.0，仍然不支持 Swing 也不支持 JavaFX。
