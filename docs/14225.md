...
> 原文:[https://dev . to/quii/learn-go-with-tests-Roman-numbers-and-property-based-tests-3m h6](https://dev.to/quii/learn-go-with-tests-roman-numerals-and-property-based-tests-3mh6)
...
### [](#the-romans-were-into-dry-too)罗马人也被干成了...
...
## [](#an-intro-to-property-based-tests)基于属性的测试介绍
...
### [](#more-tdd-practice-with-iterative-development)更多的 TDD 实践与迭代开发
