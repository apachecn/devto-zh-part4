...
> 原文:[https://dev.to/ahferroin7/the-html5-template-element-26b6](https://dev.to/ahferroin7/the-html5-template-element-26b6)
...
## [](#what-exactly-is-the-raw-lttemplategt-endraw-element)到底是什么`<template>`元素？
...
## [](#so-what-can-you-do-with-it)那么你能用它做什么呢？
...
## [](#ok-but-what-about-using-it-for-actual-templates)好吧，但是把它用于实际的模板呢？
...
## [](#but-surely-its-not-widely-supported)但是肯定不是广泛支持的吧？
