...
> 原文:[https://dev . to/Brent onhouse/are-you-ready-for-xcode-11-and-IOs-13-development-4h6g](https://dev.to/brentonhouse/are-you-ready-for-xcode-11-and-ios-13-development-4h6g)
...
### [](#installing-xcode-11)安装 Xcode 11
...
### [](#download-and-install-titanium-sdk-820ga)下载安装 Titanium SDK 8.2.0.GA
...
### [](#building-your-app-with-different-versions-of-sdk-and-xcode)使用不同版本的 SDK 和 Xcode 构建您的应用

> *以下章节描述了作为开发人员您可能想要运行的不同目标场景*

#### [](#target-ios-13x-simulator-from-sdk-82x)目标来自 SDK 8.2.x 的 iOS 13.x 模拟器
...
#### [](#target-ios-12x-simulator-from-sdk-82x)目标来自 SDK 8.2.x 的 iOS 12.x 模拟器
...
#### [](#target-ios-13-simulator-from-pre-82x-sdk)目标 8.2.x SDK 之前的 iOS 13 模拟器
...
#### [](#target-ios-12-simulator-from-sdk-75x)目标来自 SDK 7.5.x 的 iOS 12 模拟器
...
### [](#enjoy-adding-new-ios-13-features-to-your-titanium-native-mobile-app)尽情享受为您的 Titanium 原生移动应用添加新的 iOS 13 功能吧！
