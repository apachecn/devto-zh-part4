...
> 原文:[https://dev.to/codingpizza/parametros-en-dart-1f11](https://dev.to/codingpizza/parametros-en-dart-1f11)
...
## [](#ya-hemos-hablado-un-poco-sobre-ellos)我们已经谈了一些他们的事。

在前面关于功能的帖子中，我们已经稍微谈了一下 ***参数*** 。我们已经看到它们作为运行“冰淇淋机”的原料。我们也可以说，参数是函数执行其程式码所需的相依性。

## [](#required-parameters-par%C3%A1metros-requeridos)必需参数(必需参数)
...
## [](#optional-parameters-par%C3%A1metros-opcionales)可选参数/可选参数
...
## [](#named-parameters-par%C3%A1metros-nombrados)命名参数/命名参数
