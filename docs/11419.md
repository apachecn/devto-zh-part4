...
> 原文:[https://dev . to/David wells/7-server less-auth-strategies-for-protecting-gated-functions-2 mkp](https://dev.to/davidwells/7-serverless-auth-strategies-for-protecting-gated-functions-2mkp)
...
## [](#pick-your-auth-provider)选择您的授权提供商
...
### [](#1-inline-auth-checking)1。内嵌验证检查
...
### [](#7-single-use-access-token)7。一次性访问令牌
