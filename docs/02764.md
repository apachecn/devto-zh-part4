...
> 原文:[https://dev . to/star BIST/my-favorite-chrome-extensions-for-web-development-mosely-3aj 8](https://dev.to/starbist/my-favorite-chrome-extensions-for-web-development-mostly-3aj8)
...
[![Octotree Screenshot](img/6d99efff0e3d3b50bd6d3761e56b21db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cdBnuObo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pdgep59zkbkh8aq4ei9z.png)

这是我的网站知识库 Octotree 侧边栏的预览。

## [](#wappalizer)[晶片化器](https://chrome.google.com/webstore/detail/code-line-daily/jfgojeolhopchbgfdgodicnaimmkbpbg)

Wappalizer 识别当前站点中使用的技术。我发现这个扩展在审查新项目时很有帮助。我可以看到网站上使用的大多数技术，这让我可以决定是否接受一个项目，甚至做出评估。

[![Wappalizer Screenshot](img/1283905d612447151b1560971d0cf89a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qhOHQ4O8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1jj4j8hwvk1j45lltl8q.png)

例如，您可以看到我的网站使用 Matomo 进行分析，使用 Netlify 作为 web 服务器和 CDN，使用 Hexo 生成静态网站。

## [](#css-feature-toggle-extension)[CSS 特性切换扩展](https://github.com/keithclark/css-feature-toggle-devtools-extension)
...
[![CSS Feature Toggle Screenshot](img/d8cf958bd3f451e4e3da8dfc33712d30.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dykSPxaO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2vtj4c8bj4kdn57xh2uq.png)
...
## [](#workona)[沃克纳](https://chrome.google.com/webstore/detail/workona/ailcmbgekjpnablpdkmaaccecekgdhlh?hl=en)
...
[![Workona Screenshot](img/ca90a482dfecce7648358f68a0e3d69d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aFzYeN96--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/whqptzjp5fcgsaap9ypg.png)

你可以在仪表板上看到我工作的一部分。要打开特定工作区的选项卡，只需单击一下即可。

## [](#lastpass)[LastPass](https://chrome.google.com/webstore/detail/lastpass-free-password-ma/hdokiejnpimakedhajhdlcegeplioahd)

LastPass 是一个密码管理器。它可以存储密码，并且可以自动为您填充登录字段。当处理大量客户时，它可以节省你的时间和理智。我也在手机上使用它。它非常有效。

[![LassPass Screenshot](img/a985489ed8c910e69041909092cef7f2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cJJz6XYF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yon9yxussix78kzr5a62.png)

在测试表单时，LastPass 也可以为您节省大量时间。您可以用虚拟数据创建一个配置文件，然后使用“填充”选项来填充表单。我经常在注册表单中使用这个特性。

有趣的事实:我有超过 20 次的空闲登录。😵

## [](#code-line-daily)[代码行日报](https://chrome.google.com/webstore/detail/code-line-daily/jfgojeolhopchbgfdgodicnaimmkbpbg)

《每日代码行》是我上个月左右做的一个兼职项目。这是本月早些时候在产品搜索上推出的。

[![Code Line Daily](img/a5647c256ca377e21b576d9df4d48f76.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CmOT3fFU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i5jj4tx856u89ofduzbs.png)
