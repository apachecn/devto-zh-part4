...
> 原文:[https://dev . to/d sample/environment-configuration-with-react-nginx-3ja 5](https://dev.to/dsample/environment-configuration-with-react-nginx-3ja5)
...
#### [](#webpack-on%C2%A0deploy)部署时的 Webpack
...
### [](#using-nginx-configuration)使用 Nginx 配置
...
#### [](#separate-config%C2%A0file)单独的配置文件
...
#### [](#generate-nginxconf)生成 nginx.conf
...
#### [](#copy-the-apps-config-file-into%C2%A0place)将应用程序的配置文件复制到位
...
### [](#including-the-config-in-the%C2%A0site)包括站点中的 config
