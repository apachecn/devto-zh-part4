...
> 原文:[https://dev.to/ameseee/semantic-html-how-can-you-tell-13am](https://dev.to/ameseee/semantic-html-how-can-you-tell-13am)
...
## [](#benefits-of-semantic-html)语义 HTML 的好处

### [](#increases-accessibility)增加可达性
...
[![](../Images/e1eda880c8ddf07458ffad4c0cc233b9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kj3K5r9s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vbkovurugoiz64zmzc7e.png)

答案是——你*不应该*能够通过在浏览器中查看结果来判断。语义 HTML 应该产生相同的外观；但是我们使用的元素应该向我们、开发人员和阅读我们代码的技术传达意义，以便为所有用户提供更好的体验。

这是代码的截图，并排显示。点击下面的链接查看完整的代码。

[![](../Images/ea31543b12a19a9d9f9681e81423e99f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jTAaOOrp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zzexk332lff0d775rycg.png)
...
### [](#what-about-raw-ltdivgt-endraw-s)那`<div>` s 呢？
