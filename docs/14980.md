...
> 原文:[https://dev . to/alexanderalemayhu/dear-frontend-devs-why-using-git-interactive-is-better-5d5g](https://dev.to/alexanderalemayhu/dear-frontend-devs-why-using-git-interactively-is-better-5d5g)
