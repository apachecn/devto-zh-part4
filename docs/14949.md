...
> 原文:[https://dev . to/shermix/tooling-saturdays-1-setting-and-use-gpg-public-encryption-keys-with-key base-io-1 onj](https://dev.to/shermix/tooling-saturdays-1-setting-and-using-gpg-public-encryption-keys-with-keybase-io-1onj)
