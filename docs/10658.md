...
> 原文:[https://dev . to/santypk 4/introducing-the-best-10-node-js-frameworks-for-2019-and-2020-MCM](https://dev.to/santypk4/introducing-the-best-10-node-js-frameworks-for-2019-and-2020-mcm)
...
# [](#what-is-a-nodejs-framework)什么是 node.js 框架？

# [](#how-to-choose-a-nodejs-framework-for-my-application)如何为我的应用选择一个 node.js 框架？
...
## [](#whats-is-this-framework-about)这个框架是关于什么的？
...
# [](#get-more-advanced-nodejs-development-articles)👉获取更高级的节点。JS 开发文章

加入其他 2000 多名精通 node.js 的开发人员的行列，获取文章更新。

[![Email List Form](../Images/ab6595eef5c66adc798d313eced1d083.png)T2】](https://softwareontheroad.us20.list-manage.com/subscribe/post?u=337d8675485234c707e63777d&id=14f1331817)

# [](#9-feathers)9。羽毛

[*Feather.js*](https://feathersjs.com/) 是一个 node.js 框架，承诺成为现代应用程序的 REST 和实时 API 层。

## [](#see-whats-capable-of)看看有什么能耐！！
...
[![santypk4 image](../Images/3da502abc622980763f568f315d67060.png)](/santypk4) [## 防弹 node.js 项目架构🛡️

### Sam Apr 18 ' 1911 分钟读取

#node #javascript #webdev #tutorial](/santypk4/bulletproof-node-js-project-architecture-4epf)

## [](#now-tell-me-what-is-your-favorite-nodejs-framework)现在告诉我，你最喜欢的 node.js 框架是什么？
