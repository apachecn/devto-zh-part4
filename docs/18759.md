...
> 原文:[https://dev . to/joaofbantunes/episode-022-integrating-identity server 4-part-2-auth-service-ASP-net-core-from-0-to-overkill-2383](https://dev.to/joaofbantunes/episode-022-integrating-identityserver4-part-2-auth-service-asp-net-core-from-0-to-overkill-2383)
...
### [](#first-bits-of-configuration)配置的第一位
...
### [](#configuring-user-information-apis-and-clients)配置用户信息、API 和客户端
...
### [](#integrate-with-aspnet-core-identity)融入 ASP.NET 核心身份
...
### [](#integrate-operational-store-with-ef-core)将运营门店与 EF 核心整合
...
#### [](#configure-operational-store-implementation)配置运营门店实现
...
#### [](#create-operational-store-migrations)创建运营门店迁移
