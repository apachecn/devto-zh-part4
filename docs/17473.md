...
> 原文:[https://dev . to/sendilkumarn/loading-wasm-as-ESM-in-nodejs-2g db](https://dev.to/sendilkumarn/loading-wasm-as-esm-in-nodejs-2gdb)
...
# [](#esmodules-comes-to-nodejs)ESModules 来到 Node.js
...
### [](#no-mixing-syntaxes-in-mjs-files)中没有混合语法。mjs 文件
...
### [](#loading-js-files-inside-mjs-files)在 mjs 文件中加载 js 文件
...
### [](#loading-mjs-files-inside-js-files)在 js 文件中加载 mjs 文件
...
# [](#enters-the-webassembly-modules)进入 WebAssembly 模块
...
# [](#loading-wasm-as-esm-in-nodejs)在 NodeJS 中加载 WASM 作为 ESM
