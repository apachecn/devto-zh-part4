...
> 原文:[https://dev . to/iggredible/vim-use-dot-command-to-save-keystrokes-1c 96](https://dev.to/iggredible/vim-use-dot-command-to-save-keystrokes-1c96)
...
## [](#example-1-adding-to-the-end-of-each-line)例 1:添加；到每一行的结尾
...
## [](#example-2-deleting-specific-word-but-not-all)例 2:删除特定单词，但不是全部
...
## [](#example-3-adding-at-the-beginning-on-each-line)例 3:添加(在每行的开头
...
## [](#comparing-what-changed)比较什么‘变了’
