...
> 原文:[https://dev . to/ashleemboyer/build-a-react-firebase-blog-site-part-1-4gn 0](https://dev.to/ashleemboyer/build-a-react-firebase-blog-site-part-1-4gn0)
...
### [](#-raw-srcpagespostjs-endraw-)`src/pages/post.js`
...
### [](#-raw-srcpageshomejs-endraw-)`src/pages/home.js`
...
## [](#4-connect-firebase-to-the-application)4。将 Firebase 连接到应用程序
