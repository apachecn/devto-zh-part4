...
> 原文:[https://dev . to/moesif/in-depth-guide-to-server less-API-with-AWS-lambda-and-AWS-API-gateway-part-1-57mj](https://dev.to/moesif/in-depth-guide-to-serverless-apis-with-aws-lambda-and-aws-api-gateway-part-1-57mj)
...
## [](#implementing-the-sam-template)实现 SAM 模板
...
## [](#implementing-the-auth-lambda-function)实现 Auth Lambda 功能
...
### [](#how-to-access-the-request-body)如何访问请求体？
...
### [](#how-to-set-http-status-codes)如何设置 HTTP 状态码？
...
### [](#how-to-set-an-http-response-header)如何设置 HTTP 响应头？
