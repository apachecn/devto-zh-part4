...
> 原文：<https://dev.to/moesif/in-depth-guide-to-serverless-apis-with-aws-lambda-and-aws-api-gateway-part-1-57mj>
...
*   `LambdaCognitoUserPoolExecutionPermission`授予被管理的认知服务执行我们的`PreSignupFunction`的权限。
...
*原载于 [Moesif 博客](https://moesif.com/blog)T3】*