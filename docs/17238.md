...
> 原文:[https://dev . to/joaofbantunes/episode-024-integrating-identity server 4-part-4-back-for-front-ASP-net-core-from-0-to-overkill-58cp](https://dev.to/joaofbantunes/episode-024-integrating-identityserver4-part-4-back-for-front-asp-net-core-from-0-to-overkill-58cp)
...
## [](#configure-the-bff-to-authenticateauthorize-the-user)配置 BFF 对用户进行认证/授权
...
### [](#requiring-the-user-to-be-authenticated)要求用户进行身份验证
...
## [](#provide-the-access-token-on-api-calls)提供 API 调用的访问令牌
...
## [](#refresh-the-access-token)刷新访问令牌
