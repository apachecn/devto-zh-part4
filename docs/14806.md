...
> 原文:[https://dev . to/mangel 0111/the-what-why-and-how-of-react-with-hooks-2 aog](https://dev.to/mangel0111/the-what-why-and-how-of-react-testing-with-hooks-2aog)
...
# [](#what-else-should-i-learn-about-testing)关于测试还需要学习什么？
...
# [](#why-refactor-is-related-to-tdd)为什么重构与 TDD 有关？
...
# [](#how-to-really-make-a-good-test)如何真正考好？
...
# [](#always-tests-before-refactor)总是在重构之前进行测试
...
[![](../Images/1118d29c23dc2572cfc005ef8b7eabe8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tHFFQ-IG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o5n3xws42mar07yi4acm.PNG) 
...
# [](#lets-go-with-interactions)让我们开始互动吧
...
# [](#mutants-on-the-code-and-the-corner-cases)变种人身上的代码和角码
...
# [](#inthetestswetrust)InTheTestsWeTrust
