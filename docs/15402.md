...
> 原文:[https://dev . to/this dot media/why-you-should-consider-migrating-from-angular js-to-vue-49hj](https://dev.to/thisdotmedia/why-you-should-consider-migrating-from-angularjs-to-vue-49hj)
...
## [](#which-framework-should-we-use)我们应该使用哪个框架？
...
## [](#successfully-migrating-to-vue-from-angularjs)从 AngularJS 成功迁移到 Vue
...
### [](#setting-up-your-application-for-migration)为迁移设置您的应用程序

为此，您应该设置 AngularJS 应用程序，以便它可以同时呈现 AngularJS 和 Vue 组件。如果你有时间、预算和资源，这将允许你在 Vue 中构建新的特性，并移植 AngularJS 中的现有特性。

### [](#how-to-begin-vue-and-angularjs-integration)如何开始 Vue 和 AngularJS 整合
...
### [](#converting-angularjs-components-to-vue-components)将 AngularJS 分量转换为 Vue 分量
...
### [](#angularjs-to-vue-migration-code-example)AngularJS 到 Vue 迁移代码示例
