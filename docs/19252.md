...
> 原文:[https://dev . to/vuong/debugging-PHP-application-in-lavong-by-xdebug-vs code-3 lol](https://dev.to/vuong/debugging-php-application-in-vagrant-by-xdebug-vscode-3lol)
...
## [](#install-amp-configuration-xdebug-in-vagrant)在流浪汉中安装&配置 Xdebug
...
## [](#install-php-debug-for-visual-studio-code)安装 PHP Debug for Visual Studio 代码

*   以 PHP Debug 的名称搜索扩展，安装它

## [](#problem-with-firewall)防火墙的问题
