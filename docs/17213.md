...
> 原文:[https://dev . to/kambanthemaker/getting-to-know-AWS-lambda-FAAS-1ec 2](https://dev.to/kambanthemaker/getting-to-know-aws-lambda-faas-1ec2)

AWS Lambda 是一种 FaaS (Function as a Service)，一种编码单元的无服务器方法。我使用 AWS Lambda 已经有一段时间了，我对它的功能印象深刻。让我写一篇关于基本原理、优点和缺点的文章。

[![Lambda](../Images/7de208cea33a47ff5f877511c84a5d11.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AwBGM3VP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.ibb.co/DzPR22L/iu.jpg)
