...
> 原文:[https://dev . to/bnevilleoneill/creating-a-full-stack-mern-app-using-jwt-authentic ation-part-2-53 a4](https://dev.to/bnevilleoneill/creating-a-full-stack-mern-app-using-jwt-authentication-part-2-53a4)
...
### [](#using-raw-bearer-endraw-in-front-of-raw-lttokengt-endraw-)在`<token>`前使用`Bearer`
...
### [](#changes-to-the-core-function)修改核心功能
...
### [](#functions-to-generate-verify-and-validate-jwt)生成、验证和确认 JWT 的功能
...
### [](#exporting-and-importing-the-functions)导出和导入功能
...
## [](#creating-the-rest-api-endpoint)创建 REST API 端点
...
### [](#creating-the-right-routes)创建正确的路线
