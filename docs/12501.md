...
> 原文:[https://dev . to/michaeljota/this-is-why-I-hate-typescript-3da 0](https://dev.to/michaeljota/this-is-why-i-hate-typescript-3da0)
...
## [](#typescript-is-not-javascript)Typescript 不是 JavaScript
...
## [](#people-only-use-typescript-because-they-are-used-to-oo-languages)人们用 Typescript 只是因为习惯了 OO 语言
...
## [](#typescript-is-only-used-in-angular)Typescript 只用于有角度的
