...
> 原文:[https://dev.to/thefern/part-2-a-basic-package-bic](https://dev.to/thefern/part-2-a-basic-package-bic)

在上一篇文章中，我们讨论了什么是包，这是一个很好的介绍。我宁愿向你展示如何建立一个，我们不会疯狂，只是足够向你展示基本的。

## [](#barebones-structure)准系统结构
...
## [](#lets-add-some-python-code)让我们添加一些 python 代码
...
## [](#adding-our-function-to-init)将我们的函数添加到 init
...
## [](#install-as-development-package)作为开发包安装
...
# [](#install-package-from-github)从 Github 安装包
