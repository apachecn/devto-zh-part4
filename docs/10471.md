...
> 原文:[https://dev.to/dr_donoso/autoscale-for-cosmos-db-aj3](https://dev.to/dr_donoso/autoscale-for-cosmos-db-aj3)

如果您曾经在您的项目中使用过 Cosmos DB，也许您会意识到使用 Cosmos DB 的一个主要问题是它没有 autoscale。微软两年前开始致力于此。

[![](../Images/ffb5a4b08ca51b288bd9976ee28fcfb3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WuTLZ1KZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0e2pef8gci80rkjz64ri.png)
