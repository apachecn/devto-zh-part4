...
> 原文:[https://dev . to/n 350071/static-security-analysis-for-rails-app-by-using-break man-283 a](https://dev.to/n350071/static-security-analysis-for-rails-app-by-using-breakman-283a)
...
### [](#compare-with-last-one)与上一次比较

```
bundle exec brakeman ./ --compare ./ci/brakeman-scan-result.json 
```

## [](#in-the-case-of-falsepositive)假阳性的情况下
