...
> …
> 
> ### [](#google-hacking-or-dorking)Google Hacking，或 Dorking
> 
...
[![A screenshot of exposed api key in Google search](img/77142b78b7315138b9ca45597ff40b74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xjAYkvtX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/b33jzxxllwtke8shg7zu.png)

*简单视图中的 API 键。*

[![A screenshot of exposed username and password in Google search](img/200060752a5c8a9edf8253f5f56c687f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kuhnLaqO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1dfp9mb8b1i38bsalib0.png)
...
[![A screenshot of a Google search for tokens on GitHub](img/ab4423147e7db9e56bbd8b6b3125ceea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VvUDjF9Y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zur69lifho4v1g3vbigx.png)
...
## [](#pushing-left-to-prevent-sensitive-data-exposure)向左推，防止敏感数据泄露

从一个小小的角度来说明为什么在任何敏感数据存在之前就开始管理敏感数据非常重要。通过在 SDLC 的左边建立安全最佳实践，我们给我们的员工最好的机会来增加我们软件产品的任何未来欺骗看起来更像这样的可能性。

[![No results found in Google Search](img/76280a639bddf439eb6e61d1f768a683.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xGjBmreT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p8aehoij260aajz0qk43.png)
