...
> 原文:[https://dev . to/scout APM/8-things-you-should-know-about-docker-containers-4bdn](https://dev.to/scoutapm/8-things-you-should-know-about-docker-containers-4bdn)
...
## [](#2-what-is-a-docker-container)2。什么是 Docker 容器？
...
## [](#3-what-is-a-docker-image)3。什么是 Docker 图像？
...
## [](#4-what-is-docker-engine)4。什么是 Docker 引擎？
...
## [](#5-what-is-the-docker-cli)5。什么是 Docker CLI？
...
## [](#6-what-is-a-dockerfile)6。什么是 Dockerfile？
...
## [](#7-what-is-docker-compose)7。什么是 Docker Compose？
...
## [](#8-what-is-docker-hub)8。什么是 Docker Hub？
