...
> 原文:[https://dev . to/nab bisen/PHP-mail-function-fails-with-PHP-fpm-in-openbsd-s-httpd-1 IMC](https://dev.to/nabbisen/php-mail-function-fails-with-php-fpm-in-openbsd-s-httpd-1imc)
