...
> 原文:[https://dev . to/Mr _ steelze/setting-up-a-laravel-project-with-SQL-server-and-xampp-wamp-on-windows-3n7k](https://dev.to/mr_steelze/setting-up-a-laravel-project-with-sql-server-and-xampp-wamp-on-windows-3n7k)

昨天我花了大部分时间试图将一个现有的 Laravel 项目连接到 MsSQL。我犯了一些错误，使用了不同的教程，但我最终得到了它的设置。

##### [](#note-this-article-assumes-you-have-sql-server-xampp-or-wamp-and-laravel-correctly-installed-on-your-system)**注意:** *本文假设您的系统上已经正确安装了 SQL Server、xampp 或 wamp 和 laravel。*
