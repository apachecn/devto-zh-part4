...
> 原文:[https://dev . to/BG Schiller/understanding-typescript-generics-52j 6](https://dev.to/bgschiller/understanding-typescript-generics-52j6)
...
### [](#type-parameter-inference)类型参数推断
...
### [](#type-parameters-in-other-languages)输入其他语言的参数
