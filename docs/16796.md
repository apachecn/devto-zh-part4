...
> 原文:[https://dev . to/theodesp/best-ways-to-use-react-hooks-for-state-management-44 H3](https://dev.to/theodesp/best-ways-to-use-react-hooks-for-state-management-44h3)
...
[![todo](../Images/399c4f882aac6e96cff05ade6d1fc34c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E0XVMbks--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hjej8cmmyapwha6lj7fv.gif)

我喜欢的东西:简单。没有中央存储或复杂的配置。我们只是拿着它用它。

**我不喜欢的东西:**简单。在大型应用程序中或者当我们有一个复杂的数据集时，它可能无法很好地扩展。对于处理小范围领域的小程序来说，它是完美的。

### [](#custom-hooks-react-context)**自定义钩子+ React 上下文**
