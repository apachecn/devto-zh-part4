...
> 原文:[https://dev . to/bnevilleoneill/router-options-comparated-vue-router-voie-vue-routisan-and-vue-route-3m9j](https://dev.to/bnevilleoneill/router-options-compared-vue-router-voie-vue-routisan-and-vue-route-3m9j)

[![](../Images/f95ece40542198713ef78b3dc1ed8c91.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5QSsXU9A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/la5r589v3ufb34pqvcec.png)
...
## [](#what-is-vue-router)什么是 Vue 路由器？
...
## [](#working-with-vue-router)使用 Vue 路由器
...
### [](#installing-vue-router)**安装 Vue 路由器**
...
[![](../Images/c27b25cf91b3fe45bd83bee74cb4f8d6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HFyHYUO7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://paper-attachments.dropbox.com/s_55A7AFCA2D01F19D1DB2C5D7074A21DFD7AC4F153729C79E2C15A8BA81A1C30D_1557624053526_RouterRender.gif)

在上面的屏幕记录中，我们可以看到应用程序如何在主页和关于页面之间切换，而不会导致浏览器窗口的重新加载。这就是现代网络框架中路由器的力量。再来看看 Vue 路由器的其他一些功能和特点。

### [](#switching-to-history-mode)**切换到历史模式**
...
[![](../Images/8b3717ef9eb6d451dffa2c03bb1e6155.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0Pd2Kx-f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://paper-attachments.dropbox.com/s_55A7AFCA2D01F19D1DB2C5D7074A21DFD7AC4F153729C79E2C15A8BA81A1C30D_1557628250951_Render2.gif)
...
### [](#what-is-the-view-resolver)**什么是视图解析器？**
...
## [](#transition-keepalive-and-other-directives)过渡、保活等指令
