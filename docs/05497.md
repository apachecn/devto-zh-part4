...
> 原文:[https://dev . to/das Daniel/creating-a-dockered-vue-storybook-project-3pn 2](https://dev.to/dasdaniel/creating-a-dockerized-vue-storybook-project-3pn2)

# [](#lets-create-a-vuebased-storybook-project-that-runs-in-docker)让我们创建一个在 docker 中运行的基于 vue 的故事书项目
...
### [](#4-add-storybook-script)4。添加故事书脚本
...
### [](#6-create-storybook-configuration)6。创建故事书配置
...
### [](#8-create-dockerfile-for-docker-image)8。创建 docker 文件(用于 docker 图像)
...
### [](#9-skip-nodemodules-with-dockerignore)9。用跳过 node_modules。dockerignore
...
### [](#10-create-a-docker-container)10。创建 docker 容器
