...
> 原文:[https://dev.to/strapi/monthly-update-august-19-1p02](https://dev.to/strapi/monthly-update-august-19-1p02)
...
### [](#createstrapiapp-a-new-way-to-generate-an-application)create-strapi-app:一种生成应用的新方法
...
### [](#better-logs-to-flatten-the-learning-curve)更好的日志来拉平学习曲线

即使我们花了很大的力气定期改进文档，如果你根本不需要阅读它，那就更好了。项目的生成是解释用户在开始使用 Strapi 项目时需要知道的所有基本命令的大好时机。

[![](../Images/9a9ee3bca412be60d94914ce6b5bfc2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ABC4TtH9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fn5kz8vsfs9to92vpge9.png)
...
### [](#nodejs-v12-support)Node.js v12 支持
...
### [](#groups-and-repeatable-fields-update)分组和可重复字段更新
...
[![](../Images/c5028e9ee8d8443ba83e45773b576ea4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oaovtiWh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kkk32p5tdpu1priplwdj.jpg)
...
### [](#visualise-the-media-directly-from-the-list)直接从列表中可视化媒体
...
[![](../Images/e6f023c36a7a49cca237062ae982f81a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z1fFe0F0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/53f2b6c8cnnxeaef5bzr.png)
