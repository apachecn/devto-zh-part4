...
> 原文:[https://dev . to/sendilkumarn/easy-micro services-with-kubernetes-and-istio-3n L3](https://dev.to/sendilkumarn/easy-microservices-with-kubernetes-and-istio-3nl3)

# [](#microservices-are-great)微服务很棒

[![](../Images/ede5cd5ffdc0e83f1016e4ddc8e3f534.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NDvNDR3G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kzmv4pbxxjgzy6yq5ztk.gif)
...
# [](#but-microservices-are-a-pain-to-maintain)但是微服务维护起来很痛苦
...
[![](../Images/e3340c0199d7883f691fa56640512c96.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4GYR64Wm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vgm0nt4ntdxt5s5vs0tj.gif)
...
[![](../Images/fa66f974328c3631d05477f513138f66.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nz5cNq0W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k98aev7acha6paenctxl.gif)
...
# [](#generate-microservices-with-khipster)用 KHipster 生成微服务
...
# [](#generate-kubernetes-amp-istio-configuration-files)生成 Kubernetes & Istio 配置文件
...
*   [](https://grafana.com/)**-分析和监控**
***   [](https://www.jaegertracing.io/)**-端到端分布式追踪*****   [](https://www.kiali.io/)**-服务网状可观测性&配置******

 ******哇，配置文件真多。但是 KHipster/ JHipster 让你的工作变得容易多了。`KHipster FTW`。

# [](#deploy-the-application-to-the-gcp)将应用程序部署到 GCP
