...
> 原文:[https://dev . to/Sheldon hull/无痛-azure-blob-storage-with-AWS-S3-2k G2](https://dev.to/sheldonhull/painless-synchronization-of-azure-blob-storage-with-aws-s3-2kg2)
