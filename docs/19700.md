...
> 原文:[https://dev . to/nenitf/usando-dwm-dynamic-window-manager-4c4j](https://dev.to/nenitf/usando-dwm-dynamic-window-manager-4c4j)

[DWM](http://dwm.suckless.org/) 是一个***【uting】****窗口经理，负责在屏幕上排列应用程序。它具有 suckless 理念，使其源代码尽可能小，通常会提高程序性能。*

 *## [](#por-que-dwm)Por que DWM？
...
## [](#configura%C3%A7%C3%A3o)配置

### [](#escrevendo-no-configh)写入 config.h
...
### [](#personalizando-status-bar)Personalizando 状态栏
...
## [](#atualiza%C3%A7%C3%B5es-desse-post)本员额的更新
