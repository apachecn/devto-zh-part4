...
> 原文：<https://dev.to/moesif/api-best-practices-for-feature-deprecation-2ne7>

Stephen Edmonds 在 Flickr 上的封面图片。T3】
...
另一种方法是使用像 Moesif 这样的 [API 分析服务来找出这些特性的使用量。](https://www.moesif.com/features/api-analytics?int_source=devto)

我们来看下面这个 Moesif API Analytics 的截图:

[![](img/f7961dce67129b9288988c65338d4960.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kX7gJnFa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0b79nz7net6udaj9dsk4.png)
...
如果我们使用 [Moesif API analytics](https://www.moesif.com/features/api-analytics?int_source=devto) ，我们可以检查谁在使用我们想要弃用的特性。通常，我们有与我们的用户或公司帐户相关联的电子邮件地址，所以我们可以直接向功能用户发送邮件，这可能是最直接的方式。
...
你想知道你的 API 实际上是如何使用的吗？
Moesif 让贬低 API 特性变得轻而易举！T3】了解更多
