...
> 原文:[https://dev . to/TL hunter/hosting-a-static-site-and-contact-form-with-osgood-5c1g](https://dev.to/tlhunter/hosting-a-static-site-and-contact-form-with-osgood-5c1g)
...
## [](#application-file-appjs)申请文件(app.js)
...
## [](#worker-file-contactjs)职工档案(contact.js)
