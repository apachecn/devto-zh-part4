...
> 原文:[https://dev . to/wiredviews/kentico-CMS-quick-tip-assured-successful-backups-in-azure-app-service-3 op0](https://dev.to/wiredviews/kentico-cms-quick-tip-ensuring-successful-backups-in-azure-app-service-3op0)

## [](#kentico-azure)肯蒂科💕蔚蓝的
...
## [](#developers-app-services)开发者💕应用服务
...
[![](../Images/0dbea9ad256ac80549c32b304faff605.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jBnlaP5z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rp88fk0fnb7xn7wzcj2g.PNG)

如果你习惯于按计划编写脚本到`xcopy`或 zip 文件，这个内置特性是一个很好的替代品。👌

## [](#the-problem-backup-size-limit-10gb)问题:备份大小限制- 10GB
...
[![](../Images/e1d80eb47b63be34da22b21dba8ba276.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DJA_Dq9t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p9d2de6oftkdc51vnym1.PNG)

## [](#kentico-backups)Kentico +备份
