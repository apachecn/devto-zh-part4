...
> 原文:[https://dev.to/sandro/tesseract-training-49ji](https://dev.to/sandro/tesseract-training-49ji)

# [](#overview-of-training-process)培训流程概述
...
## [](#the-key-differences-are)主要区别在于:
...
# [](#understanding-the-various-files-used-during-training)了解培训时使用的各种文件
