...
> 原文:[https://dev . to/michalbryxi/dynamic-set-default-query params-in-ember-v3-6-x-446 I](https://dev.to/michalbryxi/dynamically-set-default-queryparams-in-ember-v3-6-x-446i)
