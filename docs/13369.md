...
> 原文:[https://dev . to/Mike born/creating-an-ms-access-lucee-extension-4 leg](https://dev.to/mikeborn/creating-an-ms-access-lucee-extension-4leg)
...
## [](#querying-an-access-file-from-cfml)查询来自 CFML 的访问文件
...
## [](#why-a-lucee-extension)为什么是 Lucee 扩展？
...
## [](#creating-the-lucee-extension)创建 Lucee 扩展
...
## [](#packaging-a-lucee-extension-with-commandbox-and-forgebox)用 CommandBox 和 ForgeBox 封装 Lucee 扩展
...
## [](#using-the-ucanaccess-lucee-extension)使用 UCanAccess Lucee 扩展
...
## [](#connecting-to-ms-access-the-hard-way)艰难地连接到 MS Access
