...
> 原文:[https://dev.to/v6/get-a-root-token-for-hashicorp-vault-2o9j](https://dev.to/v6/get-a-root-token-for-hashicorp-vault-2o9j)
...
### [](#file-backend-with-open-source-vault)文件后端带开源 Vault
...
## [](#get-the-vault-help-for-generating-vault-root-tokens)获取用于生成 Vault 根令牌的 Vault 帮助
...
## [](#generate-a-generic-otp-for-root-token-generation)为根令牌生成生成一个通用 OTP
...
## [](#start-the-root-token-geneneration)开始根令牌生成
...
## [](#generate-root-token-incorrectly)错误生成根令牌
...
## [](#get-an-encoded-token-correctly-this-time)这次获得正确的编码令牌
...
## [](#attempt-to-decode-the-encoded-token-incorrectly)试图错误解码编码令牌
...
## [](#correctly-decode-the-encoded-token)正确解码编码令牌
...
## [](#and-finally-were-done-here)最后，我们到此为止
...
## [](#now-you-can-use-the-vault-token)现在你可以使用保险库令牌了
