...
> 原文:[https://dev.to/harshadranganathan/blockchain-4jef](https://dev.to/harshadranganathan/blockchain-4jef)

## [](#introduction-to-blockchain)区块链简介

区块链是一个去中心化、分布式和公共的数字分类账，用于维护一个不断增长的记录列表，称为块，使用加密技术链接。任何涉及的记录都不能追溯性地修改，除非修改所有后续块。

## [](#benefits-of-blockchain)区块链的好处
...
## [](#how-blockchain-works)区块链如何工作

区块链从一个叫做 genesis block 的单个区块开始。

[![](../Images/23c9bc6a05225da7d4ab262894aa9322.png)T2】](https://rharshad.com/assets/img/2019/06/genesis-block.png)
...
[![](../Images/13547f915c1e9c62ad265e509775da44.png)T2】](https://rharshad.com/assets/img/2019/06/mined-block.png)
...
[![](../Images/2728936f6f842e24c5c44918a4bfe88e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5v6s3DSv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/Zzo4Ofa.gif)
...
[![](../Images/632791c377db5421a558eee2e89b4e24.png)T2】](https://rharshad.com/assets/img/2019/06/blockchain.png)

### [](#immutability)永恒性

区块链提供了记录的不变性。如果对手篡改了整个链中的任何数据，它将使所有后续数据块无效。

[![](../Images/cba696d2ba599642b2e5b2b625acc8cb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fRGIeiVm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/41UnNFa.gif)
