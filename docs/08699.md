...
> 原文:[https://dev . to/xxc zaki/how-to-make-your-electronic-app-fast-4ifb](https://dev.to/xxczaki/how-to-make-your-electron-app-faster-4ifb)
...
## [](#1-use-v8-engine-code-cache)1。使用 V8 引擎代码缓存
...
## [](#2-use-a-module-bundler)2。使用模块捆扎机
...
## [](#3-use-faster-javascript-methods-especially-when-working-with-dom)3。使用更快的 JavaScript 方法，尤其是在使用 DOM 时
...
[![](../Images/f1d879cffa2f26caf081eaf22c86445b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KU9fJKS9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5d04g3gnchv9ivv0648f.png)

如您所见，第一种方法比第二种方法快 2 倍以上。是的——这并不意味着第二种方法很慢——这两种方法在实际应用中都很快，但是当我们在应用程序中使用许多较慢的方法时，用更快的替代方法来代替它们真的会有所不同！

## [](#4-use-webassembly-or-native-addons)4。使用 WebAssembly(或本机插件)
...
## [](#bonus-5-if-you-care-about-app-size-use-something-else)加成:5。如果你关心应用程序的大小，用别的东西
