...
> 原文:[https://dev.to/jtenner/creating-a-tokio-codec-1f0l](https://dev.to/jtenner/creating-a-tokio-codec-1f0l)
...
## [](#implementing-the-encoder)实现编码器
...
## [](#implementing-the-decoder)实现解码器
