...
> 原文:[https://dev . to/herewecode/a-beginner-s-guide-to-docker-how-to-create-your-first-docker-application-5g j5](https://dev.to/herewecode/a-beginner-s-guide-to-docker-how-to-create-your-first-docker-application-5gj5)

### [](#you-are-a-developer-and-you-want-to-start-with-docker-this-article-is-made-for-you)**你是开发者，想从 Docker 做起？这篇文章是为你写的。**
...
### [](#but-is-docker-a-virtual-machine)**但是，Docker 是虚拟机吗？**
...
[![Docker VS Virtual machines (Copyright to [Docker blog](https://blog.docker.com/2018/08/containers-replacing-virtual-machines/))](../Images/1b51258702b4336b8835c34c8c0586fa.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--CRqnIjnt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2048/1%2APmDFGgS__7juycGwH1rdxA.png) * Docker VS 虚拟机(版权归 [Docker 博客](https://blog.docker.com/2018/08/containers-replacing-virtual-machines/) )*

### [](#why-use-docker-as-a-developer)**为什么要用 Docker 做开发者？**
...
## [](#now-lets-create-your-first-application)现在让我们创建您的第一个应用程序
...
### [](#1-install-docker-on-your-machine)1。在你的机器上安装 Docker
...
### [](#2-create-your-project)2。创建您的项目
...
### [](#3-edit-the-python-file)3。编辑 Python 文件
...
### [](#4-edit-the-docker-file)4。编辑 Docker 文件
...
### [](#5-create-the-docker-image)5。创建 Docker 图像
...
### [](#6-run-the-docker-image)6。运行 Docker 映像
...
### [](#code-is-available)代码可用

如果您想检索完整的代码以便轻松发现或执行它，我已经将它放在我的 GitHub 上供您使用。

## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) [盖尔托马斯](https://github.com/gaelgthomas) / [先申请示例](https://github.com/gaelgthomas/docker-first-application-example)
...
### [](#useful-commands-for-docker)**对 Docker 有用的命令**
