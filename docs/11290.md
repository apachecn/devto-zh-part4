...
> 原文:[https://dev . to/CEE Oreo/html-101-入门须知-5bmo](https://dev.to/ceeoreo/html-101-what-you-need-to-know-to-get-started-5bmo)
...
### [](#-raw-ltdoctype-htmlgt-endraw-and-raw-lthtmlgt-endraw-)`<!DOCTYPE html>`和`<html>`

我们用`<!DOCTYPE html>`和`<html>`开始我们的 HTML 文档。这两个元素告诉我们的浏览器(即。Chrome 或 Safari)之后的代码将是 HTML 格式。

### [](#-raw-ltheadgt-endraw-and-raw-ltbodygt-endraw-)`<head>`和`<body>`
...
### [](#-raw-ltmaingt-endraw-)`<main>`

HTML 代码的`<main>`部分是大部分内容所在的地方。这是你冰淇淋三明治里的冰淇淋。这是你的蟹肉馅饼的馅饼、奶酪和生菜。
[![Krabby patty diagram](../Images/0b9c84274277b233c59ec8938372137f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0fN6bb2n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m50fb0mvuhyz84hhi3pj.png) 
与`<header>`不同，你的网页只能有一个`<main>`。

### [](#-raw-ltfootergt-endraw-)`<footer>`
...
[![](../Images/758827766aa3520ab218952ab5c4d992.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s7DwsH40--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qyxz6hdbrcuh3vogd7tv.jpeg)

### [](#-raw-ltsectiongt-endraw-vs-raw-ltdivgt-endraw-)`<section>` vs `<div>`
...
### [](#-raw-lth1gt-lth6gt-endraw-)`<h1> - <h6>`
...
[![biggest h1 to smallest h6](../Images/eefd6da345be5fab893e0090efd61ccd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fnHzd0t_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rqeslc35vvqkybjpyyvm.jpeg)

### [](#-raw-ltpgt-endraw-)`<p>`

`<p>`是我们放置段落的地方。所以，是的，它听起来就像它看起来的那样。这里不多解释了。

### [](#-raw-ltimggt-endraw-)`<img>`
...
[![ceeoreo](../Images/610094803b1a53300a27f16eb707978d.png)](/ceeoreo) [## 用这 9 个很酷的资源爱上 CSS
