...
> 原文:[https://dev . to/georgeoikawa/send-mail-easy-spring boot-send grid-and-green mail-9g](https://dev.to/georgeoikawa/send-mail-easily-springboot-sendgrid-and-greenmail-9g)
...
# [](#template-parser-parameters)模板解析器参数
...
# [](#test-sending-with-a-fake-smtp-mail-server)用假冒的 smtp 邮件服务器测试发送
