...
## [](#ignoring-parts-of-angular)Ignoring parts of Angular
...
## [](#better-than-vanilla-js)Better than Vanilla JS
...
## [](#but-why-not-use-multiple-components)But why not use multiple components?
...
## [](#feel-free-to-disagree)Feel free to disagree
