...
> 原文:[https://dev.to/4nduril/building-your-library-part-1-5cii](https://dev.to/4nduril/building-your-library-part-1-5cii)
...
## [](#build-javascript-with-babel)用巴别构建 JavaScript
...
### [](#using-raw-module-endraw-)使用`module`
...
## [](#build-typescript-with-babel)用巴别塔构建打字稿
...
## [](#build-typescript-with-tsc)用 TSC 构建类型脚本
