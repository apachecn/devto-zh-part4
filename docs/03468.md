...
> 原文:[https://dev.to/drbearhands/haskell-for-madmen-setup-4cj9](https://dev.to/drbearhands/haskell-for-madmen-setup-4cj9)

在我们开始写任何代码之前，让我们确保我们的环境设置正确。

### [](#1-install-the-dependencies)1。安装依赖项
...
### [](#3-initialize-the-repository)3。初始化存储库
...
### [](#4-setup-cicd-pipeline)4。设置 CI/CD 管道
...
#### [](#41-basing-on-the-alpine-image-optional)4.1 基于阿尔卑斯山的图像(可选)
