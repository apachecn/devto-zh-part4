...
> 原文:[https://dev . to/Stephen Weiss/trials-in-CSS-fit-content-to-window-4p5c](https://dev.to/stephencweiss/trials-in-css-fit-content-to-window-4p5c)
...
我什么意思？这个视频展示了桌子*希望*如何增长，但是如果`internalScroll`是`true`，它将折叠，只填充可用的部分。 [![Table grows to fit container](../Images/f0932a73d601ac637502c07f444676dc.png)](https://i.giphy.com/media/fxBhkyHhjEGpd3DXhd/giphy.gif)
...
更有趣的是，我正在处理的页面看起来有点像这样: [![sketch](../Images/24a133d4387d05ecdb154dadf3f6f6de.png)](///static/458bb30ae4bca017be6861444e38a157/c2b56/sketch.jpg)
