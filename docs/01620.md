...
> 原文:[https://dev . to/sm0ke/html-parser-design-once-use-anywhere-1jnl](https://dev.to/sm0ke/html-parser-design-once-use-anywhere-1jnl)
...
## 2019 年 [](#html-parser-in-2019) [HTML 解析器](https://appseed.us/developer-tools/html-parser)？
...
## [](#why-to-write-such-a-tool)为什么要写这样一个工具
...
## [](#convert-bootstrap-theme-to-vue-react)将自举主题转换为 Vue，React
...
## [](#migrate-bootstrap-themes-to-bulma-and-tailwind)将[自举](https://getbootstrap.com)主题迁移到[布尔玛](https://bulma.io/)和[顺风](https://tailwindcss.com/)
...
### [](#bootstrap-to-bulma-css)[自举到布尔玛 CSS](https://appseed.us/developer-tools/bootstrap-to-bulma-css)
...
### [](#bootstrap-to-tailwind)[自举顺风](https://appseed.us/developer-tools/bootstrap-to-tailwind-css)
