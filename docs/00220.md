...
> 原文:[https://dev . to/bnevilleoneill/how-to-write-reuse-CSS-with-sass-30k 7](https://dev.to/bnevilleoneill/how-to-write-reusable-css-with-sass-30k7)
...
[![csspreprocessors](img/f3537068fff46740c51481bf81c5cf10.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0AwwPbAZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.logrocket.com/wp-content/uploads/2019/09/csspreprocessor-nocdn.jpeg)

## [](#sass-or-scss)萨斯还是 SCSS？
...
## [](#using-scss-variables)使用 SCSS 变量
...
## [](#conditional-styling-with-control-flow)带控制流的条件样式
...
## [](#some-other-features-to-note)其他一些特性要注意
