...
> 原文:[https://dev . to/devkhadka/linear-regression-gradient-descent-intuition-math-and-code-586 e](https://dev.to/devkhadka/linear-regression-gradient-descent-intuition-math-and-code-586e)

# [](#linear-regression-using-gradient-descent-for-beginners-intuition-math-and%C2%A0code)线性回归使用梯度下降适合初学者——直觉、数学和代码
...
[![Alt Text](../Images/5b90b2375f18c1489dfeb6340a79f3f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eUl_lawJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i5aeevclaruzdyxilv3c.png)
...
[![Alt Text](../Images/dd970bc8e0232928b3772bfdfdfd4594.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dZStHBB_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/24ckl9bzdc8cp7xyt41h.png)
...
[![Alt Text](../Images/593dc9c921182b8509eecd55c688f41c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--r4fxHK4z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2y19pl00vp7aqycj1y4q.png)

用我们的假设函数替换上述等式中的 p <sub>i</sub> ,我们得到

[![Alt Text](../Images/215e9f46090c9772ec930180886e67fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sowqKSIl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jjzqvgml1ijt8yrocuog.png)
...
## [](#finding-optimum-model-bias-and-weights)寻找最优模型(偏差和权重)
...
[![Alt Text](../Images/f651ae589c373c6d13d42ae03be57335.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tg-Dafha--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gu3gzvdopvwh3tf3dgfl.png)

*   其中η是小步长，∇MSE 是点 W <sub>a</sub> 处 MSE 的梯度。∇MSE 代表 MSE 在点 W <sub>a</sub> 变化最快的方向，其大小给出了该方向上成本的变化率。
*   现在用下面的等式找到新的点

[![Alt Text](../Images/2ec449ca6d98da0a4c6af8c8a91b308c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5E27pwLM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0m55mg2isa0664o4ga1l.png)
...
[![Alt Text](../Images/38f2367d715ed06d158cf6953c020340.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_PhzRebq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pc1iwoy5eqpbjf6x3vc6.jpg)
...
[![Alt Text](../Images/8b9a0af87ff1273ae35714a3a651a36b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VjgpztNi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a8y1621v7h8zn52z52e3.png)
...
[![Alt Text](../Images/43695297d7f47a771e362e0b84620cfb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q-FLjIib--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/28sobbssanunw6izmefo.png)

从等式(1.1)我们知道

[![Alt Text](../Images/09cfb8d23c6fd3d3ce4366dd809976f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D5njiEsB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fk7bd0rtqz549wvhwl2a.png)

那么如果我们对 p <sub>i</sub> w.r.t w <sub>j</sub> 取偏导数，除了 w <sub>j</sub> 其他各项都是常数。所以结果会是

[![Alt Text](../Images/d07512b31df81468b577216261343482.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8DOm0ZMG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kcdd21a2fav02hc5r3bi.png)

重新安排

[![Alt Text](../Images/654ea0c30b3a2aeed1e51a5f36effd71.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JOIhbuoY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jscf08t9j19x8gghomom.png)

## [](#matrix-representation)矩阵表示法

矩阵乘法等矩阵运算经过优化，比简单的数组计算更高效。矩阵表示也使方程更具可读性。所以我们将把上述方程转换成矩阵运算

### [](#prediction-using-matrix-multiplication)利用矩阵乘法进行预测

我们可以将公式 1.1 表示为使用矩阵运算来预测一个实例的值，以同时预测所有实例，如下所示

[![Alt Text](../Images/7b449a2154f74a508ff794dde2023c7d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xJeJLU2J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n630w1brg114vh2pagd4.png)
...
### [](#gradient-using-matrix-operations)使用矩阵运算渐变

在等式(4.1)中，我们发现 MSE w.r.t w_j 的偏导数是回归模型的第 j 个系数，它是梯度向量的第 j 个分量。基于等式(4.1)，整个梯度可以使用矩阵运算来表示，例如

[![Alt Text](../Images/92916813204f7e16355ff4762cda555a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZJljjZZq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jyffrqalsjedcfo8o2w3.png)
...
[![Alt Text](../Images/d9e45e40b018c51d60e7d0575d4ed671.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aXNJ4skD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d709dgbsfu4up56u3skd.png)
...
### [](#lets-define-some-functions)让我们定义一些函数
...
[![Alt Text](../Images/d4bef5bad7cfa5fb61805795c6e7d58b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ph-G3LjV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9mqm551layw4e24vbw28.png)
