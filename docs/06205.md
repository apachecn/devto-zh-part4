...
> 原文:[https://dev . to/mornir/create-a-service-account-to-authenticate-with-Google-5b1k](https://dev.to/mornir/create-a-service-account-to-authenticate-with-google-5b1k)
...
# [](#how-to-create-a-service-account)如何创建服务账户
...
# [](#example-using-a-service-account-to-access-google-drive)示例:使用服务帐户访问 Google Drive
...
你可以在地址栏轻松找到这个 ID:
[![shared folder id](../Images/28d7ec54b52ccedb118f611ceeb9abb5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--9asVHU9E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lp0h2cc8moykiemtdj9m.PNG)
