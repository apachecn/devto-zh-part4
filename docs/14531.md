...
> 原文:[https://dev . to/django _ stars/configuring-django-settings-best-practices-2hb 0](https://dev.to/django_stars/configuring-django-settings-best-practices-2hb0)

本文面向使用 Django 框架的工程师。它深入分析了配置 Django 项目设置，以及不同方法的优缺点。在本文中，您还可以找到关于工具、最佳实践和架构解决方案的建议，所有这些都经过了成功项目的时间考验和证明。

## [](#managing-django-settings-issues)管理 Django 设置:问题
