...
> 原文:[https://dev . to/bout houri/complete-guide-to-WordPress-menu-sourcing-in-Gatsby-h76](https://dev.to/bouthouri/complete-guide-to-wordpress-menu-sourcing-in-gatsby-h76)

使用 Gatsby 插件 gatsby-source-wordpress，我们可以从 wordpress 网站上获取几乎所有东西。默认情况下只有两样东西没有，菜单和自定义选项。
这篇博文是关于菜单的。

## [](#1-preparing-the-menu)1。准备菜单
