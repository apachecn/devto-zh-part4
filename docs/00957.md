...
> 原文:[https://dev . to/rx assim/how-I-save-by-using-cloud flare-workers-3883](https://dev.to/rxassim/how-i-save-by-using-cloudflare-workers-3883)

嗨！在这篇文章中(如标题所示),我将向您展示如何使用 Cloudflare Workers 代替 AWS 的 API-Gateway 来代理对 AWS Lambda 函数的请求，从而节省成本。

### [](#why-use-cloudflare-workers-)为什么要用 Cloudflare Workers？
