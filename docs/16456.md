...
> 原文:[https://dev . to/bnevilleoneill/design-patterns-in-node-js-a-practical-guide-4bmk](https://dev.to/bnevilleoneill/design-patterns-in-node-js-a-practical-guide-4bmk)

[![](../Images/c58ec3a0c4359acfe43387ad94838f0b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EiL7DGvO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yj9ygo6aj17dy7kwoaft.png)
...
### [](#simulating-static-variables)模拟静态变量
...
### [](#simulating-private-variables)模拟私有变量
...
### [](#what-does-the-factory-method-pattern-look-like)工厂方法模式是什么样子的？
...
### [](#what-does-the-singleton-pattern-look-like)单例模式是什么样子的？
...
### [](#what-does-the-observer-pattern-look-like)观察者模式是什么样子的？
...
### [](#what-does-the-chain-of-responsibility-look-like)责任链是什么样子的？
