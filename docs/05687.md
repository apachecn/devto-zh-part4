...
> 原文:[https://dev . to/ashleemboyer/build-a-react-firebase-blog-site-part-2-2 INM](https://dev.to/ashleemboyer/build-a-react-firebase-blog-site-part-2-2inm)
...
## [](#1-clone-the-part-2-starter-code-optional)1。克隆(第 2 部分)起始代码[可选]
...
## [](#2-add-a-page-for-creating-posts)2。添加用于创建帖子的页面
