...
> 原文:[https://dev . to/codegram/building-a-ruby-server less-ci-CD-pipeline-35 M5](https://dev.to/codegram/building-a-ruby-serverless-ci-cd-pipeline-35m5)
...
### [](#ci-amp-cd-process-explained)CI & CD 流程讲解
