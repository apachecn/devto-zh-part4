...
> 原文:[https://dev . to/brpaz/assure-the-quality-of-your-docker-images-with-this-cool-tools-1bh 7](https://dev.to/brpaz/ensure-the-quality-of-your-docker-images-with-these-cool-tools-1bh7)
...
## [](#container-structure-test)容器结构试验
...
## [](#security-testing-with-clair)用 Clair 进行安全测试
...
## [](#keep-your-image-sizes-in-control-with-dive)使用 Dive 控制图像尺寸
