...
> 原文:[https://dev . to/johnridesabike/bucklescript-and-association-lists-3e 11](https://dev.to/johnridesabike/bucklescript-and-association-lists-3e11)
...
## [](#association-list-basic-facts)关联列表基本事实
...
## [](#creating-an-association-list)创建关联列表
...
## [](#the-downsides-to-association-lists)关联列表的缺点
...
## [](#when-to-use-association-lists)何时使用关联列表
