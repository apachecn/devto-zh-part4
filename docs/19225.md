...
> 原文:[https://dev.to/giladri/basic-variables-operators-1jak](https://dev.to/giladri/basic-variables-operators-1jak)
...
#### [](#notice-at-the-end-of-each-line-we-must-put-a-semicolon-)**通知！在每一行的末尾，我们必须加上分号('；'))**

什么是“int”？这是一种变量。变量的基本类型有:

# [](#basic-variable-types)**基本变量类型**:
