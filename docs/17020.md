...
> 原文:[https://dev . to/alexandersandberg/creating-a-website-theme-switcher-with-CSS-only-4kp 2](https://dev.to/alexandersandberg/creating-a-website-theme-switcher-with-css-only-4kp2)
...
## [](#what-about-that-empty%C2%A0label)那个空标签呢？
...
## [](#remembering-the-selected%C2%A0theme)记住选中的主题
...
## [](#when-two-themes-arent%C2%A0enough)当两个主题不够用时
