...
> 原文:[https://dev . to/IBM developer/connecting-to-IBM-cloud-databases-for-redis-from-node-js-4h 58](https://dev.to/ibmdeveloper/connecting-to-ibm-cloud-databases-for-redis-from-node-js-4h58)
...
## [](#connecting-to-redis-without-tls-connections)连接到 Redis(无 TLS 连接)
...
## [](#ibm-cloud-databases-for-redis-service-credentials)用于 Redis 服务凭证的 IBM 云数据库
...
## [](#connecting-to-redis-with-tls-connections)连接到 Redis(带 TLS 连接)
...
[![Redis Service Credentials](../Images/cd6cc93504fe2794032072462607d9f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6OoWY0-1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ecu7eduv9u6f343kkurn.png)
