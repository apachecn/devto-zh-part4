...
> 原文:[https://dev.to/nestjs/advanced-nestjs-dynamic-providers-1ee](https://dev.to/nestjs/advanced-nestjs-dynamic-providers-1ee)
...
## [](#setup-a-nestjs-application)设置一个 NestJS 应用
