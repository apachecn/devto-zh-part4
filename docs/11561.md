...
> 原文:[https://dev . to/aduranil/10-docker-compose-and-docker-commands-the-used-for-active-development-22 F9](https://dev.to/aduranil/10-docker-compose-and-docker-commands-that-are-useful-for-active-development-22f9)

当然你可能需要其他的，但是随着时间的推移，我发现这些是我唯一需要或经常使用的，我经常在各种项目中使用`Docker`和`docker-compose`。

#### [](#1-terminal-into-the-docker-container)1。码头集装箱
...
#### [](#2-run-the-docker-container-in-debug-mode)2。在调试模式下运行 docker 容器
...
#### [](#3-build-the-docker-container)3。构建 docker 容器
...
#### [](#4-start-the-docker-container)4。启动 docker 容器
...
#### [](#5-start-the-docker-container-in-the-background)5。在后台启动 docker 容器
...
#### [](#6-see-all-of-the-docker-containers-currently-running)6。查看当前运行的所有 docker 容器
...
#### [](#7-remove-all-docker-containers-in-the-repository)7。删除存储库中的所有 docker 容器
...
#### [](#8-remove-a-specific-docker-container)8。移除特定的 docker 容器
...
#### [](#9-view-all-of-the-docker-images)9。查看所有 docker 图像
...
#### [](#10-clean-out-any-images-builds-etc-that-might-be-hanging)10。清除任何图像、构件等。，那可能是吊死
