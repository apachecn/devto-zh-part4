...
> 原文:[https://dev.to/jasterix/what-actually-is-react-state-19e9](https://dev.to/jasterix/what-actually-is-react-state-19e9)
...
### [](#getting-started-with-state)入门状态

#### [](#setting-the-initial-state)设定初始状态
...
### [](#how-it-all-comes-together)这一切是如何走到一起的

##### [](#codepen)( [codepen](https://codepen.io/jasterix/pen/ZdXvxR)
...
#### [](#difference-between-state-and-props)状态和道具的区别
