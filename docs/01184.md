...
> 原文:[https://dev . to/josiahbryan/personal-safety-GPS-and-machine-learning-you-run-from-danger-43bl](https://dev.to/josiahbryan/personal-safety-gps-and-machine-learning-are-you-running-from-danger-43bl)
...
[![](img/d5566a704844d2e7d14c5c96999fd476.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EwEheYol--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fyyqml69qsy0wb4st0og.png)
...
## [](#formatting-data-ngrams)格式化数据:N 元图
...
# [](#integrating-the-trained-network-into-the-app)将训练好的网络集成到 App 中
...
# [](#change-is-good-or-bad)变化是好的(或坏的)
...
# [](#beta-testers-wanted)Beta 测试员招聘
