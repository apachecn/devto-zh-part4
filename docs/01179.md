...
> 原文:[https://dev . to/alexalexyang/starting-with-saleor-store front-44e 7](https://dev.to/alexalexyang/starting-with-saleor-storefront-44e7)
...
# [](#set-allowedhosts-to-)设置 ALLOWED_HOSTS 为*
...
# [](#deploying-saleorstorefront-to-netlify)将 saleor-storefront 部署到 Netlify
...
# [](#make-sure-backendurl-is-properly-set)确保后端 URL 设置正确
...
# [](#products-page-wont-load-then-404)商品页面不会加载，那么 404
