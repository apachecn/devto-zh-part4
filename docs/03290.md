...
> 原文:[https://dev . to/jeffisadams/rds-and-steping-into-the-plumbing-the-center-of-pain-gj3](https://dev.to/jeffisadams/rds-and-stepping-into-the-plumbing-center-of-pain-gj3)

# [](#rds-and-stepping-into-the-plumbing-center-of-pain)RDS 和步入痛苦的管道中心:
...
[![Fancy plumbing center](img/eb94a331dad7b9e1eac88b4ca360f76c.png "Plumbing")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ln7gG1WI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://tenmilesquare.com/wp-content/uploads/2019/07/antique-bathroom-bathroom-sink-faucet-161417-1024x683.jpg)

## [](#lambda-example-in-a-vpc-backed-by-rds)以 RDS 支持的 VPC 为例
...
## [](#the-serverless-application-model-sam-template)无服务器应用模型(SAM)模板
...
### [](#security-group-plumbing-to-connect-to-lambda)安全组管道连接到 Lambda
...
# [](#the-runtime-guts-but-first-some-init)运行时的胆量(但先点 init)
...
### [](#init-and-user-creation)初始化和用户创建
...
# [](#summary-of-what-we-built)总结我们建造了什么
...
## [](#dont-forget-to-tear-down-the-infrastructure-on-this-one)别忘了拆掉这一个上的基础设施
