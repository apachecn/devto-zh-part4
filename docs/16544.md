...
> 原文:[https://dev . to/kingi dee/build-an-anonymous-chat-app-with-react-react-bootstrap-4h1c](https://dev.to/kingidee/build-an-anonymous-chat-app-with-react-react-bootstrap-4h1c)
...
[![Anonymous-group-chat-app.gif](../Images/c755f6ae4cfbe829e4db391218595fc5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_ESt4h2E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ucarecdn.com/70f941bc-dbf6-4ae5-974f-c846ef9bafa4/)

你可以选择直接进入[代码](https://github.com/cometchat-pro-tutorials/react-anonymous-group-chat)或者浏览我们的分步指南。

## [](#scaffolding-a-new-react-project)搭建一个新的 React 项目
...
## [](#get-the-cometchat-api)获取 CometChat API
