...
> 原文:[https://dev.to/mrmartineau/my-command-line-reference-4d4b](https://dev.to/mrmartineau/my-command-line-reference-4d4b)
...
[https://hub.github.com/](https://hub.github.com/)T2】
...
#### [](#list-the-current-repos-prs)列出当前回购的 PRs
...
### [](#create-a-branch-and-switch-to-it)创建一个分支并切换到它
...
[https://youtube-dl.org](https://youtube-dl.org/)T2】
