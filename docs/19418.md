...
> 原文:[https://dev . to/joshuamdegzman/speed-up-your-Android-project-s-grad le-builds-1366](https://dev.to/joshuamdeguzman/speed-up-your-android-project-s-gradle-builds-1366)
...
## [](#improving-your-project-build-time)改善您的项目构建时间

### [](#1-profile-profile-profile)1。侧写侧写侧写！
...
[![Command Line Options --profile](../Images/7f7fa4a0ea9d6c4ba90e882ef9ed81f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XGNxsZOQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161162-90b50c80-8b11-11e9-8eea-1c341ce19403.png)

这是使用`--profile`运行任务后的示例报告。

[![Build Profile](../Images/2d009ee16d62c3e5e5f90318523cf7ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v_ZH6ot5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161163-90b50c80-8b11-11e9-8b31-4a34374b55ae.png)

### [](#2-always-use-the-latest-gradle-plugin-for-android)2。始终使用最新的安卓 Gradle 插件
...
[![Gradle 5.0](../Images/a58bd112162f4f3b8c1989a8f9778437.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--v06FNi3b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.joshuadeguzman.me/assets/images/improve-gradle-build/step_1_gradle_5.png) 
...
### [](#3-avoid-legacy-multidex)3。避免传统的多指数
...
### [](#4-disable-lint-checks-on-development)4。开发时禁用 lint 检查
...
[![x-lint](../Images/0937591211482aa9445be8dc0cead3a3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sxPtgP8I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161158-901c7600-8b11-11e9-8f22-1e53a7fb21f3.png)

选项 3。执行 Gradle 任务时，通过命令行传递`-x lint`。

比如`./gradlew assembleDebug -x lint`。

### [](#5-disable-multiapk-generation)5。禁用多 APK 生成
...
[![pdevbuild](../Images/c69c83a25cfea5749a98a7980756db56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tyNpq-43--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161157-8f83df80-8b11-11e9-9a0c-c338f2eca278.png)

估计这将减少 5-10%的构建时间。

更多关于[多个 apk](https://developer.android.com/google/play/publishing/multiple-apks)的信息。

### [](#6-include-minimal-resources)6。包括最少的资源
...
### [](#7-disable-png-crunching)7。禁用 PNG 处理
...
### [](#8-configure-dexoptions-wisely)8。明智地配置 DexOptions
...
### [](#9-use-crashlytics-only-when-needed)9。仅在需要时使用 Crashlytics
...
### [](#10-use-static-dependency-versions)10。使用静态依赖版本
...
### [](#11-enable-build-caching)11。启用生成缓存
...
### [](#12-configure-the-heap-size-for-the-jvm)12。配置 JVM 的堆大小
...
### [](#13-modularize-your-project)13。模块化您的项目

模块化您的项目代码库允许 Gradle build 系统**只编译您修改的模块**并缓存那些输出用于将来的构建。

这里有一个项目模块化的快速概述。

[![Modularization Sample 1](../Images/bc107aecd749a6c1d9db61a688d54623.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qpZC2NGh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161159-901c7600-8b11-11e9-81c0-7beeeef3ab8c.png)

构建系统如何基于模块特定的更改来编译项目。

[![Modularization Sample 2](../Images/785f004b4a58bf2cf4871b8a96a39a23.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2hXhnV0N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161160-901c7600-8b11-11e9-9997-79a47f7f0692.png)
...
### [](#14-runnersup-alwayson-daemon-parallel-build-execution-and-configure-on-demand)14。亚军:永远在线的守护进程，并行构建执行，按需配置。

#### [](#gradle-daemon)Gradle 守护进程
...
#### [](#parallel-build-execution)并行构建执行
...
[![Google I/O 2018 Android App](../Images/73afe0e0f947f583e400ae9ce45a23fd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--JIi5J9gn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/20706361/59161161-90b50c80-8b11-11e9-917d-fdd5bf6d1c93.png) 。
