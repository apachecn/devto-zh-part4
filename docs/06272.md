...
> 原文:[https://dev . to/shahzaibkhalid/promise-all-es 2015-vs-promise-all settled-es 2020-what-s-changed-3k9d](https://dev.to/shahzaibkhalid/promise-all-es2015-vs-promise-allsettled-es2020-what-s-changed-3k9d)
...
### [](#promiseall-shortcircuits-if-any-of-the-promises-is-rejected)Promise.all(如果任何承诺被拒绝，则短路)
...
### [](#promiseallsettled-does-not-shortcircuits)Promise.allSettled(不短路)
