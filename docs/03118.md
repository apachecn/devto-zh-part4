...
> 原文:[https://dev . to/n 350071/run-JavaScript-by-capybara-feature-test-ob8](https://dev.to/n350071/run-javascript-by-capybara-feature-test-ob8)
...
## [](#one-more-tips-evaluatescript)💚还有一个技巧:evaluate_script
