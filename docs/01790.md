...
> 原文:[https://dev . to/gite den/how-to-easy-reuse-components-cross-projects-and-repositories-5f4m](https://dev.to/giteden/how-to-easily-reuse-components-across-projects-and-repositories-5f4m)

### [](#build-distribute-and-collaborate-over-components-to-build-multiple-projects-and-applications-a-practical-guide)构建、分发和协作组件以构建多个项目和应用程序——实用指南。
...
[![](img/ae6dca4df52e07c92cd7533b842589a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NcOCKixN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2Ankut1cR3cVxOEimY)

[![](img/e3410d8469686a81074dd9cf54616979.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t3z5qsFP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2A0cWDJApJ-f3C8NhB.png)

这些都是很深的问题，从组件开发的 monorepo 体验到组件的跨存储库管理，等等。在本帖中，我们将看到如何利用有用的工具和工作流来开发、分发和采用跨项目的组件。

## [](#frameworkno-framework)框架/无框架
...
## [](#monorepo-experience-for-multiple-repositories)针对多个存储库的 Monorepo 体验？
...
## [](#distribution-and-consumption-across-repositories)跨存储库的分发和消耗

当你发布你的组件时，事情还远没有结束。你必须确保人们能够找到、使用和更新这些组件。

否则，你可能会白白投入这些工作；大多数人不会花太多心思去寻找你的组件，也不会采用那些他们不能修改的组件。深入整个库并仅针对一个组件进行更新可能是一个繁琐的过程。

## [](#set-up-a-shared-component-portal-make-it-look-good)设置共享组件门户；弄得好看点！

[![](img/902743d1f8f971c65f7c1e9e9b3f7f41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l8xQEyg3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2ATilCCJsC56-IB69s.gif)
...
[![](img/d2fc26ae38e579d832745ce0be2931e6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Hvl_qpjN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2ANPpjz0Jyl-ukCOmU.gif)

*[bit . dev](https://bit.dev)——寻找、学习、尝试、安装组件*

## [](#enable-a-single-or-bulk-components-update-not-the-whole-library)启用单个或批量组件更新；不是整个图书馆
...
## [](#enable-component-modifications-and-updates-from-any-consuming-repository-manage-and-control-changes-across-projects)启用来自任何消费库的组件修改和更新；管理和控制跨项目的变更
...
## [](#component-design-system-for-developers)面向开发者的组件设计系统
...
## [](#visual-design-system-with-actual-code-components)可视化设计系统与实际代码组件

[![](img/bd0b75999cf1b34924258413f323c83c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j_Obm4KU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2708/0%2A9enzdHDn0oXDClut.png)
...
## [](#component-library-design-system-workflow)构件库设计系统工作流程

使用 Bit 可以在库中独立地构建、打包和发布组件。然后，您可以将它们导出到 bit.dev，在那里它们成为由实际的源代码组件组成的可视化设计系统。

[![](img/b1ad8f5570f64b956e569b2851d0a61b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fTMHVDMS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2A6aYnxx_muzTkiGQR.png)
