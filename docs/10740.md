...
> 原文:[https://dev . to/devopscar/increasing-ci-CD-pipeline-observability-in-Jenkins-x-5e0i](https://dev.to/devopsoscar/increasing-ci-cd-pipeline-observability-in-jenkins-x-5e0i)
...
# [](#what-we-are-doing-today)我们今天在做什么
...
[![Components](../Images/54dac25cef99479fa061532ae1b44ef2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vO8oNudt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://peter.bourgon.org/img/instrumentation/01.png)

作者:Peter Bourgon

## [](#leveraging-thirdparty-tools)利用第三方工具
...
### [](#tracing-cicd-pipeline-events)跟踪 CI/CD 管道事件
...
#### [](#create-kubernetes-secret)创造永恒的秘密
...
#### [](#modify-tekton-pipeline)修改 Tekton 管道
...
[![Honeycomb Dashboard](../Images/cc63423bd4477237b9c031604985602a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0Q6uDBO7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jenkins-x.io/news/jenkins-x-observability/honeycomb_trace_example.png)
...
## [](#jenkins-world-devops-world-2019)詹金斯世界| DevOps 世界 2019
