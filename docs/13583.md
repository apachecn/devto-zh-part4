...
> 原文:[https://dev . to/amiryusefi _/laravel-authorization-and-roles-permission-management-172 a](https://dev.to/amiryousefi_/laravel-authorization-and-roles-permission-management-172a)
...
### [](#creating-roles-and-permissions)创建角色和权限
...
### [](#creating-an-access-list-for-user-permissions)为用户权限创建访问列表
...
### [](#laravel-authorization-using-middleware)使用中间件进行授权
