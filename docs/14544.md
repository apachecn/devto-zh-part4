...
> 原文:[https://dev.to/suntong/using-squid-to-proxy-ssl-sites-nj3](https://dev.to/suntong/using-squid-to-proxy-ssl-sites-nj3)
...
### [](#generate-a-ca-certificate-to-be-used-by-squid)生成一个由 Squid 使用的 CA 证书
...
#### [](#configure-squid-to-peeknslice-ssl-connections)配置 Squid 到 Peek-N-Slice SSL 连接
...
### [](#import-certificate-ca-into-the-browser-for-squid)为 Squid 将证书 CA 导入浏览器
...
[![chrome-ssl-warning.png](../Images/90cb8483d63b88cd3970a2f31f8beb41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wv5o79gX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://seacloud.cc/d/480b5e8fcd/files/%3Fp%3D/squid-ssl-proxy/chrome-ssl-warning.png%26raw%3D1)

所以在地址栏输入`chrome://settings/certificates`，然后导入**权限**部分下的 CA 证书，并确保选择该证书来验证*网站*:

[![chrome-trust-ca.png](../Images/b6facde0765ff6939c747165a67a237e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zb2ZzNsh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://seacloud.cc/d/480b5e8fcd/files/%3Fp%3D/squid-ssl-proxy/chrome-trust-ca.png%26raw%3D1)

最后，确认证书已导入:

[![chrome-squid-cert-imported.png](../Images/9618470e6c2168537f3cbdd8b03085dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XxucbJAv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://seacloud.cc/d/480b5e8fcd/files/%3Fp%3D/squid-ssl-proxy/chrome-squid-cert-imported.png%26raw%3D1)

现在，如果您访问任何网站，您的浏览器都会信任 Squid CA，因为 Squid 会为该主机名生成一个动态证书:

[![chrome-trusts-squid-ca.png](../Images/3385957c4e380f90a5cc1074531a2210.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8sbEASDC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://seacloud.cc/d/480b5e8fcd/files/%3Fp%3D/squid-ssl-proxy/chrome-trusts-squid-ca.png%26raw%3D1)

#### [](#check-out-squid-logs)查看鱿鱼日志
...
### [](#using-a-proxy-autoconfig-pac-file-to-specify-proxy-settings)使用代理自动配置(PAC)文件来指定代理设置
...
#### [](#secure-proxy-connections)安全代理连接
...
[![websafety-web-traffic.png](../Images/3bdaebbe5d09417d23fc000e196065c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RZz1dIql--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://seacloud.cc/d/480b5e8fcd/files/%3Fp%3D/squid-ssl-proxy/websafety-web-traffic.png%26raw%3D1)