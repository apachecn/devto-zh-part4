...
> 原文:[https://dev . to/wolverineks/an-example-of-improving-readability-in-a-react-component-27hb](https://dev.to/wolverineks/an-example-of-improving-readability-in-a-react-component-27hb)
...
### [](#platform-specific-imports)平台特定进口
...
### [](#what-does-a-raw-switch-endraw-statement-do)一个`switch`语句做什么？
