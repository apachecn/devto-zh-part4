...
> 原文:[https://dev . to/dev team/feedback-on-this-new-dev-feature-5cai](https://dev.to/devteam/feedback-on-this-new-dev-feature-5cai)
...
[![ben](../Images/fe64a787b888dfb20fc13ad1e466da3d.png)](/ben) [## 你周末编码吗？多久一次，你的日常生活是怎样的？

### 本哈尔彭 6 月 15 日 191 分钟阅读

#discuss](/ben/do-you-code-on-the-weekend-how-often-what-s-your-routine-like-4h00)

### [](#and-before-getting-into-what-ive-been-up-to-this-weekend)在谈论我这个周末都在做些什么之前:

[![ben](../Images/fe64a787b888dfb20fc13ad1e466da3d.png)](/ben) [## 在工作中只写代码是非常好的，不要让任何人告诉你其他的事情。
...
## [](#first-create-the-poll-in-separate-ui-and-then-drop-in-to-a-post-like-this)首先在单独的用户界面中创建投票，然后进入如下帖子:
...
## [](#define-the-poll-entirely-inline)定义完全内嵌的投票:
