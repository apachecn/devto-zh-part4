...
> 原文:[https://dev . to/ph1/a-nice-way-to-test-redux-reducers-and-actions-2 npe](https://dev.to/ph1/a-nice-way-to-test-redux-reducers-and-actions-2npe)
...
### [](#action-creator-tests-are-unnecessary)动作创建者测试是不必要的
...
[![isolated tests of action creator and reducer](../Images/5a5d69884c264b10711add3276dad88f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gTPVhiiE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.thepete.net/images/post_images/testing-redux-reducers/diagram-isolated.jpg)

我们所做的是一个更广泛的测试，将动作创建者和缩减者作为一个单元一起覆盖。

[![integrated tests covering both action creator and reducer](../Images/5f447d49648c216af50fd4b355c41858.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8SkBqo7L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.thepete.net/images/post_images/testing-redux-reducers/diagram-integrated.jpg)
...
[![a duck - action creators present public API to reducer](../Images/1ae53ecfa779f0985f68b19cda87a2bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--unUx0TBS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.thepete.net/images/post_images/testing-redux-reducers/diagram-duck.jpg)
...
## [](#the-duck-is-the-right-unit-to-test)鸭子是正确的测试单位
