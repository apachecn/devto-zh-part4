...
> 原文:[https://dev . to/shawonashraf/swift-the-curious-generic-of-associated-types-3747](https://dev.to/shawonashraf/swift-the-curious-genericness-of-associated-types-3747)

### [](#before-we-dig-deep-protocols)在我们深挖之前，协议！
...
### [](#chasing-the-wabbitwhats-an-associated-type)追逐兔子.....什么是关联类型？
...
### [](#a-bit-formal-definition)有点正式的定义
...
### [](#so-interfaces-ugh-protocols-can-be-generic-eh)所以接口诶，协议可以通用诶？
