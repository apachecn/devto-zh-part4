...
> 原文:[https://dev.to/eadanfahey/aws-lambda-vpc-networking-p3a](https://dev.to/eadanfahey/aws-lambda-vpc-networking-p3a)
...
[![Route table of a public subnet](../Images/7368b4853766e20aea79ab97560f3c3e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tCalLBMC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2fcn8xbs8er2rg3nvjc1.png)
...
## [](#create-a-nat-gateway)创建一个 NAT 网关
...
## [](#configure-vpc-gateway-endpoints)配置 VPC 网关端点

这最后一步是可选的，但建议减少 NAT 网关的数据传输成本。
分配给专用子网的路由表应该如下所示:

[![Private subnet route table](../Images/d0c98c26f81bcdb73606c30080e52a93.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ElFx4I6T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s92ck2psvz7qmovyi8za.png)
...
[![Route table with gateway endpoints for S3 and DynamoDB](../Images/dfb2fd072344612d01d78967bba25516.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GU11Xm2o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nbm8fri6rqnh28k8692v.png)

## [](#configure-the-lambda-function)配置λ功能
...
[![VPC network diagram for the Lambda function](../Images/58c3c5e35b7f2d0781be3051d105f0df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3L4jLPU_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i8o2p7xcq3h7mmdwk6i7.png)
