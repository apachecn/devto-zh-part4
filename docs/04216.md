...
> 原文:[https://dev . to/bnevilleoneill/adding-spinners-and-notifications-to-your-react-app-35pc](https://dev.to/bnevilleoneill/adding-spinners-and-notifications-to-your-react-app-35pc)
...
[![Books List With Loading Spinner](img/9d2661e45959de8e0f9cdca1cc0f5735.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dqK6uFyS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/blog.logrocket.com/wp-content/uploads/2019/08/books-list-spinner-notification.png%3Fresize%3D730%252C612%26ssl%3D1)

您可以调整微调器的背景颜色，当然也可以使用定制的微调器。在这里，我的目标只是展示何时何地可以使用微调器，以及如何设置微调器。

## [](#configuring-notifications-with-reactnotifications)用 react-notifications 配置通知
...
### [](#setting-up-the-notification-container)设置通知容器
...
### [](#setting-notifications-from-components)设置来自组件的通知
...
## [](#configuring-notifications-with-reacttoastify)用 react-toastify 配置通知
...
[![Our App In A Web Browser](img/e48d3b4f4cba52c060416d280209ea08.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--33Tt5vD_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blog.logrocket.com/wp-content/uploads/2019/08/web-app-browser.png%3Fresize%3D730%252C614%26ssl%3D1)
...
### [](#reacttoastify-installation)反应-烘烤安装
