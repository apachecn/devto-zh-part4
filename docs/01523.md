...
> 原文:[https://dev . to/pur Wnt/getting-started-tailwindcss-with-grid some-without-using-plugin-2la](https://dev.to/purwnt/getting-started-tailwindcss-with-gridsome-without-using-plugin-2la)
...
### [](#1-instal-gridsome-cli)**1。安装 Gridsome cli**

*   使用**纱线** : `yarn global add @gridsome/cli`
*   使用 **NPM** : `npm install --global @gridsome/cli`

### [](#2-create-new-gridsome-project)**2。创建新的 Gridsome 项目**
...
### [](#3-install-tailwindcss)**3。安装尾翼**

*   `npm i tailwindcss`

### [](#4-add-tailwind-config-file)**4。添加顺风配置文件**
...
### [](#5-import-tailwind-to-gridsome)**5。将顺风导入网格体**
...
### [](#6-add-tailwindcss-to-gridsome-configuration-file)**6。将 tailwindcss 添加到 gridsome 配置文件**
...
[![Alt Text](img/2f7015807bd457192e9299cb636b79f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YLSzXsTP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/egyerkgk9s18kqo39zs5.PNG)

在浏览器上转到 [http://localhost:8080](http://localhost:8080) 并查看结果

[![Alt Text](img/a180e993a41fe61e632b631709b815f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nM-LUnvh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n044ur0slkonnpmgm9du.PNG)

对于生产，你需要运行 build `gridsome build`并将文件夹`dist`中的文件发送到你的网络服务器、亚马逊 S3 或谷歌云存储。

[![Alt Text](img/535b56ac8fbafaf3330df8e0d3a57b3f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5h7yY_2F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2j7yecgype5v71vkpzx9.PNG)
