...
> 原文:[https://dev . to/Shu bho/elastic-search-update-by-query-with-ingest-pipeline-2k 16](https://dev.to/shubho/elastic-search-update-by-query-with-ingest-pipeline-2k16)
...
## [](#updating-elasticsearch-field-value-using-regular-expressions)使用正则表达式更新 Elasticsearch 字段值
...
## [](#ingest-pipeline-and-update-by-query)通过查询摄取管道并更新
