...
[![Logo](../Images/04d790f5a21bdd3bb669549f81cdf603.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ehCqh_1R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.ibb.co/TkzPNnk/1-CIJ0-LEa6-ZR17-GFZSjy2ce-Q.png)

# [](#angular-truffle-%C3%B0apps)有角+松露=💓-应用程序
...
### [](#1instalamos-el-cli-de-angular-y-truffle-para-descargar-la-truffle-boxen-la-cual-estar%C3%A1-todo-lo-que-necesitemos-para-nuestra-dapp)1 .我们安装角& truffle CLI 下载“truffle box”，其中将包含我们的 DAPP 所需的一切。
...
### [](#4compilar-y-migrar-el-contrato-inteligente)4。智力竞赛和移民
...
### [](#6-instalar-metamask)6。Instalar Metamask
