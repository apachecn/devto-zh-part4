...
> 原文:[https://dev . to/magnus trale/net-framework-to-net-core-to-docker-3m3b](https://dev.to/magnusstrale/net-framework-to-net-core-to-docker-3m3b)
...
### [](#resources-and-resx%C2%A0files)资源和 Resx 文件
...
### [](#hosting-in-kestrel-and%C2%A0owin)托管在红隼和 OWIN
...
### [](#dotnet-from-the-command%C2%A0line)来自命令行的 Dotnet
...
### [](#putting-it-in%C2%A0docker)放入 Docker
...
### [](#time-zones-and-docker-containers)时区和码头集装箱
...
### [](#final-dockerization-pieces)最终对接件
