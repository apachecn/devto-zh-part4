...
> 原文:[https://dev . to/ashleemboyer/re-create-a-image-with-colorful-text-2 lmk](https://dev.to/ashleemboyer/re-create-an-image-with-colorful-text-2lmk)
...
## [](#1-set-up-your-html-amp-js)1。设置你的 HTML & JS
...
## [](#2-draw-your-image-on-the-raw-canvas-endraw-)2。在`canvas`上绘制您的图像
...
## [](#3-get-the-raw-imagedata-endraw-)3。拿到`ImageData`
...
## [](#4-iterate-to-get-pixel-colors)4。迭代获取像素颜色
...
## [](#5-append-some-containers)5。添加一些容器
