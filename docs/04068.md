...
> 原文:[https://dev . to/dsle may/functors-and-monads-30 days offp-week-3-Lao](https://dev.to/dslemay/functors-and-monads-30daysoffp-week-3-lao)

函子和单子听起来可能像是函数式编程深处的某种黑暗的秘密成分。出于我们的目的，我们将把它们作为遵循一组基本规则的数据类型来对待。在这篇文章中，我们将深入研究函子和单子的工作定义，以及将它们联系在一起的工作示例。

## [](#what-is-a-functor)什么是函子
