...
> 原文:[https://dev.to/jay_tillu/identifiers-in-kotlin-1dl9](https://dev.to/jay_tillu/identifiers-in-kotlin-1dl9)

*   标识符是给予对象、变量、类和函数等的名称。例如:var 年龄= 45

*   这里`var`是一个关键字，年龄是变量的名称。

## [](#rules-for-naming-identifiers)命名标识符的规则
