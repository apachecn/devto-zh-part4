...
> 原文:[https://dev . to/nore dink/drag-drop-without-draggables-drop zones-2be 5](https://dev.to/noredink/drag-drop-without-draggables-dropzones-2be5)
...
## [](#a-refresher-on-draggables-amp-dropzones)一个关于 Draggables 的复习& Dropzones
...
[![A screenshot of the Trello app, showing a card being dragged from one list to another.](../Images/d15b4007e38315413bdbcb8be6b7487b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZtivznQK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/x9lpraW.png)
...
## [](#our-first-example-a-timeslot-selector)我们的第一个例子，时隙选择器

我们的第一个例子是选择一天中某个时间段的 UI。这个 UI 将一天表示为一个水平条，我们可以在其中使用拖放来选择一个时间段。

[![Dragging to select a continuous region of time across a bar showing the hours of the day.](../Images/7ebbc2578509b1591f964041d416102f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HGz4jZjs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/U0Ft47l.gif)
...
## [](#second-example-a-polygon-editor)第二个例子，多边形编辑器

我们的第二个例子是一个编辑多边形的工具。我们希望用户能够选择一个多边形的顶点，并将其移动到其他地方。

[![Dragging a vertex of a polygon](../Images/7490cbd532e4e188cc514977860ec6ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Oq0Ng3Yn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/tpsNuZS.gif)
...
## [](#last-example-an-outline-editor)最后一个例子:一个大纲编辑器
...
[![Grabbing a node of an outline and dragging it to a different parent node](../Images/7f6279727756e15eec249c0e7d993b8c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rJOPHNKa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/0MuKonT.gif)
...
### [](#moving-nodes-in-an-outline)移动轮廓中的节点
...
## [](#necessary-javascript)必要的 JavaScript
