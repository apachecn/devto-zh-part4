...
> 原文:[https://dev . to/sophia Brandt/learning-react-step-by-step-part-0-48la](https://dev.to/sophiabrandt/learning-reasonreact-step-by-step-part-0-48la)
...
# [](#clean-up-webpack-etc)清理 Webpack 等。
...
# [](#create-the-first-component)创建第一个组件
