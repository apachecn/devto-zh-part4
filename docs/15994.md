...
> 原文:[https://dev . to/dazuma/deploying-my-blog-to-Google-cloud-run-kkl](https://dev.to/dazuma/deploying-my-blog-to-google-cloud-run-kkl)
...
## [](#why-serverless-for-static-sites)为什么静态网站要无服务器？
...
### [](#creating-and-testing-a-jekyll-project)创建和测试 Jekyll 项目
...
### [](#creating-a-production-docker-image)创建生产对接图像
...
[![Diagram of the build process](../Images/3c52182718be716c8ed36692a8bcbb8a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J8zrLlFj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daniel-azuma.com/img/posts/jekyll-cloud-run-diagram.png)
...
#### [](#writing-the-dockerfile)编写 Dockerfile
...
#### [](#testing-your-image-locally)在本地测试您的映像
