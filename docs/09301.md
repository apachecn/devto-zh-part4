...
> 原文:[https://dev . to/maciekgrzybek/make-your-website-live-with-server less-framework-little-bits-16gj](https://dev.to/maciekgrzybek/make-your-website-live-with-serverless-framework-little-bits-16gj)

[![Little Bits](../Images/b3bfc6e068d752ad6c48ddffbf9cc41b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LYltK6hi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/practicaldev/image/fetch/s--kDnOm6Tc--/c_imagga_scale%2Cf_auto%2Cfl_progressive%2Ch_420%2Cq_auto%2Cw_1000/https://thepracticaldev.s3.amazonaws.com/i/ktl98648vzd366rxgst6.jpg)

##### [](#little-bits-is-a-series-of-short-articles-explaining-quick-solutions-to-common-dev-problems-no-unnecessary-descriptions-or-code-snippets-no-bullshit)Little Bits 是一系列短文，解释常见开发问题的快速解决方案。没有不必要的描述或代码片段。不废话。

#### [](#what-we-are-going-to-do)我们要做什么？

将 [GatsbyJS](https://www.gatsbyjs.org/) 项目部署到 [AWS S3](https://aws.amazon.com/s3/) 桶中，使用实时 URL 查看网站。

#### [](#what-tools-we-are-going-to-use)我们要用什么工具？
...
### [](#1-create-aws-account)1。创建 AWS 帐户。

不言自明。要开始使用 AWS，您需要创建一个帐户。注意:你必须添加你的信用卡详细信息，但是不要担心，AWS 有免费的等级，你可能不会检查它们。除非你会使用一些大规模的人工智能计算，并坚持 S3，你是排序。
[![AWS Web console](../Images/b7cc99948f30a712c63eb024c2e8752d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--swH1Mwqu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://articles-images-123123123898989.s3-eu-west-1.amazonaws.com/Screen%2BShot%2B2019-08-05%2Bat%2B13.13.45.png)

### [](#2-setup-credentials)2。设置凭据

##### [](#install-serverless-framework-globally)全局安装无服务器框架。
...
##### [](#create-an-iam-user-and-access-key)创建一个 IAM 用户和访问密钥

登录您的 AWS 帐户，并转到身份和访问管理(IAM)部分。创建具有管理员权限的新用户。

##### [](#setup-aws-credentials-on-your-machine)在您的机器上设置 AWS 凭证
...
### [](#3-create-gatsby-starter-project)3。创建 gatsby starter 项目。
...
### [](#4-install-the-serverless-project-and-serverlessfinch-plugin)4。安装无服务器项目和无服务器 finch 插件。
...
### [](#5-setup-configuration-for-the-plugin)5。插件的设置配置。
