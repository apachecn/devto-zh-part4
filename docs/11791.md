...
> 原文:[https://dev . to/Alex MacArthur/a-simpler-unit-testing-setup-for-WordPress-1ki 9](https://dev.to/alexmacarthur/a-simpler-unit-testing-setup-for-wordpress-1ki9)
...
#### [](#install-phpunit-with-composer)用 Composer 安装 PHPUnit。
...
#### [](#lets-make-things-more-wordpressy)让我们把事情变得更 WordPress-y。
...
## [](#yeah-tradeoffs-exist)是啊，取舍是存在的
...
## [](#feedback-whatcha-got)反馈:你得到了什么？
