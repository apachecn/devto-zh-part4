...
> 原文:[https://dev . to/tylerd/deploying-azure-resources-to-multi-resource-groups-3872](https://dev.to/tylerd/deploying-azure-resources-to-multiple-resource-groups-3872)
...
## [](#deploying-to-multiple-azure-resource-groups)部署到多个 Azure 资源组
...
### [](#subscriptionlevel-templates-3)订阅级模板(#3)
...
## [](#extra-tip-using-the-raw-templatelinkuri-endraw-property)额外提示:使用`templateLink.uri`属性
