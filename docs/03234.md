...
> 原文:[https://dev . to/prestonjlamb/flexible-caching-and-refresh-with-rxjs-in-angular-hlo](https://dev.to/prestonjlamb/flexible-caching-and-refreshing-with-rxjs-in-angular-hlo)
...
## [](#flexibility-in-caching-data)灵活缓存数据
