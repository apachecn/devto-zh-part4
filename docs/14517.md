...
> 原文:[https://dev . to/florantara/creating-a-drag-drop-list-with-react-hooks-4c0i](https://dev.to/florantara/creating-a-drag-and-drop-list-with-react-hooks-4c0i)
...
### [](#about-the-datatransfer-object)关于数据传输对象
...
## [](#make-the-items-draggable)使项目可拖动
...
[![](../Images/9e58aa8d1a3cc390d3887eb82b637eb2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WKFQsioK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6h6f5ntbw5m2n9y5sjke.gif)

<figcaption>Nice! They can be dragged now</figcaption>

</figure>

### [](#convert-them-into-drop-areas)将它们转换成拖放区
...
## [](#hook-up-the-raw-ondragstart-endraw-)勾搭上了`onDragStart`
...
## [](#hook-up-the-raw-ondragover-endraw-)勾搭上了`onDragOver`
...
### [](#get-the-full-code-example-on-this-pen)获取这支笔的完整代码示例:
