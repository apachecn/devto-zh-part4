...
> 原文:[https://dev . to/lankydandev/corda-connecting-a-ktor-web-server-to-a-corda-node-1k3j](https://dev.to/lankydandev/corda-connecting-a-ktor-web-server-to-a-corda-node-1k3j)
...
## [](#high-level-look-at-the-code)高水平看代码
...
## [](#gracefully-disconnecting-from-a-node)优雅地从一个节点断开
