...
> 原文:[https://dev.to/luisejrobles/un-vistazo-a-git-aliases-2kop](https://dev.to/luisejrobles/un-vistazo-a-git-aliases-2kop)

如果我们出于某种原因或决心在编程方面处于领先地位，你可能已经意识到，在这个行业中，很多工作都是与你错误地认为的相反的合作，当这是其中一个不可或缺的工具时，它就是**【git】**。这次轮到写关于 **git 别名**的文章了。

#### [](#qu%C3%A9-son-los-git-aliases)Qué son los git 别名？

**别名**或姓氏是别名或‘昵称’，它们被分配给我们已经知道的 git 命令。

#### [](#c%C3%B3mo-lo-hacemos)我们这样做吗？
...
[![](../Images/d203ec64aa56725a2f654c722a7ea23e.png)T2】](https://i.giphy.com/media/s2qXK8wAvkHTO/giphy.gif)
