...
> 原文:[https://dev . to/jscrambler/easy-custom-web pack-setup-for-react-js-applications-35 F8](https://dev.to/jscrambler/easy-custom-webpack-setup-for-react-js-applications-35f8)
...
[![Webpack Popularity](../Images/fb46263b920f3cccc84371bc42dafb41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cYmjZjDp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.jscrambler.com/content/images/2019/07/jscrambler-blog-easy-custom-webpack-setup-react-applications-webpack-popularity.png)

请在这个 [GitHub repo](https://github.com/JscramblerBlog/Jscrambler-Webpack-React) 中找到完成的项目代码。

## [](#compilation-requirements-of-a-simple-web-application)简单 Web 应用程序的编译要求
...
## [](#setting-up-webpack-for-a-simple-web-application)为简单的 Web 应用程序设置 webpack
...
### [](#compiling-react-jsx-to-javascript-presets)编译反应 JSX 到 JavaScript(预置)
...
### [](#output-a-single-css-file)输出单个 CSS 文件
...
### [](#output-a-single-javascript-file)输出单个 JavaScript 文件
...
确保将图像存储在文件夹`src/images/imagename.jpg`中。
...
### [](#set-up-file-watching)设置文件观看

由于我们正在使用`webpack-dev-server`，我们自动获得文件监视和自动重载。

## [](#setting-up-webpack-for-more-advanced-web-applications)为更高级的 Web 应用程序设置 webpack

除了上面的简单设置，让我们为稍微复杂一点的应用程序添加更多的特性。

### [](#setting-up-hot-module-replacement)设置热模块更换
...
### [](#splitting-output-javascript-files-into-separate-files)将输出的 JavaScript 文件拆分成单独的文件
...
### [](#create-production-files)创建生产文件
...
### [](#clear-output-folders-before-regeneration)重新生成前清除输出文件夹
...
### [](#custom-html-template)自定义 HTML 模板
...
### [](#serving-other-static-asset-types)服务于其他静态资产类型
...
## [](#protecting-webpack-bundle-files)保护 webpack 捆绑文件
