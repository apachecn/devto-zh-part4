...
> 原文:[https://dev . to/makcedward/unsupervised-data-augmentation-3 ico](https://dev.to/makcedward/unsupervised-data-augmentation-3ico)

[![](../Images/c6f74db6de788fb895aee24edbbf9770.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Xr2DjAHb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2A1NvpsIcE3_oTbHQ_) 

<figcaption>照片由上[下](https://unsplash.com/?utm_source=medium&utm_medium=referral)</figcaption>

#### [](#a-look-at-data-augmentation-towards-ai)一看数据增强| [走向人工智能](https://towardsai.net)
...
### [](#augmentation-strategies)增强策略

本节将介绍计算机视觉(CV)和自然语言处理(NLP)领域中的三种数据增强。

#### [](#autoaugment-for-image-classification)图像分类的自动增强
...
[![](../Images/f8f529a880fff0f51dee26bb31241442.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--oBnjiQHh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/630/1%2AnwnEJoSn5-sxNpG6DOlFVA.png) 

<figcaption>自动增强生成的结果(Cubuk et al .，2018)</figcaption>

#### [](#back-translation-for-text-classification)反向翻译用于文本分类
...
[![](../Images/706ab346405e7ea631bad40744634ddb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tyNPDcdr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/926/1%2APkj0hnD43MJuMUUAgHpwKA.png) 

<figcaption>【例子】(谢等，2019)</figcaption>

#### [](#tfidf-based-word-replacing-for-text-classification)基于 TF-IDF 的文本分类单词替换
...
### [](#training-signal-annealing-tsa)训练信号退火(TSA)

在使用上述技巧生成大量数据后，谢等人注意到该模型容易过拟合。因此，他们引入了 TSA。在模型训练期间，具有高置信度的样本将从损失函数中移除，以防止过度训练。

下图显示了ηt 的取值范围，而 K 是类别数。如果概率高于ηt，它将从损失函数中移除。

[![](../Images/62381f82cc264ec74b21814d31eeea03.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--WU6aAdCd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/346/1%2AITyrjAHpn21ua7bDkSBaNQ.png) 

<figcaption>去除高概率门槛的例子(谢等，2019)</figcaption>

[![](../Images/f47003dc966f30c2729d7879576c7995.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PWEZxt-A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/546/1%2Awts7wcoL1hsED_5eaNGyuA.png) 
...
[![](../Images/313b02d26042d65f4c359954ca680d06.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--U6h9atXe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/491/1%2AwJrF9YPqo5VmxKc1yk5Tmw.png) 
