...
> 原文:[https://dev.to/elba/testing-in-next-js-dynamic-imports-20jn](https://dev.to/elba/testing-in-next-js-dynamic-imports-20jn)
...
## [](#babel-plugin-for-dynamic-imports)用于动态导入的巴别塔插件
...
## [](#mock-raw-nextdynamic-endraw-implementation)嘲弄`next/dynamic`实现
