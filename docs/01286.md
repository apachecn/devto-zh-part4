...
> 原文:[https://dev . to/sophiabrandt/neovim-and-language client-for-elixir-1p8b](https://dev.to/sophiabrandt/neovim-and-languageclient-for-elixir-1p8b)
...
### [](#elixirls-installation)仙丹-ls 安装
