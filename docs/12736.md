...
> 原文:[https://dev . to/toddanglin/upgrading-older-native script-apps-to-use-web pack-3e 15](https://dev.to/toddanglin/upgrading-older-nativescript-apps-to-use-webpack-3e15)
...
## [](#delete-old-generated-javascript-files)删除旧生成的 JavaScript 文件
...
## [](#rename-files-to-register-as-modules)重命名文件以注册为模块
...
### [](#cleanup-the-rename-mess)收拾重命名的烂摊子
...
## [](#-raw-frame-endraw-element-is-now-required)`Frame`元素现在是必需的
...
## [](#builder-raw-parse-endraw-vs-raw-load-endraw-)建造者`parse` vs `load`
...
## [](#debugging-the-errors)调试错误

即使是最彻底的升级，当你第一次启动你的应用程序时，你也可能会遇到一些新的与 webpack 相关的运行时错误。以下是我遇到的两个常见错误，以及我是如何克服它们的:

### [](#fixing-raw-module-not-found-endraw-errors)修复`Module not found`错误
...
### [](#fixing-raw-module-parse-failed-endraw-errors)修复`Module parse failed`错误
...
### [](#doublecheck-for-circular-references-in-barrel-files)仔细检查桶文件中的循环引用
