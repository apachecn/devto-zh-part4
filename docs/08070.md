...
> 原文:[https://dev . to/San fra 1407/had-you-even-heard-on-vue-functional-components-G3](https://dev.to/sanfra1407/have-you-ever-heard-about-vue-functional-components-g3)
...
## [](#what-is-a-vue-component)什么是 Vue 组件？
...
基本上 Vue [创建它的实例](https://vuejs.org/images/lifecycle.png)，增加反应性并安装组件。所有没用的东西，因为`SmartComponent`不会使用反应性。而且，正如我已经说过的，最后一捆会更重。
...
#### [](#the-functional-keyword)功能关键字

嗯，你很容易猜到，`functional`关键字是用来对 Vue 说:“*嘿，我要写一个功能组件了！不要增加整个生命周期和反应性，使其过载；我不需要他们！*

#### [](#the-props-keyword)道具关键字

由于功能组件没有实例，`this`关键字将是`undefined`。所以，要阅读道具，你需要在每个道具前加上`props`关键字。

[![Woah](../Images/742d54688f29398bc3e7dfb016dc5b6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--430EvxUB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://giphygifs.s3.amazonaws.com/media/hAK7E1hcIXPgI/giphy.gif)
