...
> 原文:[https://dev . to/thefrugaldev/getting-family-with-redis-data-types-40i 8](https://dev.to/thefrugaldev/getting-familiar-with-redis-data-types-40i8)
...
### [](#when-to-use-sorted-sets)**何时使用排序集**
