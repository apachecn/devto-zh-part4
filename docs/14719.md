...
> 原文:[https://dev . to/christianstrang/sailsjs-use-passport-to-log-with-Facebook-6nk](https://dev.to/christianstrang/sailsjs-use-passport-to-login-with-facebook-6nk)

对于本教程，我假设您使用步骤 1 (Web 应用程序)创建了 sails.js 应用程序。

### [](#1-install-passport-and-the-facebook-strategy-for-passport)1。安装 Passport 和 Passport 的脸书策略
...
### [](#3-add-the-passportfacebookstrategy)3。添加 Passport-Facebook 策略
...
### [](#4-create-a-passport-controller-to-handle-facebook-authentication)4。创建一个 Passport 控制器来处理脸书验证
...
### [](#6-add-the-your-localhost-url-to-your-facebook-app)6。将您的本地主机 URL 添加到您的脸书应用程序中

在你的 facebook 开发者后端，进入设置= >基本，在底部添加网站平台。作为站点 url 使用您的真实域，或者，如果您创建了一个测试应用程序，您可以添加一个本地主机 url，在我们的例子中应该是这样的:

[![](../Images/a53e682f947da896af0bd692059964a7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rFN40KuJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g7493yxkai0ltn9ou4wo.png)

### [](#7-login-in-via-facebook)7。通过脸书登录
