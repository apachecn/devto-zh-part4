...
> 原文:[https://dev . to/saashub/postgres-trigram-indexes-vs-algolia-1oma](https://dev.to/saashub/postgres-trigram-indexes-vs-algolia-1oma)
...
## [](#1-enable-the-postgres-extension)1)启用 Postgres 扩展

`CREATE EXTENSION IF NOT EXISTS pg_trgm`

## [](#2-index-the-columns-you-are-going-to-query)2)索引你要查询的列
...
## [](#4-search-for-different-types-of-records-simultaneously)4)同时搜索不同类型的记录
