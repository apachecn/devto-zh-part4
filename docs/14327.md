...
> 原文:[https://dev . to/孙同/how-to-create-a-self-signed-certificate-1 AIB](https://dev.to/suntong/how-to-create-a-self-signed-certificate-1aib)
...
### [](#what-is-a-selfsigned-tls-certificate)什么是自签名 TLS 证书？
...
### [](#create-the-certificate-getting-started)创建证书-入门
...
### [](#create-the-certificate-the-whole-nineyard)创建证书-全九码
...
### [](#create-the-certificate-the-actual-command)创建证书- [实际命令](https://stackoverflow.com/a/41366949/2125837)
...
### [](#create-the-certificate-parameter-explained)创建证书-参数说明
...
### [](#create-the-certificate-for-the-public)创建证书-面向公众
