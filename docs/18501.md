...
> 原文:[https://dev . to/ushmidave/best-way-to-show-error-messages-in-angular-reactive-forms-3e 31](https://dev.to/ushmidave/best-way-to-show-error-messages-in-angular-reactive-forms-3e31)
...
# [](#multiple-error-messages)多个错误信息
