...
> 原文:[https://dev . to/nab bisen/debugging-opensmtpd-openbsd-s-smtpd-failed-when-starting-pl](https://dev.to/nabbisen/debugging-opensmtpd-openbsd-s-smtpd-failed-when-starting-pl)
