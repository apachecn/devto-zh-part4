...
> 原文:[https://dev . to/rdlauer/JavaScript-101-var-or-let-or-const-5epj](https://dev.to/rdlauer/javascript-101-var-or-let-or-const-5epj)
...
## [](#the-venerable-raw-var-endraw-)德高望重的`var`
...
## [](#function-scope-vs-block-scope)功能范围 vs 块范围
...
## [](#this-raw-const-endraw-thing)这件`const`事情
...
## [](#so-which-should-i-use)那么我该用哪个呢？？？
