...
> 原文:[https://dev.to/vbilopav/postgexecute-net-is-not-orm-ljd](https://dev.to/vbilopav/postgexecute-net-is-not-orm-ljd)
...
### [](#1-raw-postgresql-endraw-connection-extensions)1。`PostgreSQL`连接扩展
