...
> 原文:[https://dev.to/antoniogamiz/first-work-report-of-gsoc-3gk4](https://dev.to/antoniogamiz/first-work-report-of-gsoc-3gk4)

我回来了，如我所承诺的！是时候谈谈我这段时间都在做什么了。自编码期开始以来，已经过去了三个星期，自那时以来已经做了一些工作:

# [](#perl6linkhealth-repo)Perl6::LinkHealth [回购](https://github.com/antoniogamiz/Perl6-LinkHealth)

这是我的第一个模块！我试着做了一个基本的工具来检查一些文件是否停止生成。它需要改进，还没有完成，但我的导师建议我暂时搁置这个项目。

# [](#mini-doc-repository-issue-2529)迷你文档库[第 2529 期](https://github.com/perl6/doc/issues/2529)
...
# [](#spin-off-perl6documentable-issue-1937)剥离 Perl6::可记录的[第 1937 期](https://github.com/perl6/doc/issues/1937)
...
# [](#perl6typegraph-issue-2573)Perl6::Typegraph [第 2573 期](https://github.com/perl6/doc/issues/2573)
...
# [](#podload-repo)Pod::Load [回购](https://github.com/JJ/p6-pod-load)

这个模块将用于读取文档中的每个 pod 文件，所以我一直在使用它，并发现了一些错误。

# [](#eslibre19)[esLibre19](https://eslib.re/2019/)
