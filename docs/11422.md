...
> 原文:[https://dev.to/gualtierofr/navigation-in-swiftui-1hg2](https://dev.to/gualtierofr/navigation-in-swiftui-1hg2)
...
### [](#navigationlink-isactive)导航链接激活
...
### [](#navigationlink-with-tag)带标签的导航链接
