...
> 原文:[https://dev . to/Stephen fluin/5-things-to-do-after-ng-new-1nd 7](https://dev.to/stephenfluin/5-things-to-do-after-ng-new-1nd7)
...
## [](#1-setup-naive-continuous-integration-with-circleci)1。设置与 CircleCI 的简单持续集成
...
## [](#2-add-a-design-system)2。添加设计系统
...
## [](#3-add-offline-support-and-pwa-superpowers)3。添加离线支持和 PWA 超能力
...
## [](#4-add-firebase-authentication)4。添加 Firebase 身份验证
...
## [](#5-add-a-server-amp-backend)5。添加一个服务器&后端
