...
> 原文:[https://dev . to/kyrell Dixon/how-to-setup-an-express-js-server-in-node-js-56hp](https://dev.to/kyrelldixon/how-to-setup-an-express-js-server-in-node-js-56hp)

本教程旨在向您展示如何使用 Express framework 和 Node.js 从零开始构建并运行一个简单的服务器。它深入探讨了测试服务器的不同方法，而无需编写前端程序。

## [](#understanding-the-terms)理解术语
...
## [](#creating-the-initial-server)创建初始服务器
...
## [](#a-quick-refactor-of-the-raw-port-endraw-)快速重构的`PORT`
...
## [](#creating-rest-api-endpoints)创建 REST API 端点
...
## [](#three-ways-to-test-api-endpoints)测试 API 端点的三种方式
...
### [](#testing-a-get-endpoint-from-the-browser)从浏览器测试一个 GET 端点
...
[![Hello world endpoint in browser](../Images/e17a2f67dae19e745c9d08b93e49359d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eOfrgeKk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kyrelldixon.com/static/e0ab551bfccd1e9eab4bb2da69714864/4b668/hello-endpoint.webp)
...
### [](#test-any-api-endpoints-from-the-command-line-with-curl)用 cURL 从命令行测试任何 API 端点
...
### [](#testing-your-api-endpoints-with-postman)用 Postman 测试您的 API 端点

[![Postman front-page](../Images/94406111f24e8a8badf6d40f1c391557.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ruBzvfRI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kyrelldixon.com/static/01a21035897cd75cbf2b94e1b14e9acf/c3bcd/postman.webp)
...
[![Postman headers](../Images/f7b421b8653775544c86a8b9d35cce59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oW5_IdY0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kyrelldixon.com/static/3b6bb5b0c4a95ed92e088510a529494a/78593/postman-headers.webp)
...
## [](#bonus-reduce-development-errors-with-raw-nodemon-endraw-)加成:用`nodemon`减少开发错误
...
[![Nodemon output](../Images/be6218b061db75a13d480494df128401.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JvklkU1H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kyrelldixon.com/static/0847f9990467c8ed1ebfe4e10ffb0913/a0dba/nodemon.webp)
