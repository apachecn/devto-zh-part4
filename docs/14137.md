...
> 原文:[https://dev.to/sierisimo/tdd-with-urm-kotlin-increment-3m7c](https://dev.to/sierisimo/tdd-with-urm-kotlin-increment-3m7c)

在上一篇文章中，我们提到了一种使用 TDD 开始编写 URM 实现的方法。我们也提到了很多在编写`zero`函数时出现的问题。

现在该写增量函数了。

## [](#increment-function)增量功能
