...
> 原文:[https://dev . to/satorutakeuchi/a-Linux-kernel-module-for-stopping-the-system-a-while-3i7n](https://dev.to/satorutakeuchi/a-linux-kernel-module-for-stopping-the-system-for-a-while-3i7n)
...
# [](#confirm-the-effect-of-this-module)确认本模块的效果
...
# [](#how-this-module-is-implemented)本模块是如何实现的
