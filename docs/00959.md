...
> 原文:[https://dev . to/bjornlindholmdk/using-air table-as-a-back end-5079](https://dev.to/bjornlindholmdk/using-airtable-as-a-backend-5079)

# [](#using-airtable-as-a-backend)使用 Airtable 作为后端

我最近推出了第一版[会议总部](http://conferencehq.io)。该项目的一个有趣的部分是由 Airtable 支持的后端。我最初在 Laravel 中构建了自己的 API，但在那时我放弃了这个项目。我稍后将回到这一点。

## [](#what-is-airtable)什么是 Airtable
...
[![Alt Text](img/f5361e9e0c28e5077acf110fc5f536f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xGmzhhkZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a8mom8iuq0m0ai0wdnhj.png)
...
## [](#why-i-chose-airtable-for-conference-hq)我为什么选择 Airtable 作为会议总部
...
## [](#when-to-use-airtable)何时使用 Airtable
...
## [](#working-with-airtables-api)使用 Airtable 的 API
