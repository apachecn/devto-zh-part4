...
> 原文:[https://dev.to/oinak/a-very-classy-snake-8e3](https://dev.to/oinak/a-very-classy-snake-8e3)
...
| ![A humble but familiar UI](../Images/1d573a600eb615d3f8a80302ca1796db.png) |
| --- |
| 一个简陋但熟悉的用户界面 |
...
### [](#the-main-raw-game-endraw-class)主`Game`类
...
### [](#the-very-slithering-raw-snake-endraw-class)非常滑`Snake`级
...
### [](#-and-the-humble-tasty-raw-apple-endraw-class)...还有不起眼的美味`Apple`类
