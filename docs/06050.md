...
> 原文:[https://dev.to/dillionmegida/javascript-for-loop-jcn](https://dev.to/dillionmegida/javascript-for-loop-jcn)
...
### [](#lets-analyze-this-program-shall-we)我们来分析一下这个程序，好吗？😃
...
#### [](#lets-try-to-loop-through-an-array)让我们尝试循环遍历一个数组🤗
