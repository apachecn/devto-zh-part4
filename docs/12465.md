...
> 原文:[https://dev . to/lamp light dev/how-to-server-side-render-web-components-4ad 7](https://dev.to/lamplightdev/how-to-server-side-render-web-components-4ad7)
...
#### [](#twittersharejs)twitter-share.js
