...
> 原文:[https://dev.to/samanthaming/strikethrough-using-html5-3b9h](https://dev.to/samanthaming/strikethrough-using-html5-3b9h)

[![Code Tidbit by SamanthaMing.com](../Images/445300d9d0e5b337bfbfbf05f4ffb5c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lA7_-18A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/muwt6sg10m46w8ls0fl5.png)
...
## [](#-raw-ltsgt-endraw-vs-raw-ltdelgt-endraw-)`<s>` vs `<del>`
...
### [](#example-git-interface)举例:Git 接口
