...
> 原文:[https://dev . to/Dwayne/5-nothing-things-I-learn-from-reading-elm-s-syntax-documentation-6](https://dev.to/dwayne/5-notable-things-i-learned-from-reading-elm-s-syntax-documentation-6)

## [](#5-a-neat-trick-for-toggling-comments)5。切换评论的巧妙技巧
...
## [](#3-field-access-functions)3。字段访问功能
...
## [](#2-extensible-record-definitions)2。可扩展记录定义
