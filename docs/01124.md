...
> 原文:[https://dev . to/Dai _ Shi/off-main-thread-react-redux-with-performance-59f 7](https://dev.to/dai_shi/off-main-thread-react-redux-with-performance-59f7)

##### [](#run-redux-in-web-workers)在 Web Workers 中运行 Redux
...
[![screenshot1](img/e929870607115abed52766b7073e31b2.png "Benchmark result")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RotLSC1w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./screenshot1.png)
