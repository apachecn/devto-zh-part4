...
> 原文:[https://dev . to/neverendingqs/API-gateway-web socket-API-with-the-server less-framework-1ph 6](https://dev.to/neverendingqs/api-gateway-websocket-apis-with-the-serverless-framework-1ph6)
...
### [](#routing-websocket-messages)路由 WebSocket 消息
...
### [](#using-the-apigatewaymanagementapi-class)使用 ApiGatewayManagementApi 类
...
### [](#creating-an-authorizer-lambda-function)创建授权人λ函数
