...
> 原文:[https://dev . to/Tuan tvk/essential-python-tips-and-tricks-for-python-developer-5g 9j](https://dev.to/tuantvk/essential-python-tips-and-tricks-for-python-developer-5g9j)

# [](#writing-shorthand-statements-in-python)用 python 写速记语句
...
## [](#string-concatenation-with-delimiter)带分隔符的字符串串联
...
## [](#removing-duplicates-items-from-a-list)从列表中删除重复项
...
## [](#how-to-efficiently-compare-two-unordered-lists)如何高效比较两个无序列表
...
## [](#convert-byte-to-string)将字节转换成字符串
...
## [](#convert-hex-string-string-to-int)将十六进制字符串转换为 int 字符串
...
### [](#view-my-repo-on-github-bulb)[在 Github 上查看我的回购](https://github.com/tuantvk/python-cheatsheet)💡