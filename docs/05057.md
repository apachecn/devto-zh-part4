...
> 原文:[https://dev . to/mainawycliffe/lazy-loading-modules-preloading-strategy-in-angular-8-2d6o](https://dev.to/mainawycliffe/lazy-loading-modules-preloading-strategy-in-angular-8-2d6o)
...
## [](#lazy-loading-feature-modules)懒加载功能模块
...
## [](#preloading-strategy-for-lazyloaded-modules)延迟加载模块的预加载策略
...
### [](#no-preloading-default-preloading-strategy)无预加载–默认预加载策略
...
### [](#preloading-all-modules)预加载所有模块
...
### [](#creating-a-custom-preload-strategy)创建自定义预加载策略
