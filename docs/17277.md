...
> 原文:[https://dev . to/shear ytan/adding-timestamps-to-the-SQL-raw-queries-with-laravel-melatory-here-is-how-226 c](https://dev.to/shearytan/adding-timestamps-to-the-sql-raw-queries-with-laravel-eloquent-here-is-how-226c)

## [](#using-laravel-eloquent)用巧言令色
...
## [](#using-sql-raw-queries)使用 SQL 原始查询
