...
> 原文:[https://dev . to/manuels idler/keep-your-git-history-clean-101-k7](https://dev.to/manuelsidler/keep-your-git-history-clean-101-k7)
...
## [](#scenario-1-add-something-to-your-last-commit)场景 1:在最后一次提交时添加内容
...
## [](#git-interactive-rebase)Git 交互式 rebase
...
## [](#scenario-2-add-something-to-an-arbitrary-commit-in-your-history)场景 2:在你的历史中任意添加一些东西
...
## [](#scenario-3-merge-commits)场景 3:合并提交
...
## [](#scenario-4-split-commit)场景 4:拆分提交
...
## [](#scenario-5-reorder-commits)场景 5:重新排序提交
...
## [](#scenario-6-change-commit-message)场景 6:更改提交消息
...
## [](#scenario-7-drop-commit)场景 7:放弃提交
...
## [](#when-somethings-going-wrong)不顺心的时候
