...
> 原文:[https://dev . to/Ryan cal/how-to-use-axios-to-make-http-requests-get-post-and-parallel-requests-3kn 9](https://dev.to/ryancal/how-to-use-axios-to-make-http-requests-get-post-and-parallel-requests-3kn9)
...
## [](#performing-multiple-parallel-requests-simultaneously)同时执行多个并行请求
