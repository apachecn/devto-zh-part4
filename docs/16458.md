...
> 原文:[https://dev . to/jsjoeio/how-to-create-code-profiles-in-vs code-3 foo](https://dev.to/jsjoeio/how-to-create-code-profiles-in-vscode-3ofo)
...
### [](#1-create-a-raw-codeprofiles-endraw-directory)1。创建一个`code_profiles`目录
...
### [](#2-create-your-first-profile)2。创建您的第一个个人资料
...
### [](#3-add-your-settingsjson)3。添加 settings.json
...
### [](#4-test-your-new-code-profile)4。测试您的新代码配置文件
...
[![screenshot of vscode with new settings](../Images/4bbd4f3cebad7c89c4945c88446e777f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nC6IY-FF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8r277j7k5r0oi1b3axym.png)

### [](#5-create-an-alias-for-your-profile)5。为您的个人资料创建别名。
