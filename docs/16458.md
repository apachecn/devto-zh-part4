...
> 原文：<https://dev.to/jsjoeio/how-to-create-code-profiles-in-vscode-3ofo>

这篇文章借鉴了 [@avanslaars](https://dev.to/avanslaars) 所做的工作，他是 [egghead.io](https://github.com/avanslaars/code-profiles) 的讲师同事。他不久前在书呆子聚会上分享了这一点，而我从来没有自己动手做过。

现在，我正在安装一台新的笔记本电脑，并决定尝试一下。在安迪的[回购这里](https://github.com/avanslaars/code-profiles)之后，我将向您介绍整个过程，以便您可以跟随。

在我们开始之前，“代码概要”本质上是一个不同的`settings.json`配置。您还可以定制每个代码配置文件加载哪些扩展，但这超出了本文的范围。
...
如果成功了，您应该会看到 VSCode 打开并显示您的设置:
[![screenshot of vscode with new settings](img/4bbd4f3cebad7c89c4945c88446e777f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nC6IY-FF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8r277j7k5r0oi1b3axym.png)
...
特别感谢 [@avanslaars](https://dev.to/avanslaars) 的分享。这里有一个他的 [`code_profiles`回购](https://github.com/avanslaars/code-profiles)的链接，我在那里学会了如何做这件事。
