...
> 原文:[https://dev . to/chantastic/improve-pull-requests-with-5-practices-1ke 9](https://dev.to/chantastic/improve-pull-requests-with-5-practices-1ke9)

## [](#1-start-your-message-with-a-verb)1。用动词开始你的信息
...
## [](#2-write-messages-in-an-imperative-style)2。用命令式风格写信息
...
## [](#3-use-raw-haveneedget-endraw-to-describe-your-pr)3。用`have/need/get`来描述你的公关
...
## [](#4-use-the-raw-fixup-endraw-flag-to-commit-fixes)4。使用`--fixup`标志提交修复
