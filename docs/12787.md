...
[![](../Images/6c4aba3fa74e2d11d60bef7772e1e1ec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xhspSh2J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A8hGsfjx9JcHoZkEAkdRSBA.png)
...
> # [](#una-clase-deber%C3%ADa-estar-abierta-a-extensi%C3%B3n-pero-cerrada-a-modificaci%C3%B3n-tenemos-que-ser-capaces-de-extender-el-comportamiento-de-nuestras-clases-sin-necesidad-de-modificar-su-c%C3%B3digo)A class should be open for expansion, but not for modification. We must be able to extend the behavior of our classes without modifying their code.

简而言之，**我们班应该能够做更多的事情，但不要编辑他们的代码**。

## [](#c%C3%B3mo-cumplimos-con-el-ocp)我们是否符合 OCP？
...
## [](#a-qu%C3%A9-huele-una-clase-que-no-cumple-con-el-ocp)一类不符合 OCP 的气味是什么？
