...
> 原文:[https://dev . to/Victoria/bash-one-liners-to-clone-all-your-github-repositories-and-back-them-up-to-git lab-28n 4](https://dev.to/victoria/bash-one-liners-to-clone-all-your-github-repositories-and-back-them-up-to-gitlab-28n4)
...
### [](#splitting-strings-with-raw-awk-endraw-)用`awk`拆分字符串
...
# [](#to-elaborate-on-the-succinctness-of-bash-oneliners)阐述 Bash 俏皮话的简洁
