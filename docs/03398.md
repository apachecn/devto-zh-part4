...
> 原文:[https://dev . to/kendru/bootstrapping-a-clojurescript-project-kn1](https://dev.to/kendru/bootstrapping-a-clojurescript-project-kn1)
...
#### [](#using-leiningen-to-bootstrap-a-new-project)使用 Leiningen 引导一个新项目
...
#### [](#summary-of-key-leiningen-tasks)重点雷宁根任务汇总
...
[![Leiningen Template Resolution](img/c923d65fa96838977ee9b891a2808a32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vRD7-zoy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter5/lein-template-resolution.png)
...
[![Dissecting a lein new Command](img/e41368f338bef31ecbc1de8ee1b86d7b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NA8yM6zE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter5/new_new_dissected.png)

*解剖一`lein new`命令*

## [](#exploring-the-project)探索项目

我们现在有了一个正在运行的(尽管是框架性的)ClojureScript 项目。要查看 Leiningen 生成的应用程序，我们可以导航到项目目录并查看生成了什么文件。

#### [](#exploring-the-generated-project)探索生成的项目
...
[![Editing core.cljs with Emacs](img/ad60c63a03c693dbeba620e0ec2b2d11.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--16vHbhzo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter5/emacs_screenshot.png)
...
[![Filename to Namespace Convention](img/9be3e16674be46bb516e79f3c0753979.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HecfYty6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kendru.github.io/img/learn-cljs/chapter5/namespace-transformation.png)
