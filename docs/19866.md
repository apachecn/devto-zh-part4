...
> 原文:[https://dev . to/rgeraldporter/building-expressive-monads-in-JavaScript-introduction-23b](https://dev.to/rgeraldporter/building-expressive-monads-in-javascript-introduction-23b)
...
## [](#what-problems-do-monads-solve)单子解决什么问题？
...
## [](#how-is-it-used-in-javascript)在 Javascript 中是如何使用的？
...
## [](#the-most-basic-monad-raw-identity-endraw-)最基本的单子:`Identity`
...
### [](#second-a-quick-note-on-the-term-identity)第二，对“同一性”这个术语的一个快速注释...
...
### [](#-raw-identity-endraw-the-code)`Identity`:代码
...
#### [](#-raw-const-identity-x-gt-endraw-)`const Identity = x => ({ ... });`
...
#### [](#method-raw-emit-endraw-)方法:`emit`
...
#### [](#method-raw-chain-endraw-)方法:`chain`
...
#### [](#one-more-method-raw-inspect-endraw-)一更法:`inspect`
...
#### [](#lastly-adding-a-constructor)最后，添加构造函数
...
## [](#lets-make-another-monad-raw-list-endraw-)我们再做一个单子:`List`
...
#### [](#method-raw-concat-endraw-)方法:`concat`
...
#### [](#method-raw-head-endraw-)方法:`head`
...
## [](#-raw-maybe-endraw-the-most-powerful-monad)`Maybe`:最强大的单子
...
### [](#method-raw-fork-endraw-)方法:`fork`
...
## [](#a-note-about-raw-emit-endraw-)关于`emit`的一个说明
...
## [](#monad-modules-you-can-use-right-now)现在就可以使用的单子模块
