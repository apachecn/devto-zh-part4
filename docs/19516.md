...
> 原文:[https://dev.to/victordeandres/javascript-es6-symbols-4pda](https://dev.to/victordeandres/javascript-es6-symbols-4pda)

## [](#javascript-es6-symbols)Javascript - ES6。符号。
...
## [](#c%C3%B3mo-nos-puede-ayudar-symbol)符号如何帮助我们。

我们已经描述了新的符号数据类型及其特征。以下是 symbol 可以帮助我们的一些情况。

## [](#evitar-duplicaciones)避免重复。
...
## [](#simular-propiedadesm%C3%A9todos-privados)模拟私有财产/方法。
