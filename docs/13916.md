...
> 原文:[https://dev . to/ryanharris/5-vue-tips-for-react-developers-1pc 2](https://dev.to/ryanharris/5-vue-tips-for-react-developers-1pc2)
...
#### [](#1-conditional-rendering)#1 条件渲染
...
#### [](#5-managing-component-state-from-a-parent)#5 管理父组件的状态
