...
> 原文:[https://dev . to/kapilgorve/navigation-in-react-native-using-react-navigation-26ag](https://dev.to/kapilgorve/navigation-in-react-native-using-react-navigation-26ag)

[!['cover'](img/73f9fbe28d89b72e3008a4e0a11bad7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bLWH238A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kapilgorve.s3.ap-south-1.amazonaws.com/blog/covers/react-navigation-cover.png)
...
[!['stack](img/3702c6101a3abfbdffcce0e8e196a73e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CihVhSVc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://visualgo.net/img/stack_illustration.png)
...
## [](#react-navigation-setup)React 导航设置

我假设您已经创建并运行了 React Native 或 Expo 应用程序。让我们快速浏览一下安装步骤。

### [](#step-1-install-the-reactnavigation-package-in-your-react-native-project)第一步。在 react 本地项目中安装 react-navigation 包。
...
### [](#step-2-install-react-nativegesturehandler-and-reactnativereanimated)第二步。安装 react native-gesture-handler 和 react-native-reanimated。
...
### [](#1-createstacknavigator)1。createStackNavigator

堆栈导航器允许像我们在上面已经看到的*堆栈*一样排列屏幕。您可以添加或移除屏幕，就像在堆栈中推入或弹出屏幕一样。

### [](#2-createswitchnavigator)2。createSwitchNavigator
...
### [](#3-createbottomtabnavigator)3。createBottomTabNavigator
...
### [](#5-createddrawernavigator)5。createdDrawerNavigator
