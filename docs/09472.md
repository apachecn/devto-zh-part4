...
> 原文:[https://dev . to/sebtoombs/use-modern-jquery-in-WordPress-5fm 4](https://dev.to/sebtoombs/use-modern-jquery-in-wordpress-5fm4)

## [](#replace-jquery-in-wordpress-with-a-modern-version)用现代版替换 Wordpress 中的 jQuery
...
#### [](#warning-upgrading-from-jquery-1x-to-3x-may-break-some-themesplugins)**警告:从 jQuery 1.x 升级到 3.x 可能会破坏一些主题/插件**
...
## [](#how-to-replace-jquery-1124-in-wordpress)如何替换 Wordpress 中的 jQuery 1.12.4？
...
#### [](#use-jquery-from-cdn)使用来自 CDN 的 jQuery
...
#### [](#use-modern-jquery-locally)本地使用现代 jQuery

首选方案是从您的站点提供一个现代的 jQuery 版本。这可以最大限度地减少对不同来源的请求，从而加快网站的交付速度。如果你实现了一个 CDN，它还允许你从你自己的 CDN 提供 jQuery。

为此，您需要文件/ftp 访问权限。

##### [](#1-download-modern-jquery-into-your-theme)1。将现代 jQuery 下载到您的主题中
...
##### [](#2-enqueue-modern-jquery-from-your-theme)2。将现代 jQuery 从您的主题中排队
