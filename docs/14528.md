...
> 原文:[https://dev . to/Ian Rodrigues/deploying-containers-to-production-with-terra form-and-AWS-fargate-introduction-28l 8](https://dev.to/ianrodrigues/deploying-containers-to-production-with-terraform-and-aws-fargate-introduction-28l8)
...
## [](#first-of-all-what-is-ecs)首先，什么是 ECS？
...
#### [](#serverless-containers-with-fargate)【无服务器】带 Fargate 的容器
...
## [](#infrastructureascode-and-terraform)基础设施即代码和地形
...
#### [](#basic-hello-world)基础 Hello World！
