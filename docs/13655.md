...
> 原文:[https://dev . to/levimore IRA/kot Lin-data-structures-arrays-and-strings-3729](https://dev.to/levimoreira/kotlin-data-structures-arrays-and-strings-3729)
...
### [](#capitalize-and-decapitalize)大写()和去大写()
...
### [](#max-min-average-sum)最大值、最小值、平均值、总和
