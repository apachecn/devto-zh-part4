...
> 原文:[https://dev.to/inktrap/refactoring-css-2a91](https://dev.to/inktrap/refactoring-css-2a91)

# [](#refactoring-css)重构 CSS

## 当考虑重构你的 CSS 时，要记住什么

[![](img/20970544a2a984b97d40857044559834.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YM8PPbME--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/10800/0%2AmnEV1SDJ52G8sXu0)
...
[![](img/107d6a7d31438dbe7c7f2ff8f2c1905d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--868gXiw7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/8640/0%2Amb1dKSfnTOS6xE1P)
...
# [](#when-and-when-not-to-refactor)何时以及何时不进行重构

也许你在想，如果它有用，我为什么还要碰它？这是一个非常重要和必要的问题，因为你可能不需要。以下并不是一份详尽的清单，只是对可能会影响你的事情的一个想法。

## [](#when-it-might-be-time-to-refactor)该重构的时候了
...
## [](#when-it-might-not-be-necessary)在没有必要的时候
...
# [](#refactoring-on-the-move)重构“在移动中”
...
[![](img/fe999f96dc74d3ca4e62c87ca278cf37.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sZVftHV8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4456/1%2ASk1oV64e2PoIO9sTxQYgvA.png)

对这些统计数据要有所保留，并对您正在开发的代码库有一个大致的概念。因为对于一个标准的营销网站来说，拥有 40 个独特的颜色声明可能看起来很多，但对于拥有色板的在线服装店来说，这些结果不会那么令人惊讶。

[![](img/7201107909619151c5bc4643c79bbc61.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4o-jMIwe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4180/1%2AQDU__D3iYs0iq6qOkG6cPQ.png)
...
## [](#is-the-refactor-short-enough)重构够短吗？
...
## [](#how-should-i-implement-the-refactored-code)我应该如何实现重构后的代码？

[![](img/855e0b696f00eb9a2c72859298774544.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TFUHJURl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/9856/0%2AcEF12X1m-kt5dJcu)
