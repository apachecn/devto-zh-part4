...
> 原文:[https://dev . to/nikhilponnuru/make-a-request-between-frontend-and-back end-locally-running-on-different-port-without-CORS-issue-4 oje](https://dev.to/nikhilponnuru/make-a-request-between-frontend-and-backend-locally-running-on-different-ports-without-cors-issue-4oje)
...
### [](#running-both-frontend-and-backend-servers-locally)本地运行前端和后端服务器:
...
### [](#steps-to-use-reverse-proxy-for-this-usecase)针对此用例使用反向代理的步骤:
