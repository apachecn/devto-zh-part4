...
## [](#muted-tweets-by-regular-expressions)Muted tweets by regular expressions
...
### [](#im-not-interested-in-public-mentions-or-conversations)I'm not interested in public mentions or conversations
...
### [](#mostly-tweets-with-more-than-two-hashtags-are-uninteresting)Mostly, tweets with more than two #Hashtags are uninteresting

Mute all tweets with more than two hashtags like `foo bar [...] #first #second #third`

`#[^#]+#[^#]+#`

### [](#tweets-with-long-hashtags-are-not-really-exciting)Tweets with long #hashtags are not really exciting
...
## [](#mute-tweet-by-clients)Mute tweet by clients
