...
> 原文:[https://dev . to/yzhernand/perl-weekly-challenge-17-writing-our-own-URL-parser-in-perl-but-should-we-20mm](https://dev.to/yzhernand/perl-weekly-challenge-17-writing-our-own-url-parser-in-perl-but-should-we-20mm)
