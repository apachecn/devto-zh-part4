...
> 原文:[https://dev . to/intrincetic cloud/adding-Google-sign-in-to-your-web-app-pt-1-435k](https://dev.to/intricatecloud/adding-google-sign-in-to-your-web-app-pt-1-435k)
...
## [](#so-when-should-i-use-it)那么什么时候该用呢？
...
## [](#adding-google-signin-stepbystep)逐步添加 Google 登录

### [](#1-hello-world-html)1。Hello World HTML
...
### [](#2-add-the-google-signin-button)2。添加 Google 登录按钮

在添加按钮之前，您首先需要创建一个客户端 ID/secret，这是一种识别您(开发者)允许用户从 Google 获取身份信息并将其发送到您的网站的方式。

### [](#creating-credentials-for-signin)创建登录凭证
...
### [](#add-the-library-credentials-button-to-your-html)将库+凭证+按钮添加到您的 HTML 中
