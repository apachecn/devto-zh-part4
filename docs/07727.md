...
> 原文:[https://dev.to/irmerk/asynchronous-with-redux-sagas-44dm](https://dev.to/irmerk/asynchronous-with-redux-sagas-44dm)

### [](#sophisticated-side-effect-flow-management-and-testing)复杂的副作用流管理和测试
...
### [](#why-redux-saga)为什么要 Redux Saga？
...
### [](#a-quick-note-on-thunks)关于 Thunks 的一个快速注释:
...
[![Redux Saga Flow Diagram](../Images/63e318cc30997492cf8562c0b7e1a8d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zEKLzQuC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/irmerk/outreach/blob/master/images/sagaDiagram.png%3Fraw%3Dtrue)
