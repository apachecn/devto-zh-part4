...
> 原文:[https://dev.to/cedretaber/pipeline-pass-it-in-first-58hh](https://dev.to/cedretaber/pipeline-pass-it-in-first-58hh)
...
## [](#to-be-first-or-to-be-last)做第一个，还是做最后一个
...
## [](#pipeline-operators-in-various-languages)各种语言的管道操作符
...
### [](#clojure-threading-macros)Clojure:线程宏
...
### [](#bucklescriptreason-pipe-first)BuckleScript/Reason:管道优先
