...
> 原文:[https://dev.to/codingpizza/variables-in-dart-4j63](https://dev.to/codingpizza/variables-in-dart-4j63)
...
## [](#how-do-we-create-them-in-dart)我们如何在 Dart 中创建它们？

在 Dart 中，我们可以通过三种方式创建变量:

### [](#using-the-reserved-keyword-var)**使用保留关键字 var**
...
### [](#declaring-the-type-of-the-variable)声明变量的类型
...
你可以在 IDE 中尝试这些概念，比如免费的 Intellij idea 社区，你只需要安装 Dart 插件。或者在一些在线编辑器里像[](https://dartpad.dartlang.org/)**。**
