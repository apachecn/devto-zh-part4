...
> 原文：<https://dev.to/jsgoose/conquering-job-interview-code-challenges-v2-0-518l>
...
<figure>[![react code showing a project structure](img/d2924b92ea8263473350ead012610d52.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Iyp6oDnh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/08/image.png) 

<figcaption>我的项目结构</figcaption>
...
如果你像我一样，你从来没有听说过 Quip API，也不知道它是做什么的。在其核心，Quip 是一个自动化工具，允许您与 [SalesForce](https://www.salesforce.com/) 等工具集成，使您的销售团队更加协作。
...
<figure>[![a code snippet of react import statements](img/740a74665c191d5ba6c886775cdf982c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DPxZvTgH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/07/image-1.png) 

<figcaption>我的导入报表为必填项</figcaption>
...
<figure>[![some react code showing an authentication call to an outside API](img/91d7c342e49c362e038163a590139e78.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--TKZPkOiV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/07/image-4.png) 

<figcaption>我的认证功能</figcaption>
...
不不不。！！可怕的 [CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS/Errors) 怪物抬起它巨大的头！(CORS 实际上是我和服务器之间的一个有用的中介，但是如果你以前从未见过这个错误，处理起来可能会很烦人)。**旁注——如果你以前从未见过这个错误，不要担心！我仍然没有完全理解它，但我知道足够调试它。如果你遇到了困难，可以查看上面的链接以获得一些有用的信息，或者看看下面的快速解决方法。**
...
<figure>[![a POST function call to an outside API](img/86ad02c4a305eddc52f9960ac25dc7bd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--WgCGzj5P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/07/image-3.png) 

<figcaption>我的岗位功能</figcaption>
...
<figure>[![some react code for a simple button](img/aa189427a0a3737060cc588ab1f80600.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--uzD98Ntb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/07/image-5-1024x96.png) 

<figcaption>一个简单的带有点击方法的 React 按钮</figcaption>

</figure>

我的 POST 函数已经构建好了，我的按钮也已经构建好了，并且绑定了方法。是时候交叉手指，看看我的函数在控制台上显示了什么:

<figure>[![a console log statement from an outside API call](img/62e052d9127759c984ad32f12a348675.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--j910cyGc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/07/image-6.png) 

<figcaption>我的服务器请求的结果——成功了！</figcaption>

</figure>

此时我欣喜若狂！让我兴奋不已的是，这个 API 调用不仅可以工作，还可以返回一些东西。现在真正的考验...这在我的 Quip 帐户上会显示为新的电子表格吗？

[![a quip account showing the creating of a spreadsheet](img/2e759f870910ce5c674ced4088b56333.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jACsy8cV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/07/image-7.png)
...
<figure>[![a snippet of react code showing an upload function](img/9c441ca30a9c1328c79a67a92b3adff9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ANWJBk8U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/08/image-3.png) 

<figcaption>我的导入功能从来没有正常工作过:)</figcaption>
...
[![a react app showing database table data](img/9261447a0c5f2b767121b1b20f55d555.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SdCFZBH3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonathansexton.me/blog/wp-content/uploads/2019/08/image-4-1024x731.png)
...
此外，我会把我的大部分文章交叉发布在像 [freeCodeCamp](https://www.freecodecamp.org/news/author/jonathan/) 和 [Medium](https://medium.com/@joncsexton) 这样你也可以在那里找到我的作品！
