...
> 原文:[https://dev . to/this dot media/graph QL-subscriptions-with-nest-how-to-publish-cross-multi-running-servers-15e](https://dev.to/thisdotmedia/graphql-subscriptions-with-nest-how-to-publish-across-multiple-running-servers-15e)
...
[![NestJS is generated](img/90fe466bf6fa89d1797ca20c679d07d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M_vzh4l_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h21n5sya6vm418x2f8a5.png)
...
[![in-memory subscriptions in action](img/2ece7fdb98d72b7cdfb01997cd6823c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H_kpImSr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9zghuddpcvortvd2vchk.gif)

正如您所看到的，在 *:3001* 上运行的实例没有得到在 *:3000* 实例上发布的任何事件。

看看下面的图片，从不同的角度来看:

[![in-memory subscriptions under the hood](img/1fe46c4adba361f54d75a4837f922b09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NVhxty4S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2qj5undhbnay67evk5yv.jpg)
...
[![Redis is up and running](img/f46e6217578aa6afe1a4dd04e74eb741.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m8rCFbpB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cdi4l7re32u9hcbdre3z.png)
...
[![Redis subscriptions in action](img/aa5fa85d69d8b5b738232cd82a1436dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--evJhtrSo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4wahc456ikbes0cycwoz.gif)

下面是引擎盖下发生的事情:

[![Redis subscriptions under the hood](img/38340814bb3266d50b6a7b53b5abb9bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IOR70zsB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4xk2q35iolr78pnbdftd.jpg)
