...
> 原文:[https://dev . to/deep source/positional-only-arguments-in-python-108 e](https://dev.to/deepsource/positional-only-arguments-in-python-108e)
...
## [](#how-to-use-positionalonly-arguments)如何使用仅位置参数
...
## [](#when-to-use-positionalonly-arguments)何时使用仅位置参数
