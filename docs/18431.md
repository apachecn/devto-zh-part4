...
> 原文:[https://dev . to/sergiodxa/introduction-to-react-with-the-state-effects-hooks-4c BM](https://dev.to/sergiodxa/introduction-to-react-with-the-state-effects-hooks-4cbm)

## [](#starting-a-react-project)开始一个 React 项目
...
## [](#rendering-an-element-with-react)用 React 渲染一个元素
...
## [](#using-state-amp-effect-together)使用状态&一起效果
...
## [](#adding-a-second-state-amp-effect)添加第二种状态&效果
...
## [](#adding-an-effect-dependencies-array)添加一个效果依赖数组
