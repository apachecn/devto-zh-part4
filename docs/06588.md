...
> 原文:[https://dev.to/jwkicklighter/bash-quick-tips-1o1k](https://dev.to/jwkicklighter/bash-quick-tips-1o1k)
...
## [](#make-directory-and-go-there)制作目录并转到那里
...
## [](#pretty-git-log-tree)漂亮的 Git 日志树
...
## [](#execute-commands-in-pods)执行 pod 中的命令
