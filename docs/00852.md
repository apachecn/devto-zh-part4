...
> 原文:[https://dev.to/cassidycodes/learning-go-3597](https://dev.to/cassidycodes/learning-go-3597)
...
## [](#-raw-src-endraw-is-inferred)`src`是推断！
...
## [](#basic-structure-of-a-file)一个文件的基本结构。
