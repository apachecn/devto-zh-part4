...
> 原文：[https://dev.to/abhishekcghosh/creating-a-multi-level-hierarchical-flyout-navigation-menu-using-only-html-and-css-33ke](https://dev.to/abhishekcghosh/creating-a-multi-level-hierarchical-flyout-navigation-menu-using-only-html-and-css-33ke)
...
We’ll begin with a simple quite look-and-feel, something that goes back to the classic Windows™ theme. Here’s a short animation on how that would look like:

[![Css nav menu](img/f05bbfa040ac1e29011cad7b7beb0192.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eu8Yp0Y3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.ibb.co/TrrSZ9Z/css-nav-menu-3.gif)

Towards the end, we’ll make it a bit fancier by adding some more styling to give it a MacOS™ like feel.

*Impatient? Scroll down below to the Codepen embeds!*
...
[![Sub-menu positioning](img/6bc7d833091ee74ce4db7019c64be137.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--z1XeU2jM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.ibb.co/T8kTCjs/css-nav-menu-4.jpg)
...
[https://codepen.io/abhishekcghosh/embed/WqjOaX?height=600&default-tab=result&embed-version=2](https://codepen.io/abhishekcghosh/embed/WqjOaX?height=600&default-tab=result&embed-version=2)
...
[https://codepen.io/abhishekcghosh/embed/qzmEWd?height=600&default-tab=result&embed-version=2](https://codepen.io/abhishekcghosh/embed/qzmEWd?height=600&default-tab=result&embed-version=2)
