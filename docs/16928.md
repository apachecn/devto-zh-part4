...
> 原文:[https://dev . to/milandhar/chrome-local-storage-in-extensions-4k9m](https://dev.to/milandhar/chrome-local-storage-in-extensions-4k9m)
...
## [](#using-chromes-local-storage-in-your-extension)在你的扩展中使用 Chrome 的本地存储
...
### [](#removing-items-from-chrome-storage)从 Chrome 存储器中移除项目
