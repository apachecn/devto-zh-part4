...
> 原文:[https://dev . to/bnevilleoneill/handling-and-dispatching-events-with-node-js-4e5m](https://dev.to/bnevilleoneill/handling-and-dispatching-events-with-node-js-4e5m)

[![](../Images/a3fb6e2285689ca7d61138dc28a7e44f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ucdZJgFU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bp451f56ys110hu5my9c.jpeg)
...
## Node.js 中的 [](#modules-in-nodejs) 模块
...
## [](#handling-events-only-once)只处理一次事件
