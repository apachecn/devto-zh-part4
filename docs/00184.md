...
> 原文:[https://dev.to/joelvarty/dns-101-for-web-developers-5a4f](https://dev.to/joelvarty/dns-101-for-web-developers-5a4f)

作为 web 开发人员，DNS 是互联网最不为人所知的方面之一。这也是最重要的一点，因为它是连接你的域名(yourwebsite.com)和你的网站的粘合剂。

### [](#dns-stands-for-domain-name-service)DNS 代表域名服务
...
### [](#other-dns-record-types)其他 DNS 记录类型
