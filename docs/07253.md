...
> 原文:[https://dev . to/seangwright/kentico-12-设计-模式-部件-11-单元测试-定制-页面-类型-2c11](https://dev.to/seangwright/kentico-12-design-patterns-part-11-unit-testing-custom-page-types-2c11)

<figure>

[![Books and pages](../Images/4a1dc4fa73a374867929169f470a55ce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JC7OvzaM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bya0yinp23e4bm4jvq1r.jpg)
...
## [](#defining-a-scenario)定义场景

### [](#custom-page-type-raw-employeecontent-endraw-)自定义页面类型- `EmployeeContent`
...
### [](#request-handler-raw-employeeslistpagerequesthandler-endraw-)请求处理程序- `EmployeesListPageRequestHandler`
...
#### [](#a-quick-note-on-repositories-)关于存储库的快速说明...
...
## [](#setting-up-our-test)设置我们的测试

既然我们已经搭建出了所有想要测试的代码，并且确定了我们的测试将与之交互的关键领域，那么让我们开始创建我们的单元测试🥳吧！

### [](#creating-the-test-class-raw-employeeslistpagerequesthandlertests-endraw-)创建测试类- `EmployeesListPageRequestHandlerTests`
...
### [](#arranging-our-test-autofixture-nsubstitute-and-kentico-fakes)安排我们的测试-自动修复、n 替代和 Kentico 假货
...
### [](#acting-out-our-test-case)表演我们的测试用例
...
### [](#asserting-on-our-test-results-fluentassertions)在我们的测试结果上断言-流量评估
