...
> 原文:[https://dev . to/孙同/a-short-guide-on-squid-transparent-proxy-SSL-bumping-k5c](https://dev.to/suntong/a-short-guide-on-squid-transparent-proxy-ssl-bumping-k5c)
...
### [](#initialize-ssl-database)初始化 SSL 数据库
...
### [](#divert-traffic-to-the-transparent-proxy-with-iptables)使用 iptables 将流量转移到透明代理
