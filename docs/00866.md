...
> 原文:[https://dev . to/integerman/one-of-us-discribed-unions-in-c-3 MNF](https://dev.to/integerman/oneof-us-discriminated-unions-in-c-3mnf)
...
# [](#how-oneof-works)一个人是如何工作的

### [](#returning-a-oneof-result)返回结果之一
...
### [](#working-with-oneof-results)处理结果之一
...
### [](#acting-only-on-a-specific-type)只作用于特定类型
