...
> 原文:[https://dev . to/katzueno/setting-up-let-s-encrypt-on-Amazon-Linux-2-57l 7](https://dev.to/katzueno/setting-up-let-s-encrypt-on-amazon-linux-2-57l7)
...
# [](#step-0-initial-setup)第 0 步:初始设置
...
# [](#using-auto-configuration)使用自动配置

## [](#step-1-install-certbot)步骤 1:安装确定机器人
...
## [](#step-2-install-lets-encrypt-certificatte)第二步:安装加密证书
...
## [](#step-3-setup-cron-to-autorenew)第三步:设置 cron 自动续订
...
## [](#issue-an-certificate-for-the-domain)为该域颁发证书
...
## [](#set-web-server-config)设置 web 服务器配置
...
# [](#when-you-failed)当你失败时

## [](#clear-all-lets-encrypt-setting)清除所有咱们加密的设置
...
## [](#make-sure-to-set-ssl-on-defaultserver-for-dynamic-site-with-cache)确保在默认服务器上设置 SSL(用于带缓存的动态站点)
...
# [](#how-to-delete-unused-andor-old-certificates)如何删除未使用的和/或旧的证书
