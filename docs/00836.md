...
> 原文:[https://dev . to/bxcodec/today-I-learned-fix-go-get-private-repository-return-error-reading-sumgolangorglookup-4kjh](https://dev.to/bxcodec/today-i-learned-fix-go-get-private-repository-return-error-reading-sumgolangorglookup-4kjh)

#### [](#fixing-error-go-get-gomodule-on-private-module-with-error-message-pattern-verifying-githost-reading-sumgolangorglookup-410-gone)修复错误:在私有模块上获取 gomodule，错误消息模式验证 git-host…读取 sum.golang.org/lookup…410 消失

[![](img/7085613a75ce8d7d8a3843b3c42d8960.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9DZK7gzi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AcTBtBcPBD7gbyWy5RKGWLw.png)
