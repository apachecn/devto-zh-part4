...
> 原文:[https://dev . to/sven/automate-building-pushing-docker-containers-using-github-actions-202j](https://dev.to/sven/automate-building-pushing-docker-containers-using-github-actions-202j)
...
T3![GitHub Actions create a new workflow](../Images/c473aa600ba39ce464476bf50b6ef688.png)T5】

我们将创建一个工作流，当有人将某些东西推送到存储库时，该工作流就会运行。
[![GitHub Actions configure workflow](../Images/0a0e13a1fb86c8c02dbd67bac60039e3.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--uEXgEnPh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hhrs14vzbkdk7jv9dhaa.png)

向下拖动蓝色连接器，并添加“Docker 注册表”操作。
[![GitHub Actions add Docker Registry action](../Images/f9dd4cb69f8c44beefc8269de8721ed9.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--7ajhaaQS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sv27untseku6y9hunbxy.png)

此操作将使用`DOCKER_USERNAME`和`DOCKER_PASSWORD`密码让您登录 Docker Hub。添加您的用户名和密码作为密码。小心点！不要将它们作为环境变量添加，否则它们将是可见的！
T3![Adding secrets to the Docker Registry action](../Images/abf5458e3867fde65892f98a52bc53f3.png)T5】
...
[![GitHub Actions for Docker](../Images/4098a99c70897bbc67b23f4c73b5d53c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--zgHgBf-K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dgcnyknr6v7vfrz8pa1b.png)

最后，使用右上角的菜单提交工作流文件。
[![Commit](../Images/1fc849e4a29ca007bed79ee85c0c1fdc.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--T-tIwATV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7r6xq407shlpfz8wx4yn.png)

如果您等待几秒钟并导航到`Actions`选项卡，您将看到您的操作正在运行。如果一切顺利，您存储库中的容器将被推送到您的 Docker Hub 帐户。如果出了问题，您将能够查看日志来检查出了什么问题。
[![GitHub Actions success](../Images/5a61df90432274b735aa3046c5593a88.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--p0BuSN6w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uxj6ch6cgt4ajty9i3wp.png)

您可以导航到您的 Docker Hub 帐户，查看为您推送的容器图像 GitHub 操作。
[![Docker Hub success](../Images/112a97f95aa242ba0409606c05b49837.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--WedT2yiD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0n8lh0ye3mz60ih3s1si.png)
