...
> 原文:[https://dev . to/Dai _ Shi/effortless-render-optimization-with-state-usage-tracking-with-react-hooks-1jdo](https://dev.to/dai_shi/effortless-render-optimization-with-state-usage-tracking-with-react-hooks-1jdo)

##### [](#try-reacttracked-and-reactivereactredux)尝试 react-tracked 和 react-react-redux
...
### [](#solution-state-usage-tracking)解决方案:状态使用追踪
