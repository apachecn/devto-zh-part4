...
> 原文:[https://dev . to/joshuamdegzman/definitive-guide-developing-restful-API-using-python-django-and-drf-2h7e](https://dev.to/joshuamdeguzman/definitive-guide-developing-restful-apis-using-python-django-and-drf-2h7e)
...
## [](#python-and-django)Python 和 Django
...
## [](#quick-django-overview)快速 Django 概述
...
# [](#rest-apis-with-django-rest-framework)带有 Django Rest 框架的 REST APIs
...
### [](#1-installation-amp-project-setup)1。安装&项目设置
