...
> 原文:[https://dev . to/Nicky tonline/update-dependencies-with-dependency bot-cypress-and-netlify-3lkf](https://dev.to/nickytonline/update-dependencies-with-dependabot-cypress-and-netlify-3lkf)
...
## [](#get-your-repository-set-up-for-cicd)为 CI/CD 设置存储库
...
[![Branch Protection Rule](../Images/81ae3765ea73a55238366407af1cf5ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AMdiuwc0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/h5f02iehfz4jlu2p1dg3.png)

在我的例子中，因为我使用 Netlify 和 [Snyk](https://snyk.io) ，所以我希望在合并之前通过这两个状态检查。点击*保存修改*按钮。

## [](#get-cypress-set-up)把柏树立起来
...
[![Cypress Test Selection](../Images/649d81cc8943040c6333c3780bc2fd7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gdrHhmG---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/o2mkg284xtj32alrj0ge.png)

如果你的盖茨比网站正在运行，测试应该通过。

[![Cypress Test Runner with a Test Passing](../Images/02084f107c44a78eb156c32d6e6d9252.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--syfcpbU6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/5dasrrtove90dbw90718.png)

恭喜，你太棒了。在这一点上，你可以进行更多的测试，如果这些都通过了，你就可以出货了。

此时，我们已经准备好为我们的存储库重新访问我们的 Dependabot 配置。让我们改变设置，以允许我们所有的依赖关系自动 PR 合并(或配置到你喜欢的水平。

[![Dependabot Automatic PR merging settings](../Images/7ecaf1dbb5cb797654113e7490b09c05.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bSAA0e4f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/y41agaxm0dim2c45ba8h.png)
...
[![Dependabot Merged PR](../Images/aed89937dc3aae7271788effec4eed86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nd3PUX74--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/eot199766u7m1zmipwq4.png)

如果你想在我的网站上看到完整的设置，请查看我在 GitHub 上的资源库。

## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)[Nicky tonline](https://github.com/nickytonline)/[iamdeveloper.com](https://github.com/nickytonline/iamdeveloper.com)

### 我的网站 iamdeveloper.com 的源代码

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Netlify Status](../Images/afbcb9cf4dc956e7e40cbbea92c8d6f5.png)T2】](https://app.netlify.com/sites/iamdeveloperdotcom/deploys)
