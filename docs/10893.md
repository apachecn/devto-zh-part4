...
> 原文:[https://dev . to/lukaszzarzynski/五步获得个性化引导-56f6](https://dev.to/lukaszsarzynski/five-steps-to-get-personalized-bootstrap-56f6)

## [](#using-gulp-4-and-sass-preprocessor)..使用 Gulp 4 和 SASS 预处理程序
...
### [](#1-download-bootstrap-gulp-and-sass-tool)#1 下载 Bootstrap、Gulp 和 SASS 工具
...
### [](#2-copy-bootstrap-to-the-local-version)#2 复制引导程序到本地版本
...
### [](#3-change-bootstrap-personalize-it)#3 更改引导程序，将其个性化
...
### [](#4-tell-to-gulp-sass-what-is-needed)#4 告诉大口萨斯需要什么
...
### [](#5-enjoy-your-own-bootstrap)#5 享受自己的自举
