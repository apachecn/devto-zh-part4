...
> 原文:[https://dev . to/open-graph QL/graph QL-and-urql-by-example-1 LDC](https://dev.to/open-graphql/graphql-and-urql-by-example-1ldc)
...
## [](#comparison-between-apollo-and-urql)阿波罗与 Urql 的比较
...
## [](#setting-up-the-graphql-server)设置 GraphQL 服务器
...
## [](#querying-data-in-urql-using-render-props-or-react-hooks)使用 Render Props 或 React Hooks 在 Urql 中查询数据
...
## [](#mutating-data-in-urql-using-render-props-or-react-hooks)使用渲染道具或 React 钩子使 Urql 中的数据变异
...
## [](#subscribing-to-data-in-urql-using-render-props-or-react-hooks)使用 Render Props 或 React 钩子订阅 Urql 中的数据
