...
> 原文:[https://dev . to/rob _ _ race/integrating-bootstrap-4-into-rails-6-3 fgp](https://dev.to/rob__race/integrating-bootstrap-4-into-rails-6-3fgp)
...
## [](#running-a-webpack-dev-server)运行 Webpack 开发服务器
...
## [](#what-is-raw-webpackdevserver-endraw-)什么是`webpack-dev-server`？
