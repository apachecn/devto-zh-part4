...
> 原文:[https://dev . to/ba weaver/decorating-ruby-part-1-symbol-method-decoration-4po 2](https://dev.to/baweaver/decorating-ruby-part-1-symbol-method-decoration-4po2)
...
# [](#symbol-method-decoration)符号法装饰

指的是使用方法名的符号来重新定义它以添加额外的行为的修饰。这是我们在第一部分要看的，因为这里有很多内容要讲。

## [](#method-definition-returns-symbols)方法定义返回符号
...
## [](#a-method-that-eats-methods-and-raw-definemethod-endraw-)一种噬人法和`define_method`
