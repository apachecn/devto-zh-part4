...
> 原文:[https://dev . to/numtostr/running-react-and-node-js-in-one-shot-with-concurrently-2 oac](https://dev.to/numtostr/running-react-and-node-js-in-one-shot-with-concurrently-2oac)
...
#### [](#-creating-react-app)~创建 react 应用
