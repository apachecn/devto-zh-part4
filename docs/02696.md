...
> 原文:[https://dev . to/miku 86/nodejs-PostgreSQL-how-to-connect-our-database-to-our-simple-express-server-without-an-ORM-10o 0](https://dev.to/miku86/nodejs-postgresql-how-to-connect-our-database-to-our-simple-express-server-without-an-orm-10o0)
...
## [](#create-a-project-folder-do-raw-npm-init-endraw-install-express-amp-pg)创建项目文件夹，做`npm init`，安装快递& pg
...
## [](#create-raw-databasejs-endraw-with-a-generic-query)用通用查询创建`database.js`
