...
> 原文:[https://dev . to/dillion megida/inline-event-handlers-vs-addevent listener-f3l](https://dev.to/dillionmegida/inline-event-handlers-vs-addeventlistener-f3l)
...
### [](#1-inline-events-can-be-overwritten)1。内嵌事件可以被覆盖
