...
> 原文:[https://dev . to/plural sight/mocking-and-syntax-comparison-cypress-and-test cafe-1n 45](https://dev.to/pluralsight/mocking-and-syntax-comparing-cypress-and-testcafe-1n45)
...
## [](#writing-tests-testcafe-vs-cypress)写作测试:TestCafe vs Cypress
...
## [](#mocking-http-requests)嘲讽 HTTP 请求
