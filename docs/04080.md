...
> 原文:[https://dev . to/soft hints/job-automation-in-Linux-mint-for-初学者-2019-287e](https://dev.to/softhints/job-automation-in-linux-mint-for-beginners-2019-287e)
...
## [](#crontab-for-beginners)Crontab 适合初学者
...
## [](#start-random-song-from-your-machine)从你的机器上开始随机点歌
...
[![Guitar](img/02ab54bddb2d752cc4036eafbb629a07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---dN1H_bB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/os7uf1q9w2gjv0799qow.jpg)

## [](#start-motivationrelaxation-video-at-given-hour)在指定时间开始激励/放松视频
...
#### [](#how-to-download-youtube-video-in-ubuntu-linux-mint)如何在 Ubuntu / Linux Mint 下载 youtube 视频:
...
[![Meditation](img/dec0898e76bfe7176d8658705059103d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zvOp4Y16--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cvt58hwffr1ogyq3dait.jpg)
...
## [](#open-random-text-file-at-linux-mint-start)在 Linux Mint 启动时打开随机文本文件
...
## [](#scrape-webdata-and-load-the-libreoffice-or-csv-excel-etc)抓取 web 数据，加载 LibreOffice(或 csv、excel 等)
...
[![Adult](img/dec0898e76bfe7176d8658705059103d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zvOp4Y16--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cvt58hwffr1ogyq3dait.jpg)

## [](#generate-simple-report-as-doc-file-create-jupyter-notebook-and-send-mail)将简单报表生成为 doc 文件，创建笔记本并发送邮件
...
#### [](#python-how-to-create-doc-files)Python 如何创建 doc 文件
...
#### [](#python-how-to-create-jupyter-notebook)Python 如何创建 jupyter 笔记本
...
#### [](#python-how-to-send-emails)Python 如何发送邮件
