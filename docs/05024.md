...
> 原文:[https://dev . to/danimal 141/keep-your-code-format-clean-using-appearlier-40](https://dev.to/danimal141/keep-your-code-format-clean-using-prettier-40)

我最近使用了 [`prettier`](https://github.com/prettier/prettier) 来保持我团队的代码格式干净，然后我觉得它工作得很好。

本帖介绍如何在团队中使用`prettier`。

## [](#what-kind-of-project-do-we-start)我们开始一个什么样的项目？

作为一个例子，让我们考虑这样一种情况，我们将创建一个 git 存储库并编写大量 markdown 文档，任何人都可以对该存储库做出贡献。

我们当然希望保持代码格式的整洁和一致。

## [](#install-raw-prettier-endraw-)安装`prettier`
...
## [](#how-to-use-raw-prettier-endraw-)如何使用`prettier`
...
### [](#use-raw-prettier-endraw-on-ci-to-validate-the-code-format)在 CI 上使用`prettier`来验证代码格式
