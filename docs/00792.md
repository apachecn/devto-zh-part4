...
> 原文:[https://dev . to/well done 2094/use-GPS-and-magneto-for-accurate-heading-4hbi](https://dev.to/welldone2094/use-gps-and-magnetometer-for-accurate-heading-4hbi)
...
# [](#the-failed-attempts)失败的尝试

## [](#storing-the-calibration-data)存储校准数据
...
## [](#automatic-calibration-system-acs)自动校准系统(ACS)
...
[![ACS](img/18d37aa4bec473b408c6ccf884f975e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MU84owZE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/s7udh6ysyb885d3jsxol.png)
