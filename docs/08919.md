...
> 原文:[https://dev . to/kovah/cut-your-docker-for-MAC-response-times-with-docker-sync-1e8j](https://dev.to/kovah/cut-your-docker-for-mac-response-times-in-half-with-docker-sync-1e8j)
...
## [](#what-is-dockersync)什么是 docker-sync？
...
## [](#dockersync-benchmarking)docker-sync 基准测试
...
### [](#2-add-a-new-dockersyncyml-file-to-your-project)2。向项目中添加一个新的 docker-sync.yml 文件
...
### [](#4-start-the-dockersync-stack)4。启动 docker-sync 堆栈
...
#### [](#dockersync-dockercompose)坞站同步+坞站-复合
...
### [](#how-to-solve-permission-problems)如何解决权限问题
