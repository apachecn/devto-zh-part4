...
> 原文:[https://dev.to/victoravelar/episode-4-types-2l9i](https://dev.to/victoravelar/episode-4-types-2l9i)
...
### [](#wtf-are-those-things-after-the-type)WTF 是那些东西之后的类型？
...
### [](#the-practical-dev-types)实际开发类型
