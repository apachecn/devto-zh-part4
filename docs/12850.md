...
> 原文:[https://dev . to/param Harrison/how-to-draw-a-heart-using-css3-3g1n](https://dev.to/paramharrison/how-to-draw-a-heart-using-css3-3g1n)
...
#### [](#creating-heart-container)创建心脏容器
...
#### [](#create-the-pseudo-elements)创建伪元素
