...
> 原文:[https://dev . to/steadbytes/TPP-topic-14-domain-languages-2hdb](https://dev.to/steadbytes/tpp-topic-14-domain-languages-2hdb)
 ...
 **### [](#domain-language-specification)领域语言规范
...
### [](#example-raw-foo-endraw-permissions-tests)示例`/foo`权限测试
