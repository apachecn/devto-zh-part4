...
> 原文:[https://dev . to/yedukondalu 319/learn-7-basics-of-Java-programming-to-start-coding-today-3j 29](https://dev.to/yedukondalu319/learn-7-basics-of-java-programming-to-start-coding-today-3j29)

在这篇文章中，我将介绍 Java 编程的 7 个基础知识，帮助你现在就开始用 Java 编程。在继续之前，我建议您浏览一下我们关于如何从头开始学习 Java 的博客，这可以确保您心中有一个清晰的学习路线图。
...
如果以上任何一点听起来很熟悉，我有一个好消息:Java 的 7 个基本概念可以帮助你现在就开始更好地编码。您还可以找到 Java 在线课程的列表，这些课程将详细介绍这些基础概念及其应用。让我们开始讨论吧…

学习 Java 编程的 7 个基础知识，开始编写 Today.jpg

我们将以下列方式介绍 7 个 Java 编码基础元素:
...
让我们从第一个基础开始。让我们考虑一个基本的 Java 示例程序，“Hello World”程序。

1)基本程序语法:

公共类 MyfirstJavaProgram {
...
2)变量:变量用于存储数据值。这些与数据类型相关联。有不同类型的变量，如下所述:
...
继续阅读本文点击此处:[https://simpliv . WordPress . com/2019/07/09/learn-7-basics-of-Java-programming-to-start-coding-today/](https://simpliv.wordpress.com/2019/07/09/learn-7-basics-of-java-programming-to-start-coding-today/)