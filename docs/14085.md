...
> 原文:[https://dev . to/jacobm Paris/an-incomplete-guide-to-html-layouts-1din](https://dev.to/jacobmparis/an-incomplete-guide-to-html-layouts-1din)
...
# [](#two-column-layout-sidebar-and-content)两栏布局(侧栏和内容)
...
# [](#center-content-in-window)在窗口中居中显示内容
...
### [](#more-examples-to-follow)更多例子接踵而至