...
> 原文:[https://dev . to/kagundajm/laravel-development-using-PostgreSQL-and-laradock-86c](https://dev.to/kagundajm/laravel-development-using-postgresql-and-laradock-86c)

[![](../Images/365942d9c54ea80d7fefdc67cd43ed53.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MZo5Kldt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/twfp7l0i71loo8lkq525.png)
...
### [](#update-postgresql-environment-variables)更新 PostgreSQL 环境变量
...
### [](#create-unique-docker-containers)创建独特的 Docker 容器
...
### [](#provision-your-docker-containers)供应您的码头集装箱
...
### [](#verify-postgresql-database-connectivity)验证 PostgreSQL 数据库的连通性
...
### [](#creating-our-laravel-project)创建我们的 Laravel 项目
...
[![](../Images/39f530867e68780878b2ab50ede428ea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ygPdol7i--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5g60bcrkp3bil5j3fbx6.png)
...
### [](#running-our-project)运行我们的项目

打开浏览器，导航到 [http://localhost](http://localhost) ，您应该会看到 Laravel 欢迎屏幕

[![](../Images/42459b3c8c6914300f02a3daf8e65166.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aLrYigjG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cjy7qw56eqapl1ulymaw.png)
...
[![](../Images/92c2541235e76c57de3003023505113f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jqlaNake--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6sfef2tfgsokqh0ksdj7.png)

### [](#migrate-and-seed-the-database)迁移并植入数据库
