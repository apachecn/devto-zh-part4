...
> 原文:[https://dev . to/davidecavaliere/rxjs-caching-observables-with-a-decorator-12fe](https://dev.to/davidecavaliere/rxjs-caching-observables-with-a-decorator-12fe)
...
### [](#lets-move-everything-into-a-decorator)让我们把所有东西都搬进一个装饰器里
