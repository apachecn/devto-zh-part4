...
> 原文:[https://dev.to/dropconfig/using-browser-custom-events-1do9](https://dev.to/dropconfig/using-browser-custom-events-1do9)
...
## [](#listening-for-a-custom-event)监听自定义事件
