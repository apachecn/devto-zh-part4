...
> 原文:[https://dev . to/erikwhiting 88/passing-functions-as-parameters-in-JavaScript-339 a](https://dev.to/erikwhiting88/passing-functions-as-parameters-in-javascript-339a)

# [](#first-class-functions)第一类函数

在 JavaScript 中，函数被认为是“一级”或“高阶”函数。这基本上只是一种奇特的说法，我们可以将函数作为参数传递给其他函数，甚至从其他函数返回函数。

[![First class](../Images/0769edf4126a7236d823f4c56f8cfbb2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0kGBdAnZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://www.picslyrics.net/images/458/224861/thumb.jpg%3F1463657347)
