...
> 原文:[https://dev . to/jakzaizzat/how-to-build-a-reusable-vuejs-modal-component-3e9j](https://dev.to/jakzaizzat/how-to-build-a-reusable-vuejs-modal-component-3e9j)

[![Cover Image](../Images/0e6cd30fe17361badec7e1ed29aaa627.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5bpMhHd9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jakzaizzat.com/wp-content/uploads/2019/07/Featured-Image.png)

模态是用户界面中必不可少的组件之一。在不移动到其他页面的情况下显示或接收来自用户的响应是很好的。我将构建一个模态组件，并在每个页面中可重用。

我们要构建的模型是一个简单的模型，里面有静态内容。

## [](#create-a-vuejs-component)创建一个 VueJS 组件
...
## [](#call-the-component-in-your-page)调用页面中的组件
...
## [](#add-a-function-to-the-modal)给模态添加一个函数
...
## [](#receive-a-data-from-parent-in-component)接收来自父组件的数据
...
## [](#control-the-modal-visibility)控制模态可视性
...
## [](#send-the-signal-to-the-parent)向父节点发送信号
