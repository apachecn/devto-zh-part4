...
> 原文:[https://dev . to/davidgs/how-to-output-data-from-flux-to-mqtt-native-2p8c](https://dev.to/davidgs/how-to-output-data-from-flux-to-mqtt-natively-2p8c)

## [](#writing-data-from-influxdb-to-mqtt-using-flux)使用 Flux 将数据从 InfluxDB 写入 MQTT
...
## [](#adding-mqtt-to-flux)添加 MQTT 到 Flux
...
## [](#how-to-use-this-new-thing)这个新东西怎么用？
