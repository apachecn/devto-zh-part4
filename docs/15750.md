...
> 原文:[https://dev . to/victorhazbun/modern-JavaScript-初学者指南-part-1-4c10](https://dev.to/victorhazbun/modern-javascript-beginners-guide-part-1-4c10)
...
#### [](#understand-let-amp-const)明白让& const
...
#### [](#understand-the-old-var)了解旧 var

你不应该再使用`var`。🙅‍♂️

[旧“var”](https://javascript.info/var)ℹ️

## [](#spot-the-mystical-nan)点出神秘的楠

> NaN 的意思是*不是数字*。🤯

这是检查一个数字是否为 NaN 的最好方法。
[https://stackblitz.com/edit/js-hpgwny?embed=1&view=editor&file=index.js](https://stackblitz.com/edit/js-hpgwny?embed=1&view=editor&file=index.js)T2】
...
## [](#how-to-typecheck-objects)如何对对象进行类型检查

这是检查对象类型的最佳方式。
[https://stackblitz.com/edit/js-cunxw2?embed=1&view=editor&file=index.js](https://stackblitz.com/edit/js-cunxw2?embed=1&view=editor&file=index.js)T2】

## [](#function-default-parameters)功能默认参数

这是为函数定义默认参数的最佳方式。
[https://stackblitz.com/edit/js-kuv4pu?embed=1&view=editor&file=index.js](https://stackblitz.com/edit/js-kuv4pu?embed=1&view=editor&file=index.js)T2】

*   Line **(1)** :通过使用`name =`，它允许你为你的函数参数定义一个默认参数。
*   第 **(5)** 行:覆盖默认参数。
*   第 **(6)** 行:使用默认参数。

## [](#rest-parameters)休息参数
...
但是假设您想要额外的参数...
[https://stackblitz.com/edit/js-9m7jic?embed=1&view=editor&file=index.js](https://stackblitz.com/edit/js-9m7jic?embed=1&view=editor&file=index.js)T2】
...
## [](#destructuring-object-properties)析构物体属性
...
## [](#value-existence-check)值存在检查

这是检查给定对象上是否存在值的最佳方式。
[https://stackblitz.com/edit/js-l1m62a?embed=1&view=editor&file=index.js](https://stackblitz.com/edit/js-l1m62a?embed=1&view=editor&file=index.js)T2】

*   行 **(6)** :检查计算机对象上是否有一个值等于`127.0.0.1`的属性

## [](#property-existence-check)财产存在检查

有几种方法可以检查对象属性的存在。
[https://stackblitz.com/edit/js-m6zuos?embed=1&view=editor&file=index.js](https://stackblitz.com/edit/js-m6zuos?embed=1&view=editor&file=index.js)T2】

*   第 **(5)** 行:当对象有太多关键点时，性能很差。
*   第 **(6)** 行:即使对象有太多关键点也能很好地执行。

## [](#shallow-copy-objects)浅抄物体
