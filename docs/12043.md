...
> 原文:[https://dev . to/_ Miki graf/connecting-existing-users-database-to-AWS-cognito-how-to-leverage-password-authentic ation-to-use-legacy-database-1gip](https://dev.to/_mikigraf/connecting-existing-users-database-to-aws-cognito-how-to-leverage-passwordless-authentication-to-use-legacy-database-1gip)
...
[![](../Images/4b229e433e3e63f1d3adac4964b15252.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--InWzFZIZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wb4kme5cw6o2lo7ku69h.PNG)
...
## [](#define-auth-challenge-lambda)定义验证挑战λ
...
## [](#verifyauthchallenge-lambda)验证验证挑战λ
...
## [](#frontend-with-react-and-amplify)前端有反应和放大
