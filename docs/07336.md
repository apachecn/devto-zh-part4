...
> 原文:[https://dev . to/sa pegin/modern-react-testing-part-2-jest-and-enzyme-46kk](https://dev.to/sapegin/modern-react-testing-part-2-jest-and-enzyme-46kk)
...
### [](#setting-up-jest-and-enzyme)设置笑话和酶
...
[![Running Jest and Enzyme tests in the terminal](../Images/a5e8d0ea6473bfa712c8278153ff8db6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sxfHTHrj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nokm4ygln9scwcgpx5z7.png)
...
### [](#mount-vs-shallow-vs-render)挂载()vs 浅层()vs 渲染()
...
### [](#to-raw-simulate-endraw-or-not)去`simulate()`还是不去
...
## [](#enzyme-caveats)酵素注意事项

### [](#-raw-update-endraw-method)`update()`法
...
### [](#-raw-hostnodes-endraw-method)`hostNodes()`法
...
### [](#reusing-raw-find-endraw-%C2%A0queries)重用`find()`查询
