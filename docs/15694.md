...
> 原文:[https://dev . to/Chris wcs/custom-react-hooks-creating-a-use clock-hook-23pd](https://dev.to/chriswcs/custom-react-hooks-creating-a-useclock-hook-23pd)

自定义钩子是 React 的新钩子 api 的一个强大部分。在这篇文章中，我将给出一个例子来展示如何构建一个定制的钩子，以及什么时候你可能想要这样做。

## [](#rules-of-custom-hooks)自定义钩子的规则
...
## [](#reasons-for-using-custom-hooks)使用定制挂钩的原因
