...
> 原文:[https://dev.to/iris/start-trying-to-make-fetch-happen-3hp8](https://dev.to/iris/start-trying-to-make-fetch-happen-3hp8)
...
[![Movie poster for the film "It's Complicated"](img/a6290ad5990da066b341ac40099eb36e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6NIxOOQI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/89n0cr0yzwjratwm3s38.jpg)

请看 MDN 的 AJAX 资源指南中的这个简单示例:

[![Screenshot of an XMLHttpRequest from MDN](img/95597e2ff07ebaebbbf288a02c59c49a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vPcgExmG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zx8qogs91i5mkag9ozz7.png)

## [](#fetch-and-other-things-to-the-rescue)取(及其他东西)来救援！

排队一些小号和音乐膨胀，因为勇敢的图书馆从世界各地席卷而来，以挽救这一天。像 jQuery 这样的库使用助手函数来使 AJAX 变得不那么复杂。

[![A still image of two couples laughing awkwardly from the movie "It's Complicated" edited to read "It's slightly less complicated"](img/2947221a0dbac9ceefe620f78ce49077.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U3h5-zp0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q06vj4mtummackbkgd5e.jpg)
...
[![Still image from the movie "It’s Complicated" edited to read "It's even less complicated"](img/f02db81a2afcaea3f85753b8c667a6e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--21R3aA14--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bt7nl6yoxlc8bzewogf0.jpg)
...
## [](#async-await-and-the-end)异步，等待，结束…
