...
> 原文:[https://dev . to/bnevilleoneill/graphql-code-generator-1-5-is-out-5b 61](https://dev.to/bnevilleoneill/graphql-code-generator-1-5-is-out-5b61)

### 你现在可以生成阿波罗联邦解析器和完全类型化的 React-Apollo 3.0 钩子

[![](../Images/c9a050d5f658cf3918b5850e93cadf6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ha2_6k1C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hokog9jz3436glveayhs.png)
...
## [](#apollo-federation-support)阿波罗联邦支持
...
## [](#using-apollo-codegen)使用阿波罗 codegen？
