...
> 原文:[https://dev . to/dano vity/how-to-make-a-simple-hero-banner-in-react-native-3el 1](https://dev.to/danovity/how-to-make-a-simple-hero-banner-in-react-native-3el1)

今天我想写一个简短的教程，教你如何制作一个有线性渐变层的 React 原生英雄旗帜。

## [](#step-1-make-a-banner-image-using-raw-fullwidthimage-endraw-)第一步，使用`FullWidthImage`制作横幅图像
...
## [](#step-2-add-and-position-heroheadertext)第二步，添加并定位 HeroHeaderText
...
## [](#step-3-add-linear-gradient)第三步，添加线性渐变
...
## [](#step-4-add-a-herosubheader)第四步，添加一个 heroSubheader
