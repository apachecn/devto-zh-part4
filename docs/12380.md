...
> 原文：<https://dev.to/xowap/10-rules-to-code-like-nasa-applied-to-interpreted-languages-40dd>
...
## 7。检查所有非 void 函数的返回值，或者强制转换为 void 以指示返回值是无用的。
...
## 10。编译时激活所有可能的警告；然后，在软件发布之前，应解决所有警告。
