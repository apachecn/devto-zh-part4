...
> 原文:[https://dev . to/Jeet MP3/getting-started-with-graph QL-Java-53 J1](https://dev.to/jeetmp3/getting-started-with-graphql-java-53j1)
...
### [](#graphqljava-in-action)行动中的 GraphQL-Java

下面的代码将向您展示如何在 Spring 应用程序中集成 GraphQL。所以让我们从 GraphQL 模式文件开始。

代码结构将如下所示

[![GraphQL code structure](../Images/16020feb5530217e2dce8bb2f966fc2c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q5YeZRBA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/graphql/graphql-code-structure.png)

##### [](#define-schema-file-usersgraphql)定义模式文件 users.graphql
...
##### [](#step-1-read-amp-parse-schema-file)第一步:读取&解析模式文件
...
##### [](#step-2-configure-resolvers)第二步:配置解析器
...
##### [](#step-3-prepare-graphql-object-and-execute-query)第三步:准备 GraphQL 对象并执行查询
...
##### [](#step-4-serve-user-queries-on-the-endpoint-graphql)步骤 4:在端点(/graphql)上服务用户查询
...
##### [](#step-5-user-graphiql-or-rest-to-execute-graphql-query)第五步:用户 graphql 或 Rest 执行 graph QL 查询
...
[![Query hello](../Images/87eb30069e1a83b47f948c64bddbd9fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fUay-mBm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/graphql/gqlq1.png)

我们可以询问响应字段，graphql 将只服务于选定的字段。

1.  仅查询用户的姓名

[![Name only](../Images/529ac515941f24e4349ac1742c863bcc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3eADpqR4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/graphql/gqlq2.png)

1.  查询用户的所有字段

[![All fields](../Images/73fd0679fe43dbcd7a380281eae4c357.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YzLWFmHp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/graphql/gqlq3.png)

我们可以在单个请求中要求多个查询

[![Multiple queries](../Images/f9a5c5201b482a19ad087fd564ae2ece.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hLTi6XNF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/graphql/gqlq4.png)

甚至多次使用别名的相同查询

[![Duplicate queries](../Images/3b549352a0fda3c681fd91bb689c0676.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J4hoV7XF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/graphql/gqlq5.png)
