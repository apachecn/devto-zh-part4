...
> 原文:[https://dev . to/loujaybee/AWS-networking-fundamentals-a-simple-guide-for-software-engineers-4d of](https://dev.to/loujaybee/aws-networking-fundamentals-a-simple-guide-for-software-engineers-4dof)

你是否曾经进入 AWS 控制台，对所有的概念和术语感到完全困惑？你有:安全组，入站规则，VPC，子网，互联网网关，NAT，ENI，所有这些都与网络有关。简而言之:AWS 网络有很多东西。所以，如果你要打破它，你需要知道关注什么:基本面。

[![](img/9f0ec85a5c2678738b1b221650d360ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ebNJ2zSM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/www.thedevcoach.co.uk/wp-content/uploads/2019/09/AWS-Networking-Example.png%3Ffit%3D760%252C428%26ssl%3D1)
...
## [](#3-important-reasons-to-learn-aws-networking-fundamentals)学习 AWS 网络基础知识的 3 个重要原因
...
#### [](#1-aws-cloud-is-much-harder-when-you-dont-know-aws-networking-fundamentals)**1。在不了解 AWS 联网基础知识的情况下，AWS 云要难得多**。
...
#### [](#2-understanding-aws-networking-fundamentals-allows-you-to-implement-fundamentally-better-solutions)**2。了解 AWS 网络基础知识可以让您从根本上实施更好的解决方案**。
...
#### [](#3-cloud-native-is-on-the-rise-and-engineers-need-aws-networking-skills)**3。云原生正在兴起，工程师需要 AWS 联网技能。**
...
## [](#how-well-use-terraform-to-explain-the-aws-networking-fundamentals)我们将如何使用 Terraform 来解释 AWS 网络基础知识。
...
## [](#understanding-ip-and-the-need-for-private-addresses)了解 IP 和私有地址的需求。
...
[![](img/61a45f19be1133a07822e1c26685c09c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EPDp9kpJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/www.thedevcoach.co.uk/wp-content/uploads/2019/09/AWS-Networking-Example.png%3Fresize%3D760%252C428%26ssl%3D1)
...
## [](#what-is-a-virtual-private-cloud-vpc)什么是虚拟私有云(VPC)？
