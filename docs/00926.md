...
> 原文:[https://dev . to/mikister/items-in-columns-out-playing-with-CSS-grid-1en 8](https://dev.to/mikister/items-in-columns-out-playing-with-css-grid-1en8)
...
## [](#what-not-to-use-this-for)不要用这个做什么
