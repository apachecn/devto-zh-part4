...
> 原文：<https://dev.to/solacedevs/rapid-iot-prototyping-with-the-bosch-xdk110-and-an-event-mesh-3688>
...
[![](img/4a71dde5037d0505bc5c83e37e74f09d.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_01-1.png)

## 混合物联网事件网格支持的参考平台

让我们更仔细地看看下游系统和作为系统一部分的交互。下图提供了一个概述:

[![](img/173049ad5fd060a73827196751167c6c.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_02-1.png)
...
[![](img/67316dea6a504d912dc4ede43df44446.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_03-1.png)
...
[![](img/7404690f2490f1eb8df4ee21a917b78b.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_04-1.png)
...
[![](img/5fdffbf59bac38eba568444f1b4cd321.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0mPLoT3U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_06-1-1024x633.png)
...
[![](img/d6b3c2541ae49bff8e3a8e31ef6f4c04.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_07-1.png)

## 利用 SL RTView 实现实时物联网数据可视化

SL RTView 是一个可配置的通用工具，用于各种数据可视化。我们还使用 RTView 实现了 XDKs 发布的实时物联网事件数据的可视化。

来自 XDK 的各种传感器数据的实时快照:

[![](img/6836a126703caf3e08c237dbfa949f21.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_08.png)

XDK 传感器数据的时间序列图；

[![](img/15689bffa1e688a46a63d81af116337d.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_09.png)

## 使用 Altair Panopticon 进行视觉分析
...
[![](img/87a09de3cb1a619493259ba2c7eefb95.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_10.png)

在下一张图中，我们可以看到一辆卡车在赛道上“正常”地跑了几圈。陀螺仪的 X 和 Y 值相当低，而陀螺仪的 Z 值更有意思。它们非常清晰地展示了卡车如何在赛道上左右转弯。

[![](img/da419975e2061873c300df14858b117c.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_11.png)

当我们看到一辆卡车冲出轨道时，事情变得有趣了。在这种情况下，陀螺仪的 X 和 Y 值出现尖峰，正如我们在下面的屏幕截图中看到的:

[![](img/5f09f9d9892eaa3e08b36c4e7c5dad08.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_12.png)
...
[![](img/1bfb09a398210344eefdaad7d727da8a.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_13-1.png)

使用 Dell Boomi 集成实现了与 Salesforce 的集成。下图显示了该集成的流程定义:

[![](img/157c62a05f575590d56d8883c4df1c29.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_14.png)

当流式分析模块检测到车祸时，会在 Salesforce 中自动创建一个服务案例:

[![](img/29de7adb7069220f26df0682806abba4.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_15.png)
...
[![](img/37c204dea7f889fcd07a953feb363ea7.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_16.png)

之后，您可以添加发布者和订阅者。以下是 XDK 发送的指标订阅者的屏幕截图:

[![](img/e2b8d57c798d618a5f548841d25c2248.png)](https://solace.com/wp-content/uploads/2019/08/iot-prototype-blog-post_17.png)
