...
> 原文:[https://dev.to/syncfusion/file-explorer-in-javascript-4j2a](https://dev.to/syncfusion/file-explorer-in-javascript-4j2a)
...
*   网格视图
    ...
    <figure>![File Explorer Layout with Tile view](../Images/a143a358b99d3fe02ef8d4464b6011d6.png)

    <figcaption>文件浏览器布局带平铺视图</figcaption>

    </figure>

    <figure>![File Explorer Layout with Detailed Grid View](../Images/70f59775ac615d0e797c42b2e41c130a.png)
...
[![File Explorer built-in image preview option](../Images/a02341ea45f5d02465ccc87daf5a0156.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dMelLlMZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/File-Explorer-image-built-in-preview-option.gif) 
...
[![File Explorer with Customized Layout](../Images/03a0dc940b42749814c6490db47d9c27.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--AyVWc3lo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/File-Explorer-with-Customized-Layout.png) 
...
## [](#custom-tool-support)自定义工具支持

在文件资源管理器工具栏中，您可以创建带有自定义操作的自定义工具。例如，这里的帮助工具是作为工具栏中的自定义工具创建的。

[![File Explorer with Custom Tool](../Images/37b7fcab31450352136832dd2b47a3a3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wU_z-hL9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/File-Explorer-with-Custom-Tool.png) 
...
## [](#sorting-support)支持排序

在详细视图或网格视图中，文件可以按所需字段排序。

[![Sorting the files with ascending / descending order](../Images/85a59b163f269a9f3245c7575ffa8062.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VkvDpdAj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/File-Explorer-sorting-the-files.gif) 
...
[![Virtual scrolling with large number of files](../Images/285fe3b163e2064f8722cf3540cc516a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--z7lm0dwq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/File-Explorer-virtual-scrolling.gif) 
...
[![Folders with Access Permission Restricted](../Images/38daea84a18c54923b2a453124fb338f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--l4VqZ7xR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/Folders-with-Access-Permission-Restricted.png) 
...
## [](#shared-folder-support)共享文件夹支持

文件资源管理器还可以管理本地共享机器上的文件和文件夹。当您通过 intranet 环境访问文件时，这很有用。

[![Accessing the shared location](../Images/01b4578822e07a3e62bd7b30328895b1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--GR1F2d4j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2018/08/Accessing-Shared-Folder-from-File-Explorer.png) 
...
### [](#azure-storage-support)Azure 存储支持
...
### [](#sql-database-support)SQL 数据库支持
