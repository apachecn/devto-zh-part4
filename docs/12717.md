...
> 原文:[https://dev . to/hot gazpacho/Apollo-client-fetch policies-react-and-pre-rendering-1i 77](https://dev.to/hotgazpacho/apollo-client-fetchpolicies-react-and-pre-rendering-1i77)
...
## [](#enter-raw-fetchpolicy-endraw-)输入`fetchPolicy`
...
### [](#-raw-cachefirst-endraw-)`cache-first`
...
### [](#-raw-cacheandnetwork-endraw-)`cache-and-network`
