...
> 原文:[https://dev . to/nejremeslnici/migrating-from-jquery-ujs-to-rails-ujs-k9m](https://dev.to/nejremeslnici/migrating-from-jquery-ujs-to-rails-ujs-k9m)
...
### [](#why-would-you-want-to-migrate)为什么要迁移？
...
### [](#dealing-with-ajax-event-handlers)处理 AJAX 事件处理程序

这就是迁移开始有点棘手的地方…

#### [](#the-new-event-parameters-syntax)新增事件参数语法
...
#### [](#migrating-jquery-events-to-ujs-events)将 jQuery 事件迁移到 UJS 事件
...
#### [](#watch-out-for-proper-ajax-data-type)注意合适的 AJAX 数据类型
...
#### [](#dont-expect-to-raw-trigger-endraw-ujs-actions-any-more)不要再指望`trigger()` UJS 的行动了
