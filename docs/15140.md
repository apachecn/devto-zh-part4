...
> 原文:[https://dev . to/nanythery/bash-consoles-for-windows-hyper-vs-git bash-my-experience-so-far-555 l](https://dev.to/nanythery/bash-consoles-for-windows-hyper-vs-gitbash-my-experience-so-far-555l)
