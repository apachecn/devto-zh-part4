...
> 原文:[https://dev . to/kevinmungai/state-machines-and-ussd-applications-1 nch](https://dev.to/kevinmungai/state-machines-and-ussd-applications-1nch)
...
# [](#what-is-this-state-machine)这是什么状态机？
