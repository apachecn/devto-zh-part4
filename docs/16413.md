...
> 原文:[https://dev . to/kambanthemaker/a-light-weight-text-classifier-in-python-4o 36](https://dev.to/kambanthemaker/a-light-weight-text-classifier-in-python-4o36)
...
## [](#lightweight-supervised-classification)轻量级监督分类
...
## [](#tools-for-text-classification)文本分类工具
