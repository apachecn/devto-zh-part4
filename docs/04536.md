...
> 原文:[https://dev . to/kamaal/a-quick-guide-to-testing-react-hooks-that-use-rxjs-4 LPA](https://dev.to/kamaal/a-quick-guide-to-testing-react-hooks-that-use-rxjs-4lpa)
...
### [](#hooks-that-we-are-using-here)我们这里用的钩子。

*   **使用状态:**用状态增强功能部件。
*   **useEffect:** 我们可以进行 DOM 操作和选择。

### [](#rxjs-operators-we-are-using-here)我们这里用的 RxJs 运算符。
...
[![Test result v1](img/bfb494fb53cc04c6ef947e7790324b2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XQg-uLF1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3pqegyblvxim7whijiui.jpg)
...
## [](#test-subscriber-and-useeffect)测试订阅者和 useEffect。
...
[![All tests](img/b84370297301d186bdb9cf7385d54c4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5Chz7rdq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/an1wd8e81i9sea1z4d6r.jpg)
...
[![Build Status](img/57676ed445674a4edc0fe0a1be4bcae8.png)T2】](https://travis-ci.org/kamaal-/react-hook-rxjs-test)
