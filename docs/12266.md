...
> 原文:[https://dev . to/npentrel/docker-行话-from-docker file-to-container-942](https://dev.to/npentrel/docker-jargon-from-dockerfile-to-container-942)
...
[![Docker logo](../Images/ba658045da5facee6386fe92ba6a44f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C3Vd9b_O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ngmui5tyc9dcc0rs12s3.png)
...
[![A Dockerfile is turned into a Docker Image by running the command `docker build .`. A Docker Container is run on top of a Docker Image by running the command `docker run`.](../Images/61b237fa55aed3b2daf742c557f76eda.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--X0q5Qmh7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5qq30mkchh5klr2yr48o.png)
...
[![Image showing layers stacked on top of each other, forming an image](../Images/ca45075569c0fd04940c4a4bdaaafe55.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--x_PKqu2v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mn7ueb9f1yp7q8ytxgq6.png)

<figcaption>Source: https://docs.docker.com/terms/images/docker-filesystems-multilayer.png</figcaption>
...
[![Multiple containers are shown as thin read-writable layers which all point to the same image](../Images/4106a8458c7ff72d148774d5c2cc4617.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T3aqgK4d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kk4fknsqcaf45ew1qju3.jpg)
...
T3![The Docker Engine is shown to comprise the Docker CLI and the Docker daemon. These all sit on top of the operating system and manage the containers which are also directly on top of the operating system](../Images/af5111f01d05d7051e2737bd31c8c9d8.png)T5】
