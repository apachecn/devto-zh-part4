...
> 原文:[https://dev . to/luka bratos/how-to-save-swift-enum-types-with-associated-values-3o 33](https://dev.to/lukabratos/how-to-save-swift-enum-types-with-associated-values-3o33)
...
## [](#adding-codable-conformance)添加可编码一致性
...
## [](#persisting-values-atomically-to-the-file)将值自动保存到文件中
...
## [](#reading-values-from-the-file)从文件中读取数值
