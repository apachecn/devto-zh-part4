...
> 原文:[https://dev . to/swyx/tutorial-on-deploying-a-create-react-app-website-to-netlify-418 l](https://dev.to/swyx/tutorial-on-deploying-a-create-react-app-website-to-netlify-418l)

## TL；速度三角形定位法(dead reckoning)

单击此处:

[![Deploy to Netlify](../Images/8f270f0bff04fe4f2060a41c2299611b.png)T2】](https://app.netlify.com/start/deploy?repository=https://github.com/netlify-labs/deploy-create-react-app&utm_source=blog&utm_medium=devto&utm_campaign=devex)
