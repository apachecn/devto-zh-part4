...
> 原文:[https://dev . to/imtyrelchambers/build-a-Reddit-scraper-composing-messages-4 ILP](https://dev.to/imtyrelchambers/build-a-reddit-scraper-composing-messages-4ilp)
...
## [](#creating-our-submit-handler)**创建我们的提交处理程序**
...
#### [](#formatting-our-formdata)**格式化我们的表单数据**
...
#### [](#save-our-author-to-the-database)**将作者保存到数据库**
...
#### [](#handling-our-component-state)**处理我们的组件状态**
