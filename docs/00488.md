...
> 原文:[https://dev.to/vinistock/write-a-simple-dsl-in-ruby-1jgi](https://dev.to/vinistock/write-a-simple-dsl-in-ruby-1jgi)

# [](#what-is-a-dsl-and-what-is-it-used-for)什么是 DSL，它是用来做什么的？
...
# [](#how-to-create-a-dsl-in-ruby)如何在 Ruby 中创建 DSL
