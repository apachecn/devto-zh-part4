...
> 原文:[https://dev . to/it next/hands-on-guide-configure-your-kubernetes-apps-using-the-config map-object-44gj](https://dev.to/itnext/hands-on-guide-configure-your-kubernetes-apps-using-the-configmap-object-44gj)
...
[![](img/26cf6090126e7e799ee16033b1094c90.png)T2】](https://i.giphy.com/media/l2SpYDOZmp3H2cAAo/giphy.gif)
...
### [](#using-environment-variables-for-configuration)使用环境变量进行配置
