...
> 原文:[https://dev.to/samanthaming/css-only-child-1j6d](https://dev.to/samanthaming/css-only-child-1j6d)

[![CodeTidbit by SamanthaMing.com](../Images/90a01f5f8d02e2ef725441bec5bd0b85.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7qDEu9cn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pty03v3asw69wy7llz7b.png)
...
[![Code Sample Output](../Images/d993fa990872c2966fda76f73aebfdcf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aOI-__Qx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qbvk1g6nva84syq8ixof.png)

## [](#alternative-solutions)备选方案

或者，您也可以使用其他子选择器来实现这个“唯一的孩子”

### [](#using-firstchild-and-lastchild)使用:第一个孩子和:最后一个孩子
...
### [](#using-nthchild-and-nthlastchild)使用:n-child 和:n-last-child
...
## [](#onlychild-vs-onlyoftype)独生子女 vs 独生子女
...
### [](#example-not-onlychild)举例:非独生子女
...
## [](#update-onlychild-in-css-selectors-4)更新:CSS 选择器 4 中的独生子女
...
### [](#firstchild-vs-onlychild)第一胎 vs 独生子女
