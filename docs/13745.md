...
> 原文:[https://dev.to/jay_tillu/numbers-in-kotlin-54ke](https://dev.to/jay_tillu/numbers-in-kotlin-54ke)
...
#### [](#integer-literal-constants)整数文字常数
...
#### [](#fractional-literal-constants)分数文字常数
...
## [](#underscores-in-numeric-literals-since-version-11)数字文字中的下划线(从版本 1.1 开始)
