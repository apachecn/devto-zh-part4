...
> 原文:[https://dev . to/PC Michaels/setting-up-entity-framework-core-for-a-console-application-one-error-at-a-time-1pn 5](https://dev.to/pcmichaels/setting-up-entity-framework-core-for-a-console-application-one-error-at-a-time-1pn5)
...
[![](../Images/de7f3f330ca291f2a4e17cf75ab59ca8.png)T2】](http://pmichaels.net/wp-content/uploads/2018/02/EF-1.png)

所以我们需要添加一个迁移？如果我们在这里调用`Add-Migration`,我们会得到这个:

> 如果你尝试过这个:删除-迁移将恢复它。

[![](../Images/ac5ef448cdff5e91af411f84c6993be9.png)T2】](http://pmichaels.net/wp-content/uploads/2018/02/EF-2.png)
...
[![](../Images/86ac8969148a427b3166787614918e15.png)T2】](http://pmichaels.net/wp-content/uploads/2018/02/EF-3.png)
