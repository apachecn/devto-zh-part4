...
> 原文:[https://dev . to/mega zear 7/using-async-await-with-callbacks-28o 4](https://dev.to/megazear7/using-async-await-with-callbacks-28o4)
...
## [](#a-promiseless-starting-point)一个没有承诺的起点
...
## [](#a-promise-filled-update)一诺千金更新
