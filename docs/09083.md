...
> 原文:[https://dev . to/this dot media/vue-js-for-angular-developers-566g](https://dev.to/thisdotmedia/vue-js-for-angular-developers-566g)
...
[![](../Images/dc14175a784fe9ace09edf3c0c0f93f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ogJ63-e7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a7bu8eb8eog060etn0yj.PNG)

这篇文章的源代码可以在这个 GitHub [repo](https://github.com/bhaidar/todo-vue) 获得。
让我们开始编写 Todo 应用程序吧！

## [](#create-vue-app)创建 Vue app
...
[![](../Images/6da4eb672a97f3bb0f87ca2db171e362.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3shhYEoy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/85d6525kz0xgtmotjpel.PNG)

Vue UI 的主页允许您管理现有项目、创建新项目和导入现有项目。

点击**创建**选项卡，您将看到类似如下的内容:

[![](../Images/80ff9b759de9673144975c611aba3490.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qvF15SfL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ydxeflt0vmev7y3riivz.PNG)

将系统路径更改为要创建新项目的目录。在我的例子中，我选择了路径`D:\Projects`

找到并点击**在此创建新项目**按钮。将打开一个新页面，如下所示:

[![](../Images/446515389c22a61f2a96713c19a84c1d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eSjcAlj5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xjsf04mwylqaaonz55q9.PNG)
...
[![](../Images/cf26fe7af815854e9d544005f4be256b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--75Y0Fdip--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gbte4wletb6hctde0zbp.PNG)

您可以选择**默认预设**来创建具有默认功能和选项的应用程序。我选择了**手动**选项，这样我就可以定制我的应用程序生成。

找到并点击**下一个**按钮，转到您选择希望应用程序包含哪些功能的页面。

[![](../Images/167832c6151c0fe156464e6bb4a26ef4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Pdxscy9z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9sl8m33ah1dk6gy8js1j.PNG)
...
[![](../Images/998e23ac70171098e62ba5ef8d0fcb5f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H1x8SsnD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i6tcbrj55lusn39yi9sa.PNG)
...
[![](../Images/9bd7d4d3812329b6060db08b01e3cd4b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---qXWZbJH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7vnt1vzsn5x9mucr2me2.PNG)

**NB** :在项目文件生成过程开始之前，会出现一个提示，询问您是否要将当前设置保存为预置。如果您愿意，这将保存所有首选项和配置供将来使用。现在，我将继续，而不将其保存为预设。

一旦生成过程结束，您将创建以下项目:

[![](../Images/8e5e76198e5e9b79dc2fff925d87c918.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TvT1q50E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p3n9z5gxcj6y6kq92zdp.PNG)
...
## [](#anatomy-of-a-vuejs-app)剖析一个 Vue.js app
...
## [](#vuex-state-management-simplified)Vuex -状态管理简化
...
## [](#building-the-todo-app)构建待办事宜 app
...
### [](#todobrand-component)TodoBrand 组件
