...
> 原文:[https://dev . to/and be/when-seri log-works-locally-not-on-azure-app-service-557 e](https://dev.to/andbe/when-serilog-works-locally-but-not-on-azure-app-service-557e)
