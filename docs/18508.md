...
> 原文:[https://dev . to/danimal 141/how-to-investigation-memory-usage-on-elastic cache-for-redis-5dm 5](https://dev.to/danimal141/how-to-investigate-memory-usage-on-elasticache-for-redis-5dm5)

最近，我遇到了一个问题，Redis 的 ElastiCache 上的内存使用量变得很大。这篇文章描述了我们如何调查这样一个问题(哪些键是 ElastiCache 上的瓶颈)。

## [](#export-and-download-a-redis-backup)导出并下载 Redis 备份
...
## [](#analyze-raw-rdb-endraw-with-redisrdbtools)用 redis-rdb-tools 分析`.rdb`
