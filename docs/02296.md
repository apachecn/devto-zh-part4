...
> 原文:[https://dev.to/swlkr/do-good-daily-day-3-4cka](https://dev.to/swlkr/do-good-daily-day-3-4cka)
...
## [](#setting-swiftui-initial-state)设置 SwiftUI 初始状态
...
## [](#serialize-app-state-to-a-json-file)将应用状态序列化为 json 文件
