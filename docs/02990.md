...
> 原文:[https://dev . to/omri Lotan/front-end-observability-a-practical-guide-to-browser-error-monitoring-2g cm](https://dev.to/omrilotan/front-end-observability-a-practical-guide-to-browser-error-monitoring-2gcm)
...
## [](#-raw-windowonerror-endraw-good-news-everyone)🎉好消息，各位！
...
#### [](#key-players-of-our-system)我们系统的关键人物
...
## [](#%F0%9F%96%A5-browser)🖥浏览器

### [](#make-sure-youve-set-cors-headers)确保你已经设置了 CORS 标题
...
### [](#dont-bully-your-tenants)不要欺负你的房客
...
### [](#details-about-the-error)关于错误的详细信息
...
### [](#lots-and-lots-of-details)许许多多的细节
...
### [](#add-some-unique-details)添加一些独特的细节
...
### [](#declare-log-stream-subsystem)声明日志流/子系统
...
### [](#create-separate-streams-for-providers)为提供商创建单独的流
...
## [](#%F0%9F%97%84-logs-aggregator)🗄日志聚合器
...
[![](img/2f03f56a6a68e2859faa8954135d3683.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DO4vantn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f1rumnym0byi5d5k02ao.png)

### [](#log-reduce-loggregation)对数减少/对数聚集

我们将尽可能多的细节发送到日志中，并且我们希望有一个系统能够在警报触发时帮助我们找到模式。在您选择的日志提供程序中寻找这个特性。

### [](#be-elaborative-in-alert-descriptions)对预警的描述要详细
...
### [](#help-your-database-recognise-important-patterns)帮助你的数据库识别重要模式。
...
## [](#%E2%80%8D-who-watches-the-watchmen)💂谁在看《守望者》的‍？
...
### [](#catch-errors-in-the-error-handler)在错误处理程序中捕捉错误
...
### [](#monitor-the-error-log-stream)监控错误日志流
...
## [](#%E2%80%8D%E2%80%8D-extracurricular-activities)🤸‍‍课外活动
...
### [](#avoid-errors-from-old-cached-pages)避免来自旧的缓存页面的错误
...
### [](#sourcemap-integration)Sourcemap 集成
