...
> 原文:[https://dev . to/Adrian designs/post CSS-preset-env-babel-for-CSS-12hp](https://dev.to/adrianbdesigns/postcss-preset-env-babel-for-css-12hp)

在过去的一年半时间里，在所有用于编写 CSS 的工具(或风格)中，PostCSS 是我个人最喜欢的。设置真的很简单，它有大量非常有用的插件，而且性能很好。我最喜欢的一个插件绝对是`postcss-preset-env`。

## [](#what-is-postcsspresetenv)什么是 postcss-preset-env？
...
**成绩**
[![Alt Text](../Images/b15c80aaac814fec69af17dc8ad277e9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8f4_85a---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u68aqybwbyc3ux5ncl6n.JPG)
