...
> 原文:[https://dev . to/juliang/sharing-remote-data-with-react-context-3859](https://dev.to/juliang/sharing-remote-data-with-react-context-3859)
...
## [](#sharing-remote-data-with-react-context)与 React 上下文共享远程数据
...
[![List of games with totals panel](img/64117fd88ed6953ebda749e0ceaf70d7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IJFYysQF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/onbdxd66zfp7scwt3ebe.png)

### [](#lifting-state-to-a-common-ancestor)解除国家对共同祖先的限制
...
### [](#sharing-state-using-hooks-the-wrong-way)共享状态使用钩子(错误方式)
...
[![the total panel reports zero finished games but the gamegrid shows 2 games are finished](img/9df86707856cd4ccf877bf0ec18a4732.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--llnTAVhT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x8ads85i0ay7ijcfym2q.png)

例如，在将两个游戏标记为完成后，`GameGrid`组件如预期的那样显示它们已经完成，但是`Totals`组件继续报告零个游戏完成。

这就是为什么我们只需要获取和更新一个游戏列表。

### [](#sharing-state-using-react-context-the-right-way)使用 React 上下文共享状态(正确方式)
...
[![correct-totals](img/c9137fbb955218ebbe502c949d43c2e1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CJd7n5Z6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/12mn1tgnprhg8x012zft.png)
