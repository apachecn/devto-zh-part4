...
> 原文:[https://dev . to/bgopikrishna/how-to-use-local-storage-in-JavaScript-26d 6](https://dev.to/bgopikrishna/how-to-use-local-storage-in-javascript-26d6)
...
### [](#removing-the-particular-data)删除特定数据
