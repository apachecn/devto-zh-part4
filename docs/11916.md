...
> 原文:[https://dev . to/numtostr/running-react-and-node-js-in-one-shot-with-docker-3o 09](https://dev.to/numtostr/running-react-and-node-js-in-one-shot-with-docker-3o09)
...
## [](#-client-setup-react)#客户端设置(React)
...
#### [](#-dockerfile-for-react)~ Dockerfile for React
...
## [](#-server-setup-nodejs)#服务器设置(Node.js)
...
#### [](#-dockerfile-for-node-server)~节点服务器的 Dockerfile
...
## [](#-running-with-dockercompose)#用 docker-compose 运行
