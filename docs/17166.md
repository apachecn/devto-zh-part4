...
> 原文:[https://dev.to/fosteman/unidirectional-data-flow-4hb3](https://dev.to/fosteman/unidirectional-data-flow-4hb3)
...
### [](#heres-how-unidirectional-dataflow-is-established)单向数据流是如何建立的:
