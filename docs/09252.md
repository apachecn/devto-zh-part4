...
> 原文:[https://dev . to/tman 540/simple-remote-back door-with-python-33a 0](https://dev.to/tman540/simple-remote-backdoor-with-python-33a0)

### [](#note-before-you-start-reading-this-tutorial-do-not-use-this-code-for-malicious-purposes-this-is-tutorial-is-only-for-educational-purposes)注意:在开始阅读本教程之前:不要将此代码用于恶意目的。本教程仅用于教育目的！

## [](#part-1-what-is-a-backdoor)第一部分:什么是借壳？
...
## [](#part-2-how-to-build-a-custom-backdoor-client)第 2 部分:如何构建定制后门(客户端)
...
## [](#part-3-how-to-build-a-custom-backdoor-server)第三部分:如何构建自定义后门(服务器)
