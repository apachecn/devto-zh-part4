...
> 原文:[https://dev.to/sustained/laravel-vue-4530](https://dev.to/sustained/laravel-vue-4530)
...
# [](#reasons-to-use-vue-and-laravel-together)一起使用 Vue 和 Laravel 的理由

## [](#scaffolded-by-default)默认脚手架
...
## [](#widespread-community-adoption)广泛的社区采用
...
# [](#common-gotchas-when-using-vue-and-laravel-together)一起使用 Vue 和 Laravel 时的常见问题

## [](#blade-and-vue-interpolation-syntax)Blade 和 Vue 插补语法
...
## [](#passing-php-variables-as-vue-component-props)传递 PHP 变量作为 Vue 组件道具
...
## [](#laravel-router-and-vuerouter)Laravel 路由器和 vue 路由器
...
#### [](#create-a-router-instance-and-some-routes)创建一个路由器实例和一些路由
...
#### [](#create-a-simple-app-component)创建一个简单的 App 组件
...
#### [](#create-a-few-page-components)创建几个页面组件
...
#### [](#configure-the-root-vue-instance)配置根 Vue 实例
...
#### [](#configure-the-laravel-router)配置 Laravel 路由器
...
#### [](#create-the-controller-and-action)创建控制器和动作
...
## [](#lack-of-webpack-aliases-when-using-laravel-mix)使用 Laravel Mix 时缺少 Webpack 别名
