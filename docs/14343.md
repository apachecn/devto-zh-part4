...
> 原文:[https://dev . to/checkly/how-we-deal-with-plan-limits-in our-vue-js-SaaS-app-1p7o](https://dev.to/checkly/how-we-deal-with-plan-limits-in-our-vue-js-saas-app-1p7o)
...
## [](#example-1-plan-expiry-nag-screen)例 1:计划到期日屏幕

如果你的计划即将到期，这就是出现在导航栏顶部的内容。这种情况只在两种情况下发生:

1.  您是试用用户，尚未升级。
2.  你是我们这个秘密且排外的社团的付费会员，但是由于某种不言而喻的原因，你的信用卡失效了。![Example of plan expiry nag message](../Images/e94e7a009d6be5bbb9ab52cdef8bb914.png)
...
## [](#example-2-plan-volume-limit-reached)例 2:达到计划容量限制

这是用户在已经达到计划限额的情况下试图再创建一张支票时看到的情况。

[![Example of plan volume message](../Images/947a6353cdaaac57433f9bf9692740e1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KcfzaoAb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.checklyhq.com/content/images/2019/03/Screen-Shot-2019-03-31-at-20.15.45.png)
...
## [](#example-3-plan-feature-toggle)例 3:计划特征切换

以下是当您的计划没有特定功能时所看到的情况，在这种情况下，Pagerduty 集成不在我们的开发人员计划中。

[![Example of plan feature toggle message](../Images/82d6bb144df837045d360d0c908aaf56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2jCIdTY---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.checklyhq.com/content/images/2019/03/Screen-Shot-2019-03-31-at-20.22.00.png)
