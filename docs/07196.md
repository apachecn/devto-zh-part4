...
> 原文:[https://dev . to/paulasantamaria/document-your-JavaScript-code-with-jsdoc-2fbf](https://dev.to/paulasantamaria/document-your-javascript-code-with-jsdoc-2fbf)
...
[![A screenshot of the documentation formatted in the website including all the JSDoc tags specified in the previous code](../Images/9bf0e3f10aecbf0496001d38204d6c0b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--21dnoAHa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/cdcDW66.png)
...
### [](#export-files-or-folders)导出文件或文件夹
...
### [](#export-all-files-recursively)递归导出所有文件
...
### [](#use-a-configuration-file)使用一个配置文件
...
# [](#other-cool-stuff-about-jsdoc)关于 JSDoc 的其他酷事

## [](#built-in-support-in-vscode)在 VSCode 中内置支持

所以，就像我说的，我甚至在安装 JSDoc 之前就喜欢它了，这是因为 VSCode 内置了对 JSDoc 注释的支持，包括:

*   当您在函数声明前键入`/**`(然后按 enter 键)时，它会为您构建 JSDoc 注释结构。![VSCode automatically generates the structure of the JSCode annotations for a function](../Images/13f0de56a9577be9971392b503923604.png)
*   丰富的悬停信息![VSCode displays all the tags from a function when you hover said function](../Images/62d0761b53aacd0a41411557ca5fd5aa.png)
*   关于您正在使用的函数签名的信息![VSCode displays info about the function params when the user types the name of the function](../Images/c4c88b9a88903f10414edc4a96a1a786.png)
...
## [](#jsdoc-and-swagger)JSDoc 和 Swagger
...
## [](#know-any-other-interesting-jsdoc-feature)知道 JSDoc 还有什么有趣的特性吗？
