...
> 原文:[https://dev . to/Alex MacArthur/deploying-code-with-a-git-hook-on-a-digital ocean-droplet-5h 60](https://dev.to/alexmacarthur/deploying-code-with-a-git-hook-on-a-digitalocean-droplet-5h60)
...
## [](#configure-a-remote-repository-on-your-droplet)在您的 Droplet 上配置远程存储库
...
## [](#configure-your-local-repository-for-easier-deployments)配置您的本地存储库以便于部署
