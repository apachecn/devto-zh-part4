...
> 原文:[https://dev . to/this dot media/mixing-story book-with-angular-a-spray-of-appli tools-33bl](https://dev.to/thisdotmedia/mixing-storybook-with-angular-with-a-sprinkle-of-applitools-33bl)

[![](../Images/cd38a0a7d13059da5bc3e3aeffc33589.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YRC8deKz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AQIVngeAg0WMqyb4wupevDw.jpeg)
...
## [](#create-angular-7-app-using-the-latest-cli)使用最新 CLI 创建 Angular 7 App
...
[![ContentEditableComponent in action](../Images/5114415cfc1602379ee93776f6599efb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DDuy0cg2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2ApFhETPGvj9JNtRc4a_wVQg.png)

您可以开始在黄色的可编辑矩形中键入，您将看到您在下面键入的任何内容。

让我们换个方式，将故事书添加到应用程序中。

## [](#add-storybook-packages)添加故事书包
...
## [](#create-and-run-a-few-storybook-stories)创建并运行几个故事书故事
...
[![ContentEditableComponent under Storybook IDE](../Images/5ca837ac758bafff3f9d9b14d3a9a5c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VKV02m0v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AEppbFXA4I1q3dM6pMJXygQ.png)

既然我们已经确定故事书故事已经建立并运行了，那么让我们设置 Applitools 来使用这些故事并运行我们的可视化自动化测试。

## [](#add-and-run-applitools-storybook-sdk-for-angular)添加并运行 appli tools Storybook SDK for Angular
...
## [](#review-test-results-on-applitools-test-manager)在 Applitools 测试管理器上查看测试结果
...
[![Applitools Test Manager Results](../Images/28855d79cb0393d006a41b12ba1867f0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZGyNBLvE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2At_0-_CZHNtl4iibupPJ1eA.png)

测试管理器在左侧列出了测试运行或批次(由 Applitools 引用)。单击任何一个批处理都会显示应用程序中所有故事书故事的所有快照。

单击第一个快照(红色)以展开并详细查看:

[![Inspecting results with Test Manager](../Images/d5ac71015821cc283e7b1f04bd95861a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---rFgDjaC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2Aw4SgCd5rQzbwCR7bYsDG3g.png)
...
[![Showing differences on the Test Manager](../Images/f4dff75d6b5d4dd55989b5523596a9bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aLHgL5Mv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2Av3fmPie91oW75Xvc59PJKg.png)
...
[![Compare two snapshots side by side](../Images/cacb93168582597bf8ae7c64aa02b475.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HNHfx-Ad--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A79K8ehcwVaxO_LPuLWM-OQ.png)
