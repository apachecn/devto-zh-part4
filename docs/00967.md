...
> 原文:[https://dev . to/sophia Brandt/phoenix-1-4-with-bootstrap-jquery-bootstrap-notify-sass-and-web pack-3fd 2](https://dev.to/sophiabrandt/phoenix-1-4-with-bootstrap-jquery-bootstrap-notify-sass-and-webpack-3fd2)
...
# [](#add-bootstrap-and-font-awesome-to-css)给 CSS 添加自举和字体 Awesome
...
# [](#add-jquery-and-jquery-plugins-to-javascript)给 JavaScript 添加 jquery 和 jquery 插件
