...
> 原文:[https://dev . to/neth _ 6/free-phone-SMS-verification-on-your-website-in-10-minutes-1558](https://dev.to/neth_6/free-phone-sms-verification-on-your-website-in-10-minutes-1558)

# [](#phone-sms-verification-overview)手机短信验证概述
...
# [](#how-does-phone-sms-verification-work)电话短信验证是如何进行的？

我们向手机发送一次性密码(OTP ),以便只有能够访问手机的用户才能调用 OTP 并在网站上输入它，以证明她拥有该手机。

# [](#how-to-send-sms-otp-for-free)如何免费发送短信 OTP？
...
# [](#outline-of-sms-verification-implementation)短信验证实施概述
...
## [](#signup-for-ringcaptcha)注册 Ringcaptcha
...
[![](../Images/da0e3ead6b42f804f97608e650ebd126.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--x7zyn2li--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z3t08ecpgcza663o6av3.png)

## [](#create-ringcaptcha-app)创建 Ringcaptcha 应用程序

登录后，点击左侧菜单中的“我的应用”,然后点击“我的应用”页面右上角的“新建”按钮。

[![](../Images/7dc414c457d1c09a47baf087314ad108.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---e0hLjvt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d02042jn7mwhtddbx7rr.png)
...
[![](../Images/6ae1c5d5e0c99f400a3d31a0000150dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mV3X362h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/loz3omn9aji8qi725cho.png)

## [](#get-ringcaptcha-app-and-api-keys)获取 Ringcaptcha 应用程序和 API 密钥

您将看到您新创建的应用程序。

[![](../Images/e71b9c1d29696f624152094d692467e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Bd1llAww--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3kbspetx2gpt368z3rqn.png)

获取应用列表顶部的 API 密钥。所有应用程序的 API 密钥都是相同的。

获取应用密钥，它位于每个应用的右侧。您可以创建不同的 Ringcaptcha 应用程序来代表每个需要短信验证的网站。

## [](#test-ringcaptcha-app-and-api-keys)测试 Ringcaptcha 应用程序和 API 密钥
...
[![](../Images/77286dfbabc0fdf2729a090440c378ef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZB5n59dd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8h95f2y9tvv44pcrdn29.png)
