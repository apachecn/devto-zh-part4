...
> 原文:[https://dev . to/mornir/use-netlify-cloud-function-to-back-up-data-to-Google-drive-49ep](https://dev.to/mornir/use-netlify-cloud-function-to-back-up-data-to-google-drive-49ep)
...
# [](#setting-up-the-google-drive-api)设置 Google Drive API
...
# [](#uploading-data-dump-to-google-drive)上传数据转储到 Google Drive
...
# [](#netlify-handler-method)Netlify 处理程序方法
