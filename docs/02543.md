...
> 原文:[https://dev . to/sophiabrandt/how-to-build-a-markdown-preview-app-with-reagent-5d 63](https://dev.to/sophiabrandt/how-to-build-a-markdown-preview-app-with-reagent-5d63)

请注意:这是我不久前在博客上发表的旧帖子。如果你遇到任何问题，打电话给我，我会尽力解决。

***这个 app 是在我们有 React hooks 之前写的。**T3】*

## [](#why-clojurescript)为什么要 ClojureScript？
