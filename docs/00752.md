...
> 原文:[https://dev . to/bnevilleoneill/crafting-build-pipelines-with-docker-2g KC](https://dev.to/bnevilleoneill/crafting-build-pipelines-with-docker-2gkc)
...
### [](#listing-1-a-runofthemill-dockerfile-for-nodejs)清单 1:node . js 的普通 docker 文件
...
## [](#the-need-for-multiple-stages)需要多个阶段
...
## [](#crafting-a-dockerfile-with-a-multistage-build)制作多阶段构建的 Dockerfile 文件
...
### [](#listing-3-a-multistage-dockerfile-for-building-typescript-code)清单 3:用于构建类型脚本代码的多阶段 docker 文件
...
## [](#the-effect-of-the-multistage-build)多阶段构建的效果
