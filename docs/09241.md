...
> 原文:[https://dev.to/pablo/agent-based-modelling-part-1-48d6](https://dev.to/pablo/agent-based-modelling-part-1-48d6)

# [](#agentbased-modelling-an-introduction)基于智能体的建模:一个简介
...
1.  这里引用[](http://www.geog.leeds.ac.uk/courses/other/crime/abm/general-modelling/index.html)*[↩](#fnref1)*
