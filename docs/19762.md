...
> 原文:[https://dev . to/hrbrmstr/reader-challenge-have-some-fun-with-apple-s-wwdc-2019-keynote-subtitle-show-your-work-4 nkg](https://dev.to/hrbrmstr/reader-challenge-have-some-fun-with-apple-s-wwdc-2019-keynote-subtitles-show-your-work-4nkg)
...
### [](#not-so-subtle-subtitle-scraping)没那么细微的字幕刮

如果你去前面链接的 WWDC 视频网址，你会在右下角看到添加字幕轨道的控件。如果您在浏览器开发工具打开的情况下这样做，您将会看到:

[![webdevtools subtitle index screen shot](../Images/69cc203d896cf2be6f6c99c1d32eb482.png)T2】](https://i0.wp.com/rud.is/b/wp-content/uploads/2019/06/01-subtitle-index.png?ssl=1)

这些是 [WebVTT](https://www.w3.org/TR/webvtt1/) 格式的字幕，其格式/语法使其能够以正确的回放时间码显示。我们可以通过查看文件的结尾来了解它们的数量:

[![count of subtitles](../Images/000faf724d796d4a4f76e709e98712cc.png)T2】](https://i1.wp.com/rud.is/b/wp-content/uploads/2019/06/02-subtitle-count.png?ssl=1)
...
[![](../Images/fb339c14958d5b50822d88912e79c69f.png)T2】](https://i0.wp.com/rud.is/b/wp-content/uploads/2019/06/03-subtitle-curl.png?ssl=1)
...
[![](../Images/04c670607889dc94701b97552fbc9152.png)T2】](https://i1.wp.com/rud.is/b/wp-content/uploads/2019/06/04-subtitle-check.png?ssl=1)
