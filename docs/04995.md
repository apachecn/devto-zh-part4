...
> 原文:[https://dev.to/somedood/the-semantics-of-falsy-values-330f](https://dev.to/somedood/the-semantics-of-falsy-values-330f)

[![nunocpnp](../Images/bd15d559e37636c82cd9a0ee46506668.png)](/nunocpnp) [## “空”和“未定义”关键词的区别？
...
# [](#not-a-number-raw-nan-endraw-)不是数字(`NaN`)
...
# [](#empty-arrays-raw-endraw-and-empty-strings-raw-endraw-)空数组(`[]`)和空字符串(`''`)
...
# [](#empty-objects-raw-endraw-and-raw-null-endraw-)空物体(`{}`)和`null`
...
# [](#-raw-undefined-endraw-)`undefined`
