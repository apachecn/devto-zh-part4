...
> 原文:[https://dev . to/wiredviews/kentico-CMS-quick-tip-automatic-static-file-fingerprinting-30 C5](https://dev.to/wiredviews/kentico-cms-quick-tip-automatic-static-file-fingerprinting-30c5)

<figure>

[![Wooden Finger](img/05364b1aae3eb657b5964e4ea08219f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8SMl-wrF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pgh2t77bdtv1kspojewm.jpg)

<figcaption>Photo by [Charles 🇵🇭](https://unsplash.com/@charlesdeluvio) on [Unsplash](https://unsplash.com)</figcaption>

</figure>

## [](#static-content-and-urls)静态内容和网址
...
### [](#handling-clientside-caches)处理客户端缓存
...
## [](#automatic-url-versioning-fingerprinting)自动 URL 版本控制(指纹识别)
...
### [](#fingerprint-helper-method)指纹助手法
...
### [](#generating-urls-in-our-razor-views)在我们的 Razor 视图中生成 URL
...
### [](#webconfig-url-rewrite)Web.config 网址重写
