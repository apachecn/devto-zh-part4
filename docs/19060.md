...
> 原文:[https://dev . to/Christopher lai/deploying-a-phoenix-project-on-AWS-5d 4](https://dev.to/christopherlai/deploying-a-phoenix-project-on-aws-5d4)
...
## [](#github-aws-codepipeline)GitHub + AWS 代码管道
...
## [](#bonus-production-credentials)奖金:生产凭证
