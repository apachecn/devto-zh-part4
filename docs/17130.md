...
> 原文:[https://dev.to/dandyvica/using-threads-on-rust-part-1-2gld](https://dev.to/dandyvica/using-threads-on-rust-part-1-2gld)
...
## [](#simple-thread-experiment)简单的线程实验
...
## [](#version-without-any-additional-crate)版本不带任何附加板条箱
