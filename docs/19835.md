...
> 原文:[https://dev . to/fros nerd/testing-your-database-migrations-with-fly way-and-test containers-44fc](https://dev.to/frosnerd/testing-your-database-migrations-with-flyway-and-testcontainers-44fc)

# [](#why-database-migrations)为什么要进行数据库迁移？
...
# [](#testing-migrations-with-testcontainers)用 Testcontainers 测试迁移
