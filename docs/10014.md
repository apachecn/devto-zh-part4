...
> 原文:[https://dev . to/dillionmegida/URLs-and-web pack-in-react js-3 bln](https://dev.to/dillionmegida/urls-and-webpack-in-reactjs-3bln)
...
##### [](#1-change-the-location-of-the-image-folder)1。更改图像文件夹的位置

我改变了图像文件夹的位置，使它成为公共目录下的一个子目录，它像预期的那样工作。

##### [](#2-use-the-require-keyword)2。使用 require 关键字
