...
> 原文:[https://dev . to/willamoseares/destructing-JavaScript-objects-like-a-pro-17bg](https://dev.to/willamesoares/destructuring-javascript-objects-like-a-pro-17bg)
...
### [](#it-also-works-with-arrays)同样适用于数组！
...
### [](#it-also-works-in-a-function-signature)在函数签名中也有效！
...
## [](#can-i-do-destructuring-everywhere)我可以到处做析构吗？
...
[![destrucure_compatibility](../Images/5c85d0b70c31b03ce85feb18e6c26be4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2IHNajDB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/bHeYv00.png)
