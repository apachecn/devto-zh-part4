...
> 原文:[https://dev . to/nirmal _ Kumar/proposal-for-standarding-user-digital-presence-profile-using-yml-2l3h](https://dev.to/nirmal_kumar/proposal-for-standardising-user-digital-presence-profile-using-yml-2l3h)
...
### [](#how-if-everyone-has-a-common-profile-as-a-yaml-file-)如果每个人都有一个共同的配置文件作为 yaml 文件会怎样:
