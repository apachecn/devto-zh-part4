...
> 原文:[https://dev . to/leewarrickjr/bridging-the-gap-between-react-s-use state-usereducer-and-redux-3k 94](https://dev.to/leewarrickjr/bridging-the-gap-between-react-s-usestate-usereducer-and-redux-3k94)

[![Photo of a man carelessly leaping over a very deep chasm by Alex Radelich](img/b0bb22ab9e67367f3bcf0c87378d609a.png "Photo of a man carelessly leaping over a very deep chasm by Alex Radelich")T2】](https://leewarrick.com/blog/static/ba29f3c8bad89c521880863a2ddfe9a2/c35de/mindthegap.jpg)
...
[![Photo of a man stirring a campfire cooking pot by Gary Sandoz](img/ee424a58f1b3be0c800007e0012d6cf0.png "Photo of a man stirring a campfire cooking pot by Gary Sandoz")T2】](https://leewarrick.com/blog/static/1a1acb148e3f2c1505bb60e360fc0d10/c35de/cooking.jpg)
...
## [](#the-problem-with-state-in-react)对“状态”中的问题做出反应
...
### [](#handling-business-logic-using-reducers)使用归约器处理业务逻辑
...
## [](#implicit-vs-explicit-states)隐性 vs 显性状态
...
## [](#-allowed-actions-editing-and-submitting-but-submitting-does-not-trigger-errors-just-a-message)-允许的操作:编辑和提交，但提交不会触发错误，只是一条消息

**脏** -用户已开始输入信息，但尚未成功完成并提交

*   可能的转换:已完成

## [](#-allowed-actions-editing-and-submitting-but-submitting-triggers-error-messages)-允许操作:编辑和提交，但提交会触发错误信息
...
### [](#advanced-switch-statements)高级开关报表
