...
> 原文:[https://dev . to/moesif/how-to-embed-an-API-debug-dashboard-in-your-developer-portal-5223](https://dev.to/moesif/how-to-embed-an-api-debug-dashboard-in-your-developer-portal-5223)
...
## [](#what-are-moesif-workspaces)什么是 Moesif 工作区？
...
## [](#creating-a-workspace-token)创建工作区令牌
...
[![api-keys.png](img/5706825937d82a79b9dbc613b008b00d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wyUBHSdd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/%7B%7B%20%img/posts/technical/shareable-workspaces/api-keys.png%22%20%7C%20absolute_url%20%7D%7D)
...
## [](#embed-the-workspace-in-your-customer-portal)将工作区嵌入您的客户门户
