...
> 原文:[https://dev . to/macsikora/data-mutation-in-functional-JavaScript-1h 97](https://dev.to/macsikora/data-mutation-in-functional-javascript-1h97)
...
## [](#data-normalization-as-an-example)以数据归一化为例
...
[![Big O notation](../Images/9752ef0204940c37446afc43fe0b7681.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VwYYAwqj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2rons000ia78kjpkdksu.png)

显然，传递给`reduce`的匿名函数不是一个纯粹的函数，它改变了赋予它的状态。所以它打破了不变性规则，但是它有缺陷吗？

## [](#pure-outside-impure-inside)外纯内不纯

我们从外部看一下这两个函数，传递什么，返回什么。

[![Input - Output of functions](../Images/9593c519ba762a7041826cd497c9aa3b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wPTbM39v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/43dhyv34rsswtfwjldnq.png)
...
[![Implementation detail](../Images/56e5e643d34109e30f4a59fdb2fac4fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dTZgVQnT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/44skf5nfm17if3rag0zw.png)

## [](#performance-does-matter)业绩确实重要
...
[![Immutable car](../Images/64244d6ca72a39d1adc835d56b34cf52.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Og9fbdxk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dn6h69yatmap2r3tcqgw.png)

## [](#where-the-immutable-version-fits-better)不可变版本更适合的地方。
...
[![Crying Js dev](../Images/e39227222588ff9878b44372483b0b53.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mN_8j52u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nbvesoc6vioffwgf3ikl.png)

假如，我可以说，一切基于复制的东西都是不够的，这是多么大的发现啊😂，适用于高性能最重要的地方(所有地方😝).不要哭函数式程序员，因为总是有一个权衡，对于大多数前端操作，纯函数的全函数组合可能会工作得很好，但正如已经说过的，我们应该知道它的缺陷。

## [](#be-functional-and-know-when-mutation-is-allowed)有功能，知道什么时候允许突变
