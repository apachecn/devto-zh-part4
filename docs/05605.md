...
> 原文:[https://dev . to/_ static void/node-js-under-the-hood-1-get-to-know-our-tools-1465](https://dev.to/_staticvoid/node-js-under-the-hood-1-getting-to-know-our-tools-1465)
...
### [](#elements-that-compose-nodejs)组成 Node.js 的元素
...
[![Take from Samer Buna's Pluralsight course: Advanced Node.js](../Images/01393e70481e68638f47d7fc19f20fea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B4RyMPrD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/khaosdoctor/my-notes/raw/master/node/assets/nodejs-components.png)

也就是说，我们可以把 Node.js 分成两部分:V8 和 Libuv。V8 大约 70% C++和 30% JavaScript，而 Libuv 几乎完全是用 C 写的。

## [](#our-example-io-function-call)我们的例子- I/O 函数调用
