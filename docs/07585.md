...
> 原文:[https://dev . to/Lawrence Johnson/improving-form-and-Ajax-security-4g 29](https://dev.to/lawrencejohnson/improving-form-and-ajax-security-4g29)
...
# [](#principals-of-form-security)表单安全的原则
...
## [](#efficacy-of-clientside-validation)客户端验证功效
...
## [](#serverside-processing-of-usergenerated-content)服务器端处理用户生成的内容
...
## [](#a-note-about-web-application-firewalls-waf)关于 Web 应用防火墙(WAF)的说明
...
# [](#filtering-input-in-php)过滤 PHP 中的输入
...
## [](#retrievingcapturing-form-data-traditional)检索/捕获表单数据(繁体)
...
## [](#enter-raw-filterinput-endraw-)输入`filter_input`
...
## [](#how-malicious-data-is-handled)如何处理恶意数据
...
## [](#handling-filtered-results-and-further-processing)处理过滤后的结果并进一步处理
...
## [](#some-final-notes-on-raw-filterinput-endraw-)关于`filter_input`的一些期末笔记
...
# [](#quick-summary-tldr)快速汇总/TL；博士；医生
