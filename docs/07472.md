...
> 原文:[https://dev . to/spu kas/3-reasons-to-usereducer-over-use state-43ad](https://dev.to/spukas/3-reasons-to-usereducer-over-usestate-43ad)
...
## [](#3-reasons-to-use-it)使用它的 3 个理由

大多数时候，你只需要使用建立在`useReducer()`之上的`useState()`方法就可以了。但是有些情况下`useReducer()`更好。

### [](#next-state-depends-on-the-previous)下一个状态取决于上一个
