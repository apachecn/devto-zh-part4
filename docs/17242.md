...
> 原文:[https://dev . to/juliang/configuring-beauty-and-typescript-compiler-as-a-pre-commit-hook-44jh](https://dev.to/juliang/configuring-prettier-and-typescript-compiler-as-a-pre-commit-hook-44jh)
...
## [](#1-install-prettier-husky-and-lintstaged)1。安装[漂亮器](https://www.npmjs.com/package/prettier)、[哈士奇](https://www.npmjs.com/package/husky)和[皮棉器](https://www.npmjs.com/package/lint-staged)
...
## [](#3-create-a-lintstaged-config-file-lintstagedrc)3。创建 lint 暂存的配置文件:。lintstagedrc:
...
## [](#4-create-a-husky-config-file-huskyrc)4。创建一个 husky 配置文件:。huskyrc:
