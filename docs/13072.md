...
> 原文:[https://dev . to/gypsydave 5/TDD-an-analog-clock face-in-go-4 Ono](https://dev.to/gypsydave5/tdd-an-analogue-clockface-in-go-4ono)
...
[![an svg of a clock](../Images/8b8de1fc8944408a2611f0cd78670b90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3jxWzBBA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/example_clock.svg)
...
### [](#repeat-for-new-requirements)重复进行新的要求
...
[![picture of the unit circle](../Images/e8301b26786be2a5f416b872eb9c6463.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JTszuvFz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/images/unit_circle.png)

这被称为“单位圆”,因为...嗯，半径是 1 个单位！

圆的圆周是由网格上的点组成的——更多的坐标。每个坐标的 x 和 y 分量形成一个三角形，其斜边总是 1 -圆的半径

[![picture of the unit circle with a point defined on the circumference](../Images/bce7394852c3d5d5aae64d533b61adfe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jLZaomR_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/images/unit_circle_coords.png)

现在，三角学将让我们计算出每个三角形的 X 和 Y 的长度，如果我们知道它们与原点所成的角度。X 坐标将是 cos(a)，Y 坐标将是 sin(a)，其中 a 是直线和(正)X 轴之间的角度。

[![picture of the unit circle with the x and y elements of a ray defined as cos(a) and sin(a) respectively, where a is the angle made by the ray with the x axis](../Images/ab684ed95e5f5aff8c9ebcddc2f469e6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lhigcsGr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/images/unit_circle_params.png)

(如果你不相信这个，去看看维基百科...)

最后一个扭曲——因为我们想从 12 点钟位置测量角度，而不是从 X 轴(3 点钟位置)测量，所以我们需要交换轴；现在 x = sin(a)，y = cos(a)。

[![unit circle ray defined from by angle from y axis](../Images/b19662f75e3d308faca0d85861be75d5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZRcfQDD4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/images/unit_circle_12_oclock.png)
...
[![a clock with only a second hand](../Images/933b84e59e56c08d1b2d424b3f51ce9a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TxC3yHu6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/v6/clockface/clockface/clock.svgg)
...
[![a clock with only a second hand](../Images/e221c54ef0d8f98ebd62d5a8625dd2cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lFA-oEYW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/v9/clockface/clockface/clock.svg)
...
[![a clock](../Images/a9eca36daaab1abde6b4c92ccde52982.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TPbFHlHI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/quii/learn-go-with-tests/master/math/v12/clockface/clockface/clock.svg)
...
### [](#a-program-and-a-library)一个程序...和一个图书馆
...
### [](#the-most-valuable-test)最有价值的测试
