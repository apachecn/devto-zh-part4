...
> 原文:[https://dev . to/hasurahq/using-graph QL-to-join-data-cross-Google-places-API-and-postgres-to-build-location-based-apps-4knl](https://dev.to/hasurahq/using-graphql-to-join-data-across-google-places-api-and-postgres-to-build-location-based-apps-4knl)
...
<figure>[![](../Images/1c2ae120e516a3c9a1e823e7ce7496ac.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vF9XbU_O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.hasura.io/content/images/2019/07/google-places-remote-schema-banner.png) 
