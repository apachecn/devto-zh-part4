...
> 原文:[https://dev . to/claudiodavi/reducing-vs code-memory-consumption-527k](https://dev.to/claudiodavi/reducing-vscode-memory-consumption-527k)

# [](#how-to-reduce-vscode-memory-usage)如何减少 VSCode 的内存使用
...
### [](#organizing-your-explorer)组织你的资源管理器
