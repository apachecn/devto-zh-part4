...
> 原文:[https://dev . to/hackersandslackers/using-Amazon-redshift-as-your-data-warehouse-3 LDM](https://dev.to/hackersandslackers/using-amazon-redshift-as-your-data-warehouse-3ldm)

[![Using Amazon Redshift as your Data Warehouse](../Images/a2073fc454852867b1555e4af2417ad3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pL26e7TO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackersandslackers.com/content/images/2019/07/redshift.jpg)
...
### [](#columnoriented-database-management-systems)面向列的数据库管理系统
...
### [](#a-note-about-redshift-spectrum)关于红移光谱的一个注记
...
## [](#getting-started-with-redshift)红移入门
...
[![Using Amazon Redshift as your Data Warehouse](../Images/bd4aaf719af9797dcc370f36d3966d87.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---A5SxV0z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.googleapis.com/hackersandslackers-cdn/2019/07/Screen-Shot-2019-06-08-at-9.13.58-PM.png) 

<figcaption>创造一个新的红移星团。</figcaption>

默认设置使创建红移星团变得容易。除了命名约定和与用户相关的选项，我们需要做的就是选择我们想要的节点类型和节点总数。

## [](#loading-data-into-redshift)加载数据成红移
...
### [](#vacuum-and-analyze-after-adding-data)添加数据后真空分析
...
## [](#table-distribution-styles)表格分布样式
...
[![Using Amazon Redshift as your Data Warehouse](../Images/dcb2af2e001682f698dd04012312c5f1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vtMJp8mf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackersandslackers.com/content/images/2019/07/skew.png) 
...
## [](#further-optimizing-redshift)进一步优化红移
