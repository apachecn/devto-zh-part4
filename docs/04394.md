...
> 原文:[https://dev.to/greymd/eq-can-be-critically-vulnerable-338m](https://dev.to/greymd/eq-can-be-critically-vulnerable-338m)

# [](#is-it-vulnerable)是否不堪一击？
...
## [](#other-affected-expressions)其他受影响的表情
...
### [](#check-input-as-string)检查输入为字符串
...
### [](#use-external-command-as-much-as-possible)尽可能使用外部命令
...
# [](#again-is-it-vulnerability-)再问:是漏洞吗？
