...
> 原文:[https://dev.to/lewish/typed-css-modules-with-bazel-3133](https://dev.to/lewish/typed-css-modules-with-bazel-3133)
...
## [](#using-raw-typedcssmodules-endraw-)使用`typed-css-modules`
...
## [](#writing-the-bazel-rule)书写巴泽尔法则
