...
> 原文:[https://dev . to/rygelxvi/reverse-an-integer-code-challenge-5g 66](https://dev.to/rygelxvi/reverse-an-integer-code-challenge-5g66)

密码问题 7

### [](#given-a-32bit-signed-integer-reverse-digits-of-an-integer)给定一个 32 位有符号整数，取整数的反数位。
