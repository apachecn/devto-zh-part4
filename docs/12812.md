...
> 原文:[https://dev . to/Sara fian/improved-soap-proxy-management-in-powershell-6hf](https://dev.to/sarafian/improved-soap-proxies-management-in-powershell-6hf)
...
# [](#under-the-hood-of-newwebserviceproxy)在 New-WebServiceProxy 的引擎盖下
...
# [](#powershell-core-not-supported)不支持 PowerShell 核心
...
# [](#working-with-the-soap-proxy)使用 soap 代理
...
# [](#debugging-and-tracing-the-proxies)调试和跟踪代理
