...
> 原文:[https://dev . to/aziziyazit/performance-optimizations-in-react-1 aph](https://dev.to/aziziyazit/performance-optimizations-in-react-1aph)
...
[![](../Images/af885770e45b8953e57537e495dcfe56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3JUXuXkQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vxk5thoeqns4zvycucol.png)
...
### [](#parentchild-component)父子组件

当我们识别出一个很有可能重新渲染一个批次的父组件时，我们可以使用 useCallback 来防止子组件不必要的重新渲染。

考虑下面的代码示例(我从 Kent C Dodds 的文章中选取了这个示例，对我来说它是最清楚的示例)

[![](../Images/38d157cb6beffaed4651d95db1ffe041.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CZ8aSd7F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7fnaiito8po13ri7urh8.png)
...
[![](../Images/29a0a048e56f7a1dc5164ad0ecedc2a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k8oCjSC---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mp05orc23dkliy5ys821.png)
