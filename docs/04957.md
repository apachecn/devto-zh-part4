...
> 原文:[https://dev.to/techelevator/refactoring-c-unit-tests-5bh6](https://dev.to/techelevator/refactoring-c-unit-tests-5bh6)
...
## [](#using-shouldly-for-assertions)用 Shouldly 作断言
...
## [](#using-bogus-to-hide-meaningless-values)用伪造品隐藏无意义的数值
...
## [](#extracting-methods-to-hide-setup-details)提取方法隐藏设置细节
...
## [](#extracting-abstract-classes-to-improve-tests)提取抽象类以改进测试
