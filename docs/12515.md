...
> 原文:[https://dev . to/this dot media/angular-and-the-rest-authentic ation-with-jwt-5em 0](https://dev.to/thisdotmedia/angular-and-the-rest-authentication-with-jwt-5em0)
...
## [](#adding-jwt-authentication-to-aspnet-core-web-api)向 ASP.NET 核心 Web API 添加 JWT 认证
