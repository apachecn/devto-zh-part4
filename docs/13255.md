...
> 原文:[https://dev . to/the fern/other-package-with-cookiecutter-578d](https://dev.to/thefern/another-package-with-cookiecutter-578d)
...
[![prompts](../Images/13d73b09f4e789b36a6e257b63b4e717.png)T4】](https://res.cloudinary.com/practicaldev/image/fetch/s--_N-Lmnb8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kodaman2.github.io/blog/images/python-package-series/cookiecutter-prompts.png)

一切就绪:

[![contents](../Images/32cdd78c7e32cc6f3749698895aeecf8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0ORcETND--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kodaman2.github.io/blog/images/python-package-series/package-contents.png)

不到一分钟，一个完整的项目就创建好了，包含了 python 包的所有必要文件。

## [](#adding-a-function-to-test-the-package)添加功能测试包
...
## [](#testing-sayhello-function)测试 say_hello 功能
...
## [](#adding-a-py-module-to-init)向 init 添加 py 模块
...
## [](#a-word-on-cookiecutter)关于库克的一句话
