...
> 原文:[https://dev.to/jacobmgevans/anagram-generator-5ej9](https://dev.to/jacobmgevans/anagram-generator-5ej9)
...
## [](#changing-the-approach-there-are-usually-many-different-ways-to-do-something)改变方法，做一件事通常有许多不同的方法。

*   对我来说，第一步仍然是创建一个伪随机数，以便以后使用。我有一个想法，它将采取一些不同的输入，以增加随机性。我考虑过添加 Date.now()这个函数，但是对于这个目的来说，这似乎有点过了。![randomIntGenerator](../Images/ec78c0305a97661f4ecb4a8134dc6e13.png)
...
*   现在如果你想，“等等，循环在哪里...?"干得好。最后一个方法是我从[![kyleshevlin image](../Images/0c6448d7312651e031738752119ab6da.png)](/kyleshevlin)
...
export { convertAnagram };](../Images/6f53a586dea3872fe756d8051d60b158.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AueEFOr1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wjw9o8h4asx9nvqgy1ne.png)
...
});](../Images/cd614d0d89d162062165dfa5f6b1bf32.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--e9ky6NiI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/83tppdhmeo9l7ii4b9fv.png)