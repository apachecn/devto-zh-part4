...
> 原文:[https://dev . to/Stephen Weiss/using-coalesce-and-dynamic-updates-to-multi-records-in-postgres-50jd](https://dev.to/stephencweiss/using-coalesce-and-dynamic-updates-to-multiple-records-in-postgres-50jd)
...
# [](#handling-multiple-records-with-ambiguity)处理多条歧义记录
