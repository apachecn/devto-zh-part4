...
> 原文:[https://dev . to/azure/build-a-we b-VR-game-with-JavaScript-using-the-babylonjs-framework-aek](https://dev.to/azure/build-a-web-vr-game-with-javascript-using-the-babylonjs-framework-aek)

## 在本教程中，我将一步一步地向你展示如何用 BabylonJS 构建一个网络虚拟现实游戏

[![game img](../Images/33feb911db517440b05ad2178d8fb5a3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Id3h1vyj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/bvJslJf.jpg)
...
## [](#what-is-babylonjs-and-cannonjs)什么是 BabylonJS 和 CannonJS
...
### [](#steps-to-run-starter-project-and-git-repo-link)运行 Starter 项目的步骤和 [Git 回购链接](https://github.com/cassieview/babylonjs-webpack-typescript-starter-project)
...
## [](#lets-talk-about-the-starter-project)让我们来谈谈启动项目

### [](#simple-indexhtml-template)简单的 index.html 模板。
...
## [](#start-building-the-game)开始构建游戏
...
## [](#make-sphere-disappear-on-click)点击使球体消失
...
## [](#add-loop-to-add-multiple-spheres-when-you-click-start)添加循环点击开始时添加多个球体
...
## [](#add-particle-animation-to-sphere-to-mimic-an-explosion)给球体添加粒子动画来模拟爆炸
...
## [](#add-scorets-because-every-game-needs-a-way-to-keep-score)添加 score.ts 因为每个游戏都需要一种方式来保持分数
...
## [](#remove-raw-physicsimpostor-endraw-from-ground-mesh-so-balls-fall-through-the-ground-instead-of-sitting-on-top)将`PhysicsImpostor`从地面网格中移除，这样球会从地面落下，而不是落在地面上。
...
## [](#deploy-site-to-azure-storage-as-a-static-site-so-all-your-friends-can-play-too)将站点部署到 azure 存储作为静态站点，这样您的所有朋友也可以玩了
