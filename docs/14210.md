...
> 原文:[https://dev . to/bpetetot/themify-your-app-with-custom-properties-2k ke](https://dev.to/bpetetot/themify-your-app-with-custom-properties-2kke)
...
### [](#themify-with-custom-properties)用自定义属性进行主题化
...
### [](#apply-theme-to-subcomponents)将主题应用到子组件
