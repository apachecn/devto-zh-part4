...
#### [](#-raw-datacourse-endraw-)`data.course || {}`
...
#### [](#-raw-datacourse-enrolments-endraw-)`(data.course || {}).enrolments || [])`
...
#### [](#-raw-enrolmentconfirm-ampamp-enrolmentconfirm-endraw-)`enrolment.confirm && enrolment.confirm()`
