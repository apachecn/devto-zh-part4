...
> 原文:[https://dev.to/keevcodes/pure-functions-in-react-2o7n](https://dev.to/keevcodes/pure-functions-in-react-2o7n)
...
# [](#what-are-pure-functions)什么是纯函数？
...
# [](#side-effects-impure-pure)副作用？不纯:纯
...
# [](#return-the-same-value-when-given-the-same-input-value)给定相同的输入值时返回相同的值。
