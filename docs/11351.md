...
> 原文:[https://dev . to/akhilaariyachandra/understanding-this-in-react-b57](https://dev.to/akhilaariyachandra/understanding-this-in-react-b57)
...
### [](#this-in-an-inner-function)“此”在一个内在函数中
...
### [](#so-how-do-we-get-the-proper-this-into-the-inner-function)那么我们如何把适当的“这个”带入内在函数呢？
...
## [](#so-what-about-react)那么 React 呢？
