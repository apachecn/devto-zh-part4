...
> 原文:[https://dev . to/bug magnet/extending-the-array-class-to-calculate-Fibonacci-sequences-50a 0](https://dev.to/bugmagnet/extending-the-array-class-to-calculate-fibonacci-sequences-50a0)
