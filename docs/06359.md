...
> 原文:[https://dev . to/MII izen/compiler-series-part-5-lexical-analysis-3kf 7](https://dev.to/miiizen/compiler-series-part-5-lexical-analysis-3kf7)

从这篇文章开始，我将解释我的编译器的各个部分以及设计它们的思路。我将链接到我的编译器储存库中的相关文件，这里是。

## [](#defining-basic-tokens)定义基本令牌
...
## [](#some-language-theory1)有些语言理论 <sup id="fnref1">[1](#fn1)</sup>
...
[![The Chomsky Hierarchy](../Images/d00caab2e8e38f1a6cd6a08676165146.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VDM8nhHk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e5v1ojd7td4t5w27ny9w.png) 
...
2.  [计算理论——乔姆斯基等级体系](https://www.geeksforgeeks.org/toc-chomsky-hierarchy/)T2】↩
