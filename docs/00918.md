...
> 原文:[https://dev . to/margaretkrutikova/reason-react-context-explained-in-action-5eki](https://dev.to/margaretkrutikova/reason-react-context-explained-in-action-5eki)
...
## [](#create-provider-and-context)创建提供者和上下文
...
## [](#update-value-in-context)更新上下文中的值
...
## [](#pass-dispatch-in-context)在上下文中传递分派
...
## [](#use-context-value-via-hook)通过钩子使用上下文值
...
## [](#bonus-optimization-techniques)加成:优化技术
