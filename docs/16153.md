...
> 原文:[https://dev . to/jwoertink/deploying-lucky-apps-to-elastic-beanstalk-2p0d](https://dev.to/jwoertink/deploying-lucky-apps-to-elastic-beanstalk-2p0d)
...
### [](#dockerrunbuild)docker_run_build
