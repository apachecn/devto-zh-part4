...
> 原文:[https://dev . to/sureshmurali 29/eye p-dev-coolest-way-to-get-your-IP-address-53d 8](https://dev.to/sureshmurali29/eyep-dev-coolest-way-to-get-your-ip-address-53d8)
...
#### [](#eyepdev-in-action)运行中的 eyep.dev

[![eyep.dev](../Images/c0e589e405c9bdf9bee46b4eace96fae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_VmrVyuv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lal5sj8hv3z9irrzehb6.gif)

### [](#tech-stack)技术堆栈👩‍💻

🌐 **IP** 及其位置由[IP stack](https://ipstack.com/)T4】🗺️ **地图**由谷歌地图&设计由[snazzymaps](https://snazzymaps.com/)T9】💻**前端** -香草 JS &后端- AWS Lambda

## [](#producthunt-launch)产品搜索启动🔥
...
已经更新了`<Title>`和`<meta>`标签，也配置了**搜索控制台**，让我们看看✌️进展如何