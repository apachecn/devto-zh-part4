...
> 原文:[https://dev.to/giteden/the-state-of-angular-in-2019-ein](https://dev.to/giteden/the-state-of-angular-in-2019-ein)
...
## [](#angulars-adoption-is-growing)棱角分明的采用率正在增长
...
## [](#the-angulars-ecosystem-is-large-and-thriving)棱角分明的生态系统庞大而欣欣向荣
...
> 
> # [](#the-deep-integration-with-tools-such-as-typescript-and-rxjs-make-angular-benefit-indirectly-as-these-tools-make-more-and-more-progress)and *TypeScript* and *RxJS ** *indirectly brings benefits from the angle*
> 
> as these tools progress more and more.

## [](#angular-cli)角度 CLI

### [](#updating-is-easier-than-ever)更新比以往更容易
...
## [](#new-and-exciting-features)令人兴奋的新功能
...
[![](img/55d672984040206899c942c6735d78de.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0CL6RiEX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/4642/1%2Aify8X8H_P6wnZjTIMNE1ng.png)

正如您所看到的，ngForOf 指令为我们提供了关于什么被作为值传递的信息。

## [](#angular-on-mobile)棱角分明地在移动
