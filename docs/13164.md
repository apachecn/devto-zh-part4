...
> 原文:[https://dev . to/cmelgarejo/creating-an-opinious-graph QL-server-with-go-part-1-3g3l](https://dev.to/cmelgarejo/creating-an-opinionated-graphql-server-with-go-part-1-3g3l)
...
## [](#coding-our-web-server)编码我们的 web 服务器

### [](#1-web-framework-gin)1。Web 框架:Gin
...
### [](#2-code-the-web-server)2。编写 web 服务器代码
