...
## [](#do-not-start-writing-code-before-you-know-what-the-code-needs-to-accomplish)Do not start writing code before you know what the code needs to accomplish

Breaking down this directive in reverse order:

### [](#functional-requirements-what-the-code-needs-to-accomplish)Functional Requirements: What the Code needs to Accomplish
...
## [](#i-need-to-write-something-other-than-code)I need to write something other than Code?
...
## [](#what-if-its-impossible-to-fully-define-all-functional-requirements-before-starting)What if it’s Impossible to Fully Define ALL Functional Requirements Before Starting?
...
## [](#but-what-about-my-waterfall)But What About my Waterfall?
