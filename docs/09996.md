...
> 原文:[https://dev . to/k _ penguin _ sato/my-journey-of-go-pointers-structures-52jb](https://dev.to/k_penguin_sato/my-journey-of-go-pointers-structures-52jb)

# [](#pointers)指针

### [](#how-to-declare-a-pointer)如何声明一个指针
...
### [](#how-to-retrieve-the-memory-address-of-a-variable)如何检索变量的内存地址
...
### [](#accessing-the-value-of-a-variable-through-its-pointer)通过指针访问变量的值
...
### [](#how-to-declare-a-struct)如何声明一个结构体
...
### [](#different-ways-of-struct-instantiation)结构实例化的不同方式
...
#### [](#using-the-raw-new-endraw-keyword)使用`new`关键字
...
### [](#how-to-define-a-method)如何定义一个方法
