...
> 原文:[https://dev . to/segun _ codes/anonymous-auth-with-firebase-on-Android-2obk](https://dev.to/segun_codes/anonymous-auth-with-firebase-on-android-2obk)
...
## [](#migrate-an-anonymous-account-to-a-permanent-account)将匿名账户迁移为永久账户
