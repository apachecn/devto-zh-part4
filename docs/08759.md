...
> 原文:[https://dev . to/keplersj/simplizing-Gatsby-unit-testing-using-a-jest-preset-5g3c](https://dev.to/keplersj/simplifying-gatsby-unit-testing-using-a-jest-preset-5g3c)
...
# [](#using-jests-preset-functionality-to-reduce-configuration-boilerplate)利用 Jest 的预置功能减少配置样板文件
...
# [](#installation-from-scratch)从头安装

有兴趣测试您的 Gatsby 项目，还没有配置它？现在是开始的好时机！

## [](#javascript-projects)JavaScript 项目
