...
> 原文:[https://dev . to/iam _ Tim Smith/take-snapshot s-of-your-project with-git-1439](https://dev.to/iam_timsmith/take-snapshots-of-your-project-with-git-1439)
...
[![I'm using git, so you could say it's getting pretty serious](../Images/da92befb204308f2ac25218be26290b5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GQrng_jV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.iamtimsmith.com/static/526f2d86ad144dc3266fafde485aae9b/82472/napoleon-meme.jpg)
...
### [](#macos-with-homebrew)带有自制软件的 MacOS
...
### [](#making-sure-git-is-installed)确保安装了 git
...
## [](#creating-different-versions)创建不同的版本

### [](#see-all-of-your-versions)查看您的所有版本
...
### [](#change-to-a-different-branch)换到不同的分支
...
## [](#working-with-remote-repositories)使用远程存储库
...
### [](#adding-a-remote-location)添加远程位置
...
### [](#send-your-repo-to-the-remote-location)将您的回购发送到远程位置
...
### [](#getting-changes-from-the-remote-location)从远程位置获取更改
...
### [](#getting-a-local-copy-of-a-repo)获取回购的本地副本
