...
> 原文:[https://dev . to/sema text/spa-tracking-monitoring-how-to-build-better-single-page-applications-through-rum-real-user-monitoring-na0](https://dev.to/sematext/spa-tracking-monitoring-how-to-build-better-single-page-applications-through-rum-real-user-monitoring-na0)
...
## [](#what-is-real-user-monitoring)什么是真实用户监控？
...
## [](#how-to-monitor-singlepage-applications)如何监控单页应用
...
### [](#why-monitor-singlepage-applications)为什么要监控单页应用？
...
#### [](#5-error-and-crash-reporting)5。错误和崩溃报告

错误时有发生，你的单页应用程序可能会崩溃，这都是生活的一部分。但是，**你**需要知道这个！不要依赖你的用户告诉你。他们宁愿停止使用你的产品也不会告诉你。当 JavaScript 让你失望时，真正的用户监控会在你背后看着你。

### [](#how-is-singlepage-application-monitoring-different-from-static-website-monitoring)单页面应用监控与静态网站监控有何不同？
...
[![RUM supported libraries](img/29f4680259dd7898b4e9dabf798c96e3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vmG41DC8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/09/RUM-supported-libraries.png)

将真实用户监控添加到 webapp 的方式非常简单。

### [](#adding-real-user-monitoring-to-a-singlepage-application)为单页应用程序添加真实用户监控

以下是将真实用户监控添加到单页应用程序的步骤列表:

**1。**首先， **[在 Sematext](https://sematext.com/docs/experience/getting-started/)** 中创建体验 App **。不要忘记启用*网站使用单页面架构*切换。**

[![create RUM app](img/e2c5dae74c8182aabe14164b0fecc9e5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--O1tuLJXb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/09/create-RUM-app.png)
...
### [](#using-onpage-transactions-to-track-user-experience)使用页面上的事务来跟踪用户体验
...
### [](#visualizing-user-experience)可视化用户体验

完成配置并有数据流入后，您可以可视化指标并开始制定业务决策，以改善用户体验，从而提高客户的满意度。

[![RUM dashboard](img/7fafc821a0332e73988d97a80a4f3f6b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--huGQefae--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/09/RUM-dashboard.png)

除了显而易见的，你还可以根据用户生活在世界的哪个部分来可视化用户满意度。地理数据对于了解和优化您希望进入的市场至关重要。

[![RUM geographic dashboard](img/55d8bdbb6e0a44d2fe15e7fdc8957984.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kKD01lM0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/09/RUM-geographic-dashboard.png)

## [](#wrapping-up-monitoring-singlepage-applications)包装监控单页应用
