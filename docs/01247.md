...
> 原文:[https://dev . to/twaintaylor/10-things-to-keep-in-mind-when-performing-a-windows-server-backup-2pd](https://dev.to/twaintaylor/10-things-to-keep-in-mind-when-performing-a-windows-server-backup-2pd)
...
## [](#2-limited-backup-copies)2)有限的备份副本
...
## [](#7-backup-sizereduction)7)备份大小缩减
