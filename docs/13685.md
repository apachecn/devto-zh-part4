...
> 原文:[https://dev . to/the groo/spring-Kafka-生产者和消费者-41oc](https://dev.to/thegroo/spring-kafka-producer-and-consumer-41oc)
...
### [](#create-a-spring-kafka-consumer)创造春天的卡夫卡消费
...
### [](#start-kafka-and-zookeeper)启动卡夫卡和动物园管理员
...
[![console-kafka-zookeeper-running-docker](../Images/4b6010d2be3886ffb62ce358a6a77496.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5cxfidl---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n4imhs85mag9fwmc7ieg.png)
...
[![app-started](../Images/a9883da892cbd246c8b0e4ed1a3865c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EMfsAVgu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/befpvuucezpd6la8hlvd.png)

确保应用程序保持运行，不要关闭它正在运行的终端窗口。现在让我们用 Kafka 控制台生成器生成几条消息，并查看我们的消费者处理消息并注销它们。

### [](#produce-message-using-the-kafka-console-producer)使用 Kafka 控制台生成器生成消息
...
[![kafka-console-producer](../Images/4ca57339e409e5e4e338f785fc391590.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d9qxjKsx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qeg8lzfxbdg65e4r3dg3.png)
...
[![console-producer-spring-kafka-consumer](../Images/a3aa1f8af005d768b10ea571f95ea6dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6eRbT4YU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4na7ngkvae1m3nwr4lgg.png)

### [](#write-a-simple-producer)写一个简单的生产者
...
## [](#send-some-messages-with-curl)用 curl 发送一些消息
...
[![spring-kafka-curl](../Images/a016c9d27943664df7e409f44f070cd7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pDZKQdLb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6g06gzs7x0ynapj35vki.png)
