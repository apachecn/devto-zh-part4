...
> 原文:[https://dev . to/jchiatt/let-s-re-implement-JavaScript-s-array-map-method-2 CND](https://dev.to/jchiatt/let-s-re-implement-javascript-s-array-map-method-2cnd)
...
## [](#reimplementing-the-method)重新实施方法

### [](#1-set-up-our-function-with-the-arguments-we-know-it-will-take)1。用我们知道会用到的参数来设置我们的函数。
...
### [](#2-exit-early-if-theres-a-problem-and-give-error-messages)2。如果有问题，尽早退出并给出错误信息。
...
### [](#3-execute-the-callback-for-each-item-in-the-array)3。对数组中的每一项执行回调。
...
## [](#testing-our-new-method)测试我们的新方法。
