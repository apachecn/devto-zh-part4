...
> 原文:[https://dev . to/mandrew cito/signalr-core-python-client-v-re connecting-client-4a de](https://dev.to/mandrewcito/signalr-core-python-client-v-reconnecting-client-4ade)
...
## [](#last-message-in-socket)套接字中的最后一条消息
