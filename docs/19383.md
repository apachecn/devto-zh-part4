...
> 原文:[https://dev.to/lkopacz/an-introduction-to-aria-states-30nm](https://dev.to/lkopacz/an-introduction-to-aria-states-30nm)
...
### [](#when-to-use-raw-ariahidden-endraw-)什么时候用`aria-hidden`
...
> ![unknown tweet media content](../Images/a397bf115e197a3dd73f7c4579a12252.png)![Eric Bailey profile image](../Images/f9d62eadff39f10dfe000b8370acb096.png)埃里克·贝利[@埃里克·贝利](https://dev.to/ericwbailey)![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)我为即将到来的 [@A11YProject](https://twitter.com/A11YProject) 重新设计感到自豪的一个小细节是使用`[aria-current]'作为我们目录组件的样式挂钩。而不是用一个”。is-current”类或类似的类，我们为您在页面上的位置键入视觉外观到语义状态。2019 年 06 月 01 日下午 16:44[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1134863254310797312)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1134863254310797312)13[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1134863254310797312)96
