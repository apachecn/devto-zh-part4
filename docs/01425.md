...
> 原文:[https://dev . to/bnevilleoneill/10-errors-react-developers-make-2 mje](https://dev.to/bnevilleoneill/10-mistakes-react-developers-make-2mje)
...
### [](#1-not-creating-enough-components)1。没有创建足够的组件
...
[![An example of a React dashboard.](img/b77e3102961249c31ea2c7e4fb17c119.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LjqfdgtA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.logrocket.com/wp-content/uploads/2019/09/React-dashboard-nocdn.png)
...
### [](#2-writing-logic-in-components)2。在组件中编写逻辑
...
### [](#3-mutating-state-variables)3。突变状态变量
...
### [](#4-not-using-absolute-paths)4。不使用绝对路径
...
### [](#5-not-using-raw-key-endraw-on-a-listing-component)5。没有在列表组件上使用`key`
...
### [](#6-not-writing-unit-tests)6。不编写单元测试
...
### [](#7-not-using-proptypes)7。不使用道具类型
...
### [](#8-not-using-helper-classes-or-functions)8。不使用助手类或函数
...
### [](#9-using-redux-or-flux-to-manage-all-your-application-states)9。使用 Redux 或 Flux 管理所有应用程序状态
...
### [](#10-not-using-react-and-redux-dev-tools)10。不使用 React 和 Redux 开发工具
