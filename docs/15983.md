...
> 原文:[https://dev.to/0xkoji/learning-docker-002-images-5deb](https://dev.to/0xkoji/learning-docker-002-images-5deb)

### [](#super-simple-dockerfile)超级简单的 Dockerfile
...
### [](#simple-ubuntu-image)简单的 Ubuntu 图片
...
# [](#way-to-create-a-good-dockerfile-for-beginner)创建好 Dockerfile 的方法(针对初学者)
...
打开 localhost:8888
[![jupyter](../Images/0f869bd66a3c5f6e606d1ec9f57a5715.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Fjk0sMmn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dtb4y28c4fji7zcecmr5.png)
