...
> 原文:[https://dev . to/tan hau/creating-custom-JavaScript-syntax-with-babel-3n CJ](https://dev.to/tanhauhau/creating-custom-javascript-syntax-with-babel-3ncj)
...
## [](#fork-the-babel)分叉通天塔

前往 [babel 的 Github repo](https://github.com/babel/babel) ，点击页面左上角的“Fork”按钮。

[![Forking babel](img/beed1c21eaf5c520e4d9a6c959c11015.png "Forking babel")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lGY5NJeK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lihautan.com/static/cd47851ef23ac57b691450409164108b/7a439/forking.png)
...
## [](#our-custom-babel-parser)我们定制的巴别塔解析器
...
[![AST for generator function](img/0b98b68f6d73eab241b8a0dcbd972ed6.png "AST for generator function")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--19H-Gd64--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lihautan.com/static/e9bdfdb9e282f45dd98dc10595532005/7a439/generator-function.png)

如您所见，生成器函数由一个`FunctionDeclaration`的`generator: true`属性表示。

类似地，如果它是一个 curry 函数，我们也可以添加一个`FunctionDeclaration`的`curry: true`属性:

[![AST for curry function](img/257fdd4eb4da032824464c6864fb68ac.png "AST for curry function")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mcvoEBO7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lihautan.com/static/36268014310215f5bf3a152a93983052/bb144/curry-function.png)
...
#### [](#thiseat-thismatch-thisnext)这.吃，这.配，这.下
...
[![Uploading custom parser](img/c2cc5f3a63e54672a93c3d05f5cea48e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VrJG0R-H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://lihautan.com/custom-parser-9655bf2b7ba72e0c61e31a63a29e3f22.gif)

* * *

## [](#our-babel-plugin)我们的巴别塔插件
...
### [](#1-assume-raw-currying-endraw-has-been-declared-in-the-global-scope)1。假设`currying`已经在全局范围内声明。
...
### [](#2-use-the-raw-babelhelpers-endraw-)2。使用`@babel/helpers`
