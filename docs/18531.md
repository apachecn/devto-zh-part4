...
> 原文:[https://dev . to/florimondmanca/how-to-upgrade-your-vue press-site-to-v1-0-4 lgi](https://dev.to/florimondmanca/how-to-upgrade-your-vuepress-site-to-v1-0-4lgi)
...
## [](#1-read-the-official-announcement)1。阅读官方公告
...
[![ULIVZ](../Images/493449d880d4eda70a035d26e1e12244.png)](https://medium.com/@_ulivz/intro-to-vuepress-1-x-7e2b7885f95f) [## VuePress 1.x. TL 简介；博士:这篇文章是尤利维兹的演讲记录
...
## [](#4-upgrade-vuepress)4。升级 VuePress
...
## [](#5-use-the-new-plugins)5。使用新的插件
...
### [](#-raw-markdownconfig-endraw-)`markdown.config`
...
## [](#7-update-component-imports)7。更新组件导入
...
## [](#8-fix-custom-layouts)8。修复自定义布局
...
[![](../Images/2cd87c45b8ec41793af8b2f1dbb02699.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iIWmHOyv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uw54ywlgd1bximslwup0.png)
...
## [](#9-consider-theme-inheritance)9。考虑主题继承
