...
> 原文:[https://dev . to/evil mars on/ruby-on-whales-dockerizing-ruby-and-rails-development-4dm 7](https://dev.to/evilmartians/ruby-on-whales-dockerizing-ruby-and-rails-development-4dm7)
...
## [](#bonus-dipyml)奖金: [dip.yml](https://github.com/evilmartians/terraforming-rails/blob/master/examples/dockerdev/dip.yml)
