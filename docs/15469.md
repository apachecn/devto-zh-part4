...
> 原文:[https://dev . to/haideralipunjabi/flag-colors-visualization-from-geo pandas-to-leaflet-and-back-4o hk](https://dev.to/haideralipunjabi/flag-colours-visualisation-from-geopandas-to-leaflet-and-back-4ohk)
...
### [](#attempt-1-python-geopandas)尝试 1 (Python + Geopandas):
...
### [](#attempt-3-python-geopandas-exporting-to-svg)尝试 3: Python + GeoPandas(导出到 SVG)
...
这才能够制作出
[![](../Images/3cb8a4065a6881c6ae596cd6fd2b812d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--89eBhZsj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/2RD4s6k.png) 的地图

*我用 Inkscape 添加了文字和背景*

#### [](#the-curious-case-of-france-and-norway)法国和挪威的奇案
