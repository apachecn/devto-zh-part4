...
> 原文:[https://dev . to/takaneichinose/styling-checkbox-history-that-I-know-evolution-of-my-knowledge-3l](https://dev.to/takaneichinose/styling-checkbox-history-that-i-know-evolution-of-my-knowledge-3l)
...
# [](#searching-for-the-solution)寻找解决方案
...
[![](../Images/690c182a6a78d01873de3de38a1e20b0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WADTG0x1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ofzi8e5l9xo6x2pfn66t.png)
...
### [](#solution-number-2)解数 2

#### [](#pure-css-approach)纯 CSS 方式
...
# [](#another-learning-and-practising)学而优则仕

尽管如此，我对以前的解决方案不满意(因为我不想仅仅使用图像来做这些)，我等待更新的技术，然后，尝试研究更好的解决方案。

许多人也使用这个解决方案，所以我想我会在这里坚持一段时间。我认为这是复选框样式的“现代”方式。

### [](#solution-number-3)解数 3

#### [](#pure-css-and-no-resources-approach)纯 CSS 和无资源的方法
