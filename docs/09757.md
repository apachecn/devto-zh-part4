...
> 原文:[https://dev . to/priteshusadadiya/what-the-test-plan-test-approach-and-how-to-prepare-it-351](https://dev.to/priteshusadadiya/what-is-the-test-plan-test-approach-and-how-to-prepare-it-351)
...
### [](#how-to-prepare-the-test-plan-test-approach)如何准备测试计划/测试方法。
...
#### [](#3-test-types-categories)3。测试类型/类别:
...
#### [](#4-test-environment)4。测试环境:

将执行测试用例的所有环境的列表。

#### [](#5-test-approach)5。测试方法:

在这里，您应该提供要测试的特性和其他项目的描述，以及用于发现缺陷的总体测试深度和测试方法。

#### [](#6-exit-criteria)6。退出标准:
...
#### [](#7-open-risks-or-issues)7。未解决的风险或问题:
