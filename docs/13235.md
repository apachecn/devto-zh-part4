...
> 原文:[https://dev . to/vbaknation/creating-visual-for-music-using-speech-recognition-JavaScript-and-ffmpeg-version-1-4ml](https://dev.to/vbaknation/creating-visuals-for-music-using-speech-recognition-javascript-and-ffmpeg-version-1-4mll)
...
## [](#milliseconds-not-frames)毫秒，不是帧
...
## [](#examples-using-raw-requestanimationframe-endraw-)使用`requestAnimationFrame`的例子
...
## [](#refactor-and-raw-generateframeimages-endraw-)重构和`generateFrameImages`
