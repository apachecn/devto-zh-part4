...
> 原文:[https://dev . to/Allen ball/a-Java-net-response cache-implementation-1 AIA](https://dev.to/allenball/a-java-net-responsecache-implementation-1aia)
...
## [](#responsecacheputuriurlconnection-implementation)ResponseCache.put(URI，URLConnection)实现
...
## [](#responsecachegeturistringmapgt-implementation)ResponseCache.get(URI，字符串，地图>)实现
