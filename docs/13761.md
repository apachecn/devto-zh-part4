...
> 原文:[https://dev . to/weg2g/debugging-with-truffle-and-ether eum-remix-in-tontine-dapp-game-20mi](https://dev.to/weg2g/debugging-with-truffle-and-ethereum-remix-in-tontine-dapp-game-20mi)
...
[![Ethereum blockchian debugging with Truffle](../Images/87be1174b82897a5326bf0893019aebd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--j9ggGz13--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-1.gif) 
...
[![Ethereum blockchian debugging with Truffle](../Images/2aa5b515e5338bccd591cb40d33c7b91.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--oP8T-g6d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-2.gif)
...
[![Ethereum blockchian debugging with Truffle](../Images/8d64514715407faf092889244f1d70ba.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vn2T4duf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-3.gif) 

持续按下 *Enter* 按钮，以单步执行代码并跟踪执行步骤。最后，调试器将停止，并显示一条错误消息:

[![Ethereum blockchian debugging with Truffle](../Images/a9a77bd53b4bc878ef0da2a31894eb27.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Z6hNRXdt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-4.gif) 
...
[![Ethereum blockchian debugging with Truffle](../Images/d38e5a7de8782eb9ca4d381b34ee57f7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SUdXyylp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-5.gif) 
...
[![Ethereum blockchian debugging with Truffle](../Images/982f868dd2eac8b66ff30aacb78eb9bd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--FjHP1ITr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-6.gif)
T4】

在 Remix 的右侧窗格中，在有几个控件的调试窗体上，按下 play 按钮开始调试。您将看到一个调试菜单，其中显示了以下视图:

[![Ethereum blockchian debugging with Truffle](../Images/03cb8dd957b7a9452a531c48d1c1be73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3e2cD_nu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-7.gif)
...
[![Ethereum blockchian debugging with Truffle](../Images/cf3e1635f3c54093368aa2e364327859.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ax3NGjB3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-8.gif)
T4】
...
*   ![Ethereum blockchian debugging with Truffle](../Images/941554b479f952e71fef143158cee0bf.png) ![Ethereum blockchian debugging with Truffle](../Images/76b6c1c6047c06b59ed7cc18ac066bcf.png) ![Ethereum blockchian debugging with Truffle](../Images/20b799515f164916020a9471f0587a66.png) **使用调试按钮**单步执行一个事务的有效负载:单步返回![Ethereum blockchian debugging with Truffle](../Images/7143e057c36888e1c77ae3730d6397af.png)、单步返回、单步进入和单步跳过
*   ![Ethereum blockchian debugging with Truffle](../Images/4a92d603a914394e21feab0c56410c1e.png) ![Ethereum blockchian debugging with Truffle](../Images/a0731a633b95c79f2cc509bd325f47b5.png)您可以使用各自的调试按钮随时停止调试和恢复运行:和

使用 Remix debugger 的事务 ID 来调试之前的错误事务归结为处理原始信息，包括执行的操作码列表。在第一种情况下，调试器向我们展示了执行以一条 REVERT 指令结束:

[![Ethereum blockchian debugging with Truffle](../Images/d387f62683625b27f8257a13895966f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HSnQOx7l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-15.gif)
...
[![Ethereum blockchian debugging with Truffle](../Images/cde3b6cc6bdb492ed1ea27413f668b7f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--QX9zejBy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-16.gif) 

使用 truffle migrate–reset–network my _ Ganache 将合同部署到 Ganache 中，然后检索合同的地址:

[![Ethereum blockchian debugging with Truffle](../Images/2cff313e72b475c46a08aa0a8c0a57a5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tKwkufpz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-17.gif) 
...
[![Ethereum blockchian debugging with Truffle](../Images/b96303535ae266971ac1889004983165.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--p-pMmpzQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-18.gif) 
...
[![Ethereum blockchian debugging with Truffle](../Images/e0edc923620f8ca28d7e8d275fd19e74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fyvW1720--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-19.gif)

然后，通过按下“加入”按钮，让第一个玩家加入 Tontine 游戏。当它成功完成时，更改帐户并用 zero ether 调用 join 方法，您将在消息输出中得到以下错误:

[![Ethereum blockchian debugging with Truffle](../Images/e79bb24488fc5006d0a28d52f328fc98.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--bFL8DSUY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-20.gif) 
...
[![Ethereum blockchian debugging with Truffle](../Images/05484535776be6c597ab212e35e2dfe1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--R5RbN8ka--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-21.gif)** 

 **此外，当调试面板加载时，您会看到一个蓝色的高亮显示，它标记了随着调试的进行正在执行的代码部分，这提供了宝贵的帮助。

注意调试按钮下面有一个警告按钮。一旦按下，它将再次抛出异常，并直接跳转到异常发生前的最后一个操作码:

[![Ethereum blockchian debugging with Truffle](../Images/b47643f6b9b7b3b408c06bd39a3b49c1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SnEVp_uk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-22.gif)

##### 设置断点

众所周知，断点是可靠调试的最基本和最重要的特性。它们是一种方便的工具，可以帮助您详细检查特定代码段的执行情况。和其他流行的 ide 一样，在 Remix 中可以通过点击一行代码的左边来添加和删除断点:

[![Ethereum blockchian debugging with Truffle](../Images/0c130b75292f82bc37e8f5b55017a085.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4lFt1Qf7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-23.gif)
...
[![Ethereum blockchian debugging with Truffle](../Images/3d76c71f8c37e345b622a464086f6044.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eO2tjvAm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://coding-bootcamps.com/img/external/16/debugging-with-truffle-and-ethereum-remix-24.gif) 
直接跳到您的固定断点
