...
> 原文:[https://dev.to/omrilotan/working-with-git-submodules-2nc2](https://dev.to/omrilotan/working-with-git-submodules-2nc2)
...
## [](#chapter-1-module-repository-within-a-repository)第 1 章—存储库中的模块存储库

我们将创建一个简单的项目:一个带有一些样式的 HTML 页面。

### [](#the-main-project)主项目
...
### [](#editing-the-modules-content-and-updating-its-repository)编辑模块的内容并更新其存储库
...
## [](#chapter-2-distribution-across-projects)第 2 章——跨项目分布
...
## [](#chapter-3-consumption-in-teams)第三章——团队消费
...
## [](#chapter-4-extra-curricular)第四章——课外

### [](#git-configurations)Git 配置

#### [](#set-up-git-to-show-updates-to-submodules-on-git-status)设置 git 以显示 Git 状态下子模块的更新:
...
#### [](#point-to-a-branch-instead-of-a-commit)指向分支而不是提交
...
### [](#automatic-fetch-and-merge-module-not-project)自动取并(模块，非项目)
...
### [](#pushing-from-a-project-with-modules)从一个项目中推出模块
...
## [](#chapter-5-fallibles)第五章——易变物品

一些用例可能会变得有点混乱。

### [](#introducing-a-submodule-in-a-feature-branch)在特征分支中引入子模块
...
### [](#a-submodule-was-updated-while-i-was-in-a-feature-branch)当我在特征分支中时，一个子模块被更新
...
### [](#switching-from-directory-to-a-submodule)从目录切换到子模块
