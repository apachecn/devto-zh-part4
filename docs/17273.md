...
> 原文:[https://dev . to/Werner/practical-rust-web-development-front-end-538d](https://dev.to/werner/practical-rust-web-development-front-end-538d)
...
### [](#better-errors-in-the-browser)浏览器中更好的错误

为了更好地解释正在发生的事情，你可以使用`console_error_panic_hook` crate。

### [](#error-closure-invoked-recursively-or-destroyed-already)错误:闭包被递归调用或已经被销毁
