...
> 原文:[https://dev . to/iggredible/quick-vim-tips-to-generate-and-increment-numbers-3849](https://dev.to/iggredible/quick-vim-tips-to-generate-and-increment-numbers-3849)

有时候，我需要在 vim 中快速增加或生成一列数字。Vim 8/ neovim 附带有用的数字技巧。

[![magician](img/23093d6f6c045ba42b3a01ec0cf7d59d.png)T2】](https://i.giphy.com/media/KmIR3x7UG4cFy/giphy.gif)

我在这里分享其中的两个。

# [](#quickly-generate-numbers-with-put-and-range)用 put 和 range 快速生成数字
...
# [](#quickly-increment-column-of-numbers)快速递增一列数字
...
[![shocked](img/9c0e9ec4695fc9ac8dfcaa5653c2456b.png)T2】](https://i.giphy.com/media/Ki9ZNTNS7aC9q/giphy.gif)
