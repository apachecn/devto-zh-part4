...
> 原文:[https://dev.to/harbolaez/keyword-make-with-map-slice-4gaj](https://dev.to/harbolaez/keyword-make-with-map-slice-4gaj)
...
### [](#cru-a-map-with-make)**CRU** 一张地图用使
...
### [](#cru-a-slice-with-make)**CRU** 一片同令
