...
> 原文:[https://dev . to/eldadfux/introducing-app write-an-open-source-back end-server-for-mobile-web-developers-4b 84](https://dev.to/eldadfux/introducing-appwrite-an-open-source-backend-server-for-mobile-web-developers-4b84)
...
# [](#appwrite-authentication)Appwrite 认证

Appwrite 身份验证服务可让您轻松管理用户注册和应用程序登录。Auth 服务还提供与多个 OAuth 提供商的内置集成，如脸书、Github、LinkedIn 等。

[![](img/1ceab9dc9e67701538c8331ebc439b32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2VgOIkv2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4800/1%2Ad9egnOpYwD7Gxuj0rButaw.jpeg)
...
# [](#appwrite-account)Appwrite 账号

Appwrite 帐户服务向您的客户端公开一个 API，该 API 允许您与当前登录的用户帐户进行交互。

[![](img/ea09cc72d36631015555f8c83bf725db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ojkm0cGu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4800/1%2A7p-nrHK2ili_kZiQqeVNxw.png)
...
# [](#appwrite-database)Appwrite 数据库

[![](img/e1766612a8a41558574d89e3ecf6d5c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WJrxOAcB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4800/1%2Ar68IlauvlAY9PnEoW1HMzw.jpeg)
...
# [](#appwrite-teams)Appwrite 团队

Appwrite Teams 服务允许您和您的用户创建团队并共享对不同 API 资源(如文件或文档)的权限。这是为您的产品实现复杂的访问控制需求的一个伟大而简单的方法。

每个团队成员也可以扮演不同的角色，这样你就有了更大的灵活性。

# [](#appwrite-tasks)Appwrite 任务

[![](img/4a209ac81f9cab79896353ffd12e65f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NB9e6szP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4800/1%2Aoyn3wzrOtU-7WrFsomvqug.jpeg)
...
# [](#appwrite-webhooks)Appwrite Webhooks

[![](img/b54edcbaabca75f2c2dbd49b94ad2bbe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3T8_-V5E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/4800/1%2AVNdG7tIMcinmNTFZsXdQlg.png)
