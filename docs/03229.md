...
> 原文:[https://dev . to/bartr/install-docker-on-windows-subsystem-for-Linux-v2-Ubuntu-5dl 7](https://dev.to/bartr/install-docker-on-windows-subsystem-for-linux-v2-ubuntu-5dl7)

# [](#install-docker-on-windows-subsystem-for-linux-v2-ubuntu)在 Windows 子系统上安装 Docker for Linux v2(Ubuntu)
