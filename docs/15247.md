...
> 原文:[https://dev . to/jet rockets/deploy-any cable-with-capistrano-and-systemd-49j 0](https://dev.to/jetrockets/deploy-anycable-with-capistrano-and-systemd-49j0)
...
#### [](#anycable-meets-systemd)AnyCable 遇上 systemd
