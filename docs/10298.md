...
> 原文:[https://dev . to/idevkamboj/care-about-security-enable-docker-content-trust-4djh](https://dev.to/idevkamboj/care-about-security-enable-docker-content-trust-4djh)
...
#### [](#steps-to-sign-docker-images)签署 Docker 图像的步骤。
...
## [](#automation-with-content-trust)自动化与内容信任
