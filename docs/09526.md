...
> 原文:[https://dev.to/ivergara/deeper-into-dataclasses-6fd](https://dev.to/ivergara/deeper-into-dataclasses-6fd)
...
## [](#using-raw-dataclasses-endraw-introspection)利用`dataclasses`自省
...
## [](#an-alternative-solution)一种替代方案
