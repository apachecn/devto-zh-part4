...
> 原文:[https://dev . to/khu pi/I-want-to-run-JavaScript-count up-time tracker-in-the-background-when-page-closed-25kb](https://dev.to/khupi/i-want-to-run-javascript-countup-timetracker-in-the-background-when-page-closed-25kb)
