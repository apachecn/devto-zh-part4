# 当页面关闭时，我想在后台运行 Javascript countup timetracker

> 原文：<https://dev.to/khupi/i-want-to-run-javascript-countup-timetracker-in-the-background-when-page-closed-25kb>

当页面关闭时，我想在后台运行 javascript 计数时间跟踪器
