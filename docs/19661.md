...
> 原文:[https://dev . to/joshuamdegzman/get-in-depth-with-kot Lin-strings-33me](https://dev.to/joshuamdeguzman/getting-in-depth-with-kotlin-strings-33me)
...
##### [](#string-with-multiple-lines)多行字符串
...
#### [](#accessing-characters-of-a-string)访问字符串中的字符
...
##### [](#iterate-through-a-string)遍历一个字符串
...
#### [](#immutability-of-a-string)字符串的不变性
...
##### [](#reassigning-string-values)重新分配字符串值
...
##### [](#determining-length-of-a-string)确定一个字符串的长度
