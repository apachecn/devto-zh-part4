...
> 原文:[https://dev . to/wangonya/diff lib-finding-close-matches-of-string-from-a-list-54jl](https://dev.to/wangonya/difflib-finding-close-matches-of-strings-from-a-list-54jl)
