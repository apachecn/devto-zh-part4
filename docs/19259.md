...
> 原文:[https://dev . to/Daniel Sada/programs-the-save-the-me-100 hours-by-automating-repetitive-tasks-11ld](https://dev.to/danielsada/programs-that-have-saved-me-100-hours-by-automating-repetitive-tasks-11ld)
...
[![](../Images/a4e063c31e34f49bb728f2436657dd22.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q5M5xA7S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://phaven-prod.s3.amazonaws.com/files/image_part/asset/1850945/Q6oltvJvG4Kwgy_V23yBvDPOqW4/thumb_Screen_Shot_2017-03-15_at_5.46.19_PM.png)

Photobulk 允许您批量或成批地调整图像大小、添加水印、优化和重命名图像。这是节省我大量时间的主要工具之一，所以我广泛推荐它。我知道有些事情可以通过控制台或 photoshop 操作来完成。但这样更快。

# [](#2-regex-and-sublime-text-or-vs-code)2。正则表达式和升华文本或 VS 代码

同一个客户对你花了 4 个小时对图像做了手脚并上传它们感到不高兴，并要求你添加一个 php 数组中给定的 200 种颜色的调色板，以完成他们的调色板到 javascript 的迁移。

[![](../Images/a216d7d5631ff007514f6b99647c46ff.png)](https://i.giphy.com/media/j2xXLmnnN8N2g/giphy.gif) 
Regex 是如此强大，可以在海量数据中创建快速变化，以至于我节省了无数小时的转换或朋友的任务，值得学习。直到我在文本编辑器中使用了 regex，我才明白它的强大之处。真的很神奇。

# [](#3-coda-or-komodoide)3。Coda 或 KomodoIDE
...
# [](#4-alfred-or-spotlight)4。阿尔弗雷德或聚光灯。
...
[![](../Images/e4f04b0777846e4044ba6c5eebd9d74b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8Unzna99--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.alfredapp.com/media/pages/home/clipboard.jpg)
...
[![](../Images/f5ac9c92ead48c5a59399581d3210df9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KtSvQqum--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.noodlesoft.com/kb/uploads/xmain.png.pagespeed.ic.4wQ59TUX7j.webp)

例如，我可以创建一个规则，监视我的桌面上超过 4 小时的文件，即截屏，它会将它们带到我的“截屏文件夹”，或者我超过 X 周没有使用的下载。或者创建一个过滤图像的规则。或者创建一个文件夹，把我放进去的所有文件“分类”。

# [](#but-hey-this-is-pretty-basic)但是，哎，这个挺基础的。
