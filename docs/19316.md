...
> 原文:[https://dev . to/rgeraldporter/using-shell-bash-commands-in-code-use-long-options-2f4k](https://dev.to/rgeraldporter/using-shell-bash-commands-in-code-use-long-options-2f4k)
