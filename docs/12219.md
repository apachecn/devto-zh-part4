...
> 原文:[https://dev . to/bdbch/web development-for-初学者-03-bring-in-some-action-2e0b](https://dev.to/bdbch/webdevelopment-for-beginners-03-bring-in-some-action-2e0b)
...
### [](#-raw-ltulgt-endraw-unordered-lists)`<ul>`:无序列表

`ul`代表无序列表。这意味着我们的列表不会以任何方式进行编号或排序。不是自闭，需要内容。

### [](#-raw-ltolgt-endraw-ordered-lists)`<ol>`:有序列表

`ol`代表有序列表。这意味着我们的列表将以一种逻辑的方式排序。这可能是一个编号列表，或者是一个字母列表。

### [](#-raw-ltligt-endraw-list-items)`<li>`:列表项

`li`代表列表项，需要建立列表。该元素必须总是在`<ol>`或`<ul>`列表中使用。否则您将无法在列表中创建语义项。

现在我们的网站看起来怎么样？

[![](../Images/79035ebc21acda887dec5019bd42aab1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3wBFXTXL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/dnJ6ilL.png)
...
[![](../Images/28a6778c5efbb8c863a76757191a5fa2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SB8am_b2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/s78Xvi6.png)
...
[![](../Images/6adfd93f96156725dbdf9f0f4f32db06.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--llknFxQd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/NpT7fYi.png)

不是很难，对吧？

# [](#youtube-video-embed)YouTube 视频嵌入
...
[![](../Images/450c1c2c9b86afedfd22c65f4bbc8ed0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Bt253fZX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/PocMA5F.gif)
