...
> 原文:[https://dev . to/Steve George/17-important-CSS-tips-the-you-must-be-aware-of-54po](https://dev.to/stevegeorge/17-important-css-tips-that-you-must-be-aware-of-54po)

CSS 是一个广阔的领域。作为一个初学者，你需要熟悉那些能帮助你毫不费力地完成你所选择的设计的技巧和技术。这篇文章将带你了解一些行之有效的 CSS 技巧来开始设计。

## [](#important-css-tricks-you-must-know)你必须知道的重要 CSS 窍门

### [](#1-controlling-exact-position-of-web-element-with-absolute-positioning)1)用“绝对定位”控制网元素的精确位置
...
### [](#2-selecting-every-elements-of-selector)2)选择选择器的每个元素

对于给定的选择器，可以用*选择所有元素。例如，如果在添加 CSS 样式之前使用*p，那么文档中的每个元素都将使用

标签将被选中。你可以很容易地选择网站的一部分。

### [](#3-overriding-other-css-styles)3)覆盖其他 CSS 样式
...
### [](#4-centering-css-items)4)居中 CSS 项
...
### [](#5-aligning-text-vertically-for-single-line)5)垂直对齐单行文本
...
### [](#6-adding-hover-effects)6)添加悬停效果
...
### [](#7-using-transition-for-easing-in-changes)7)用过渡来缓和变化
...
### [](#8-using-max-width-for-resizing-images)8)使用“最大宽度”调整图像大小
...
### [](#9-controlling-the-sections-elements)9)控制截面的元素
...
### [](#15-forcing-text-to-change-case)15)强制文本改变大小写

如果你的整个博客都是用大写字母发布的，你可能也想用小写字母和间断的大写字母来表达。你不需要重打。相反，您可以在样式表中使用固定的 CSS 样式来强制文本更改其“大小写”格式。
举例:

[![Alt Text](../Images/71880edc833a2f8a0b9ccb1b91e10bc5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OtpFSJfF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qvwr8u6j0djl9g3riif1.jpg)

在上面的例子中，h1 标题标签已经被定位。

### [](#16-filling-the-complete-screen-with-specific-section)16)用特定部分填充整个屏幕
...
### [](#17-styling-phone-links)17)造型手机链接

假设，你已经放置了一个链接，当用户点击这个链接时，你可能会在它的样式上遇到问题。这是因为用于活动线路选项的传统选择器变得无效。你必须使用 CSS3 格式来克服这个问题。

示例:

[![Alt Text](../Images/f561ca581b8e6d23a7d75f181eee8767.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Dnj1gw7S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4vwakqn5b9eot71hotd8.jpg)T3】
