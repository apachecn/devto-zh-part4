...
> 原文:[https://dev . to/binary sort/using-docker-with-nodejs-for-local-development-43k 5](https://dev.to/binarysort/using-docker-with-nodejs-for-local-development-43k5)
...
## [](#dockerfile-docker-image-amp-containers)DockerFile，Docker Image &容器
...
## [](#lets-create-a-nodejs-app-using-docker)让我们使用 docker 创建一个 NodeJS 应用程序
