...
> 原文:[https://dev . to/se Kara/how-to-connect-elements-with-lines-on-web-page-5b9n](https://dev.to/sekara/how-to-connect-elements-with-lines-on-web-page-5b9n)
...
### [](#sneak-peak-of-final-result)潜峰的最终结果✅

在这里，您可以看到当您将一些单词与另一个单词连接起来并检查连接是否正确时的最终结果。
[![Sneak peak of final result](../Images/f7426712bd3bb1217c76af20d1132613.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--Gyp1cnFJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xfhnteflc26e1ubbsku0.gif)
