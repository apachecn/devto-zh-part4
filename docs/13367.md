...
> 原文:[https://dev . to/bnevilleoneill/node-js-12-the-future-of-server-side-JavaScript-3g ma](https://dev.to/bnevilleoneill/node-js-12-the-future-of-server-side-javascript-3gma)

[![](../Images/a293478b8f39a9775dc887c7194f4961.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TjUTkdjs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/38cvnp62cmlglakb9quc.png)
...
## [](#node-12-new-amp-improved)节点 12 新&改进
...
## [](#v8-javascript-engine-upgrades)V8 JavaScript 引擎升级
...
## [](#properly-configured-default-heap-limits)正确配置默认堆限制
...
## [](#the-default-http-parser-becomes-llhttp)默认的 http 解析器变成了 llhttp
...
## [](#diagnostic-reports-on-demand)按需诊断报告
...
## [](#worker-threads-are-coming-the-experimental-flag-has-been-removed)工作线程即将到来–实验标志已被移除
...
## [](#startup-time-improvements)启动时间的改进
...
## [](#es6-module-support-its-almost-here)ES6 模块支持，差不多了![🙌](../Images/373e63b309d80d488b9bc2d7a6a430bc.png)
...
## [](#new-compiler-amp-platform-minimum-standards-for-node-12)新编译器&平台最低标准为节点 12
