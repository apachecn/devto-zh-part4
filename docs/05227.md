...
> 原文:[https://dev . to/lad vien/a-Lego-classifier-CNN-and-elbow-grease-35nj](https://dev.to/ladvien/a-lego-classifier-cnn-and-elbow-grease-35nj)

[![](../Images/fe13ae846acb1295e7093eb1e8e72042.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ljnhhJeg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/lego_classifier/lego_classifier_comic.png)
...
[![](../Images/0809ed96b26879ff286387ca031dd478.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--SDXE_7cf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/lego_classifier/rockets_contraption.jpg) {:。总之，当我在做的时候，火箭有一个很棒的计划。他发明了一种仪器来给旋转盘上的乐高玩具拍照。它使用了树莓派，Pi 凸轮，步进电机，和独角兽放屁。
...
## [](#preprocessing-code)预处理代码

在我们开始用火箭的图像训练 CNN 之前，我们需要做一些预处理。首先，图像是全分辨率的，但我们需要裁剪它们，因为 CNN 在方形图像上训练得更好。当然，为了不丢失目标数据(乐高)，图像需要被裁剪。

例如
[![preprocess-image-for-cnn](../Images/232b5b226d1412b505d39ad23bbb7d11.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--p4q-L9ff--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/lego_classifier/crop_and_resize.png)
...
## [](#preprocessing-code-needed-libraries)预处理代码:需要的库
...
## [](#preprocessing-code-processing-parameters)预处理代码:加工参数
