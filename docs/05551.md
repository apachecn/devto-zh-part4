...
> 原文:[https://dev . to/janne _ mattila/azure-powershell-and-arm-template-deployment-from-github-actions-2038](https://dev.to/janne_mattila/azure-powershell-and-arm-template-deployment-from-github-actions-2038)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [蔚蓝](https://github.com/Azure) / [动作](https://github.com/Azure/actions)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)/[动作](https://github.com/JanneMattila/actions)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)/[AzurePwshARMActionDemo](https://github.com/JanneMattila/AzurePwshARMActionDemo)
...
[![Alt Text](../Images/b2c184a048d1a5a5321f1a4848d06eeb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BZSoD3wT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2f0ef7phnoe7wd12t24e.png)

那当然是指`deploy`文件夹和`deploy.ps1`和`azuredeploy*.json`文件。这个演示没有(还没有？)中有任何应用程序代码，但例如已经有管理 web 应用程序的操作，所以添加它会很容易:

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [蔚蓝](https://github.com/Azure) / [ appservice-actions](https://github.com/Azure/appservice-actions)
...
[![Azure credentials managed in secrets](../Images/d4bf8c7bc1ab6291831a74ba73f0a1a6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BdlU4-8y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k51isnxwjhd2ppn06nyl.png)

以上工作流基于`on: [push]`(在工作流定义中)事件自动启动。我还可以在操作下查看我的工作流执行:

[![Workflow runs visible under Actions menu](../Images/9d26d5fe400f9e9d83347352a3cc9caf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IpfpJPbd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eo282thqzhwv7xku4b5q.png)

您可以进一步深入到每次运行的详细信息:
[![Workflow execution log](../Images/2b2709bc8e8a66a90dc2f88c0e39f63b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dZOtBiXD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p4flh6y0nbpef6jkq4hw.png)

由于我在我的 PowerShell 文件中使用了 ARM 模板部署，我也可以在 Azure Portal 中看到我的部署:
[![Resource group deployments in Azure Portal](../Images/6cea32e1fa3f667b8522b1fec8c98482.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_LFNwYyC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o003umhsdsp3m3c7n9uq.png) 
...
如果你认为我能一口气完成这件事...嗯不😊: [![Trial & error implementation](../Images/a443bf27f72feb71a06644a28b14812d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--9-PLtUHI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/iq7h22b0faemqy14d1l9.png)