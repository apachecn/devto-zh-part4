...
> 原文:[https://dev . to/this _ mkhy/do-you-know-es6-part-3-advanced-3 fcl](https://dev.to/this_mkhy/do-you-know-es6-part-3-advanced-3fcl)

## [](#before-you-start-reading-this-advanced-part-we-have-discussed-some-of-es6-features)在开始阅读本高级部分之前，我们已经讨论了 ES6 的一些特性:
...
[![image](../Images/c5f54f786919eefdf03bc7af0b61b37c.png)T2】](https://i.giphy.com/media/3o7WTxQ7RFErPLfOqk/giphy.gif)
...
[![image](../Images/d43445cb60cc78e11abcc40ebb564127.png)T2】](https://i.giphy.com/media/3o6Mb7Vqfuk0n2p8Xu/giphy.gif)

闭包是指一个函数记住了它的词法范围，即使它是在词法范围之外执行的。所以闭包就是当一个函数使用另一个函数或另一个作用域中定义变量时。所以它链接到这个变量来更新它值。

[![image](../Images/17a3f60dae49a01278bcc1d505750dbe.png)T2】](https://i.giphy.com/media/Y8tdZ0MiJsuIM/giphy.gif)
...
[![image](../Images/919e365f103d611cc3fa26f9ac11704a.png)](https://i.giphy.com/media/pDWtwK7D2IlFu/giphy.gif) 
同步编程意味着你的代码一行一行地运行，一个函数一个函数地运行。所以不能同时运行两个功能。

## [](#asynchronous-programming)异步编程

[![image](../Images/3e8449cf8ec15cb6cc5401fb4463a6a3.png)](https://i.giphy.com/media/l46Cv8ujmQBUv7Kq4/giphy.gif) 
...
[![image](../Images/4d387dc70b388f364bf9b612ab7f08f1.png)T2】](https://i.giphy.com/media/MaP7o24dFPqvVAXFMy/giphy.gif)

## [](#what-is-promise)什么是承诺？
...
## [](#how-to-know-if-the-promise-works-or-not)如何知道承诺是否有效？
...
## [](#the-value-for-resolve-or-reject)解析或拒绝的值
