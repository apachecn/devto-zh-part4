...
> 原文:[https://dev . to/gege 251/haskell-do-notation-explained-through-JavaScript-async-await-part-2-HN](https://dev.to/gege251/haskell-do-notation-explained-through-javascript-async-await-part-2-hn)
...
## [](#about-type-classes-and-polymorphism)关于类型类和多态性
...
## [](#special-map-functions-for-monads)单子的特殊映射函数
