...
> 原文:[https://dev . to/dmtrkovalenko/the-neest-way-to-handle-alert-dialogs-in-react-1 AOE](https://dev.to/dmtrkovalenko/the-neatest-way-to-handle-alert-dialogs-in-react-1aoe)
...
> [![No god please no image](../Images/f76a0fb8e5fdd4c51af95d4ea6567aac.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--c8n99gLd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://github.com/dmtrKovalenko/images/blob/master/no_god_pls_no.gif%3Fraw%3Dtrue)

所以我们开始吧。我们所需要的只是在应用程序的根处只呈现 **1 顶级**模态，并在需要时显示它。我们将使用 react 钩子的能力来使它看起来更优雅。

## [](#wrap-the-context)包裹上下文
...
[![Are you ready kids?!](../Images/652ef6f1a3652a0d94533fcb8d3cb63f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PNbrn7b_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/dmtrKovalenko/images/blob/master/hey%2520children.jpg%3Fraw%3Dtrue)
