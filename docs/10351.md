...
> 原文:[https://dev . to/dot net/what-s-the-big-deal-with-iasyncenumerable-t-in-net-core-3-1 EII](https://dev.to/dotnet/what-s-the-big-deal-with-iasyncenumerable-t-in-net-core-3-1eii)
...
## [](#life-before-raw-iasyncenumerablelttgt-endraw-)之前的生活`IAsyncEnumerable<T>`
...
## [](#-raw-iasyncenumerablelttgt-endraw-to-the-rescue)`IAsyncEnumerable<T>`前来救援
...
## [](#-raw-iasyncenumerablelttgt-endraw-and-aspnet-core)`IAsyncEnumerable<T>`和 ASP.NET 核心
...
## [](#replacing-raw-taskltienumerablelttgtgt-endraw-with-raw-iasyncenumerablelttgt-endraw-)用`IAsyncEnumerable<T>`代替`Task<IEnumerable<T>>`
