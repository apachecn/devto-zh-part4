...
> 原文:[https://dev . to/bholmesdev/using-enums-with-string-values-in-typescript-consider-string-literals-instead-486 e](https://dev.to/bholmesdev/using-enums-with-string-values-in-typescript-consider-string-literals-instead-486e)
...
## [](#when-string-enums-fall-flat)当弦枚举落平
...
## [](#string-literals-to-the-rescue)字符串文字来救援！

幸运的是，当您需要这些字符串值时，TypeScript 有一个更简洁的解决方案。您可以提供一个有限的字符串列表，一个变量可以被分配。否则，它应该抛出一个类型错误。

[![Example of assigning something invalid to a string literal type](../Images/88f76940d4781752eac0cf503c3b57cc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RZOiE5LV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vg17yj980e8yzi3s3ihj.gif)

这也将阻止您将传统的“字符串”类型分配给字符串文字。因此，在声明类型时，需要导出字符串类型，并像使用枚举一样使用它。

[![Example of autocomplete for string literals using VS Code](../Images/40a9fa0f63ead6174f6b7b8ad61958a3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lC7hLhbJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4l8srodbtpwfn88dp22d.gif)
