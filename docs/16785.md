...
> 原文:[https://dev . to/cassiebreviu/how-to-get-a-dataset-and-create-a-ml-model-to-classify-yoga-poses-1p](https://dev.to/cassiebreviu/how-to-get-a-dataset-and-create-a-ml-model-to-classify-yoga-poses-1p)
...
### [](#next-we-will-create-a-bing-search-api-resource-needed-to-get-our-dataset)接下来，我们将创建获取数据集所需的阿炳搜索 Api 资源
...
### [](#image-scraper-using-bing-search-cognitive-service)图片刮刀使用 Bing 搜索认知服务
...
### [](#now-that-we-have-a-dataset-lets-create-our-custom-vision-api-resource-to-train-a-model-that-will-recognize-yoga-poses)现在我们有了一个数据集，让我们创建自定义视觉 API 资源来训练一个能够识别瑜伽姿势的模型
...
#### [](#create-a-custom-vision-project-and-train-model)创建自定义视觉项目和训练模型
...
### [](#get-the-prediction-url)获取预测 Url
...
### [](#consume-the-api-in-an-app)消费某 App 中的 API
...
### [](#i-love-to-test-apis-with-postman-here-are-steps-so-use-postman)我喜欢用 Postman 测试 API。这里是步骤，所以使用邮递员
