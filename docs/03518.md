...
> 原文:[https://dev . to/webhook relay/a-simple-way-to-keep-your-vue-page-title-in-sync-the-router-ec0](https://dev.to/webhookrelay/a-simple-way-to-keep-your-vue-page-title-in-sync-with-the-router-ec0)
...
## [](#step-1-declare-route-meta-in-your-router-config)步骤 1:在路由器配置中声明路由元
...
## [](#step-2-add-route-watcher-in-your-appvue)第二步:在你的 App.vue 中添加$route watcher
