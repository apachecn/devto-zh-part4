...
> 原文:[https://dev . to/guin/react-hooks-making-function-components-stateful-19lj](https://dev.to/guin/react-hooks-making-function-components-stateful-19lj)
...
## [](#using-the-usestate-hook)使用 useState 钩子
...
### [](#so-we-created-some-local-state-how-do-we-use-and-update-it-in-our-code)所以我们创建了一些局部状态，我们如何在代码中使用和更新它呢？
