...
> 原文:[https://dev . to/monty 5811/building-a-server less-duate-form-6j 4](https://dev.to/monty5811/building-a-serverless-donate-form-6j4)
...
[![flow chart](img/e1008c048ee0cafdc28044aefae34df8.png)T2】](https://github.com/monty5811/donate-form/flowchart.png?raw=true)
...
## [](#step-2-adding-stripe-to-the-form)第二步:给表单添加条纹
...
## [](#step-3-add-our-lambda-function)第三步:添加我们的 lambda 函数
