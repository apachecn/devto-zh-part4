...
> 原文:[https://dev . to/raddevon/how-to-use-JavaScript-s-array-map-method-462 a](https://dev.to/raddevon/how-to-use-javascript-s-array-map-method-462a)
...
### [](#breaking-down-the-callback-function)分解回调函数
