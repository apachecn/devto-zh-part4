...
> 原文:[https://dev . to/icy phox/setting-up-my-personal-mail server-3o9k](https://dev.to/icyphox/setting-up-my-personal-mailserver-3o9k)
...
### [](#so-raw-dockermailserver-endraw-)所以……`docker-mailserver`
