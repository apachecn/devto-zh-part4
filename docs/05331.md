...
> 原文:[https://dev.to/srini/help-your-code-review-i0p](https://dev.to/srini/help-your-code-review-i0p)

### 代码评审是一个与你的团队、技术和产品联系的绝佳机会。

# [](#help-is-acronym-for-humor-energy-learning-patience)HELP 是幽默、能量、学习、耐心的缩写
...
## [](#hope-yall-find-this-mindshare-useful)希望你会觉得这篇分享有用。
