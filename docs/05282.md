...
> 原文:[https://dev . to/unbug/swift-and-JavaScript-comparison-snippets-control-flow-c6a](https://dev.to/unbug/swift-and-javascript-comparison-snippets-control-flow-c6a)
