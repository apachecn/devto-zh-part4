...
> 原文:[https://dev . to/Adam _ cyclones/grunt-then-gulp-then-web pack-now-parcel-2j7b](https://dev.to/adam_cyclones/grunt-then-gulp-then-webpack-now-parcel-2j7b)
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) [亚当-万马](https://github.com/adam-cyclones) / [迪迪](https://github.com/adam-cyclones/didi)

### 将项目从普通 JS 转换为 ESmodules，包括 bundler-like / task runner 行为。

<article class="markdown-body entry-content container-lg" itemprop="text">

[![didi the dino is a pterodactyl logo](../Images/2c05d39f2b41b857eec070ccb81e5294.png)T2】](https://github.com/adam-cyclones/didi)
