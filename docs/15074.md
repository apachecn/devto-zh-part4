...
> 原文:[https://dev . to/we B- atoms/retrieve-inspired-rest-services-in-we B- atoms-core-1 nap](https://dev.to/web-atoms/retrofit-inspired-rest-services-in-web-atoms-core-1nap)
...
## [](#caching-based-on-result)基于结果的缓存
...
## [](#json-parsing-options)Json 解析选项
