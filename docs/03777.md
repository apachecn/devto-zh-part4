...
> 原文:[https://dev . to/michi/TDD-course-with-adonisjs-1-let-s-build-a-simple-forum-199](https://dev.to/michi/tdd-course-with-adonisjs-1-let-s-build-a-simple-forum-199)
...
# [](#install-cli-and-framework)安装 CLI 和框架
