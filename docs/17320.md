...
> 原文:[https://dev . to/martinhaeusler/why-I-stopped-using-coroutines-in-kotlin-kg0](https://dev.to/martinhaeusler/why-i-stopped-using-coroutines-in-kotlin-kg0)
...
# [](#binding-data-to-the-rest-call)绑定数据到 REST 调用
...
# [](#-raw-synchronized-endraw-will-no-longer-do-what-you-think-it-does)`synchronized`不再做自己认为该做的事
...
# [](#throughput-vs-horizontal-scaling)吞吐量与水平扩展
...
# [](#coroutines-have-their-place)协程有它们的位置
