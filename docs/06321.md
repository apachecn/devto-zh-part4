...
> 原文:[https://dev.to/aziziyazit/angular-theme-provider-59pe](https://dev.to/aziziyazit/angular-theme-provider-59pe)
...
### [](#themeprovidercomponent-snippet-code)ThemeProviderComponent 代码片段
