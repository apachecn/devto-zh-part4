...
> 原文:[https://dev . to/shawonashraf/tracking-download-progress-with-urlsessiondownloaddelegate-9io](https://dev.to/shawonashraf/tracking-download-progress-with-urlsessiondownloaddelegate-9io)
...
[![final state of the app](img/f67a67181858ed30c514afe5a45ca0c4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lmdD42Qf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/FfiyPbQ.gif)

## [](#interface)界面

打开故事板，添加 3 个控件——一个 imageview，一个 label 和一个 button，使用你喜欢的任何约束。(约束对于我们目前的讨论来说是不必要的)以下面的图片作为参考。

[![reference storyboard interface](img/3de013af00b39cc0e6bb851e4ff062ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GxS_Z2PK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fsmnlz0jn13rp8qqifyw.png)
...
## [](#now-for-the-main-course)现在为主菜

### [](#creating-the-downloadtask)创建下载任务
...
## [](#side-concerns-download-done-how-to-set-the-image-then)侧面关注——下载完成，如何设置镜像呢？
...
### [](#accessing-downloaded-data)访问下载的数据
...
### [](#uiimage-from-data)UIImage 来自数据？
...
### [](#completing-the-protocol-function)完成协议功能
