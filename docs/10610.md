...
> 原文:[https://dev . to/this dot media/angular-and-the-rest-with-nest-js-2g lo](https://dev.to/thisdotmedia/angular-and-the-rest-with-nest-js-2glo)
...
## [](#building-the-monorepo-with-nrwlnx-workspace)使用 Nrwl/Nx 工作空间构建 Monorepo
...
### [](#what-is-an-nx-workspace)什么是 Nx 工作空间？

Nx 工作空间是使用 Nx 创建的文件夹。该文件夹由一个 git 存储库组成，包含应用程序和库的文件夹；以及一些脚手架来帮助建筑，林挺和测试。

### [](#create-the-movie-tracker-nx-workspace)创建电影跟踪器 Nx 工作区
...
[![Empty Nx workspace](../Images/bb01ca205f3a1aa031878c1ba75db48b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B5suml10--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7df927458fjg6o6597kq.PNG)
