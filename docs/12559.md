...
> 原文:[https://dev.to/firstclown/how-to-format-dates-in-vue-42em](https://dev.to/firstclown/how-to-format-dates-in-vue-42em)
...
## [](#a-simple-date-filter-for-vue)一个用于 Vue 的简单日期过滤器
