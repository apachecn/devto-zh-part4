...
> 原文:[https://dev . to/leandrocp/enforcing-code-quality-in-elixir-4on 9](https://dev.to/leandrocp/enforcing-code-quality-in-elixir-4on9)
...
### [](#a-note-before-we-continue)我们继续之前先说明一下
...
## [](#complete-example-files)完整的示例文件
