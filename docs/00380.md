...
> 原文:[https://dev.to/tayyebi/linux-as-a-web-server-1l3i](https://dev.to/tayyebi/linux-as-a-web-server-1l3i)
...
# [](#connect-to-your-server)连接你的服务器！
...
# [](#learn-more-about-firewalld)了解更多关于防火墙的信息
...
# [](#wanna-create-a-secondary-sysadmin-user-sudoer-guy)想创建一个二级系统管理员用户吗？(苏多尔盖伊)
...
# [](#disable-a-user-login-email-or-ftp-accounts-maybe)禁用用户登录(也许是邮箱或 FTP 账号)

1-编辑`/etc/passwd`

2-将外壳更改为`/bin/nologin`

# [](#learn-more-about-configuring-ftp-server)了解有关配置 FTP 服务器的更多信息:
...
# [](#hey-server-keep-everything-in-mind-even-clean-your-mind)嘿服务器！把一切都记在心里；甚至“清洁你的心灵”
...
# [](#how-to-install-mysql)如何安装 MySQL
...
# [](#bind-dns-domain-name-server-the-magic-behind-mycustomcomputernamecom)绑定 DNS(域名服务器:mycustomcomputername.com 背后的魔法)
