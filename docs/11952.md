...
> 原文:[https://dev.to/aman_singh/hidden-gems-of-debugging-1f11](https://dev.to/aman_singh/hidden-gems-of-debugging-1f11)
...
### [](#1-using-shorthand-object-property-value-notation-in-consolelog)1。在 console.log 中使用速记对象属性值表示法
...
### [](#2-no-more-wrapping-of-curly-braces-for-fat-arrow-functions)2。胖[箭头](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions)函数不再需要花括号
...
### [](#3-add-logpointsless-sprinkling-of-consolelog-in-your-code)3。添加日志点——减少代码中 console.log 的使用
...
[![alt text](../Images/eefa37356c409f09b6d09cfe41624d65.png "add log points")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cCydX6KU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/274an9y5c9uerghyf4lh.gif)

> **额外好处**:您还可以使用条件断点特性，在条件评估为真时插入一个断点。

### [](#4-store-and-copying)4。存储和复制
...
[![alt text](../Images/224c1f1d11e7ec0fe4eb29d7a3a612ed.png "store as a global variable and then use copy command")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aR5ch39I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xqd3qfehpjqshlv85rh0.gif)

> **附加功能**:您可以使用“Ctrl + f”在预览部分的整个响应对象中搜索特定的字符串匹配。

### [](#5-the-breakpoint-for-your-network-requests)5。网络请求的断点
...
[![alt text](../Images/69133886d106792800cb76e0ac8dc03a.png "fetch breakpoint")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FIc25YeQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fc5d8mw10m9keudxtvsm.gif)

### [](#6-copying-your-request-as-curl)6。将您的请求复制为 cURL
...
[![alt text](../Images/4e3e6eaf4cf8e7454d54660bd03e3d9e.png "copy as cURL")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qtH4Wfm4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jl54fll4xn5jya2yjw5e.gif)

### [](#7-dont-let-go-off-your-css-changespersist-styling-when-refreshing)7。不要放弃你的 CSS 改变——刷新时保持样式
