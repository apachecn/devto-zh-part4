...
> 原文:[https://dev . to/Christopher kade/adding-international ization-to-your-nuxt-js-applications-39jd](https://dev.to/christopherkade/adding-internationalization-to-your-nuxt-js-applications-39jd)
...
### [](#step-1-installing-raw-vuei18n-endraw-and-setting-it-up)第一步:安装`vue-i18n`并设置好
...
### [](#step-2-changing-our-locale-on-the-fly)第二步:动态改变我们的语言环境
...
### [](#step-3-wait-theres-no-step-3)第三步:等等，没有第三步？
