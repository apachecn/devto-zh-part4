...
> 原文:[https://dev . to/rafaelcpalmeida/enhancing-your-git-commit-messages-3mk 7](https://dev.to/rafaelcpalmeida/enhancing-your-git-commit-messages-3mk7)
...
# [](#apply-your-changes-globally)全局应用您的更改
