...
> 原文:[https://dev . to/xeraa/combining-date-and-date nanos-in-elastic search-and-ki Bana-27o 6](https://dev.to/xeraa/combining-date-and-datenanos-in-elasticsearch-and-kibana-27o6)
...
## [](#combining-raw-date-endraw-and-raw-datenanos-endraw-in-elasticsearch)结合`date`和`date_nanos`进行弹性搜索
...
## [](#does-this-work-for-kibana)这对基巴纳有用吗？
