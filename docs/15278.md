...
> 原文:[https://dev . to/app signal/building-the-go-game-in-elixir-time-travel and-the-ko-rule-4pei](https://dev.to/appsignal/building-the-go-game-in-elixir-time-travel-and-the-ko-rule-4pei)
...
## [](#time-travel-preparations)时间旅行准备工作
...
## [](#branching-off-in-history)历史上的分支
...
## [](#disabling-inapplicable-undo-and-redo-buttons)禁用不适用的撤销和重做按钮
...
## [](#time-travel-and-the-ko-rule)时间旅行和 ko 法则
