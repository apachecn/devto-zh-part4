...
> 原文:[https://dev.to/pmalhaire/an-haskell-trip-part-2-kii](https://dev.to/pmalhaire/an-haskell-trip-part-2-kii)
...
## [](#lets-enter-the-haskell-world)让我们进入哈斯克尔的世界
...
## [](#meet-the-haskell-syntax)满足 haskell 语法
...
### [](#meet-raw-endraw-using-raw-type-endraw-)遇见`::`利用`:type`
...
### [](#meet-raw-gt-endraw-arrow-using-raw-type-endraw-)遇见`->`(箭头)利用`:type`
...
### [](#meet-the-raw-gt-endraw-double-arrow-using-raw-info-endraw-)遇到`=>`双箭头使用`:info`
...
## [](#interlude-the-smell-of-lisp)【插曲】口齿不清的味道
