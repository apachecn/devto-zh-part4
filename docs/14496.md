...
> 原文:[https://dev . to/kristjank/an-简介-区块链-应用-开发-部分-1-2-462a](https://dev.to/kristjank/an-introduction-to-blockchain-application-development-part-1-2-462a)
...
# [](#bootstrapping-the-development-environment-setup)引导开发环境设置
...
[![steps.png](../Images/fe6d29db4c379613b15220d10d9add76.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--slSg10Vi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1562652496863/ZDPYJGcrh.png)
...
# [](#distributed-blockchain-applications-in%C2%A0general)分布式区块链的一般应用
...
[![Screenshot 2019-07-09 at 08.49.50.png](../Images/2fa67db3a958b856d781a207af4392af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_DOi-mkk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1562655104655/OWAu2mmop.png)
...
[![ark-logic.png](../Images/93c11a060d29915b013af6db54bbcb39.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iVjJgZIA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1562652809298/2v8okqJW0.png)
...
# [](#ark-logic-best-practices)方舟逻辑:最佳实践
...
## [](#interacting-with-the-blockchain-state)与区块链为伍的状态
...
## [](#interacting-with-the%C2%A0database)与数据库交互
...
## [](#use-events-to-listen-and-react-to%C2%A0changes)利用事件倾听变化并做出反应
...
## [](#add-new-api-endpoints-via-customizable-http-server-running-within-core%C2%A0nodes)通过运行在核心节点内的可定制 HTTP 服务器添加新的 API 端点
...
## [](#pack-and-distribute-your-blockchain-application-as-a%C2%A0module)将您的区块链应用程序打包并作为一个模块分发
...
## [](#next-steps-part%C2%A022)下一步:第 2/2 部分
