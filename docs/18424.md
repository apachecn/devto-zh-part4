...
> 原文:[https://dev . to/hadrysmateusz/how-to-use-multiple-versions-of-node-on-windows-1op 9](https://dev.to/hadrysmateusz/how-to-use-multiple-versions-of-node-on-windows-1op9)
...
### [](#nvmwindows-to-the-rescue)nvm-windows 来救援了！

这是一个功能齐全的 Windows 命令行节点版本管理器。它甚至附带了一个简单的 gui 安装程序，这很棒。

[![](../Images/945e4815b1ede4e339f6d91ad464a98e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E0CEL3__--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4sz0wkre3qvb9efqihct.png)

### [](#here-are-the-steps-to-getting-up-and-running-with-nvmwindows)以下是启动和运行 nvm-windows 的步骤
...
### [](#other-articles-you-might-enjoy)你可能喜欢的其他文章

[![hadrysmateusz](../Images/6b90ff502ec0d1282d9167c02f7ff173.png)](/hadrysmateusz) [## 在 JavaScript 中获取字符串中所有字符的 4 种方法

### 马太福音 17 章 20 节 2 分钟

#javascript #webdev #beginners #programming](/hadrysmateusz/how-to-get-all-characters-in-a-string-57c7)[![hadrysmateusz](../Images/6b90ff502ec0d1282d9167c02f7ff173.png)](/hadrysmateusz) [## 使用现代 CSS 的漂亮的自定义列表样式
