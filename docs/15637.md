...
> 原文:[https://dev.to/wchr/why-you-should-learn-next-js-5952](https://dev.to/wchr/why-you-should-learn-next-js-5952)

下一个。JS 是一个 javascript 框架，允许开发人员创建服务器渲染的 react web 应用程序，还附带其他好处，使前端开发变得快速。

## [](#how-i-encountered-nextjs)我如何遭遇下一个。JS？
...
*   在创建自己的 express 服务器时，我遇到了`Babel`和`webpack`版本不一致的问题。这花了我很长时间，我一遍又一遍地删除了`yarn.lock`文件和 node_modules，我也尝试了`npm`的建议，但什么也没有。
    ...
    [![bummer](../Images/fb716ced7380bb72eff8f4087f786900.png)T2】](https://i.giphy.com/media/l0MYv7rC7HeZeuuWI/giphy.gif)

*   当使用`prerender`和`react-snap`时，它在我的笔记本电脑上运行得很好，但在我的`Netlify`版本中一直失败。

    [![bummer](../Images/389d6b9a5e09e928a2e28edf5f3e681b.png)T2】](https://i.giphy.com/media/40OlZsaF8UheU/giphy.gif)
...
[![eureka](../Images/580855da9b5263493ac208d05ad85138.png)T2】](https://i.giphy.com/media/5z0cCCGooBQUtejM4v/giphy.gif)

## [](#advantages-of-using-next)使用 Next 的优点

*   开箱即用的服务器端渲染以这样一种简单的方式处理 SSR。安装，运行你的应用，打开你的浏览器，你就有了 SSR。SSR 的一些优势有*丰富的链接预览*。

[![Screenshot 2019-07-02 at 8.55.49 PM.png](../Images/90dd078264d50394610edcb833623d76.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WrNpvHxw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1562090212454/TTQQ8yKTP.png)
