...
> 原文:[https://dev . to/yazeedb/deep-understand-currying-in-7-minutes-1 ago](https://dev.to/yazeedb/deeply-understand-currying-in-7-minutes-1ago)
...
[![](../Images/b2f3aa4305cc351bd2bf136669960a0e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--84hvrKuK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7np833ublebvdsj38rcv.jpeg)
...
[![that-code-is-hard-to-read-cmm](../Images/d499b36fec8178cf9e60f15fd7cbbe01.png)T2】](/news/content/images/2019/07/that-code-is-hard-to-read-cmm.jpeg)

是的，我知道...简洁得令人难以置信，让我们一起重构欣赏吧。

## [](#this-version-works-the-same)此版本工作原理相同
...
### [](#pause-on-line-2)第二行暂停

[![](../Images/23ace7e2bf34a9838ecc80341558fb4e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7mE-aVEO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A8_q3YkOu6fDzIEMY65lqUg.png)
...
### [](#pause-on-line-4)第 4 行暂停

[![](../Images/01d74c5b2253bf0db3ddb3a716b07dc0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2uahYaHr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AFXCJQi5Numlbis5d_bGsjw.png)

在继续之前，在您的控制台中键入`originalFunction`和`initialParams`。注意，即使我们在一个全新的函数中，我们仍然可以访问这两个参数。这是因为从父函数返回的函数享有其父函数的作用域。

#### [](#reallife-inheritance)现实生活中的传承
...
### [](#ok-back-to-line-4)好了，回到第 4 行…

[![](../Images/d3d2dafca92de53e022f232c41d819ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nXMa9H-u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A_TFVnxtqgisi1i0q_K3dUQ.png)
...
### [](#line-6-now-but-hold-on)现在 6 号线，但是坚持住。
...
[![](../Images/8b51f371f1d27ee8911a2c90e49dbfa8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z16kY5Z0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ApM31i2QVNxVUiqj9aZzVvg.png)
...
### [](#so-what-happens%C2%A0next)那么接下来会发生什么呢？
...
[![](../Images/1923ca3027421949f2035ad797f4ab6c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XPFrM4NO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AAZKiupYSanV5iJSQWrtUwg.png)
...
[![](../Images/4227f3c6bce3d78a104c4596731d58d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eOryZMAx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Apej6yZ-vGvA2T9LgIIc-vg.png)

### [](#why-why%C2%A0why)为什么，为什么，为什么？

因为记住，第 12 行说“嘿`curriedFunction`，他上次给了我`'Hello'`，这次给了我`‘John’`。把它们都放在这个数组里`[...initialParams, ...nextParams]`。

[![](../Images/4618c290e88f536ef039ff4ad4fe2ca6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xM0llzyO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ALjvk2BMLxIsbJ09idgStdg.png)
...
[![](../Images/2c2b066f7658cde92c713a6254555b9c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t6mLX4L3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AEYv9jdo2id8tynbTI5SXYQ.png)
...
[![](../Images/18c1f389c6b4f49959f0c602fb648433.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--WnjqsQxz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AtMJvls2j9eAjrCGykVN84g.png)[![](../Images/35cf39e100ccfa9a1426231a4460c3db.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--gmX4RZ5s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ANHm1TMo8Tjk7jQVlGGa9zQ.png)[![](../Images/9fc97e2d843703955e7e049bff675e61.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--q6fKgpCw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AeTwjEYLKGCGJoqdP4Xe9hA.png)

## [](#the-deed-is-done)大功告成
