...
> 原文:[https://dev . to/rx assim/testing-react-setup-unit-integration-and-e2e-using-jest-and-cypress-feat-graph QL-4fj 7](https://dev.to/rxassim/testing-react-setup-unit-integration-and-e2e-using-jest-and-cypress-feat-graphql-4fj7)
...
## [](#install-jest-cypress-and-helper-libraries)安装 jest、cypress 和 helper 库
