...
> 原文:[https://dev . to/daudr/write-your-first-transaction-on-the-Libra-network-5f5e](https://dev.to/daudr/write-your-first-transaction-on-the-libra-network-5f5e)
...
[![Libra logo](../Images/0c567f3e957ebbda3fc3281d1283a871.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--viRkyY2u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mw029rhi99hu6fh1dpcs.png)

> 天秤座标志

## [](#installing-the-testnet-locally)本地安装测试网
...
## [](#clone-the-libra-core-github-repository)克隆 Libra 核心 GitHub 库
...
## [](#build-libra-cli-client-and-connect-to-the%C2%A0testnet)构建 Libra CLI 客户端并连接到 Testnet
...
## [](#create-new-accounts)创建新账户

一旦您的客户端连接到`testnet`，您就可以运行 CLI 命令来创建新帐户。我将指导您为两个用户创建帐户。

### [](#step-1-check-if-the-client-is-running)第一步:检查客户端是否正在运行
...
### [](#step-2-create-the-first-account)第二步:创建第一个账户
...
### [](#step-3-create-the-second-account)第三步:创建第二个账户

要创建第二个帐户，请重复帐户创建命令:

`libra% account create`

### [](#optional-step-4-list-accounts)【可选】第四步:列出账户
...
## [](#add-libra-coins-to-the-accounts)向账户中添加天秤座币
...
### [](#step-1-add-libra-coins-to-the-accounts)第一步:将天秤座币加入账户
...
### [](#step-3-check-an-accounts-balance)第三步:查看账户余额
...
## [](#query-sequence-number-after-transfer)查询转账后的序号
...
## [](#check-the-accounts-balance-after-the-transfer)转账后查看账户余额
