...
> 原文:[https://dev . to/gvinod 1991/CSS-selectors-and-it-s-specificity-priority-to-override-other-1kij](https://dev.to/gvinod1991/css-selectors-and-it-s-specificity-priority-to-override-other-1kij)

## [](#whats-the-problem-when-a-developer-didnt-understand-selectors-clearly)一个开发人员没搞清楚选择器是什么问题？
...
## [](#type-selectorby-tag-name)类型选择器(按标签名)
...
## [](#attribute-selectorattribute)属性选择器(【属性】)
...
## [](#combinator-selectors-gtspace-and-)组合子选择器(+、>、空格和~)

我们可以用+、>空格和~来组合两个元素，以标识两个组合元素的相对元素

### [](#descendant-selectorspace)(空格)后代选择器
...
### [](#adjacent-sibling-selector)相邻同胞选择器(+)
...
## [](#selector-specificitypriority-to-override-other)选择器特异性(优先于其他)
