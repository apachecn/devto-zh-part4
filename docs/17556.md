...
> 原文:[https://dev . to/angular/7-从 angularjs-to-angular-5hk6](https://dev.to/angular/7-mistakes-to-avoid-when-moving-from-angularjs-to-angular-5hk6)
...
## [](#1-not-knowing-how-to-google-for-angular)1。不知道如何搜索 Angular
...
## [](#2-not-installing-amp-using-the-angular-cli)2。不使用 Angular CLI 安装&
...
[![Bane quote moulded by webpack](../Images/a00751ed12bca2a279a79467995ae8a5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bY9zZAfd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/abepiy49sa4x25y3mezn.jpg)
...
## [](#3-not-taking-the-time-to-learn-typescript-fundamentals)3。没有花时间学习 TypeScript 基础知识
...
## [](#4-getting-trolled-by-syntax-changes)4。受到语法变化的影响
...
## [](#5-not-learning-the-basics-of-rxjs)5。没有学习 RxJS 的基础知识
...
### [](#making-an-http-request)发出 HTTP 请求
...
## [](#6-not-realizing-the-nuances-of-dependency-injection-with-services)6。没有意识到服务依赖注入的细微差别
...
## [](#7-not-understanding-change-detection)7。不了解变更检测

[![$scope.$watch all the things](../Images/3bbca50d1b269dcb0327507e4a7f6172.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fIc7EADD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tup2f1gbd80xy286bx0m.jpg)
