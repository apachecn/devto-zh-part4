...
> 原文:[https://dev . to/adriansandu/8-edition-of-js13k games-native-lazy-loading-and-github-actions-with-ci-CD-front-end-news-13-4 nki](https://dev.to/adriansandu/8th-edition-of-js13kgames-native-lazy-loading-and-github-actions-with-ci-cd-front-end-news-13-4nki)

<figure>[![](../Images/1b9f95bb1128b6e0cd064135d3ccb300.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--mrl3t5oa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AaxgIfPhA-RupmWRPWmqZaw.png) 
...
### [](#eighth-annual-js13kgames-challenge)第八届年度 js13k 运动会挑战赛

Js13kGames 是面向 HTML5 游戏开发者的 JavaScript 编码竞赛，第八版即将推出。顾名思义，挑战在于仅使用 web 技术创建一个功能游戏，其中压缩在`.zip`档案中的最终代码占用不到 13kB 的空间。

[![](../Images/bdac4038f48e137e2e1404bb16a21df9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ramB5-7n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AQw2JYb4auszkGNMjlTjT-g.png)
...
### [](#native-lazyloading-for-the-web)面向 web 的原生惰性加载
...
### [](#github-actions-now-supports-cicd)GitHub 动作现在支持 CI/CD
...
### [](#codepen-offers-new-build-process-for-exported-pens)CodePen 为导出的笔提供了新的构建流程
...
[![](../Images/90c52552cf6add77f15657adecb1d8df.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wexc0yFp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AXuqg_6U3s_AiD787nQsGGg.jpeg)
