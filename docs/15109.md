...
> 原文:[https://dev . to/azure/going-full-reactive-with-spring-web flux-and-the-new-cosmosdb-API-v3-1n2a](https://dev.to/azure/going-full-reactive-with-spring-webflux-and-the-new-cosmosdb-api-v3-1n2a)

## [](#going-full-reactive)去满无功？
...
### [](#cosmosdb-configuration-and-connection)CosmosDB 配置和连接
...
### [](#creating-finding-and-deleting-an-item)创建、查找和删除项目
...
### [](#running-with-100-users)运行 100 个用户

我们的第一个测试有 100 个用户，正如预期的那样，一切都运行得很好，因为没有太多的并发请求:

[![](../Images/8bf70215bef44f4a5e813fbb257e47bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kvWMdbAu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pil647rechfszf4g6qgy.png)
...
[![](../Images/2b3a5384d4fae7ff0aaf3e8bf421b462.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Rg4wuHmG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ol3xx4524lt4tcktfbwr.png)
...
[![](../Images/e80b040b2a0bad941f9babec1b265244.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dxCbYBHk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k2uj7dgzqqy7mpxm4dm4.png)
...
[![](../Images/49dcfd97d4f126f1bb5d64f0c2ac3aaf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--azi4XyJN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zbukn4b3r7uwggmnnwnm.png)

另请注意，我们的第 99 百分位性能非常出色，我们可以在一分钟内轻松扩展到 1，000 个请求/秒，图表非常清晰:

[![](../Images/7df6f7a855b62f39860ce8f81da2976d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1FiTAMtP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/42iktgwydenn48pb8roh.png)
...
[![](../Images/73a78b81149188eb3976d4c300b809af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qnUN4paP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3gkg33i2tcg6gjte2a0n.png)

此外，我们的 CPU 使用率极低，线程数稳定，内存低且稳定:

[![](../Images/23e523825cbff6f60179792cec4b6e3e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KXTT7X9f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ta27kg4a2eiaucfk86rz.png)
