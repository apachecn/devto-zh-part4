...
> 原文:[https://dev . to/Martins Stewart/what-is-elm-and-a-game-I-m-making-with-it-3d i1](https://dev.to/martinsstewart/what-is-elm-and-a-game-i-m-making-with-it-3di1)
...
[![The game I'm working on](../Images/00963a7e3ab6e0206f9c282a8f70015c.png)T2】](https://i.giphy.com/media/JRJcPCvE9hpbPH26uF/giphy.gif)
...
### [](#no-crashes-in-production-thats-not-hard-just-put-a-trycatch-around-the-whole-application)生产中没有死机？这并不难，只需围绕整个应用程序进行尝试即可！
...
[![I pasted the example code into my game to get this error. That's why the line numbers start at 400.](../Images/215195ee128e5ebd9fbb482172f7669a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mfUZ6Bus--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/K2KrxkD.png)
...
### [](#what-is-a-functional-language)什么是函数式语言？
...
### [](#static-typing-more-like-excessive-typing)静态打字？更像是，过度打字！
...
### [](#the-elm-architecture-tea)榆树建筑(茶)

[![The Elm Architecture](../Images/704225a8e4ccb199ac4b661ad70ee250.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UTW6U6og--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dennisreimann.de/files/elm/architecture-overview-diagram.svg)
