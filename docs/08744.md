...
> 原文:[https://dev.to/huijing/sub-pixel-rendering-and-borders-4bhk](https://dev.to/huijing/sub-pixel-rendering-and-borders-4bhk)

我非常高兴能够在就职演讲上发言。CSS 最近在墨尔本，在活动结束后，我和一位与会者就不同浏览器之间的细边框的亚像素渲染问题进行了一次愉快的聊天。

<figcaption>非官方新加坡 CSS 吉祥物亮相</figcaption>

[![Giving talk on layout at inaugural Talk.CSS in Melbourne](../Images/ff9713031313bfa05325286e876efd3b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UUYMEnEU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/sub-pixel/melcss-1280.jpg)

在我的演讲中，我非常简要地谈到了亚像素渲染的主题，同时也谈到了边距折叠。如果你有一个完全空的盒子，它沿着方块方向的边距会互相折叠。

## [](#computed-padding-values)计算出的填充值
...
[![Difference between rendering padding of 0.0083333323709666669px and 0.0083333323709666668px in Firefox](../Images/7cea8188b8a7ff2a9507e16fc29e2525.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--s2bHeger--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/sub-pixel/firefox-1280.png)

至于 Chrome 和 Safari，似乎盒子模型图与我们在浏览器中看到的不一致，并且显示的计算值也有问题。

<figcaption>Chrome 的盒子模型图貌似很混乱</figcaption>

[![Difference between rendering padding of 0.015624999534338711824899004199096452794037759304046px and 0.015624999534338711824899004199096452794037759304047px in Chrome](../Images/6bd494511524435c52d8d39ca397ae21.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3dVZ4gJc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/sub-pixel/chrome-1280.png)

<figcaption>Safari 的计算值似乎有些四舍五入</figcaption>

[![Difference between rendering padding of 0.015624999534338711824899004199096452794037759304046px and 0.015624999534338711824899004199096452794037759304047px in Safari](../Images/7c554f14619b0e22980f43cd869fe48a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NV38Rmm---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/sub-pixel/safari-1280.png)

## [](#on-floating-point-numbers)浮点数
...
## [](#on-the-rendering-of-borders)在渲染的边框上
