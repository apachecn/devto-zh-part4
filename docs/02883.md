...
> 原文:[https://dev . to/clarity 89/the-most-common-errors-when-using-react-45 H2](https://dev.to/clarity89/the-most-common-mistakes-when-using-react-45h2)
...
#### [](#1-directly-modifying%C2%A0the-state)1。直接修改状态
...
#### [](#2-setting-wrong-value-types-on-the-initial-state)2。在初始状态下设置错误的值类型
...
#### [](#3-forgetting-that-raw-setstate-endraw-%C2%A0is-asynchronous)3。忘记了`setState`是异步的
...
#### [](#4-incorrectly-relying-on-the-current-state-value-for-calculating-the-next-state)4。错误地依赖当前状态值来计算下一个状态
...
#### [](#5-omitting-dependency-array-for%C2%A0-raw-useeffect-endraw-)5。省略`useEffect`的依赖数组
