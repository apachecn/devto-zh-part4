...
> 原文:[https://dev . to/seangwright/kentico-12-design-patterns-part-7-integrating-we B- API-2-4 ldg](https://dev.to/seangwright/kentico-12-design-patterns-part-7-integrating-web-api-2-4ldg)

<figure>

[![](../Images/2bb8e39b20c71bf8706abcd248f602b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y_WMxk-w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dcl0raddowtu0vncahpz.jpg)
...
[![](../Images/a711b0ff4d95bd76c70a03038a2b2126.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Oi7QeGF9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zfori7krbnynsj7x9rr6.png)
...
### [](#custom-exception-types)自定义异常类型
...
### [](#centrally-stored-serialization-configuration)集中存储序列化配置
...
### [](#serialization-and-database-date-precision)序列化和数据库日期精度
...
## [](#define-your-api-contracts)定义您的 API 合同
...
### [](#request-validation-%E2%98%91)请求验证☑
...
## [](#crosscutting-concerns-via-aspect-oriented-programming-aop)通过面向方面编程(AOP)横切关注点
...
## [](#understand-owin-vs-aspnet-pipelines)了解 ASP.NET vs OWIN 管道
