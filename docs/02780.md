...
## [](#entendendo-a-estrutura-do-projeto-mean)了解项目结构意思
...
## [](#o-que-%C3%A9-azure-functions-%EF%B8%8F)O que é Azure 函数？！⚡️
...
## [](#templates-importantes-no-azure-functions)模板重要无 Azure 功能
...
## [](#instalando-o-pacote-azure-functions-core-tools)Instalando o pacote Azure 功能核心工具
...
## [](#criando-uma-nova-aplica%C3%A7%C3%A3o-no-azure-functions)创建蓝色函数的新应用
...
## [](#criando-a-conex%C3%A3o-com-o-mongodb)建立与蒙戈布的连接
...
## [](#criando-a-fun%C3%A7%C3%A3o-createfuncionario)创建‘create official’功能
...
## [](#criando-a-fun%C3%A7%C3%A3o-getfuncionarios)创建‘get officers’功能
...
## [](#criando-a-fun%C3%A7%C3%A3o-updatefuncionario)创建角色:'更新官员'
...
## [](#criando-a-fun%C3%A7%C3%A3o-deletefuncionario)创建角色:【删除工作人员】
