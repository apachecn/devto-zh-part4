...
> 原文:[https://dev . to/Jay _ js/setting-up-flutter-without-Android-studio-olo](https://dev.to/jay_js/setting-up-flutter-without-android-studio-olo)
...
# [](#setting-up-android-environment)设置 Android 环境
...
# [](#setting-up-flutter-config)设置颤振配置
