...
> 原文:[https://dev . to/deep u105/static-site-generators-down-how-I-set-up-my-own-blog-with-Jekyll-2 ic5](https://dev.to/deepu105/static-site-generators-rundown-how-i-set-up-my-own-blog-with-jekyll-2ic5)
...
[![deepu105](../Images/50afb42a32b9b5d6684585aa01f2857b.png)](/deepu105) [## 为什么我要离开媒体
...
## [](#the-options-rundown)选项纲要

带着这些想法，我开始评估下面一些流行的选项。

### [](#jekyll)[杰基尔](https://jekyllrb.com/)
...
### [](#vuepress)[武库](https://vuepress.vuejs.org/)
...
### [](#gatsby)[盖茨比](https://www.gatsbyjs.org)
...
### [](#wordpress)[文字出版社](https://wordpress.org/)
...
## [](#building-a-personal-website-and-blog-with-jekyll)用 Jekyll 建立个人网站和博客
...
### [](#adding-custom-liquid-tags)添加自定义液体标签
