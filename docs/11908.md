...
> 原文:[https://dev . to/orkon/how-to-add-native-code-to-a-flutter-app-using-platform-views-on-Android-4j8a](https://dev.to/orkon/how-to-add-native-code-to-a-flutter-app-using-platform-views-on-android-4j8a)
...
## [](#step-3-register-native-code)第三步。注册本机代码
