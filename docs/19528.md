...
> 原文:[https://dev . to/ATA pas/meta programming-an-introduction-to-JavaScript-es6-proxy-4p FH](https://dev.to/atapas/metaprogramming-an-introduction-to-javascript-es6-proxy-4pfh)
...
[![magic.gif](../Images/d79cd78131f1d16bd5a3c44693c0e922.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--HuxU9DhR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1559815386583/RGcMHgRZZ.gif) 
*图片提供:吉菲*
...
### [](#proxy-for-validation-of-values)用于验证值的代理
