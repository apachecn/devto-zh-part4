...
> 原文:[https://dev . to/m4rcoperuano/react-native-best-practices-when-using-flat list-or-section list-4j 41](https://dev.to/m4rcoperuano/react-native-best-practices-when-using-flatlist-or-sectionlist-4j41)
...
## [](#section-list-example)章节列表示例

[![Alt Text](img/9aa6a6dd3a6bc7a60bd6b929ca4b4c2d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2aSbQcXe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bpfrrwuna192gjre5aub.png)
...
[![Alt Text](img/eff7008f97938372c00e66bf76555af0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AYb2whOE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9mtvbm9xi57dtr1e9pig.png)
...
#### [](#i-stop-doing-calculations-in-your-sectionlistflatlist-header-or-row-components)I .停止在您的 SectionList/FlatList 表头或行组件中进行计算。
...
#### [](#ii-make-your-sectionlists-header-and-row-components-really-simple)二世。让你的节列表的标题和行组件非常简单。
...
#### [](#iii-make-use-of-pure-components)三世。利用纯组件
