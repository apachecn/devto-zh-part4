...
> 原文:[https://dev . to/bnevilleoneill/the-history-and-legacy-of-jquery-7d 8](https://dev.to/bnevilleoneill/the-history-and-legacy-of-jquery-7d8)
...
## [](#changing-circumstances)变化多端的环境
...
## [](#when-to-use-jquery)何时使用 jQuery
