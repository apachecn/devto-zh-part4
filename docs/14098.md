...
> 原文:[https://dev . to/letmypeoplecode/JavaScript-selection-sort-1411](https://dev.to/letmypeoplecode/javascript-selection-sort-1411)

昨晚我玩 JavaScript 冒泡排序玩得很开心，今晚我挑战自己去理解并编写一个选择排序。

## [](#what-is-a-selection-sort)什么是选择排序？
