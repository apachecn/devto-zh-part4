...
> 原文:[https://dev . to/lampewebdev/top-7-essential-SEO-optimizations-for-you-to-learn-in-2019-15 i5](https://dev.to/lampewebdev/top-7-essential-seo-optimizations-for-you-to-learn-in-2019-15i5)
...
### [](#make-images-readable-by-search-engines)💡让图像可以被搜索引擎读取
...
#### [](#how-to-write-a-good-title-for-your-page)如何为你的页面写好标题？
...
#### [](#good-examples-for-titles)封号的好例子
...
### [](#declare-the-correct-language-in-the-html-tag)💡在 HTML 标签中声明正确的语言
...
### [](#use-raw-nofollow-endraw-in-anchor-tags)💡在锚点标签中使用`nofollow`
...
### [](#use-raw-relcanonical-endraw-)💡使用`rel="canonical"`
...
### [](#add-the-viewport-metatag-in-the-header)💡在标题中添加视口元标记
