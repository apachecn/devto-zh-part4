...
> 原文:[https://dev . to/bnevilleoneill/3-rules-for-writing-idiomatic-typescript-39p 0](https://dev.to/bnevilleoneill/3-rules-for-writing-idiomatic-typescript-39p0)
...
## [](#1-dont-neglect-interfaces)1。不要忽视接口
...
## [](#2-stop-abusing-raw-any-endraw-)2。停止滥用`any`
...
## [](#3-remember-index-signatures)3。记住索引签名
