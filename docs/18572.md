...
> 原文:[https://dev . to/Silvio buss/resilience-for-Java-micro services-带 resilience 的断路器 4j-5c81](https://dev.to/silviobuss/resilience-for-java-microservices-circuit-breaker-with-resilience4j-5c81)

# [](#what-is-circuit-breaker-pattern)什么是断路器模式？

阅读第一篇文章来理解这个概念。

[![silviobuss](../Images/f8087747d0b6d8dcae125b2c80a852dc.png)](/silviobuss) [## Java 微服务的弹性模式。断路器。
...
## [](#prometheus-and-grafana)普罗米修斯和格拉夫纳
...
## [](#implementation-with-spring-boot-2-resilience4j-prometheus-grafana)用 Spring Boot 2 + Resilience4j +普罗米修斯+格拉法纳实现
...
[![config file](../Images/57b18b8397e51673fe1bdbc231913ef2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EHw0HPuX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7i9sebgxq0ja5zolk3yc.png)

*   这是断路器的保护方法

[![connector_class](../Images/31f7f1b7e22981ee913597d82b480f2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ip1fhQLZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mvf5ai0q07u8dvh73mou.png)

*   使用项目端点来模拟成功。

    *   [http://localhost:9080/backendA/success](http://localhost:9080/backendA/success)

[![success_endpoint](../Images/96902f795860569031aebe8f4d433c7a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2d91Lopx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eko9u5rnf8o2p9jh0l3c.png)

*   以及用于模拟故障。

    *   [http://localhost:9080/backendA/failure](http://localhost:9080/backendA/failure)

[![failure_remote](../Images/8c34e750feb5bf60dd35548059cd6d35.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uyFJo4dI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/axhaj5ietcqcb0o1mipl.png)

*   为了模拟打开状态，调用失败端点，直到它达到设置中使用的 5 次尝试的阈值。

[![focus_config_5](../Images/cc3e23cee36dd88fae3b4eb66edafcfd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vt7bV3VY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k40ui15qqcibv7h53vpk.png)

*   当状态为打开时，将不会执行远程调用(backendA connector . class # failure ),并且对断路器的所有进一步调用将返回错误“断路器‘backendA’打开...”。

*   我们可以通过 grafana 仪表盘看到生成的状态和指标:

[![grafana](../Images/0aefa34b156977614c304e607df3a4bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8FsMhdq3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z2o1cmhbb6nylpaxkp3l.png)

## [](#source-code)源代码

## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png) [西尔维奥巴斯](https://github.com/silviobuss)/[resilience 4j-spring-boot 2-demo](https://github.com/silviobuss/resilience4j-spring-boot2-demo)
...
[![Build Status](../Images/dc8c38c1693dbe4d50a9e0505b2db785.png)T2】](https://travis-ci.org/resilience4j/resilience4j-spring-boot2-demo)
