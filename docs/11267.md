...
> 原文:[https://dev . to/shakib 609/deploy-your-django-react-js-app-to-heroku-2 bck](https://dev.to/shakib609/deploy-your-django-react-js-app-to-heroku-2bck)
...
# [](#generating-react-app)生成 React App
...
# [](#create-python-virtualenv)创建 Python 虚拟人
...
# [](#generate-django-app)生成 Django App
...
[![Django + React app preview](../Images/787eeb93f85db5d1ead711ac057fb04e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wtbMr-9n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v1rv8b4h9kpfg39lty5h.png) 。

# [](#preparing-for-heroku-deployment)为 Heroku 部署做准备
