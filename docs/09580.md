...
> 原文:[https://dev . to/elastic crash/angular-display-a-warning-and-prevent-navigation-when-model-is-dirty-29 E0](https://dev.to/elasticrash/angular-display-a-warning-and-prevent-navigation-when-model-is-dirty-29e0)
