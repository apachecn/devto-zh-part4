...
> 原文：<https://dev.to/olivier32621338/how-to-manage-your-product-backlog-1p2k>
...
产品所有者可能要考虑的一个选项是 [Quire](https://quire.io) ，这是一个[在线项目管理软件工具](https://quire.io/compare/best-project-management-software-reviews-comparisons)，具有任务和子任务跟踪以及看板功能，可以与敏捷团队保持同步，同时保持对产品所有者如何设计即将推出的功能和产品增强功能的不感兴趣。Quire 的人联系我，让我看一下他们的产品，他们可能已经想出了一个解决方案，可以为产品所有者创建和维护他们团队的 backlog。

## 什么是产品积压，你如何管理它？

产品 backlog 是潜在故事的集合，这些故事描述了一个团队最终可能开发的特性，每个特性都为客户增加了价值。在 scrum 和看板中，故事是离散的垂直切片的终端用户功能块，它们是独立的、可协商的、有价值的、可估计的、小的和可测试的。

这与瀑布式组织有很大的不同，在瀑布式组织中，每一块工作都可能是一个更大的计划中经过深思熟虑的任务，最终应该为客户增加价值。甘特图任务通常表现为产品需求文档中顺序的、相互依赖的构件，产品需求文档由详细的甘特图或类似的图表表示。

敏捷团队不会默认甘特图或详细的预先计划。在团队坐下来与产品负责人一起整理之前，敏捷故事通常没有典型的甘特图任务详细，由增加价值的客户目标驱动，并且为了清晰起见，验收标准以可读的小黄瓜语法编写。一个未公开的潜在故事应该创造一个与团队其他成员讨论应该开发什么以及如何开发的机会。
...
什么信息应该进入产品待办事项列表？在一个敏捷的组织中，故事代表了整个产品为客户增加价值的可能方向，而不是有中间期限的固定需求，这些需求可能会也可能不会受到它们所交付的内在价值的驱动。Quire 允许产品所有者尽可能深入地维护潜在变更和特性的列表，在各种准备状态下，有或没有文档，在将它们提交给团队进行整理和开发之前，适当地重新组织和调整它们。Quire 调用这些任务，这是一个有用的命名约定，因为它们可能会或可能不会成为真实的故事，直到团队培训和接受它们并开始处理它们。
...
[![Quire Features](img/74b4dd2cba42a5f6da1815c42058cbef.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BxdxHmum--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/huc309nca5iyxct4v51s.png)

…微小的错误修复，可选地包括子任务…

[![project management software](img/492da8dd4e4b4fbac1b83e10e9e6c5de.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--03kr4_yA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o6dngb3blhv4m3kdy2dy.png)

…或者它们可以是充满幻想的单行愿望，由潜在的子任务和子子任务组成，甚至是那些在技术上不可能实现的任务。

[![Quire](img/4505e9aa70510fbabc2a183fb6af850e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--uj-0PF0t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/07k476o1g5b18pxz6sw6.png)
...
像 Quire 这样的工具，位于传统的[敏捷](https://quire.io)故事板工具之外，对于维护产品积压的隐私非常有用。没有必要为那些可能永远不会被开发的特性的描述设置特殊的权限，这样团队就不会分心。这使得产品所有者可以避免因未来可能的变更而污染正在进行的工作。因为产品 backlog 是用一个单独的工具管理的，所以只有产品所有者需要直接访问。

[![project](img/dbf7c3f951d678a96a61ca5561a1ca09.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--RCnu15pS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n143u75cmohymw6g1x7r.jpeg)
...
创建和维护产品 backlog 是产品负责人角色的重要组成部分。产品负责人需要维护一个 backlog，以便于团队创建和跟踪潜在故事的优先级。由于 Quire 在面向任务的界面中集成了看板特性，以及方便的嵌套子任务界面，因此 Quire 可能是一个更好的解决方案，而不是尝试使用团队用于活动故事的相同看板，或者用电子表格和文字处理器拼凑一个定制的解决方案。