...
> 原文:[https://dev . to/ankursheel/react-component-to-fraw-on-a-page-using-hooks-and-typescript-2 aph](https://dev.to/ankursheel/react-component-to-fraw-on-a-page-using-hooks-and-typescript-2ahp)
...
#### [](#start-drawing-when-the-mouse-is-pressed)按下鼠标开始绘图。
...
#### [](#draw-the-line-on-mouse-move)鼠标移动时画线
...
#### [](#stop-drawing-on-mouse-release)松开鼠标停止绘图
