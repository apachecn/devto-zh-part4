...
> 原文:[https://dev.to/integerman/fun-with-feature-flags-31jf](https://dev.to/integerman/fun-with-feature-flags-31jf)
...
# [](#why-use-feature-flags)为什么要使用特征标志？
...
[![Beta Users getting access to new code before other users](img/dd83ce6f1e2d7989ecadaa29a9207308.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_U9HtrlY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/vy6nhFg.png)
...
# [](#implementing-a-feature-flag)实现一个特征标志
...
# [](#ways-to-configure-feature-flags)配置特征标志的方式
...
# [](#objections-to-feature-flags)对特征标志的异议
...
[![Using Scientist to run an experiment featuring a legacy and new version of a routine](img/5ff27c3ce4887dfcffdc350ef1ece668.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K_ZTM6A2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/FDAgrQO.png)
