...
> 原文:[https://dev . to/bnevilleoneill/how-to-do-semantics-the-right-way-nal](https://dev.to/bnevilleoneill/how-to-do-semantics-the-right-way-nal)
...
## [](#what-does-semantics-even-mean)语义到底是什么意思？
...
### [](#increased-discoverability-seo)提高可发现性(SEO)
