...
> 原文:[https://dev . to/peterj/5-tips-to-be-more-productive-with-kubernetes-27hg](https://dev.to/peterj/5-tips-to-be-more-productive-with-kubernetes-27hg)
...
## [](#1-switching-between-kubernetes-contexts)1。在 Kubernetes 上下文之间切换
...
## [](#2-switching-between-kubernetes-namespaces)2。在 Kubernetes 名称空间之间切换
...
## [](#4-get-a-terminal-inside-the-kubernetes-cluster)4。在 Kubernetes 集群中获得一个终端
...
## [](#5-quickly-open-grafanajaegerkiali-or-anything-else)5。快速打开 Grafana/Jaeger/Kiali(或其他任何东西)
