...
> 原文:[https://dev . to/skar lso/introducing-furnace-a-lightweight-solution-for-managing-your-application-and-infra structure-life cycle-5anf](https://dev.to/skarlso/introducing-furnace-a-lightweight-solution-for-managing-your-application-and-infrastructure-lifecycle-5anf)
...
## [](#gcp-deployment-manager)GCP 部署经理
...
### [](#gcp-application-deployment)GCP 应用部署
