...
> 原文:[https://dev . to/aaronpowell/recursive-settimeout-with-react-hooks-168n](https://dev.to/aaronpowell/recursive-settimeout-with-react-hooks-168n)
...
## [](#implementing-recursive-raw-settimeout-endraw-with-react-hooks)用 React 钩子实现递归`setTimeout`
