...
> 原文:[https://dev . to/benlesh/a-simple-explain-functional-pipe-in-JavaScript-2hbj](https://dev.to/benlesh/a-simple-explanation-of-functional-pipe-in-javascript-2hbj)
...
## [](#providing-broad-apis)提供广泛的 API
...
### [](#prototype-augmentation-is-problematic)原型增强有问题
...
## [](#functional-programming-ftw)功能编程 FTW！
...
## [](#piping-for-lefttoright-readability)从左到右可读性的管道
...
### [](#pipeable-functions-with-arguments)【可管道化】带参数的函数
...
## [](#the-larger-js-ecosystem-and-the-pipeline-operator)更大的 JS 生态系统和管道运营商
