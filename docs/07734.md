...
> 原文:[https://dev.to/jdsteinhauser/modern-c-isn-t-scary-7ai](https://dev.to/jdsteinhauser/modern-c-isn-t-scary-7ai)
...
# [](#less-horrendous-syntax)不那么可怕的语法
...
# [](#template-parameter-inference)模板参数推断
...
# [](#more-platform-independent-libraries)多平台独立库
...
# [](#creating-objects-in-template-classes)在模板类中创建对象
