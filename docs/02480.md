...
## [](#executando-um-c%C3%B3digo-ruby)运行 Ruby 代码
...
## [](#criando-uma-aplica%C3%A7%C3%A3o-de-terminal-para-c%C3%A1lculo-de-imc)创建 IMC 计算的终端应用程序
...
### [](#sa%C3%ADda-de-dados-padr%C3%A3o)标准数据输出
...
### [](#entrada-padr%C3%A3o-de-dados)标准数据输入
...
### [](#criando-sua-pr%C3%B3pria-fun%C3%A7%C3%A3o)创造自己的功能
