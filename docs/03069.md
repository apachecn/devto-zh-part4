...
> 原文:[https://dev . to/iankloppers/sketch it-c-intro-just-draw-something-4p0e](https://dev.to/iankloppers/sketchit-c-intro-just-draw-something-4p0e)

这是我的第一篇文章，所以请原谅我，并让我知道我可以在哪里以及如何提高我的写作技巧。

# [](#what-is-sketchit)什么是 SketchIt
...
# [](#making-use-of-the-animation-loop)利用动画循环
