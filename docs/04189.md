...
> 原文:[https://dev . to/lankydandev/implementing-multi-interfaces-through-delegation-h3a](https://dev.to/lankydandev/implementing-multiple-interfaces-through-delegation-h3a)
