...
> 原文:[https://dev . to/oieduardorabelo/react-quando-usar-uselayouteffect-ao-inves-de-use effect-3 IHP](https://dev.to/oieduardorabelo/react-quando-usar-uselayouteffect-ao-inves-de-useeffect-3ihp)
...
# [](#99-do-tempo-useeffect)99%做节拍，使用效果
...
# [](#quando-usarlayouteffect)Quando usarLayoutEffect
...
# [](#devo-usar-o-effect-ou-use-o-layouteffect)我应该使用效果还是使用布局效果？
