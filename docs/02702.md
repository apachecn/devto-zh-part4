...
> 原文:[https://dev . to/pdwarkanath/adding-structured-data-to-your-Hugo-site-58db](https://dev.to/pdwarkanath/adding-structured-data-to-your-hugo-site-58db)

如果你在谷歌上搜索一个热门话题，你可以看到一些新闻文章突出显示在谷歌搜索结果的顶部。像这样:

[![](img/79455ea445c76e868ed0e1dcb0b653f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jg_Q8yIM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i5dtg7ldl584gvb12nj0.png)
...
## [](#crate-a-raw-schemahtml-endraw-file)板条箱一个`schema.html`文件
...
## [](#add-variable-values-to-raw-config-endraw-file)添加变量值到`config`文件
...
## [](#add-partial-to-raw-head-endraw-tag)添加部分到`head`标签
