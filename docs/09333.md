...
> 原文:[https://dev . to/nesterow/setup-minimal-kiosk-environment-with-alpine-Linux-27b](https://dev.to/nesterow/setup-minimal-kiosk-environment-with-alpine-linux-27b)

在这篇文章中，我想分享一个为 Raspberry PI 和类似物开发 kiosk 应用程序的方法。

## [](#why-alpine-linux)为什么是 Alpine Linux？
...
## [](#install-raspberry-pi-firmware)安装树莓 PI 固件
...
## [](#saving-system-configuration)保存系统配置
