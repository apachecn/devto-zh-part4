...
> 原文:[https://dev . to/caffiendkitten/wtf-is-a-serializer-anyway-1d gj](https://dev.to/caffiendkitten/wtf-is-a-serializer-anyway-1dgj)
...
## [](#so-what-is-this-fast-json-and-how-does-it-make-serialization-easier)那么这个快速的 JSON 是什么，它是如何让序列化变得更容易的呢？
