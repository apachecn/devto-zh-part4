...
> 原文:[https://dev . to/sync fusion/introducing-stepprogress bar-for-xa marin-forms-gmj](https://dev.to/syncfusion/introducing-stepprogressbar-for-xamarin-forms-gmj)
...
[Xamarin。Forms](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/) StepProgressBar 是一个指示多步骤(状态)过程进度的控件，比如新用户注册或包状态跟踪。您可以通过更改步骤形状、步骤内容、进度条颜色等来自定义其外观。在这篇博文中，我们将总结 Xamarin 的主要特性。窗体 StepProgressBar 控件。【T2![StepProgressBar Control Overview](../Images/921842fa4f0a66dc6d17ae48152b7f5b.png)
...
由于多步骤流程可以在水平或垂直方向上进行，我们为这两个方向都提供了方向支持。[![Horizontal StepProgressBar Control](../Images/d9f9d182cc556d9273b260e12e41fe3f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--auXIu_h9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Horizontal-StepProgressBar-Control.png)
...
[![Vertical StepProgressBar Control](../Images/46ed38fe03bd801c9f7c8de9225f7368.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DbbAysy2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Vertical-StepProgressBar-Control.png)
...
我们通过提供额外的支持扩展了这个特性，在这里, [FormattedString](https://docs.microsoft.com/en-us/dotnet/api/xamarin.forms.formattedstring?view=xamarin-forms) 类可以作为两个描述的输入。您可以使用不同的格式样式来自定义这些描述。【T2![Step Descriptions](../Images/63dc3ee02f62f3d5338406b35c2b253d.png)
...
台阶标记的形状可以是圆形或方形。[![Step Markers](../Images/6e09b5c11bf7ce5ceb5569fa82a82739.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--in8gLRb9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Step-Markers.jpg)
...
您可以使用数字、记号、十字、点或图像来自定义步骤内容。[![Step Content](../Images/323fab495cfb54d7c17477b41a201893.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---g4GVqnY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Step-Content.png)
...
Xamarin。Forms StepProgressBar 控件允许您根据步骤的状态对其进行自定义。为每个状态定义一个单独的风格来实现这一点。可以为样式定义标记颜色、标记形状类型、标记内容颜色、标记内容类型、标记笔画颜色、标记笔画宽度、标记大小、标记内容大小、进度线颜色和字体。[![Style applied to Step Progress Bar](../Images/739fda616c04cdcf4c27af63a12d9b46.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RT2PQWFT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Style-applied-to-Step-Progress-Bar.png)
...
这就是如何将 StepProgressBar 控件添加到应用程序中。[![Step Progress Bar](../Images/303df096af4f08a14bff0efc6c534c01.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K_BGTEdY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.syncfusion.com/wp-content/uploads/2019/07/Step-Progress-Bar.jpg)
