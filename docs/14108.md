...
> 原文:[https://dev . to/kotest/testing-a-spring-boot-application-with-kotlint test-PGD](https://dev.to/kotest/testing-a-spring-boot-application-with-kotlintest-pgd)
...
[![](../Images/dc0fe17a66054b144eccab845c4a90bd.png)T2】](https://search.maven.org/artifact/io.kotest.extensions/kotest-extensions-spring)

## [](#transform-a-junit-test-to-a-kotest-spec)将 JUnit 测试转换为 Kotest 规范
...
## [](#transform-that-test-in-a-kotest-spec)在 Kotest 规范中转换测试
...
## [](#add-the-springlistener-to-the-class)将 SpringListener 添加到类中
