...
> 原文:[https://dev . to/ybogomolov/type safe-frontend-development-4 lbj](https://dev.to/ybogomolov/typesafe-frontend-development-4lbj)
...
## [](#typesafe-patterns)键入安全模式

> **注意**由于我使用的是 Giulio Canti 的令人难以置信的 [fp-ts](https://github.com/gcanti/fp-ts) 包，我将坚持使用它的术语。

### [](#use-raw-const-endraw-to-allow-easy-reasoning)用`const`来进行简单的推理
...
### [](#avoid-raw-null-endraw-and-raw-undefined-endraw-)避开`null`和`undefined`
...
### [](#avoid-throwing-exceptions-and-side-effects)避免抛出异常和副作用
...
### [](#compute-as-much-as-possible-in-compile-time)在编译时尽可能多地计算
...
### [](#finally-tagless-partially-evaluated)最后无标签，部分求值
