...
> 原文:[https://dev . to/njnareshjoshi/how-to-customize-serialization-in-Java-by-using-externalizable-interface-3g ja](https://dev.to/njnareshjoshi/how-to-customize-serialization-in-java-by-using-externalizable-interface-3gja)
...
## [](#what-is-externalization-and-externalizable-interface)什么是外化和可外化接口
...
## [](#how-serialization-works-with-externalizable-interface)序列化如何与外部化接口一起工作
...
## [](#differences-between-externalizable-vs-serializable)可外部化与可序列化的区别

让我们列出 java 中可外部化接口和可序列化接口的主要区别。

[![](../Images/206c77ed637a2845a49748e5875343c6.png)T2】](////4.bp.blogspot.com/-Z-MlBmCNsYs/XVAcnBY5cNI/AAAAAAAAVwk/JkyAJ74GdgUTqSisG8LNbWDYoLJJO0pMQCK4BGAYYCw/s1600/Differences-between-Externalizable-vs-Serializable.png)
