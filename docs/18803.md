...
> 原文:[https://dev . to/kcarrel/where-are-all-the-public-brand-APIs-158h](https://dev.to/kcarrel/where-are-all-the-public-brand-apis-158h)
...
# [](#where-are-all-the-brand-apis)品牌 API 都去哪了？
...
# [](#why-should-a-brand-provide-their-own-public-api)为什么一个品牌要提供自己的公共 API？
...
# [](#building-my-own-example-public-api)构建我自己的示例公共 API
...
[![](../Images/226eae9b6b240ec22a6366eeab14eddc.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--tGF73dfo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mtu2kejd0qyaatwm22gj.png)
