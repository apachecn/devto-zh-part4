...
> 原文:[https://dev . to/sebsanzdesant/rails-setup-on-Ubuntu-19-04-disco-dingo-2 ccl](https://dev.to/sebsanzdesant/rails-setup-on-ubuntu-19-04-disco-dingo-2ccl)
...
## [](#step-1-install-the-latest-version-of-ruby)第一步:安装最新版本的 Ruby。
...
## [](#step-2-configure-git)步骤 2 -配置 Git
...
## [](#setup-postgresql)设置 PostgreSQL
...
[![Yay! You're on Rails](../Images/3fe8bd980fc5c59982bb66888c4cfb74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xlRaWcwC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://edgeguides.rubyonrails.org/images/getting_started/rails_welcome.png)
