...
> 原文:[https://dev . to/siaarzh/vs-code-with-python-in-docker-quick start-3ph 4](https://dev.to/siaarzh/vs-code-with-python-in-docker-quickstart-3ph4)
...
### [](#a-note-on-opening-ports)关于开放端口的一个注记
