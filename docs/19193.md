...
> 原文：<https://dev.to/bnevilleoneill/5-vue-tips-for-react-developers-4j2g>

[![](img/f00735243e546433f60885dfe5946c6c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_M818km_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nozjvdnqbdw2g7o81fmv.jpg)
...
最后，应用程序最终看起来是这样的:
[https://codesandbox.io/embed/brew-bus-r8xkp](https://codesandbox.io/embed/brew-bus-r8xkp)
...
如果你看了 Codesandbox，我肯定你看到了`Home`和`Work`并不孤单；他们有一个兄弟姐妹叫做`Toggle`，其中有一些我们以前没有见过的有趣标记。
...
3.  我很想尝试用 Vue 在更大的范围内进行构建，以便真正感受它。到目前为止，我喜欢单文件组件！* * * * # Plug:[log rocket](https://logrocket.com/signup/)，一款适用于 web 应用的 DVR
...
给 React 开发人员的 5 个 Vue 提示的帖子最先出现在[博客](https://blog.logrocket.com)上。