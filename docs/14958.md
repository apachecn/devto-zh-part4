...
> 原文:[https://dev . to/first clown/what-are-custom-html-elements-1h 90](https://dev.to/firstclown/what-are-custom-html-elements-1h90)
...
## [](#web-components-standard)Web 组件标准
...
## [](#constructing-a-simple-custom-element)构造一个简单的自定义元素
...
## [](#future-articles-will-cover-more)以后的文章会覆盖更多
