...
> 原文:[https://dev . to/bertilmuth/a-radically-simple-approach-to-user-stories-5e3a](https://dev.to/bertilmuth/a-radically-simple-approach-to-user-stories-5e3a)

[![](img/40e89383ffffc8bd39cf4defbecf8c39.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U5peZJ-M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AV01olvkBSZw49SQbsQvNmA.jpeg)

用户故事是规划开发工作的好方法。理论上。但是在实践中如何避免引火烧身呢？我提出一个非常简单的方法。

这里有一个描述用户故事的流行模板:

[![](img/d7cf98c37df58a9517edbbae716f2fd4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E6D1iZG7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/204/1%2AH3A6fK_MbszLy5qO5a6RlQ.png)

下面是一个用户案例:

[![](img/b5c7321f0a292239ff6382e8fbd5a9b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_kD_vTsZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/243/1%2A2OaREloqXz0xUmcKz9Om_w.png)
...
### [](#acceptance-criteria-and-invest)验收标准和投入
...
### [](#the-problems-in-practice)实践中的问题
...
### [](#goals-deliver-value-but-cant-be-implemented)目标交付价值，但无法实施

在我的一门课程中，我会问这样的问题:“你能用网络商店做什么？”典型的回答是:“买一个产品”，或者“订购产品”。

参与者谈论的是目标。如果我们是一个开发网上商店的团队，我们可能会想出下面的用户故事:

[![](img/82b9ae3b4287ef69b626508d3a29985c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rKTKLo2R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/275/1%2AdgIKwzmLoHxAa3YYTNj9Ig.png)

这个目标层次的故事对用户有价值吗？是啊！它反映了网上商店顾客的需求。

可以直接实现这个目标吗？不要！为了实现一个目标，你需要先推导出达到目标的步骤。对于“购买产品”这个故事，步骤可能如下所示:

[![](img/c38c4d8512fabde51287cb7e7b8ad8be.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--86a4AC9w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/631/1%2Aoqv9IsQ3mVfo-anIUil9xQ.png)
...
### [](#a-radically-simple-approach)一种极其简单的方法

目标层的故事是粗粒度的。它们可用于长期规划，无需在细节上浪费精力:

[![](img/8847c48c98ea3e434c21fdac218b4bdf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lK8s6OrX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/790/1%2AQsM4gbvj_Scw9Uoj1PBx0A.png)
...
[![](img/bfbac7990943e288579a1d1240835cd3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oXl4c895--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/465/1%2AMl7ZUf0TFCJv2xApuF0xVw.png)
