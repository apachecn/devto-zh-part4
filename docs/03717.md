...
> 原文:[https://dev . to/next _ cart/upgrade-from-open cart-2-to-open cart-3-in-a-minutes-5g7b](https://dev.to/next_cart/upgrade-from-opencart-2-to-opencart-3-in-a-few-minutes-5g7b)

# [](#step-by-step-guide-on-how-to-upgrade-opencart-2-to-opencart-3)如何将 OpenCart 2 升级到 OpenCart 3 的分步指南
...
# [](#what-data-can-me-migrated-from-opencart-2-to-opencart-3)哪些数据可以从 OpenCart 2 迁移到 OpenCart 3
...
# [](#how-to-migrate-opencart-2-to-opencart-3-with-nextcart)如何用 Next-Cart 将 OpenCart 2 迁移到 OpenCart 3
