# 在几分钟内从 OpenCart 2 升级到 OpenCart 3

> 原文：<https://dev.to/next_cart/upgrade-from-opencart-2-to-opencart-3-in-a-few-minutes-5g7b>

# 如何将 OpenCart 2 升级到 OpenCart 3 的分步指南

1.  在你的服务器上安装 OpenCart 3(指向它的子域或子目录)
2.  使用 [OpenCart 到 OpenCart 迁移工具](https://next-cart.com/product/opencart-to-opencart/)将 CMS 和电子商务数据从 OpenCart 2 迁移到新的 OpenCart 商店。
...
# 哪些数据可以从 OpenCart 2 迁移到 OpenCart 3
...
# 如何用 Next-Cart 将 OpenCart 2 迁移到 OpenCart 3

Next-Cart 是一个购物车迁移服务，允许您将数据从当前商店迁移到另一个电子商务平台。整个过程可以分为三个简单的步骤:

1.  将 Kitconnect 上传到 OpenCart 2 和 OpenCart 3 商店的根文件夹。
2.  选择要迁移的数据
3.  执行迁移
