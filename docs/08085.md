...
> 原文:[https://dev . to/bnevilleoneill/you-re-over-use memo-re thinking-hooks-memo ization-19 G8](https://dev.to/bnevilleoneill/you-re-overusing-usememo-rethinking-hooks-memoization-19g8)
...
## [](#where-not-to-use-raw-usememo-endraw-)哪里不用`useMemo`

出于学习的目的，这些分类将被称为狮子和变色龙。

[![Category A And Category B: Lions And Chameleons](../Images/cf29c3e588af72ab200de5dc667c385d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MbwacXaO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blog.logrocket.com/wp-content/uploads/2019/08/lions-and-chameleons.png%3Fresize%3D730%252C241%26ssl%3D1)
...
### [](#1-same-reference-and-inexpensive-operations)1。相同的参考和廉价的操作
...
### [](#2-memoizing-default-state-for-any-number-of-reasons)2。出于多种原因记忆默认状态
...
### [](#3-using-raw-usememo-endraw-as-an-escape-hatch-for-the-eslint-hook-warnings)3。使用`useMemo`作为 ESLint 吊钩警告的出口

[![ESLint Hook Warnings](../Images/28b0bfb8745f29ae857fbead4abe6dae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lxyvgopm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/blog.logrocket.com/wp-content/uploads/2019/08/eslint-hook-warnings.png%3Fresize%3D730%252C134%26ssl%3D1)
...
[![Initial Props And Updated Props Example](../Images/465b214dc8490705dde4bdfa6866dfd9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0vzKcv1e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blog.logrocket.com/wp-content/uploads/2019/08/props-lint-warning-example.png%3Fresize%3D730%252C309%26ssl%3D1)
...
### [](#4-using-raw-usememo-endraw-solely-for-referential-equalities)4。仅将`useMemo`用于参考等式
