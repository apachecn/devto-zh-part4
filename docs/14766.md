...
# [](#create-firebase-app)Create Firebase App
...
# [](#connect-project-to-firebase-app)Connect Project to Firebase App
...
# [](#verify-service-functionality)Verify Service Functionality
...
# [](#modify-notify-demo-app-to-use-new-api)Modify Notify Demo App to Use New API
...
# [](#run-notify-and-enjoy)Run Notify and Enjoy
...
## [](#note-on-api-limits)Note on API Limits
