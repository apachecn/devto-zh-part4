...
> 原文:[https://dev . to/nkratzmeyer/using-includes-partials-in-pug js-19fa](https://dev.to/nkratzmeyer/using-includes-partials-in-pugjs-19fa)
...
## [](#about-partials-includes)关于偏旁(包括)
...
## [](#using-a-partial-for-the-header)使用分部分项为表头
