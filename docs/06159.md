...
> 原文:[https://dev . to/stefanjudis/til-how-to-create-your-custom-node-js-repl-4l 89](https://dev.to/stefanjudis/til-how-to-create-your-custom-node-js-repl-4l89)
...
[![Screenshot of a terminal: start a new REPL by running "node index.js" and see the available command 'printSomething'](../Images/99b5ebea8107feedb6ed253f1350f7ff.png)T2】](//images.ctfassets.net/f20lfrunubsq/3ThVsUOwFhhzxQCaRV8lm8/28ac1d8fc83a4010be01ae28f0529a8e/repl.jpg)
