...
> 原文:[https://dev . to/Carlos cuesta/managing-react-native-crashes-with-error-boundaries-13k](https://dev.to/carloscuesta/managing-react-native-crashes-with-error-boundaries-13k)

#### [](#originally-posted-at-carloscuestas-blog)*原载于 [carloscuesta 的博客](https://carloscuesta.me/blog/managing-react-native-crashes-with-error-boundaries)*
...
[![React-Native unmounted component tree error](img/60fa17edda3fbbf4b49579dd2c08257d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XfPS33V1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/carloscuesta/image/upload/react-native-error-unmounted-tree.png)

### [](#how-to-use-error-boundaries)如何使用误差边界
...
[![react-native-error-boundary](img/38725b507eae0a5e940229cd70e47e48.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9qXihKEz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/carloscuesta/image/upload/react-native-error-boundary.png)

⚠️ **错误边界只捕捉 JavaScript 错误**，你的应用程序可能出现的所有本地崩溃都不会被处理。

### [](#introducing-raw-reactnativeerrorboundary-endraw-)介绍 [`react-native-error-boundary`](https://github.com/carloscuesta/react-native-error-boundary)
