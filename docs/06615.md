...
> 原文:[https://dev . to/marcushellberg/setting-up-typescript-support-in-vaa din-bf9](https://dev.to/marcushellberg/setting-up-typescript-support-in-vaadin-bf9)
...
## [](#get-your-vaadin-project-ready)准备好您的 Vaadin 项目
...
## [](#install-typescript-and-its-webpack-loader)安装 TypeScript 及其 Webpack 加载器

在项目文件夹中，运行

`npm install --save-dev typescript ts-loader`

## [](#configure-webpack-to-handle-typescript)配置 Webpack 处理 TypeScript
...
## [](#configure-the-typescript-compiler)配置 TypeScript 编译器
...
## [](#load-a-typescript-file-from-java)从 Java 加载一个 TypeScript 文件
