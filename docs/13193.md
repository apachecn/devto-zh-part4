...
> 原文:[https://dev . to/ehsan network/problem-in-rails-credentials-in-production-2gc 9](https://dev.to/ehsanatwork/problem-in-rails-credentials-in-production-2gc9)
