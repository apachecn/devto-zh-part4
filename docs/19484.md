...
> 原文:[https://dev . to/philhardwick/when-Kafka-not-restart-memory-allocation-error-14ik](https://dev.to/philhardwick/when-kafka-doesn-t-restart-memory-allocation-error-14ik)
