...
> 原文:[https://dev . to/nab bisen/PHP-error-on-openbsd-env-PHP-no-such-file-or-directory-1f5p](https://dev.to/nabbisen/php-error-on-openbsd-env-php-no-such-file-or-directory-1f5p)
