...
> 原文:[https://dev . to/collinstommy/a-case-against-type-selectors-46nn](https://dev.to/collinstommy/a-case-against-type-selectors-46nn)
...
## [](#breaking-future-designs)打破未来的设计
...
## [](#reliance-on-element-types)对元素类型的依赖
...
## [](#in-summary-avoid-overuse-of-type-selectors)总之，避免过度使用类型选择器:
