...
> 原文:[https://dev . to/Sara fian/introduction-to-posts-about-JSON path-soap-and-Amadeus-with-powershell-4i3k](https://dev.to/sarafian/introduction-to-posts-about-jsonpath-soap-and-amadeus-with-powershell-4i3k)

# [](#the-airline-industry)航空业
...
# [](#why-powershell)为什么选择 PowerShell
