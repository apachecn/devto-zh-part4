...
> 原文:[https://dev . to/bnevilleoneill/axios-or-fetch-what-you-use-95i](https://dev.to/bnevilleoneill/axios-or-fetch-which-should-you-use-95i)
...
## [](#automatic-json-data-transformation)自动 JSON 数据转换
