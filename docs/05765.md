...
> 原文:[https://dev . to/mail meteor/how-to-create-a-bunch-of-Google-alerts-in-3-minutes-54n](https://dev.to/mailmeteor/how-to-create-a-bunch-of-google-alerts-in-3-minutes-54n)
...
[![Google Alerts homepage](../Images/e283b59d06db0bc04212f2ebd6e1cd25.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MyXrRqOb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://pix.watch/DO6exB/BZ2pVW.png)

我用的是谷歌浏览器，但用 Safari 或 Firefox 应该也可以。

## [](#create-a-google-alert-with-js)用 JS 创建 Google Alert

在 Google Alerts 首页，打开开发者工具`Alt`+`Command`+`J`(Mac 上)或者`Ctrl`+`Shit`+`J`(Windows 上)，然后打开`Network`标签页。您应该会看到类似这样的内容:

[![Network request opened on Google Alerts homepage](../Images/1a93e1b3548cd44009c5a3ea58928eb7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qk088Q9l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://pix.watch/Qt8-II/_LTCvL.png)

现在使用关键字`dev.to`创建一个示例警报。网络选项卡将显示对`/create`端点的请求。使用`Copy as fetch`来查看请求的内容:

[![Request to the /create endpoint](../Images/5142fea464fe025e187c1b15e786b321.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8ncNXht7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://pix.watch/noiPEk/xR3iqw.png)
...
## [](#a-script-that-creates-google-alerts-in-bulk)批量创建 Google Alerts 的脚本
