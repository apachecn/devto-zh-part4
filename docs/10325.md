...
> 原文:[https://dev . to/azure/azure-IOT-edge-on-raspberry-pi-buster-plus-tips-for-raspberry-pi-4-22nn](https://dev.to/azure/azure-iot-edge-on-raspberry-pi-buster-plus-tips-for-raspberry-pi-4-22nn)

# Azure IoT Edge on Raspberry Pi Buster plus tips for Raspberry Pi 4

[![Raspberry Pi 4 with Fan SHIM](../Images/e2f5e0bb0990087adcbd6da88b2a0050.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vaeyRlYZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Azure-IoT-Edge-on-Raspberry-Pi-Buster/master/resources/rpi4.jpg)

## [](#useful-references)有用的参考文献
...
## [](#installing-raspbian-buster)安装拉斯扁克星
...
## [](#azure-iot-edge-on-raspbian-buster)拉斯边巴斯特上的天蓝色物联网边缘

### [](#raspberry-pi-4-tips)树莓 Pi 4 提示

1.  [冷却您的覆盆子酱 4](#cooling-your-raspberry-pi-4)
2.  [从 USB 3 闪存或固态硬盘启动您的 Raspberry Pi 4](#booting-from-a-usb-3-flash-or-ssd-drive)

### [](#azure-iot-edge-and-raspbian-buster-tips)Azure IoT Edge 和 Raspbian Buster 提示
...
## [](#cooling-your-raspberry-pi-4)给你的树莓派降温 4
...
[![Fan SHIM](../Images/c51ee2a46d1d515e38dc6c5c85077fb0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7i7VZa47--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Azure-IoT-Edge-on-Raspberry-Pi-Buster/master/resources/fan-shim.jpg)

### [](#install-the-fan-shim-software)安装风扇垫片软件
...
## [](#booting-from-a-usb-3-flash-or-ssd-drive)从 USB 3 闪存或固态硬盘启动
...
### [](#usb-booting-your-raspberry-pi-from-with-beta-firmware-may-2020)使用测试版固件从 USB 启动您的 Raspberry Pi(2020 年 5 月)

[如何从 USB 固态硬盘或闪存盘启动 Raspberry Pi 4](https://www.tomshardware.com/how-to/boot-raspberry-pi-4-usb)

* * *

## [](#installing-docker-on-raspbian-buster)将 Docker 安装在 Raspbian Buster 上

```
curl -sSL get.docker.com | sh && sudo usermod pi -aG docker && sudo reboot 
```

## [](#installing-azure-iot-edge-on-raspbian-buster)在 Raspbian Buster 上安装 Azure IoT Edge

[![](../Images/9ef64f4972190cb0e57edd22cdd355c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1nMXl_it--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Azure-IoT-Edge-on-Raspberry-Pi-Buster/master/resources/iotedge.png)

回顾如何在基于 Debian 的 Linux 系统上安装 Azure IoT Edge 运行时。

### [](#ssl-library-libssl102)SSL Library libssl1.0.2
...
### [](#add-iot-edge-connection-string)添加物联网边缘连接字符串

```
sudo nano /etc/iotedge/config.yaml 
```

### [](#restart-azure-iot-edge)重启 Azure 物联网边缘

```
sudo systemctl restart iotedge 
```

## [](#ssh-authentication-with-privatepublic-keys)使用私钥/公钥的 SSH 认证

[![ssh login](../Images/df87986eb1e36759f0fe54782423c888.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5Ovy8wpi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Azure-IoT-Edge-on-Raspberry-Pi-Buster/master/resources/ssh-login.jpg)

为 SSH 登录和认证设置公钥/私钥非常方便(而且安全)。

下面创建一个新的 SSH 密钥，将公钥复制到 Raspberry Pi。采用默认选项。

### [](#from-windows)来自 Windows
...
### [](#from-linux-macos-and-the-windows-subsystem-for-linux)来自 Linux、macOS 和 Windows 子系统
...
[![tools](../Images/0b8b51b925119308d4e5ca487045bc0d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--URH03Vvr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Azure-IoT-Edge-on-Raspberry-Pi-Buster/master/resources/tools.jpg)
...
### [](#asmt-model-1153-usb-3-ssd)ASMT -型号:1153 - USB 3 固态硬盘
