...
> 原文:[https://dev . to/sandordargo/the-big-STL-algorithms-tutorial-modificing-sequence-operations-copy-et-al-CMA](https://dev.to/sandordargo/the-big-stl-algorithms-tutorial-modifying-sequence-operations-copy-et-al-cma)
...
## [](#-raw-movebackward-endraw-)`move_backward`
...
## [](#-raw-swapranges-endraw-)`swap_ranges`
