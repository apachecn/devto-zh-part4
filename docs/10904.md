...
> 原文:[https://dev . to/eice blue/add-headers-and-footers-to-word-document-in-Java-dah](https://dev.to/eiceblue/add-headers-and-footers-to-word-document-in-java-dah)
...
## [](#1-add-simple-header-and-footer)1。添加简单的页眉和页脚
...
[![simple header and footer](../Images/c7c2190293de438fd74264b8b5427e56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rEcEIb2C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pe7qr169jtuqkpdjvgie.png)

## [](#2-add-different-first-page-header-and-footer)2。添加不同的首页页眉和页脚
...
[![different first page header and footer](../Images/845a3514c9821b5fa1af68a908e76d84.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rmPFcBY0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x1lihu900c906m0ma7c5.png)

## [](#3-add-different-headers-and-footers-for-odd-and-even-pages)3。为奇数页和偶数页添加不同的页眉和页脚
...
[![different headers and footers for odd and even pages](../Images/5721e53ab31c70018c3a15475ddbe29f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AIQgZTeO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/en3qiemibh6xieqzgq1k.png)
