...
> 原文:[https://dev . to/webixui/webix-tooltips-for-improving-user-experience-32eb](https://dev.to/webixui/webix-tooltips-for-improving-user-experience-32eb)

工具提示是改善用户体验的冠军。这些弹出消息会引导用户浏览您的 web 应用程序，提供线索和其他有用的信息。Webix 工具提示可以添加到任何地方:数据表的页眉和页脚、控件、HTML 元素等等。
[![](../Images/e34f09ea5f819ffda2b8c1c1da53c91e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SCZXFwt0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bm1s1gra6k2ejapma71s.png) 
...
### [](#add-a-tooltip-anywhere-you-like)在你喜欢的任何地方添加工具提示

你几乎可以给你的应用程序的任何项目配备工具提示。看看下面的橱窗。

[![](../Images/f6547db0b184e8ecb2ef64dd86cd1f90.png)T4】](https://res.cloudinary.com/practicaldev/image/fetch/s--v35p8cng--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c1cxzg58wn227xq3f5f2.png)
...
### [](#datatable-and-webix-tooltips)DataTable 和 Webix 工具提示
...
### [](#tooltips-for-sparklines)迷你图工具提示
...
### [](#tooltips-for-any-html-areas)任何 HTML 区域的工具提示
